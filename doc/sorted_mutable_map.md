...
classDiagram
    ...
    class sorted_mutable_map {
        keys()
        values()
    }
    <<interface>> sorted_mutable_map
    sorted_settable_incremental_map *-- sorted_mutable_map
    sorted_settable_reducible_map *-- sorted_mutable_map
    mutable_map *-- sorted_mutable_map
```

[sorted_mutable_map](sorted_mutable_map.md) _is a_ [sorted_map](sorted_map.md) 
whose contents may change.
- [sorted_mutable_set](sorted_mutable_set.md) view of keys
