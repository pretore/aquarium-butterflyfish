...
#define INVOKE(x)               (*(struct butterflyfish_reducible_set_i_i **) x)
...
static inline int
as_set(const struct butterflyfish_reducible_set_i_i *const object,
...
static inline int
as_removable(struct butterflyfish_reducible_set_i_i *const object,
...
static inline int
as_collection(const struct butterflyfish_reducible_set_i_i *const object,
...
static inline int
as_stream(const struct butterflyfish_reducible_set_i_i *const object,
...
int butterflyfish_reducible_set_i_i_first(
    ...
    if (!out) {
        return BUTTERFLYFISH_REDUCIBLE_SET_I_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_reducible_set_i_i_next(
    ...
    if (!item) {
        return BUTTERFLYFISH_REDUCIBLE_SET_I_I_ERROR_ITEM_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_REDUCIBLE_SET_I_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_reducible_set_i_i_contains_all(
    ...
    if (!other) {
        return BUTTERFLYFISH_REDUCIBLE_SET_I_I_ERROR_OTHER_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_REDUCIBLE_SET_I_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_reducible_set_i_i_remove_item(
        struct butterflyfish_reducible_set_i_i *const object,
        const struct butterflyfish_map_i_i_entry *const item) {
    if (!object) {
        return BUTTERFLYFISH_REDUCIBLE_SET_I_I_ERROR_OBJECT_IS_NULL;
    }
