...
as_sorted_incremental_list(
    ...
    assert(object);
    assert(out);
    return INVOKE(object)->as_sorted_incremental_list(object, out);
}
...
as_sorted_settable_list(
    ...
    assert(object);
    assert(out);
    return INVOKE(object)->as_sorted_settable_list(object, out);
}
...
static inline int
as_addable(struct butterflyfish_sorted_settable_incremental_list_i
            *const object,
...
static inline int
as_settable(struct butterflyfish_sorted_settable_incremental_list_i
                *const object,
...
static inline int
as_list(const struct butterflyfish_sorted_settable_incremental_list_i
                *const object,
...
static inline int
as_sorted(const struct butterflyfish_sorted_settable_incremental_list_i
                *const object,
...
static inline int
as_collection(const struct butterflyfish_sorted_settable_incremental_list_i
                    *const object,
...
static inline int
as_stream(const struct butterflyfish_sorted_settable_incremental_list_i
            *const object,
...
#pragma mark sorted_settable_incremental_list_i -
