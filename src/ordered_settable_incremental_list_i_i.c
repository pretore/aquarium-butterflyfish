...
#define INVOKE(x) \
    (*(struct butterflyfish_ordered_settable_incremental_list_i_i **) x)
...
#define INVOKE_ORDERED_SETTABLE_LIST(x) \
    (*(struct butterflyfish_ordered_settable_list_i_i **) x)
#define INVOKE_ORDERED_INCREMENTAL_LIST(x) \
    (*(struct butterflyfish_ordered_incremental_list_i_i **) x)
#define INVOKE_SETTABLE_LIST(x) \
    (*(struct butterflyfish_settable_list_i_i **) x)
#define INVOKE_INCREMENTAL_LIST(x) \
    (*(struct butterflyfish_incremental_list_i_i **) x)
#define INVOKE_ORDERED_LIST(x)  (*(struct butterflyfish_ordered_list_i_i **) x)
...
as_ordered_settable_list(
    ...
    assert(object);
    assert(out);
    return INVOKE(object)->as_ordered_settable_list(object, out);
}
...
as_ordered_incremental_list(
    ...
    assert(object);
    assert(out);
    return INVOKE(object)->as_ordered_incremental_list(object, out);
}

static inline int
as_insertable(struct butterflyfish_ordered_settable_incremental_list_i_i
                *const object,
              struct butterflyfish_insertable_i_i **const out) {
    assert(object);
    assert(out);
    struct butterflyfish_ordered_incremental_list_i_i *ordered_incremental_list;
...
static inline int
as_ordered_list(const struct butterflyfish_ordered_settable_incremental_list_i_i
                    *const object,
                const struct butterflyfish_ordered_list_i_i **const out) {
    assert(object);
    assert(out);
    struct butterflyfish_ordered_incremental_list_i_i *ordered_incremental_list;
    seagrass_required_true(!as_ordered_incremental_list((void *)
            object, &ordered_incremental_list));
    return INVOKE_ORDERED_INCREMENTAL_LIST(ordered_incremental_list)
...
static inline int
as_incremental_list(struct butterflyfish_ordered_settable_incremental_list_i_i
                        *const object,
...
static inline int
as_settable_list(struct butterflyfish_ordered_settable_incremental_list_i_i
                    *const object,
                 struct butterflyfish_settable_list_i_i **const out) {
    assert(object);
    assert(out);
    struct butterflyfish_ordered_settable_list_i_i *ordered_settable_list;
...
static inline int
as_ordered(const struct butterflyfish_ordered_settable_incremental_list_i_i
                *const object,
...
static inline int
as_list(const struct butterflyfish_ordered_settable_incremental_list_i_i
                *const object,
...
static inline int
as_addable(struct butterflyfish_ordered_settable_incremental_list_i_i
                *const object,
...
static inline int
as_settable(struct butterflyfish_ordered_settable_incremental_list_i_i
                *const object,
...
static inline int
as_collection(const struct butterflyfish_ordered_settable_incremental_list_i_i
                    *const object,
...
static inline int
as_stream(const struct butterflyfish_ordered_settable_incremental_list_i_i
                    *const object,
...
#pragma mark ordered_settable_incremental_list_i_i -
