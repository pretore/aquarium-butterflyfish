...
#define INVOKE(x)               (*(struct butterflyfish_insertable_i **) x)
...
static inline int
as_ordered(const struct butterflyfish_insertable_i *const object,
...
static inline int
as_collection(const struct butterflyfish_insertable_i *const object,
...
static inline int
as_stream(const struct butterflyfish_insertable_i *const object,
