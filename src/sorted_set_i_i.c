...
#define INVOKE(x)               (*(struct butterflyfish_sorted_set_i_i **) x)
...
static inline int
as_sorted(const struct butterflyfish_sorted_set_i_i *const object,
...
static inline int
as_set(const struct butterflyfish_sorted_set_i_i *const object,
...
static inline int
as_collection(const struct butterflyfish_sorted_set_i_i *const object,
...
static inline int
as_stream(const struct butterflyfish_sorted_set_i_i *const object,
...
int butterflyfish_sorted_set_i_i_first(
        const struct butterflyfish_sorted_set_i_i *const object,
        const struct butterflyfish_map_i_i_entry **const out) {
    if (!object) {
        return BUTTERFLYFISH_SORTED_SET_I_I_ERROR_OBJECT_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SORTED_SET_I_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_sorted_set_i_i_next(
    ...
    if (!item) {
        return BUTTERFLYFISH_SORTED_SET_I_I_ERROR_ITEM_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SORTED_SET_I_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_sorted_set_i_i_ceiling(
    ...
    if (!value) {
        return BUTTERFLYFISH_SORTED_SET_I_I_ERROR_VALUE_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SORTED_SET_I_I_ERROR_OUT_IS_NULL;
    }
