...
static inline int
as_stream(const struct butterflyfish_ordered_i_i *const object,
...
int butterflyfish_ordered_i_i_first(
        const struct butterflyfish_ordered_i_i *const object,
        const struct butterflyfish_map_i_i_entry **const out) {
    if (!object) {
        return BUTTERFLYFISH_ORDERED_I_I_ERROR_OBJECT_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_ORDERED_I_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_ordered_i_i_next(
    ...
    if (!item) {
        return BUTTERFLYFISH_ORDERED_I_I_ERROR_ITEM_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_ORDERED_I_I_ERROR_OUT_IS_NULL;
    }
