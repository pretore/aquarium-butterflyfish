...
#define INVOKE(x)               (*(struct butterflyfish_incremental_set_i **) x)
...
static inline int
as_addable(struct butterflyfish_incremental_set_i *const object,
...
static inline int
as_set(const struct butterflyfish_incremental_set_i *const object,
...
static inline int
as_collection(const struct butterflyfish_incremental_set_i *const object,
...
static inline int
as_stream(const struct butterflyfish_incremental_set_i *const object,
...
int butterflyfish_incremental_set_i_first(
    ...
    if (!object) {
        return BUTTERFLYFISH_INCREMENTAL_SET_I_ERROR_OBJECT_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_INCREMENTAL_SET_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_incremental_set_i_next(
    ...
    if (!item) {
        return BUTTERFLYFISH_INCREMENTAL_SET_I_ERROR_ITEM_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_INCREMENTAL_SET_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_incremental_set_i_contains(
    ...
    if (!value) {
        return BUTTERFLYFISH_INCREMENTAL_SET_I_ERROR_VALUE_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_INCREMENTAL_SET_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_incremental_set_i_contains_all(
    ...
    if (!other) {
        return BUTTERFLYFISH_INCREMENTAL_SET_I_ERROR_OTHER_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_INCREMENTAL_SET_I_ERROR_OUT_IS_NULL;
    }
