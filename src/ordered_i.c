...
static inline int
as_stream(const struct butterflyfish_ordered_i *const object,
...
int butterflyfish_ordered_i_first(
        const struct butterflyfish_ordered_i *const object,
        const struct sea_turtle_integer **const out) {
    if (!object) {
        return BUTTERFLYFISH_ORDERED_I_ERROR_OBJECT_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_ORDERED_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_ordered_i_next(
        const struct butterflyfish_ordered_i *const object,
    ...
    if (!item) {
        return BUTTERFLYFISH_ORDERED_I_ERROR_ITEM_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_ORDERED_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_ordered_i_count(
        const struct butterflyfish_ordered_i *const object,
        uintmax_t *const out) {
    if (!object) {
        return BUTTERFLYFISH_ORDERED_I_ERROR_OBJECT_IS_NULL;
...
int butterflyfish_ordered_i_last(
        const struct butterflyfish_ordered_i *const object,
        const struct sea_turtle_integer **const out) {
    if (!object) {
        return BUTTERFLYFISH_ORDERED_I_ERROR_OBJECT_IS_NULL;
...
int butterflyfish_ordered_i_prev(
        const struct butterflyfish_ordered_i *const object,
        const struct sea_turtle_integer *const item,
        const struct sea_turtle_integer **const out) {
    if (!object) {
...
#pragma mark ordered_i -

int butterflyfish_ordered_i_as_stream(
        const struct butterflyfish_ordered_i *const object,
        const struct butterflyfish_stream_i **const out) {
    if (!object) {
        return BUTTERFLYFISH_ORDERED_I_ERROR_OBJECT_IS_NULL;
...
int butterflyfish_ordered_i_as_collection(
        const struct butterflyfish_ordered_i *const object,
        const struct butterflyfish_collection_i **const out) {
    if (!object) {
        return BUTTERFLYFISH_ORDERED_I_ERROR_OBJECT_IS_NULL;
