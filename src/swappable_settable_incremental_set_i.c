...
#define INVOKE(x) \
    (*(struct butterflyfish_swappable_settable_incremental_set_i **) x)
#define INVOKE_ORDERED_SETTABLE_INCREMENTAL_SET(x) \
    (*(struct butterflyfish_ordered_settable_incremental_set_i **) x)
#define INVOKE_SWAPPABLE_SETTABLE_SET(x) \
    (*(struct butterflyfish_swappable_settable_set_i **) x)
#define INVOKE_SWAPPABLE_INCREMENTAL_SET(x) \
...
as_swappable_incremental_set(
    ...
    assert(object);
    assert(out);
    return INVOKE(object)->as_swappable_incremental_set(object, out);
}
...
as_swappable_set(
    ...
    assert(object);
    assert(out);
    struct butterflyfish_swappable_incremental_set_i *swappable_incremental_set;
    seagrass_required_true(!as_swappable_incremental_set(
            object, &swappable_incremental_set));
    return INVOKE_SWAPPABLE_INCREMENTAL_SET(swappable_incremental_set)
        ->as_swappable_set(swappable_incremental_set, out);
}
...
as_ordered_incremental_set(
    ...
    seagrass_required_true(!as_swappable_incremental_set(
            object, &swappable_incremental_set));
    return INVOKE_SWAPPABLE_INCREMENTAL_SET(swappable_incremental_set)
        ->as_ordered_incremental_set(swappable_incremental_set, out);
}
...
as_settable_incremental_set(
    ...
    return INVOKE_ORDERED_SETTABLE_INCREMENTAL_SET(ordered_settable_incremental_set)
        ->as_settable_incremental_set(ordered_settable_incremental_set, out);
}
...
as_settable_set(
    ...
    assert(object);
    assert(out);
    struct butterflyfish_settable_incremental_set_i *settable_incremental_set;
...
static inline int
as_set(const struct butterflyfish_swappable_settable_incremental_set_i
            *const object,
...
static inline int
as_addable(struct butterflyfish_swappable_settable_incremental_set_i
                *const object,
...
static inline int
as_settable(struct butterflyfish_swappable_settable_incremental_set_i
                *const object,
...
static inline int
as_collection(const struct butterflyfish_swappable_settable_incremental_set_i
                *const object,
    ...
    return INVOKE_SET(object)->as_collection(set, out);
}

static inline int
as_stream(const struct butterflyfish_swappable_settable_incremental_set_i
            *const object,
...
#pragma mark swappable_settable_incremental_set_i -
...
butterflyfish_swappable_settable_incremental_set_i_as_swappable_incremental_set(
    ...
    return as_swappable_incremental_set(object, out);
}
