...
static inline int
as_sorted_list(const struct butterflyfish_sorted_settable_list_i *const object,
...
static inline int
as_settable_list(struct butterflyfish_sorted_settable_list_i *const object,
...
static inline int
as_list(const struct butterflyfish_sorted_settable_list_i *const object,
...
static inline int
as_sorted(const struct butterflyfish_sorted_settable_list_i *const object,
...
static inline int
as_settable(struct butterflyfish_sorted_settable_list_i *const object,
...
static inline int
as_collection(const struct butterflyfish_sorted_settable_list_i *const object,
...
static inline int
as_stream(const struct butterflyfish_sorted_settable_list_i *const object,
...
int butterflyfish_sorted_settable_list_i_first(
    ...
    if (!object) {
        return BUTTERFLYFISH_SORTED_SETTABLE_LIST_I_ERROR_OBJECT_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SORTED_SETTABLE_LIST_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_sorted_settable_list_i_next(
    ...
    if (!item) {
        return BUTTERFLYFISH_SORTED_SETTABLE_LIST_I_ERROR_ITEM_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SORTED_SETTABLE_LIST_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_sorted_settable_list_i_set_item(
    ...
    if (!value) {
        return BUTTERFLYFISH_SORTED_SETTABLE_LIST_I_ERROR_VALUE_IS_NULL;
    }
...
#pragma mark sorted_settable_list_i -
