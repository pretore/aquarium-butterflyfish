...
static inline int
as_settable_set(struct butterflyfish_sorted_settable_set_i_i *const object,
...
static inline int
as_sorted_set(const struct butterflyfish_sorted_settable_set_i_i *const object,
...
static inline int
as_sorted(const struct butterflyfish_sorted_settable_set_i_i *const object,
...
static inline int
as_set(const struct butterflyfish_sorted_settable_set_i_i *const object,
...
static inline int
as_settable(struct butterflyfish_sorted_settable_set_i_i *const object,
...
static inline int
as_collection(const struct butterflyfish_sorted_settable_set_i_i *const object,
...
static inline int
as_stream(const struct butterflyfish_sorted_settable_set_i_i *const object,
...
int butterflyfish_sorted_settable_set_i_i_first(
    ...
    if (!object) {
        return BUTTERFLYFISH_SORTED_SETTABLE_SET_I_I_ERROR_OBJECT_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SORTED_SETTABLE_SET_I_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_sorted_settable_set_i_i_next(
    ...
    if (!item) {
        return BUTTERFLYFISH_SORTED_SETTABLE_SET_I_I_ERROR_ITEM_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SORTED_SETTABLE_SET_I_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_sorted_settable_set_i_i_set_item(
    ...
    if (!value) {
        return BUTTERFLYFISH_SORTED_SETTABLE_SET_I_I_ERROR_VALUE_IS_NULL;
    }
...
int butterflyfish_sorted_settable_set_i_i_contains_all(
    ...
    if (!other) {
        return BUTTERFLYFISH_SORTED_SETTABLE_SET_I_I_ERROR_OTHER_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SORTED_SETTABLE_SET_I_I_ERROR_OUT_IS_NULL;
    }
...
#pragma mark sorted_settable_set_i_i -
