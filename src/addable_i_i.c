...
static inline int
as_stream(const struct butterflyfish_addable_i_i *const object,
...
int butterflyfish_addable_i_i_first(
    ...
    if (!out) {
        return BUTTERFLYFISH_ADDABLE_I_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_addable_i_i_next(
        const struct butterflyfish_addable_i_i *const object,
    ...
    if (!item) {
        return BUTTERFLYFISH_ADDABLE_I_I_ERROR_ITEM_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_ADDABLE_I_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_addable_i_i_count(
        const struct butterflyfish_addable_i_i *const object,
        uintmax_t *const out) {
    if (!object) {
        return BUTTERFLYFISH_ADDABLE_I_I_ERROR_OBJECT_IS_NULL;
...
int butterflyfish_addable_i_i_prev(
        const struct butterflyfish_addable_i_i *const object,
        const struct butterflyfish_map_i_i_entry *const item,
        const struct butterflyfish_map_i_i_entry **const out) {
    if (!object) {
...
int butterflyfish_addable_i_i_as_stream(
        const struct butterflyfish_addable_i_i *const object,
        const struct butterflyfish_stream_i_i **const out) {
    if (!object) {
        return BUTTERFLYFISH_ADDABLE_I_I_ERROR_OBJECT_IS_NULL;
...
int butterflyfish_addable_i_i_as_collection(
        const struct butterflyfish_addable_i_i *const object,
        const struct butterflyfish_collection_i_i **const out) {
    if (!object) {
        return BUTTERFLYFISH_ADDABLE_I_I_ERROR_OBJECT_IS_NULL;
...
int butterflyfish_addable_i_i_add(
        struct butterflyfish_addable_i_i *const object,
...
int butterflyfish_addable_i_i_add_all(
        struct butterflyfish_addable_i_i *const object,
    ...
    if (!other) {
        return BUTTERFLYFISH_ADDABLE_I_I_ERROR_OTHER_IS_NULL;
    }
