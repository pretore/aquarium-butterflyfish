...
static inline int
as_settable_set(struct butterflyfish_mutable_set_i_i *const object,
...
static inline int
as_incremental_set(struct butterflyfish_mutable_set_i_i *const object,
...
static inline int
as_reducible_set(struct butterflyfish_mutable_set_i_i *const object,
                 struct butterflyfish_reducible_set_i_i **const out) {
    assert(object);
    assert(out);
    struct butterflyfish_settable_reducible_set_i_i *settable_reducible_set;
...
static inline int
as_set(const struct butterflyfish_mutable_set_i_i *const object,
...
static inline int
as_settable(struct butterflyfish_mutable_set_i_i *const object,
...
static inline int
as_addable(struct butterflyfish_mutable_set_i_i *const object,
...
static inline int
as_removable(struct butterflyfish_mutable_set_i_i *const object,
...
static inline int
as_collection(const struct butterflyfish_mutable_set_i_i *const object,
...
static inline int
as_stream(const struct butterflyfish_mutable_set_i_i *const object,
...
int butterflyfish_mutable_set_i_i_first(
        const struct butterflyfish_mutable_set_i_i *const object,
        const struct butterflyfish_map_i_i_entry **const out) {
    if (!object) {
        return BUTTERFLYFISH_MUTABLE_SET_I_I_ERROR_OBJECT_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_MUTABLE_SET_I_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_mutable_set_i_i_next(
        const struct butterflyfish_mutable_set_i_i *const object,
    ...
    if (!item) {
        return BUTTERFLYFISH_MUTABLE_SET_I_I_ERROR_ITEM_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_MUTABLE_SET_I_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_mutable_set_i_i_count(
        const struct butterflyfish_mutable_set_i_i *const object,
        uintmax_t *const out) {
    if (!object) {
        return BUTTERFLYFISH_MUTABLE_SET_I_I_ERROR_OBJECT_IS_NULL;
...
int butterflyfish_mutable_set_i_i_last(
        const struct butterflyfish_mutable_set_i_i *const object,
        const struct butterflyfish_map_i_i_entry **const out) {
    if (!object) {
        return BUTTERFLYFISH_MUTABLE_SET_I_I_ERROR_OBJECT_IS_NULL;
...
int butterflyfish_mutable_set_i_i_prev(
        const struct butterflyfish_mutable_set_i_i *const object,
        const struct butterflyfish_map_i_i_entry *const item,
        const struct butterflyfish_map_i_i_entry **const out) {
    if (!object) {
...
int butterflyfish_mutable_set_i_i_set_item(
        struct butterflyfish_mutable_set_i_i *const object,
        const struct butterflyfish_map_i_i_entry *const item,
    ...
    if (!value) {
        return BUTTERFLYFISH_MUTABLE_SET_I_I_ERROR_VALUE_IS_NULL;
    }
...
int butterflyfish_mutable_set_i_i_contains(
        const struct butterflyfish_mutable_set_i_i *const object,
        const struct butterflyfish_map_i_i_entry *const value,
        bool *const out) {
    if (!object) {
...
int butterflyfish_mutable_set_i_i_contains_all(
        const struct butterflyfish_mutable_set_i_i *const object,
    ...
    if (!other) {
        return BUTTERFLYFISH_MUTABLE_SET_I_I_ERROR_OTHER_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_MUTABLE_SET_I_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_mutable_set_i_i_get(
        const struct butterflyfish_mutable_set_i_i *const object,
        const struct butterflyfish_map_i_i_entry *const value,
        const struct butterflyfish_map_i_i_entry **const out) {
    if (!object) {
...
int butterflyfish_mutable_set_i_i_set(
        struct butterflyfish_mutable_set_i_i *const object,
        const struct butterflyfish_map_i_i_entry *const item,
        const struct butterflyfish_map_i_i_entry *const value) {
    if (!object) {
...
int butterflyfish_mutable_set_i_i_add(
        struct butterflyfish_mutable_set_i_i *const object,
        const struct butterflyfish_map_i_i_entry *const value) {
    if (!object) {
        return BUTTERFLYFISH_MUTABLE_SET_I_I_ERROR_OBJECT_IS_NULL;
...
int butterflyfish_mutable_set_i_i_add_all(
        struct butterflyfish_mutable_set_i_i *const object,
        const struct butterflyfish_stream_i_i *const other) {
    if (!object) {
        return BUTTERFLYFISH_MUTABLE_SET_I_I_ERROR_OBJECT_IS_NULL;
...
int butterflyfish_mutable_set_i_i_remove_item(
        struct butterflyfish_mutable_set_i_i *const object,
        const struct butterflyfish_map_i_i_entry *const item) {
    if (!object) {
        return BUTTERFLYFISH_MUTABLE_SET_I_I_ERROR_OBJECT_IS_NULL;
...
int butterflyfish_mutable_set_i_i_remove_all_items(
        struct butterflyfish_mutable_set_i_i *const object,
        const struct butterflyfish_stream_i_i *const other) {
    if (!object) {
        return BUTTERFLYFISH_MUTABLE_SET_I_I_ERROR_OBJECT_IS_NULL;
...
int butterflyfish_mutable_set_i_i_remove(
        struct butterflyfish_mutable_set_i_i *const object,
        const struct butterflyfish_map_i_i_entry *const value) {
    if (!object) {
        return BUTTERFLYFISH_MUTABLE_SET_I_I_ERROR_OBJECT_IS_NULL;
...
int butterflyfish_mutable_set_i_i_remove_all(
        struct butterflyfish_mutable_set_i_i *const object,
        const struct butterflyfish_stream_i_i *const other) {
    if (!object) {
        return BUTTERFLYFISH_MUTABLE_SET_I_I_ERROR_OBJECT_IS_NULL;
...
int butterflyfish_mutable_set_i_i_retain_all(
        struct butterflyfish_mutable_set_i_i *const object,
        const struct butterflyfish_stream_i_i *const other) {
    if (!object) {
        return BUTTERFLYFISH_MUTABLE_SET_I_I_ERROR_OBJECT_IS_NULL;
...
#pragma mark mutable_set_i_i -

int butterflyfish_mutable_set_i_i_as_stream(
        const struct butterflyfish_mutable_set_i_i *const object,
        const struct butterflyfish_stream_i_i **const out) {
    if (!object) {
        return BUTTERFLYFISH_MUTABLE_SET_I_I_ERROR_OBJECT_IS_NULL;
...
int butterflyfish_mutable_set_i_i_as_collection(
        const struct butterflyfish_mutable_set_i_i *const object,
        const struct butterflyfish_collection_i_i **const out) {
    if (!object) {
        return BUTTERFLYFISH_MUTABLE_SET_I_I_ERROR_OBJECT_IS_NULL;
...
int butterflyfish_mutable_set_i_i_as_addable(
        struct butterflyfish_mutable_set_i_i *const object,
        struct butterflyfish_addable_i_i **const out) {
    if (!object) {
        return BUTTERFLYFISH_MUTABLE_SET_I_I_ERROR_OBJECT_IS_NULL;
...
int butterflyfish_mutable_set_i_i_as_removable(
        struct butterflyfish_mutable_set_i_i *const object,
        struct butterflyfish_removable_i_i **const out) {
    if (!object) {
        return BUTTERFLYFISH_MUTABLE_SET_I_I_ERROR_OBJECT_IS_NULL;
...
int butterflyfish_mutable_set_i_i_as_settable(
        struct butterflyfish_mutable_set_i_i *const object,
        struct butterflyfish_settable_i_i **const out) {
    if (!object) {
        return BUTTERFLYFISH_MUTABLE_SET_I_I_ERROR_OBJECT_IS_NULL;
...
int butterflyfish_mutable_set_i_i_as_set(
        const struct butterflyfish_mutable_set_i_i *const object,
        const struct butterflyfish_set_i_i **const out) {
    if (!object) {
        return BUTTERFLYFISH_MUTABLE_SET_I_I_ERROR_OBJECT_IS_NULL;
...
int butterflyfish_mutable_set_i_i_as_settable_set(
        struct butterflyfish_mutable_set_i_i *const object,
        struct butterflyfish_settable_set_i_i **const out) {
    if (!object) {
        return BUTTERFLYFISH_MUTABLE_SET_I_I_ERROR_OBJECT_IS_NULL;
...
int butterflyfish_mutable_set_i_i_as_incremental_set(
        struct butterflyfish_mutable_set_i_i *const object,
        struct butterflyfish_incremental_set_i_i **const out) {
    if (!object) {
        return BUTTERFLYFISH_MUTABLE_SET_I_I_ERROR_OBJECT_IS_NULL;
...
int butterflyfish_mutable_set_i_i_as_reducible_set(
        struct butterflyfish_mutable_set_i_i *const object,
        struct butterflyfish_reducible_set_i_i **const out) {
    if (!object) {
        return BUTTERFLYFISH_MUTABLE_SET_I_I_ERROR_OBJECT_IS_NULL;
...
int butterflyfish_mutable_set_i_i_as_settable_incremental_set(
        struct butterflyfish_mutable_set_i_i *const object,
        struct butterflyfish_settable_incremental_set_i_i **const out) {
    if (!object) {
        return BUTTERFLYFISH_MUTABLE_SET_I_I_ERROR_OBJECT_IS_NULL;
...
int butterflyfish_mutable_set_i_i_as_settable_reducible_set(
        struct butterflyfish_mutable_set_i_i *const object,
        struct butterflyfish_settable_reducible_set_i_i **const out) {
    if (!object) {
        return BUTTERFLYFISH_MUTABLE_SET_I_I_ERROR_OBJECT_IS_NULL;
