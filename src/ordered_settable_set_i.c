...
static inline int
as_ordered_set(const struct butterflyfish_ordered_settable_set_i *const object,
...
static inline int
as_settable_set(struct butterflyfish_ordered_settable_set_i *const object,
...
static inline int
as_set(const struct butterflyfish_ordered_settable_set_i *const object,
...
static inline int
as_ordered(const struct butterflyfish_ordered_settable_set_i *const object,
...
static inline int
as_settable(struct butterflyfish_ordered_settable_set_i *const object,
...
static inline int
as_collection(const struct butterflyfish_ordered_settable_set_i *const object,
...
static inline int
as_stream(const struct butterflyfish_ordered_settable_set_i *const object,
...
int butterflyfish_ordered_settable_set_i_first(
    ...
    if (!out) {
        return BUTTERFLYFISH_SETTABLE_SET_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_ordered_settable_set_i_contains_all(
    ...
    if (!other) {
        return BUTTERFLYFISH_SETTABLE_SET_I_ERROR_OTHER_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SETTABLE_SET_I_ERROR_OUT_IS_NULL;
    }
...
#pragma mark ordered_settable_set_i -
