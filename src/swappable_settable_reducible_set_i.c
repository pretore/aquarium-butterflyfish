...
#define INVOKE(x) \
    (*(struct butterflyfish_swappable_settable_reducible_set_i **) x)
#define INVOKE_ORDERED_SETTABLE_REDUCIBLE_SET(x) \
    (*(struct butterflyfish_ordered_settable_reducible_set_i **) x)
#define INVOKE_SWAPPABLE_SETTABLE_SET(x) \
    (*(struct butterflyfish_swappable_settable_set_i **) x)
#define INVOKE_SWAPPABLE_REDUCIBLE_SET(x) \
    (*(struct butterflyfish_swappable_reducible_set_i **) x)
...
#define INVOKE_ORDERED_REDUCIBLE_SET(x) \
    (*(struct butterflyfish_ordered_reducible_set_i **) x)
#define INVOKE_SWAPPABLE_SET(x) (*(struct butterflyfish_swappable_set_i **) x)
#define INVOKE_SETTABLE_SET(x)  (*(struct butterflyfish_settable_set_i **) x)
#define INVOKE_REDUCIBLE_SET(x) (*(struct butterflyfish_reducible_set_i **) x)
#define INVOKE_ORDERED_SET(x)   (*(struct butterflyfish_ordered_set_i **) x)
...
as_swappable_reducible_set(
    ...
    assert(object);
    assert(out);
    return INVOKE(object)->as_swappable_reducible_set(object, out);
}
...
as_swappable_settable_set(
    ...
    assert(object);
    assert(out);
    return INVOKE(object)->as_swappable_settable_set(object, out);
}
...
as_swappable_set(
    ...
    assert(object);
    assert(out);
    struct butterflyfish_swappable_reducible_set_i *swappable_reducible_set;
    seagrass_required_true(!as_swappable_reducible_set(
            object, &swappable_reducible_set));
    return INVOKE_SWAPPABLE_REDUCIBLE_SET(swappable_reducible_set)
        ->as_swappable_set(swappable_reducible_set, out);
}
...
as_ordered_reducible_set(
    ...
    seagrass_required_true(!as_swappable_reducible_set(
            object, &swappable_reducible_set));
    return INVOKE_SWAPPABLE_REDUCIBLE_SET(swappable_reducible_set)
            ->as_ordered_reducible_set(swappable_reducible_set, out);
}
...
as_ordered_settable_set(
    ...
    assert(object);
    assert(out);
    struct butterflyfish_swappable_settable_set_i *swappable_settable_set;
    seagrass_required_true(!as_swappable_settable_set(
            object, &swappable_settable_set));
    return INVOKE_SWAPPABLE_SETTABLE_SET(swappable_settable_set)
        ->as_ordered_settable_set(swappable_settable_set, out);
}
...
as_settable_reducible_set(
    ...
    return INVOKE_ORDERED_SETTABLE_REDUCIBLE_SET(ordered_settable_reducible_set)
        ->as_settable_reducible_set(ordered_settable_reducible_set, out);
}
...
as_ordered_set(
    ...
    assert(out);
    struct butterflyfish_swappable_set_i *swappable_set;
    seagrass_required_true(!as_swappable_set((void *) object, &swappable_set));
    return INVOKE_SWAPPABLE_SET(swappable_set)
        ->as_ordered_set(swappable_set, out);
}
...
as_reducible_set(
    ...
    assert(object);
    assert(out);
    struct butterflyfish_ordered_reducible_set_i *ordered_reducible_set;
...
as_ordered(
    ...
    seagrass_required_true(!as_swappable((void *) object, &swappable));
    return INVOKE_SWAPPABLE(swappable)->as_ordered(swappable, out);
}

static inline int
as_set(const struct butterflyfish_swappable_settable_reducible_set_i
            *const object,
...
static inline int
as_removable(struct butterflyfish_swappable_settable_reducible_set_i
                *const object,
    ...
    return INVOKE_REDUCIBLE_SET(reducible_set)->as_removable(
            reducible_set, out);
}

static inline int
as_settable(struct butterflyfish_swappable_settable_reducible_set_i
                *const object,
...
static inline int
as_collection(const struct butterflyfish_swappable_settable_reducible_set_i
                *const object,
...
#pragma mark swappable_settable_reducible_set_i -
...
butterflyfish_swappable_settable_reducible_set_i_as_swappable_reducible_set(
    ...
    return as_swappable_reducible_set(object, out);
}
...
butterflyfish_swappable_settable_reducible_set_i_as_swappable_settable_set(
    ...
    return as_swappable_settable_set(object, out);
}
