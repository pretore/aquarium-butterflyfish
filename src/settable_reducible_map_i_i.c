...
static inline int
as_settable_map(struct butterflyfish_settable_reducible_map_i_i *const object,
...
static inline int
as_reducible_map(struct butterflyfish_settable_reducible_map_i_i *const object,
...
static inline int
as_map(const struct butterflyfish_settable_reducible_map_i_i *const object,
...
static inline int
as_removable(
        const struct butterflyfish_settable_reducible_map_i_i *const object,
...
static inline int
as_settable(struct butterflyfish_settable_reducible_map_i_i *const object,
...
static inline int
as_set(const struct butterflyfish_settable_reducible_map_i_i *const object,
...
static inline int
as_stream(const struct butterflyfish_settable_reducible_map_i_i *const object,
...
int butterflyfish_settable_reducible_map_i_i_first(
    ...
    if (!object) {
        return BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_OBJECT_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_settable_reducible_map_i_i_next(
    ...
    if (!item) {
        return BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_ITEM_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_settable_reducible_map_i_i_remove_entry(
    ...
    if (!entry) {
        return BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_ENTRY_IS_NULL;
    }
...
int butterflyfish_settable_reducible_map_i_i_remove_all_entries(
    ...
    if (!other) {
        return BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_OTHER_IS_NULL;
    }
    struct butterflyfish_removable_i_i *removable;
    seagrass_required_true(!as_removable(object, &removable));
...
int butterflyfish_settable_reducible_map_i_i_contains_key(
    ...
    if (!key) {
        return BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_KEY_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_settable_reducible_map_i_i_contains_value(
    ...
    if (!value) {
        return BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_VALUE_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_OUT_IS_NULL;
    }
...
#pragma mark settable_reducible_map_i_i -
