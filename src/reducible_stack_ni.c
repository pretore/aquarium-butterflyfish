...
#define INVOKABLE   (*(struct butterflyfish_reducible_stack_ni **) object)

#pragma mark stream_ni -

int butterflyfish_reducible_stack_ni_first(
        const struct butterflyfish_reducible_stack_ni *const object,
        const uintmax_t **const out) {
    if (!object) {
        return BUTTERFLYFISH_REDUCIBLE_STACK_NI_ERROR_OBJECT_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_REDUCIBLE_STACK_NI_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_reducible_stack_ni_next(
    ...
    if (!item) {
        return BUTTERFLYFISH_REDUCIBLE_STACK_NI_ERROR_ITEM_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_REDUCIBLE_STACK_NI_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_reducible_stack_ni_pop(
        struct butterflyfish_reducible_stack_ni *const object,
        uintmax_t *const out) {
    if (!object) {
        return BUTTERFLYFISH_REDUCIBLE_STACK_NI_ERROR_OBJECT_IS_NULL;
    }
