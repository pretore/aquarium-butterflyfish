...
static inline int
as_settable_list(struct butterflyfish_mutable_list_i_i *const object,
...
static inline int
as_incremental_list(struct butterflyfish_mutable_list_i_i *const object,
...
static inline int
as_reducible_list(struct butterflyfish_mutable_list_i_i *const object,
                  struct butterflyfish_reducible_list_i_i **const out) {
    assert(object);
    assert(out);
    struct butterflyfish_settable_reducible_list_i_i *settable_reducible_list;
...
static inline int
as_settable(struct butterflyfish_mutable_list_i_i *const object,
...
static inline int
as_list(const struct butterflyfish_mutable_list_i_i *const object,
...
static inline int
as_addable(const struct butterflyfish_mutable_list_i_i *const object,
...
static inline int
as_removable(const struct butterflyfish_mutable_list_i_i *const object,
...
static inline int
as_collection(const struct butterflyfish_mutable_list_i_i *const object,
...
static inline int
as_stream(const struct butterflyfish_mutable_list_i_i *const object,
...
int butterflyfish_mutable_list_i_i_first(
        const struct butterflyfish_mutable_list_i_i *const object,
        const struct butterflyfish_map_i_i_entry **const out) {
    if (!object) {
        return BUTTERFLYFISH_MUTABLE_LIST_I_I_ERROR_OBJECT_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_MUTABLE_LIST_I_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_mutable_list_i_i_next(
    ...
    if (!item) {
        return BUTTERFLYFISH_MUTABLE_LIST_I_I_ERROR_ITEM_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_MUTABLE_LIST_I_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_mutable_list_i_i_set_item(
    ...
    if (!value) {
        return BUTTERFLYFISH_MUTABLE_LIST_I_I_ERROR_VALUE_IS_NULL;
    }
...
int butterflyfish_mutable_list_i_i_add_all(
    ...
    if (!other) {
        return BUTTERFLYFISH_MUTABLE_LIST_I_I_ERROR_OTHER_IS_NULL;
    }
    struct butterflyfish_addable_i_i *addable;
    seagrass_required_true(!as_addable(object, &addable));
