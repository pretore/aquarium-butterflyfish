...
#define INVOKE(x)               (*(struct butterflyfish_settable_list_i **) x)
...
static inline int
as_list(const struct butterflyfish_settable_list_i *const object,
...
static inline int
as_settable(struct butterflyfish_settable_list_i *const object,
...
static inline int
as_collection(const struct butterflyfish_settable_list_i *const object,
...
static inline int
as_stream(const struct butterflyfish_settable_list_i *const object,
...
int butterflyfish_settable_list_i_first(
    ...
    if (!out) {
        return BUTTERFLYFISH_SETTABLE_LIST_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_settable_list_i_next(
    ...
    if (!item) {
        return BUTTERFLYFISH_SETTABLE_LIST_I_ERROR_ITEM_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SETTABLE_LIST_I_ERROR_OUT_IS_NULL;
    }
