...
#define INVOKE(x)               (*(struct butterflyfish_settable_set_i_i **) x)
...
static inline int
as_set(const struct butterflyfish_settable_set_i_i *const object,
...
static inline int
as_settable(struct butterflyfish_settable_set_i_i *const object,
...
static inline int
as_collection(const struct butterflyfish_settable_set_i_i *const object,
...
static inline int
as_stream(const struct butterflyfish_settable_set_i_i *const object,
