...
static inline int
as_ordered(const struct butterflyfish_ordered_settable_reducible_list_i
            *const object,
...
static inline int
as_list(const struct butterflyfish_ordered_settable_reducible_list_i
            *const object,
...
static inline int
as_collection(const struct butterflyfish_ordered_settable_reducible_list_i
                *const object,
...
static inline int
as_stream(const struct butterflyfish_ordered_settable_reducible_list_i
                *const object,
...
#pragma mark ordered_settable_reducible_list_i -
