...
static inline int
as_stream(const struct butterflyfish_unordered_i_i *const object,
...
int butterflyfish_unordered_i_i_first(
        const struct butterflyfish_unordered_i_i *const object,
        const struct butterflyfish_map_i_i_entry **const out) {
    if (!object) {
        return BUTTERFLYFISH_UNORDERED_I_I_ERROR_OBJECT_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_UNORDERED_I_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_unordered_i_i_next(
        const struct butterflyfish_unordered_i_i *const object,
    ...
    if (!item) {
        return BUTTERFLYFISH_UNORDERED_I_I_ERROR_ITEM_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_UNORDERED_I_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_unordered_i_i_count(
        const struct butterflyfish_unordered_i_i *const object,
        uintmax_t *const out) {
    if (!object) {
        return BUTTERFLYFISH_UNORDERED_I_I_ERROR_OBJECT_IS_NULL;
...
int butterflyfish_unordered_i_i_last(
        const struct butterflyfish_unordered_i_i *const object,
        const struct butterflyfish_map_i_i_entry **const out) {
    if (!object) {
        return BUTTERFLYFISH_UNORDERED_I_I_ERROR_OBJECT_IS_NULL;
...
int butterflyfish_unordered_i_i_prev(
        const struct butterflyfish_unordered_i_i *const object,
        const struct butterflyfish_map_i_i_entry *const item,
        const struct butterflyfish_map_i_i_entry **const out) {
    if (!object) {
...
#pragma mark unordered_i_i -

int butterflyfish_unordered_i_i_as_stream(
        const struct butterflyfish_unordered_i_i *const object,
        const struct butterflyfish_stream_i_i **const out) {
    if (!object) {
        return BUTTERFLYFISH_UNORDERED_I_I_ERROR_OBJECT_IS_NULL;
...
int butterflyfish_unordered_i_i_as_collection(
        const struct butterflyfish_unordered_i_i *const object,
        const struct butterflyfish_collection_i_i **const out) {
    if (!object) {
        return BUTTERFLYFISH_UNORDERED_I_I_ERROR_OBJECT_IS_NULL;
