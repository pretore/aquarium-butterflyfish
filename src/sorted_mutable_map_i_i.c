...
#define INVOKE(x) \
    (*(struct butterflyfish_sorted_mutable_map_i_i **) x)
#define INVOKE_MUTABLE_MAP(x) \
    (*(struct butterflyfish_mutable_map_i_i **) x)
#define INVOKE_SORTED_SETTABLE_REDUCIBLE_MAP(x) \
    (*(struct butterflyfish_sorted_settable_reducible_map_i_i **) x)
#define INVOKE_SORTED_SETTABLE_INCREMENTAL_MAP(x) \
    (*(struct butterflyfish_sorted_settable_incremental_map_i_i **) x)
...
#define INVOKE_SETTABLE_INCREMENTAL_MAP(x) \
...
#define INVOKE_SORTED_INCREMENTAL_MAP(x) \
    (*(struct butterflyfish_sorted_incremental_map_i_i **) x)
...
as_sorted_settable_incremental_map(
    ...
    assert(object);
    assert(out);
    return INVOKE(object)->as_sorted_settable_incremental_map(object, out);
}
...
as_sorted_settable_reducible_map(
    ...
    assert(object);
    assert(out);
    return INVOKE(object)->as_sorted_settable_reducible_map(object, out);
}

static inline int
as_mutable_map(struct butterflyfish_sorted_mutable_map_i_i *const object,
               struct butterflyfish_mutable_map_i_i **const out) {
    assert(object);
    assert(out);
    return INVOKE(object)->as_mutable_map(object, out);
}
...
as_sorted_reducible_map(
    ...
    assert(object);
    assert(out);
    struct butterflyfish_sorted_settable_reducible_map_i_i *map;
    seagrass_required_true(!as_sorted_settable_reducible_map(object, &map));
    return INVOKE_SORTED_SETTABLE_REDUCIBLE_MAP(map)
        ->as_sorted_reducible_map(map, out);
}
...
as_sorted_incremental_map(
    ...
    assert(object);
    assert(out);
    struct butterflyfish_sorted_settable_incremental_map_i_i *map;
    seagrass_required_true(!as_sorted_settable_incremental_map(object, &map));
    return INVOKE_SORTED_SETTABLE_INCREMENTAL_MAP(map)
        ->as_sorted_incremental_map(map, out);
}
...
as_settable_reducible_map(
    ...
    seagrass_required_true(!as_sorted_settable_reducible_map(object, &map));
    return INVOKE_SORTED_SETTABLE_REDUCIBLE_MAP(map)
        ->as_settable_reducible_map(map, out);
}
...
as_settable_incremental_map(
    ...
    seagrass_required_true(!as_sorted_settable_incremental_map(object, &map));
    return INVOKE_SORTED_SETTABLE_INCREMENTAL_MAP(map)
        ->as_settable_incremental_map(map, out);
}
...
as_sorted_settable_map(
    ...
    seagrass_required_true(!as_sorted_settable_incremental_map(object, &map));
    return INVOKE_SORTED_SETTABLE_INCREMENTAL_MAP(map)
        ->as_sorted_settable_map(map, out);
}

static inline int
as_settable_map(struct butterflyfish_sorted_mutable_map_i_i *const object,
...
static inline int
as_sorted_map(const struct butterflyfish_sorted_mutable_map_i_i *const object,
...
static inline int
as_reducible_map(struct butterflyfish_sorted_mutable_map_i_i *const object,
...
static inline int
as_incremental_map(struct butterflyfish_sorted_mutable_map_i_i *const object,
                   struct butterflyfish_incremental_map_i_i **const out) {
    assert(object);
    assert(out);
    struct butterflyfish_sorted_incremental_map_i_i *sorted_incremental_map;
    seagrass_required_true(!as_sorted_incremental_map(
            object, &sorted_incremental_map));
    return INVOKE_SORTED_INCREMENTAL_MAP(sorted_incremental_map)
            ->as_incremental_map(sorted_incremental_map, out);
}

static inline int
as_map(const struct butterflyfish_sorted_mutable_map_i_i *const object,
    ...
    return INVOKE_SORTED_MAP(sorted_map)->as_map(sorted_map, out);
}

static inline int
as_sorted(const struct butterflyfish_sorted_mutable_map_i_i *const object,
...
static inline int
as_removable(struct butterflyfish_sorted_mutable_map_i_i *const object,
...
static inline int
as_addable(struct butterflyfish_sorted_mutable_map_i_i *const object,
...
static inline int
as_settable(struct butterflyfish_sorted_mutable_map_i_i *const object,
...
static inline int
as_set(const struct butterflyfish_sorted_mutable_map_i_i *const object,
...
static inline int
as_collection(const struct butterflyfish_sorted_mutable_map_i_i *const object,
...
static inline int
as_stream(const struct butterflyfish_sorted_mutable_map_i_i *const object,
...
int butterflyfish_sorted_mutable_map_i_i_first(
        const struct butterflyfish_sorted_mutable_map_i_i *const object,
        const struct butterflyfish_map_i_i_entry **const out) {
    if (!object) {
        return BUTTERFLYFISH_SORTED_MUTABLE_MAP_I_I_ERROR_OBJECT_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SORTED_MUTABLE_MAP_I_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_sorted_mutable_map_i_i_next(
    ...
    if (!item) {
        return BUTTERFLYFISH_SORTED_MUTABLE_MAP_I_I_ERROR_ITEM_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SORTED_MUTABLE_MAP_I_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_sorted_mutable_map_i_i_remove_entry(
    ...
    if (!entry) {
        return BUTTERFLYFISH_SORTED_MUTABLE_MAP_I_I_ERROR_ENTRY_IS_NULL;
    }
...
int butterflyfish_sorted_mutable_map_i_i_remove_all_entries(
    ...
    if (!other) {
        return BUTTERFLYFISH_SORTED_MUTABLE_MAP_I_I_ERROR_OTHER_IS_NULL;
    }
    struct butterflyfish_removable_i_i *removable;
    seagrass_required_true(!as_removable(object, &removable));
...
int butterflyfish_sorted_mutable_map_i_i_contains_key(
    ...
    if (!key) {
        return BUTTERFLYFISH_SORTED_MUTABLE_MAP_I_I_ERROR_KEY_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SORTED_MUTABLE_MAP_I_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_sorted_mutable_map_i_i_contains_value(
    ...
    if (!value) {
        return BUTTERFLYFISH_SORTED_MUTABLE_MAP_I_I_ERROR_VALUE_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SORTED_MUTABLE_MAP_I_I_ERROR_OUT_IS_NULL;
    }
...
#pragma mark sorted_mutable_map_i_i -
...
int butterflyfish_sorted_mutable_map_i_i_as_sorted_incremental_map(
    ...
    return as_sorted_incremental_map(object, out);
}
...
int butterflyfish_sorted_mutable_map_i_i_as_settable_incremental_map(
    ...
    return as_settable_incremental_map(object, out);
}
...
int butterflyfish_sorted_mutable_map_i_i_as_sorted_settable_incremental_map(
    ...
    return as_sorted_settable_incremental_map(object, out);
}
...
int butterflyfish_sorted_mutable_map_i_i_as_sorted_settable_reducible_map(
    ...
    return as_sorted_settable_reducible_map(object, out);
}
...
int butterflyfish_sorted_mutable_map_i_i_as_mutable_map(
    ...
    return as_mutable_map(object, out);
}
