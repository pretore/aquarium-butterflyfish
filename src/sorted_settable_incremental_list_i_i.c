...
#define INVOKE(x) \
    (*(struct butterflyfish_sorted_settable_incremental_list_i_i **) x)
...
as_incremental_list(
    ...
    assert(object);
    assert(out);
    struct butterflyfish_sorted_incremental_list_i_i *sorted_incremental_list;
...
as_settable_list(
    ...
    assert(object);
    assert(out);
    struct butterflyfish_sorted_settable_list_i_i *sorted_settable_list;
...
static inline int
as_addable(struct butterflyfish_sorted_settable_incremental_list_i_i
            *const object,
...
static inline int
as_settable(struct butterflyfish_sorted_settable_incremental_list_i_i
                *const object,
...
static inline int
as_list(const struct butterflyfish_sorted_settable_incremental_list_i_i
                *const object,
...
static inline int
as_sorted(const struct butterflyfish_sorted_settable_incremental_list_i_i
                *const object,
...
static inline int
as_collection(const struct butterflyfish_sorted_settable_incremental_list_i_i
                    *const object,
...
static inline int
as_stream(const struct butterflyfish_sorted_settable_incremental_list_i_i
            *const object,
...
#pragma mark sorted_settable_incremental_list_i_i -
