...
static inline int
as_addable(struct butterflyfish_incremental_list_i_i *const object,
...
static inline int
as_list(const struct butterflyfish_incremental_list_i_i *const object,
...
static inline int
as_collection(const struct butterflyfish_incremental_list_i_i *const object,
...
static inline int
as_stream(const struct butterflyfish_incremental_list_i_i *const object,
...
int butterflyfish_incremental_list_i_i_first(
    ...
    if (!object) {
        return BUTTERFLYFISH_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_INCREMENTAL_LIST_I_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_incremental_list_i_i_next(
    ...
    if (!item) {
        return BUTTERFLYFISH_INCREMENTAL_LIST_I_I_ERROR_ITEM_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_INCREMENTAL_LIST_I_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_incremental_list_i_i_add(
    ...
    if (!value) {
        return BUTTERFLYFISH_INCREMENTAL_LIST_I_I_ERROR_VALUE_IS_NULL;
    }
...
int butterflyfish_incremental_list_i_i_add_all(
    ...
    if (!other) {
        return BUTTERFLYFISH_INCREMENTAL_LIST_I_I_ERROR_OTHER_IS_NULL;
    }
    struct butterflyfish_addable_i_i *addable;
    seagrass_required_true(!as_addable(object, &addable));
...
#pragma mark incremental_list_i_i -
