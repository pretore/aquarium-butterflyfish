...
#define INVOKE(x)               (*(struct butterflyfish_ordered_set_i_i **) x)
...
static inline int
as_set(const struct butterflyfish_ordered_set_i_i *const object,
...
static inline int
as_ordered(const struct butterflyfish_ordered_set_i_i *const object,
...
static inline int
as_collection(const struct butterflyfish_ordered_set_i_i *const object,
...
static inline int
as_stream(const struct butterflyfish_ordered_set_i_i *const object,
...
int butterflyfish_ordered_set_i_i_first(
        const struct butterflyfish_ordered_set_i_i *const object,
        const struct butterflyfish_map_i_i_entry **const out) {
    if (!object) {
        return BUTTERFLYFISH_ORDERED_SET_I_I_ERROR_OBJECT_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_ORDERED_SET_I_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_ordered_set_i_i_next(
    ...
    if (!item) {
        return BUTTERFLYFISH_ORDERED_SET_I_I_ERROR_ITEM_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_ORDERED_SET_I_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_ordered_set_i_i_contains(
    ...
    if (!value) {
        return BUTTERFLYFISH_ORDERED_SET_I_I_ERROR_VALUE_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_ORDERED_SET_I_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_ordered_set_i_i_contains_all(
    ...
    if (!other) {
        return BUTTERFLYFISH_ORDERED_SET_I_I_ERROR_OTHER_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_ORDERED_SET_I_I_ERROR_OUT_IS_NULL;
    }
