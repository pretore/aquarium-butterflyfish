...
static inline int
as_settable_set(struct butterflyfish_mutable_set_i *const object,
...
static inline int
as_incremental_set(struct butterflyfish_mutable_set_i *const object,
...
static inline int
as_reducible_set(struct butterflyfish_mutable_set_i *const object,
                 struct butterflyfish_reducible_set_i **const out) {
    assert(object);
    assert(out);
    struct butterflyfish_settable_reducible_set_i *settable_reducible_set;
...
static inline int
as_set(const struct butterflyfish_mutable_set_i *const object,
...
static inline int
as_settable(struct butterflyfish_mutable_set_i *const object,
...
static inline int
as_addable(struct butterflyfish_mutable_set_i *const object,
...
static inline int
as_removable(struct butterflyfish_mutable_set_i *const object,
...
static inline int
as_collection(const struct butterflyfish_mutable_set_i *const object,
...
static inline int
as_stream(const struct butterflyfish_mutable_set_i *const object,
...
int butterflyfish_mutable_set_i_first(
        const struct butterflyfish_mutable_set_i *const object,
        const struct sea_turtle_integer **const out) {
    if (!object) {
        return BUTTERFLYFISH_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_MUTABLE_SET_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_mutable_set_i_next(
    ...
    if (!item) {
        return BUTTERFLYFISH_MUTABLE_SET_I_ERROR_ITEM_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_MUTABLE_SET_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_mutable_set_i_set_item(
    ...
    if (!value) {
        return BUTTERFLYFISH_MUTABLE_SET_I_ERROR_VALUE_IS_NULL;
    }
...
int butterflyfish_mutable_set_i_contains_all(
    ...
    if (!other) {
        return BUTTERFLYFISH_MUTABLE_SET_I_ERROR_OTHER_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_MUTABLE_SET_I_ERROR_OUT_IS_NULL;
    }
