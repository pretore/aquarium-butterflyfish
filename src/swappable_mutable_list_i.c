...
#define INVOKE(x) \
    (*(struct butterflyfish_swappable_mutable_list_i **) x)
#define INVOKE_SWAPPABLE_SETTABLE_INCREMENTAL_LIST(x) \
    (*(struct butterflyfish_swappable_settable_incremental_list_i **) x)
#define INVOKE_SWAPPABLE_SETTABLE_REDUCIBLE_LIST(x) \
    (*(struct butterflyfish_swappable_settable_reducible_list_i **) x)
#define INVOKE_SWAPPABLE_SETTABLE_LIST(x) \
    (*(struct butterflyfish_swappable_settable_list_i **) x)
#define INVOKE_SWAPPABLE_INCREMENTAL_LIST(x) \
    (*(struct butterflyfish_swappable_incremental_list_i **) x)
#define INVOKE_SWAPPABLE_REDUCIBLE_LIST(x) \
    (*(struct butterflyfish_swappable_reducible_list_i **) x)
#define INVOKE_ORDERED_MUTABLE_LIST(x) \
...
#define INVOKE_SWAPPABLE_LIST(x) \
    (*(struct butterflyfish_swappable_list_i **) x)
#define INVOKE_ORDERED_LIST(x)  \
    (*(struct butterflyfish_ordered_list_i **) x)
#define INVOKE_SETTABLE_INCREMENTAL_LIST(x) \
    (*(struct struct butterflyfish_settable_incremental_list_i **) x)
#define INVOKE_SETTABLE_REDUCIBLE_LIST(x) \
    (*(struct struct butterflyfish_settable_reducible_list_i **) x)
...
#define INVOKE_SWAPPABLE(x)     (*(struct butterflyfish_swappable_i **) x)
...
as_swappable_settable_incremental_list(
    ...
    assert(object);
    assert(out);
    return INVOKE(object)->as_swappable_settable_incremental_list(object, out);
}
...
as_swappable_settable_reducible_list(
    ...
    assert(object);
    assert(out);
    return INVOKE(object)->as_swappable_settable_reducible_list(object, out);
}
...
as_ordered_mutable_list(
    ...
    assert(object);
    assert(out);
    return INVOKE(object)->as_ordered_mutable_list(object, out);
}
...
as_swappable_settable_list(
    ...
    seagrass_required_true(!as_swappable_settable_incremental_list(
            object, &swappable_settable_incremental_list));
    return INVOKE_SWAPPABLE_SETTABLE_INCREMENTAL_LIST(swappable_settable_incremental_list)
        ->as_swappable_settable_list(swappable_settable_incremental_list, out);
}
...
as_swappable_incremental_list(
    ...
    seagrass_required_true(!as_swappable_settable_incremental_list(
            object, &swappable_settable_incremental_list));
    return INVOKE_SWAPPABLE_SETTABLE_INCREMENTAL_LIST(swappable_settable_incremental_list)
            ->as_swappable_incremental_list(swappable_settable_incremental_list, out);
}
...
as_swappable_reducible_list(
    ...
    seagrass_required_true(!as_swappable_settable_reducible_list(
            object, &swappable_settable_reducible_list));
    return INVOKE_SWAPPABLE_SETTABLE_REDUCIBLE_LIST(swappable_settable_reducible_list)
            ->as_swappable_reducible_list(swappable_settable_reducible_list,
                                          out);
}
...
as_ordered_settable_incremental_list(
    ...
    assert(object);
    assert(out);
    struct butterflyfish_ordered_mutable_list_i *ordered_mutable_list;
    seagrass_required_true(!as_ordered_mutable_list(
            object, &ordered_mutable_list));
    return INVOKE_ORDERED_MUTABLE_LIST(ordered_mutable_list)
        ->as_ordered_settable_incremental_list(ordered_mutable_list, out);
}
...
as_ordered_settable_reducible_list(
    ...
    seagrass_required_true(!as_ordered_mutable_list(
            object, &ordered_mutable_list));
    return INVOKE_ORDERED_MUTABLE_LIST(ordered_mutable_list)
            ->as_ordered_settable_reducible_list(ordered_mutable_list, out);
}
...
as_mutable_list(
    ...
    seagrass_required_true(!as_ordered_mutable_list(
            object, &ordered_mutable_list));
    return INVOKE_ORDERED_MUTABLE_LIST(ordered_mutable_list)
        ->as_mutable_list(ordered_mutable_list, out);
}

static inline int
as_ordered_list(
        const struct butterflyfish_swappable_mutable_list_i *const object,
...
static inline int
as_settable_list(struct butterflyfish_swappable_mutable_list_i *const object,
...
as_swappable_list(
    ...
    assert(object);
    assert(out);
    struct butterflyfish_swappable_settable_list_i *swappable_settable_list;
    seagrass_required_true(!as_swappable_settable_list(
            object, &swappable_settable_list));
    return INVOKE_SWAPPABLE_SETTABLE_LIST(swappable_settable_list)
            ->as_swappable_list(swappable_settable_list, out);
}
...
static inline int
as_list(const struct butterflyfish_swappable_mutable_list_i *const object,
...
static inline int
as_removable(struct butterflyfish_swappable_mutable_list_i *const object,
...
static inline int
as_addable(struct butterflyfish_swappable_mutable_list_i *const object,
...
static inline int
as_swappable(struct butterflyfish_swappable_mutable_list_i *const object,
             struct butterflyfish_swappable_i **const out) {
    assert(object);
    assert(out);
    struct butterflyfish_swappable_list_i *swappable_list;
    seagrass_required_true(!as_swappable_list(object, &swappable_list));
    return INVOKE_SWAPPABLE_LIST(swappable_list)
        ->as_swappable(swappable_list, out);
}

static inline int
as_settable(struct butterflyfish_swappable_mutable_list_i *const object,
...
static inline int
as_ordered(const struct butterflyfish_swappable_mutable_list_i *const object,
...
static inline int
as_insertable(struct butterflyfish_swappable_mutable_list_i *const object,
...
static inline int
as_collection(const struct butterflyfish_swappable_mutable_list_i *const object,
...
static inline int
as_stream(const struct butterflyfish_swappable_mutable_list_i *const object,
...
int butterflyfish_swappable_mutable_list_i_first(
    ...
    if (!object) {
        return BUTTERFLYFISH_SWAPPABLE_MUTABLE_LIST_I_ERROR_OBJECT_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SWAPPABLE_MUTABLE_LIST_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_swappable_mutable_list_i_next(
    ...
    if (!item) {
        return BUTTERFLYFISH_SWAPPABLE_MUTABLE_LIST_I_ERROR_ITEM_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SWAPPABLE_MUTABLE_LIST_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_swappable_mutable_list_i_set_item(
    ...
    if (!value) {
        return BUTTERFLYFISH_SWAPPABLE_MUTABLE_LIST_I_ERROR_VALUE_IS_NULL;
    }
...
int butterflyfish_swappable_mutable_list_i_swap(
    ...
    if (!other) {
        return BUTTERFLYFISH_SWAPPABLE_MUTABLE_LIST_I_ERROR_OTHER_IS_NULL;
    }
...
int butterflyfish_swappable_mutable_list_i_as_swappable_list(
    ...
    return as_swappable_list(object, out);
}
...
int butterflyfish_swappable_mutable_list_i_as_ordered_settable_incremental_list(
        struct butterflyfish_swappable_mutable_list_i *const object,
        struct butterflyfish_ordered_settable_incremental_list_i **const out) {
    if (!object) {
        return BUTTERFLYFISH_SWAPPABLE_MUTABLE_LIST_I_ERROR_OBJECT_IS_NULL;
...
int butterflyfish_swappable_mutable_list_i_as_ordered_settable_reducible_list(
        struct butterflyfish_swappable_mutable_list_i *const object,
        struct butterflyfish_ordered_settable_reducible_list_i **const out) {
    if (!object) {
        return BUTTERFLYFISH_SWAPPABLE_MUTABLE_LIST_I_ERROR_OBJECT_IS_NULL;
...
int butterflyfish_swappable_mutable_list_i_as_swappable_settable_list(
    ...
    return as_swappable_settable_list(object, out);
}
...
int butterflyfish_swappable_mutable_list_i_as_swappable_incremental_list(
    ...
    return as_swappable_incremental_list(object, out);
}
...
int butterflyfish_swappable_mutable_list_i_as_swappable_reducible_list(
    ...
    return as_swappable_reducible_list(object, out);
}
...
butterflyfish_swappable_mutable_list_i_as_swappable_settable_incremental_list(
    ...
    return as_swappable_settable_incremental_list(object, out);
}
...
butterflyfish_swappable_mutable_list_i_as_swappable_settable_reducible_list(
    ...
    return as_swappable_settable_reducible_list(object, out);
}
...
int butterflyfish_swappable_mutable_list_i_as_ordered_mutable_list(
    ...
    return as_ordered_mutable_list(object, out);
}
