...
#define INVOKE(x) \
    (*(struct butterflyfish_sorted_reducible_list_i_i **) x)
#define INVOKE_SORTED_LIST(x) \
    (*(struct butterflyfish_sorted_list_i_i **) x)
...
static inline int
as_sorted_list(const struct butterflyfish_sorted_reducible_list_i_i *const object,
...
static inline int
as_reducible_list(struct butterflyfish_sorted_reducible_list_i_i *const object,
...
static inline int
as_removable(struct butterflyfish_sorted_reducible_list_i_i *const object,
...
static inline int
as_sorted(const struct butterflyfish_sorted_reducible_list_i_i *const object,
          const struct butterflyfish_sorted_i_i **const out) {
    assert(object);
    assert(out);
    const struct butterflyfish_sorted_list_i_i *sorted_list;
...
static inline int
as_list(const struct butterflyfish_sorted_reducible_list_i_i *const object,
...
static inline int
as_collection(const struct butterflyfish_sorted_reducible_list_i_i *const object,
...
static inline int
as_stream(const struct butterflyfish_sorted_reducible_list_i_i *const object,
...
int butterflyfish_sorted_reducible_list_i_i_first(
    ...
    if (!object) {
        return BUTTERFLYFISH_SORTED_REDUCIBLE_LIST_I_I_ERROR_OBJECT_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SORTED_REDUCIBLE_LIST_I_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_sorted_reducible_list_i_i_next(
    ...
    if (!item) {
        return BUTTERFLYFISH_SORTED_REDUCIBLE_LIST_I_I_ERROR_ITEM_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SORTED_REDUCIBLE_LIST_I_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_sorted_reducible_list_i_i_remove_all_items(
    ...
    if (!other) {
        return BUTTERFLYFISH_SORTED_REDUCIBLE_LIST_I_I_ERROR_OTHER_IS_NULL;
    }
    struct butterflyfish_removable_i_i *removable;
    seagrass_required_true(!as_removable(object, &removable));
...
int butterflyfish_sorted_reducible_list_i_i_ceiling(
    ...
    if (!value) {
        return BUTTERFLYFISH_SORTED_REDUCIBLE_LIST_I_I_ERROR_VALUE_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SORTED_REDUCIBLE_LIST_I_I_ERROR_OUT_IS_NULL;
    }
...
#pragma mark sorted_reducible_list_i_i -
