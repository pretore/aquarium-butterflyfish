...
static inline int
as_sorted_set(const struct butterflyfish_sorted_settable_incremental_set_i
                *const object,
...
static inline int
as_addable(struct butterflyfish_sorted_settable_incremental_set_i
                *const object,
...
static inline int
as_settable(struct butterflyfish_sorted_settable_incremental_set_i
                *const object,
...
static inline int
as_set(const struct butterflyfish_sorted_settable_incremental_set_i
        *const object,
...
static inline int
as_sorted(const struct butterflyfish_sorted_settable_incremental_set_i
            *const object,
...
static inline int
as_collection(const struct butterflyfish_sorted_settable_incremental_set_i
            *const object,
...
static inline int
as_stream(const struct butterflyfish_sorted_settable_incremental_set_i
            *const object,
...
#pragma mark sorted_settable_incremental_set_i -
