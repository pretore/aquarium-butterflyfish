...
int butterflyfish_list_s_as_stream(
        const struct butterflyfish_list_s *const object,
    ...
    *out = (const struct butterflyfish_stream_s *)
            &object->reducible_list_s.fixed_list_s.collection_s.stream_s;
    return 0;
}

int butterflyfish_list_s_as_collection(
        const struct butterflyfish_list_s *const object,
    ...
    *out = (const struct butterflyfish_collection_s *)
            &object->reducible_list_s.fixed_list_s.collection_s;
    return 0;
}

int butterflyfish_list_s_as_fixed_list(
        struct butterflyfish_list_s *const object,
        struct butterflyfish_fixed_list_s **const out) {
    if (!object) {
        return BUTTERFLYFISH_LIST_S_ERROR_OBJECT_IS_NULL;
    }
    if (!out) {
    ...
    *out = (struct butterflyfish_fixed_list_s *)
            &object->reducible_list_s.fixed_list_s;
    return 0;
}

int butterflyfish_list_s_as_reducible_list(
        struct butterflyfish_list_s *const object,
    ...
    *out = (struct butterflyfish_reducible_list_s *)
            &object->reducible_list_s;
    return 0;
}
