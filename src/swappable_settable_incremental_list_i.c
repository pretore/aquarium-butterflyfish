...
as_swappable_incremental_list(
    ...
    assert(object);
    assert(out);
    return INVOKE(object)->as_swappable_incremental_list(object, out);
}
...
as_settable_incremental_list(
    ...
    return INVOKE_ORDERED_SETTABLE_INCREMENTAL_LIST(ordered_settable_incremental_list)
        ->as_settable_incremental_list(ordered_settable_incremental_list, out);
}
...
as_ordered_incremental_list(
    ...
    seagrass_required_true(!as_swappable_incremental_list(
            object, &swappable_incremental_list));
    return INVOKE_SWAPPABLE_INCREMENTAL_LIST(swappable_incremental_list)
        ->as_ordered_incremental_list(swappable_incremental_list, out);
}
...
as_swappable_list(
    ...
    seagrass_required_true(!as_swappable_incremental_list(
            object, &swappable_incremental_list));
    return INVOKE_SWAPPABLE_INCREMENTAL_LIST(swappable_incremental_list)
        ->as_swappable_list(swappable_incremental_list, out);
}
...
as_ordered_list(
    ...
    struct butterflyfish_ordered_incremental_list_i *ordered_incremental_list;
    seagrass_required_true(!as_ordered_incremental_list(
            (void *) object, &ordered_incremental_list));
    return INVOKE_ORDERED_INCREMENTAL_LIST(ordered_incremental_list)
        ->as_ordered_list(ordered_incremental_list, out);
}
...
static inline int
as_list(const struct butterflyfish_swappable_settable_incremental_list_i
            *const object,
...
static inline int
as_ordered(const struct butterflyfish_swappable_settable_incremental_list_i
            *const object,
...
static inline int
as_stream(const struct butterflyfish_swappable_settable_incremental_list_i
                *const object,
...
#pragma mark swappable_settable_incremental_list_i -
