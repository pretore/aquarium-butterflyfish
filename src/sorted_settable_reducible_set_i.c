...
#define INVOKE_REMOVABLE(x) \
    (*(struct butterflyfish_removable_i **) x)
...
as_sorted_reducible_set(
    ...
    assert(object);
    assert(out);
    return INVOKE(object)->as_sorted_reducible_set(object, out);
}

static inline int
as_sorted_set(const struct butterflyfish_sorted_settable_reducible_set_i
                *const object,
...
static inline int
as_sorted(const struct butterflyfish_sorted_settable_reducible_set_i
                *const object,
...
static inline int
as_set(const struct butterflyfish_sorted_settable_reducible_set_i
            *const object,
    ...
    const struct butterflyfish_sorted_set_i *sorted_set;
    seagrass_required_true(!as_sorted_set(object, &sorted_set));
    return INVOKE_SORTED_SET(sorted_set)->as_set(sorted_set, out);
}

static inline int
as_settable(struct butterflyfish_sorted_settable_reducible_set_i *const object,
...
static inline int
as_removable(struct butterflyfish_sorted_settable_reducible_set_i *const object,
...
static inline int
as_collection(const struct butterflyfish_sorted_settable_reducible_set_i
                *const object,
...
static inline int
as_stream(const struct butterflyfish_sorted_settable_reducible_set_i
            *const object,
...
int butterflyfish_sorted_settable_reducible_set_i_first(
    ...
    if (!out) {
        return BUTTERFLYFISH_SORTED_SETTABLE_REDUCIBLE_SET_I_ERROR_OUT_IS_NULL;
    }
...
#pragma mark sorted_settable_reducible_set_i -
