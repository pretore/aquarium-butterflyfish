...
static inline int
as_addable(struct butterflyfish_incremental_map_i_i *const object,
...
static inline int
as_map(const struct butterflyfish_incremental_map_i_i *const object,
...
static inline int
as_set(const struct butterflyfish_incremental_map_i_i *const object,
...
static inline int
as_collection(const struct butterflyfish_incremental_map_i_i *const object,
...
static inline int
as_stream(const struct butterflyfish_incremental_map_i_i *const object,
...
int butterflyfish_incremental_map_i_i_next(
    ...
    if (!item) {
        return BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_ITEM_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_incremental_map_i_i_contains(
    ...
    if (!entry) {
        return BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_ENTRY_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_incremental_map_i_i_contains_all(
    ...
    if (!other) {
        return BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_OTHER_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL;
    }
