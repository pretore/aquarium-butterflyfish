...
static inline int
as_ordered_set(
        const struct butterflyfish_swappable_reducible_set_i *const object,
    ...
    seagrass_required_true(!as_ordered_reducible_set(
            (void *) object, &ordered_reducible_set));
    return INVOKE_ORDERED_REDUCIBLE_SET(ordered_reducible_set)
            ->as_ordered_set(ordered_reducible_set, out);
}

static inline int
as_reducible_set(struct butterflyfish_swappable_reducible_set_i *const object,
...
static inline int
as_removable(struct butterflyfish_swappable_reducible_set_i *const object,
...
static inline int
as_set(const struct butterflyfish_swappable_reducible_set_i *const object,
       const struct butterflyfish_set_i **const out) {
    assert(object);
    assert(out);
    struct butterflyfish_reducible_set_i *reducible_set;
    seagrass_required_true(!as_reducible_set(
            (void *) object, &reducible_set));
    return INVOKE_REDUCIBLE_SET(reducible_set)->as_set(reducible_set, out);
}

static inline int
as_swappable(struct butterflyfish_swappable_reducible_set_i *const object,
...
static inline int
as_ordered(const struct butterflyfish_swappable_reducible_set_i *const object,
...
static inline int
as_stream(const struct butterflyfish_swappable_reducible_set_i *const object,
...
int butterflyfish_swappable_reducible_set_i_first(
    ...
    if (!object) {
        return BUTTERFLYFISH_SWAPPABLE_REDUCIBLE_SET_I_ERROR_OBJECT_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SWAPPABLE_REDUCIBLE_SET_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_swappable_reducible_set_i_next(
    ...
    if (!item) {
        return BUTTERFLYFISH_SWAPPABLE_REDUCIBLE_SET_I_ERROR_ITEM_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SWAPPABLE_REDUCIBLE_SET_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_swappable_reducible_set_i_contains(
    ...
    if (!value) {
        return BUTTERFLYFISH_SWAPPABLE_REDUCIBLE_SET_I_ERROR_VALUE_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SWAPPABLE_REDUCIBLE_SET_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_swappable_reducible_set_i_contains_all(
    ...
    if (!other) {
        return BUTTERFLYFISH_SWAPPABLE_REDUCIBLE_SET_I_ERROR_OTHER_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SWAPPABLE_REDUCIBLE_SET_I_ERROR_OUT_IS_NULL;
    }
