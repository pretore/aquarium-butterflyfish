...
int butterflyfish_sorted_map_sr_sr_as_stream(
    ...
    *out = (const struct butterflyfish_stream_sr_sr *)
            &object->ordered_map_sr_sr.map_sr_sr.collection_sr_sr.stream_sr_sr;
    return 0;
}
...
int butterflyfish_sorted_map_sr_sr_as_collection(
    ...
    *out = (const struct butterflyfish_collection_sr_sr *)
            &object->ordered_map_sr_sr.map_sr_sr.collection_sr_sr;
    return 0;
}
...
int butterflyfish_sorted_map_sr_sr_as_map(
    ...
    *out = (struct butterflyfish_map_sr_sr *)
            &object->ordered_map_sr_sr.map_sr_sr;
    return 0;
}

int butterflyfish_sorted_map_sr_sr_as_ordered_map(
        struct butterflyfish_sorted_map_sr_sr *const object,
        struct butterflyfish_ordered_map_sr_sr **const out) {
    if (!object) {
        return BUTTERFLYFISH_SORTED_MAP_SR_SR_ERROR_OBJECT_IS_NULL;
    }
    if (!out) {
    ...
    *out = (struct butterflyfish_ordered_map_sr_sr *)
            &object->ordered_map_sr_sr;
    return 0;
}
