...
static inline int
as_insertable(struct butterflyfish_ordered_incremental_set_i_i *const object,
...
static inline int
as_set(const struct butterflyfish_ordered_incremental_set_i_i *const object,
       const struct butterflyfish_set_i_i **const out) {
    assert(object);
    assert(out);
    struct butterflyfish_incremental_set_i_i *incremental_set;
    seagrass_required_true(!as_incremental_set((void *) object,
            &incremental_set));
...
static inline int
as_ordered(const struct butterflyfish_ordered_incremental_set_i_i *const object,
...
static inline int
as_addable(struct butterflyfish_ordered_incremental_set_i_i *const object,
...
static inline int
as_stream(const struct butterflyfish_ordered_incremental_set_i_i *const object,
...
int butterflyfish_ordered_incremental_set_i_i_first(
    ...
    if (!object) {
        return BUTTERFLYFISH_ORDERED_INCREMENTAL_SET_I_I_ERROR_OBJECT_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_ORDERED_INCREMENTAL_SET_I_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_ordered_incremental_set_i_i_next(
    ...
    if (!item) {
        return BUTTERFLYFISH_ORDERED_INCREMENTAL_SET_I_I_ERROR_ITEM_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_ORDERED_INCREMENTAL_SET_I_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_ordered_incremental_set_i_i_contains(
    ...
    if (!value) {
        return BUTTERFLYFISH_ORDERED_INCREMENTAL_SET_I_I_ERROR_VALUE_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_ORDERED_INCREMENTAL_SET_I_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_ordered_incremental_set_i_i_contains_all(
    ...
    if (!other) {
        return BUTTERFLYFISH_ORDERED_INCREMENTAL_SET_I_I_ERROR_OTHER_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_ORDERED_INCREMENTAL_SET_I_I_ERROR_OUT_IS_NULL;
    }
...
#pragma mark ordered_incremental_set_i_i -
