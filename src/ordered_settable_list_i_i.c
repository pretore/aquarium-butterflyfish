...
static inline int
as_settable_list(struct butterflyfish_ordered_settable_list_i_i *const object,
...
static inline int
as_settable(struct butterflyfish_ordered_settable_list_i_i *const object,
...
static inline int
as_list(const struct butterflyfish_ordered_settable_list_i_i *const object,
...
static inline int
as_ordered(const struct butterflyfish_ordered_settable_list_i_i *const object,
...
static inline int
as_collection(const struct butterflyfish_ordered_settable_list_i_i *const object,
...
static inline int
as_stream(const struct butterflyfish_ordered_settable_list_i_i *const object,
...
int butterflyfish_ordered_settable_list_i_i_first(
    ...
    if (!object) {
        return BUTTERFLYFISH_ORDERED_SETTABLE_LIST_I_I_ERROR_OBJECT_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_ORDERED_SETTABLE_LIST_I_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_ordered_settable_list_i_i_next(
    ...
    if (!item) {
        return BUTTERFLYFISH_ORDERED_SETTABLE_LIST_I_I_ERROR_ITEM_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_ORDERED_SETTABLE_LIST_I_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_ordered_settable_list_i_i_set_item(
    ...
    if (!value) {
        return BUTTERFLYFISH_ORDERED_SETTABLE_LIST_I_I_ERROR_VALUE_IS_NULL;
    }
...
#pragma mark ordered_settable_list_i_i -
