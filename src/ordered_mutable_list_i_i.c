...
#define INVOKE(x) \
    (*(struct butterflyfish_ordered_mutable_list_i_i **) x)
...
#define INVOKE_ORDERED_SETTABLE_REDUCIBLE_LIST(x) \
    (*(struct butterflyfish_ordered_settable_reducible_list_i_i **) x)
...
#define INVOKE_MUTABLE_LIST(x) \
    (*(struct butterflyfish_mutable_list_i_i **) x)
...
#define INVOKE_SETTABLE_REDUCIBLE_LIST(x) \
    (*(struct butterflyfish_settable_reducible_list_i_i **) x)
...
static inline int
as_mutable_list(struct butterflyfish_ordered_mutable_list_i_i *const object,
...
static inline int
as_ordered_list(
        const struct butterflyfish_ordered_mutable_list_i_i *const object,
...
as_settable_incremental_list(
    ...
    assert(object);
    assert(out);
    struct butterflyfish_mutable_list_i_i *mutable_list;
...
static inline int
as_settable_list(struct butterflyfish_ordered_mutable_list_i_i *const object,
...
static inline int
as_incremental_list(struct butterflyfish_ordered_mutable_list_i_i *const object,
...
static inline int
as_reducible_list(struct butterflyfish_ordered_mutable_list_i_i *const object,
                  struct butterflyfish_reducible_list_i_i **const out) {
    assert(object);
    assert(out);
    struct butterflyfish_ordered_reducible_list_i_i *ordered_reducible_list;
...
static inline int
as_list(const struct butterflyfish_ordered_mutable_list_i_i *const object,
...
static inline int
as_removable(struct butterflyfish_ordered_mutable_list_i_i *const object,
...
static inline int
as_addable(struct butterflyfish_ordered_mutable_list_i_i *const object,
...
static inline int
as_settable(struct butterflyfish_ordered_mutable_list_i_i *const object,
...
static inline int
as_ordered(const struct butterflyfish_ordered_mutable_list_i_i *const object,
...
static inline int
as_insertable(struct butterflyfish_ordered_mutable_list_i_i *const object,
...
static inline int
as_collection(const struct butterflyfish_ordered_mutable_list_i_i *const object,
...
static inline int
as_stream(const struct butterflyfish_ordered_mutable_list_i_i *const object,
...
int butterflyfish_ordered_mutable_list_i_i_first(
    ...
    if (!object) {
        return BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OBJECT_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_ordered_mutable_list_i_i_next(
    ...
    if (!item) {
        return BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_ITEM_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_ordered_mutable_list_i_i_set_item(
    ...
    if (!value) {
        return BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_VALUE_IS_NULL;
    }
...
int butterflyfish_ordered_mutable_list_i_i_add_all(
    ...
    if (!other) {
        return BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OTHER_IS_NULL;
    }
    struct butterflyfish_addable_i_i *addable;
    seagrass_required_true(!as_addable(object, &addable));
