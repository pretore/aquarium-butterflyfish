...
static inline int
as_ordered_list(
        const struct butterflyfish_swappable_reducible_list_i *const object,
    ...
    seagrass_required_true(!as_ordered_reducible_list(
            (void *) object, &ordered_reducible_list));
    return INVOKE_ORDERED_REDUCIBLE_LIST(ordered_reducible_list)
        ->as_ordered_list(ordered_reducible_list, out);
}
...
static inline int
as_ordered(const struct butterflyfish_swappable_reducible_list_i *const object,
...
static inline int
as_removable(struct butterflyfish_swappable_reducible_list_i *const object,
...
static inline int
as_swappable(struct butterflyfish_swappable_reducible_list_i *const object,
...
static inline int
as_list(const struct butterflyfish_swappable_reducible_list_i *const object,
...
static inline int
as_stream(const struct butterflyfish_swappable_reducible_list_i *const object,
...
int butterflyfish_swappable_reducible_list_i_remove_item(
        ...
        const struct sea_turtle_integer *const item) {
    if (!object) {
        return BUTTERFLYFISH_SWAPPABLE_REDUCIBLE_LIST_I_ERROR_OBJECT_IS_NULL;
    }
    if (!item) {
        return BUTTERFLYFISH_SWAPPABLE_REDUCIBLE_LIST_I_ERROR_ITEM_IS_NULL;
    }
...
int butterflyfish_swappable_reducible_list_i_remove_all_items(
    ...
    if (!other) {
        return BUTTERFLYFISH_SWAPPABLE_REDUCIBLE_LIST_I_ERROR_OTHER_IS_NULL;
    }
    struct butterflyfish_removable_i *removable;
    seagrass_required_true(!as_removable(object, &removable));
...
int butterflyfish_swappable_reducible_list_i_get(
    ...
    if (!out) {
        return BUTTERFLYFISH_SWAPPABLE_REDUCIBLE_LIST_I_ERROR_OUT_IS_NULL;
    }
    const struct butterflyfish_list_i *list;
    seagrass_required_true(!as_list(object, &list));
...
#pragma mark swappable_reducible_list_i -
