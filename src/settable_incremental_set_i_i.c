...
static inline int
as_settable_set(struct butterflyfish_settable_incremental_set_i_i *const object,
...
static inline int
as_settable(struct butterflyfish_settable_incremental_set_i_i *const object,
...
static inline int
as_set(const struct butterflyfish_settable_incremental_set_i_i *const object,
...
static inline int
as_addable(struct butterflyfish_settable_incremental_set_i_i *const object,
...
static inline int
as_collection(
        const struct butterflyfish_settable_incremental_set_i_i *const object,
...
static inline int
as_stream(const struct butterflyfish_settable_incremental_set_i_i *const object,
...
int butterflyfish_settable_incremental_set_i_i_first(
    ...
    if (!object) {
        return BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_I_I_ERROR_OBJECT_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_I_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_settable_incremental_set_i_i_next(
    ...
    if (!item) {
        return BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_I_I_ERROR_ITEM_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_I_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_settable_incremental_set_i_i_contains(
    ...
    if (!value) {
        return BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_I_I_ERROR_VALUE_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_I_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_settable_incremental_set_i_i_contains_all(
    ...
    if (!other) {
        return BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_I_I_ERROR_OTHER_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_I_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_settable_incremental_set_i_i_set_item(
    ...
    struct butterflyfish_settable_i_i *settable_i_i;
    seagrass_required_true(!as_settable(object, &settable_i_i));
    return INVOKE_SETTABLE(settable_i_i)->set_item(settable_i_i, item, value);
}
...
#pragma mark settable_incremental_set_i_i -
