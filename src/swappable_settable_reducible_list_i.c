...
as_swappable_settable_list(
    ...
    assert(object);
    assert(out);
    return INVOKE(object)->as_swappable_settable_list(object, out);
}
...
as_swappable_reducible_list(
    ...
    assert(object);
    assert(out);
    return INVOKE(object)->as_swappable_reducible_list(object, out);
}
...
as_settable_reducible_list(
    ...
    return INVOKE_ORDERED_SETTABLE_REDUCIBLE_LIST(ordered_settable_reducible_list)
        ->as_settable_reducible_list(ordered_settable_reducible_list, out);
}
...
as_ordered_settable_list(
    ...
    return INVOKE_SWAPPABLE_SETTABLE_LIST(swappable_settable_list)
        ->as_ordered_settable_list(swappable_settable_list, out);
}
...
as_ordered_reducible_list(
    ...
    assert(object);
    assert(out);
    struct butterflyfish_swappable_reducible_list_i *swappable_reducible_list;
    seagrass_required_true(!as_swappable_reducible_list(
            object, &swappable_reducible_list));
    return INVOKE_SWAPPABLE_REDUCIBLE_LIST(swappable_reducible_list)
        ->as_ordered_reducible_list(swappable_reducible_list, out);
}
...
as_swappable_list(
    ...
    seagrass_required_true(!as_swappable_reducible_list(
            object, &swappable_reducible_list));
    return INVOKE_SWAPPABLE_REDUCIBLE_LIST(swappable_reducible_list)
        ->as_swappable_list(swappable_reducible_list, out);
}
...
as_ordered_list(
    ...
    seagrass_required_true(!as_swappable_list(
            (void *) object, &swappable_list));
    return INVOKE_SWAPPABLE_LIST(swappable_list)
        ->as_ordered_list(swappable_list, out);
}

static inline int
as_swappable(struct butterflyfish_swappable_settable_reducible_list_i
                *const object,
...
static inline int
as_settable(struct butterflyfish_swappable_settable_reducible_list_i
                *const object,
...
static inline int
as_removable(struct butterflyfish_swappable_settable_reducible_list_i
                *const object,
...
static inline int
as_list(const struct butterflyfish_swappable_settable_reducible_list_i
            *const object,
    ...
    return INVOKE_ORDERED_LIST(ordered_list)->as_list(ordered_list, out);
}

static inline int
as_ordered(const struct butterflyfish_swappable_settable_reducible_list_i
                *const object,
...
static inline int
as_collection(const struct butterflyfish_swappable_settable_reducible_list_i
                *const object,
...
static inline int
as_stream(const struct butterflyfish_swappable_settable_reducible_list_i
                *const object,
...
#pragma mark swappable_settable_reducible_list_i -
