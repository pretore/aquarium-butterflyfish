...
#define INVOKE(x)               (*(struct butterflyfish_settable_map_i_i **) x)
...
static inline int
as_map(const struct butterflyfish_settable_map_i_i *const object,
...
static inline int
as_settable(struct butterflyfish_settable_map_i_i *const object,
...
static inline int
as_set(const struct butterflyfish_settable_map_i_i *const object,
...
static inline int
as_collection(const struct butterflyfish_settable_map_i_i *const object,
...
static inline int
as_stream(const struct butterflyfish_settable_map_i_i *const object,
...
int butterflyfish_settable_map_i_i_first(
    ...
    if (!out) {
        return BUTTERFLYFISH_SETTABLE_MAP_I_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_settable_map_i_i_next(
    ...
    if (!item) {
        return BUTTERFLYFISH_SETTABLE_MAP_I_I_ERROR_ITEM_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SETTABLE_MAP_I_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_settable_map_i_i_contains(
    ...
    if (!entry) {
        return BUTTERFLYFISH_SETTABLE_MAP_I_I_ERROR_ENTRY_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SETTABLE_MAP_I_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_settable_map_i_i_contains_all(
    ...
    if (!other) {
        return BUTTERFLYFISH_SETTABLE_MAP_I_I_ERROR_OTHER_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SETTABLE_MAP_I_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_settable_map_i_i_set_value(
    ...
    return INVOKE(object)->set_value(object, key, value);
}
...
int butterflyfish_settable_map_i_i_set_key(
    ...
    return INVOKE(object)->set_key(object, key, value);
}
...
int butterflyfish_settable_map_i_i_set_entry(
    ...
    return INVOKE(object)->set_entry(object, entry, value);
}
