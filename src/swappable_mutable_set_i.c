...
#define INVOKE(x) \
    (*(struct butterflyfish_swappable_mutable_set_i **) x)
#define INVOKE_SWAPPABLE_SETTABLE_INCREMENTAL_SET(x) \
    (*(struct butterflyfish_swappable_settable_incremental_set_i **) x)
#define INVOKE_SWAPPABLE_SETTABLE_REDUCIBLE_SET(x) \
...
#define INVOKE_ORDERED_MUTABLE_SET(x) \
    (*(struct butterflyfish_ordered_mutable_set_i **) x)
...
as_swappable_settable_incremental_set(
    ...
    assert(object);
    assert(out);
    return INVOKE(object)->as_swappable_settable_incremental_set(object, out);
}
...
as_swappable_settable_reducible_set(
    ...
    assert(object);
    assert(out);
    return INVOKE(object)->as_swappable_settable_reducible_set(object, out);
}
...
as_swappable_settable_set(
    ...
    assert(out);
    struct butterflyfish_swappable_settable_incremental_set_i
            *swappable_settable_incremental_set;
    seagrass_required_true(!as_swappable_settable_incremental_set(
            object, &swappable_settable_incremental_set));
    return INVOKE_SWAPPABLE_SETTABLE_INCREMENTAL_SET(swappable_settable_incremental_set)
        ->as_swappable_settable_set(swappable_settable_incremental_set, out);
}
...
as_swappable_incremental_set(
    ...
    seagrass_required_true(!as_swappable_settable_incremental_set(
            object, &swappable_settable_incremental_set));
    return INVOKE_SWAPPABLE_SETTABLE_INCREMENTAL_SET(swappable_settable_incremental_set)
        ->as_swappable_incremental_set(swappable_settable_incremental_set, out);
}
...
as_swappable_reducible_set(
    ...
    seagrass_required_true(!as_swappable_settable_reducible_set(
            object, &swappable_settable_reducible_set));
    return INVOKE_SWAPPABLE_SETTABLE_REDUCIBLE_SET(swappable_settable_reducible_set)
        ->as_swappable_reducible_set(swappable_settable_reducible_set, out);
}

static inline int
as_mutable_set(struct butterflyfish_swappable_mutable_set_i *const object,
               struct butterflyfish_mutable_set_i **const out) {
    assert(object);
    assert(out);
    struct butterflyfish_ordered_mutable_set_i *ordered_mutable_set;
    seagrass_required_true(!as_ordered_mutable_set(
            object, &ordered_mutable_set));
    return INVOKE_ORDERED_MUTABLE_SET(ordered_mutable_set)
            ->as_mutable_set(ordered_mutable_set, out);
}
...
as_ordered_settable_incremental_set(
    ...
    return INVOKE_SWAPPABLE_SETTABLE_INCREMENTAL_SET(swappable_settable_incremental_set)
        ->as_ordered_settable_incremental_set(
                swappable_settable_incremental_set, out);
}
...
as_ordered_settable_reducible_set(
    ...
    return INVOKE_SWAPPABLE_SETTABLE_REDUCIBLE_SET(swappable_settable_reducible_set)
        ->as_ordered_settable_reducible_set(
                swappable_settable_reducible_set, out);
}
...
as_ordered_incremental_set(
    ...
    return INVOKE_ORDERED_SETTABLE_INCREMENTAL_SET(ordered_settable_incremental_set)
            ->as_ordered_incremental_set(
                    ordered_settable_incremental_set, out);
}
...
as_swappable_set(
    ...
    return INVOKE_SWAPPABLE_SETTABLE_SET(swappable_settable_set)
            ->as_swappable_set(swappable_settable_set, out);
}

static inline int
as_ordered_set(
        const struct butterflyfish_swappable_mutable_set_i *const object,
...
static inline int
as_reducible_set(struct butterflyfish_swappable_mutable_set_i *const object,
...
static inline int
as_set(const struct butterflyfish_swappable_mutable_set_i *const object,
...
static inline int
as_swappable(struct butterflyfish_swappable_mutable_set_i *const object,
...
static inline int
as_ordered(const struct butterflyfish_swappable_mutable_set_i *const object,
...
static inline int
as_insertable(struct butterflyfish_swappable_mutable_set_i *const object,
...
static inline int
as_settable(struct butterflyfish_swappable_mutable_set_i *const object,
...
static inline int
as_removable(struct butterflyfish_swappable_mutable_set_i *const object,
...
static inline int
as_addable(struct butterflyfish_swappable_mutable_set_i *const object,
...
static inline int
as_collection(const struct butterflyfish_swappable_mutable_set_i *const object,
...
static inline int
as_stream(const struct butterflyfish_swappable_mutable_set_i *const object,
...
int butterflyfish_swappable_mutable_set_i_first(
    ...
    if (!object) {
        return BUTTERFLYFISH_SWAPPABLE_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SWAPPABLE_MUTABLE_SET_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_swappable_mutable_set_i_next(
    ...
    if (!item) {
        return BUTTERFLYFISH_SWAPPABLE_MUTABLE_SET_I_ERROR_ITEM_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SWAPPABLE_MUTABLE_SET_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_swappable_mutable_set_i_set_item(
    ...
    if (!value) {
        return BUTTERFLYFISH_SWAPPABLE_MUTABLE_SET_I_ERROR_VALUE_IS_NULL;
    }
...
int butterflyfish_swappable_mutable_set_i_swap(
    ...
    if (!other) {
        return BUTTERFLYFISH_SWAPPABLE_MUTABLE_SET_I_ERROR_OTHER_IS_NULL;
    }
...
#pragma mark swappable_mutable_set_i -
...
int butterflyfish_swappable_mutable_set_i_as_swappable_settable_incremental_set(
    ...
    return as_swappable_settable_incremental_set(object, out);
}
...
int butterflyfish_swappable_mutable_set_i_as_swappable_settable_reducible_set(
    ...
    return as_swappable_settable_reducible_set(object, out);
}
...
int butterflyfish_swappable_mutable_set_i_as_ordered_mutable_set(
    ...
    return as_ordered_mutable_set(object, out);
}
