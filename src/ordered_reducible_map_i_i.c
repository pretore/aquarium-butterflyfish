...
#define INVOKE_ORDERED_MAP(x)   (*(struct butterflyfish_ordered_map_i_i **) x)
...
static inline int
as_reducible_map(struct butterflyfish_ordered_reducible_map_i_i *const object,
...
static inline int
as_ordered(const struct butterflyfish_ordered_reducible_map_i_i *const object,
...
static inline int
as_removable(struct butterflyfish_ordered_reducible_map_i_i *const object,
...
static inline int
as_map(const struct butterflyfish_ordered_reducible_map_i_i *const object,
...
static inline int
as_set(const struct butterflyfish_ordered_reducible_map_i_i *const object,
...
static inline int
as_stream(const struct butterflyfish_ordered_reducible_map_i_i *const object,
...
int butterflyfish_ordered_reducible_map_i_i_first(
    ...
    if (!object) {
        return BUTTERFLYFISH_ORDERED_REDUCIBLE_MAP_I_I_ERROR_OBJECT_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_ORDERED_REDUCIBLE_MAP_I_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_ordered_reducible_map_i_i_next(
    ...
    if (!item) {
        return BUTTERFLYFISH_ORDERED_REDUCIBLE_MAP_I_I_ERROR_ITEM_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_ORDERED_REDUCIBLE_MAP_I_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_ordered_reducible_map_i_i_contains(
    ...
    if (!entry) {
        return BUTTERFLYFISH_ORDERED_REDUCIBLE_MAP_I_I_ERROR_ENTRY_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_ORDERED_REDUCIBLE_MAP_I_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_ordered_reducible_map_i_i_contains_all(
    ...
    if (!other) {
        return BUTTERFLYFISH_ORDERED_REDUCIBLE_MAP_I_I_ERROR_OTHER_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_ORDERED_REDUCIBLE_MAP_I_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_ordered_reducible_map_i_i_contains_key(
    ...
    if (!key) {
        return BUTTERFLYFISH_ORDERED_REDUCIBLE_MAP_I_I_ERROR_KEY_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_ORDERED_REDUCIBLE_MAP_I_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_ordered_reducible_map_i_i_contains_value(
    ...
    if (!value) {
        return BUTTERFLYFISH_ORDERED_REDUCIBLE_MAP_I_I_ERROR_VALUE_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_ORDERED_REDUCIBLE_MAP_I_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_ordered_reducible_map_i_i_remove_all(
    ...
    struct butterflyfish_reducible_map_i_i *reducible_map;
    seagrass_required_true(!as_reducible_map(object, &reducible_map));
    return INVOKE_REDUCIBLE_MAP(reducible_map)->remove_all(reducible_map, other);
}
...
int butterflyfish_ordered_reducible_map_i_i_retain_all(
    ...
    struct butterflyfish_reducible_map_i_i *reducible_map;
    seagrass_required_true(!as_reducible_map(object, &reducible_map));
    return INVOKE_REDUCIBLE_MAP(reducible_map)->retain_all(reducible_map, other);
}

#pragma mark ordered_reducible_map_i_i -
