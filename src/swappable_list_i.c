...
#define INVOKE(x)               (*(struct butterflyfish_swappable_list_i **) x)
...
static inline int
as_ordered_list(const struct butterflyfish_swappable_list_i *const object,
...
static inline int
as_swappable(struct butterflyfish_swappable_list_i *const object,
...
static inline int
as_list(const struct butterflyfish_swappable_list_i *const object,
...
static inline int
as_ordered(const struct butterflyfish_swappable_list_i *const object,
...
static inline int
as_collection(const struct butterflyfish_swappable_list_i *const object,
...
static inline int
as_stream(const struct butterflyfish_swappable_list_i *const object,
...
int butterflyfish_swappable_list_i_first(
    ...
    if (!out) {
        return BUTTERFLYFISH_SWAPPABLE_LIST_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_swappable_list_i_swap(
        struct butterflyfish_swappable_list_i *const object,
        const struct sea_turtle_integer *const item,
