...
static inline int
as_set(const struct butterflyfish_ordered_settable_incremental_set_i_i
        *const object,
...
static inline int
as_stream(const struct butterflyfish_ordered_settable_incremental_set_i_i
        *const object,
...
#pragma mark ordered_settable_incremental_set_i_i -
