...
#define INVOKE(x)               (*(struct butterflyfish_sorted_map_i_i **) x)
...
static inline int
as_map(const struct butterflyfish_sorted_map_i_i *const object,
...
static inline int
as_sorted(const struct butterflyfish_sorted_map_i_i *const object,
...
static inline int
as_set(const struct butterflyfish_sorted_map_i_i *const object,
...
static inline int
as_collection(const struct butterflyfish_sorted_map_i_i *const object,
...
static inline int
as_stream(const struct butterflyfish_sorted_map_i_i *const object,
...
int butterflyfish_sorted_map_i_i_next(
    ...
    if (!item) {
        return BUTTERFLYFISH_SORTED_MAP_I_I_ERROR_ITEM_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SORTED_MAP_I_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_sorted_map_i_i_contains(
        const struct butterflyfish_sorted_map_i_i *const object,
...
int butterflyfish_sorted_map_i_i_contains_all(
        const struct butterflyfish_sorted_map_i_i *const object,
...
int butterflyfish_sorted_map_i_i_contains_value(
        const struct butterflyfish_sorted_map_i_i *const object,
...
int butterflyfish_sorted_map_i_i_contains_all_values(
        const struct butterflyfish_sorted_map_i_i *const object,
        const struct butterflyfish_stream_i *const other,
        bool *const out) {
    if (!object) {
...
int butterflyfish_sorted_map_i_i_get_value(
        const struct butterflyfish_sorted_map_i_i *const object,
        const struct sea_turtle_integer *const key,
...
int butterflyfish_sorted_map_i_i_as_set(
        const struct butterflyfish_sorted_map_i_i *const object,
        const struct butterflyfish_set_i_i **const out) {
    if (!object) {
        return BUTTERFLYFISH_SORTED_MAP_I_I_ERROR_OBJECT_IS_NULL;
...
int butterflyfish_sorted_map_i_i_as_sorted(
        const struct butterflyfish_sorted_map_i_i *const object,
        const struct butterflyfish_sorted_i_i **const out) {
    if (!object) {
        return BUTTERFLYFISH_SORTED_MAP_I_I_ERROR_OBJECT_IS_NULL;
