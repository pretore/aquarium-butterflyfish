...
static inline int
as_swappable_list(struct butterflyfish_swappable_settable_list_i *const object,
                  struct butterflyfish_swappable_list_i **const out) {
    assert(object);
    assert(out);
    return INVOKE(object)->as_swappable_list(object, out);
}
...
static inline int
as_ordered_list(
        const struct butterflyfish_swappable_settable_list_i *const object,
...
static inline int
as_settable_list(struct butterflyfish_swappable_settable_list_i *const object,
...
static inline int
as_list(const struct butterflyfish_swappable_settable_list_i *const object,
...
static inline int
as_settable(struct butterflyfish_swappable_settable_list_i *const object,
...
static inline int
as_ordered(const struct butterflyfish_swappable_settable_list_i *const object,
...
static inline int
as_collection(const struct butterflyfish_swappable_settable_list_i *const object,
...
static inline int
as_stream(const struct butterflyfish_swappable_settable_list_i *const object,
...
int butterflyfish_swappable_settable_list_i_first(
    ...
    if (!object) {
        return BUTTERFLYFISH_SWAPPABLE_SETTABLE_LIST_I_ERROR_OBJECT_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SWAPPABLE_SETTABLE_LIST_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_swappable_settable_list_i_next(
    ...
    if (!item) {
        return BUTTERFLYFISH_SWAPPABLE_SETTABLE_LIST_I_ERROR_ITEM_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SWAPPABLE_SETTABLE_LIST_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_swappable_settable_list_i_swap(
    ...
    if (!other) {
        return BUTTERFLYFISH_SWAPPABLE_SETTABLE_LIST_I_ERROR_OTHER_IS_NULL;
    }
...
int butterflyfish_swappable_settable_list_i_set_item(
    ...
    if (!value) {
        return BUTTERFLYFISH_SWAPPABLE_SETTABLE_LIST_I_ERROR_VALUE_IS_NULL;
    }
...
#pragma mark swappable_settable_list_i -
