...
static inline int
as_ordered_map(const struct butterflyfish_ordered_settable_reducible_map_i_i
                    *const object,
               const struct butterflyfish_ordered_map_i_i **const out) {
    assert(object);
    assert(out);
    struct butterflyfish_ordered_reducible_map_i_i *ordered_reducible_map;
...
static inline int
as_settable_map(struct butterflyfish_ordered_settable_reducible_map_i_i
                    *const object,
                struct butterflyfish_settable_map_i_i **const out) {
    assert(object);
    assert(out);
    struct butterflyfish_settable_reducible_map_i_i *ordered_reducible_map;
...
static inline int
as_reducible_map(struct butterflyfish_ordered_settable_reducible_map_i_i
                    *const object,
                 struct butterflyfish_reducible_map_i_i **const out) {
    assert(object);
    assert(out);
    struct butterflyfish_settable_reducible_map_i_i *settable_reducible_map;
    seagrass_required_true(!as_settable_reducible_map(
...
static inline int
as_settable(struct butterflyfish_ordered_settable_reducible_map_i_i
                *const object,
...
static inline int
as_removable(struct butterflyfish_ordered_settable_reducible_map_i_i
                *const object,
...
static inline int
as_ordered(const struct butterflyfish_ordered_settable_reducible_map_i_i
                *const object,
...
static inline int
as_map(const struct butterflyfish_ordered_settable_reducible_map_i_i
            *const object,
...
static inline int
as_set(const struct butterflyfish_ordered_settable_reducible_map_i_i
            *const object,
...
static inline int
as_collection(const struct butterflyfish_ordered_settable_reducible_map_i_i
                *const object,
...
static inline int
as_stream(const struct butterflyfish_ordered_settable_reducible_map_i_i
            *const object,
...
#pragma mark ordered_settable_reducible_map_i_i -
