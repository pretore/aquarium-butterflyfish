...
static inline int
as_settable_map(struct butterflyfish_mutable_map_i_i *const object,
...
static inline int
as_incremental_map(struct butterflyfish_mutable_map_i_i *const object,
    ...
    seagrass_required_true(!as_settable_incremental_map(
            object, &settable_incremental_map));
    return INVOKE_SETTABLE_INCREMENTAL_MAP(settable_incremental_map)
        ->as_incremental_map(settable_incremental_map, out);
}

static inline int
as_reducible_map(struct butterflyfish_mutable_map_i_i *const object,
...
static inline int
as_map(const struct butterflyfish_mutable_map_i_i *const object,
       const struct butterflyfish_map_i_i **const out) {
    assert(object);
    assert(out);
    struct butterflyfish_settable_map_i_i *settable_map;
    seagrass_required_true(!as_settable_map(
            (void *) object, &settable_map));
    return INVOKE_SETTABLE_MAP(settable_map)->as_map(settable_map, out);
}

static inline int
as_addable(struct butterflyfish_mutable_map_i_i *const object,
...
static inline int
as_removable(struct butterflyfish_mutable_map_i_i *const object,
...
static inline int
as_settable(struct butterflyfish_mutable_map_i_i *const object,
...
static inline int
as_set(const struct butterflyfish_mutable_map_i_i *const object,
...
static inline int
as_collection(const struct butterflyfish_mutable_map_i_i *const object,
...
static inline int
as_stream(const struct butterflyfish_mutable_map_i_i *const object,
...
int butterflyfish_mutable_map_i_i_first(
        const struct butterflyfish_mutable_map_i_i *const object,
        const struct butterflyfish_map_i_i_entry **const out) {
    if (!object) {
        return BUTTERFLYFISH_MUTABLE_MAP_I_I_ERROR_OBJECT_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_MUTABLE_MAP_I_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_mutable_map_i_i_next(
        const struct butterflyfish_mutable_map_i_i *const object,
    ...
    if (!item) {
        return BUTTERFLYFISH_MUTABLE_MAP_I_I_ERROR_ITEM_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_MUTABLE_MAP_I_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_mutable_map_i_i_count(
        const struct butterflyfish_mutable_map_i_i *const object,
        uintmax_t *const out) {
    if (!object) {
        return BUTTERFLYFISH_MUTABLE_MAP_I_I_ERROR_OBJECT_IS_NULL;
...
int butterflyfish_mutable_map_i_i_last(
        const struct butterflyfish_mutable_map_i_i *const object,
        const struct butterflyfish_map_i_i_entry **const out) {
    if (!object) {
        return BUTTERFLYFISH_MUTABLE_MAP_I_I_ERROR_OBJECT_IS_NULL;
...
int butterflyfish_mutable_map_i_i_prev(
        const struct butterflyfish_mutable_map_i_i *const object,
        const struct butterflyfish_map_i_i_entry *const item,
        const struct butterflyfish_map_i_i_entry **const out) {
    if (!object) {
...
int butterflyfish_mutable_map_i_i_contains(
        const struct butterflyfish_mutable_map_i_i *const object,
    ...
    if (!entry) {
        return BUTTERFLYFISH_MUTABLE_MAP_I_I_ERROR_ENTRY_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_MUTABLE_MAP_I_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_mutable_map_i_i_contains_all(
        const struct butterflyfish_mutable_map_i_i *const object,
    ...
    if (!other) {
        return BUTTERFLYFISH_MUTABLE_MAP_I_I_ERROR_OTHER_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_MUTABLE_MAP_I_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_mutable_map_i_i_get(
        const struct butterflyfish_mutable_map_i_i *const object,
        const struct butterflyfish_map_i_i_entry *const entry,
        const struct butterflyfish_map_i_i_entry **const out) {
    if (!object) {
...
int butterflyfish_mutable_map_i_i_add(
        struct butterflyfish_mutable_map_i_i *const object,
        const struct butterflyfish_map_i_i_entry *const entry) {
    if (!object) {
        return BUTTERFLYFISH_MUTABLE_MAP_I_I_ERROR_OBJECT_IS_NULL;
...
int butterflyfish_mutable_map_i_i_add_all(
        struct butterflyfish_mutable_map_i_i *const object,
        const struct butterflyfish_stream_i_i *const other) {
    if (!object) {
        return BUTTERFLYFISH_MUTABLE_MAP_I_I_ERROR_OBJECT_IS_NULL;
...
int butterflyfish_mutable_map_i_i_remove_entry(
        struct butterflyfish_mutable_map_i_i *const object,
        const struct butterflyfish_map_i_i_entry *const entry) {
    if (!object) {
        return BUTTERFLYFISH_MUTABLE_MAP_I_I_ERROR_OBJECT_IS_NULL;
...
int butterflyfish_mutable_map_i_i_remove_all_entries(
        struct butterflyfish_mutable_map_i_i *const object,
        const struct butterflyfish_stream_i_i *const other) {
    if (!object) {
        return BUTTERFLYFISH_MUTABLE_MAP_I_I_ERROR_OBJECT_IS_NULL;
...
int butterflyfish_mutable_map_i_i_contains_key(
        const struct butterflyfish_mutable_map_i_i *const object,
    ...
    if (!key) {
        return BUTTERFLYFISH_MUTABLE_MAP_I_I_ERROR_KEY_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_MUTABLE_MAP_I_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_mutable_map_i_i_contains_value(
        const struct butterflyfish_mutable_map_i_i *const object,
    ...
    if (!value) {
        return BUTTERFLYFISH_MUTABLE_MAP_I_I_ERROR_VALUE_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_MUTABLE_MAP_I_I_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_mutable_map_i_i_contains_all_keys(
        const struct butterflyfish_mutable_map_i_i *const object,
...
int butterflyfish_mutable_map_i_i_contains_all_values(
        const struct butterflyfish_mutable_map_i_i *const object,
        const struct butterflyfish_stream_i *const other,
        bool *const out) {
    if (!object) {
...
int butterflyfish_mutable_map_i_i_get_value(
        const struct butterflyfish_mutable_map_i_i *const object,
        const struct sea_turtle_integer *const key,
...
int butterflyfish_mutable_map_i_i_get_entry(
        const struct butterflyfish_mutable_map_i_i *const object,
        const struct sea_turtle_integer *const key,
        const struct butterflyfish_map_i_i_entry **const out) {
    if (!object) {
...
int butterflyfish_mutable_map_i_i_set_value(
        struct butterflyfish_mutable_map_i_i *const object,
        const struct sea_turtle_integer *const key,
        const struct sea_turtle_integer *const value) {
    if (!object) {
...
int butterflyfish_mutable_map_i_i_set_key(
        struct butterflyfish_mutable_map_i_i *const object,
        const struct sea_turtle_integer *const key,
        const struct sea_turtle_integer *const value) {
    if (!object) {
...
int butterflyfish_mutable_map_i_i_set_entry(
        struct butterflyfish_mutable_map_i_i *const object,
        const struct butterflyfish_map_i_i_entry *const entry,
...
int butterflyfish_mutable_map_i_i_add_value(
        struct butterflyfish_mutable_map_i_i *const object,
        const struct sea_turtle_integer *const key,
        const struct sea_turtle_integer *const value) {
    if (!object) {
...
int butterflyfish_mutable_map_i_i_remove(
        struct butterflyfish_mutable_map_i_i *const object,
        const struct sea_turtle_integer *const key) {
    if (!object) {
        return BUTTERFLYFISH_MUTABLE_MAP_I_I_ERROR_OBJECT_IS_NULL;
...
int butterflyfish_mutable_map_i_i_remove_all(
        struct butterflyfish_mutable_map_i_i *const object,
        const struct butterflyfish_stream_i *const other) {
    if (!object) {
        return BUTTERFLYFISH_MUTABLE_MAP_I_I_ERROR_OBJECT_IS_NULL;
...
int butterflyfish_mutable_map_i_i_retain_all(
        struct butterflyfish_mutable_map_i_i *const object,
        const struct butterflyfish_stream_i *const other) {
    if (!object) {
        return BUTTERFLYFISH_MUTABLE_MAP_I_I_ERROR_OBJECT_IS_NULL;
...
#pragma mark mutable_map_i_i -

int butterflyfish_mutable_map_i_i_as_stream(
        const struct butterflyfish_mutable_map_i_i *const object,
        const struct butterflyfish_stream_i_i **const out) {
    if (!object) {
        return BUTTERFLYFISH_MUTABLE_MAP_I_I_ERROR_OBJECT_IS_NULL;
...
int butterflyfish_mutable_map_i_i_as_collection(
        const struct butterflyfish_mutable_map_i_i *const object,
        const struct butterflyfish_collection_i_i **const out) {
    if (!object) {
        return BUTTERFLYFISH_MUTABLE_MAP_I_I_ERROR_OBJECT_IS_NULL;
...
int butterflyfish_mutable_map_i_i_as_set(
        const struct butterflyfish_mutable_map_i_i *const object,
        const struct butterflyfish_set_i_i **const out) {
    if (!object) {
        return BUTTERFLYFISH_MUTABLE_MAP_I_I_ERROR_OBJECT_IS_NULL;
...
int butterflyfish_mutable_map_i_i_as_map(
        const struct butterflyfish_mutable_map_i_i *const object,
        const struct butterflyfish_map_i_i **const out) {
    if (!object) {
        return BUTTERFLYFISH_MUTABLE_MAP_I_I_ERROR_OBJECT_IS_NULL;
...
int butterflyfish_mutable_map_i_i_as_settable(
        struct butterflyfish_mutable_map_i_i *const object,
        struct butterflyfish_settable_i_i **const out) {
    if (!object) {
        return BUTTERFLYFISH_MUTABLE_MAP_I_I_ERROR_OBJECT_IS_NULL;
...
int butterflyfish_mutable_map_i_i_as_addable(
        struct butterflyfish_mutable_map_i_i *const object,
        struct butterflyfish_addable_i_i **const out) {
    if (!object) {
        return BUTTERFLYFISH_MUTABLE_MAP_I_I_ERROR_OBJECT_IS_NULL;
...
int butterflyfish_mutable_map_i_i_as_removable(
        struct butterflyfish_mutable_map_i_i *const object,
        struct butterflyfish_removable_i_i **const out) {
    if (!object) {
        return BUTTERFLYFISH_MUTABLE_MAP_I_I_ERROR_OBJECT_IS_NULL;
...
int butterflyfish_mutable_map_i_i_as_settable_map(
        struct butterflyfish_mutable_map_i_i *const object,
        struct butterflyfish_settable_map_i_i **const out) {
    if (!object) {
        return BUTTERFLYFISH_MUTABLE_MAP_I_I_ERROR_OBJECT_IS_NULL;
...
int butterflyfish_mutable_map_i_i_as_incremental_map(
        struct butterflyfish_mutable_map_i_i *const object,
        struct butterflyfish_incremental_map_i_i **const out) {
    if (!object) {
        return BUTTERFLYFISH_MUTABLE_MAP_I_I_ERROR_OBJECT_IS_NULL;
...
int butterflyfish_mutable_map_i_i_as_reducible_map(
        struct butterflyfish_mutable_map_i_i *const object,
        struct butterflyfish_reducible_map_i_i **const out) {
    if (!object) {
        return BUTTERFLYFISH_MUTABLE_MAP_I_I_ERROR_OBJECT_IS_NULL;
...
int butterflyfish_mutable_map_i_i_as_settable_incremental_map(
        struct butterflyfish_mutable_map_i_i *const object,
        struct butterflyfish_settable_incremental_map_i_i **const out) {
    if (!object) {
        return BUTTERFLYFISH_MUTABLE_MAP_I_I_ERROR_OBJECT_IS_NULL;
...
int butterflyfish_mutable_map_i_i_as_settable_reducible_map(
        struct butterflyfish_mutable_map_i_i *const object,
        struct butterflyfish_settable_reducible_map_i_i **const out) {
    if (!object) {
        return BUTTERFLYFISH_MUTABLE_MAP_I_I_ERROR_OBJECT_IS_NULL;
...
int butterflyfish_mutable_map_i_i_keys(
        struct butterflyfish_mutable_map_i_i *const object,
