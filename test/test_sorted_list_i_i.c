...
static void check_as_stream_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_list_i_i_as_stream(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_stream_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_list_i_i_as_stream((void *) 1, NULL),
...
static void check_as_stream(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_list_i_i_as_stream(
            (const struct butterflyfish_sorted_list_i_i *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}

static void check_as_collection_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_list_i_i_as_collection(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_collection_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_list_i_i_as_collection((void *) 1, NULL),
...
static void check_as_collection(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_list_i_i_as_collection(
            (const struct butterflyfish_sorted_list_i_i *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_sorted_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_list_i_i_as_sorted(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_sorted_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_list_i_i_as_sorted((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_LIST_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_as_sorted(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_list_i_i_as_sorted(
            (const struct butterflyfish_sorted_list_i_i *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_list_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_list_i_i_as_list(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_list_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_list_i_i_as_list((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_LIST_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_as_list(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_list_i_i_as_list(
            (const struct butterflyfish_sorted_list_i_i *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_sorted_as_collection(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_list_i_i_as_sorted(
            (const struct butterflyfish_sorted_list_i_i *) &instance, &as), 0);
    const struct butterflyfish_collection_i_i *out;
...
static void check_count_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_list_i_i_count(NULL, (void *) 1),
            BUTTERFLYFISH_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_count_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_list_i_i_count((void *) 1, NULL),
...
static void check_count(void **state) {
    ...
    uintmax_t out;
    assert_int_equal(butterflyfish_sorted_list_i_i_count(
            (const struct butterflyfish_sorted_list_i_i *) &instance, &out), 0);
...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_list_i_i_first(NULL, (void *) 1),
            BUTTERFLYFISH_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_first_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_list_i_i_first((void *) 1, NULL),
            BUTTERFLYFISH_LIST_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_first_error_on_list_is_empty(void **state) {
    ...
    assert_int_equal(
            butterflyfish_sorted_list_i_i_first(
                    (const struct butterflyfish_sorted_list_i_i *) &instance,
                    (void *) 1),
...
static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_list_i_i_last(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_last_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_list_i_i_last((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_LIST_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_last_error_on_list_is_empty(void **state) {
    ...
    assert_int_equal(
            butterflyfish_sorted_list_i_i_last(
                    (const struct butterflyfish_sorted_list_i_i *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_LIST_I_I_ERROR_LIST_IS_EMPTY);
}
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_list_i_i_next(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_next_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_list_i_i_next((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_LIST_I_I_ERROR_ITEM_IS_NULL);
}

static void check_next_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_list_i_i_next((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_LIST_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_next_error_on_end_of_sequence(void **state) {
    ...
    assert_int_equal(
            butterflyfish_sorted_list_i_i_next(
                    (const struct butterflyfish_sorted_list_i_i *) &instance,
                    (void *) 1,
                    (void *) 1),
...
static void check_prev_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_list_i_i_prev(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_prev_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_list_i_i_prev((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_LIST_I_I_ERROR_ITEM_IS_NULL);
}

static void check_prev_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_list_i_i_prev((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_LIST_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_prev_error_on_end_of_sequence(void **state) {
    ...
    assert_int_equal(
            butterflyfish_sorted_list_i_i_prev(
                    (const struct butterflyfish_sorted_list_i_i *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_LIST_I_I_ERROR_END_OF_SEQUENCE);
...
static void check_get_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_list_i_i_get(NULL, 0, (void *) 1),
            BUTTERFLYFISH_SORTED_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_get_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_list_i_i_get((void *) 1, 0, NULL),
            BUTTERFLYFISH_SORTED_LIST_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_get_error_on_index_out_of_bounds(void **state) {
    ...
    assert_int_equal(
            butterflyfish_sorted_list_i_i_get(
                    (const struct butterflyfish_sorted_list_i_i *) &instance,
                    0,
                    (void *) 1),
...
static void check_at_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_list_i_i_at(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_at_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_list_i_i_at((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_LIST_I_I_ERROR_ITEM_IS_NULL);
}

static void check_at_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_list_i_i_at((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_LIST_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_get_error_on_item_not_found(void **state) {
    ...
    assert_int_equal(
            butterflyfish_sorted_list_i_i_at(
                    (const struct butterflyfish_sorted_list_i_i *) &instance,
                    (void *) 1,
                    (void *) 1),
...
static void check_ceiling_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_list_i_i_ceiling(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_ceiling_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_list_i_i_ceiling((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_LIST_I_I_ERROR_VALUE_IS_NULL);
}

static void check_ceiling_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_list_i_i_ceiling((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_LIST_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_ceiling_error_on_value_not_found(void **state) {
    ...
    assert_int_equal(
            butterflyfish_sorted_list_i_i_ceiling(
                    (const struct butterflyfish_sorted_list_i_i *) &instance,
                    (void *) 1,
                    (void *) 1),
...
static void check_floor_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_list_i_i_floor(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_floor_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_list_i_i_floor((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_LIST_I_I_ERROR_VALUE_IS_NULL);
}

static void check_floor_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_list_i_i_floor((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_LIST_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_floor_error_on_value_not_found(void **state) {
    ...
    will_return(sorted_floor,
                BUTTERFLYFISH_SORTED_I_I_ERROR_VALUE_NOT_FOUND);
    assert_int_equal(
            butterflyfish_sorted_list_i_i_floor(
                    (const struct butterflyfish_sorted_list_i_i *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_LIST_I_I_ERROR_VALUE_NOT_FOUND);
...
static void check_higher_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_list_i_i_higher(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_higher_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_list_i_i_higher((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_LIST_I_I_ERROR_VALUE_IS_NULL);
}

static void check_higher_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_list_i_i_higher((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_LIST_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_higher_error_on_value_not_found(void **state) {
    ...
    will_return(sorted_higher,
                BUTTERFLYFISH_SORTED_I_I_ERROR_VALUE_NOT_FOUND);
    assert_int_equal(
            butterflyfish_sorted_list_i_i_higher(
                    (const struct butterflyfish_sorted_list_i_i *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_LIST_I_I_ERROR_VALUE_NOT_FOUND);
...
static void check_lower_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_list_i_i_lower(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_lower_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_list_i_i_lower((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_LIST_I_I_ERROR_VALUE_IS_NULL);
}

static void check_lower_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_list_i_i_lower((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_LIST_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_lower_error_on_value_not_found(void **state) {
    ...
    will_return(sorted_lower,
                BUTTERFLYFISH_SORTED_I_I_ERROR_VALUE_NOT_FOUND);
    assert_int_equal(
            butterflyfish_sorted_list_i_i_lower(
                    (const struct butterflyfish_sorted_list_i_i *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_LIST_I_I_ERROR_VALUE_NOT_FOUND);
