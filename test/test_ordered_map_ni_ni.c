...
static void check_as_stream_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_ni_ni_as_stream(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_NI_NI_ERROR_OBJECT_IS_NULL);
}

static void check_as_stream_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_ni_ni_as_stream((void *) 1, NULL),
...
static void check_as_stream(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_map_ni_ni_as_stream(
...
static void check_as_collection_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_ni_ni_as_collection(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_NI_NI_ERROR_OBJECT_IS_NULL);
}

static void check_as_collection_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_ni_ni_as_collection((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_NI_NI_ERROR_OUT_IS_NULL);
}
...
static void check_as_collection(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_map_ni_ni_as_collection(
...
static void check_as_map_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_ni_ni_as_map(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_NI_NI_ERROR_OBJECT_IS_NULL);
}

static void check_as_map_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_ni_ni_as_map((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_NI_NI_ERROR_OUT_IS_NULL);
}
...
static void check_as_map(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_map_ni_ni_as_map(
            &ordered_map, &map), 0);
...
static void check_count_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_ni_ni_count(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_NI_NI_ERROR_OBJECT_IS_NULL);
}

static void check_count_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_ni_ni_count((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_NI_NI_ERROR_OUT_IS_NULL);
}
...
static void check_count(void **state) {
    ...
    const struct butterflyfish_ordered_map_ni_ni ordered_map_ni_ni = {
            .map_ni_ni.collection_ni_ni.count = count
    };
    struct object {
        const struct butterflyfish_ordered_map_ni_ni *ordered_map_ni_ni;
    };
...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_ni_ni_first(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_NI_NI_ERROR_OBJECT_IS_NULL);
}

static void check_first_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_ni_ni_first((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_NI_NI_ERROR_OUT_IS_NULL);
}
...
static void check_first_error_on_map_is_empty(void **state) {
    const struct butterflyfish_ordered_map_ni_ni ordered_map_ni_ni = {
            .map_ni_ni.collection_ni_ni.stream_ni_ni.first = fl_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_map_ni_ni *ordered_map_ni_ni;
    };
...
static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_ni_ni_last(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_NI_NI_ERROR_OBJECT_IS_NULL);
}

static void check_last_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_ni_ni_last((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_NI_NI_ERROR_OUT_IS_NULL);
}

static void check_last_error_on_map_is_empty(void **state) {
    const struct butterflyfish_ordered_map_ni_ni ordered_map_ni_ni = {
            .map_ni_ni.collection_ni_ni.last = fl_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_map_ni_ni *ordered_map_ni_ni;
    };
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_ni_ni_next(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_NI_NI_ERROR_OBJECT_IS_NULL);
}

static void check_next_error_on_entry_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_ni_ni_next((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_NI_NI_ERROR_ENTRY_IS_NULL);
}

static void check_next_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_ni_ni_next((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_NI_NI_ERROR_OUT_IS_NULL);
}
...
static void check_next_error_on_end_of_sequence(void **state) {
    const struct butterflyfish_ordered_map_ni_ni ordered_map_ni_ni = {
            .map_ni_ni.collection_ni_ni.stream_ni_ni.next = np_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_map_ni_ni *ordered_map_ni_ni;
    };
...
static void check_prev_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_ni_ni_prev(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_NI_NI_ERROR_OBJECT_IS_NULL);
}

static void check_prev_error_on_entry_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_ni_ni_prev((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_NI_NI_ERROR_ENTRY_IS_NULL);
}

static void check_prev_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_ni_ni_prev((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_NI_NI_ERROR_OUT_IS_NULL);
}

static void check_prev_error_on_end_of_sequence(void **state) {
    const struct butterflyfish_ordered_map_ni_ni ordered_map_ni_ni = {
            .map_ni_ni.collection_ni_ni.prev = np_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_map_ni_ni *ordered_map_ni_ni;
    };
...
static void check_remove_entry_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_ni_ni_remove_entry(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_NI_NI_ERROR_OBJECT_IS_NULL);
}

static void check_remove_entry_error_on_entry_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_ni_ni_remove_entry((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_NI_NI_ERROR_ENTRY_IS_NULL);
}
...
static void check_remove_entry(void **state) {
    const struct butterflyfish_ordered_map_ni_ni ordered_map_ni_ni = {
            .map_ni_ni.remove_entry = remove_entry
    };
    struct object {
        const struct butterflyfish_ordered_map_ni_ni *ordered_map_ni_ni;
    };
...
static void check_remove_all_entries_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_ni_ni_remove_all_entries(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_NI_NI_ERROR_OBJECT_IS_NULL);
}

static void check_remove_all_entries_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_ni_ni_remove_all_entries((void *) 1, NULL),
...
static void check_remove_all_entries(void **state) {
    const struct butterflyfish_ordered_map_ni_ni ordered_map_ni_ni = {
            .map_ni_ni.remove_all_entries = remove_all_entries
    };
    struct object {
        const struct butterflyfish_ordered_map_ni_ni *ordered_map_ni_ni;
    };
...
static void check_add_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_ni_ni_add(NULL, 0, 0),
            BUTTERFLYFISH_ORDERED_MAP_NI_NI_ERROR_OBJECT_IS_NULL);
}
...
static void check_put_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_ni_ni_put(NULL, 0, 0),
            BUTTERFLYFISH_ORDERED_MAP_NI_NI_ERROR_OBJECT_IS_NULL);
}

static void check_put_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_ordered_map_ni_ni ordered_map_ni_ni = {
            .map_ni_ni.put = apr_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_map_ni_ni *ordered_map_ni_ni;
    };
...
static void check_replace_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_ni_ni_replace(NULL, 0, 0),
            BUTTERFLYFISH_ORDERED_MAP_NI_NI_ERROR_OBJECT_IS_NULL);
}

static void check_replace_error_on_key_not_found(void **state) {
    const struct butterflyfish_ordered_map_ni_ni ordered_map_ni_ni = {
            .map_ni_ni.replace = apr_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_map_ni_ni *ordered_map_ni_ni;
    };
...
static void check_remove_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_ni_ni_remove(NULL, 0),
            BUTTERFLYFISH_ORDERED_MAP_NI_NI_ERROR_OBJECT_IS_NULL);
}
...
static void check_add_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_ni_ni_add_all(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_NI_NI_ERROR_OBJECT_IS_NULL);
}

static void check_add_all_error_on_key_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_ni_ni_add_all((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_NI_NI_ERROR_OTHER_IS_NULL);
}
...
static void check_add_all_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_ordered_map_ni_ni ordered_map_ni_ni = {
            .map_ni_ni.add_all = all_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_map_ni_ni *ordered_map_ni_ni;
    };
...
static void check_put_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_ni_ni_put_all(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_NI_NI_ERROR_OBJECT_IS_NULL);
}

static void check_put_all_error_on_key_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_ni_ni_put_all((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_NI_NI_ERROR_OTHER_IS_NULL);
}

static void check_put_all_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_ordered_map_ni_ni ordered_map_ni_ni = {
            .map_ni_ni.put_all = all_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_map_ni_ni *ordered_map_ni_ni;
    };
...
static void check_replace_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_ni_ni_replace_all(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_NI_NI_ERROR_OBJECT_IS_NULL);
}

static void check_replace_all_error_on_key_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_ni_ni_replace_all((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_NI_NI_ERROR_OTHER_IS_NULL);
}

static void check_replace_all_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_ordered_map_ni_ni ordered_map_ni_ni = {
            .map_ni_ni.replace_all = all_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_map_ni_ni *ordered_map_ni_ni;
    };
...
static void check_remove_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_ni_ni_remove_all(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_NI_NI_ERROR_OBJECT_IS_NULL);
}

static void check_remove_all_error_on_key_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_ni_ni_remove_all((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_NI_NI_ERROR_OTHER_IS_NULL);
}
...
static void check_remove_all_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_ordered_map_ni_ni ordered_map_ni_ni = {
            .map_ni_ni.remove_all = rr_all_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_map_ni_ni *ordered_map_ni_ni;
    };
...
static void check_retain_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_ni_ni_retain_all(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_NI_NI_ERROR_OBJECT_IS_NULL);
}

static void check_retain_all_error_on_key_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_ni_ni_retain_all((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_NI_NI_ERROR_OTHER_IS_NULL);
}

static void check_retain_all_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_ordered_map_ni_ni ordered_map_ni_ni = {
            .map_ni_ni.retain_all = rr_all_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_map_ni_ni *ordered_map_ni_ni;
    };
...
static void check_merge_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_ni_ni_merge(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_NI_NI_ERROR_OBJECT_IS_NULL);
}

static void check_merge_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_ni_ni_merge((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_NI_NI_ERROR_OTHER_IS_NULL);
}

static void check_merge_error_on_function_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_ni_ni_merge((void *) 1, (void *) 1, NULL),
...
static void check_merge_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_ordered_map_ni_ni ordered_map_ni_ni = {
            .map_ni_ni.merge = merge_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_map_ni_ni *ordered_map_ni_ni;
    };
...
static void check_contains_key_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_ni_ni_contains_key(NULL, 0, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_NI_NI_ERROR_OBJECT_IS_NULL);
}

static void check_contains_key_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_ni_ni_contains_key((void *) 1, 0, NULL),
            BUTTERFLYFISH_ORDERED_MAP_NI_NI_ERROR_OUT_IS_NULL);
}
...
check_contains_key_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_ordered_map_ni_ni ordered_map_ni_ni = {
            .map_ni_ni.contains_key = contains_key_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_map_ni_ni *ordered_map_ni_ni;
    };
...
check_contains_all_keys_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_ordered_map_ni_ni ordered_map_ni_ni = {
            .map_ni_ni.contains_all_keys = contains_all_keys_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_map_ni_ni *ordered_map_ni_ni;
    };
...
static void check_get_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_ni_ni_get(NULL, 0, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_NI_NI_ERROR_OBJECT_IS_NULL);
}

static void check_get_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_ni_ni_get((void *) 1, 0, NULL),
            BUTTERFLYFISH_ORDERED_MAP_NI_NI_ERROR_OUT_IS_NULL);
}
...
static void check_get_entry_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_ni_ni_get_entry(NULL, 0, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_NI_NI_ERROR_OBJECT_IS_NULL);
}

static void check_get_entry_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_ni_ni_get_entry((void *) 1, 0, NULL),
            BUTTERFLYFISH_ORDERED_MAP_NI_NI_ERROR_OUT_IS_NULL);
}
...
static void check_get_entry_error_on_key_not_found(void **state) {
    const struct butterflyfish_ordered_map_ni_ni ordered_map_ni_ni = {
            .map_ni_ni.get_entry = get_entry_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_map_ni_ni *ordered_map_ni_ni;
    };
...
static void check_keys_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_ni_ni_keys(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_NI_NI_ERROR_OBJECT_IS_NULL);
}

static void check_keys_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_ni_ni_keys((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_NI_NI_ERROR_OUT_IS_NULL);
}
...
static void check_keys(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_map_ni_ni_keys(
                    (struct butterflyfish_ordered_map_ni_ni *) &instance,
                    (void *) 1),
            0);
}
...
static void check_values_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_ni_ni_values(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_NI_NI_ERROR_OBJECT_IS_NULL);
}

static void check_values_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_ni_ni_values((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_NI_NI_ERROR_OUT_IS_NULL);
}
