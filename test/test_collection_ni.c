...
static void check_as_stream_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_collection_ni_as_stream(NULL, (void *) 1),
            BUTTERFLYFISH_COLLECTION_NI_ERROR_OBJECT_IS_NULL);
}

static void check_as_stream_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_collection_ni_as_stream((void *) 1, NULL),
            BUTTERFLYFISH_COLLECTION_NI_ERROR_OUT_IS_NULL);
}

static void check_as_stream(void **state) {
    struct butterflyfish_collection_ni collection = {};
    const struct butterflyfish_stream_ni *stream;
    assert_int_equal(butterflyfish_collection_ni_as_stream(
            &collection, &stream), 0);
...
static void check_count_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_collection_ni_count(NULL, (void *) 1),
            BUTTERFLYFISH_COLLECTION_NI_ERROR_OBJECT_IS_NULL);
}

static void check_count_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_collection_ni_count((void *) 1, NULL),
            BUTTERFLYFISH_COLLECTION_NI_ERROR_OUT_IS_NULL);
}
...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_collection_ni_first(NULL, (void *) 1),
            BUTTERFLYFISH_COLLECTION_NI_ERROR_OBJECT_IS_NULL);
}

static void check_first_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_collection_ni_first((void *) 1, NULL),
            BUTTERFLYFISH_COLLECTION_NI_ERROR_OUT_IS_NULL);
}

static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_collection_ni_last(NULL, (void *) 1),
            BUTTERFLYFISH_COLLECTION_NI_ERROR_OBJECT_IS_NULL);
}

static void check_last_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_collection_ni_last((void *) 1, NULL),
            BUTTERFLYFISH_COLLECTION_NI_ERROR_OUT_IS_NULL);
}
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_collection_ni_next(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_COLLECTION_NI_ERROR_OBJECT_IS_NULL);
}

static void check_next_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_collection_ni_next((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_COLLECTION_NI_ERROR_ITEM_IS_NULL);
}

static void check_next_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_collection_ni_next((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_COLLECTION_NI_ERROR_OUT_IS_NULL);
}
...
static void check_prev_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_collection_ni_prev(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_COLLECTION_NI_ERROR_OBJECT_IS_NULL);
}

static void check_prev_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_collection_ni_prev((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_COLLECTION_NI_ERROR_ITEM_IS_NULL);
}

static void check_prev_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_collection_ni_prev((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_COLLECTION_NI_ERROR_OUT_IS_NULL);
}
