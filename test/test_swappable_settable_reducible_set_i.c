...
static void check_as_stream_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_settable_reducible_set_i_as_stream(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SWAPPABLE_SETTABLE_REDUCIBLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_stream_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_settable_reducible_set_i_as_stream(
                    (void *) 1, NULL),
            BUTTERFLYFISH_SWAPPABLE_SETTABLE_REDUCIBLE_SET_I_ERROR_OUT_IS_NULL);
}
...
static void check_as_stream(void **state) {
    ...
    assert_int_equal(butterflyfish_swappable_settable_reducible_set_i_as_stream(
            (const struct butterflyfish_swappable_settable_reducible_set_i *)
                    &instance, &out), 0);
...
static void check_as_collection_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_settable_reducible_set_i_as_collection(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SWAPPABLE_SETTABLE_REDUCIBLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_collection(void **state) {
    ...
    assert_int_equal(butterflyfish_swappable_settable_reducible_set_i_as_collection(
            (const struct butterflyfish_swappable_settable_reducible_set_i *)
                    &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_ordered_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_settable_reducible_set_i_as_ordered(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SWAPPABLE_SETTABLE_REDUCIBLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_ordered(void **state) {
    ...
    assert_int_equal(butterflyfish_swappable_settable_reducible_set_i_as_ordered(
            (const struct butterflyfish_swappable_settable_reducible_set_i *)
                    &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_settable_reducible_set_i_as_set(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SWAPPABLE_SETTABLE_REDUCIBLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_set(void **state) {
    ...
    const void *check = (char *) &instance
                        + offsetof(struct object, set_i);
    const struct butterflyfish_set_i *out;
    assert_int_equal(butterflyfish_swappable_settable_reducible_set_i_as_set(
            (const struct butterflyfish_swappable_settable_reducible_set_i *)
                    &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_removable_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_settable_reducible_set_i_as_removable(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SWAPPABLE_SETTABLE_REDUCIBLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_removable(void **state) {
    ...
    assert_int_equal(butterflyfish_swappable_settable_reducible_set_i_as_removable(
...
static void check_as_settable_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_settable_reducible_set_i_as_settable(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SWAPPABLE_SETTABLE_REDUCIBLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_settable(void **state) {
    ...
    assert_int_equal(butterflyfish_swappable_settable_reducible_set_i_as_settable(
            (struct butterflyfish_swappable_settable_reducible_set_i *)
                    &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_swappable_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_settable_reducible_set_i_as_swappable(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SWAPPABLE_SETTABLE_REDUCIBLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_swappable(void **state) {
    ...
    assert_int_equal(butterflyfish_swappable_settable_reducible_set_i_as_swappable(
            (struct butterflyfish_swappable_settable_reducible_set_i *)
                    &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_ordered_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_settable_reducible_set_i_as_ordered_set(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SWAPPABLE_SETTABLE_REDUCIBLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_ordered_set(void **state) {
    ...
    assert_int_equal(butterflyfish_swappable_settable_reducible_set_i_as_ordered_set(
            (const struct butterflyfish_swappable_settable_reducible_set_i *)
                    &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_reducible_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_settable_reducible_set_i_as_reducible_set(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SWAPPABLE_SETTABLE_REDUCIBLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_reducible_set(void **state) {
    ...
    assert_int_equal(butterflyfish_swappable_settable_reducible_set_i_as_reducible_set(
            (struct butterflyfish_swappable_settable_reducible_set_i *)
                    &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_settable_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_settable_reducible_set_i_as_settable_set(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SWAPPABLE_SETTABLE_REDUCIBLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_settable_set(void **state) {
    ...
    assert_int_equal(butterflyfish_swappable_settable_reducible_set_i_as_settable_set(
            (struct butterflyfish_swappable_settable_reducible_set_i *)
                    &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_swappable_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_settable_reducible_set_i_as_swappable_set(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SWAPPABLE_SETTABLE_REDUCIBLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_swappable_set(void **state) {
    ...
    assert_int_equal(butterflyfish_swappable_settable_reducible_set_i_as_swappable_set(
            (struct butterflyfish_swappable_settable_reducible_set_i *)
                    &instance, &out), 0);
    assert_ptr_equal(out, check);
}

static void check_as_ordered_reducible_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_settable_reducible_set_i_as_ordered_reducible_set(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SWAPPABLE_SETTABLE_REDUCIBLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_ordered_reducible_set(void **state) {
    ...
    assert_int_equal(butterflyfish_swappable_settable_reducible_set_i_as_ordered_reducible_set(
            (struct butterflyfish_swappable_settable_reducible_set_i *)
                    &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_ordered_settable_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_settable_reducible_set_i_as_ordered_settable_set(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SWAPPABLE_SETTABLE_REDUCIBLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_ordered_settable_set(void **state) {
    ...
    assert_int_equal(butterflyfish_swappable_settable_reducible_set_i_as_ordered_settable_set(
            (struct butterflyfish_swappable_settable_reducible_set_i *)
                    &instance, &out), 0);
    assert_ptr_equal(out, check);
}

static void check_as_settable_reducible_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_settable_reducible_set_i_as_settable_reducible_set(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SWAPPABLE_SETTABLE_REDUCIBLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_settable_reducible_set(void **state) {
    ...
    assert_int_equal(butterflyfish_swappable_settable_reducible_set_i_as_settable_reducible_set(
            (struct butterflyfish_swappable_settable_reducible_set_i *)
                    &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_swappable_reducible_set(void **state) {
    ...
    assert_int_equal(butterflyfish_swappable_settable_reducible_set_i_as_swappable_reducible_set(
            (struct butterflyfish_swappable_settable_reducible_set_i *)
                    &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_swappable_settable_set(void **state) {
    ...
    assert_int_equal(butterflyfish_swappable_settable_reducible_set_i_as_swappable_settable_set(
            (struct butterflyfish_swappable_settable_reducible_set_i *)
                    &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_ordered_settable_reducible_set(void **state) {
    ...
    assert_int_equal(butterflyfish_swappable_settable_reducible_set_i_as_ordered_settable_reducible_set(
            (struct butterflyfish_swappable_settable_reducible_set_i *)
                    &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void
check_ordered_settable_reducible_set_as_ordered_reducible_set(void **state) {
    const struct object instance = {
            .swappable_settable_reducible_set_i =
                    &swappable_settable_reducible_set_i,
            .ordered_settable_reducible_set_i =
    ...
    assert_int_equal(butterflyfish_swappable_settable_reducible_set_i_as_ordered_settable_reducible_set(
            (struct butterflyfish_swappable_settable_reducible_set_i *) &instance,
                    &as), 0);
    struct butterflyfish_ordered_reducible_set_i *out;
    assert_int_equal(butterflyfish_ordered_settable_reducible_set_i_as_ordered_reducible_set(
            as, &out), 0);
    assert_ptr_equal(out, check);
}
...
check_ordered_settable_reducible_set_as_ordered_settable_set(void **state) {
    ...
    assert_int_equal(butterflyfish_swappable_settable_reducible_set_i_as_ordered_settable_reducible_set(
            (struct butterflyfish_swappable_settable_reducible_set_i *) &instance,
                    &as), 0);
    struct butterflyfish_ordered_settable_set_i *out;
    assert_int_equal(butterflyfish_ordered_settable_reducible_set_i_as_ordered_settable_set(
            as, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_settable_reducible_set_as_reducible_set(void **state) {
    ...
    assert_int_equal(butterflyfish_swappable_settable_reducible_set_i_as_settable_reducible_set(
            (struct butterflyfish_swappable_settable_reducible_set_i *) &instance,
                    &as), 0);
    struct butterflyfish_reducible_set_i *out;
    assert_int_equal(butterflyfish_settable_reducible_set_i_as_reducible_set(
            as, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_ordered_set_as_ordered(void **state) {
    ...
    assert_int_equal(butterflyfish_swappable_settable_reducible_set_i_as_ordered_set(
            (const struct butterflyfish_swappable_settable_reducible_set_i *) &instance,
                    &as), 0);
    const struct butterflyfish_ordered_i *out;
...
static void check_count_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_settable_reducible_set_i_count(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SWAPPABLE_SETTABLE_REDUCIBLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_count(void **state) {
    ...
    uintmax_t out;
    assert_int_equal(butterflyfish_swappable_settable_reducible_set_i_count(
            (const struct butterflyfish_swappable_settable_reducible_set_i *)
                    &instance, &out), 0);
...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_settable_reducible_set_i_first(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SWAPPABLE_SETTABLE_REDUCIBLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_first_error_on_set_is_empty(void **state) {
    ...
    assert_int_equal(
            butterflyfish_swappable_settable_reducible_set_i_first(
                    (const struct butterflyfish_swappable_settable_reducible_set_i *)
                            &instance, (void *) 1),
            BUTTERFLYFISH_SWAPPABLE_SETTABLE_REDUCIBLE_SET_I_ERROR_SET_IS_EMPTY);
}

static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_settable_reducible_set_i_last(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SWAPPABLE_SETTABLE_REDUCIBLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_settable_reducible_set_i_next(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SWAPPABLE_SETTABLE_REDUCIBLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_next_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_settable_reducible_set_i_next(
                    (void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SWAPPABLE_SETTABLE_REDUCIBLE_SET_I_ERROR_ITEM_IS_NULL);
}
...
static void check_next_error_on_end_of_sequence(void **state) {
    ...
    assert_int_equal(
            ...
            BUTTERFLYFISH_SWAPPABLE_SETTABLE_REDUCIBLE_SET_I_ERROR_END_OF_SEQUENCE);
}

static void check_prev_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_settable_reducible_set_i_prev(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SWAPPABLE_SETTABLE_REDUCIBLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_contains_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_settable_reducible_set_i_contains(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SWAPPABLE_SETTABLE_REDUCIBLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_contains_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_settable_reducible_set_i_contains(
                    (void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SWAPPABLE_SETTABLE_REDUCIBLE_SET_I_ERROR_VALUE_IS_NULL);
}
...
static void check_contains_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_settable_reducible_set_i_contains_all(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SWAPPABLE_SETTABLE_REDUCIBLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_contains_all_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_settable_reducible_set_i_contains_all(
                    (void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SWAPPABLE_SETTABLE_REDUCIBLE_SET_I_ERROR_OTHER_IS_NULL);
}
...
static void check_get_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_settable_reducible_set_i_get(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SWAPPABLE_SETTABLE_REDUCIBLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_get_error_on_value_not_found(void **state) {
    ...
    assert_int_equal(
            butterflyfish_swappable_settable_reducible_set_i_get(
                    (struct butterflyfish_swappable_settable_reducible_set_i *)
                            &instance, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SWAPPABLE_SETTABLE_REDUCIBLE_SET_I_ERROR_VALUE_NOT_FOUND);
}
...
static void check_set_item_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_settable_reducible_set_i_set_item(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SWAPPABLE_SETTABLE_REDUCIBLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_settable_reducible_set_i_set(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SWAPPABLE_SETTABLE_REDUCIBLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_swap_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_settable_reducible_set_i_swap(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SWAPPABLE_SETTABLE_REDUCIBLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_remove_item_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_settable_reducible_set_i_remove_item(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SWAPPABLE_SETTABLE_REDUCIBLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_remove_all_items_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_settable_reducible_set_i_remove_all_items(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SWAPPABLE_SETTABLE_REDUCIBLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_remove_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_settable_reducible_set_i_remove(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SWAPPABLE_SETTABLE_REDUCIBLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_remove_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_settable_reducible_set_i_remove_all(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SWAPPABLE_SETTABLE_REDUCIBLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_retain_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_settable_reducible_set_i_retain_all(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SWAPPABLE_SETTABLE_REDUCIBLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
int main(int argc, char *argv[]) {
    const struct CMUnitTest tests[] = {
            ...
            cmocka_unit_test(check_ordered_settable_reducible_set_as_ordered_reducible_set),
