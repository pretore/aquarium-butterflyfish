...
struct instance {
    const struct butterflyfish_stream_i_i *const id;
    void *data;
};
...
static int stream_first(const void *const object,
    ...
    seagrass_required_true(&stream_i_i == instance->id);
    return mock();
}
...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(stream_i_i.first(NULL, (void *) 1),
                     BUTTERFLYFISH_STREAM_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_first_error_on_out_is_null(void **state) {
    assert_int_equal(stream_i_i.first((void *) 1, NULL),
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(stream_i_i.next(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_STREAM_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_next_error_on_item_is_null(void **state) {
    assert_int_equal(stream_i_i.next((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_STREAM_I_I_ERROR_ITEM_IS_NULL);
}

static void check_next_error_on_out_is_null(void **state) {
    assert_int_equal(stream_i_i.next((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_STREAM_I_I_ERROR_OUT_IS_NULL);
}
