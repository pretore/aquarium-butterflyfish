...
struct instance {
    const struct butterflyfish_addable_i_i *const id;
    void *data;
};
...
static int stream_first(const void *const object,
    ...
    seagrass_required_true(&addable_i_i == instance->id);
    return mock();
}
...
static void check_as_stream(void **state) {
    assert_ptr_equal(addable_i_i.as_stream, &stream_i_i);
}

static void check_as_collection(void **state) {
    assert_ptr_equal(addable_i_i.as_collection, &collection_i_i);
}

static void check_count_error_on_object_is_null(void **state) {
    assert_int_equal(addable_i_i.count(NULL, (void *) 1),
                     BUTTERFLYFISH_ADDABLE_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_count_error_on_out_is_null(void **state) {
    assert_int_equal(addable_i_i.count((void *) 1, NULL),
...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(addable_i_i.first(NULL, (void *) 1),
                     BUTTERFLYFISH_ADDABLE_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_first_error_on_out_is_null(void **state) {
    assert_int_equal(addable_i_i.first((void *) 1, NULL),
                     BUTTERFLYFISH_ADDABLE_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(addable_i_i.last(NULL, (void *) 1),
                     BUTTERFLYFISH_ADDABLE_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_last_error_on_out_is_null(void **state) {
    assert_int_equal(addable_i_i.last((void *) 1, NULL),
                     BUTTERFLYFISH_ADDABLE_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(addable_i_i.next(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_ADDABLE_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_next_error_on_item_is_null(void **state) {
    assert_int_equal(addable_i_i.next((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_ADDABLE_I_I_ERROR_ITEM_IS_NULL);
}

static void check_next_error_on_out_is_null(void **state) {
    assert_int_equal(addable_i_i.next((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_ADDABLE_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_prev_error_on_object_is_null(void **state) {
    assert_int_equal(addable_i_i.prev(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_ADDABLE_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_prev_error_on_item_is_null(void **state) {
    assert_int_equal(addable_i_i.prev((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_ADDABLE_I_I_ERROR_ITEM_IS_NULL);
}

static void check_prev_error_on_out_is_null(void **state) {
    assert_int_equal(addable_i_i.prev((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_ADDABLE_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_add_error_on_object_is_null(void **state) {
    assert_int_equal(addable_i_i.add(NULL, (void *) 1),
                     BUTTERFLYFISH_ADDABLE_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_add_error_on_value_is_null(void **state) {
    assert_int_equal(addable_i_i.add((void *) 1, NULL),
