...
static int
as_collection(const struct butterflyfish_removable_i_i *const object,
...
static int
reducible_remove_item(struct butterflyfish_removable_i_i *const object,
                      const struct butterflyfish_map_i_i_entry *const item) {
    function_called();
    assert_non_null(object);
    assert_non_null(item);
...
static void check_as_stream_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_removable_i_i_as_stream(NULL, (void *) 1),
            BUTTERFLYFISH_REMOVABLE_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_stream_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_removable_i_i_as_stream((void *) 1, NULL),
            BUTTERFLYFISH_REMOVABLE_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_as_stream(void **state) {
    ...
    assert_int_equal(butterflyfish_removable_i_i_as_stream(
            (const struct butterflyfish_removable_i_i *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}

static void check_as_collection_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_removable_i_i_as_collection(NULL, (void *) 1),
            BUTTERFLYFISH_REMOVABLE_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_collection_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_removable_i_i_as_collection((void *) 1, NULL),
            BUTTERFLYFISH_REMOVABLE_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_count_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_removable_i_i_count(NULL, (void *) 1),
            BUTTERFLYFISH_REMOVABLE_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_count_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_removable_i_i_count((void *) 1, NULL),
            BUTTERFLYFISH_REMOVABLE_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_count(void **state) {
    ...
    uintmax_t out;
    assert_int_equal(butterflyfish_removable_i_i_count(
            (const struct butterflyfish_removable_i_i *) &instance, &out), 0);
...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_removable_i_i_first(NULL, (void *) 1),
            BUTTERFLYFISH_REMOVABLE_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_first_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_removable_i_i_first((void *) 1, NULL),
            BUTTERFLYFISH_REMOVABLE_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_first_error_on_ordered_is_empty(void **state) {
    ...
    assert_int_equal(
            butterflyfish_removable_i_i_first(
                    (const struct butterflyfish_removable_i_i *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_REMOVABLE_I_I_ERROR_REMOVABLE_IS_EMPTY);
}

static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_removable_i_i_last(NULL, (void *) 1),
            BUTTERFLYFISH_REMOVABLE_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_last_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_removable_i_i_last((void *) 1, NULL),
            BUTTERFLYFISH_REMOVABLE_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_last_error_on_ordered_is_empty(void **state) {
    ...
    assert_int_equal(
            butterflyfish_removable_i_i_last(
                    (const struct butterflyfish_removable_i_i *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_REMOVABLE_I_I_ERROR_REMOVABLE_IS_EMPTY);
}
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_removable_i_i_next(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_REMOVABLE_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_next_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_removable_i_i_next((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_REMOVABLE_I_I_ERROR_ITEM_IS_NULL);
}

static void check_next_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_removable_i_i_next((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_REMOVABLE_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_next_error_on_end_of_sequence(void **state) {
    ...
    assert_int_equal(
            butterflyfish_removable_i_i_next(
                    (const struct butterflyfish_removable_i_i *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_REMOVABLE_I_I_ERROR_END_OF_SEQUENCE);
}

static void check_prev_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_removable_i_i_prev(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_REMOVABLE_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_prev_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_removable_i_i_prev((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_REMOVABLE_I_I_ERROR_ITEM_IS_NULL);
}

static void check_prev_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_removable_i_i_prev((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_REMOVABLE_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_prev_error_on_end_of_sequence(void **state) {
    ...
    assert_int_equal(
            butterflyfish_removable_i_i_prev(
                    (const struct butterflyfish_removable_i_i *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_REMOVABLE_I_I_ERROR_END_OF_SEQUENCE);
...
static void check_remove_item_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_removable_i_i_remove_item(NULL, (void *) 1),
            BUTTERFLYFISH_REMOVABLE_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_remove_item_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_removable_i_i_remove_item((void *) 1, NULL),
            BUTTERFLYFISH_REMOVABLE_I_I_ERROR_ITEM_IS_NULL);
}
...
static void check_remove_item(void **state) {
    ...
    assert_int_equal(
            butterflyfish_removable_i_i_remove_item(
                    (struct butterflyfish_removable_i_i *) &instance,
                    (void *) 1), 0);
}

static void check_remove_all_items_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_removable_i_i_remove_all_items(NULL, (void *) 1),
            BUTTERFLYFISH_REMOVABLE_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_remove_all_items_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_removable_i_i_remove_all_items((void *) 1, NULL),
            BUTTERFLYFISH_REMOVABLE_I_I_ERROR_OTHER_IS_NULL);
}
...
static void check_remove_all_items(void **state) {
    ...
    assert_int_equal(
            butterflyfish_removable_i_i_remove_all_items(
                    (struct butterflyfish_removable_i_i *) &instance,
                    (void *) 1), 0);
}
