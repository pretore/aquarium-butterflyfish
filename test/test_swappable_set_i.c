...
static void check_as_stream_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_set_i_as_stream(NULL, (void *) 1),
            BUTTERFLYFISH_SWAPPABLE_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_stream_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_set_i_as_stream((void *) 1, NULL),
...
static void check_as_stream(void **state) {
    ...
    assert_int_equal(butterflyfish_swappable_set_i_as_stream(
            (const struct butterflyfish_swappable_set_i *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}

static void check_as_collection_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_set_i_as_collection(NULL, (void *) 1),
            BUTTERFLYFISH_SWAPPABLE_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_collection_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_set_i_as_collection((void *) 1, NULL),
            BUTTERFLYFISH_SWAPPABLE_SET_I_ERROR_OUT_IS_NULL);
}
...
static void check_as_collection(void **state) {
    ...
    assert_int_equal(butterflyfish_swappable_set_i_as_collection(
            (const struct butterflyfish_swappable_set_i *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_ordered_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_set_i_as_ordered(NULL, (void *) 1),
            BUTTERFLYFISH_SWAPPABLE_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_ordered_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_set_i_as_ordered((void *) 1, NULL),
            BUTTERFLYFISH_SWAPPABLE_SET_I_ERROR_OUT_IS_NULL);
}
...
static void check_as_ordered(void **state) {
    ...
    assert_int_equal(butterflyfish_swappable_set_i_as_ordered(
            (struct butterflyfish_swappable_set_i *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}

static void check_as_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_set_i_as_set(NULL, (void *) 1),
            BUTTERFLYFISH_SWAPPABLE_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_set_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_set_i_as_set((void *) 1, NULL),
            BUTTERFLYFISH_SWAPPABLE_SET_I_ERROR_OUT_IS_NULL);
}
...
static void check_as_set(void **state) {
    ...
    assert_int_equal(butterflyfish_swappable_set_i_as_set(
            (struct butterflyfish_swappable_set_i *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_ordered_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_set_i_as_ordered_set(NULL, (void *) 1),
            BUTTERFLYFISH_SWAPPABLE_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_ordered_set_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_set_i_as_ordered_set((void *) 1, NULL),
            BUTTERFLYFISH_SWAPPABLE_SET_I_ERROR_OUT_IS_NULL);
}
...
static void check_as_swappable_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_set_i_as_swappable(NULL, (void *) 1),
            BUTTERFLYFISH_SWAPPABLE_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_swappable_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_set_i_as_swappable((void *) 1, NULL),
            BUTTERFLYFISH_SWAPPABLE_SET_I_ERROR_OUT_IS_NULL);
}
...
static void check_as_swappable(void **state) {
    ...
    assert_int_equal(butterflyfish_swappable_set_i_as_swappable(
            (struct butterflyfish_swappable_set_i *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_swappable_as_collection(void **state) {
    ...
    assert_int_equal(butterflyfish_swappable_set_i_as_swappable(
            (struct butterflyfish_swappable_set_i *) &instance, &as), 0);
    const struct butterflyfish_collection_i *out;
...
static void check_count_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_set_i_count(NULL, (void *) 1),
            BUTTERFLYFISH_SWAPPABLE_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_count_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_set_i_count((void *) 1, NULL),
            BUTTERFLYFISH_SWAPPABLE_SET_I_ERROR_OUT_IS_NULL);
}
...
static void check_count(void **state) {
    ...
    uintmax_t out;
    assert_int_equal(butterflyfish_swappable_set_i_count(
            (const struct butterflyfish_swappable_set_i *) &instance, &out), 0);
...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_set_i_first(NULL, (void *) 1),
            BUTTERFLYFISH_SWAPPABLE_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_first_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_set_i_first((void *) 1, NULL),
            BUTTERFLYFISH_SWAPPABLE_SET_I_ERROR_OUT_IS_NULL);
}
...
static void check_first_error_on_set_is_empty(void **state) {
    ...
    assert_int_equal(
            butterflyfish_swappable_set_i_first(
                    (const struct butterflyfish_swappable_set_i *) &instance,
                    (void *) 1),
...
static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_set_i_last(NULL, (void *) 1),
            BUTTERFLYFISH_SWAPPABLE_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_last_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_set_i_last((void *) 1, NULL),
            BUTTERFLYFISH_SWAPPABLE_SET_I_ERROR_OUT_IS_NULL);
}
...
static void check_last_error_on_set_is_empty(void **state) {
    ...
    assert_int_equal(
            butterflyfish_swappable_set_i_last(
                    (const struct butterflyfish_swappable_set_i *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_SWAPPABLE_SET_I_ERROR_SET_IS_EMPTY);
}
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_set_i_next(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SWAPPABLE_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_next_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_set_i_next((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SWAPPABLE_SET_I_ERROR_ITEM_IS_NULL);
}

static void check_next_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_set_i_next((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SWAPPABLE_SET_I_ERROR_OUT_IS_NULL);
}
...
static void check_next_error_on_end_of_sequence(void **state) {
    ...
    assert_int_equal(
            butterflyfish_swappable_set_i_next(
                    (const struct butterflyfish_swappable_set_i *) &instance,
                    (void *) 1,
                    (void *) 1),
...
static void check_prev_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_set_i_prev(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SWAPPABLE_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_prev_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_set_i_prev((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SWAPPABLE_SET_I_ERROR_ITEM_IS_NULL);
}

static void check_prev_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_set_i_prev((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SWAPPABLE_SET_I_ERROR_OUT_IS_NULL);
}
...
static void check_prev_error_on_end_of_sequence(void **state) {
    ...
    assert_int_equal(
            butterflyfish_swappable_set_i_prev(
                    (const struct butterflyfish_swappable_set_i *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SWAPPABLE_SET_I_ERROR_END_OF_SEQUENCE);
...
static void check_contains_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_set_i_contains(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SWAPPABLE_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_contains_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_set_i_contains((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SWAPPABLE_SET_I_ERROR_VALUE_IS_NULL);
}

static void check_contains_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_set_i_contains((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SWAPPABLE_SET_I_ERROR_OUT_IS_NULL);
}
...
static void check_contains_error_on_memory_allocation_failed(void **state) {
    ...
    assert_int_equal(
            butterflyfish_swappable_set_i_contains(
                    (struct butterflyfish_swappable_set_i *) &instance,
                    (void *) 1,
                    (void *) 1),
...
static void check_contains_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_set_i_contains_all(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SWAPPABLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_get_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_set_i_get(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SWAPPABLE_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_get_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_set_i_get((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SWAPPABLE_SET_I_ERROR_VALUE_IS_NULL);
}

static void check_get_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_set_i_get((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SWAPPABLE_SET_I_ERROR_OUT_IS_NULL);
}
...
static void check_get_error_on_value_not_found(void **state) {
    ...
    assert_int_equal(
            butterflyfish_swappable_set_i_get(
                    (struct butterflyfish_swappable_set_i *) &instance,
                    (void *) 1,
                    (void *) 1),
...
static void check_swap_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_set_i_swap(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SWAPPABLE_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_swap_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_set_i_swap((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SWAPPABLE_SET_I_ERROR_ITEM_IS_NULL);
}

static void check_swap_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_swappable_set_i_swap((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SWAPPABLE_SET_I_ERROR_OTHER_IS_NULL);
}
...
static void check_swap(void **state) {
    ...
    assert_int_equal(
            butterflyfish_swappable_set_i_swap(
                    (struct butterflyfish_swappable_set_i *) &instance,
                    (void *) 1,
                    (void *) 1), 0);
}
