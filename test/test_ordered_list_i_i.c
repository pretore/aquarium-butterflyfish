...
struct instance {
    const struct butterflyfish_ordered_list_i_i *const id;
    void *data;
};
...
static int stream_first(const void *const object,
    ...
    seagrass_required_true(&ordered_list_i_i == instance->id);
    return mock();
}
...
static void check_as_stream(void **state) {
    assert_ptr_equal(ordered_list_i_i.as_stream, &stream_i_i);
}

static void check_as_collection(void **state) {
    assert_ptr_equal(ordered_list_i_i.as_collection, &collection_i_i);
}

static void check_as_ordered(void **state) {
    assert_ptr_equal(ordered_list_i_i.as_ordered, &ordered_i_i);
}

static void check_as_list(void **state) {
    assert_ptr_equal(ordered_list_i_i.as_list, &list_i_i);
}

static void check_count_error_on_object_is_null(void **state) {
    assert_int_equal(ordered_list_i_i.count(NULL, (void *) 1),
                     BUTTERFLYFISH_ORDERED_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_count_error_on_out_is_null(void **state) {
    assert_int_equal(ordered_list_i_i.count((void *) 1, NULL),
...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(ordered_list_i_i.first(NULL, (void *) 1),
                     BUTTERFLYFISH_ORDERED_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_first_error_on_out_is_null(void **state) {
    assert_int_equal(ordered_list_i_i.first((void *) 1, NULL),
                     BUTTERFLYFISH_ORDERED_LIST_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(ordered_list_i_i.last(NULL, (void *) 1),
                     BUTTERFLYFISH_ORDERED_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_last_error_on_out_is_null(void **state) {
    assert_int_equal(ordered_list_i_i.last((void *) 1, NULL),
                     BUTTERFLYFISH_ORDERED_LIST_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(ordered_list_i_i.next(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_ORDERED_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_next_error_on_item_is_null(void **state) {
    assert_int_equal(ordered_list_i_i.next((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_ORDERED_LIST_I_I_ERROR_ITEM_IS_NULL);
}

static void check_next_error_on_out_is_null(void **state) {
    assert_int_equal(ordered_list_i_i.next((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_ORDERED_LIST_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_prev_error_on_object_is_null(void **state) {
    assert_int_equal(ordered_list_i_i.prev(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_ORDERED_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_prev_error_on_item_is_null(void **state) {
    assert_int_equal(ordered_list_i_i.prev((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_ORDERED_LIST_I_I_ERROR_ITEM_IS_NULL);
}

static void check_prev_error_on_out_is_null(void **state) {
    assert_int_equal(ordered_list_i_i.prev((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_ORDERED_LIST_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_get_error_on_object_is_null(void **state) {
    assert_int_equal(ordered_list_i_i.get(NULL, 0, (void *) 1),
                     BUTTERFLYFISH_ORDERED_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_get_error_on_out_is_null(void **state) {
    assert_int_equal(ordered_list_i_i.get((void *) 1, 0, NULL),
                     BUTTERFLYFISH_ORDERED_LIST_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_at_error_on_object_is_null(void **state) {
    assert_int_equal(ordered_list_i_i.at(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_ORDERED_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_at_error_on_item_is_null(void **state) {
    assert_int_equal(ordered_list_i_i.at((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_ORDERED_LIST_I_I_ERROR_ITEM_IS_NULL);
}

static void check_at_error_on_out_is_null(void **state) {
    assert_int_equal(ordered_list_i_i.at((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_ORDERED_LIST_I_I_ERROR_OUT_IS_NULL);
}
