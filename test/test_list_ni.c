...
static void check_as_collection(void **state) {
    ...
    assert_int_equal(butterflyfish_list_ni_as_collection(
            &list, &collection), 0);
...
static void check_as_fixed_list_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_ni_as_fixed_list(NULL, (void *) 1),
            BUTTERFLYFISH_LIST_NI_ERROR_OBJECT_IS_NULL);
}

static void check_as_fixed_list_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_ni_as_fixed_list((void *) 1, NULL),
            BUTTERFLYFISH_LIST_NI_ERROR_OUT_IS_NULL);
}
...
static void check_as_fixed_list(void **state) {
    ...
    assert_int_equal(butterflyfish_list_ni_as_fixed_list(
            &list, &fixed_list), 0);
...
static void check_as_reducible_list_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_ni_as_reducible_list(NULL, (void *) 1),
            BUTTERFLYFISH_LIST_NI_ERROR_OBJECT_IS_NULL);
}

static void check_as_reducible_list_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_ni_as_reducible_list((void *) 1, NULL),
            BUTTERFLYFISH_LIST_NI_ERROR_OUT_IS_NULL);
}
...
static void check_as_reducible_list(void **state) {
    ...
    assert_int_equal(butterflyfish_list_ni_as_reducible_list(
...
static void check_count(void **state) {
    ...
    const struct butterflyfish_list_ni list_ni = {
            .reducible_list_ni.fixed_list_ni.collection_ni.count = count
    };
    struct object {
        const struct butterflyfish_list_ni *list_ni;
    };
    ...
    uintmax_t out;
    assert_int_equal(butterflyfish_list_ni_count(
            (const struct butterflyfish_list_ni *) &instance, &out), 0);
...
static void check_at_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_ni_at(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_LIST_NI_ERROR_OBJECT_IS_NULL);
}

static void check_at_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_ni_at((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_LIST_NI_ERROR_ITEM_IS_NULL);
}

static void check_at_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_ni_at((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_LIST_NI_ERROR_OUT_IS_NULL);
}
...
static void check_remove(void **state) {
    const struct butterflyfish_list_ni list_ni = {
            .reducible_list_ni.remove = remove
    };
    struct object {
        const struct butterflyfish_list_ni *list_ni;
    };
    ...
    assert_int_equal(
            butterflyfish_list_ni_remove(
                    (struct butterflyfish_list_ni *) &instance, 0),
            0);
}
...
static void check_remove_item(void **state) {
    const struct butterflyfish_list_ni list_ni = {
            .reducible_list_ni.remove_item = remove_item
    };
    struct object {
        const struct butterflyfish_list_ni *list_ni;
    };
    ...
    assert_int_equal(
            butterflyfish_list_ni_remove_item(
                    (struct butterflyfish_list_ni *) &instance,
                    (void *) 1),
            0);
}
...
static void check_remove_items(void **state) {
    const struct butterflyfish_list_ni list_ni = {
            .reducible_list_ni.remove_all_items = remove_all_items
    };
    struct object {
        const struct butterflyfish_list_ni *list_ni;
    };
    ...
    assert_int_equal(
            butterflyfish_list_ni_remove_all_items(
                    (struct butterflyfish_list_ni *) &instance,
                    (void *) 1),
            0);
}
