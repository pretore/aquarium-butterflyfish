...
static void check_set_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_p_set((void *) 1, 0, NULL),
            BUTTERFLYFISH_LIST_P_ERROR_VALUE_IS_NULL);
}
...
static void check_add_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_p_add((void *) 1, NULL),
            BUTTERFLYFISH_LIST_P_ERROR_VALUE_IS_NULL);
}
...
static void check_insert_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_p_insert((void *) 1, 0, NULL),
            BUTTERFLYFISH_LIST_P_ERROR_VALUE_IS_NULL);
}
