...
static void check_as_stream_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_p_as_stream(NULL, (void *) 1),
            BUTTERFLYFISH_LIST_P_ERROR_OBJECT_IS_NULL);
}

static void check_as_stream_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_p_as_stream((void *) 1, NULL),
            BUTTERFLYFISH_LIST_P_ERROR_OUT_IS_NULL);
}

static void check_as_stream(void **state) {
    struct butterflyfish_list_p list = {};
    const struct butterflyfish_stream_p *stream;
    assert_int_equal(butterflyfish_list_p_as_stream(&list, &stream), 0);
    assert_ptr_equal(&list, stream);
}

static void check_as_collection_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_p_as_collection(NULL, (void *) 1),
            BUTTERFLYFISH_LIST_P_ERROR_OBJECT_IS_NULL);
}

static void check_as_collection_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_p_as_collection((void *) 1, NULL),
            BUTTERFLYFISH_LIST_P_ERROR_OUT_IS_NULL);
}
...
static void check_as_collection(void **state) {
    ...
    assert_int_equal(butterflyfish_list_p_as_collection(
            &list, &collection), 0);
...
static void check_as_fixed_list_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_p_as_fixed_list(NULL, (void *) 1),
            BUTTERFLYFISH_LIST_P_ERROR_OBJECT_IS_NULL);
}

static void check_as_fixed_list_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_p_as_fixed_list((void *) 1, NULL),
            BUTTERFLYFISH_LIST_P_ERROR_OUT_IS_NULL);
}
...
static void check_as_fixed_list(void **state) {
    ...
    assert_int_equal(butterflyfish_list_p_as_fixed_list(
            &list, &fixed_list), 0);
...
static void check_as_reducible_list_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_p_as_reducible_list(NULL, (void *) 1),
            BUTTERFLYFISH_LIST_P_ERROR_OBJECT_IS_NULL);
}

static void check_as_reducible_list_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_p_as_reducible_list((void *) 1, NULL),
            BUTTERFLYFISH_LIST_P_ERROR_OUT_IS_NULL);
}

static void check_as_reducible_list(void **state) {
    struct butterflyfish_list_p list = {};
    struct butterflyfish_reducible_list_p *reducible_list;
    assert_int_equal(butterflyfish_list_p_as_reducible_list(
...
static void check_count_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_p_count(NULL, (void *) 1),
            BUTTERFLYFISH_LIST_P_ERROR_OBJECT_IS_NULL);
}

static void check_count_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_p_count((void *) 1, NULL),
            BUTTERFLYFISH_LIST_P_ERROR_OUT_IS_NULL);
}
...
static void check_count(void **state) {
    srand(time(NULL));
    const struct butterflyfish_list_p list_p = {
            .reducible_list_p.fixed_list_p.collection_p.count = count
    };
    struct object {
        const struct butterflyfish_list_p *list_p;
    };
    ...
    uintmax_t out;
    assert_int_equal(butterflyfish_list_p_count(
            (const struct butterflyfish_list_p *) &instance, &out), 0);
...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_p_first(NULL, (void *) 1),
            BUTTERFLYFISH_LIST_P_ERROR_OBJECT_IS_NULL);
}

static void check_first_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_p_first((void *) 1, NULL),
            BUTTERFLYFISH_LIST_P_ERROR_OUT_IS_NULL);
}
...
static void check_first_error_on_list_is_empty(void **state) {
    const struct butterflyfish_list_p list_p = {
            .reducible_list_p.fixed_list_p.collection_p.stream_p.first
            = fl_emit_error
    };
    struct object {
        const struct butterflyfish_list_p *list_p;
    ...
    will_return(fl_emit_error,
                BUTTERFLYFISH_LIST_P_ERROR_LIST_IS_EMPTY);
    assert_int_equal(
            butterflyfish_list_p_first(
                    (const struct butterflyfish_list_p *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_LIST_P_ERROR_LIST_IS_EMPTY);
}
...
static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_p_last(NULL, (void *) 1),
            BUTTERFLYFISH_LIST_P_ERROR_OBJECT_IS_NULL);
}

static void check_last_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_p_last((void *) 1, NULL),
            BUTTERFLYFISH_LIST_P_ERROR_OUT_IS_NULL);
}

static void check_last_error_on_list_is_empty(void **state) {
    const struct butterflyfish_list_p list_p = {
            .reducible_list_p.fixed_list_p.collection_p.last = fl_emit_error
    };
    struct object {
        const struct butterflyfish_list_p *list_p;
    };
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_p_next(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_LIST_P_ERROR_OBJECT_IS_NULL);
}

static void check_next_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_p_next((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_LIST_P_ERROR_ITEM_IS_NULL);
}

static void check_next_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_p_next((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_LIST_P_ERROR_OUT_IS_NULL);
}
...
static void check_next_error_on_end_of_sequence(void **state) {
    const struct butterflyfish_list_p list_p = {
            .reducible_list_p.fixed_list_p.collection_p.stream_p.next
            = np_emit_error
    };
    struct object {
        const struct butterflyfish_list_p *list_p;
    ...
    will_return(np_emit_error,
                BUTTERFLYFISH_LIST_P_ERROR_END_OF_SEQUENCE);
    assert_int_equal(
            butterflyfish_list_p_next(
                    (const struct butterflyfish_list_p *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_LIST_P_ERROR_END_OF_SEQUENCE);
...
static void check_prev_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_p_prev(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_LIST_P_ERROR_OBJECT_IS_NULL);
}

static void check_prev_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_p_prev((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_LIST_P_ERROR_ITEM_IS_NULL);
}

static void check_prev_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_p_prev((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_LIST_P_ERROR_OUT_IS_NULL);
}

static void check_prev_error_on_end_of_sequence(void **state) {
    const struct butterflyfish_list_p list_p = {
            .reducible_list_p.fixed_list_p.collection_p.prev = np_emit_error
    };
    struct object {
        const struct butterflyfish_list_p *list_p;
    };
...
static void check_get_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_p_get(NULL, 0, (void *) 1),
            BUTTERFLYFISH_LIST_P_ERROR_OBJECT_IS_NULL);
}

static void check_get_error_on_out(void **state) {
    assert_int_equal(
            butterflyfish_list_p_get((void *) 1, 0, NULL),
            BUTTERFLYFISH_LIST_P_ERROR_OUT_IS_NULL);
}
...
static void check_get_error_on_index_out_of_bounds(void **state) {
    const struct butterflyfish_list_p list_p = {
            .reducible_list_p.fixed_list_p.get = get_emit_error
    };
    struct object {
        const struct butterflyfish_list_p *list_p;
    };
    ...
    will_return(get_emit_error,
                BUTTERFLYFISH_LIST_P_ERROR_INDEX_IS_OUT_OF_BOUNDS);
    assert_int_equal(
            butterflyfish_list_p_get(
                    (const struct butterflyfish_list_p *) &instance,
                    0,
                    (void *) 1),
            BUTTERFLYFISH_LIST_P_ERROR_INDEX_IS_OUT_OF_BOUNDS);
...
static void check_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_p_set(NULL, 0, (void *) 1),
            BUTTERFLYFISH_LIST_P_ERROR_OBJECT_IS_NULL);
}
...
static void check_set_error_on_index_out_of_bounds(void **state) {
    const struct butterflyfish_list_p list_p = {
            .reducible_list_p.fixed_list_p.set = set_emit_error
    };
    struct object {
        const struct butterflyfish_list_p *list_p;
    };
    ...
    will_return(set_emit_error,
                BUTTERFLYFISH_LIST_P_ERROR_INDEX_IS_OUT_OF_BOUNDS);
    assert_int_equal(
            butterflyfish_list_p_set(
                    (struct butterflyfish_list_p *) &instance,
                    0,
                    (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_LIST_P_ERROR_INDEX_IS_OUT_OF_BOUNDS);
}
...
static void check_set_error_on_memory_allocation_failed(void **state) {
    ...
    expect_function_call(set_emit_error);
    will_return(set_emit_error,
                BUTTERFLYFISH_LIST_P_ERROR_MEMORY_ALLOCATION_FAILED);
    assert_int_equal(
            butterflyfish_list_p_set(
                    (struct butterflyfish_list_p *) &instance,
                    0,
...
static void check_set_error_on_value_is_invalid(void **state) {
    ...
    expect_function_call(set_emit_error);
    will_return(set_emit_error,
                BUTTERFLYFISH_LIST_P_ERROR_VALUE_IS_INVALID);
    assert_int_equal(
            butterflyfish_list_p_set(
                    (struct butterflyfish_list_p *) &instance,
                    0,
...
static void check_set_item_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_p_set_item(NULL, (void *) 1, 0),
            BUTTERFLYFISH_LIST_P_ERROR_OBJECT_IS_NULL);
}

static void check_set_item_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_p_set_item((void *) 1, NULL, 0),
            BUTTERFLYFISH_LIST_P_ERROR_ITEM_IS_NULL);
}
...
static void check_set_item_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_list_p list_p = {
            .reducible_list_p.fixed_list_p.set_item = set_item_emit_error
    };
    struct object {
        const struct butterflyfish_list_p *list_p;
    };
...
static void check_at_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_p_at(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_LIST_P_ERROR_OBJECT_IS_NULL);
}

static void check_at_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_p_at((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_LIST_P_ERROR_ITEM_IS_NULL);
}

static void check_at_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_p_at((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_LIST_P_ERROR_OUT_IS_NULL);
}
...
static void check_at_error_on_item_is_out_of_bounds(void **state) {
    const struct butterflyfish_list_p list_p = {
            .reducible_list_p.fixed_list_p.at = at_emit_error
    };
    struct object {
        const struct butterflyfish_list_p *list_p;
    };
    ...
    will_return(at_emit_error,
                BUTTERFLYFISH_LIST_P_ERROR_ITEM_IS_OUT_OF_BOUNDS);
    assert_int_equal(
            butterflyfish_list_p_at(
                    (struct butterflyfish_list_p *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_LIST_P_ERROR_ITEM_IS_OUT_OF_BOUNDS);
...
static void check_remove_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_p_remove(NULL, 0),
            BUTTERFLYFISH_LIST_P_ERROR_OBJECT_IS_NULL);
}
...
static void check_remove_error_on_index_out_of_bounds(void **state) {
    const struct butterflyfish_list_p list_p = {
            .reducible_list_p.remove = remove_emit_error
    };
    struct object {
        const struct butterflyfish_list_p *list_p;
    };
...
static void check_remove(void **state) {
    const struct butterflyfish_list_p list_p = {
            .reducible_list_p.remove = remove
    };
    struct object {
        const struct butterflyfish_list_p *list_p;
    };
    ...
    assert_int_equal(
            butterflyfish_list_p_remove(
                    (struct butterflyfish_list_p *) &instance, 0),
            0);
}
...
static void check_remove_item_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_p_remove_item(NULL, (void *) 1),
            BUTTERFLYFISH_LIST_P_ERROR_OBJECT_IS_NULL);
}

static void check_remove_item_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_p_remove_item((void *) 1, NULL),
            BUTTERFLYFISH_LIST_P_ERROR_ITEM_IS_NULL);
}
...
static void check_remove_item(void **state) {
    const struct butterflyfish_list_p list_p = {
            .reducible_list_p.remove_item = remove_item
    };
    struct object {
        const struct butterflyfish_list_p *list_p;
    };
    ...
    assert_int_equal(
            butterflyfish_list_p_remove_item(
                    (struct butterflyfish_list_p *) &instance,
                    (void *) 1),
            0);
}
...
static void check_remove_items_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_p_remove_all_items(NULL, (void *) 1),
            BUTTERFLYFISH_LIST_P_ERROR_OBJECT_IS_NULL);
}

static void check_remove_items_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_p_remove_all_items((void *) 1, NULL),
            BUTTERFLYFISH_LIST_P_ERROR_OTHER_IS_NULL);
}
...
static void check_remove_items(void **state) {
    const struct butterflyfish_list_p list_p = {
            .reducible_list_p.remove_all_items = remove_all_items
    };
    struct object {
        const struct butterflyfish_list_p *list_p;
    };
    ...
    assert_int_equal(
            butterflyfish_list_p_remove_all_items(
                    (struct butterflyfish_list_p *) &instance,
                    (void *) 1),
            0);
}
...
static void check_add_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_p_add(NULL, (void *) 1),
            BUTTERFLYFISH_LIST_P_ERROR_OBJECT_IS_NULL);
}
...
static void check_add_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_p_add_all(NULL, (void *) 1),
            BUTTERFLYFISH_LIST_P_ERROR_OBJECT_IS_NULL);
}

static void check_add_all_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_p_add_all((void *) 1, NULL),
            BUTTERFLYFISH_LIST_P_ERROR_OTHER_IS_NULL);
}
...
static void check_insert_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_p_insert(NULL, 0, (void *) 1),
            BUTTERFLYFISH_LIST_P_ERROR_OBJECT_IS_NULL);
}
...
static void check_insert_item_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_p_insert_item(NULL, (void *) 1, 0),
            BUTTERFLYFISH_LIST_P_ERROR_OBJECT_IS_NULL);
}

static void check_insert_item_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_p_insert_item((void *) 1, NULL, 0),
            BUTTERFLYFISH_LIST_P_ERROR_ITEM_IS_NULL);
}
...
static void check_insert_item_error_on_item_is_out_of_bounds(void **state) {
    ...
    will_return(insert_item_emit_error,
                BUTTERFLYFISH_LIST_P_ERROR_ITEM_IS_OUT_OF_BOUNDS);
    assert_int_equal(
            butterflyfish_list_p_insert_item(
                    (struct butterflyfish_list_p *) &instance,
                    (void *) 1,
                    0),
            BUTTERFLYFISH_LIST_P_ERROR_ITEM_IS_OUT_OF_BOUNDS);
...
static void check_insert_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_p_insert_all(NULL, 0, (void *) 1),
            BUTTERFLYFISH_LIST_P_ERROR_OBJECT_IS_NULL);
}

static void check_insert_all_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_p_insert_all((void *) 1, 0, NULL),
            BUTTERFLYFISH_LIST_P_ERROR_OTHER_IS_NULL);
}
...
static void check_insert_all_error_on_index_is_out_of_bounds(void **state) {
    ...
    will_return(insert_all_emit_error,
                BUTTERFLYFISH_LIST_P_ERROR_INDEX_IS_OUT_OF_BOUNDS);
    assert_int_equal(
            butterflyfish_list_p_insert_all(
                    (struct butterflyfish_list_p *) &instance,
                    0,
                    (void *) 1),
            BUTTERFLYFISH_LIST_P_ERROR_INDEX_IS_OUT_OF_BOUNDS);
...
static void check_insert_all_item_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_p_insert_all_item(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_LIST_P_ERROR_OBJECT_IS_NULL);
}

static void check_insert_all_item_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_p_insert_all_item((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_LIST_P_ERROR_ITEM_IS_NULL);
}

static void check_insert_all_item_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_p_insert_all_item((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_LIST_P_ERROR_OTHER_IS_NULL);
}
...
static void check_insert_all_item_error_on_item_is_out_of_bounds(void **state) {
    ...
    will_return(insert_all_item_emit_error,
                BUTTERFLYFISH_LIST_P_ERROR_ITEM_IS_OUT_OF_BOUNDS);
    assert_int_equal(
            butterflyfish_list_p_insert_all_item(
                    (struct butterflyfish_list_p *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_LIST_P_ERROR_ITEM_IS_OUT_OF_BOUNDS);
