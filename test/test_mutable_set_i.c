...
struct instance {
    const struct butterflyfish_mutable_set_i *const id;
    void* data;
};
...
static int stream_first(const void *const object,
    ...
    seagrass_required_true(&mutable_set_i == instance->id);
    return mock();
}
...
butterflyfish_settable_incremental_set_i settable_incremental_set_i = {
        ...
        .as_incremental_set = &incremental_set_i,
...
const struct butterflyfish_mutable_set_i mutable_set_i = {
        ...
        .as_incremental_set = &incremental_set_i,
        .as_reducible_set = &reducible_set_i,
        .as_settable_incremental_set_i = &settable_incremental_set_i,
        .as_settable_reducible_set_i = &settable_reducible_set_i,
        .first = stream_first,
        .next = stream_next,
        .count = collection_count,
        .last = collection_last,
...
static void check_as_stream(void **state) {
    assert_ptr_equal(mutable_set_i.as_stream, &stream_i);
}

static void check_as_collection(void **state) {
    assert_ptr_equal(mutable_set_i.as_collection, &collection_i);
}

static void check_as_settable(void **state) {
    assert_ptr_equal(mutable_set_i.as_settable, &settable_i);
}

static void check_as_addable(void **state) {
    assert_ptr_equal(mutable_set_i.as_addable, &addable_i);
}

static void check_as_removable(void **state) {
    assert_ptr_equal(mutable_set_i.as_removable, &removable_i);
}

static void check_as_set(void **state) {
    assert_ptr_equal(mutable_set_i.as_set, &set_i);
}

static void check_as_settable_set(void **state) {
    assert_ptr_equal(mutable_set_i.as_settable_set, &settable_set_i);
}

static void check_as_incremental_set(void **state) {
    assert_ptr_equal(mutable_set_i.as_incremental_set, &incremental_set_i);
}

static void check_as_reducible_set(void **state) {
    assert_ptr_equal(mutable_set_i.as_reducible_set, &reducible_set_i);
}

static void check_as_settable_incremental_set(void **state) {
    assert_ptr_equal(mutable_set_i.as_settable_incremental_set_i,
                     &settable_incremental_set_i);
}

static void check_as_settable_reducible_set(void **state) {
    assert_ptr_equal(mutable_set_i.as_settable_reducible_set_i,
                     &settable_reducible_set_i);
}

static void check_count_error_on_object_is_null(void **state) {
    assert_int_equal(mutable_set_i.count(NULL, (void *) 1),
                     BUTTERFLYFISH_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_count_error_on_out_is_null(void **state) {
    assert_int_equal(mutable_set_i.count((void *) 1, NULL),
...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(mutable_set_i.first(NULL, (void *) 1),
                     BUTTERFLYFISH_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_first_error_on_out_is_null(void **state) {
    assert_int_equal(mutable_set_i.first((void *) 1, NULL),
                     BUTTERFLYFISH_MUTABLE_SET_I_ERROR_OUT_IS_NULL);
}
...
static void check_first_error_on_set_is_empty(void **state) {
    ...
    assert_int_equal(mutable_set_i.first(&instance, (void *) 1),
                     BUTTERFLYFISH_MUTABLE_SET_I_ERROR_SET_IS_EMPTY);
}

static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(mutable_set_i.last(NULL, (void *) 1),
                     BUTTERFLYFISH_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_last_error_on_out_is_null(void **state) {
    assert_int_equal(mutable_set_i.last((void *) 1, NULL),
                     BUTTERFLYFISH_MUTABLE_SET_I_ERROR_OUT_IS_NULL);
}
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(mutable_set_i.next(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_next_error_on_item_is_null(void **state) {
    assert_int_equal(mutable_set_i.next((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_MUTABLE_SET_I_ERROR_ITEM_IS_NULL);
}

static void check_next_error_on_out_is_null(void **state) {
    assert_int_equal(mutable_set_i.next((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_MUTABLE_SET_I_ERROR_OUT_IS_NULL);
}
...
static void check_prev_error_on_object_is_null(void **state) {
    assert_int_equal(mutable_set_i.prev(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_prev_error_on_item_is_null(void **state) {
    assert_int_equal(mutable_set_i.prev((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_MUTABLE_SET_I_ERROR_ITEM_IS_NULL);
}

static void check_prev_error_on_out_is_null(void **state) {
    assert_int_equal(mutable_set_i.prev((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_MUTABLE_SET_I_ERROR_OUT_IS_NULL);
}
...
static void check_contains_error_on_object_is_null(void **state) {
    assert_int_equal(mutable_set_i.contains(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_contains_error_on_value_is_null(void **state) {
    assert_int_equal(mutable_set_i.contains((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_MUTABLE_SET_I_ERROR_VALUE_IS_NULL);
}

static void check_contains_error_on_out_is_null(void **state) {
    assert_int_equal(mutable_set_i.contains((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_MUTABLE_SET_I_ERROR_OUT_IS_NULL);
}
...
static void check_get_error_on_object_is_null(void **state) {
    assert_int_equal(mutable_set_i.get(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_get_error_on_value_is_null(void **state) {
    assert_int_equal(mutable_set_i.get((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_MUTABLE_SET_I_ERROR_VALUE_IS_NULL);
}

static void check_get_error_on_out_is_null(void **state) {
    assert_int_equal(mutable_set_i.get((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_MUTABLE_SET_I_ERROR_OUT_IS_NULL);
}
...
static void check_set_item_error_on_object_is_null(void **state) {
    assert_int_equal(mutable_set_i.set_item(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_set_item_error_on_item_is_null(void **state) {
    assert_int_equal(mutable_set_i.set_item((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_MUTABLE_SET_I_ERROR_ITEM_IS_NULL);
}

static void check_set_item_error_on_value_is_null(void **state) {
    assert_int_equal(mutable_set_i.set_item((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_MUTABLE_SET_I_ERROR_VALUE_IS_NULL);
}
...
static void check_set_error_on_object_is_null(void **state) {
    assert_int_equal(mutable_set_i.set(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_set_error_on_item_is_null(void **state) {
    assert_int_equal(mutable_set_i.set((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_MUTABLE_SET_I_ERROR_ITEM_IS_NULL);
}

static void check_set_error_on_value_is_null(void **state) {
    assert_int_equal(mutable_set_i.set((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_MUTABLE_SET_I_ERROR_VALUE_IS_NULL);
}
...
static void check_add_error_on_object_is_null(void **state) {
    assert_int_equal(mutable_set_i.add(NULL, (void *) 1),
                     BUTTERFLYFISH_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_add_error_on_value_is_null(void **state) {
    assert_int_equal(mutable_set_i.add((void *) 1, NULL),
                     BUTTERFLYFISH_MUTABLE_SET_I_ERROR_VALUE_IS_NULL);
}
...
static void check_remove_item_error_on_object_is_null(void **state) {
    assert_int_equal(mutable_set_i.remove_item(NULL, (void *) 1),
                     BUTTERFLYFISH_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_remove_item_error_on_item_is_null(void **state) {
    assert_int_equal(mutable_set_i.remove_item((void *) 1, NULL),
                     BUTTERFLYFISH_MUTABLE_SET_I_ERROR_ITEM_IS_NULL);
}
...
static void check_remove_item(void **state) {
    ...
    assert_int_equal(mutable_set_i.remove_item(&instance, (void *) 1), 0);
}

static void check_remove_error_on_object_is_null(void **state) {
    assert_int_equal(mutable_set_i.remove(NULL, (void *) 1),
                     BUTTERFLYFISH_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_remove_error_on_value_is_null(void **state) {
    assert_int_equal(mutable_set_i.remove((void *) 1, NULL),
                     BUTTERFLYFISH_MUTABLE_SET_I_ERROR_VALUE_IS_NULL);
}
