...
static void check_count(void **state) {
    ...
    uintmax_t out;
    assert_int_equal(
            butterflyfish_sorted_set_p_count(
...
static void check_remove_item(void **state) {
    const struct butterflyfish_sorted_set_p sorted_set_p = {
            .ordered_set_p.set_p.remove_item = remove_item
    };
    struct object {
        const struct butterflyfish_sorted_set_p *sorted_set_p;
    };
    ...
    assert_int_equal(
            butterflyfish_sorted_set_p_remove_item(
...
static void check_remove_all_items(void **state) {
    const struct butterflyfish_sorted_set_p sorted_set_p = {
            .ordered_set_p.set_p.remove_all_items = remove_all_items
    };
    struct object {
        const struct butterflyfish_sorted_set_p *sorted_set_p;
    };
    ...
    assert_int_equal(
            butterflyfish_sorted_set_p_remove_all_items(
                    (struct butterflyfish_sorted_set_p *) &instance,
                    (void *) 1),
            0);
}
...
static void check_contains_error_on_memory_allocation_failed(void **state) {
    ...
    will_return(contains_emit_error,
                BUTTERFLYFISH_SORTED_SET_P_ERROR_MEMORY_ALLOCATION_FAILED);
    assert_int_equal(
            butterflyfish_sorted_set_p_contains(
                    (struct butterflyfish_sorted_set_p *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_SET_P_ERROR_MEMORY_ALLOCATION_FAILED);
