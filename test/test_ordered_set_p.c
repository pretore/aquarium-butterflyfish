...
static void check_as_stream_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_p_as_stream(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SET_P_ERROR_OBJECT_IS_NULL);
}

static void check_as_stream_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_p_as_stream((void *) 1, NULL),
...
static void check_as_stream(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_set_p_as_stream(
...
static void check_as_collection_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_p_as_collection(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SET_P_ERROR_OBJECT_IS_NULL);
}

static void check_as_collection_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_p_as_collection((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_SET_P_ERROR_OUT_IS_NULL);
}
...
static void check_as_collection(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_set_p_as_collection(
...
static void check_as_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_p_as_set(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SET_P_ERROR_OBJECT_IS_NULL);
}

static void check_as_set_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_p_as_set((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_SET_P_ERROR_OUT_IS_NULL);
}
...
static void check_as_set(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_set_p_as_set(
            &ordered_set, &set), 0);
...
static void check_count_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_p_count(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SET_P_ERROR_OBJECT_IS_NULL);
}

static void check_count_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_p_count((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_SET_P_ERROR_OUT_IS_NULL);
}
...
static void check_count(void **state) {
    ...
    const struct butterflyfish_ordered_set_p ordered_set_p = {
            .set_p.collection_p.count = count
    };
    struct object {
        const struct butterflyfish_ordered_set_p *ordered_set_p;
    };
    struct object instance = {
            .ordered_set_p = &ordered_set_p
    };
    ...
    uintmax_t out;
    assert_int_equal(
            butterflyfish_ordered_set_p_count(
...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_p_first(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SET_P_ERROR_OBJECT_IS_NULL);
}

static void check_first_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_p_first((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_SET_P_ERROR_OUT_IS_NULL);
}
...
static void check_first_error_on_set_is_empty(void **state) {
    const struct butterflyfish_ordered_set_p ordered_set_p = {
            .set_p.collection_p.stream_p.first = fl_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_set_p *ordered_set_p;
    };
...
static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_p_last(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SET_P_ERROR_OBJECT_IS_NULL);
}

static void check_last_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_p_last((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_SET_P_ERROR_OUT_IS_NULL);
}

static void check_last_error_on_set_is_empty(void **state) {
    const struct butterflyfish_ordered_set_p ordered_set_p = {
            .set_p.collection_p.last = fl_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_set_p *ordered_set_p;
    };
...
static void check_remove_item_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_p_remove_item(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SET_P_ERROR_OBJECT_IS_NULL);
}

static void check_remove_item_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_p_remove_item((void *) 1, NULL),
...
static void check_remove_item(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_set_p_remove_item(
...
static void check_remove_all_items_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_p_remove_all_items(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SET_P_ERROR_OBJECT_IS_NULL);
}

static void check_remove_all_items_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_p_remove_all_items((void *) 1, NULL),
...
static void check_remove_all_items(void **state) {
    const struct butterflyfish_ordered_set_p ordered_set_p = {
            .set_p.remove_all_items = remove_all_items
    };
    struct object {
        const struct butterflyfish_ordered_set_p *ordered_set_p;
    };
    ...
    assert_int_equal(
            butterflyfish_ordered_set_p_remove_all_items(
                    (struct butterflyfish_ordered_set_p *) &instance,
                    (void *) 1),
            0);
}
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_p_next(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_SET_P_ERROR_OBJECT_IS_NULL);
}

static void check_next_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_p_next((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SET_P_ERROR_ITEM_IS_NULL);
}

static void check_next_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_p_next((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_SET_P_ERROR_OUT_IS_NULL);
}
...
static void check_next_error_on_end_of_sequence(void **state) {
    const struct butterflyfish_ordered_set_p ordered_set_p = {
            .set_p.collection_p.stream_p.next = np_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_set_p *ordered_set_p;
    };
...
static void check_prev_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_p_prev(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_SET_P_ERROR_OBJECT_IS_NULL);
}

static void check_prev_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_p_prev((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SET_P_ERROR_ITEM_IS_NULL);
}

static void check_prev_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_p_prev((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_SET_P_ERROR_OUT_IS_NULL);
}

static void check_prev_error_on_end_of_sequence(void **state) {
    const struct butterflyfish_ordered_set_p ordered_set_p = {
            .set_p.collection_p.prev = np_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_set_p *ordered_set_p;
    };
...
static void check_add_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_p_add(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SET_P_ERROR_OBJECT_IS_NULL);
}
...
static void check_add_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_p_add_all(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SET_P_ERROR_OBJECT_IS_NULL);
}

static void check_add_all_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_p_add_all((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_SET_P_ERROR_OTHER_IS_NULL);
}
...
static void check_add_all_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_ordered_set_p ordered_set_p = {
            .set_p.add_all = ar_all_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_set_p *ordered_set_p;
    };
...
static void check_remove_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_p_remove(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SET_P_ERROR_OBJECT_IS_NULL);
}
...
static void check_contains_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_p_contains((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_SET_P_ERROR_OUT_IS_NULL);
}
...
static void check_contains_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_ordered_set_p ordered_set_p = {
            .set_p.contains = contains_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_set_p *ordered_set_p;
    };
    ...
    will_return(contains_emit_error,
                BUTTERFLYFISH_ORDERED_SET_P_ERROR_MEMORY_ALLOCATION_FAILED);
    assert_int_equal(
            butterflyfish_ordered_set_p_contains(
                    (struct butterflyfish_ordered_set_p *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_ORDERED_SET_P_ERROR_MEMORY_ALLOCATION_FAILED);
...
static void check_contains_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_p_contains_all(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_SET_P_ERROR_OBJECT_IS_NULL);
}
...
check_contains_all_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_ordered_set_p ordered_set_p = {
            .set_p.contains_all = contains_all_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_set_p *ordered_set_p;
    };
...
static void check_retain_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_p_retain_all(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SET_P_ERROR_OBJECT_IS_NULL);
}

static void check_retain_all_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_p_retain_all((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_SET_P_ERROR_OTHER_IS_NULL);
}
...
check_retain_all_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_ordered_set_p ordered_set_p = {
            .set_p.retain_all = retain_all_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_set_p *ordered_set_p;
    };
...
static void check_get_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_p_get(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_SET_P_ERROR_OBJECT_IS_NULL);
}
