...
struct instance {
    const struct butterflyfish_sorted_i *const id;
    void *data;
};
...
static int stream_first(const void *const object,
    ...
    seagrass_required_true(&sorted_i == instance->id);
    return mock();
}
...
static void check_as_stream(void **state) {
    assert_ptr_equal(sorted_i.as_stream, &stream_i);
}

static void check_as_collection(void **state) {
    assert_ptr_equal(sorted_i.as_collection, &collection_i);
}

static void check_count_error_on_object_is_null(void **state) {
    assert_int_equal(sorted_i.count(NULL, (void *) 1),
                     BUTTERFLYFISH_SORTED_I_ERROR_OBJECT_IS_NULL);
}

static void check_count_error_on_out_is_null(void **state) {
    assert_int_equal(sorted_i.count((void *) 1, NULL),
...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(sorted_i.first(NULL, (void *) 1),
                     BUTTERFLYFISH_SORTED_I_ERROR_OBJECT_IS_NULL);
}

static void check_first_error_on_out_is_null(void **state) {
    assert_int_equal(sorted_i.first((void *) 1, NULL),
                     BUTTERFLYFISH_SORTED_I_ERROR_OUT_IS_NULL);
}
...
static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(sorted_i.last(NULL, (void *) 1),
                     BUTTERFLYFISH_SORTED_I_ERROR_OBJECT_IS_NULL);
}

static void check_last_error_on_out_is_null(void **state) {
    assert_int_equal(sorted_i.last((void *) 1, NULL),
                     BUTTERFLYFISH_SORTED_I_ERROR_OUT_IS_NULL);
}
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(sorted_i.next(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_SORTED_I_ERROR_OBJECT_IS_NULL);
}

static void check_next_error_on_item_is_null(void **state) {
    assert_int_equal(sorted_i.next((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_SORTED_I_ERROR_ITEM_IS_NULL);
}

static void check_next_error_on_out_is_null(void **state) {
    assert_int_equal(sorted_i.next((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_SORTED_I_ERROR_OUT_IS_NULL);
}
...
static void check_prev_error_on_object_is_null(void **state) {
    assert_int_equal(sorted_i.prev(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_SORTED_I_ERROR_OBJECT_IS_NULL);
}

static void check_prev_error_on_item_is_null(void **state) {
    assert_int_equal(sorted_i.prev((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_SORTED_I_ERROR_ITEM_IS_NULL);
}

static void check_prev_error_on_out_is_null(void **state) {
    assert_int_equal(sorted_i.prev((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_SORTED_I_ERROR_OUT_IS_NULL);
}
...
static void check_floor_error_on_object_is_null(void **state) {
    assert_int_equal(sorted_i.floor(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_SORTED_I_ERROR_OBJECT_IS_NULL);
}

static void check_floor_error_on_value_is_null(void **state) {
    assert_int_equal(sorted_i.floor((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_SORTED_I_ERROR_VALUE_IS_NULL);
}

static void check_floor_error_on_out_is_null(void **state) {
    assert_int_equal(sorted_i.floor((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_SORTED_I_ERROR_OUT_IS_NULL);
}
...
static void check_higher_error_on_object_is_null(void **state) {
    assert_int_equal(sorted_i.higher(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_SORTED_I_ERROR_OBJECT_IS_NULL);
}

static void check_higher_error_on_value_is_null(void **state) {
    assert_int_equal(sorted_i.higher((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_SORTED_I_ERROR_VALUE_IS_NULL);
}

static void check_higher_error_on_out_is_null(void **state) {
    assert_int_equal(sorted_i.higher((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_SORTED_I_ERROR_OUT_IS_NULL);
}
...
static void check_lower_error_on_object_is_null(void **state) {
    assert_int_equal(sorted_i.lower(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_SORTED_I_ERROR_OBJECT_IS_NULL);
}

static void check_lower_error_on_value_is_null(void **state) {
    assert_int_equal(sorted_i.lower((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_SORTED_I_ERROR_VALUE_IS_NULL);
}

static void check_lower_error_on_out_is_null(void **state) {
    assert_int_equal(sorted_i.lower((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_SORTED_I_ERROR_OUT_IS_NULL);
}
