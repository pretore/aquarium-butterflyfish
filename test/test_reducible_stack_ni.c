...
static void check_count_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_stack_ni_count((void *) 1, NULL),
            BUTTERFLYFISH_REDUCIBLE_STACK_NI_ERROR_OUT_IS_NULL);
}
...
static void check_count(void **state) {
    ...
    struct object instance = {
            .reducible_stack_ni = &reducible_stack_ni
    };
    ...
    uintmax_t out;
    assert_int_equal(
            butterflyfish_reducible_stack_ni_count(
...
static void check_first_error_on_stack_is_empty(void **state) {
    const struct butterflyfish_reducible_stack_ni stack_ni = {
...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_stack_ni_first(NULL, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_STACK_NI_ERROR_OBJECT_IS_NULL);
}

static void check_first_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_stack_ni_first((void *) 1, NULL),
            BUTTERFLYFISH_REDUCIBLE_STACK_NI_ERROR_OUT_IS_NULL);
}

static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_stack_ni_last(NULL, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_STACK_NI_ERROR_OBJECT_IS_NULL);
}

static void check_last_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_stack_ni_last((void *) 1, NULL),
            BUTTERFLYFISH_REDUCIBLE_STACK_NI_ERROR_OUT_IS_NULL);
}
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_stack_ni_next(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_STACK_NI_ERROR_OBJECT_IS_NULL);
}

static void check_next_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_stack_ni_next((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_STACK_NI_ERROR_ITEM_IS_NULL);
}

static void check_next_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_stack_ni_next((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_REDUCIBLE_STACK_NI_ERROR_OUT_IS_NULL);
}
...
static void check_prev_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_stack_ni_prev(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_STACK_NI_ERROR_OBJECT_IS_NULL);
}

static void check_prev_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_stack_ni_prev((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_STACK_NI_ERROR_ITEM_IS_NULL);
}

static void check_prev_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_stack_ni_prev((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_REDUCIBLE_STACK_NI_ERROR_OUT_IS_NULL);
}
...
static void check_pop_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_stack_ni_pop(NULL, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_STACK_NI_ERROR_OBJECT_IS_NULL);
}

static void check_pop_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_stack_ni_pop((void *) 1, NULL),
            BUTTERFLYFISH_REDUCIBLE_STACK_NI_ERROR_OUT_IS_NULL);
}
...
static void check_pop_error_on_stack_is_empty(void **state) {
    ...
    will_return(pop_emit_error,
                BUTTERFLYFISH_REDUCIBLE_STACK_NI_ERROR_STACK_IS_EMPTY);
    assert_int_equal(
            butterflyfish_reducible_stack_ni_pop(
                    (struct butterflyfish_reducible_stack_ni *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_STACK_NI_ERROR_STACK_IS_EMPTY);
}
