...
static void check_as_stream_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_queue_i_as_stream(NULL, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_QUEUE_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_stream_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_queue_i_as_stream((void *) 1, NULL),
...
static void check_as_stream(void **state) {
    ...
    assert_int_equal(butterflyfish_reducible_queue_i_as_stream(
...
static void check_as_collection_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_queue_i_as_collection(NULL, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_QUEUE_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_collection_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_queue_i_as_collection((void *) 1, NULL),
            BUTTERFLYFISH_REDUCIBLE_QUEUE_I_ERROR_OUT_IS_NULL);
}
...
static void check_as_collection(void **state) {
    ...
    assert_int_equal(butterflyfish_reducible_queue_i_as_collection(
...
static void check_count_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_queue_i_count(NULL, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_QUEUE_I_ERROR_OBJECT_IS_NULL);
}

static void check_count_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_queue_i_count((void *) 1, NULL),
            BUTTERFLYFISH_REDUCIBLE_QUEUE_I_ERROR_OUT_IS_NULL);
}
...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_queue_i_first(NULL, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_QUEUE_I_ERROR_OBJECT_IS_NULL);
}

static void check_first_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_queue_i_first((void *) 1, NULL),
            BUTTERFLYFISH_REDUCIBLE_QUEUE_I_ERROR_OUT_IS_NULL);
}

static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_queue_i_last(NULL, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_QUEUE_I_ERROR_OBJECT_IS_NULL);
}

static void check_last_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_queue_i_last((void *) 1, NULL),
            BUTTERFLYFISH_REDUCIBLE_QUEUE_I_ERROR_OUT_IS_NULL);
}
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_queue_i_next(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_QUEUE_I_ERROR_OBJECT_IS_NULL);
}

static void check_next_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_queue_i_next((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_QUEUE_I_ERROR_ITEM_IS_NULL);
}

static void check_next_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_queue_i_next((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_REDUCIBLE_QUEUE_I_ERROR_OUT_IS_NULL);
}
...
static void check_prev_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_queue_i_prev(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_QUEUE_I_ERROR_OBJECT_IS_NULL);
}

static void check_prev_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_queue_i_prev((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_QUEUE_I_ERROR_ITEM_IS_NULL);
}

static void check_prev_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_queue_i_prev((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_REDUCIBLE_QUEUE_I_ERROR_OUT_IS_NULL);
}
...
static void check_remove_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_queue_i_remove(NULL, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_QUEUE_I_ERROR_OBJECT_IS_NULL);
}

static void check_remove_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_queue_i_remove((void *) 1, NULL),
            BUTTERFLYFISH_REDUCIBLE_QUEUE_I_ERROR_OUT_IS_NULL);
}
