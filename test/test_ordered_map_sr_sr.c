...
static void check_as_stream_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_sr_sr_as_stream(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_OBJECT_IS_NULL);
}

static void check_as_stream_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_sr_sr_as_stream((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_OUT_IS_NULL);
}

static void check_as_stream(void **state) {
    struct butterflyfish_ordered_map_sr_sr ordered_map = {};
    const struct butterflyfish_stream_sr_sr *stream;
    assert_int_equal(butterflyfish_ordered_map_sr_sr_as_stream(
...
static void check_as_collection_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_sr_sr_as_collection(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_OBJECT_IS_NULL);
}

static void check_as_collection_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_sr_sr_as_collection((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_OUT_IS_NULL);
}
...
static void check_as_collection(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_map_sr_sr_as_collection(
...
static void check_as_map_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_sr_sr_as_map(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_OBJECT_IS_NULL);
}

static void check_as_map_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_sr_sr_as_map((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_OUT_IS_NULL);
}
...
static void check_as_map(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_map_sr_sr_as_map(
            &ordered_map, &map), 0);
...
static void check_count_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_sr_sr_count(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_OBJECT_IS_NULL);
}

static void check_count_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_sr_sr_count((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_OUT_IS_NULL);
}
...
static void check_count(void **state) {
    ...
    const struct butterflyfish_ordered_map_sr_sr ordered_map_sr_sr = {
            .map_sr_sr.collection_sr_sr.count = count
    };
    struct object {
        const struct butterflyfish_ordered_map_sr_sr *ordered_map_sr_sr;
    };
    struct object instance = {
            .ordered_map_sr_sr = &ordered_map_sr_sr
    };
...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_sr_sr_first(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_OBJECT_IS_NULL);
}

static void check_first_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_sr_sr_first((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_OUT_IS_NULL);
}
...
static void check_first_error_on_map_is_empty(void **state) {
    const struct butterflyfish_ordered_map_sr_sr ordered_map_sr_sr = {
            .map_sr_sr.collection_sr_sr.stream_sr_sr.first = fl_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_map_sr_sr *ordered_map_sr_sr;
    };
...
static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_sr_sr_last(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_OBJECT_IS_NULL);
}

static void check_last_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_sr_sr_last((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_OUT_IS_NULL);
}

static void check_last_error_on_map_is_empty(void **state) {
    const struct butterflyfish_ordered_map_sr_sr ordered_map_sr_sr = {
            .map_sr_sr.collection_sr_sr.last = fl_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_map_sr_sr *ordered_map_sr_sr;
    };
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_sr_sr_next(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_OBJECT_IS_NULL);
}

static void check_next_error_on_entry_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_sr_sr_next((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_ENTRY_IS_NULL);
}

static void check_next_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_sr_sr_next((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_OUT_IS_NULL);
}
...
static void check_next_error_on_end_of_sequence(void **state) {
    const struct butterflyfish_ordered_map_sr_sr ordered_map_sr_sr = {
            .map_sr_sr.collection_sr_sr.stream_sr_sr.next = np_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_map_sr_sr *ordered_map_sr_sr;
    };
...
static void check_prev_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_sr_sr_prev(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_OBJECT_IS_NULL);
}

static void check_prev_error_on_entry_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_sr_sr_prev((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_ENTRY_IS_NULL);
}

static void check_prev_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_sr_sr_prev((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_OUT_IS_NULL);
}

static void check_prev_error_on_end_of_sequence(void **state) {
    const struct butterflyfish_ordered_map_sr_sr ordered_map_sr_sr = {
            .map_sr_sr.collection_sr_sr.prev = np_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_map_sr_sr *ordered_map_sr_sr;
    };
...
static void check_remove_entry_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_sr_sr_remove_entry(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_OBJECT_IS_NULL);
}

static void check_remove_entry_error_on_entry_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_sr_sr_remove_entry((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_ENTRY_IS_NULL);
}
...
static void check_remove_entry(void **state) {
    const struct butterflyfish_ordered_map_sr_sr ordered_map_sr_sr = {
            .map_sr_sr.remove_entry = remove_entry
    };
    struct object {
        const struct butterflyfish_ordered_map_sr_sr *ordered_map_sr_sr;
    };
...
static void check_remove_all_entries_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_sr_sr_remove_all_entries(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_OBJECT_IS_NULL);
}

static void check_remove_all_entries_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_sr_sr_remove_all_entries((void *) 1, NULL),
...
static void check_remove_all_entries(void **state) {
    const struct butterflyfish_ordered_map_sr_sr ordered_map_sr_sr = {
            .map_sr_sr.remove_all_entries = remove_all_entries
    };
    struct object {
        const struct butterflyfish_ordered_map_sr_sr *ordered_map_sr_sr;
    };
...
static void check_add_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_sr_sr_add(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_OBJECT_IS_NULL);
}

static void check_add_error_on_key_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_sr_sr_add((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_KEY_IS_NULL);
}

static void check_add_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_sr_sr_add((void *) 1, (void *) 1, NULL),
...
static void check_put_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_sr_sr_put(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_OBJECT_IS_NULL);
}

static void check_put_error_on_key_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_sr_sr_put((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_KEY_IS_NULL);
}

static void check_put_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_sr_sr_put((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_VALUE_IS_NULL);
}

static void check_put_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_ordered_map_sr_sr ordered_map_sr_sr = {
            .map_sr_sr.put = apr_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_map_sr_sr *ordered_map_sr_sr;
    };
...
static void check_replace_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_sr_sr_replace(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_OBJECT_IS_NULL);
}

static void check_replace_error_on_key_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_sr_sr_replace((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_KEY_IS_NULL);
}

static void check_replace_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_sr_sr_replace((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_VALUE_IS_NULL);
}

static void check_replace_error_on_key_not_found(void **state) {
    const struct butterflyfish_ordered_map_sr_sr ordered_map_sr_sr = {
            .map_sr_sr.replace = apr_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_map_sr_sr *ordered_map_sr_sr;
    };
...
static void check_remove_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_sr_sr_remove(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_OBJECT_IS_NULL);
}

static void check_remove_error_on_key_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_sr_sr_remove((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_KEY_IS_NULL);
}
...
static void check_remove_error_on_key_not_found(void **state) {
    const struct butterflyfish_ordered_map_sr_sr ordered_map_sr_sr = {
            .map_sr_sr.remove = remove_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_map_sr_sr *ordered_map_sr_sr;
    };
...
static void check_add_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_sr_sr_add_all(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_OBJECT_IS_NULL);
}

static void check_add_all_error_on_key_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_sr_sr_add_all((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_OTHER_IS_NULL);
}
...
static void check_add_all_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_ordered_map_sr_sr ordered_map_sr_sr = {
            .map_sr_sr.add_all = all_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_map_sr_sr *ordered_map_sr_sr;
    };
...
static void check_put_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_sr_sr_put_all(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_OBJECT_IS_NULL);
}

static void check_put_all_error_on_key_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_sr_sr_put_all((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_OTHER_IS_NULL);
}

static void check_put_all_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_ordered_map_sr_sr ordered_map_sr_sr = {
            .map_sr_sr.put_all = all_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_map_sr_sr *ordered_map_sr_sr;
    };
...
static void check_replace_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_sr_sr_replace_all(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_OBJECT_IS_NULL);
}

static void check_replace_all_error_on_key_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_sr_sr_replace_all((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_OTHER_IS_NULL);
}

static void check_replace_all_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_ordered_map_sr_sr ordered_map_sr_sr = {
            .map_sr_sr.replace_all = all_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_map_sr_sr *ordered_map_sr_sr;
    };
...
static void check_remove_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_sr_sr_remove_all(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_OBJECT_IS_NULL);
}

static void check_remove_all_error_on_key_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_sr_sr_remove_all((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_OTHER_IS_NULL);
}
...
static void check_remove_all_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_ordered_map_sr_sr ordered_map_sr_sr = {
            .map_sr_sr.remove_all = rr_all_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_map_sr_sr *ordered_map_sr_sr;
    };
...
static void check_retain_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_sr_sr_retain_all(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_OBJECT_IS_NULL);
}

static void check_retain_all_error_on_key_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_sr_sr_retain_all((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_OTHER_IS_NULL);
}

static void check_retain_all_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_ordered_map_sr_sr ordered_map_sr_sr = {
            .map_sr_sr.retain_all = rr_all_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_map_sr_sr *ordered_map_sr_sr;
    };
...
static void check_merge_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_sr_sr_merge(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_OBJECT_IS_NULL);
}

static void check_merge_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_sr_sr_merge((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_OTHER_IS_NULL);
}

static void check_merge_error_on_function_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_sr_sr_merge((void *) 1, (void *) 1, NULL),
...
static void check_merge_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_ordered_map_sr_sr ordered_map_sr_sr = {
            .map_sr_sr.merge = merge_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_map_sr_sr *ordered_map_sr_sr;
    };
...
static void check_contains_key_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_sr_sr_contains_key(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_OBJECT_IS_NULL);
}

static void check_contains_key_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_sr_sr_contains_key((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_KEY_IS_NULL);
}

static void check_contains_key_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_sr_sr_contains_key((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_OUT_IS_NULL);
}
...
check_contains_key_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_ordered_map_sr_sr ordered_map_sr_sr = {
            .map_sr_sr.contains_key = contains_key_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_map_sr_sr *ordered_map_sr_sr;
    };
...
check_contains_all_keys_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_ordered_map_sr_sr ordered_map_sr_sr = {
            .map_sr_sr.contains_all_keys = contains_all_keys_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_map_sr_sr *ordered_map_sr_sr;
    };
...
static void check_get_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_sr_sr_get(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_OBJECT_IS_NULL);
}

static void check_get_error_on_key_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_sr_sr_get((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_KEY_IS_NULL);
}

static void check_get_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_sr_sr_get((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_OUT_IS_NULL);
}
...
static void check_get_entry_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_sr_sr_get_entry(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_OBJECT_IS_NULL);
}

static void check_get_entry_error_on_key_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_sr_sr_get_entry((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_KEY_IS_NULL);
}

static void check_get_entry_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_sr_sr_get_entry((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_OUT_IS_NULL);
}
...
static void check_get_entry_error_on_key_not_found(void **state) {
    const struct butterflyfish_ordered_map_sr_sr ordered_map_sr_sr = {
            .map_sr_sr.get_entry = get_entry_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_map_sr_sr *ordered_map_sr_sr;
    };
...
static void check_keys_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_sr_sr_keys(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_OBJECT_IS_NULL);
}

static void check_keys_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_sr_sr_keys((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_OUT_IS_NULL);
}
...
static void check_keys(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_map_sr_sr_keys(
                    (struct butterflyfish_ordered_map_sr_sr *) &instance,
                    (void *) 1),
            0);
}
...
static void check_values_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_sr_sr_values(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_OBJECT_IS_NULL);
}

static void check_values_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_sr_sr_values((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_OUT_IS_NULL);
}
