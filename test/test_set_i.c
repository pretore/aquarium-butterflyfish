...
static int as_collection(const struct butterflyfish_set_i *const object,
...
static void check_as_stream_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_set_i_as_stream(NULL, (void *) 1),
            BUTTERFLYFISH_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_stream_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_set_i_as_stream((void *) 1, NULL),
...
static void check_as_stream(void **state) {
    ...
    assert_int_equal(butterflyfish_set_i_as_stream(
            (const struct butterflyfish_set_i *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}

static void check_as_collection_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_set_i_as_collection(NULL, (void *) 1),
            BUTTERFLYFISH_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_collection_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_set_i_as_collection((void *) 1, NULL),
            BUTTERFLYFISH_SET_I_ERROR_OUT_IS_NULL);
}
...
static void check_as_collection(void **state) {
    ...
    assert_int_equal(butterflyfish_set_i_as_collection(
            (const struct butterflyfish_set_i *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_count(void **state) {
    ...
    uintmax_t out;
    assert_int_equal(butterflyfish_set_i_count(
            (const struct butterflyfish_set_i *) &instance, &out), 0);
