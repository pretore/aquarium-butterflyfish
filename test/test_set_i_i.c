...
static void check_as_stream_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_set_i_i_as_stream(NULL, (void *) 1),
            BUTTERFLYFISH_SET_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_stream_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_set_i_i_as_stream((void *) 1, NULL),
...
static void check_as_collection_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_set_i_i_as_collection(NULL, (void *) 1),
            BUTTERFLYFISH_SET_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_collection_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_set_i_i_as_collection((void *) 1, NULL),
            BUTTERFLYFISH_SET_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_as_collection(void **state) {
    ...
    assert_int_equal(butterflyfish_set_i_i_as_collection(
            (const struct butterflyfish_set_i_i *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_count_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_set_i_i_count(NULL, (void *) 1),
            BUTTERFLYFISH_SET_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_count_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_set_i_i_count((void *) 1, NULL),
            BUTTERFLYFISH_SET_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_count(void **state) {
    ...
    uintmax_t out;
    assert_int_equal(butterflyfish_set_i_i_count(
            (const struct butterflyfish_set_i_i *) &instance, &out), 0);
...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_set_i_i_first(NULL, (void *) 1),
            BUTTERFLYFISH_SET_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_first_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_set_i_i_first((void *) 1, NULL),
            BUTTERFLYFISH_SET_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_first_error_on_set_is_empty(void **state) {
    ...
    assert_int_equal(
            butterflyfish_set_i_i_first(
                    (const struct butterflyfish_set_i_i *) &instance,
                    (void *) 1),
...
static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_set_i_i_last(NULL, (void *) 1),
            BUTTERFLYFISH_SET_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_last_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_set_i_i_last((void *) 1, NULL),
            BUTTERFLYFISH_SET_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_set_i_i_next(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SET_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_next_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_set_i_i_next((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SET_I_I_ERROR_ITEM_IS_NULL);
}

static void check_next_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_set_i_i_next((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SET_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_prev_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_set_i_i_prev(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SET_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_prev_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_set_i_i_prev((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SET_I_I_ERROR_ITEM_IS_NULL);
}

static void check_prev_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_set_i_i_prev((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SET_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_contains_error_on_memory_allocation_failed(void **state) {
    ...
    assert_int_equal(
            butterflyfish_set_i_i_contains(
                    (struct butterflyfish_set_i_i *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SET_I_I_ERROR_MEMORY_ALLOCATION_FAILED);
}
...
check_contains_all_error_on_memory_allocation_failed(void **state) {
    ...
    will_return(set_contains_all,
                BUTTERFLYFISH_SET_I_I_ERROR_MEMORY_ALLOCATION_FAILED);
    assert_int_equal(
            butterflyfish_set_i_i_contains_all(
                    (struct butterflyfish_set_i_i *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SET_I_I_ERROR_MEMORY_ALLOCATION_FAILED);
...
static void check_get_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_set_i_i_get(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SET_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_get_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_set_i_i_get((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SET_I_I_ERROR_VALUE_IS_NULL);
}

static void check_get_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_set_i_i_get((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SET_I_I_ERROR_OUT_IS_NULL);
}
