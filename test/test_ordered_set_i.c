...
static void check_as_stream_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_i_as_stream(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_stream_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_i_as_stream((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_SET_I_ERROR_OUT_IS_NULL);
}

static void check_as_stream(void **state) {
    struct butterflyfish_ordered_set_i ordered_set = {};
    const struct butterflyfish_stream_i *stream;
    assert_int_equal(butterflyfish_ordered_set_i_as_stream(
...
static void check_as_collection_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_i_as_collection(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_collection_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_i_as_collection((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_SET_I_ERROR_OUT_IS_NULL);
}
...
static void check_as_collection(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_set_i_as_collection(
...
static void check_as_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_i_as_set(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_set_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_i_as_set((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_SET_I_ERROR_OUT_IS_NULL);
}

static void check_as_set(void **state) {
    struct butterflyfish_ordered_set_i ordered_set = {};
    struct butterflyfish_set_i *set;
    assert_int_equal(butterflyfish_ordered_set_i_as_set(
            &ordered_set, &set), 0);
...
static void check_count_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_i_count(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_count_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_i_count((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_SET_I_ERROR_OUT_IS_NULL);
}
...
static void check_count(void **state) {
    ...
    const struct butterflyfish_ordered_set_i ordered_set_i = {
            .set_i.collection_i.count = count
    };
    struct object {
        const struct butterflyfish_ordered_set_i *ordered_set_i;
    };
    ...
    uintmax_t out;
    assert_int_equal(
            butterflyfish_ordered_set_i_count(
...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_i_first(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_first_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_i_first((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_SET_I_ERROR_OUT_IS_NULL);
}
...
static void check_first_error_on_set_is_empty(void **state) {
    const struct butterflyfish_ordered_set_i ordered_set_i = {
            .set_i.collection_i.stream_i.first = fl_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_set_i *ordered_set_i;
    };
...
static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_i_last(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_last_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_i_last((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_SET_I_ERROR_OUT_IS_NULL);
}

static void check_last_error_on_set_is_empty(void **state) {
    const struct butterflyfish_ordered_set_i ordered_set_i = {
            .set_i.collection_i.last = fl_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_set_i *ordered_set_i;
    };
...
static void check_remove_item_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_i_remove_item(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_remove_item_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_i_remove_item((void *) 1, NULL),
...
static void check_remove_item(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_set_i_remove_item(
...
static void check_remove_all_items_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_i_remove_all_items(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_remove_all_items_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_i_remove_all_items((void *) 1, NULL),
...
static void check_remove_all_items(void **state) {
    const struct butterflyfish_ordered_set_i ordered_set_i = {
            .set_i.remove_all_items = remove_all_items
    };
    struct object {
        const struct butterflyfish_ordered_set_i *ordered_set_i;
    };
    ...
    assert_int_equal(
            butterflyfish_ordered_set_i_remove_all_items(
                    (struct butterflyfish_ordered_set_i *) &instance,
                    (void *) 1),
            0);
}
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_i_next(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_next_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_i_next((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SET_I_ERROR_ITEM_IS_NULL);
}

static void check_next_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_i_next((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_SET_I_ERROR_OUT_IS_NULL);
}
...
static void check_next_error_on_end_of_sequence(void **state) {
    const struct butterflyfish_ordered_set_i ordered_set_i = {
            .set_i.collection_i.stream_i.next = np_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_set_i *ordered_set_i;
    };
...
static void check_prev_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_i_prev(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_prev_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_i_prev((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SET_I_ERROR_ITEM_IS_NULL);
}

static void check_prev_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_i_prev((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_SET_I_ERROR_OUT_IS_NULL);
}

static void check_prev_error_on_end_of_sequence(void **state) {
    const struct butterflyfish_ordered_set_i ordered_set_i = {
            .set_i.collection_i.prev = np_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_set_i *ordered_set_i;
    };
...
static void check_add_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_i_add(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_add_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_i_add((void *) 1, NULL),
...
static void check_add_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_i_add_all(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_add_all_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_i_add_all((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_SET_I_ERROR_OTHER_IS_NULL);
}
...
static void check_add_all_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_ordered_set_i ordered_set_i = {
            .set_i.add_all = ar_all_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_set_i *ordered_set_i;
    };
...
static void check_remove_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_i_remove(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_remove_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_i_remove((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_SET_I_ERROR_VALUE_IS_NULL);
}

static void check_remove_error_on_value_not_found(void **state) {
    const struct butterflyfish_ordered_set_i ordered_set_i = {
            .set_i.remove = ar_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_set_i *ordered_set_i;
    };
...
static void check_contains_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_i_contains(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_contains_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_i_contains((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SET_I_ERROR_VALUE_IS_NULL);
}

static void check_contains_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_i_contains((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_SET_I_ERROR_OUT_IS_NULL);
}
...
static void check_contains_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_ordered_set_i ordered_set_i = {
            .set_i.contains = contains_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_set_i *ordered_set_i;
    };
    ...
    will_return(contains_emit_error,
                BUTTERFLYFISH_ORDERED_SET_I_ERROR_MEMORY_ALLOCATION_FAILED);
    assert_int_equal(
            butterflyfish_ordered_set_i_contains(
                    (struct butterflyfish_ordered_set_i *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_ORDERED_SET_I_ERROR_MEMORY_ALLOCATION_FAILED);
...
static void check_contains_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_i_contains_all(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_SET_I_ERROR_OBJECT_IS_NULL);
}
...
check_contains_all_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_ordered_set_i ordered_set_i = {
            .set_i.contains_all = contains_all_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_set_i *ordered_set_i;
    };
...
static void check_retain_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_i_retain_all(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_retain_all_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_i_retain_all((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_SET_I_ERROR_OTHER_IS_NULL);
}
...
check_retain_all_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_ordered_set_i ordered_set_i = {
            .set_i.retain_all = retain_all_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_set_i *ordered_set_i;
    };
...
static void check_get_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_i_get(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_get_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_i_get((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SET_I_ERROR_VALUE_IS_NULL);
}

static void check_get_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_i_get((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_SET_I_ERROR_OUT_IS_NULL);
}
