...
static void check_as_stream(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_set_i_as_stream(
            (const struct butterflyfish_ordered_set_i *) &instance, &out), 0);
...
static void check_as_ordered_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_i_as_ordered(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_ordered_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_set_i_as_ordered((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_SET_I_ERROR_OUT_IS_NULL);
}
...
static void check_as_ordered(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_set_i_as_ordered(
            (const struct butterflyfish_ordered_set_i *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_set(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_set_i_as_set(
            (struct butterflyfish_ordered_set_i *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_ordered_as_collection(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_set_i_as_ordered(
            (struct butterflyfish_ordered_set_i *) &instance, &as), 0);
    const struct butterflyfish_collection_i *out;
...
static void check_count(void **state) {
    ...
    uintmax_t out;
    assert_int_equal(butterflyfish_ordered_set_i_count(
            (const struct butterflyfish_ordered_set_i *) &instance, &out), 0);
