...
struct instance {
    const struct butterflyfish_settable_reducible_list_i_i *const id;
    void *data;
};

const struct butterflyfish_settable_reducible_list_i_i settable_reducible_list_i_i;
...
static int stream_first(const void *const object,
    ...
    seagrass_required_true(&settable_reducible_list_i_i == instance->id);
    return mock();
}
...
reducible_list_remove(void *const object, const uintmax_t at) {
    if (!object) {
        return BUTTERFLYFISH_REDUCIBLE_LIST_I_I_ERROR_OBJECT_IS_NULL;
    }
    function_called();
    const struct instance *instance = object;
    seagrass_required_true(&settable_reducible_list_i_i == instance->id);
...
butterflyfish_settable_reducible_list_i_i settable_reducible_list_i_i = {
        ...
        .as_settable = &settable_i_i,
        .as_removable = &removable_i_i,
        .as_reducible_list = &reducible_list_i_i,
        .as_settable_list = &settable_list_i_i,
        .first = stream_first,
        .next = stream_next,
        .count = collection_count,
        .last = collection_last,
...
static void check_as_stream(void **state) {
    assert_ptr_equal(settable_reducible_list_i_i.as_stream, &stream_i_i);
}

static void check_as_collection(void **state) {
    assert_ptr_equal(settable_reducible_list_i_i.as_collection, &collection_i_i);
}

static void check_as_settable(void **state) {
    assert_ptr_equal(settable_reducible_list_i_i.as_settable, &settable_i_i);
}

static void check_as_list(void **state) {
    assert_ptr_equal(settable_reducible_list_i_i.as_list, &list_i_i);
}

static void check_as_removable(void **state) {
    assert_ptr_equal(settable_reducible_list_i_i.as_removable, &removable_i_i);
}

static void check_as_settable_list(void **state) {
    assert_ptr_equal(settable_reducible_list_i_i.as_settable_list, &settable_list_i_i);
}

static void check_as_reducible_list(void **state) {
    assert_ptr_equal(settable_reducible_list_i_i.as_reducible_list, &reducible_list_i_i);
}

static void check_count_error_on_object_is_null(void **state) {
    assert_int_equal(settable_reducible_list_i_i.count(NULL, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_count_error_on_out_is_null(void **state) {
    assert_int_equal(settable_reducible_list_i_i.count((void *) 1, NULL),
...
static void check_count(void **state) {
    ...
    struct instance instance = {
            .id = &settable_reducible_list_i_i,
    };
...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(settable_reducible_list_i_i.first(NULL, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_first_error_on_out_is_null(void **state) {
    assert_int_equal(settable_reducible_list_i_i.first((void *) 1, NULL),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_LIST_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(settable_reducible_list_i_i.last(NULL, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_last_error_on_out_is_null(void **state) {
    assert_int_equal(settable_reducible_list_i_i.last((void *) 1, NULL),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_LIST_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(settable_reducible_list_i_i.next(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_next_error_on_item_is_null(void **state) {
    assert_int_equal(settable_reducible_list_i_i.next((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_LIST_I_I_ERROR_ITEM_IS_NULL);
}

static void check_next_error_on_out_is_null(void **state) {
    assert_int_equal(settable_reducible_list_i_i.next((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_LIST_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_prev_error_on_object_is_null(void **state) {
    assert_int_equal(settable_reducible_list_i_i.prev(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_prev_error_on_item_is_null(void **state) {
    assert_int_equal(settable_reducible_list_i_i.prev((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_LIST_I_I_ERROR_ITEM_IS_NULL);
}

static void check_prev_error_on_out_is_null(void **state) {
    assert_int_equal(settable_reducible_list_i_i.prev((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_LIST_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_get_error_on_object_is_null(void **state) {
    assert_int_equal(settable_reducible_list_i_i.get(NULL, 0, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_get_error_on_out_is_null(void **state) {
    assert_int_equal(settable_reducible_list_i_i.get((void *) 1, 0, NULL),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_LIST_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_at_error_on_object_is_null(void **state) {
    assert_int_equal(settable_reducible_list_i_i.at(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_at_error_on_item_is_null(void **state) {
    assert_int_equal(settable_reducible_list_i_i.at((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_LIST_I_I_ERROR_ITEM_IS_NULL);
}

static void check_at_error_on_out_is_null(void **state) {
    assert_int_equal(settable_reducible_list_i_i.at((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_LIST_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_set_error_on_object_is_null(void **state) {
    assert_int_equal(settable_reducible_list_i_i.set(NULL, 0, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_set_error_on_value_is_null(void **state) {
    assert_int_equal(settable_reducible_list_i_i.set((void *) 1, 0, NULL),
...
static void check_set_error_on_index_out_of_bounds(void **state) {
    ...
    assert_int_equal(settable_reducible_list_i_i.set(&instance, 0, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_LIST_I_I_ERROR_INDEX_IS_OUT_OF_BOUNDS);
}
...
static void check_set_item_error_on_object_is_null(void **state) {
    assert_int_equal(settable_reducible_list_i_i.set_item(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_set_item_error_on_item_is_null(void **state) {
    assert_int_equal(settable_reducible_list_i_i.set_item((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_LIST_I_I_ERROR_ITEM_IS_NULL);
}

static void check_set_item_error_on_value_is_null(void **state) {
    assert_int_equal(settable_reducible_list_i_i.set_item((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_LIST_I_I_ERROR_VALUE_IS_NULL);
}
...
static void check_remove_error_on_object_is_null(void **state) {
    assert_int_equal(settable_reducible_list_i_i.remove(NULL, 0),
...
static void check_remove_item_error_on_object_is_null(void **state) {
    assert_int_equal(settable_reducible_list_i_i.remove_item(NULL, (void *) 1),
                     BUTTERFLYFISH_REDUCIBLE_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_remove_item_error_on_item_is_null(void **state) {
    assert_int_equal(settable_reducible_list_i_i.remove_item((void *) 1, NULL),
