...
static void check_as_stream_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_reducible_list_i_as_stream(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_stream_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_reducible_list_i_as_stream((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_OUT_IS_NULL);
}
...
static void check_as_stream(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_settable_reducible_list_i_as_stream(
            (const struct butterflyfish_ordered_settable_reducible_list_i *) &instance,
            &out), 0);
...
static void check_as_collection_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_reducible_list_i_as_collection(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_collection_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_reducible_list_i_as_collection((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_OUT_IS_NULL);
}
...
static void check_as_collection(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_settable_reducible_list_i_as_collection(
            (const struct butterflyfish_ordered_settable_reducible_list_i *) &instance,
            &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_ordered_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_reducible_list_i_as_ordered(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_ordered_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_reducible_list_i_as_ordered((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_OUT_IS_NULL);
}
...
static void check_as_ordered(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_settable_reducible_list_i_as_ordered(
            (const struct butterflyfish_ordered_settable_reducible_list_i *) &instance,
            &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_list_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_reducible_list_i_as_list(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_list_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_reducible_list_i_as_list((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_OUT_IS_NULL);
}
...
static void check_as_list(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_settable_reducible_list_i_as_list(
            (const struct butterflyfish_ordered_settable_reducible_list_i *) &instance,
            &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_settable_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_reducible_list_i_as_settable(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_settable_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_reducible_list_i_as_settable((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_OUT_IS_NULL);
}
...
static void check_as_settable(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_settable_reducible_list_i_as_settable(
            (struct butterflyfish_ordered_settable_reducible_list_i *) &instance,
            &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_removable_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_reducible_list_i_as_removable(
                    NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_removable(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_settable_reducible_list_i_as_removable(
            (struct butterflyfish_ordered_settable_reducible_list_i *) &instance,
            &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_ordered_list_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_reducible_list_i_as_ordered_list(
                    NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_ordered_list(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_settable_reducible_list_i_as_ordered_list(
            (const struct butterflyfish_ordered_settable_reducible_list_i *) &instance,
            &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_settable_list_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_reducible_list_i_as_settable_list(
                    NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_settable_list(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_settable_reducible_list_i_as_settable_list(
            (struct butterflyfish_ordered_settable_reducible_list_i *) &instance,
            &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_reducible_list_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_reducible_list_i_as_reducible_list(
                    NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_reducible_list(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_settable_reducible_list_i_as_reducible_list(
            (struct butterflyfish_ordered_settable_reducible_list_i *) &instance,
            &out), 0);
    assert_ptr_equal(out, check);
}
...
check_as_ordered_settable_list_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_reducible_list_i_as_ordered_settable_list(
                    NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_OBJECT_IS_NULL);
}
...
check_as_ordered_reducible_list_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_reducible_list_i_as_ordered_reducible_list(
                    NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_OBJECT_IS_NULL);
}
...
check_as_settable_reducible_list_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_reducible_list_i_as_settable_reducible_list(
                    NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_settable_reducible_list_as_settable_list(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_settable_reducible_list_i_as_settable_reducible_list(
            (struct butterflyfish_ordered_settable_reducible_list_i *)
                    &instance, &as), 0);
    struct butterflyfish_settable_list_i *out;
    assert_int_equal(butterflyfish_settable_reducible_list_i_as_settable_list(as, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_settable_reducible_list_as_reducible_list(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_settable_reducible_list_i_as_settable_reducible_list(
            (struct butterflyfish_ordered_settable_reducible_list_i *)
                    &instance, &as), 0);
    struct butterflyfish_reducible_list_i *out;
    assert_int_equal(butterflyfish_settable_reducible_list_i_as_reducible_list(as, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_ordered_reducible_list_as_ordered_list(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_settable_reducible_list_i_as_ordered_reducible_list(
            (struct butterflyfish_ordered_settable_reducible_list_i *)
                    &instance, &as), 0);
    const struct butterflyfish_ordered_list_i *out;
    assert_int_equal(butterflyfish_ordered_reducible_list_i_as_ordered_list(as, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_count_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_reducible_list_i_count(
                    NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_count(void **state) {
    ...
    uintmax_t out;
    assert_int_equal(butterflyfish_ordered_settable_reducible_list_i_count(
            (const struct butterflyfish_ordered_settable_reducible_list_i *) &instance,
                    &out), 0);
...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_reducible_list_i_first(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_OBJECT_IS_NULL);
}

static void check_first_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_reducible_list_i_first((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_OUT_IS_NULL);
}
...
static void check_first_error_on_list_is_empty(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_settable_reducible_list_i_first(
                    (const struct butterflyfish_ordered_settable_reducible_list_i *)
                            &instance, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_LIST_IS_EMPTY);
}

static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_reducible_list_i_last(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_OBJECT_IS_NULL);
}

static void check_last_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_reducible_list_i_last((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_OUT_IS_NULL);
}
...
static void check_last_error_on_list_is_empty(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_settable_reducible_list_i_last(
                    (const struct butterflyfish_ordered_settable_reducible_list_i *)
                            &instance, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_LIST_IS_EMPTY);
}
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_reducible_list_i_next(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_next_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_reducible_list_i_next(
                    (void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_ITEM_IS_NULL);
}
...
static void check_next_error_on_end_of_sequence(void **state) {
    ...
    assert_int_equal(
            ...
            BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_END_OF_SEQUENCE);
}

static void check_prev_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_reducible_list_i_prev(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_get_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_reducible_list_i_get(NULL, 0, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_OBJECT_IS_NULL);
}

static void check_get_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_reducible_list_i_get((void *) 1, 0, NULL),
            BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_OUT_IS_NULL);
}
...
static void check_get_error_on_index_out_of_bounds(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_settable_reducible_list_i_get(
                    (const struct butterflyfish_ordered_settable_reducible_list_i *)
                            &instance, 0, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_INDEX_IS_OUT_OF_BOUNDS);
}

static void check_at_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_reducible_list_i_at(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_at_error_on_item_not_found(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_settable_reducible_list_i_at(
                    (const struct butterflyfish_ordered_settable_reducible_list_i *)
                            &instance, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_ITEM_NOT_FOUND);
}

static void check_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_reducible_list_i_set(NULL, 0, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_OBJECT_IS_NULL);
}

static void check_set_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_reducible_list_i_set((void *) 1, 0, NULL),
            BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_VALUE_IS_NULL);
}
...
static void check_set_error_on_index_out_of_bounds(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_settable_reducible_list_i_set(
                    (struct butterflyfish_ordered_settable_reducible_list_i *) &instance,
                    0,
                    (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_INDEX_IS_OUT_OF_BOUNDS);
...
static void check_set_error_on_memory_allocation_failed(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_settable_reducible_list_i_set(
                    ...
                    0,
                    (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_MEMORY_ALLOCATION_FAILED);
}
...
static void check_set_error_on_value_is_invalid(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_settable_reducible_list_i_set(
                    ...
                    0,
                    (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_VALUE_IS_INVALID);
}

static void check_set_item_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_reducible_list_i_set_item(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_remove_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_reducible_list_i_remove(NULL, 0),
            BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_remove(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_settable_reducible_list_i_remove(
                    (struct butterflyfish_ordered_settable_reducible_list_i *)
                            &instance, 0), 0);
}
...
static void check_remove_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_reducible_list_i_remove_all(
                    NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_remove_all_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_reducible_list_i_remove_all(
                    (void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_OTHER_IS_NULL);
}
...
static void check_remove_item_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_reducible_list_i_remove_item(
                    NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_remove_all_items_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_reducible_list_i_remove_all_items(
                    NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_OBJECT_IS_NULL);
}
