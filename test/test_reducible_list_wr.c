...
static void check_as_stream_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_list_wr_as_stream(NULL, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_LIST_WR_ERROR_OBJECT_IS_NULL);
}

static void check_as_stream_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_list_wr_as_stream((void *) 1, NULL),
...
static void check_as_stream(void **state) {
    ...
    assert_int_equal(butterflyfish_reducible_list_wr_as_stream(
...
static void check_as_collection_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_list_wr_as_collection(NULL, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_LIST_WR_ERROR_OBJECT_IS_NULL);
}

static void check_as_collection_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_list_wr_as_collection((void *) 1, NULL),
            BUTTERFLYFISH_REDUCIBLE_LIST_WR_ERROR_OUT_IS_NULL);
}
...
static void check_as_collection(void **state) {
    ...
    assert_int_equal(butterflyfish_reducible_list_wr_as_collection(
...
static void check_as_fixed_list_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_list_wr_as_fixed_list(NULL, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_LIST_WR_ERROR_OBJECT_IS_NULL);
}

static void check_as_fixed_list_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_list_wr_as_fixed_list((void *) 1, NULL),
            BUTTERFLYFISH_REDUCIBLE_LIST_WR_ERROR_OUT_IS_NULL);
}
...
static void check_as_fixed_list(void **state) {
    ...
    assert_int_equal(butterflyfish_reducible_list_wr_as_fixed_list(
...
static void check_count_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_list_wr_count(NULL, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_LIST_WR_ERROR_OBJECT_IS_NULL);
}

static void check_count_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_list_wr_count((void *) 1, NULL),
            BUTTERFLYFISH_REDUCIBLE_LIST_WR_ERROR_OUT_IS_NULL);
}
...
static void check_as_fixed_list_count(void **state) {
    srand(time(NULL));
    const struct butterflyfish_reducible_list_wr reducible_list_wr = {
            .fixed_list_wr.collection_wr.count = count
    };
...
static void check_first_error_on_reducible_list_is_empty(void **state) {
    const struct butterflyfish_reducible_list_wr reducible_list_wr = {
            .fixed_list_wr.collection_wr.stream_wr.first = fl_emit_error
    };
    struct object {
        const struct butterflyfish_reducible_list_wr *reducible_list_wr;
    };
...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_list_wr_first(NULL, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_LIST_WR_ERROR_OBJECT_IS_NULL);
}

static void check_first_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_list_wr_first((void *) 1, NULL),
            BUTTERFLYFISH_REDUCIBLE_LIST_WR_ERROR_OUT_IS_NULL);
}

static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_list_wr_last(NULL, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_LIST_WR_ERROR_OBJECT_IS_NULL);
}

static void check_last_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_list_wr_last((void *) 1, NULL),
            BUTTERFLYFISH_REDUCIBLE_LIST_WR_ERROR_OUT_IS_NULL);
}

static void check_last_error_on_reducible_list_is_empty(void **state) {
    const struct butterflyfish_reducible_list_wr reducible_list_wr = {
            .fixed_list_wr.collection_wr.last = fl_emit_error
    };
    struct object {
        const struct butterflyfish_reducible_list_wr *reducible_list_wr;
    };
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_list_wr_next(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_LIST_WR_ERROR_OBJECT_IS_NULL);
}

static void check_next_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_list_wr_next((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_LIST_WR_ERROR_ITEM_IS_NULL);
}

static void check_next_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_list_wr_next((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_REDUCIBLE_LIST_WR_ERROR_OUT_IS_NULL);
}
...
static void check_next_error_on_end_of_sequence(void **state) {
    const struct butterflyfish_reducible_list_wr reducible_list_wr = {
            .fixed_list_wr.collection_wr.stream_wr.next = np_emit_error
    };
    struct object {
        const struct butterflyfish_reducible_list_wr *reducible_list_wr;
    };
...
static void check_prev_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_list_wr_prev(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_LIST_WR_ERROR_OBJECT_IS_NULL);
}

static void check_prev_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_list_wr_prev((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_LIST_WR_ERROR_ITEM_IS_NULL);
}

static void check_prev_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_list_wr_prev((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_REDUCIBLE_LIST_WR_ERROR_OUT_IS_NULL);
}

static void check_prev_error_on_end_of_sequence(void **state) {
    const struct butterflyfish_reducible_list_wr reducible_list_wr = {
            .fixed_list_wr.collection_wr.prev = np_emit_error
    };
    struct object {
        const struct butterflyfish_reducible_list_wr *reducible_list_wr;
    };
...
static void check_get_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_list_wr_get(NULL, 0, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_LIST_WR_ERROR_OBJECT_IS_NULL);
}

static void check_get_error_on_out(void **state) {
    assert_int_equal(
            butterflyfish_reducible_list_wr_get((void *) 1, 0, NULL),
            BUTTERFLYFISH_REDUCIBLE_LIST_WR_ERROR_OUT_IS_NULL);
}
...
static void check_get_error_on_index_out_of_bounds(void **state) {
    const struct butterflyfish_reducible_list_wr reducible_list_wr = {
            .fixed_list_wr.get = get_emit_error
    };
    struct object {
        const struct butterflyfish_reducible_list_wr *reducible_list_wr;
    };
...
static void check_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_list_wr_set(NULL, 0, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_LIST_WR_ERROR_OBJECT_IS_NULL);
}

static void check_set_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_list_wr_set((void *) 1, 0, NULL),
...
static void check_set_item_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_reducible_list_wr reducible_list_wr = {
            .fixed_list_wr.set_item = set_item_emit_error,
    };
    struct object {
        const struct butterflyfish_reducible_list_wr *reducible_list_wr;
    };
...
static void check_at_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_list_wr_at(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_LIST_WR_ERROR_OBJECT_IS_NULL);
}

static void check_at_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_list_wr_at((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_LIST_WR_ERROR_ITEM_IS_NULL);
}

static void check_at_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_list_wr_at((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_REDUCIBLE_LIST_WR_ERROR_OUT_IS_NULL);
}
...
static void check_at_error_on_item_is_out_of_bounds(void **state) {
    const struct butterflyfish_reducible_list_wr reducible_list_wr = {
            .fixed_list_wr.at = at_emit_error
    };
    struct object {
        const struct butterflyfish_reducible_list_wr *reducible_list_wr;
    };
...
static void check_remove_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_list_wr_remove(NULL, 0),
            BUTTERFLYFISH_REDUCIBLE_LIST_WR_ERROR_OBJECT_IS_NULL);
}
...
static void check_remove_item_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_list_wr_remove_item(NULL, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_LIST_WR_ERROR_OBJECT_IS_NULL);
}

static void check_remove_item_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_list_wr_remove_item((void *) 1, NULL),
            BUTTERFLYFISH_REDUCIBLE_LIST_WR_ERROR_ITEM_IS_NULL);
}
...
static void check_remove_items_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_list_wr_remove_all_items(NULL, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_LIST_WR_ERROR_OBJECT_IS_NULL);
}

static void check_remove_items_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_list_wr_remove_all_items((void *) 1, NULL),
...
int main(int argc, char *argv[]) {
    const struct CMUnitTest tests[] = {
            ...
            cmocka_unit_test(check_as_fixed_list_count),
