...
static void check_as_stream_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_collection_i_as_stream(NULL, (void *) 1),
            BUTTERFLYFISH_COLLECTION_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_stream_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_collection_i_as_stream((void *) 1, NULL),
...
static void check_as_stream(void **state) {
    ...
    assert_int_equal(butterflyfish_collection_i_as_stream(
            (struct butterflyfish_collection_i *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}

static void check_count_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_collection_i_count(NULL, (void *) 1),
            BUTTERFLYFISH_COLLECTION_I_ERROR_OBJECT_IS_NULL);
}

static void check_count_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_collection_i_count((void *) 1, NULL),
            BUTTERFLYFISH_COLLECTION_I_ERROR_OUT_IS_NULL);
}
...
static void check_count(void **state) {
    ...
    uintmax_t out;
    assert_int_equal(butterflyfish_collection_i_count(
            (const struct butterflyfish_collection_i *) &instance, &out), 0);
...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_collection_i_first(NULL, (void *) 1),
            BUTTERFLYFISH_COLLECTION_I_ERROR_OBJECT_IS_NULL);
}

static void check_first_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_collection_i_first((void *) 1, NULL),
            BUTTERFLYFISH_COLLECTION_I_ERROR_OUT_IS_NULL);
}

static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_collection_i_last(NULL, (void *) 1),
            BUTTERFLYFISH_COLLECTION_I_ERROR_OBJECT_IS_NULL);
}

static void check_last_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_collection_i_last((void *) 1, NULL),
            BUTTERFLYFISH_COLLECTION_I_ERROR_OUT_IS_NULL);
}
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_collection_i_next(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_COLLECTION_I_ERROR_OBJECT_IS_NULL);
}

static void check_next_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_collection_i_next((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_COLLECTION_I_ERROR_ITEM_IS_NULL);
}

static void check_next_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_collection_i_next((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_COLLECTION_I_ERROR_OUT_IS_NULL);
}
...
static void check_prev_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_collection_i_prev(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_COLLECTION_I_ERROR_OBJECT_IS_NULL);
}

static void check_prev_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_collection_i_prev((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_COLLECTION_I_ERROR_ITEM_IS_NULL);
}

static void check_prev_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_collection_i_prev((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_COLLECTION_I_ERROR_OUT_IS_NULL);
}
