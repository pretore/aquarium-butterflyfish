...
static void check_as_stream_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_ni_as_stream(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_NI_ERROR_OBJECT_IS_NULL);
}

static void check_as_stream_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_ni_as_stream((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_NI_ERROR_OUT_IS_NULL);
}

static void check_as_stream(void **state) {
    struct butterflyfish_sorted_set_ni sorted_set = {};
    const struct butterflyfish_stream_ni *stream;
    assert_int_equal(butterflyfish_sorted_set_ni_as_stream(
            &sorted_set, &stream), 0);
...
static void check_as_collection_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_ni_as_collection(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_NI_ERROR_OBJECT_IS_NULL);
}

static void check_as_collection_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_ni_as_collection((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_NI_ERROR_OUT_IS_NULL);
}
...
static void check_as_collection(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_set_ni_as_collection(
...
static void check_as_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_ni_as_set(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_NI_ERROR_OBJECT_IS_NULL);
}

static void check_as_set_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_ni_as_set((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_NI_ERROR_OUT_IS_NULL);
}

static void check_as_set(void **state) {
    struct butterflyfish_sorted_set_ni sorted_set = {};
    struct butterflyfish_set_ni *set;
    assert_int_equal(butterflyfish_sorted_set_ni_as_set(&sorted_set, &set), 0);
    assert_ptr_equal(&sorted_set, set);
}

static void check_as_ordered_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_ni_as_ordered_set(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_NI_ERROR_OBJECT_IS_NULL);
}

static void check_as_ordered_set_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_ni_as_ordered_set((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_NI_ERROR_OUT_IS_NULL);
}

static void check_as_ordered_set(void **state) {
    struct butterflyfish_sorted_set_ni sorted_set = {};
    struct butterflyfish_ordered_set_ni *ordered_set;
    assert_int_equal(butterflyfish_sorted_set_ni_as_ordered_set(
...
static void check_count_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_ni_count(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_NI_ERROR_OBJECT_IS_NULL);
}

static void check_count_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_ni_count((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_NI_ERROR_OUT_IS_NULL);
}
...
static void check_count(void **state) {
    ...
    uintmax_t out;
    assert_int_equal(
            butterflyfish_sorted_set_ni_count(
...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_ni_first(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_NI_ERROR_OBJECT_IS_NULL);
}

static void check_first_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_ni_first((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_NI_ERROR_OUT_IS_NULL);
}
...
static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_ni_last(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_NI_ERROR_OBJECT_IS_NULL);
}

static void check_last_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_ni_last((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_NI_ERROR_OUT_IS_NULL);
}
...
static void check_remove_item_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_ni_remove_item(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_NI_ERROR_OBJECT_IS_NULL);
}

static void check_remove_item_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_ni_remove_item((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_NI_ERROR_ITEM_IS_NULL);
}
...
static void check_remove_item(void **state) {
    const struct butterflyfish_sorted_set_ni sorted_set_ni = {
            .ordered_set_ni.set_ni.remove_item = remove_item
    };
    struct object {
        const struct butterflyfish_sorted_set_ni *sorted_set_ni;
    };
    ...
    assert_int_equal(
            butterflyfish_sorted_set_ni_remove_item(
                    (struct butterflyfish_sorted_set_ni *) &instance,
                    (void *) 1),
            0);
}
...
static void check_remove_all_items_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_ni_remove_all_items(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_NI_ERROR_OBJECT_IS_NULL);
}

static void check_remove_all_items_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_ni_remove_all_items((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_NI_ERROR_OTHER_IS_NULL);
}
...
static void check_remove_all_items(void **state) {
    const struct butterflyfish_sorted_set_ni sorted_set_ni = {
            .ordered_set_ni.set_ni.remove_all_items = remove_all_items
    };
    struct object {
        const struct butterflyfish_sorted_set_ni *sorted_set_ni;
    };
    ...
    assert_int_equal(
            butterflyfish_sorted_set_ni_remove_all_items(
                    (struct butterflyfish_sorted_set_ni *) &instance,
                    (void *) 1),
            0);
}
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_ni_next(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_NI_ERROR_OBJECT_IS_NULL);
}

static void check_next_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_ni_next((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_NI_ERROR_ITEM_IS_NULL);
}

static void check_next_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_ni_next((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_NI_ERROR_OUT_IS_NULL);
}
...
static void check_prev_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_ni_prev(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_NI_ERROR_OBJECT_IS_NULL);
}

static void check_prev_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_ni_prev((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_NI_ERROR_ITEM_IS_NULL);
}

static void check_prev_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_ni_prev((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_NI_ERROR_OUT_IS_NULL);
}
...
static void check_add_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_ni_add(NULL, 0),
            BUTTERFLYFISH_SORTED_SET_NI_ERROR_OBJECT_IS_NULL);
}
...
static void check_add_error_on_value_already_exits(void **state) {
    const struct butterflyfish_sorted_set_ni sorted_set_ni = {
            .ordered_set_ni.set_ni.add = ar_emit_error
    };
    struct object {
        const struct butterflyfish_sorted_set_ni *sorted_set_ni;
    };
    ...
    will_return(ar_emit_error,
                BUTTERFLYFISH_SORTED_SET_NI_ERROR_VALUE_ALREADY_EXISTS);
    assert_int_equal(
            butterflyfish_sorted_set_ni_add(
                    (struct butterflyfish_sorted_set_ni *) &instance,
                    0),
            BUTTERFLYFISH_SORTED_SET_NI_ERROR_VALUE_ALREADY_EXISTS);
}
...
static void check_add_error_on_memory_allocation_failed(void **state) {
    ...
    expect_function_call(ar_emit_error);
    will_return(ar_emit_error,
                BUTTERFLYFISH_SORTED_SET_NI_ERROR_MEMORY_ALLOCATION_FAILED);
    assert_int_equal(
            butterflyfish_sorted_set_ni_add(
                    (struct butterflyfish_sorted_set_ni *) &instance,
                    0),
...
static void check_add_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_ni_add_all(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_NI_ERROR_OBJECT_IS_NULL);
}

static void check_add_all_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_ni_add_all((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_NI_ERROR_OTHER_IS_NULL);
}
...
static void check_add_all_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_sorted_set_ni sorted_set_ni = {
            .ordered_set_ni.set_ni.add_all = ar_all_emit_error
    };
    struct object {
        const struct butterflyfish_sorted_set_ni *sorted_set_ni;
    };
    ...
    will_return(ar_all_emit_error,
                BUTTERFLYFISH_SORTED_SET_NI_ERROR_MEMORY_ALLOCATION_FAILED);
    assert_int_equal(
            butterflyfish_sorted_set_ni_add_all(
                    (struct butterflyfish_sorted_set_ni *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_SET_NI_ERROR_MEMORY_ALLOCATION_FAILED);
}
...
static void check_remove_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_ni_remove(NULL, 0),
            BUTTERFLYFISH_SORTED_SET_NI_ERROR_OBJECT_IS_NULL);
}

static void check_remove_error_on_value_not_found(void **state) {
    const struct butterflyfish_sorted_set_ni sorted_set_ni = {
            .ordered_set_ni.set_ni.remove = ar_emit_error
    };
    struct object {
        const struct butterflyfish_sorted_set_ni *sorted_set_ni;
    };
    ...
    expect_function_call(ar_emit_error);
    will_return(ar_emit_error,
                BUTTERFLYFISH_SORTED_SET_NI_ERROR_VALUE_NOT_FOUND);
    assert_int_equal(
            butterflyfish_sorted_set_ni_remove(
                    (struct butterflyfish_sorted_set_ni *) &instance,
                    0),
...
static void check_remove_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_ni_remove_all(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_NI_ERROR_OBJECT_IS_NULL);
}

static void check_remove_all_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_ni_remove_all((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_NI_ERROR_OTHER_IS_NULL);
}

static void check_remove_all_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_sorted_set_ni sorted_set_ni = {
            .ordered_set_ni.set_ni.remove_all = ar_all_emit_error
    };
    struct object {
        const struct butterflyfish_sorted_set_ni *sorted_set_ni;
    };
    ...
    will_return(ar_all_emit_error,
                BUTTERFLYFISH_SORTED_SET_NI_ERROR_MEMORY_ALLOCATION_FAILED);
    assert_int_equal(
            butterflyfish_sorted_set_ni_remove_all(
                    (struct butterflyfish_sorted_set_ni *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_SET_NI_ERROR_MEMORY_ALLOCATION_FAILED);
}
...
static void check_contains_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_ni_contains(NULL, 0, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_NI_ERROR_OBJECT_IS_NULL);
}

static void check_contains_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_ni_contains((void *) 1, 0, NULL),
            BUTTERFLYFISH_SORTED_SET_NI_ERROR_OUT_IS_NULL);
}
...
static void check_contains_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_sorted_set_ni sorted_set_ni = {
            .ordered_set_ni.set_ni.contains = contains_emit_error
    };
    struct object {
        const struct butterflyfish_sorted_set_ni *sorted_set_ni;
    };
    ...
    will_return(contains_emit_error,
                BUTTERFLYFISH_SORTED_SET_NI_ERROR_MEMORY_ALLOCATION_FAILED);
    assert_int_equal(
            butterflyfish_sorted_set_ni_contains(
                    (struct butterflyfish_sorted_set_ni *) &instance,
                    0,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_SET_NI_ERROR_MEMORY_ALLOCATION_FAILED);
...
static void check_contains_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_ni_contains_all(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_NI_ERROR_OBJECT_IS_NULL);
}
...
check_contains_all_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_sorted_set_ni sorted_set_ni = {
            .ordered_set_ni.set_ni.contains_all = contains_all_emit_error
    };
    struct object {
        const struct butterflyfish_sorted_set_ni *sorted_set_ni;
    };
...
static void check_retain_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_ni_retain_all(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_NI_ERROR_OBJECT_IS_NULL);
}

static void check_retain_all_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_ni_retain_all((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_NI_ERROR_OTHER_IS_NULL);
}
...
check_retain_all_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_sorted_set_ni sorted_set_ni = {
            .ordered_set_ni.set_ni.retain_all = retain_all_emit_error
    };
    struct object {
        const struct butterflyfish_sorted_set_ni *sorted_set_ni;
    };
    ...
    will_return(retain_all_emit_error,
                BUTTERFLYFISH_SORTED_SET_NI_ERROR_MEMORY_ALLOCATION_FAILED);
    assert_int_equal(
            butterflyfish_sorted_set_ni_retain_all(
                    (struct butterflyfish_sorted_set_ni *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_SET_NI_ERROR_MEMORY_ALLOCATION_FAILED);
}
...
static void check_get_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_ni_get(NULL, 0, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_NI_ERROR_OBJECT_IS_NULL);
}

static void check_get_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_ni_get((void *) 1, 0, NULL),
            BUTTERFLYFISH_SORTED_SET_NI_ERROR_OUT_IS_NULL);
}
...
static void check_get_error_on_item_not_found(void **state) {
    const struct butterflyfish_sorted_set_ni sorted_set_ni = {
            .ordered_set_ni.set_ni.get = get_emit_error
    };
    struct object {
        const struct butterflyfish_sorted_set_ni *sorted_set_ni;
    };
    ...
    will_return(get_emit_error,
                BUTTERFLYFISH_SORTED_SET_NI_ERROR_ITEM_NOT_FOUND);
    assert_int_equal(
            butterflyfish_sorted_set_ni_get(
                    (struct butterflyfish_sorted_set_ni *) &instance,
                    0,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_SET_NI_ERROR_ITEM_NOT_FOUND);
...
static void check_ceiling_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_ni_ceiling(NULL, 0, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_NI_ERROR_OBJECT_IS_NULL);
}

static void check_ceiling_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_ni_ceiling( (void *) 1, 0, NULL),
            BUTTERFLYFISH_SORTED_SET_NI_ERROR_OUT_IS_NULL);
}
...
static void check_ceiling_error_on_item_not_found(void **state) {
    ...
    will_return(get_emit_error,
                BUTTERFLYFISH_SORTED_SET_NI_ERROR_ITEM_NOT_FOUND);
    assert_int_equal(
            butterflyfish_sorted_set_ni_ceiling(
                    (struct butterflyfish_sorted_set_ni *) &instance,
                    0,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_SET_NI_ERROR_ITEM_NOT_FOUND);
...
static void check_floor_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_ni_floor(NULL, 0, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_NI_ERROR_OBJECT_IS_NULL);
}

static void check_floor_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_ni_floor( (void *) 1, 0, NULL),
            BUTTERFLYFISH_SORTED_SET_NI_ERROR_OUT_IS_NULL);
}
...
static void check_floor_error_on_item_not_found(void **state) {
    ...
    will_return(get_emit_error,
                BUTTERFLYFISH_SORTED_SET_NI_ERROR_ITEM_NOT_FOUND);
    assert_int_equal(
            butterflyfish_sorted_set_ni_floor(
                    (struct butterflyfish_sorted_set_ni *) &instance,
                    0,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_SET_NI_ERROR_ITEM_NOT_FOUND);
...
static void check_higher_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_ni_higher(NULL, 0, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_NI_ERROR_OBJECT_IS_NULL);
}

static void check_higher_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_ni_higher( (void *) 1, 0, NULL),
            BUTTERFLYFISH_SORTED_SET_NI_ERROR_OUT_IS_NULL);
}
...
static void check_higher_error_on_item_not_found(void **state) {
    ...
    will_return(get_emit_error,
                BUTTERFLYFISH_SORTED_SET_NI_ERROR_ITEM_NOT_FOUND);
    assert_int_equal(
            butterflyfish_sorted_set_ni_higher(
                    (struct butterflyfish_sorted_set_ni *) &instance,
                    0,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_SET_NI_ERROR_ITEM_NOT_FOUND);
...
static void check_lower_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_ni_lower(NULL, 0, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_NI_ERROR_OBJECT_IS_NULL);
}

static void check_lower_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_ni_lower( (void *) 1, 0, NULL),
            BUTTERFLYFISH_SORTED_SET_NI_ERROR_OUT_IS_NULL);
}
...
static void check_lower_error_on_item_not_found(void **state) {
    ...
    will_return(get_emit_error,
                BUTTERFLYFISH_SORTED_SET_NI_ERROR_ITEM_NOT_FOUND);
    assert_int_equal(
            butterflyfish_sorted_set_ni_lower(
                    (struct butterflyfish_sorted_set_ni *) &instance,
                    0,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_SET_NI_ERROR_ITEM_NOT_FOUND);
