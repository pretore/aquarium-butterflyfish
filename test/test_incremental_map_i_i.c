...
struct instance {
    const struct butterflyfish_incremental_map_i_i *const id;
    void *data;
};
...
static int stream_first(const void *const object,
    ...
    seagrass_required_true(&incremental_map_i_i == instance->id);
    return mock();
}
...
static void check_as_stream(void **state) {
    assert_ptr_equal(incremental_map_i_i.as_stream, &stream_i_i);
}

static void check_as_collection(void **state) {
    assert_ptr_equal(incremental_map_i_i.as_collection, &collection_i_i);
}

static void check_as_set(void **state) {
    assert_ptr_equal(incremental_map_i_i.as_set, &set_i_i);
}

static void check_as_addable(void **state) {
    assert_ptr_equal(incremental_map_i_i.as_addable, &addable_i_i);
}

static void check_as_map(void **state) {
    assert_ptr_equal(incremental_map_i_i.as_map, &map_i_i);
}

static void check_count_error_on_object_is_null(void **state) {
    assert_int_equal(incremental_map_i_i.count(NULL, (void *) 1),
                     BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_count_error_on_out_is_null(void **state) {
    assert_int_equal(incremental_map_i_i.count((void *) 1, NULL),
...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(incremental_map_i_i.first(NULL, (void *) 1),
                     BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_first_error_on_out_is_null(void **state) {
    assert_int_equal(incremental_map_i_i.first((void *) 1, NULL),
                     BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(incremental_map_i_i.last(NULL, (void *) 1),
                     BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_last_error_on_out_is_null(void **state) {
    assert_int_equal(incremental_map_i_i.last((void *) 1, NULL),
                     BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(incremental_map_i_i.next(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_next_error_on_item_is_null(void **state) {
    assert_int_equal(incremental_map_i_i.next((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_ITEM_IS_NULL);
}

static void check_next_error_on_out_is_null(void **state) {
    assert_int_equal(incremental_map_i_i.next((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_prev_error_on_object_is_null(void **state) {
    assert_int_equal(incremental_map_i_i.prev(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_prev_error_on_item_is_null(void **state) {
    assert_int_equal(incremental_map_i_i.prev((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_ITEM_IS_NULL);
}

static void check_prev_error_on_out_is_null(void **state) {
    assert_int_equal(incremental_map_i_i.prev((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_contains_key_error_on_object_is_null(void **state) {
    assert_int_equal(incremental_map_i_i.contains_key(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_contains_key_error_on_key_is_null(void **state) {
    assert_int_equal(incremental_map_i_i.contains_key((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_KEY_IS_NULL);
}

static void check_contains_key_error_on_out_is_null(void **state) {
    assert_int_equal(incremental_map_i_i.contains_key((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_contains_value_error_on_object_is_null(void **state) {
    assert_int_equal(incremental_map_i_i.contains_value(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_contains_value_error_on_value_is_null(void **state) {
    assert_int_equal(incremental_map_i_i.contains_value((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_VALUE_IS_NULL);
}

static void check_contains_value_error_on_out_is_null(void **state) {
    assert_int_equal(incremental_map_i_i.contains_value((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_get_error_on_object_is_null(void **state) {
    assert_int_equal(incremental_map_i_i.get(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_get_error_on_key_is_null(void **state) {
    assert_int_equal(incremental_map_i_i.get((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_KEY_IS_NULL);
}

static void check_get_error_on_out_is_null(void **state) {
    assert_int_equal(incremental_map_i_i.get((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_get_entry_error_on_object_is_null(void **state) {
    assert_int_equal(incremental_map_i_i.get_entry(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_get_entry_error_on_key_is_null(void **state) {
    assert_int_equal(incremental_map_i_i.get_entry((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_KEY_IS_NULL);
}

static void check_get_entry_error_on_out_is_null(void **state) {
    assert_int_equal(incremental_map_i_i.get_entry((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_add_error_on_object_is_null(void **state) {
    assert_int_equal(incremental_map_i_i.add(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_add_error_on_key_is_null(void **state) {
    assert_int_equal(incremental_map_i_i.add((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_KEY_IS_NULL);
}

static void check_add_error_on_value_is_null(void **state) {
    assert_int_equal(incremental_map_i_i.add((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_VALUE_IS_NULL);
}
...
static void check_keys(void **state) {
    assert_int_equal(incremental_map_i_i.keys, (void *) 1);
}

static void check_values(void **state) {
    assert_ptr_equal(incremental_map_i_i.values, (void *) 1);
}
