...
struct object {
    const struct butterflyfish_sorted_settable_incremental_set_i_i *const
            sorted_settable_incremental_set_i_i;
    const struct butterflyfish_settable_incremental_set_i_i *const
            settable_incremental_set_i_i;
    const struct butterflyfish_sorted_incremental_set_i_i *const
            sorted_incremental_set_i_i;
    const struct butterflyfish_sorted_settable_set_i_i *const
            sorted_settable_set_i_i;
    ...
    const struct butterflyfish_sorted_set_i_i *const sorted_set_i_i;
...
static int
sorted_set_as_sorted(const struct butterflyfish_sorted_set_i_i *const object,
                     const struct butterflyfish_sorted_i_i **const out) {
    assert_non_null(object);
    assert_non_null(out);
    *out = butterflyfish_cast(object, struct object, sorted_set_i_i, sorted_i_i);
    return 0;
}

static int
sorted_set_as_set(const struct butterflyfish_sorted_set_i_i *const object,
                  const struct butterflyfish_set_i_i **const out) {
    assert_non_null(object);
    assert_non_null(out);
    *out = butterflyfish_cast(object, struct object, sorted_set_i_i, set_i_i);
    return 0;
}

const struct butterflyfish_sorted_set_i_i sorted_set_i_i = {
...
sorted_settable_set_as_settable_set(
        struct butterflyfish_sorted_settable_set_i_i *const object,
        struct butterflyfish_settable_set_i_i **const out) {
    assert_non_null(object);
    assert_non_null(out);
    *out = butterflyfish_cast(object, struct object, sorted_settable_set_i_i,
                              settable_set_i_i);
    return 0;
}
...
sorted_settable_set_as_sorted_set(
        const struct butterflyfish_sorted_settable_set_i_i *const object,
...
const struct butterflyfish_sorted_settable_set_i_i sorted_settable_set_i_i = {
...
sorted_incremental_set_as_incremental_set(
        struct butterflyfish_sorted_incremental_set_i_i *const object,
        struct butterflyfish_incremental_set_i_i **const out) {
    assert_non_null(object);
    assert_non_null(out);
    *out = butterflyfish_cast(object, struct object, sorted_incremental_set_i_i,
                              incremental_set_i_i);
    return 0;
}
...
sorted_incremental_set_as_sorted_set(
        const struct butterflyfish_sorted_incremental_set_i_i *const object,
        const struct butterflyfish_sorted_set_i_i **const out) {
    assert_non_null(object);
    assert_non_null(out);
    *out = butterflyfish_cast(object, struct object, sorted_incremental_set_i_i,
...
const struct
butterflyfish_sorted_incremental_set_i_i sorted_incremental_set_i_i = {
...
static void check_as_stream_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_set_i_i_as_stream(
                    NULL, (void *) 1),
...
static void check_as_stream(void **state) {
    const struct object instance = {
            ...
            .sorted_incremental_set_i_i = &sorted_incremental_set_i_i,
            .sorted_settable_set_i_i = &sorted_settable_set_i_i,
            .incremental_set_i_i = &incremental_set_i_i,
            .settable_set_i_i = &settable_set_i_i,
            .sorted_set_i_i = &sorted_set_i_i,
    ...
    assert_int_equal(butterflyfish_sorted_settable_incremental_set_i_i_as_stream(
            (const struct butterflyfish_sorted_settable_incremental_set_i_i *)
                    &instance, &out), 0);
...
static void check_as_collection_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_set_i_i_as_collection(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_collection(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_settable_incremental_set_i_i_as_collection(
            (const struct butterflyfish_sorted_settable_incremental_set_i_i *)
                    &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_sorted_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_set_i_i_as_sorted(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_sorted(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_settable_incremental_set_i_i_as_sorted(
            (const struct butterflyfish_sorted_settable_incremental_set_i_i *)
                    &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_set_i_i_as_set(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_set(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_settable_incremental_set_i_i_as_set(
            (const struct butterflyfish_sorted_settable_incremental_set_i_i *)
                    &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_settable_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_set_i_i_as_settable(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_settable(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_settable_incremental_set_i_i_as_settable(
...
static void check_as_addable_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_set_i_i_as_addable(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_addable(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_settable_incremental_set_i_i_as_addable(
            (struct butterflyfish_sorted_settable_incremental_set_i_i *)
                    &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_sorted_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_set_i_i_as_sorted_set(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_sorted_set(void **state) {
    ...
    const void *check = (char *) &instance
            + offsetof(struct object, sorted_set_i_i);
    const struct butterflyfish_sorted_set_i_i *out;
    assert_int_equal(butterflyfish_sorted_settable_incremental_set_i_i_as_sorted_set(
            (const struct butterflyfish_sorted_settable_incremental_set_i_i *)
                    &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_settable_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_set_i_i_as_settable_set(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_settable_set(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_settable_incremental_set_i_i_as_settable_set(
            (struct butterflyfish_sorted_settable_incremental_set_i_i *)
                    &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_incremental_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_set_i_i_as_incremental_set(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_incremental_set(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_settable_incremental_set_i_i_as_incremental_set(
                    (struct butterflyfish_sorted_settable_incremental_set_i_i *)
                    &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_sorted_settable_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_set_i_i_as_sorted_settable_set(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_sorted_settable_set(void **state) {
    ...
    const void *check = (char *) &instance
            + offsetof(struct object, sorted_settable_set_i_i);
    struct butterflyfish_sorted_settable_set_i_i *out;
    assert_int_equal(butterflyfish_sorted_settable_incremental_set_i_i_as_sorted_settable_set(
                    (struct butterflyfish_sorted_settable_incremental_set_i_i *)
                    &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_sorted_incremental_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_set_i_i_as_sorted_incremental_set(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_sorted_incremental_set(void **state) {
    ...
    const void *check = (char *) &instance
            + offsetof(struct object, sorted_incremental_set_i_i);
    struct butterflyfish_sorted_incremental_set_i_i *out;
    assert_int_equal(butterflyfish_sorted_settable_incremental_set_i_i_as_sorted_incremental_set(
                    (struct butterflyfish_sorted_settable_incremental_set_i_i *)
                    &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_settable_incremental_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_set_i_i_as_settable_incremental_set(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_settable_incremental_set(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_settable_incremental_set_i_i_as_settable_incremental_set(
                    (struct butterflyfish_sorted_settable_incremental_set_i_i *)
                    &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_sorted_incremental_set_as_sorted_set(void **state) {
    ...
    const void *check = (char *) &instance
            + offsetof(struct object, sorted_set_i_i);
    struct butterflyfish_sorted_incremental_set_i_i *as;
    assert_int_equal(butterflyfish_sorted_settable_incremental_set_i_i_as_sorted_incremental_set(
            (struct butterflyfish_sorted_settable_incremental_set_i_i *)
                    &instance, &as), 0);
    const struct butterflyfish_sorted_set_i_i *out;
    assert_int_equal(butterflyfish_sorted_incremental_set_i_i_as_sorted_set(
            as, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_sorted_incremental_set_as_incremental_set(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_settable_incremental_set_i_i_as_sorted_incremental_set(
            (struct butterflyfish_sorted_settable_incremental_set_i_i *)
                    &instance, &as), 0);
    struct butterflyfish_incremental_set_i_i *out;
    assert_int_equal(butterflyfish_sorted_incremental_set_i_i_as_incremental_set(
            as, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_sorted_set_as_set(void **state) {
    ...
    const void *check = (char *) &instance + offsetof(struct object, set_i_i);
    const struct butterflyfish_sorted_set_i_i *as;
    assert_int_equal(butterflyfish_sorted_settable_incremental_set_i_i_as_sorted_set(
            (const struct butterflyfish_sorted_settable_incremental_set_i_i *)
                    &instance, &as), 0);
    const struct butterflyfish_set_i_i *out;
    assert_int_equal(butterflyfish_sorted_set_i_i_as_set(as, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_count_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_set_i_i_count(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_count(void **state) {
    ...
    uintmax_t out;
    assert_int_equal(butterflyfish_sorted_settable_incremental_set_i_i_count(
            (const struct butterflyfish_sorted_settable_incremental_set_i_i *)
                    &instance, &out), 0);
...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_set_i_i_first(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_OBJECT_IS_NULL);
}
    ...
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_set_i_i_first(
                    (const struct butterflyfish_sorted_settable_incremental_set_i_i *)
                            &instance,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_SET_IS_EMPTY);
}

static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_set_i_i_last(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_set_i_i_next(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_next_error_on_end_of_sequence(void **state) {
    ...
    assert_int_equal(
            ...
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_END_OF_SEQUENCE);
}

static void check_prev_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_set_i_i_prev(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_contains_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_set_i_i_contains(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_contains_error_on_memory_allocation_failed(void **state) {
    ...
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_set_i_i_contains(
                    (const struct butterflyfish_sorted_settable_incremental_set_i_i *)
                            &instance, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_MEMORY_ALLOCATION_FAILED);
}

static void check_contains_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_set_i_i_contains_all(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_get_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_set_i_i_get(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_get_error_on_value_not_found(void **state) {
    ...
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_set_i_i_get(
                    (const struct butterflyfish_sorted_settable_incremental_set_i_i *)
                            &instance, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_VALUE_NOT_FOUND);
}
...
static void check_set_item_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_set_i_i_set_item(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_set_item_error_on_value_is_invalid(void **state) {
    ...
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_set_i_i_set_item(
                    (struct butterflyfish_sorted_settable_incremental_set_i_i
                            *) &instance,(void *) 1,(void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_VALUE_IS_INVALID);
}
...
static void check_set_item_error_on_value_already_exists(void **state) {
    ...
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_set_i_i_set_item(
                    (struct butterflyfish_sorted_settable_incremental_set_i_i
                            *) &instance,(void *) 1,(void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_VALUE_ALREADY_EXISTS);
}
...
static void check_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_set_i_i_set(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_add_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_set_i_i_add(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_add_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_set_i_i_add_all(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_ceiling_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_set_i_i_ceiling(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_floor_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_set_i_i_floor(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_higher_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_set_i_i_higher(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_lower_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_set_i_i_lower(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_OBJECT_IS_NULL);
}
