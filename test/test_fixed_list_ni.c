...
static void check_as_stream_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_fixed_list_ni_as_stream(NULL, (void *) 1),
            BUTTERFLYFISH_FIXED_LIST_NI_ERROR_OBJECT_IS_NULL);
}

static void check_as_stream_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_fixed_list_ni_as_stream((void *) 1, NULL),
...
static void check_as_stream(void **state) {
    ...
    assert_int_equal(butterflyfish_fixed_list_ni_as_stream(
            &fixed_list, &stream), 0);
...
static void check_as_collection_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_fixed_list_ni_as_collection(NULL, (void *) 1),
            BUTTERFLYFISH_FIXED_LIST_NI_ERROR_OBJECT_IS_NULL);
}

static void check_as_collection_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_fixed_list_ni_as_collection((void *) 1, NULL),
            BUTTERFLYFISH_FIXED_LIST_NI_ERROR_OUT_IS_NULL);
}
...
static void check_as_collection(void **state) {
    ...
    assert_int_equal(butterflyfish_fixed_list_ni_as_collection(
