...
struct object {
    const struct butterflyfish_ordered_mutable_list_i_i
            *const ordered_mutable_list_i_i;
    const struct butterflyfish_ordered_settable_incremental_list_i_i
            *const ordered_settable_incremental_list_i_i;
    const struct butterflyfish_ordered_settable_reducible_list_i_i
            *const ordered_settable_reducible_list_i_i;
    const struct butterflyfish_ordered_settable_list_i_i
            *const ordered_settable_list_i_i;
    const struct butterflyfish_ordered_incremental_list_i_i
            *const ordered_incremental_list_i_i;
    const struct butterflyfish_ordered_reducible_list_i_i
            *const ordered_reducible_list_i_i;
    const struct butterflyfish_mutable_list_i_i *const mutable_list_i_i;
    const struct butterflyfish_settable_incremental_list_i_i
            *const settable_incremental_list_i_i;
    const struct butterflyfish_settable_reducible_list_i_i
            *const settable_reducible_list_i_i;
    const struct butterflyfish_reducible_list_i_i *const reducible_list_i_i;
    const struct butterflyfish_incremental_list_i_i *const incremental_list_i_i;
    const struct butterflyfish_settable_list_i_i *const settable_list_i_i;
    const struct butterflyfish_ordered_list_i_i *const ordered_list_i_i;
...
ordered_list_as_ordered(
        const struct butterflyfish_ordered_list_i_i *const object,
        const struct butterflyfish_ordered_i_i **const out) {
    assert_non_null(object);
    assert_non_null(out);
    *out = butterflyfish_cast(object, struct object, ordered_list_i_i,
            ordered_i_i);
    return 0;
}
...
ordered_list_as_list(
    ...
    assert_non_null(object);
    assert_non_null(out);
    *out = butterflyfish_cast(object, struct object, ordered_list_i_i, list_i_i);
    return 0;
}

const struct butterflyfish_ordered_list_i_i ordered_list_i_i = {
        .as_ordered = ordered_list_as_ordered,
        .as_list = ordered_list_as_list,
};

static int
settable_list_as_list(
...
incremental_list_as_list(
        const struct butterflyfish_incremental_list_i_i *const object,
        const struct butterflyfish_list_i_i **const out) {
    assert_non_null(object);
    assert_non_null(out);
    *out = butterflyfish_cast(object, struct object, incremental_list_i_i,
                              list_i_i);
    return 0;
}
...
incremental_list_as_addable(
        struct butterflyfish_incremental_list_i_i *const object,
...
const struct butterflyfish_incremental_list_i_i incremental_list_i_i = {
...
removable_remove_item(struct butterflyfish_removable_i_i *const object,
                      const struct butterflyfish_map_i_i_entry *const other) {
    function_called();
    assert_non_null(object);
    assert_non_null(other);
    return mock();
...
reducible_list_as_list(
        const struct butterflyfish_reducible_list_i_i *const object,
        const struct butterflyfish_list_i_i **const out) {
    assert_non_null(object);
    assert_non_null(out);
    *out = butterflyfish_cast(object, struct object, reducible_list_i_i,
                              list_i_i);
    return 0;
}

static int
reducible_list_as_removable(struct butterflyfish_reducible_list_i_i *const object,
...
static int
reducible_list_remove(struct butterflyfish_reducible_list_i_i *const object,
                      const uintmax_t at) {
    function_called();
    assert_non_null(object);
    return mock();
...
static int
reducible_list_remove_all(struct butterflyfish_reducible_list_i_i *const object,
...
const struct butterflyfish_reducible_list_i_i reducible_list_i_i = {
...
settable_incremental_list_as_incremental_list(
    ...
    *out = butterflyfish_cast(object, struct object,
                              settable_incremental_list_i_i,
                              incremental_list_i_i);
    return 0;
}

const struct
butterflyfish_settable_incremental_list_i_i settable_incremental_list_i_i = {
...
settable_reducible_list_as_settable_list(
        struct butterflyfish_settable_reducible_list_i_i *const object,
        struct butterflyfish_settable_list_i_i **const out) {
    assert_non_null(object);
    assert_non_null(out);
    *out = butterflyfish_cast(object, struct object,
                              settable_reducible_list_i_i,
                              settable_list_i_i);
    return 0;
}
...
const struct
butterflyfish_settable_reducible_list_i_i settable_reducible_list_i_i = {
...
mutable_list_as_settable_incremental_list(
        struct butterflyfish_mutable_list_i_i *const object,
        struct butterflyfish_settable_incremental_list_i_i **const out) {
    assert_non_null(object);
    assert_non_null(out);
    *out = butterflyfish_cast(object, struct object,
                              mutable_list_i_i,
...
mutable_list_as_settable_reducible_list(
        struct butterflyfish_mutable_list_i_i *const object,
        struct butterflyfish_settable_reducible_list_i_i **const out) {
    assert_non_null(object);
    assert_non_null(out);
    *out = butterflyfish_cast(object, struct object,
                              mutable_list_i_i,
...
const struct
butterflyfish_mutable_list_i_i mutable_list_i_i = {
...
ordered_reducible_list_as_reducible_list(
    ...
    assert_non_null(object);
    assert_non_null(out);
    *out = butterflyfish_cast(object, struct object, ordered_reducible_list_i_i,
                              reducible_list_i_i);
    return 0;
}
...
const struct
butterflyfish_ordered_reducible_list_i_i ordered_reducible_list_i_i = {
...
ordered_incremental_list_as_incremental_list(
        struct butterflyfish_ordered_incremental_list_i_i *const object,
        struct butterflyfish_incremental_list_i_i **const out) {
    assert_non_null(object);
    assert_non_null(out);
    *out = butterflyfish_cast(object, struct object,
                              ordered_incremental_list_i_i, incremental_list_i_i);
    return 0;
}

static int
ordered_incremental_list_as_ordered_list(
        const struct butterflyfish_ordered_incremental_list_i_i *const object,
        const struct butterflyfish_ordered_list_i_i **const out) {
    assert_non_null(object);
    assert_non_null(out);
    *out = butterflyfish_cast(object, struct object,
                              ordered_incremental_list_i_i, ordered_list_i_i);
    return 0;
}
...
ordered_incremental_list_as_insertable(
    ...
    assert_non_null(out);
    *out = butterflyfish_cast(object, struct object,
                              ordered_incremental_list_i_i, insertable_i_i);
    return 0;
}

const struct
butterflyfish_ordered_incremental_list_i_i ordered_incremental_list_i_i = {
...
ordered_settable_list_as_ordered_list(
        const struct butterflyfish_ordered_settable_list_i_i *const object,
        const struct butterflyfish_ordered_list_i_i **const out) {
    assert_non_null(object);
    assert_non_null(out);
    *out = butterflyfish_cast(object, struct object, ordered_settable_list_i_i,
            ordered_list_i_i);
    return 0;
}
...
ordered_settable_list_as_settable_list(
        struct butterflyfish_ordered_settable_list_i_i *const object,
        struct butterflyfish_settable_list_i_i **const out) {
    assert_non_null(object);
    assert_non_null(out);
    *out = butterflyfish_cast(object, struct object, ordered_settable_list_i_i,
...
const struct butterflyfish_ordered_settable_list_i_i ordered_settable_list_i_i = {
...
ordered_settable_incremental_list_as_ordered_settable_list(
        struct butterflyfish_ordered_settable_incremental_list_i_i *const object,
        struct butterflyfish_ordered_settable_list_i_i **const out) {
    assert_non_null(object);
    assert_non_null(out);
    *out = butterflyfish_cast(object, struct object,
                              ordered_settable_incremental_list_i_i,
                              ordered_settable_list_i_i);
    return 0;
}
...
ordered_settable_incremental_list_as_ordered_incremental_list(
        struct butterflyfish_ordered_settable_incremental_list_i_i *const object,
        struct butterflyfish_ordered_incremental_list_i_i **const out) {
    assert_non_null(object);
    assert_non_null(out);
    *out = butterflyfish_cast(object, struct object,
                              settable_incremental_list_i_i,
...
const struct
butterflyfish_ordered_settable_incremental_list_i_i
ordered_settable_incremental_list_i_i = {
...
ordered_settable_reducible_list_as_ordered_settable_list(
        struct butterflyfish_ordered_settable_reducible_list_i_i *const object,
        struct butterflyfish_ordered_settable_list_i_i **const out) {
    assert_non_null(object);
    assert_non_null(out);
    *out = butterflyfish_cast(object, struct object,
                              ordered_settable_reducible_list_i_i,
                              ordered_settable_list_i_i);
    return 0;
}
...
ordered_settable_reducible_list_as_ordered_reducible_list(
        struct butterflyfish_ordered_settable_reducible_list_i_i *const object,
        struct butterflyfish_ordered_reducible_list_i_i **const out) {
    assert_non_null(object);
    assert_non_null(out);
    *out = butterflyfish_cast(object, struct object,
                              ordered_settable_reducible_list_i_i,
                              ordered_reducible_list_i_i);
    return 0;
}

const struct
butterflyfish_ordered_settable_reducible_list_i_i
ordered_settable_reducible_list_i_i = {
        .as_ordered_settable_list =
                ordered_settable_reducible_list_as_ordered_settable_list,
...
ordered_mutable_list_as_mutable_list(
        struct butterflyfish_ordered_mutable_list_i_i *const object,
        struct butterflyfish_mutable_list_i_i **const out) {
    assert_non_null(object);
    assert_non_null(out);
    *out = butterflyfish_cast(object, struct object, ordered_mutable_list_i_i,
                              mutable_list_i_i);
    return 0;
}
...
ordered_mutable_list_as_ordered_settable_incremental_list(
        struct butterflyfish_ordered_mutable_list_i_i *const object,
        struct butterflyfish_ordered_settable_incremental_list_i_i **const out) {
    assert_non_null(object);
    assert_non_null(out);
    *out = butterflyfish_cast(object, struct object, ordered_mutable_list_i_i,
                              ordered_settable_incremental_list_i_i);
...
ordered_mutable_list_as_ordered_settable_reducible_list(
        struct butterflyfish_ordered_mutable_list_i_i *const object,
        struct butterflyfish_ordered_settable_reducible_list_i_i **const out) {
    assert_non_null(object);
    assert_non_null(out);
    *out = butterflyfish_cast(object, struct object, ordered_mutable_list_i_i,
                              ordered_settable_reducible_list_i_i);
...
const struct butterflyfish_ordered_mutable_list_i_i ordered_mutable_list_i_i = {
...
static void check_as_stream_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_as_stream(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_stream_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_as_stream((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OUT_IS_NULL);
}

static void check_as_stream(void **state) {
    const struct object instance = {
            .ordered_mutable_list_i_i = &ordered_mutable_list_i_i,
            .ordered_settable_incremental_list_i_i =
                    &ordered_settable_incremental_list_i_i,
            .ordered_settable_reducible_list_i_i =
                    &ordered_settable_reducible_list_i_i,
            .ordered_settable_list_i_i = &ordered_settable_list_i_i,
            .ordered_incremental_list_i_i = &ordered_incremental_list_i_i,
            .ordered_reducible_list_i_i = &ordered_reducible_list_i_i,
            .mutable_list_i_i = &mutable_list_i_i,
            .settable_incremental_list_i_i = &settable_incremental_list_i_i,
            .settable_reducible_list_i_i = &settable_reducible_list_i_i,
            .reducible_list_i_i = &reducible_list_i_i,
            .incremental_list_i_i = &incremental_list_i_i,
            .settable_list_i_i = &settable_list_i_i,
            .ordered_list_i_i = &ordered_list_i_i,
            .list_i_i = &list_i_i,
    ...
    assert_int_equal(butterflyfish_ordered_mutable_list_i_i_as_stream(
            (const struct butterflyfish_ordered_mutable_list_i_i *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}

static void check_as_collection_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_as_collection(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_collection_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_as_collection((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_as_collection(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_mutable_list_i_i_as_collection(
            (const struct butterflyfish_ordered_mutable_list_i_i *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_list_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_as_list(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_list_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_as_list((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_as_list(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_mutable_list_i_i_as_list(
            (const struct butterflyfish_ordered_mutable_list_i_i *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_settable_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_as_settable(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_settable_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_as_settable((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_as_settable(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_mutable_list_i_i_as_settable(
            (struct butterflyfish_ordered_mutable_list_i_i *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}

static void check_as_ordered_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_as_ordered(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_ordered_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_as_ordered((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_as_ordered(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_mutable_list_i_i_as_ordered(
            (const struct butterflyfish_ordered_mutable_list_i_i *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_addable_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_as_addable(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_addable_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_as_addable((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_as_addable(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_mutable_list_i_i_as_addable(
            (struct butterflyfish_ordered_mutable_list_i_i *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_removable_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_as_removable(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_removable_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_as_removable((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_as_removable(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_mutable_list_i_i_as_removable(
            (struct butterflyfish_ordered_mutable_list_i_i *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_insertable_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_as_insertable(
                    NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_insertable(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_mutable_list_i_i_as_insertable(
            (struct butterflyfish_ordered_mutable_list_i_i *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_ordered_list_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_as_ordered_list(
                    NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_ordered_list(void **state) {
    ...
    const void *check = (char *) &instance
                        + offsetof(struct object, ordered_list_i_i);
    const struct butterflyfish_ordered_list_i_i *out;
    assert_int_equal(butterflyfish_ordered_mutable_list_i_i_as_ordered_list(
            (const struct butterflyfish_ordered_mutable_list_i_i *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_settable_list_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_as_settable_list(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_settable_list_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_as_settable_list((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_as_settable_list(void **state) {
    ...
    const void *check = (char *) &instance
                        + offsetof(struct object, settable_list_i_i);
    struct butterflyfish_settable_list_i_i *out;
    assert_int_equal(butterflyfish_ordered_mutable_list_i_i_as_settable_list(
            (struct butterflyfish_ordered_mutable_list_i_i *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_incremental_list_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_as_incremental_list(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_incremental_list_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_as_incremental_list((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_as_incremental_list(void **state) {
    ...
    const void *check = (char *) &instance
                        + offsetof(struct object, incremental_list_i_i);
    struct butterflyfish_incremental_list_i_i *out;
    assert_int_equal(butterflyfish_ordered_mutable_list_i_i_as_incremental_list(
            (struct butterflyfish_ordered_mutable_list_i_i *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_reducible_list_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_as_reducible_list(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_reducible_list_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_as_reducible_list((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_as_reducible_list(void **state) {
    ...
    const void *check = (char *) &instance
                        + offsetof(struct object, reducible_list_i_i);
    struct butterflyfish_reducible_list_i_i *out;
    assert_int_equal(butterflyfish_ordered_mutable_list_i_i_as_reducible_list(
            (struct butterflyfish_ordered_mutable_list_i_i *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
check_as_settable_incremental_list_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_as_settable_incremental_list(
                    NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_settable_incremental_list(void **state) {
    ...
    const void *check = (char *) &instance
                        + offsetof(struct object, settable_incremental_list_i_i);
    struct butterflyfish_settable_incremental_list_i_i *out;
    assert_int_equal(butterflyfish_ordered_mutable_list_i_i_as_settable_incremental_list(
            (struct butterflyfish_ordered_mutable_list_i_i *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
check_as_settable_reducible_list_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_as_settable_reducible_list(
                    NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_settable_reducible_list(void **state) {
    ...
    const void *check = (char *) &instance
                        + offsetof(struct object, settable_reducible_list_i_i);
    struct butterflyfish_settable_reducible_list_i_i *out;
    assert_int_equal(butterflyfish_ordered_mutable_list_i_i_as_settable_reducible_list(
            (struct butterflyfish_ordered_mutable_list_i_i *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_mutable_list_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_as_mutable_list(
                    NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_mutable_list(void **state) {
    ...
    const void *check = (char *) &instance
                        + offsetof(struct object, mutable_list_i_i);
...
static void check_as_ordered_settable_list_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_as_ordered_settable_list(
                    NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_ordered_settable_list(void **state) {
    ...
    const void *check = (char *) &instance
                        + offsetof(struct object, ordered_settable_list_i_i);
    struct butterflyfish_ordered_settable_list_i_i *out;
    assert_int_equal(butterflyfish_ordered_mutable_list_i_i_as_ordered_settable_list(
            (struct butterflyfish_ordered_mutable_list_i_i *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
check_as_ordered_incremental_list_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_as_ordered_incremental_list(
                    NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_ordered_incremental_list(void **state) {
    ...
    const void *check = (char *) &instance
                        + offsetof(struct object, ordered_incremental_list_i_i);
...
check_as_ordered_reducible_list_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_as_ordered_reducible_list(
                    NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_ordered_reducible_list(void **state) {
    ...
    const void *check = (char *) &instance
                        + offsetof(struct object, ordered_reducible_list_i_i);
...
check_as_ordered_settable_incremental_list_error_on_object_is_null(
        void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_as_ordered_settable_incremental_list(
                    NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_ordered_settable_incremental_list(void **state) {
    ...
    const void *check = (char *) &instance
            + offsetof(struct object, ordered_settable_incremental_list_i_i);
    struct butterflyfish_ordered_settable_incremental_list_i_i *out;
    assert_int_equal(butterflyfish_ordered_mutable_list_i_i_as_ordered_settable_incremental_list(
            (struct butterflyfish_ordered_mutable_list_i_i *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
check_as_ordered_settable_reducible_list_error_on_object_is_null(
        void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_as_ordered_settable_reducible_list(
                    NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_ordered_settable_reducible_list(void **state) {
    ...
    const void *check = (char *) &instance
            + offsetof(struct object, ordered_settable_reducible_list_i_i);
    struct butterflyfish_ordered_settable_reducible_list_i_i *out;
    assert_int_equal(butterflyfish_ordered_mutable_list_i_i_as_ordered_settable_reducible_list(
            (struct butterflyfish_ordered_mutable_list_i_i *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
check_ordered_settable_reducible_list_as_ordered_settable_list(void **state) {
    ...
    const void *check = (char *) &instance
            + offsetof(struct object, ordered_settable_list_i_i);
    struct butterflyfish_ordered_settable_reducible_list_i_i *as;
    assert_int_equal(butterflyfish_ordered_mutable_list_i_i_as_ordered_settable_reducible_list(
            (struct butterflyfish_ordered_mutable_list_i_i *) &instance, &as), 0);
    struct butterflyfish_ordered_settable_list_i_i *out;
    assert_int_equal(butterflyfish_ordered_settable_reducible_list_i_i_as_ordered_settable_list(
            as, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_settable_reducible_list_as_settable_list(void **state) {
    ...
    const void *check = (char *) &instance
            + offsetof(struct object, settable_list_i_i);
    struct butterflyfish_settable_reducible_list_i_i *as;
    assert_int_equal(butterflyfish_ordered_mutable_list_i_i_as_settable_reducible_list(
            (struct butterflyfish_ordered_mutable_list_i_i *) &instance, &as), 0);
    struct butterflyfish_settable_list_i_i *out;
    assert_int_equal(butterflyfish_settable_reducible_list_i_i_as_settable_list(
            as, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_mutable_list_as_settable_list(void **state) {
    ...
    const void *check = (char *) &instance
                        + offsetof(struct object, settable_list_i_i);
    struct butterflyfish_mutable_list_i_i *as;
    assert_int_equal(butterflyfish_ordered_mutable_list_i_i_as_mutable_list(
            (struct butterflyfish_ordered_mutable_list_i_i *) &instance, &as), 0);
    struct butterflyfish_settable_list_i_i *out;
    assert_int_equal(butterflyfish_mutable_list_i_i_as_settable_list(as, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_mutable_list_as_incremental_list(void **state) {
    ...
    struct butterflyfish_incremental_list_i_i *out;
    assert_int_equal(
            butterflyfish_mutable_list_i_i_as_incremental_list(as, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_mutable_list_as_reducible_list(void **state) {
    ...
    struct butterflyfish_reducible_list_i_i *out;
    assert_int_equal(
            butterflyfish_mutable_list_i_i_as_reducible_list(as, &out) ,0);
    assert_ptr_equal(out, check);
}
...
static void check_ordered_reducible_list_as_ordered_list(void **state) {
    ...
    const void *check = (char *) &instance
                        + offsetof(struct object, ordered_list_i_i);
    struct butterflyfish_ordered_reducible_list_i_i *as;
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_as_ordered_reducible_list(
            (struct butterflyfish_ordered_mutable_list_i_i *) &instance, &as), 0);
    const struct butterflyfish_ordered_list_i_i *out;
    assert_int_equal(
            butterflyfish_ordered_reducible_list_i_i_as_ordered_list(as, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_ordered_incremental_list_as_ordered_list(void **state) {
    ...
    const void *check = (char *) &instance
                        + offsetof(struct object, ordered_list_i_i);
    struct butterflyfish_ordered_incremental_list_i_i *as;
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_as_ordered_incremental_list(
                    (struct butterflyfish_ordered_mutable_list_i_i *) &instance, &as), 0);
    const struct butterflyfish_ordered_list_i_i *out;
    assert_int_equal(butterflyfish_ordered_incremental_list_i_i_as_ordered_list(
                    as, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_ordered_list_as_list(void **state) {
    ...
    const void *check = (char *) &instance
                        + offsetof(struct object, list_i_i);
    const struct butterflyfish_ordered_list_i_i *as;
    assert_int_equal(butterflyfish_ordered_mutable_list_i_i_as_ordered_list(
            (const struct butterflyfish_ordered_mutable_list_i_i *) &instance, &as), 0);
    const struct butterflyfish_list_i_i *out;
    assert_int_equal(butterflyfish_ordered_list_i_i_as_list(as, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_settable_list_as_list(void **state) {
    ...
    const void *check = (char *) &instance + offsetof(struct object, list_i_i);
    struct butterflyfish_settable_list_i_i *as;
    assert_int_equal(butterflyfish_ordered_mutable_list_i_i_as_settable_list(
            (struct butterflyfish_ordered_mutable_list_i_i *) &instance, &as), 0);
    const struct butterflyfish_list_i_i *out;
    assert_int_equal(butterflyfish_settable_list_i_i_as_list(as, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_incremental_list_as_list(void **state) {
    ...
    const void *check = (char *) &instance + offsetof(struct object, list_i_i);
    struct butterflyfish_incremental_list_i_i *as;
    assert_int_equal(butterflyfish_ordered_mutable_list_i_i_as_incremental_list(
            (struct butterflyfish_ordered_mutable_list_i_i *) &instance, &as), 0);
    const struct butterflyfish_list_i_i *out;
    assert_int_equal(butterflyfish_incremental_list_i_i_as_list(as, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_reducible_list_as_list(void **state) {
    ...
    const void *check = (char *) &instance + offsetof(struct object, list_i_i);
    struct butterflyfish_reducible_list_i_i *as;
    assert_int_equal(butterflyfish_ordered_mutable_list_i_i_as_reducible_list(
            (struct butterflyfish_ordered_mutable_list_i_i *) &instance, &as), 0);
    const struct butterflyfish_list_i_i *out;
    assert_int_equal(butterflyfish_reducible_list_i_i_as_list(as, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_count_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_count(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_count_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_count((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_count(void **state) {
    ...
    uintmax_t out;
    assert_int_equal(butterflyfish_ordered_mutable_list_i_i_count(
            (const struct butterflyfish_ordered_mutable_list_i_i *) &instance, &out), 0);
...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_first(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_first_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_first((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_first_error_on_list_is_empty(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_first(
                    (const struct butterflyfish_ordered_mutable_list_i_i *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_LIST_IS_EMPTY);
}

static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_last(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_last_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_last((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_last_error_on_list_is_empty(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_last(
                    (const struct butterflyfish_ordered_mutable_list_i_i *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_LIST_IS_EMPTY);
}
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_next(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_next_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_next((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_ITEM_IS_NULL);
}

static void check_next_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_next((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_next_error_on_end_of_sequence(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_next(
                    (const struct butterflyfish_ordered_mutable_list_i_i *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_END_OF_SEQUENCE);
}

static void check_prev_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_prev(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_prev_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_prev((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_ITEM_IS_NULL);
}

static void check_prev_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_prev((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_prev_error_on_end_of_sequence(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_prev(
                    (const struct butterflyfish_ordered_mutable_list_i_i *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_END_OF_SEQUENCE);
...
static void check_get_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_get(NULL, 0, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_get_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_get((void *) 1, 0, NULL),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_get_error_on_index_out_of_bounds(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_get(
                    (const struct butterflyfish_ordered_mutable_list_i_i *) &instance,
                    0,
                    (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_INDEX_IS_OUT_OF_BOUNDS);
}

static void check_at_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_at(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_at_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_at((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_ITEM_IS_NULL);
}

static void check_at_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_at((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_at_error_on_item_not_found(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_at(
                    (const struct butterflyfish_ordered_mutable_list_i_i *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_ITEM_NOT_FOUND);
}

static void check_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_set(NULL, 0, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_set_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_set((void *) 1, 0, NULL),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_VALUE_IS_NULL);
}
...
static void check_set_error_on_index_out_of_bounds(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_set(
                    (struct butterflyfish_ordered_mutable_list_i_i *) &instance,
                    0,
                    (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_INDEX_IS_OUT_OF_BOUNDS);
}
...
static void check_set_error_on_value_is_invalid(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_set(
                    ...
                    0,
                    (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_VALUE_IS_INVALID);
}

static void check_set_item_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_set_item(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_add_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_add(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_add_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_add((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_VALUE_IS_NULL);
}
...
static void check_add_error_on_memory_allocation_failed(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_add(
                    (struct butterflyfish_ordered_mutable_list_i_i *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_MEMORY_ALLOCATION_FAILED);
}
...
static void check_add_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_add_all(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_add_all_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_add_all((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OTHER_IS_NULL);
}
...
static void check_add_all_error_on_memory_allocation_failed(void **state) {
    ...
    will_return(addable_add_all,
                BUTTERFLYFISH_ADDABLE_I_I_ERROR_MEMORY_ALLOCATION_FAILED);
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_add_all(
                    (struct butterflyfish_ordered_mutable_list_i_i *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_MEMORY_ALLOCATION_FAILED);
}
...
static void check_remove_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_remove(NULL, 0),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_remove(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_remove(
                    (struct butterflyfish_ordered_mutable_list_i_i *) &instance, 0),
            0);
}
...
static void check_remove_error_on_index_out_of_bounds(void **state) {
    ...
    will_return(reducible_list_remove,
                BUTTERFLYFISH_REDUCIBLE_LIST_I_I_ERROR_INDEX_IS_OUT_OF_BOUNDS);
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_remove(
                    (struct butterflyfish_ordered_mutable_list_i_i *) &instance,
                    0),
...
static void check_remove_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_remove_all(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_remove_all_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_remove_all((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OTHER_IS_NULL);
}
...
static void check_remove_all_error_on_memory_allocation_failed(void **state) {
    ...
    will_return(reducible_list_remove_all,
                BUTTERFLYFISH_REDUCIBLE_LIST_I_I_ERROR_MEMORY_ALLOCATION_FAILED);
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_remove_all(
                    (struct butterflyfish_ordered_mutable_list_i_i *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_MEMORY_ALLOCATION_FAILED);
}
...
static void check_remove_item_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_remove_item(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_remove_item_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_remove_item((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_ITEM_IS_NULL);
}
...
static void check_remove_item(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_remove_item(
                    (struct butterflyfish_ordered_mutable_list_i_i *) &instance,
                    (void *) 1),
            0);
}
...
static void check_remove_all_items_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_remove_all_items(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_remove_all_items_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_remove_all_items((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OTHER_IS_NULL);
}
...
static void check_remove_all_items(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_remove_all_items(
                    (struct butterflyfish_ordered_mutable_list_i_i *) &instance,
                    (void *) 1),
            0);
}
...
static void check_insert_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_insert(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_insert_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_list_i_i_insert_all(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
