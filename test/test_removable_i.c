...
struct instance {
    const struct butterflyfish_removable_i *const id;
    void *data;
};
...
static int stream_first(const void *const object,
    ...
    seagrass_required_true(&removable_i == instance->id);
    return mock();
}
...
static void check_as_stream(void **state) {
    assert_ptr_equal(removable_i.as_stream, &stream_i);
}

static void check_as_collection(void **state) {
    assert_ptr_equal(removable_i.as_collection, &collection_i);
}

static void check_count_error_on_object_is_null(void **state) {
    assert_int_equal(removable_i.count(NULL, (void *) 1),
                     BUTTERFLYFISH_REMOVABLE_I_ERROR_OBJECT_IS_NULL);
}

static void check_count_error_on_out_is_null(void **state) {
    assert_int_equal(removable_i.count((void *) 1, NULL),
...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(removable_i.first(NULL, (void *) 1),
                     BUTTERFLYFISH_REMOVABLE_I_ERROR_OBJECT_IS_NULL);
}

static void check_first_error_on_out_is_null(void **state) {
    assert_int_equal(removable_i.first((void *) 1, NULL),
                     BUTTERFLYFISH_REMOVABLE_I_ERROR_OUT_IS_NULL);
}
...
static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(removable_i.last(NULL, (void *) 1),
                     BUTTERFLYFISH_REMOVABLE_I_ERROR_OBJECT_IS_NULL);
}

static void check_last_error_on_out_is_null(void **state) {
    assert_int_equal(removable_i.last((void *) 1, NULL),
                     BUTTERFLYFISH_REMOVABLE_I_ERROR_OUT_IS_NULL);
}
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(removable_i.next(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_REMOVABLE_I_ERROR_OBJECT_IS_NULL);
}

static void check_next_error_on_item_is_null(void **state) {
    assert_int_equal(removable_i.next((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_REMOVABLE_I_ERROR_ITEM_IS_NULL);
}

static void check_next_error_on_out_is_null(void **state) {
    assert_int_equal(removable_i.next((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_REMOVABLE_I_ERROR_OUT_IS_NULL);
}
...
static void check_prev_error_on_object_is_null(void **state) {
    assert_int_equal(removable_i.prev(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_REMOVABLE_I_ERROR_OBJECT_IS_NULL);
}

static void check_prev_error_on_item_is_null(void **state) {
    assert_int_equal(removable_i.prev((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_REMOVABLE_I_ERROR_ITEM_IS_NULL);
}

static void check_prev_error_on_out_is_null(void **state) {
    assert_int_equal(removable_i.prev((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_REMOVABLE_I_ERROR_OUT_IS_NULL);
}
...
static void check_remove_item_error_on_object_is_null(void **state) {
    assert_int_equal(removable_i.remove_item(NULL, (void *) 1),
                     BUTTERFLYFISH_REMOVABLE_I_ERROR_OBJECT_IS_NULL);
}

static void check_remove_item_error_on_item_is_null(void **state) {
    assert_int_equal(removable_i.remove_item((void *) 1, NULL),
                     BUTTERFLYFISH_REMOVABLE_I_ERROR_ITEM_IS_NULL);
}
...
static void check_remove_item(void **state) {
    ...
    assert_int_equal(removable_i.remove_item(&instance, (void *) 1), 0);
}
