...
static void check_at_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_list_sr_at(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_LIST_SR_ERROR_OBJECT_IS_NULL);
}

static void check_at_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_list_sr_at((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_LIST_SR_ERROR_ITEM_IS_NULL);
}

static void check_at_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_list_sr_at((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_REDUCIBLE_LIST_SR_ERROR_OUT_IS_NULL);
}
...
static void check_remove_item_error_on_item_out_of_bounds(void **state) {
    const struct butterflyfish_list_sr list_sr = {
            .reducible_list_sr.remove_item = remove_item_emit_error
    };
    struct object {
        const struct butterflyfish_list_sr *list_sr;
    };
