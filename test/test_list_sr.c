...
static void check_as_collection(void **state) {
    ...
    assert_int_equal(butterflyfish_list_sr_as_collection(
            &list, &collection), 0);
...
static void check_as_fixed_list_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_sr_as_fixed_list(NULL, (void *) 1),
            BUTTERFLYFISH_LIST_SR_ERROR_OBJECT_IS_NULL);
}

static void check_as_fixed_list_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_sr_as_fixed_list((void *) 1, NULL),
            BUTTERFLYFISH_LIST_SR_ERROR_OUT_IS_NULL);
}

static void check_as_fixed_list(void **state) {
    struct butterflyfish_list_sr list = {};
    struct butterflyfish_fixed_list_sr *fixed_list;
    assert_int_equal(butterflyfish_list_sr_as_fixed_list(
            &list, &fixed_list), 0);
...
static void check_as_reducible_list_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_sr_as_reducible_list(NULL, (void *) 1),
            BUTTERFLYFISH_LIST_SR_ERROR_OBJECT_IS_NULL);
}

static void check_as_reducible_list_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_sr_as_reducible_list((void *) 1, NULL),
            BUTTERFLYFISH_LIST_SR_ERROR_OUT_IS_NULL);
}

static void check_as_reducible_list(void **state) {
    struct butterflyfish_list_sr list = {};
    struct butterflyfish_reducible_list_sr *reducible_list;
    assert_int_equal(butterflyfish_list_sr_as_reducible_list(
...
static void check_count_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_sr_count(NULL, (void *) 1),
            BUTTERFLYFISH_LIST_SR_ERROR_OBJECT_IS_NULL);
}

static void check_count_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_sr_count((void *) 1, NULL),
            BUTTERFLYFISH_LIST_SR_ERROR_OUT_IS_NULL);
}
...
static void check_count(void **state) {
    srand(time(NULL));
    const struct butterflyfish_list_sr list_sr = {
            .reducible_list_sr.fixed_list_sr.collection_sr.count = count
    };
    struct object {
        const struct butterflyfish_list_sr *list_sr;
    };
    ...
    uintmax_t out;
    assert_int_equal(butterflyfish_list_sr_count(
            (const struct butterflyfish_list_sr *) &instance, &out), 0);
    assert_int_equal(out, check);
}

static void check_count_as_reducible_list(void **state) {
    srand(time(NULL));
    const struct butterflyfish_reducible_list_sr reducible_list_sr = {
            .fixed_list_sr.collection_sr.count = count
    };
    struct object {
        const struct butterflyfish_reducible_list_sr *reducible_list_sr;
    };
    struct object instance = {
            .reducible_list_sr = &reducible_list_sr
    };
    expect_function_call(count);
    const uintmax_t check = abs(rand());
    will_return(count, check);
    uintmax_t out;
    assert_int_equal(
            butterflyfish_reducible_list_sr_count(
                    (const struct butterflyfish_reducible_list_sr *) &instance,
                    &out),
            0);
    assert_int_equal(out, check);
}
...
static void check_count_as_fixed_list(void **state) {
    ...
    uintmax_t out;
    assert_int_equal(
            butterflyfish_fixed_list_sr_count(
...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_sr_first(NULL, (void *) 1),
            BUTTERFLYFISH_LIST_SR_ERROR_OBJECT_IS_NULL);
}

static void check_first_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_sr_first((void *) 1, NULL),
            BUTTERFLYFISH_LIST_SR_ERROR_OUT_IS_NULL);
}
...
static void check_first_error_on_list_is_empty(void **state) {
    const struct butterflyfish_list_sr list_sr = {
            .reducible_list_sr.fixed_list_sr.collection_sr.stream_sr.first
            = fl_emit_error
    };
    struct object {
        const struct butterflyfish_list_sr *list_sr;
    ...
    will_return(fl_emit_error,
                BUTTERFLYFISH_LIST_SR_ERROR_LIST_IS_EMPTY);
    assert_int_equal(
            butterflyfish_list_sr_first(
                    (const struct butterflyfish_list_sr *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_LIST_SR_ERROR_LIST_IS_EMPTY);
}
...
check_as_reducible_list_first_error_on_reducible_list_is_empty(void **state) {
    ...
    will_return(fl_emit_error,
                BUTTERFLYFISH_LIST_SR_ERROR_LIST_IS_EMPTY);
    assert_int_equal(
            butterflyfish_reducible_list_sr_first(
                    (const struct butterflyfish_reducible_list_sr *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_LIST_SR_ERROR_LIST_IS_EMPTY);
}
...
static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_sr_last(NULL, (void *) 1),
            BUTTERFLYFISH_LIST_SR_ERROR_OBJECT_IS_NULL);
}

static void check_last_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_sr_last((void *) 1, NULL),
            BUTTERFLYFISH_LIST_SR_ERROR_OUT_IS_NULL);
}

static void check_last_error_on_list_is_empty(void **state) {
    const struct butterflyfish_list_sr list_sr = {
            .reducible_list_sr.fixed_list_sr.collection_sr.last = fl_emit_error
    };
    struct object {
        const struct butterflyfish_list_sr *list_sr;
    };
...
check_as_reducible_list_last_error_on_reducible_list_is_empty(void **state) {
    ...
    will_return(fl_emit_error,
                BUTTERFLYFISH_LIST_SR_ERROR_LIST_IS_EMPTY);
    assert_int_equal(
            butterflyfish_reducible_list_sr_last(
                    (const struct butterflyfish_reducible_list_sr *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_LIST_SR_ERROR_LIST_IS_EMPTY);
}
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_sr_next(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_LIST_SR_ERROR_OBJECT_IS_NULL);
}

static void check_next_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_sr_next((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_LIST_SR_ERROR_ITEM_IS_NULL);
}

static void check_next_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_sr_next((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_LIST_SR_ERROR_OUT_IS_NULL);
}
...
static void check_next_error_on_end_of_sequence(void **state) {
    const struct butterflyfish_list_sr list_sr = {
            .reducible_list_sr.fixed_list_sr.collection_sr.stream_sr.next
            = np_emit_error
    };
    struct object {
        const struct butterflyfish_list_sr *list_sr;
    ...
    will_return(np_emit_error,
                BUTTERFLYFISH_LIST_SR_ERROR_END_OF_SEQUENCE);
    assert_int_equal(
            butterflyfish_list_sr_next(
                    (const struct butterflyfish_list_sr *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_LIST_SR_ERROR_END_OF_SEQUENCE);
...
check_as_reducible_list_next_error_on_end_of_sequence(void **state) {
    ...
    will_return(np_emit_error,
                BUTTERFLYFISH_LIST_SR_ERROR_END_OF_SEQUENCE);
    assert_int_equal(
            butterflyfish_reducible_list_sr_next(
                    (const struct butterflyfish_reducible_list_sr *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_LIST_SR_ERROR_END_OF_SEQUENCE);
}
...
static void check_prev_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_sr_prev(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_LIST_SR_ERROR_OBJECT_IS_NULL);
}

static void check_prev_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_sr_prev((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_LIST_SR_ERROR_ITEM_IS_NULL);
}

static void check_prev_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_sr_prev((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_LIST_SR_ERROR_OUT_IS_NULL);
}

static void check_prev_error_on_end_of_sequence(void **state) {
    const struct butterflyfish_list_sr list_sr = {
            .reducible_list_sr.fixed_list_sr.collection_sr.prev = np_emit_error
    };
    struct object {
        const struct butterflyfish_list_sr *list_sr;
    };
...
check_as_reducible_list_prev_error_on_end_of_sequence(void **state) {
    ...
    will_return(np_emit_error,
                BUTTERFLYFISH_LIST_SR_ERROR_END_OF_SEQUENCE);
    assert_int_equal(
            butterflyfish_reducible_list_sr_prev(
                    (const struct butterflyfish_reducible_list_sr *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_LIST_SR_ERROR_END_OF_SEQUENCE);
...
static void check_get_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_sr_get(NULL, 0, (void *) 1),
            BUTTERFLYFISH_LIST_SR_ERROR_OBJECT_IS_NULL);
}

static void check_get_error_on_out(void **state) {
    assert_int_equal(
            butterflyfish_list_sr_get((void *) 1, 0, NULL),
            BUTTERFLYFISH_LIST_SR_ERROR_OUT_IS_NULL);
}
...
static void check_get_error_on_index_out_of_bounds(void **state) {
    const struct butterflyfish_list_sr list_sr = {
            .reducible_list_sr.fixed_list_sr.get = get_emit_error
    };
    struct object {
        const struct butterflyfish_list_sr *list_sr;
    };
    ...
    will_return(get_emit_error,
                BUTTERFLYFISH_LIST_SR_ERROR_INDEX_IS_OUT_OF_BOUNDS);
    assert_int_equal(
            butterflyfish_list_sr_get(
                    (const struct butterflyfish_list_sr *) &instance,
                    0,
                    (void *) 1),
            BUTTERFLYFISH_LIST_SR_ERROR_INDEX_IS_OUT_OF_BOUNDS);
...
check_as_reducible_list_get_error_on_index_out_of_bounds(void **state) {
    ...
    will_return(get_emit_error,
                BUTTERFLYFISH_LIST_SR_ERROR_INDEX_IS_OUT_OF_BOUNDS);
    assert_int_equal(
            butterflyfish_reducible_list_sr_get(
                    (const struct butterflyfish_reducible_list_sr *) &instance,
                    0,
                    (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_LIST_SR_ERROR_INDEX_IS_OUT_OF_BOUNDS);
}
...
static void check_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_sr_set(NULL, 0, (void *) 1),
            BUTTERFLYFISH_LIST_SR_ERROR_OBJECT_IS_NULL);
}

static void check_set_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_sr_set((void *) 1, 0, NULL),
            BUTTERFLYFISH_LIST_SR_ERROR_VALUE_IS_NULL);
}
...
static void check_set_error_on_index_out_of_bounds(void **state) {
    const struct butterflyfish_list_sr list_sr = {
            .reducible_list_sr.fixed_list_sr.set = set_emit_error
    };
    struct object {
        const struct butterflyfish_list_sr *list_sr;
    };
    ...
    will_return(set_emit_error,
                BUTTERFLYFISH_LIST_SR_ERROR_INDEX_IS_OUT_OF_BOUNDS);
    assert_int_equal(
            butterflyfish_list_sr_set(
                    (struct butterflyfish_list_sr *) &instance,
                    0,
                    (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_LIST_SR_ERROR_INDEX_IS_OUT_OF_BOUNDS);
}
...
check_as_reducible_list_set_error_on_index_out_of_bounds(void **state) {
    ...
    will_return(set_emit_error,
                BUTTERFLYFISH_LIST_SR_ERROR_INDEX_IS_OUT_OF_BOUNDS);
    assert_int_equal(
            butterflyfish_reducible_list_sr_set(
                    (struct butterflyfish_reducible_list_sr *) &instance,
                    0,
                    (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_LIST_SR_ERROR_INDEX_IS_OUT_OF_BOUNDS);
}
...
static void check_set_error_on_memory_allocation_failed(void **state) {
    ...
    expect_function_call(set_emit_error);
    will_return(set_emit_error,
                BUTTERFLYFISH_LIST_SR_ERROR_MEMORY_ALLOCATION_FAILED);
    assert_int_equal(
            butterflyfish_list_sr_set(
                    (struct butterflyfish_list_sr *) &instance,
                    0,
...
check_as_reducible_list_set_error_on_memory_allocation_failed(void **state) {
    ...
    assert_int_equal(
            butterflyfish_reducible_list_sr_set(
                    ...
                    0,
                    (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_LIST_SR_ERROR_MEMORY_ALLOCATION_FAILED);
}

static void
check_as_fixed_list_set_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_reducible_list_sr reducible_list_sr = {
            .fixed_list_sr.set = set_emit_error
    };
    struct object {
        const struct butterflyfish_reducible_list_sr *reducible_list_sr;
    };
...
static void check_set_error_on_value_is_invalid(void **state) {
    ...
    expect_function_call(set_emit_error);
    will_return(set_emit_error,
                BUTTERFLYFISH_LIST_SR_ERROR_VALUE_IS_INVALID);
    assert_int_equal(
            butterflyfish_list_sr_set(
                    (struct butterflyfish_list_sr *) &instance,
                    0,
...
check_as_reducible_list_set_error_on_value_is_invalid(void **state) {
    ...
    assert_int_equal(
            butterflyfish_reducible_list_sr_set(
                    ...
                    0,
                    (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_LIST_SR_ERROR_VALUE_IS_INVALID);
}
...
static void check_set_item_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_sr_set_item(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_LIST_SR_ERROR_OBJECT_IS_NULL);
}

static void check_set_item_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_sr_set_item((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_LIST_SR_ERROR_ITEM_IS_NULL);
}

static void check_set_item_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_sr_set_item((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_LIST_SR_ERROR_VALUE_IS_NULL);
}
...
static void check_set_item_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_list_sr list_sr = {
            .reducible_list_sr.fixed_list_sr.set_item = set_item_emit_error
    };
    struct object {
        const struct butterflyfish_list_sr *list_sr;
    };
    ...
    will_return(set_item_emit_error,
                BUTTERFLYFISH_LIST_SR_ERROR_MEMORY_ALLOCATION_FAILED);
    assert_int_equal(
            butterflyfish_list_sr_set_item(
                    (struct butterflyfish_list_sr *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_LIST_SR_ERROR_MEMORY_ALLOCATION_FAILED);
...
check_as_reducible_list_set_item_error_on_memory_allocation_failed(
    ...
    will_return(set_item_emit_error,
                BUTTERFLYFISH_LIST_SR_ERROR_MEMORY_ALLOCATION_FAILED);
    assert_int_equal(
            butterflyfish_reducible_list_sr_set_item(
                    (struct butterflyfish_reducible_list_sr *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_LIST_SR_ERROR_MEMORY_ALLOCATION_FAILED);
...
static void check_at_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_sr_at(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_LIST_SR_ERROR_OBJECT_IS_NULL);
}

static void check_at_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_sr_at((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_LIST_SR_ERROR_ITEM_IS_NULL);
}

static void check_at_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_sr_at((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_LIST_SR_ERROR_OUT_IS_NULL);
}
...
static void check_at_error_on_item_is_out_of_bounds(void **state) {
    const struct butterflyfish_list_sr list_sr = {
            .reducible_list_sr.fixed_list_sr.at = at_emit_error
    };
    struct object {
        const struct butterflyfish_list_sr *list_sr;
    };
    ...
    will_return(at_emit_error,
                BUTTERFLYFISH_LIST_SR_ERROR_ITEM_IS_OUT_OF_BOUNDS);
    assert_int_equal(
            butterflyfish_list_sr_at(
                    (struct butterflyfish_list_sr *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_LIST_SR_ERROR_ITEM_IS_OUT_OF_BOUNDS);
...
check_as_reducible_list_at_error_on_item_is_out_of_bounds(void **state) {
    ...
    will_return(at_emit_error,
                BUTTERFLYFISH_LIST_SR_ERROR_ITEM_IS_OUT_OF_BOUNDS);
    assert_int_equal(
            butterflyfish_reducible_list_sr_at(
                    (struct butterflyfish_reducible_list_sr *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_LIST_SR_ERROR_ITEM_IS_OUT_OF_BOUNDS);
}
...
static void check_remove_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_sr_remove(NULL, 0),
            BUTTERFLYFISH_LIST_SR_ERROR_OBJECT_IS_NULL);
}
...
static void check_remove_error_on_index_out_of_bounds(void **state) {
    const struct butterflyfish_list_sr list_sr = {
            .reducible_list_sr.remove = remove_emit_error
    };
    struct object {
        const struct butterflyfish_list_sr *list_sr;
    };
...
check_as_reducible_list_remove_error_on_index_out_of_bounds(void **state) {
    ...
    will_return(remove_emit_error,
                BUTTERFLYFISH_LIST_SR_ERROR_INDEX_IS_OUT_OF_BOUNDS);
    assert_int_equal(
            butterflyfish_reducible_list_sr_remove(
                    (struct butterflyfish_reducible_list_sr *) &instance,
                    0),
            BUTTERFLYFISH_REDUCIBLE_LIST_SR_ERROR_INDEX_IS_OUT_OF_BOUNDS);
}
...
static void check_remove(void **state) {
    const struct butterflyfish_list_sr list_sr = {
            .reducible_list_sr.remove = remove
    };
    struct object {
        const struct butterflyfish_list_sr *list_sr;
    };
    ...
    assert_int_equal(
            butterflyfish_list_sr_remove(
                    (struct butterflyfish_list_sr *) &instance, 0),
            0);
}
...
static void check_as_reducible_list_remove(void **state) {
    ...
    assert_int_equal(
            butterflyfish_reducible_list_sr_remove(
                    (struct butterflyfish_reducible_list_sr *) &instance, 0),
            0);
}

static void check_remove_item_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_sr_remove_item(NULL, (void *) 1),
            BUTTERFLYFISH_LIST_SR_ERROR_OBJECT_IS_NULL);
}

static void check_remove_item_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_sr_remove_item((void *) 1, NULL),
            BUTTERFLYFISH_LIST_SR_ERROR_ITEM_IS_NULL);
}
...
static void check_remove_item(void **state) {
    const struct butterflyfish_list_sr list_sr = {
            .reducible_list_sr.remove_item = remove_item
    };
    struct object {
        const struct butterflyfish_list_sr *list_sr;
    };
    ...
    assert_int_equal(
            butterflyfish_list_sr_remove_item(
                    (struct butterflyfish_list_sr *) &instance,
                    (void *) 1),
            0);
}
...
static void check_as_reducible_list_remove_item(void **state) {
    ...
    expect_function_call(remove_item);
    assert_int_equal(
            butterflyfish_reducible_list_sr_remove_item(
                    (struct butterflyfish_reducible_list_sr *) &instance,
                    (void *) 1),
            0);
}
...
static void check_remove_items_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_sr_remove_all_items(NULL, (void *) 1),
            BUTTERFLYFISH_LIST_SR_ERROR_OBJECT_IS_NULL);
}

static void check_remove_items_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_sr_remove_all_items((void *) 1, NULL),
            BUTTERFLYFISH_LIST_SR_ERROR_OTHER_IS_NULL);
}

static int
remove_all_items(void *const object,
                 const struct butterflyfish_stream_sr *const stream) {
    function_called();
    assert_non_null(object);
...
static void check_remove_items(void **state) {
    const struct butterflyfish_list_sr list_sr = {
            .reducible_list_sr.remove_all_items = remove_all_items
    };
    struct object {
        const struct butterflyfish_list_sr *list_sr;
    };
    ...
    assert_int_equal(
            butterflyfish_list_sr_remove_all_items(
                    (struct butterflyfish_list_sr *) &instance,
                    (void *) 1),
            0);
}
...
static void check_as_reducible_list_remove_items(void **state) {
    ...
    expect_function_call(remove_all_items);
    assert_int_equal(
            butterflyfish_reducible_list_sr_remove_all_items(
                    (struct butterflyfish_reducible_list_sr *) &instance,
                    (void *) 1),
            0);
}
...
static void check_add_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_sr_add(NULL, (void *) 1),
            BUTTERFLYFISH_LIST_SR_ERROR_OBJECT_IS_NULL);
}

static void check_add_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_sr_add((void *) 1, NULL),
            BUTTERFLYFISH_LIST_SR_ERROR_VALUE_IS_NULL);
}
...
static void check_add_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_sr_add_all(NULL, (void *) 1),
            BUTTERFLYFISH_LIST_SR_ERROR_OBJECT_IS_NULL);
}

static void check_add_all_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_sr_add_all((void *) 1, NULL),
            BUTTERFLYFISH_LIST_SR_ERROR_OTHER_IS_NULL);
}
...
static void check_insert_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_sr_insert(NULL, 0, (void *) 1),
            BUTTERFLYFISH_LIST_SR_ERROR_OBJECT_IS_NULL);
}

static void check_insert_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_sr_insert((void *) 1, 0, NULL),
            BUTTERFLYFISH_LIST_SR_ERROR_VALUE_IS_NULL);
}
...
static void check_insert_item_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_sr_insert_item(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_LIST_SR_ERROR_OBJECT_IS_NULL);
}

static void check_insert_item_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_sr_insert_item((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_LIST_SR_ERROR_ITEM_IS_NULL);
}

static void check_insert_item_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_sr_insert_item((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_LIST_SR_ERROR_VALUE_IS_NULL);
}
...
static void check_insert_item_error_on_item_is_out_of_bounds(void **state) {
    ...
    will_return(insert_item_emit_error,
                BUTTERFLYFISH_LIST_SR_ERROR_ITEM_IS_OUT_OF_BOUNDS);
    assert_int_equal(
            butterflyfish_list_sr_insert_item(
                    (struct butterflyfish_list_sr *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_LIST_SR_ERROR_ITEM_IS_OUT_OF_BOUNDS);
...
static void check_insert_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_sr_insert_all(NULL, 0, (void *) 1),
            BUTTERFLYFISH_LIST_SR_ERROR_OBJECT_IS_NULL);
}

static void check_insert_all_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_sr_insert_all((void *) 1, 0, NULL),
            BUTTERFLYFISH_LIST_SR_ERROR_OTHER_IS_NULL);
}
...
static void check_insert_all_error_on_index_is_out_of_bounds(void **state) {
    ...
    will_return(insert_all_emit_error,
                BUTTERFLYFISH_LIST_SR_ERROR_INDEX_IS_OUT_OF_BOUNDS);
    assert_int_equal(
            butterflyfish_list_sr_insert_all(
                    (struct butterflyfish_list_sr *) &instance,
                    0,
                    (void *) 1),
            BUTTERFLYFISH_LIST_SR_ERROR_INDEX_IS_OUT_OF_BOUNDS);
...
static void check_insert_all_item_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_sr_insert_all_item(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_LIST_SR_ERROR_OBJECT_IS_NULL);
}

static void check_insert_all_item_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_sr_insert_all_item((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_LIST_SR_ERROR_ITEM_IS_NULL);
}

static void check_insert_all_item_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_sr_insert_all_item((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_LIST_SR_ERROR_OTHER_IS_NULL);
}

static void
check_insert_all_item_error_on_item_is_out_of_bounds(void **state) {
    const struct butterflyfish_list_sr list_sr = {
    ...
    will_return(insert_all_item_emit_error,
                BUTTERFLYFISH_LIST_SR_ERROR_ITEM_IS_OUT_OF_BOUNDS);
    assert_int_equal(
            butterflyfish_list_sr_insert_all_item(
                    (struct butterflyfish_list_sr *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_LIST_SR_ERROR_ITEM_IS_OUT_OF_BOUNDS);
