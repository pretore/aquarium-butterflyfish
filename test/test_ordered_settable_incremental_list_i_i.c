...
struct object {
    const struct butterflyfish_ordered_settable_incremental_list_i_i *const
            ordered_settable_incremental_list_i_i;
    const struct butterflyfish_settable_incremental_list_i_i *const
            settable_incremental_list_i_i;
    const struct butterflyfish_ordered_settable_list_i_i *const
            ordered_settable_list_i_i;
    const struct butterflyfish_ordered_incremental_list_i_i *const
            ordered_incremental_list_i_i;
...
static int
ordered_list_as_list(const struct butterflyfish_ordered_list_i_i *const object,
...
settable_incremental_list_as_incremental_list(
    ...
    assert_non_null(out);
    *out = butterflyfish_cast(object, struct object,
                              settable_incremental_list_i_i, incremental_list_i_i);
    return 0;
}
...
settable_incremental_list_as_settable_list(
    ...
    assert_non_null(out);
    *out = butterflyfish_cast(object, struct object,
                              settable_incremental_list_i_i, settable_list_i_i);
    return 0;
}
...
static void check_as_stream_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_list_i_i_as_stream(
                    NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_stream_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_list_i_i_as_stream(
                    (void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_as_stream(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_settable_incremental_list_i_i_as_stream(
...
static void check_as_collection_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_list_i_i_as_collection(
                    NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_collection(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_settable_incremental_list_i_i_as_collection(
            (const struct butterflyfish_ordered_settable_incremental_list_i_i
                    *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_ordered_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_list_i_i_as_ordered(
                    NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_ordered(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_settable_incremental_list_i_i_as_ordered(
            (const struct butterflyfish_ordered_settable_incremental_list_i_i
            *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_list_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_list_i_i_as_list(
                    NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_list(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_settable_incremental_list_i_i_as_list(
            (const struct butterflyfish_ordered_settable_incremental_list_i_i
                    *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_addable_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_list_i_i_as_addable(
                    NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_addable(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_settable_incremental_list_i_i_as_addable(
            (struct butterflyfish_ordered_settable_incremental_list_i_i *)
                    &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_settable_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_list_i_i_as_settable(
                    NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_settable(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_settable_incremental_list_i_i_as_settable(
            (struct butterflyfish_ordered_settable_incremental_list_i_i
            *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_insertable_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_list_i_i_as_insertable(
                    NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_insertable(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_settable_incremental_list_i_i_as_insertable(
            (struct butterflyfish_ordered_settable_incremental_list_i_i
            *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_ordered_list_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_list_i_i_as_ordered_list(
                    NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_ordered_list(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_settable_incremental_list_i_i_as_ordered_list(
            (const struct butterflyfish_ordered_settable_incremental_list_i_i
            *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_incremental_list_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_list_i_i_as_incremental_list(
                    NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_incremental_list(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_settable_incremental_list_i_i_as_incremental_list(
            (struct butterflyfish_ordered_settable_incremental_list_i_i *)
                    &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_settable_list_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_list_i_i_as_settable_list(
                    NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_settable_list(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_settable_incremental_list_i_i_as_settable_list(
            (struct butterflyfish_ordered_settable_incremental_list_i_i *)
                    &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_ordered_incremental_list_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_list_i_i_as_ordered_incremental_list(
                    NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_ordered_incremental_list(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_settable_incremental_list_i_i_as_ordered_incremental_list(
            (struct butterflyfish_ordered_settable_incremental_list_i_i *)
                    &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_ordered_settable_list_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_list_i_i_as_ordered_settable_list(
                    NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_ordered_settable_list(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_settable_incremental_list_i_i_as_ordered_settable_list(
            (struct butterflyfish_ordered_settable_incremental_list_i_i *)
                    &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_settable_incremental_list_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_list_i_i_as_settable_incremental_list(
                    NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_settable_incremental_list(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_settable_incremental_list_i_i_as_settable_incremental_list(
            (struct butterflyfish_ordered_settable_incremental_list_i_i *)
                    &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_settable_incremental_list_as_settable_list(void **state) {
    ...
    const void *check = (char *) &instance
                        + offsetof(struct object, settable_list_i_i);
    struct butterflyfish_settable_incremental_list_i_i *as;
    assert_int_equal(butterflyfish_ordered_settable_incremental_list_i_i_as_settable_incremental_list(
            (struct butterflyfish_ordered_settable_incremental_list_i_i *) &instance,
            &as), 0);
    struct butterflyfish_settable_list_i_i *out;
    assert_int_equal(butterflyfish_settable_incremental_list_i_i_as_settable_list(as, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_settable_incremental_list_as_incremental_list(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_settable_incremental_list_i_i_as_settable_incremental_list(
            ...
            &as), 0);
    struct butterflyfish_incremental_list_i_i *out;
    assert_int_equal(butterflyfish_settable_incremental_list_i_i_as_incremental_list(as, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_ordered_settable_list_as_ordered_list(void **state) {
    ...
    const void *check = (char *) &instance
            + offsetof(struct object, ordered_list_i_i);
    struct butterflyfish_ordered_settable_list_i_i *as;
    assert_int_equal(butterflyfish_ordered_settable_incremental_list_i_i_as_ordered_settable_list(
            (struct butterflyfish_ordered_settable_incremental_list_i_i *) &instance,
            &as), 0);
    const struct butterflyfish_ordered_list_i_i *out;
    assert_int_equal(butterflyfish_ordered_settable_list_i_i_as_ordered_list(
            as, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_count_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_list_i_i_count(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_count_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_list_i_i_count((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_count(void **state) {
    ...
    uintmax_t out;
    assert_int_equal(butterflyfish_ordered_settable_incremental_list_i_i_count(
            (const struct butterflyfish_ordered_settable_incremental_list_i_i *) &instance, &out), 0);
    assert_int_equal(out, check);
}

static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_list_i_i_first(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_first_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_list_i_i_first((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_first_error_on_list_is_empty(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_list_i_i_first(
                    (const struct butterflyfish_ordered_settable_incremental_list_i_i *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_LIST_IS_EMPTY);
}

static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_list_i_i_last(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_last_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_list_i_i_last((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_last_error_on_list_is_empty(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_list_i_i_last(
                    (const struct butterflyfish_ordered_settable_incremental_list_i_i *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_LIST_IS_EMPTY);
}
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_list_i_i_next(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_next_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_list_i_i_next((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_ITEM_IS_NULL);
}

static void check_next_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_list_i_i_next((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_next_error_on_end_of_sequence(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_list_i_i_next(
                    (const struct butterflyfish_ordered_settable_incremental_list_i_i *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_END_OF_SEQUENCE);
}

static void check_prev_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_list_i_i_prev(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_prev_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_list_i_i_prev((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_ITEM_IS_NULL);
}

static void check_prev_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_list_i_i_prev((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_prev_error_on_end_of_sequence(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_list_i_i_prev(
                    (const struct butterflyfish_ordered_settable_incremental_list_i_i *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_END_OF_SEQUENCE);
...
static void check_get_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_list_i_i_get(NULL, 0, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_get_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_list_i_i_get((void *) 1, 0, NULL),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_get_error_on_index_out_of_bounds(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_list_i_i_get(
                    (const struct butterflyfish_ordered_settable_incremental_list_i_i *) &instance,
                    0,
                    (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_INDEX_IS_OUT_OF_BOUNDS);
}

static void check_at_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_list_i_i_at(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_at_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_list_i_i_at((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_ITEM_IS_NULL);
}

static void check_at_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_list_i_i_at((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_at_error_on_item_not_found(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_list_i_i_at(
                    (const struct butterflyfish_ordered_settable_incremental_list_i_i *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_ITEM_NOT_FOUND);
}

static void check_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_list_i_i_set(NULL, 0, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_set_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_list_i_i_set((void *) 1, 0, NULL),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_VALUE_IS_NULL);
}
...
static void check_set_error_on_index_out_of_bounds(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_list_i_i_set(
                    (struct butterflyfish_ordered_settable_incremental_list_i_i *) &instance,
                    0,
                    (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_INDEX_IS_OUT_OF_BOUNDS);
...
static void check_set_error_on_memory_allocation_failed(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_list_i_i_set(
                    ...
                    0,
                    (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_MEMORY_ALLOCATION_FAILED);
}
...
static void check_set_error_on_value_is_invalid(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_list_i_i_set(
                    ...
                    0,
                    (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_VALUE_IS_INVALID);
}

static void check_set_item_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_list_i_i_set_item(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_add_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_list_i_i_add(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_add_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_list_i_i_add((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_VALUE_IS_NULL);
}
...
static void check_add_error_on_memory_allocation_failed(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_list_i_i_add(
                    (struct butterflyfish_ordered_settable_incremental_list_i_i *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_MEMORY_ALLOCATION_FAILED);
}
...
static void check_add_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_list_i_i_add_all(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_add_all_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_list_i_i_add_all((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OTHER_IS_NULL);
}
...
static void check_add_all_error_on_memory_allocation_failed(void **state) {
    ...
    will_return(addable_add_all,
                BUTTERFLYFISH_ADDABLE_I_I_ERROR_MEMORY_ALLOCATION_FAILED);
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_list_i_i_add_all(
                    (struct butterflyfish_ordered_settable_incremental_list_i_i *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_MEMORY_ALLOCATION_FAILED);
}
...
static void check_insert_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_list_i_i_insert(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_insert_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_list_i_i_insert(
                    (void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_INCREMENTAL_LIST_I_I_ERROR_ITEM_IS_NULL);
}
...
static void check_insert_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_list_i_i_insert(
                    (void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_INCREMENTAL_LIST_I_I_ERROR_VALUE_IS_NULL);
}
...
static void check_insert_error_on_value_is_invalid(void **state) {
    ...
    assert_int_equal(
            ...
            BUTTERFLYFISH_ORDERED_INCREMENTAL_LIST_I_I_ERROR_VALUE_IS_INVALID);
}
...
static void check_insert_error_on_memory_allocation_failed(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_list_i_i_insert(
                    (struct butterflyfish_ordered_settable_incremental_list_i_i *)
                            &instance, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_INCREMENTAL_LIST_I_I_ERROR_MEMORY_ALLOCATION_FAILED);
}

static void check_insert_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_list_i_i_insert_all(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_insert_all_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_list_i_i_insert_all(
                    (void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_INCREMENTAL_LIST_I_I_ERROR_OTHER_IS_NULL);
}
