...
static void check_as_stream_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_i_as_stream(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_stream_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_i_as_stream((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_I_ERROR_OUT_IS_NULL);
}

static void check_as_stream(void **state) {
    struct butterflyfish_sorted_set_i sorted_set = {};
    const struct butterflyfish_stream_i *stream;
    assert_int_equal(butterflyfish_sorted_set_i_as_stream(
            &sorted_set, &stream), 0);
...
static void check_as_collection_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_i_as_collection(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_collection_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_i_as_collection((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_I_ERROR_OUT_IS_NULL);
}
...
static void check_as_collection(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_set_i_as_collection(
...
static void check_as_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_i_as_set(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_set_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_i_as_set((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_I_ERROR_OUT_IS_NULL);
}
...
static void check_as_set(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_set_i_as_set(&sorted_set, &set), 0);
    assert_ptr_equal(&sorted_set, set);
}

static void check_as_ordered_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_i_as_ordered_set(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_ordered_set_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_i_as_ordered_set((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_I_ERROR_OUT_IS_NULL);
}
...
static void check_as_ordered_set(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_set_i_as_ordered_set(
...
static void check_count(void **state) {
    ...
    const struct butterflyfish_sorted_set_i sorted_set_i = {
            .ordered_set_i.set_i.collection_i.count = count
    };
    struct object {
        const struct butterflyfish_sorted_set_i *sorted_set_i;
    };
    ...
    uintmax_t out;
    assert_int_equal(
            butterflyfish_sorted_set_i_count(
...
static void check_remove_item(void **state) {
    const struct butterflyfish_sorted_set_i sorted_set_i = {
            .ordered_set_i.set_i.remove_item = remove_item
    };
    struct object {
        const struct butterflyfish_sorted_set_i *sorted_set_i;
    };
    ...
    assert_int_equal(
            butterflyfish_sorted_set_i_remove_item(
...
static void check_remove_all_items(void **state) {
    const struct butterflyfish_sorted_set_i sorted_set_i = {
            .ordered_set_i.set_i.remove_all_items = remove_all_items
    };
    struct object {
        const struct butterflyfish_sorted_set_i *sorted_set_i;
    };
    ...
    assert_int_equal(
            butterflyfish_sorted_set_i_remove_all_items(
                    (struct butterflyfish_sorted_set_i *) &instance,
                    (void *) 1),
            0);
}
...
static void check_contains_error_on_memory_allocation_failed(void **state) {
    ...
    will_return(contains_emit_error,
                BUTTERFLYFISH_SORTED_SET_I_ERROR_MEMORY_ALLOCATION_FAILED);
    assert_int_equal(
            butterflyfish_sorted_set_i_contains(
                    (struct butterflyfish_sorted_set_i *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_SET_I_ERROR_MEMORY_ALLOCATION_FAILED);
