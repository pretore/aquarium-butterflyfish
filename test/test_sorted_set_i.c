...
static void check_as_stream(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_set_i_as_stream(
            (const struct butterflyfish_sorted_set_i *) &instance, &out), 0);
...
static void check_as_sorted_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_i_as_sorted(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_sorted_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_i_as_sorted((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_I_ERROR_OUT_IS_NULL);
}
...
static void check_as_sorted(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_set_i_as_sorted(
            (struct butterflyfish_sorted_set_i *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_set(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_set_i_as_set(
            (struct butterflyfish_sorted_set_i *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_sorted_as_collection(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_set_i_as_sorted(
            (struct butterflyfish_sorted_set_i *) &instance, &as), 0);
    const struct butterflyfish_collection_i *out;
...
static void check_count(void **state) {
    ...
    uintmax_t out;
    assert_int_equal(butterflyfish_sorted_set_i_count(
            (const struct butterflyfish_sorted_set_i *) &instance, &out), 0);
