...
static void check_as_stream_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_as_stream(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_OBJECT_IS_NULL);
}

static void check_as_stream_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_as_stream((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_OUT_IS_NULL);
}

static void check_as_stream(void **state) {
    struct butterflyfish_sorted_map_s_s sorted_map = {};
    const struct butterflyfish_stream_s_s *stream;
    assert_int_equal(butterflyfish_sorted_map_s_s_as_stream(
            &sorted_map, &stream), 0);
...
static void check_as_collection_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_as_collection(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_OBJECT_IS_NULL);
}

static void check_as_collection_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_as_collection((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_OUT_IS_NULL);
}
...
static void check_as_collection(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_map_s_s_as_collection(
...
static void check_as_map_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_as_map(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_OBJECT_IS_NULL);
}

static void check_as_map_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_as_map((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_OUT_IS_NULL);
}
...
static void check_as_map(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_map_s_s_as_map(
            &sorted_map, &map), 0);
...
static void check_as_ordered_map_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_as_ordered_map(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_OBJECT_IS_NULL);
}

static void check_as_ordered_map_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_as_ordered_map((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_OUT_IS_NULL);
}
...
static void check_as_ordered_map(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_map_s_s_as_ordered_map(
...
static void check_count_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_count(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_OBJECT_IS_NULL);
}

static void check_count_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_count((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_OUT_IS_NULL);
}
...
static void check_count(void **state) {
    ...
    const struct butterflyfish_sorted_map_s_s sorted_map_s_s = {
            .ordered_map_s_s.map_s_s.collection_s_s.count = count
    };
    struct object {
        const struct butterflyfish_sorted_map_s_s *sorted_map_s_s;
    };
    struct object instance = {
            .sorted_map_s_s = &sorted_map_s_s
    };
    ...
    uintmax_t out;
    assert_int_equal(
            butterflyfish_sorted_map_s_s_count(
                    (const struct butterflyfish_sorted_map_s_s *) &instance,
                    &out),
            0);
...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_first(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_OBJECT_IS_NULL);
}

static void check_first_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_first((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_OUT_IS_NULL);
}
...
static void check_first_error_on_map_is_empty(void **state) {
    ...
    will_return(fl_emit_error,
                BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_MAP_IS_EMPTY);
    assert_int_equal(
            butterflyfish_sorted_map_s_s_first(
                    (const struct butterflyfish_sorted_map_s_s *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_MAP_IS_EMPTY);
}
...
static void check_as_sorted_map_first_error_on_map_is_empty(void **state) {
    const struct butterflyfish_sorted_map_s_s sorted_map_s_s = {
            .ordered_map_s_s.map_s_s.collection_s_s.stream_s_s.first
            = fl_emit_error
    };
    struct object {
        const struct butterflyfish_sorted_map_s_s *sorted_map_s_s;
...
static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_last(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_OBJECT_IS_NULL);
}

static void check_last_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_last((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_OUT_IS_NULL);
}
...
static void check_last_error_on_map_is_empty(void **state) {
    ...
    will_return(fl_emit_error,
                BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_MAP_IS_EMPTY);
    assert_int_equal(
            butterflyfish_sorted_map_s_s_last(
                    (const struct butterflyfish_sorted_map_s_s *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_MAP_IS_EMPTY);
}
...
static void check_as_sorted_map_last_error_on_map_is_empty(void **state) {
    const struct butterflyfish_sorted_map_s_s sorted_map_s_s = {
            .ordered_map_s_s.map_s_s.collection_s_s.last = fl_emit_error
    };
    struct object {
        const struct butterflyfish_sorted_map_s_s *sorted_map_s_s;
    };
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_next(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_OBJECT_IS_NULL);
}

static void check_next_error_on_entry_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_next((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_ENTRY_IS_NULL);
}

static void check_next_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_next((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_OUT_IS_NULL);
}
...
static void check_next_error_on_end_of_sequence(void **state) {
    ...
    will_return(np_emit_error,
                BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_END_OF_SEQUENCE);
    assert_int_equal(
            butterflyfish_sorted_map_s_s_next(
                    (const struct butterflyfish_sorted_map_s_s *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_END_OF_SEQUENCE);
...
static void check_as_sorted_map_next_error_on_end_of_sequence(void **state) {
    const struct butterflyfish_sorted_map_s_s sorted_map_s_s = {
            .ordered_map_s_s.map_s_s.collection_s_s.stream_s_s.next
            = np_emit_error
    };
    struct object {
        const struct butterflyfish_sorted_map_s_s *sorted_map_s_s;
...
static void check_prev_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_prev(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_OBJECT_IS_NULL);
}

static void check_prev_error_on_entry_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_prev((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_ENTRY_IS_NULL);
}

static void check_prev_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_prev((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_OUT_IS_NULL);
}
...
static void check_prev_error_on_end_of_sequence(void **state) {
    ...
    will_return(np_emit_error,
                BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_END_OF_SEQUENCE);
    assert_int_equal(
            butterflyfish_sorted_map_s_s_prev(
                    (const struct butterflyfish_sorted_map_s_s *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_END_OF_SEQUENCE);
...
static void check_as_sorted_map_prev_error_on_end_of_sequence(void **state) {
    const struct butterflyfish_sorted_map_s_s sorted_map_s_s = {
            .ordered_map_s_s.map_s_s.collection_s_s.prev = np_emit_error
    };
    struct object {
        const struct butterflyfish_sorted_map_s_s *sorted_map_s_s;
    };
...
static void check_remove_entry_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_remove_entry(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_OBJECT_IS_NULL);
}

static void check_remove_entry_error_on_entry_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_remove_entry((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_ENTRY_IS_NULL);
}
...
static void check_remove_entry(void **state) {
    const struct butterflyfish_sorted_map_s_s sorted_map_s_s = {
            .ordered_map_s_s.map_s_s.remove_entry = remove_entry
    };
    struct object {
        const struct butterflyfish_sorted_map_s_s *sorted_map_s_s;
    };
    ...
    assert_int_equal(
            butterflyfish_sorted_map_s_s_remove_entry(
                    (struct butterflyfish_sorted_map_s_s *) &instance,
                    (void *) 1),
            0);
}
...
static void check_remove_all_entries_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_remove_all_entries(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_OBJECT_IS_NULL);
}

static void check_remove_all_entries_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_remove_all_entries((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_OTHER_IS_NULL);
}
...
static void check_remove_all_entries(void **state) {
    const struct butterflyfish_sorted_map_s_s sorted_map_s_s = {
            .ordered_map_s_s.map_s_s.remove_all_entries = remove_all_entries
    };
    struct object {
        const struct butterflyfish_sorted_map_s_s *sorted_map_s_s;
    };
    ...
    assert_int_equal(
            butterflyfish_sorted_map_s_s_remove_all_entries(
                    (struct butterflyfish_sorted_map_s_s *) &instance,
                    (void *) 1),
            0);
}
...
static void check_add_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_add(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_OBJECT_IS_NULL);
}

static void check_add_error_on_key_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_add((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_KEY_IS_NULL);
}

static void check_add_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_add((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_VALUE_IS_NULL);
}
...
static void check_add_error_on_key_already_exists(void **state) {
    const struct butterflyfish_sorted_map_s_s sorted_map_s_s = {
            .ordered_map_s_s.map_s_s.add = apr_emit_error
    };
    struct object {
        const struct butterflyfish_sorted_map_s_s *sorted_map_s_s;
    };
    ...
    will_return(apr_emit_error,
                BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_KEY_ALREADY_EXISTS);
    assert_int_equal(
            butterflyfish_sorted_map_s_s_add(
                    (struct butterflyfish_sorted_map_s_s *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_KEY_ALREADY_EXISTS);
...
static void check_add_error_on_memory_allocation_failed(void **state) {
    ...
    expect_function_call(apr_emit_error);
    will_return(apr_emit_error,
                BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_MEMORY_ALLOCATION_FAILED);
    assert_int_equal(
            butterflyfish_sorted_map_s_s_add(
                    (struct butterflyfish_sorted_map_s_s *) &instance,
                    (void *) 1,
...
static void check_put_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_put(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_OBJECT_IS_NULL);
}

static void check_put_error_on_key_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_put((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_KEY_IS_NULL);
}

static void check_put_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_put((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_VALUE_IS_NULL);
}

static void check_put_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_sorted_map_s_s sorted_map_s_s = {
            .ordered_map_s_s.map_s_s.put = apr_emit_error
    };
    struct object {
        const struct butterflyfish_sorted_map_s_s *sorted_map_s_s;
    };
    ...
    will_return(apr_emit_error,
                BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_MEMORY_ALLOCATION_FAILED);
    assert_int_equal(
            butterflyfish_sorted_map_s_s_put(
                    (struct butterflyfish_sorted_map_s_s *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_MEMORY_ALLOCATION_FAILED);
...
static void check_replace_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_replace(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_OBJECT_IS_NULL);
}

static void check_replace_error_on_key_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_replace((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_KEY_IS_NULL);
}

static void check_replace_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_replace((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_VALUE_IS_NULL);
}

static void check_replace_error_on_key_not_found(void **state) {
    const struct butterflyfish_sorted_map_s_s sorted_map_s_s = {
            .ordered_map_s_s.map_s_s.replace = apr_emit_error
    };
    struct object {
        const struct butterflyfish_sorted_map_s_s *sorted_map_s_s;
    };
    ...
    assert_int_equal(
            butterflyfish_sorted_map_s_s_replace(
                    (struct butterflyfish_sorted_map_s_s *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_KEY_NOT_FOUND);
...
static void check_remove_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_remove(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_OBJECT_IS_NULL);
}

static void check_remove_error_on_key_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_remove((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_KEY_IS_NULL);
}
...
static void check_remove_error_on_key_not_found(void **state) {
    const struct butterflyfish_sorted_map_s_s sorted_map_s_s = {
            .ordered_map_s_s.map_s_s.remove = remove_emit_error
    };
    struct object {
        const struct butterflyfish_sorted_map_s_s *sorted_map_s_s;
    };
    ...
    will_return(remove_emit_error,
                BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_KEY_NOT_FOUND);
    assert_int_equal(
            butterflyfish_sorted_map_s_s_remove(
                    (struct butterflyfish_sorted_map_s_s *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_KEY_NOT_FOUND);
}
...
static void check_add_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_add_all(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_OBJECT_IS_NULL);
}

static void check_add_all_error_on_key_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_add_all((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_OTHER_IS_NULL);
}
...
static void check_add_all_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_sorted_map_s_s sorted_map_s_s = {
            .ordered_map_s_s.map_s_s.add_all = all_emit_error
    };
    struct object {
        const struct butterflyfish_sorted_map_s_s *sorted_map_s_s;
    };
    ...
    will_return(all_emit_error,
                BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_MEMORY_ALLOCATION_FAILED);
    assert_int_equal(
            butterflyfish_sorted_map_s_s_add_all(
                    (struct butterflyfish_sorted_map_s_s *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_MEMORY_ALLOCATION_FAILED);
}
...
static void check_put_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_put_all(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_OBJECT_IS_NULL);
}

static void check_put_all_error_on_key_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_put_all((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_OTHER_IS_NULL);
}

static void check_put_all_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_sorted_map_s_s sorted_map_s_s = {
            .ordered_map_s_s.map_s_s.put_all = all_emit_error
    };
    struct object {
        const struct butterflyfish_sorted_map_s_s *sorted_map_s_s;
    };
    ...
    will_return(all_emit_error,
                BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_MEMORY_ALLOCATION_FAILED);
    assert_int_equal(
            butterflyfish_sorted_map_s_s_put_all(
                    (struct butterflyfish_sorted_map_s_s *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_MEMORY_ALLOCATION_FAILED);
}
...
static void check_replace_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_replace_all(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_OBJECT_IS_NULL);
}

static void check_replace_all_error_on_key_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_replace_all((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_OTHER_IS_NULL);
}

static void check_replace_all_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_sorted_map_s_s sorted_map_s_s = {
            .ordered_map_s_s.map_s_s.replace_all = all_emit_error
    };
    struct object {
        const struct butterflyfish_sorted_map_s_s *sorted_map_s_s;
    };
    ...
    will_return(all_emit_error,
                BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_MEMORY_ALLOCATION_FAILED);
    assert_int_equal(
            butterflyfish_sorted_map_s_s_replace_all(
                    (struct butterflyfish_sorted_map_s_s *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_MEMORY_ALLOCATION_FAILED);
}
...
static void check_remove_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_remove_all(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_OBJECT_IS_NULL);
}

static void check_remove_all_error_on_key_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_remove_all((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_OTHER_IS_NULL);
}
...
static void check_remove_all_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_sorted_map_s_s sorted_map_s_s = {
            .ordered_map_s_s.map_s_s.remove_all = rr_all_emit_error
    };
    struct object {
        const struct butterflyfish_sorted_map_s_s *sorted_map_s_s;
    };
    ...
    will_return(rr_all_emit_error,
                BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_MEMORY_ALLOCATION_FAILED);
    assert_int_equal(
            butterflyfish_sorted_map_s_s_remove_all(
                    (struct butterflyfish_sorted_map_s_s *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_MEMORY_ALLOCATION_FAILED);
}
...
static void check_retain_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_retain_all(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_OBJECT_IS_NULL);
}

static void check_retain_all_error_on_key_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_retain_all((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_OTHER_IS_NULL);
}

static void check_retain_all_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_sorted_map_s_s sorted_map_s_s = {
            .ordered_map_s_s.map_s_s.retain_all = rr_all_emit_error
    };
    struct object {
        const struct butterflyfish_sorted_map_s_s *sorted_map_s_s;
    };
    ...
    will_return(rr_all_emit_error,
                BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_MEMORY_ALLOCATION_FAILED);
    assert_int_equal(
            butterflyfish_sorted_map_s_s_retain_all(
                    (struct butterflyfish_sorted_map_s_s *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_MEMORY_ALLOCATION_FAILED);
}
...
static void check_merge_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_merge(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_OBJECT_IS_NULL);
}

static void check_merge_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_merge((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_OTHER_IS_NULL);
}

static void check_merge_error_on_function_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_merge((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_FUNCTION_IS_NULL);
}
...
static void check_merge_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_sorted_map_s_s sorted_map_s_s = {
            .ordered_map_s_s.map_s_s.merge = merge_emit_error
    };
    struct object {
        const struct butterflyfish_sorted_map_s_s *sorted_map_s_s;
    };
    ...
    will_return(merge_emit_error,
                BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_MEMORY_ALLOCATION_FAILED);
    assert_int_equal(
            butterflyfish_sorted_map_s_s_merge(
                    (struct butterflyfish_sorted_map_s_s *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_MEMORY_ALLOCATION_FAILED);
...
static void check_contains_key_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_contains_key(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_OBJECT_IS_NULL);
}

static void check_contains_key_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_contains_key((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_KEY_IS_NULL);
}

static void check_contains_key_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_contains_key((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_OUT_IS_NULL);
}
...
check_contains_key_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_sorted_map_s_s sorted_map_s_s = {
            .ordered_map_s_s.map_s_s.contains_key = contains_key_emit_error
    };
    struct object {
        const struct butterflyfish_sorted_map_s_s *sorted_map_s_s;
    };
    ...
    will_return(contains_key_emit_error,
                BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_MEMORY_ALLOCATION_FAILED);
    assert_int_equal(
            butterflyfish_sorted_map_s_s_contains_key(
                    (struct butterflyfish_sorted_map_s_s *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_MEMORY_ALLOCATION_FAILED);
...
static void check_contains_all_keys_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_contains_all_keys(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_OBJECT_IS_NULL);
}
...
check_contains_all_keys_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_sorted_map_s_s sorted_map_s_s = {
            .ordered_map_s_s.map_s_s.contains_all_keys
...
static void check_get_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_get(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_OBJECT_IS_NULL);
}

static void check_get_error_on_key_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_get((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_KEY_IS_NULL);
}

static void check_get_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_get((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_OUT_IS_NULL);
}
...
static void check_get_error_on_key_not_found(void **state) {
    const struct butterflyfish_sorted_map_s_s sorted_map_s_s = {
            .ordered_map_s_s.map_s_s.get = get_emit_error
    };
    struct object {
        const struct butterflyfish_sorted_map_s_s *sorted_map_s_s;
    };
    ...
    will_return(get_emit_error,
                BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_KEY_NOT_FOUND);
    assert_int_equal(
            butterflyfish_sorted_map_s_s_get(
                    (struct butterflyfish_sorted_map_s_s *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_KEY_NOT_FOUND);
...
static void check_get_entry_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_get_entry(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_OBJECT_IS_NULL);
}

static void check_get_entry_error_on_key_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_get_entry((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_KEY_IS_NULL);
}

static void check_get_entry_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_get_entry((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_OUT_IS_NULL);
}
...
static void check_get_entry_error_on_key_not_found(void **state) {
    const struct butterflyfish_sorted_map_s_s sorted_map_s_s = {
            .ordered_map_s_s.map_s_s.get_entry = get_entry_emit_error
    };
    struct object {
        const struct butterflyfish_sorted_map_s_s *sorted_map_s_s;
    };
    ...
    will_return(get_entry_emit_error,
                BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_KEY_NOT_FOUND);
    assert_int_equal(
            butterflyfish_sorted_map_s_s_get_entry(
                    (struct butterflyfish_sorted_map_s_s *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_KEY_NOT_FOUND);
...
static void check_keys_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_keys(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_OBJECT_IS_NULL);
}

static void check_keys_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_keys((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_OUT_IS_NULL);
}
...
static void check_keys(void **state) {
    ...
    assert_int_equal(
            butterflyfish_sorted_map_s_s_keys(
                    (struct butterflyfish_sorted_map_s_s *) &instance,
                    (void *) 1),
            0);
}
...
static void check_values_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_values(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_OBJECT_IS_NULL);
}

static void check_values_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_values((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_OUT_IS_NULL);
}
...
static void check_values(void **state) {
    const struct butterflyfish_sorted_map_s_s sorted_map_s_s = {
            .ordered_map_s_s.map_s_s.values = values
    };
    struct object {
        const struct butterflyfish_sorted_map_s_s *sorted_map_s_s;
    };
    ...
    assert_int_equal(
            butterflyfish_sorted_map_s_s_values(
                    (struct butterflyfish_sorted_map_s_s *) &instance,
                    (void *) 1),
            0);
}
...
static void check_ceiling_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_ceiling(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_OBJECT_IS_NULL);
}

static void check_ceiling_error_on_key_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_ceiling((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_KEY_IS_NULL);
}

static void check_ceiling_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_ceiling((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_OUT_IS_NULL);
}
...
static void check_ceiling_error_on_key_not_found(void **state) {
    ...
    will_return(get_emit_error,
                BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_KEY_NOT_FOUND);
    assert_int_equal(
            butterflyfish_sorted_map_s_s_ceiling(
                    (struct butterflyfish_sorted_map_s_s *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_KEY_NOT_FOUND);
...
static void check_floor_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_floor(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_OBJECT_IS_NULL);
}

static void check_floor_error_on_key_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_floor((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_KEY_IS_NULL);
}

static void check_floor_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_floor((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_OUT_IS_NULL);
}
...
static void check_floor_error_on_key_not_found(void **state) {
    ...
    will_return(get_emit_error,
                BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_KEY_NOT_FOUND);
    assert_int_equal(
            butterflyfish_sorted_map_s_s_floor(
                    (struct butterflyfish_sorted_map_s_s *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_KEY_NOT_FOUND);
...
static void check_higher_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_higher(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_OBJECT_IS_NULL);
}

static void check_higher_error_on_key_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_higher((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_KEY_IS_NULL);
}

static void check_higher_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_higher((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_OUT_IS_NULL);
}
...
static void check_higher_error_on_key_not_found(void **state) {
    ...
    will_return(get_emit_error,
                BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_KEY_NOT_FOUND);
    assert_int_equal(
            butterflyfish_sorted_map_s_s_higher(
                    (struct butterflyfish_sorted_map_s_s *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_KEY_NOT_FOUND);
...
static void check_lower_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_lower(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_OBJECT_IS_NULL);
}

static void check_lower_error_on_key_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_lower((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_KEY_IS_NULL);
}

static void check_lower_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_lower((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_OUT_IS_NULL);
}
...
static void check_lower_error_on_key_not_found(void **state) {
    ...
    will_return(get_emit_error,
                BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_KEY_NOT_FOUND);
    assert_int_equal(
            butterflyfish_sorted_map_s_s_lower(
                    (struct butterflyfish_sorted_map_s_s *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_KEY_NOT_FOUND);
...
static void check_ceiling_entry_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_ceiling_entry(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_OBJECT_IS_NULL);
}
...
static void check_floor_entry_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_floor_entry(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_OBJECT_IS_NULL);
}
...
static void check_higher_entry_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_higher_entry(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_OBJECT_IS_NULL);
}
...
static void check_lower_entry_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_s_s_lower_entry(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_S_S_ERROR_OBJECT_IS_NULL);
}
