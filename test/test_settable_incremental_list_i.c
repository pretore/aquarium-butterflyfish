...
struct instance {
    const struct butterflyfish_settable_incremental_list_i *const id;
    void *data;
};

const struct butterflyfish_settable_incremental_list_i settable_incremental_list_i;
...
static int stream_first(const void *const object,
    ...
    seagrass_required_true(&settable_incremental_list_i == instance->id);
    return mock();
}
...
static void check_as_stream(void **state) {
    assert_ptr_equal(settable_incremental_list_i.as_stream, &stream_i);
}

static void check_as_collection(void **state) {
    assert_ptr_equal(settable_incremental_list_i.as_collection, &collection_i);
}

static void check_as_settable(void **state) {
    assert_ptr_equal(settable_incremental_list_i.as_settable, &settable_i);
}

static void check_as_list(void **state) {
    assert_ptr_equal(settable_incremental_list_i.as_list, &list_i);
}

static void check_as_addable(void **state) {
    assert_ptr_equal(settable_incremental_list_i.as_addable, &addable_i);
}

static void check_as_settable_list(void **state) {
    assert_ptr_equal(settable_incremental_list_i.as_settable_list,
                     &settable_list_i);
}

static void check_as_incremental_list(void **state) {
    assert_ptr_equal(settable_incremental_list_i.as_incremental_list,
                     &incremental_list_i);
}

static void check_count_error_on_object_is_null(void **state) {
    assert_int_equal(settable_incremental_list_i.count(NULL, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_ERROR_OBJECT_IS_NULL);
}

static void check_count_error_on_out_is_null(void **state) {
    assert_int_equal(settable_incremental_list_i.count((void *) 1, NULL),
...
static void check_count(void **state) {
    ...
    struct instance instance = {
            .id = &settable_incremental_list_i
    };
...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(settable_incremental_list_i.first(NULL, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_ERROR_OBJECT_IS_NULL);
}

static void check_first_error_on_out_is_null(void **state) {
    assert_int_equal(settable_incremental_list_i.first((void *) 1, NULL),
                     BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_ERROR_OUT_IS_NULL);
}
...
static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(settable_incremental_list_i.last(NULL, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_ERROR_OBJECT_IS_NULL);
}

static void check_last_error_on_out_is_null(void **state) {
    assert_int_equal(settable_incremental_list_i.last((void *) 1, NULL),
                     BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_ERROR_OUT_IS_NULL);
}
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(settable_incremental_list_i.next(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_ERROR_OBJECT_IS_NULL);
}

static void check_next_error_on_item_is_null(void **state) {
    assert_int_equal(settable_incremental_list_i.next((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_ERROR_ITEM_IS_NULL);
}

static void check_next_error_on_out_is_null(void **state) {
    assert_int_equal(settable_incremental_list_i.next((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_ERROR_OUT_IS_NULL);
}
...
static void check_prev_error_on_object_is_null(void **state) {
    assert_int_equal(settable_incremental_list_i.prev(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_ERROR_OBJECT_IS_NULL);
}

static void check_prev_error_on_item_is_null(void **state) {
    assert_int_equal(settable_incremental_list_i.prev((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_ERROR_ITEM_IS_NULL);
}

static void check_prev_error_on_out_is_null(void **state) {
    assert_int_equal(settable_incremental_list_i.prev((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_ERROR_OUT_IS_NULL);
}
...
static void check_get_error_on_object_is_null(void **state) {
    assert_int_equal(settable_incremental_list_i.get(NULL, 0, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_ERROR_OBJECT_IS_NULL);
}

static void check_get_error_on_out_is_null(void **state) {
    assert_int_equal(settable_incremental_list_i.get((void *) 1, 0, NULL),
                     BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_ERROR_OUT_IS_NULL);
}
...
static void check_at_error_on_object_is_null(void **state) {
    assert_int_equal(settable_incremental_list_i.at(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_ERROR_OBJECT_IS_NULL);
}

static void check_at_error_on_item_is_null(void **state) {
    assert_int_equal(settable_incremental_list_i.at((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_ERROR_ITEM_IS_NULL);
}

static void check_at_error_on_out_is_null(void **state) {
    assert_int_equal(settable_incremental_list_i.at((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_ERROR_OUT_IS_NULL);
}
...
static void check_set_error_on_object_is_null(void **state) {
    assert_int_equal(settable_incremental_list_i.set(NULL, 0, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_ERROR_OBJECT_IS_NULL);
}

static void check_set_error_on_value_is_null(void **state) {
    assert_int_equal(settable_incremental_list_i.set((void *) 1, 0, NULL),
...
static void check_set_item_error_on_object_is_null(void **state) {
    assert_int_equal(settable_incremental_list_i.set_item(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_ERROR_OBJECT_IS_NULL);
}

static void check_set_item_error_on_item_is_null(void **state) {
    assert_int_equal(settable_incremental_list_i.set_item((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_ERROR_ITEM_IS_NULL);
}

static void check_set_item_error_on_value_is_null(void **state) {
    assert_int_equal(settable_incremental_list_i.set_item((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_ERROR_VALUE_IS_NULL);
}
...
static void check_add_error_on_object_is_null(void **state) {
    assert_int_equal(settable_incremental_list_i.add(NULL, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_ERROR_OBJECT_IS_NULL);
}

static void check_add_error_on_value_is_null(void **state) {
    assert_int_equal(settable_incremental_list_i.add((void *) 1, NULL),
                     BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_ERROR_VALUE_IS_NULL);
}
