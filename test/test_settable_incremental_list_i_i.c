...
static void check_as_stream_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_incremental_list_i_i_as_stream(
                    NULL, (void *) 1),
...
static void check_as_stream(void **state) {
    ...
    assert_int_equal(butterflyfish_settable_incremental_list_i_i_as_stream(
...
static void check_as_collection_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_incremental_list_i_i_as_collection(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_collection(void **state) {
    ...
    assert_int_equal(butterflyfish_settable_incremental_list_i_i_as_collection(
            (const struct butterflyfish_settable_incremental_list_i_i *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}

static void check_as_settable_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_incremental_list_i_i_as_settable(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_settable(void **state) {
    ...
    assert_int_equal(butterflyfish_settable_incremental_list_i_i_as_settable(
            (struct butterflyfish_settable_incremental_list_i_i *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}

static void check_as_list_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_incremental_list_i_i_as_list(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_list(void **state) {
    ...
    assert_int_equal(butterflyfish_settable_incremental_list_i_i_as_list(
            (const struct butterflyfish_settable_incremental_list_i_i *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_addable_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_incremental_list_i_i_as_addable(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_addable(void **state) {
    ...
    assert_int_equal(butterflyfish_settable_incremental_list_i_i_as_addable(
            (struct butterflyfish_settable_incremental_list_i_i *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_settable_list_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_incremental_list_i_i_as_settable_list(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_settable_list(void **state) {
    ...
    assert_int_equal(butterflyfish_settable_incremental_list_i_i_as_settable_list(
            (struct butterflyfish_settable_incremental_list_i_i *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_incremental_list_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_incremental_list_i_i_as_incremental_list(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_incremental_list(void **state) {
    ...
    assert_int_equal(butterflyfish_settable_incremental_list_i_i_as_incremental_list(
            (struct butterflyfish_settable_incremental_list_i_i *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_list_as_collection(void **state) {
    ...
    assert_int_equal(butterflyfish_settable_incremental_list_i_i_as_list(
            (const struct butterflyfish_settable_incremental_list_i_i *) &instance, &as), 0);
    const struct butterflyfish_collection_i_i *out;
...
static void check_addable_as_collection(void **state) {
    ...
    assert_int_equal(butterflyfish_settable_incremental_list_i_i_as_addable(
            (struct butterflyfish_settable_incremental_list_i_i *) &instance, &as), 0);
    const struct butterflyfish_collection_i_i *out;
...
static void check_count_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_incremental_list_i_i_count(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_count(void **state) {
    ...
    uintmax_t out;
    assert_int_equal(butterflyfish_settable_incremental_list_i_i_count(
            (const struct butterflyfish_settable_incremental_list_i_i *)
                    &instance, &out), 0);
...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_incremental_list_i_i_first(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_incremental_list_i_i_last(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_incremental_list_i_i_next(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_prev_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_incremental_list_i_i_prev(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_get_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_incremental_list_i_i_get(
                    NULL, 0, (void *) 1),
            BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_at_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_incremental_list_i_i_at(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_incremental_list_i_i_set(
                    NULL, 0, (void *) 1),
            BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_set_error_on_index_out_of_bounds(void **state) {
    ...
    assert_int_equal(
            butterflyfish_settable_incremental_list_i_i_set(
                    (struct butterflyfish_settable_incremental_list_i_i *)
                            &instance, 0, (void *) 1),
            BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_INDEX_IS_OUT_OF_BOUNDS);
}
...
static void check_set_item_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_incremental_list_i_i_set_item(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_add_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_incremental_list_i_i_add(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_add_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_incremental_list_i_i_add_all(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
