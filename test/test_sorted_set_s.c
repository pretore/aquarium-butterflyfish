...
static void check_as_stream_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_s_as_stream(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_OBJECT_IS_NULL);
}

static void check_as_stream_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_s_as_stream((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_OUT_IS_NULL);
}

static void check_as_stream(void **state) {
    struct butterflyfish_sorted_set_s sorted_set = {};
    const struct butterflyfish_stream_s *stream;
    assert_int_equal(butterflyfish_sorted_set_s_as_stream(
            &sorted_set, &stream), 0);
...
static void check_as_collection_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_s_as_collection(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_OBJECT_IS_NULL);
}

static void check_as_collection_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_s_as_collection((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_OUT_IS_NULL);
}
...
static void check_as_collection(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_set_s_as_collection(
...
static void check_as_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_s_as_set(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_OBJECT_IS_NULL);
}

static void check_as_set_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_s_as_set((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_OUT_IS_NULL);
}
...
static void check_as_set(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_set_s_as_set(&sorted_set, &set), 0);
    assert_ptr_equal(&sorted_set, set);
}

static void check_as_ordered_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_s_as_ordered_set(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_OBJECT_IS_NULL);
}

static void check_as_ordered_set_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_s_as_ordered_set((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_OUT_IS_NULL);
}
...
static void check_as_ordered_set(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_set_s_as_ordered_set(
...
static void check_count_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_s_count(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_OBJECT_IS_NULL);
}

static void check_count_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_s_count((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_OUT_IS_NULL);
}
...
static void check_count(void **state) {
    srand(time(NULL));
    const struct butterflyfish_sorted_set_s sorted_set_s = {
            .ordered_set_s.set_s.collection_s.count = count
    };
    struct object {
        const struct butterflyfish_sorted_set_s *sorted_set_s;
    };
    struct object instance = {
            .sorted_set_s = &sorted_set_s
    };
    ...
    uintmax_t out;
    assert_int_equal(
            butterflyfish_sorted_set_s_count(
                    (const struct butterflyfish_sorted_set_s *) &instance,
                    &out),
            0);
...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_s_first(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_OBJECT_IS_NULL);
}

static void check_first_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_s_first((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_OUT_IS_NULL);
}
...
static void check_first_error_on_set_is_empty(void **state) {
    ...
    will_return(fl_emit_error,
                BUTTERFLYFISH_SORTED_SET_S_ERROR_SET_IS_EMPTY);
    assert_int_equal(
            butterflyfish_sorted_set_s_first(
                    (const struct butterflyfish_sorted_set_s *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_SET_IS_EMPTY);
}
...
static void check_as_sorted_set_first_error_on_set_is_empty(void **state) {
    const struct butterflyfish_sorted_set_s sorted_set_s = {
            .ordered_set_s.set_s.collection_s.stream_s.first = fl_emit_error
    };
    struct object {
        const struct butterflyfish_sorted_set_s *sorted_set_s;
    };
...
static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_s_last(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_OBJECT_IS_NULL);
}

static void check_last_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_s_last((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_OUT_IS_NULL);
}
...
static void check_last_error_on_set_is_empty(void **state) {
    ...
    will_return(fl_emit_error,
                BUTTERFLYFISH_SORTED_SET_S_ERROR_SET_IS_EMPTY);
    assert_int_equal(
            butterflyfish_sorted_set_s_last(
                    (const struct butterflyfish_sorted_set_s *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_SET_IS_EMPTY);
}
...
static void check_as_sorted_set_last_error_on_set_is_empty(void **state) {
    const struct butterflyfish_sorted_set_s sorted_set_s = {
            .ordered_set_s.set_s.collection_s.last = fl_emit_error
    };
    struct object {
        const struct butterflyfish_sorted_set_s *sorted_set_s;
    };
...
static void check_remove_item_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_s_remove_item(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_OBJECT_IS_NULL);
}

static void check_remove_item_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_s_remove_item((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_ITEM_IS_NULL);
}
...
static void check_remove_item(void **state) {
    const struct butterflyfish_sorted_set_s sorted_set_s = {
            .ordered_set_s.set_s.remove_item = remove_item
    };
    struct object {
        const struct butterflyfish_sorted_set_s *sorted_set_s;
    };
    ...
    assert_int_equal(
            butterflyfish_sorted_set_s_remove_item(
                    (struct butterflyfish_sorted_set_s *) &instance,
                    (void *) 1),
            0);
}
...
static void check_remove_all_items_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_s_remove_all_items(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_OBJECT_IS_NULL);
}

static void check_remove_all_items_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_s_remove_all_items((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_OTHER_IS_NULL);
}
...
static void check_remove_all_items(void **state) {
    const struct butterflyfish_sorted_set_s sorted_set_s = {
            .ordered_set_s.set_s.remove_all_items = remove_all_items
    };
    struct object {
        const struct butterflyfish_sorted_set_s *sorted_set_s;
    };
    ...
    assert_int_equal(
            butterflyfish_sorted_set_s_remove_all_items(
                    (struct butterflyfish_sorted_set_s *) &instance,
                    (void *) 1),
            0);
}
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_s_next(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_OBJECT_IS_NULL);
}

static void check_next_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_s_next((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_ITEM_IS_NULL);
}

static void check_next_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_s_next((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_OUT_IS_NULL);
}
...
static void check_next_error_on_end_of_sequence(void **state) {
    ...
    will_return(np_emit_error,
                BUTTERFLYFISH_SORTED_SET_S_ERROR_END_OF_SEQUENCE);
    assert_int_equal(
            butterflyfish_sorted_set_s_next(
                    (const struct butterflyfish_sorted_set_s *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_END_OF_SEQUENCE);
...
static void check_as_sorted_set_next_error_on_end_of_sequence(void **state) {
    const struct butterflyfish_sorted_set_s sorted_set_s = {
            .ordered_set_s.set_s.collection_s.stream_s.next = np_emit_error
    };
    struct object {
        const struct butterflyfish_sorted_set_s *sorted_set_s;
    };
...
static void check_prev_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_s_prev(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_OBJECT_IS_NULL);
}

static void check_prev_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_s_prev((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_ITEM_IS_NULL);
}

static void check_prev_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_s_prev((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_OUT_IS_NULL);
}
...
static void check_prev_error_on_end_of_sequence(void **state) {
    ...
    will_return(np_emit_error,
                BUTTERFLYFISH_SORTED_SET_S_ERROR_END_OF_SEQUENCE);
    assert_int_equal(
            butterflyfish_sorted_set_s_prev(
                    (const struct butterflyfish_sorted_set_s *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_END_OF_SEQUENCE);
...
static void check_as_sorted_set_prev_error_on_end_of_sequence(void **state) {
    const struct butterflyfish_sorted_set_s sorted_set_s = {
            .ordered_set_s.set_s.collection_s.prev = np_emit_error
    };
    struct object {
        const struct butterflyfish_sorted_set_s *sorted_set_s;
    };
...
static void check_add_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_s_add(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_OBJECT_IS_NULL);
}

static void check_add_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_s_add((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_VALUE_IS_NULL);
}
...
static void check_add_error_on_value_already_exits(void **state) {
    const struct butterflyfish_sorted_set_s sorted_set_s = {
            .ordered_set_s.set_s.add = ar_emit_error
    };
    struct object {
        const struct butterflyfish_sorted_set_s *sorted_set_s;
    };
    ...
    will_return(ar_emit_error,
                BUTTERFLYFISH_SORTED_SET_S_ERROR_VALUE_ALREADY_EXISTS);
    assert_int_equal(
            butterflyfish_sorted_set_s_add(
                    (struct butterflyfish_sorted_set_s *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_VALUE_ALREADY_EXISTS);
}
...
static void check_add_error_on_memory_allocation_failed(void **state) {
    ...
    expect_function_call(ar_emit_error);
    will_return(ar_emit_error,
                BUTTERFLYFISH_SORTED_SET_S_ERROR_MEMORY_ALLOCATION_FAILED);
    assert_int_equal(
            butterflyfish_sorted_set_s_add(
                    (struct butterflyfish_sorted_set_s *) &instance,
                    (void *) 1),
...
static void check_add_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_s_add_all(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_OBJECT_IS_NULL);
}

static void check_add_all_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_s_add_all((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_OTHER_IS_NULL);
}
...
static void check_add_all_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_sorted_set_s sorted_set_s = {
            .ordered_set_s.set_s.add_all = ar_all_emit_error
    };
    struct object {
        const struct butterflyfish_sorted_set_s *sorted_set_s;
    };
    ...
    will_return(ar_all_emit_error,
                BUTTERFLYFISH_SORTED_SET_S_ERROR_MEMORY_ALLOCATION_FAILED);
    assert_int_equal(
            butterflyfish_sorted_set_s_add_all(
                    (struct butterflyfish_sorted_set_s *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_MEMORY_ALLOCATION_FAILED);
}
...
static void check_remove_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_s_remove(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_OBJECT_IS_NULL);
}

static void check_remove_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_s_remove((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_VALUE_IS_NULL);
}

static void check_remove_error_on_value_not_found(void **state) {
    const struct butterflyfish_sorted_set_s sorted_set_s = {
            .ordered_set_s.set_s.remove = ar_emit_error
    };
    struct object {
        const struct butterflyfish_sorted_set_s *sorted_set_s;
    };
    ...
    expect_function_call(ar_emit_error);
    will_return(ar_emit_error,
                BUTTERFLYFISH_SORTED_SET_S_ERROR_VALUE_NOT_FOUND);
    assert_int_equal(
            butterflyfish_sorted_set_s_remove(
                    (struct butterflyfish_sorted_set_s *) &instance,
                    (void *) 1),
...
static void check_remove_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_s_remove_all(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_OBJECT_IS_NULL);
}

static void check_remove_all_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_s_remove_all((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_OTHER_IS_NULL);
}

static void check_remove_all_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_sorted_set_s sorted_set_s = {
            .ordered_set_s.set_s.remove_all = ar_all_emit_error
    };
    struct object {
        const struct butterflyfish_sorted_set_s *sorted_set_s;
    };
    ...
    will_return(ar_all_emit_error,
                BUTTERFLYFISH_SORTED_SET_S_ERROR_MEMORY_ALLOCATION_FAILED);
    assert_int_equal(
            butterflyfish_sorted_set_s_remove_all(
                    (struct butterflyfish_sorted_set_s *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_MEMORY_ALLOCATION_FAILED);
}
...
static void check_contains_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_s_contains(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_OBJECT_IS_NULL);
}

static void check_contains_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_s_contains((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_VALUE_IS_NULL);
}

static void check_contains_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_s_contains((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_OUT_IS_NULL);
}
...
static void check_contains_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_sorted_set_s sorted_set_s = {
            .ordered_set_s.set_s.contains = contains_emit_error
    };
    struct object {
        const struct butterflyfish_sorted_set_s *sorted_set_s;
    };
    ...
    will_return(contains_emit_error,
                BUTTERFLYFISH_SORTED_SET_S_ERROR_MEMORY_ALLOCATION_FAILED);
    assert_int_equal(
            butterflyfish_sorted_set_s_contains(
                    (struct butterflyfish_sorted_set_s *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_MEMORY_ALLOCATION_FAILED);
...
static void check_contains_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_s_contains_all(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_OBJECT_IS_NULL);
}
...
check_contains_all_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_sorted_set_s sorted_set_s = {
            .ordered_set_s.set_s.contains_all = contains_all_emit_error
    };
    struct object {
        const struct butterflyfish_sorted_set_s *sorted_set_s;
    };
...
static void check_retain_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_s_retain_all(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_OBJECT_IS_NULL);
}

static void check_retain_all_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_s_retain_all((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_OTHER_IS_NULL);
}
...
check_retain_all_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_sorted_set_s sorted_set_s = {
            .ordered_set_s.set_s.retain_all = retain_all_emit_error
    };
    struct object {
        const struct butterflyfish_sorted_set_s *sorted_set_s;
    };
    ...
    will_return(retain_all_emit_error,
                BUTTERFLYFISH_SORTED_SET_S_ERROR_MEMORY_ALLOCATION_FAILED);
    assert_int_equal(
            butterflyfish_sorted_set_s_retain_all(
                    (struct butterflyfish_sorted_set_s *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_MEMORY_ALLOCATION_FAILED);
}
...
static void check_get_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_s_get(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_OBJECT_IS_NULL);
}

static void check_get_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_s_get((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_VALUE_IS_NULL);
}

static void check_get_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_s_get((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_OUT_IS_NULL);
}
...
static void check_get_error_on_item_not_found(void **state) {
    const struct butterflyfish_sorted_set_s sorted_set_s = {
            .ordered_set_s.set_s.get = get_emit_error
    };
    struct object {
        const struct butterflyfish_sorted_set_s *sorted_set_s;
    };
    ...
    will_return(get_emit_error,
                BUTTERFLYFISH_SORTED_SET_S_ERROR_ITEM_NOT_FOUND);
    assert_int_equal(
            butterflyfish_sorted_set_s_get(
                    (struct butterflyfish_sorted_set_s *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_ITEM_NOT_FOUND);
...
static void check_ceiling_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_s_ceiling(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_OBJECT_IS_NULL);
}

static void check_ceiling_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_s_ceiling( (void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_VALUE_IS_NULL);
}

static void check_ceiling_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_s_ceiling( (void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_OUT_IS_NULL);
}
...
static void check_ceiling_error_on_item_not_found(void **state) {
    ...
    will_return(get_emit_error,
                BUTTERFLYFISH_SORTED_SET_S_ERROR_ITEM_NOT_FOUND);
    assert_int_equal(
            butterflyfish_sorted_set_s_ceiling(
                    (struct butterflyfish_sorted_set_s *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_ITEM_NOT_FOUND);
...
static void check_floor_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_s_floor(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_OBJECT_IS_NULL);
}

static void check_floor_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_s_floor( (void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_VALUE_IS_NULL);
}

static void check_floor_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_s_floor( (void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_OUT_IS_NULL);
}
...
static void check_floor_error_on_item_not_found(void **state) {
    ...
    will_return(get_emit_error,
                BUTTERFLYFISH_SORTED_SET_S_ERROR_ITEM_NOT_FOUND);
    assert_int_equal(
            butterflyfish_sorted_set_s_floor(
                    (struct butterflyfish_sorted_set_s *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_ITEM_NOT_FOUND);
...
static void check_higher_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_s_higher(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_OBJECT_IS_NULL);
}

static void check_higher_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_s_higher( (void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_VALUE_IS_NULL);
}

static void check_higher_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_s_higher( (void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_OUT_IS_NULL);
}
...
static void check_higher_error_on_item_not_found(void **state) {
    ...
    will_return(get_emit_error,
                BUTTERFLYFISH_SORTED_SET_S_ERROR_ITEM_NOT_FOUND);
    assert_int_equal(
            butterflyfish_sorted_set_s_higher(
                    (struct butterflyfish_sorted_set_s *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_ITEM_NOT_FOUND);
...
static void check_lower_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_s_lower(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_OBJECT_IS_NULL);
}

static void check_lower_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_s_lower( (void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_VALUE_IS_NULL);
}

static void check_lower_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_s_lower( (void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_OUT_IS_NULL);
}
...
static void check_lower_error_on_item_not_found(void **state) {
    ...
    will_return(get_emit_error,
                BUTTERFLYFISH_SORTED_SET_S_ERROR_ITEM_NOT_FOUND);
    assert_int_equal(
            butterflyfish_sorted_set_s_lower(
                    (struct butterflyfish_sorted_set_s *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_SET_S_ERROR_ITEM_NOT_FOUND);
