...
static void check_as_collection(void **state) {
    ...
    assert_int_equal(butterflyfish_queue_p_as_collection(
            &queue, &collection), 0);
...
static void check_as_reducible_queue_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_queue_p_as_reducible_queue(NULL, (void *) 1),
            BUTTERFLYFISH_QUEUE_P_ERROR_OBJECT_IS_NULL);
}

static void check_as_reducible_queue_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_queue_p_as_reducible_queue((void *) 1, NULL),
            BUTTERFLYFISH_QUEUE_P_ERROR_OUT_IS_NULL);
}
...
static void check_as_reducible_queue(void **state) {
    ...
    assert_int_equal(butterflyfish_queue_p_as_reducible_queue(
