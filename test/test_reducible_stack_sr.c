...
static void check_as_stream_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_stack_sr_as_stream(NULL, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_STACK_SR_ERROR_OBJECT_IS_NULL);
}

static void check_as_stream_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_stack_sr_as_stream((void *) 1, NULL),
...
static void check_as_stream(void **state) {
    ...
    assert_int_equal(butterflyfish_reducible_stack_sr_as_stream(
...
static void check_as_collection_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_stack_sr_as_collection(NULL, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_STACK_SR_ERROR_OBJECT_IS_NULL);
}

static void check_as_collection_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_stack_sr_as_collection((void *) 1, NULL),
            BUTTERFLYFISH_REDUCIBLE_STACK_SR_ERROR_OUT_IS_NULL);
}
...
static void check_as_collection(void **state) {
    ...
    assert_int_equal(butterflyfish_reducible_stack_sr_as_collection(
...
static void check_count_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_stack_sr_count(NULL, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_STACK_SR_ERROR_OBJECT_IS_NULL);
}

static void check_count_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_stack_sr_count((void *) 1, NULL),
            BUTTERFLYFISH_REDUCIBLE_STACK_SR_ERROR_OUT_IS_NULL);
}
...
static void check_count(void **state) {
    ...
    struct object instance = {
            .reducible_stack_sr = &reducible_stack_sr
    };
    ...
    uintmax_t out;
    assert_int_equal(
            butterflyfish_reducible_stack_sr_count(
...
static void check_first_error_on_stack_is_empty(void **state) {
    const struct butterflyfish_reducible_stack_sr stack_sr = {
...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_stack_sr_first(NULL, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_STACK_SR_ERROR_OBJECT_IS_NULL);
}

static void check_first_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_stack_sr_first((void *) 1, NULL),
            BUTTERFLYFISH_REDUCIBLE_STACK_SR_ERROR_OUT_IS_NULL);
}

static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_stack_sr_last(NULL, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_STACK_SR_ERROR_OBJECT_IS_NULL);
}

static void check_last_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_stack_sr_last((void *) 1, NULL),
            BUTTERFLYFISH_REDUCIBLE_STACK_SR_ERROR_OUT_IS_NULL);
}
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_stack_sr_next(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_STACK_SR_ERROR_OBJECT_IS_NULL);
}

static void check_next_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_stack_sr_next((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_STACK_SR_ERROR_ITEM_IS_NULL);
}

static void check_next_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_stack_sr_next((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_REDUCIBLE_STACK_SR_ERROR_OUT_IS_NULL);
}
...
static void check_prev_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_stack_sr_prev(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_STACK_SR_ERROR_OBJECT_IS_NULL);
}

static void check_prev_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_stack_sr_prev((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_STACK_SR_ERROR_ITEM_IS_NULL);
}

static void check_prev_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_stack_sr_prev((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_REDUCIBLE_STACK_SR_ERROR_OUT_IS_NULL);
}
...
static void check_pop_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_stack_sr_pop(NULL, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_STACK_SR_ERROR_OBJECT_IS_NULL);
}

static void check_pop_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_stack_sr_pop((void *) 1, NULL),
            BUTTERFLYFISH_REDUCIBLE_STACK_SR_ERROR_OUT_IS_NULL);
}
...
static void check_pop_error_on_stack_is_empty(void **state) {
    ...
    will_return(pop_emit_error,
                BUTTERFLYFISH_REDUCIBLE_STACK_SR_ERROR_STACK_IS_EMPTY);
    assert_int_equal(
            butterflyfish_reducible_stack_sr_pop(
                    (struct butterflyfish_reducible_stack_sr *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_STACK_SR_ERROR_STACK_IS_EMPTY);
}
