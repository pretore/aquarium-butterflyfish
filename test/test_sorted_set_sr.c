...
static void check_as_stream_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_sr_as_stream(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_OBJECT_IS_NULL);
}

static void check_as_stream_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_sr_as_stream((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_OUT_IS_NULL);
}

static void check_as_stream(void **state) {
    struct butterflyfish_sorted_set_sr sorted_set = {};
    const struct butterflyfish_stream_sr *stream;
    assert_int_equal(butterflyfish_sorted_set_sr_as_stream(
            &sorted_set, &stream), 0);
...
static void check_as_collection_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_sr_as_collection(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_OBJECT_IS_NULL);
}

static void check_as_collection_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_sr_as_collection((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_OUT_IS_NULL);
}
...
static void check_as_collection(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_set_sr_as_collection(
...
static void check_as_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_sr_as_set(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_OBJECT_IS_NULL);
}

static void check_as_set_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_sr_as_set((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_OUT_IS_NULL);
}

static void check_as_set(void **state) {
    struct butterflyfish_sorted_set_sr sorted_set = {};
    struct butterflyfish_set_sr *set;
    assert_int_equal(butterflyfish_sorted_set_sr_as_set(&sorted_set, &set), 0);
    assert_ptr_equal(&sorted_set, set);
}

static void check_as_ordered_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_sr_as_ordered_set(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_OBJECT_IS_NULL);
}

static void check_as_ordered_set_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_sr_as_ordered_set((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_OUT_IS_NULL);
}

static void check_as_ordered_set(void **state) {
    struct butterflyfish_sorted_set_sr sorted_set = {};
    struct butterflyfish_ordered_set_sr *ordered_set;
    assert_int_equal(butterflyfish_sorted_set_sr_as_ordered_set(
...
static void check_count_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_sr_count(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_OBJECT_IS_NULL);
}

static void check_count_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_sr_count((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_OUT_IS_NULL);
}
...
static void check_count(void **state) {
    srand(time(NULL));
    const struct butterflyfish_sorted_set_sr sorted_set_sr = {
            .ordered_set_sr.set_sr.collection_sr.count = count
    };
    struct object {
        const struct butterflyfish_sorted_set_sr *sorted_set_sr;
    };
    struct object instance = {
            .sorted_set_sr = &sorted_set_sr
    };
    ...
    uintmax_t out;
    assert_int_equal(
            butterflyfish_sorted_set_sr_count(
                    (const struct butterflyfish_sorted_set_sr *) &instance,
                    &out),
            0);
    assert_int_equal(out, check);
}

static void check_as_ordered_set_count(void **state) {
    srand(time(NULL));
    const struct butterflyfish_sorted_set_sr sorted_set_sr = {
            .ordered_set_sr.set_sr.collection_sr.count = count
    };
    ...
    uintmax_t out;
    assert_int_equal(
            butterflyfish_ordered_set_sr_count(
...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_sr_first(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_OBJECT_IS_NULL);
}

static void check_first_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_sr_first((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_OUT_IS_NULL);
}
...
static void check_first_error_on_set_is_empty(void **state) {
    ...
    will_return(fl_emit_error,
                BUTTERFLYFISH_SORTED_SET_SR_ERROR_SET_IS_EMPTY);
    assert_int_equal(
            butterflyfish_sorted_set_sr_first(
                    (const struct butterflyfish_sorted_set_sr *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_SET_IS_EMPTY);
}
...
static void check_as_sorted_set_first_error_on_set_is_empty(void **state) {
    const struct butterflyfish_sorted_set_sr sorted_set_sr = {
            .ordered_set_sr.set_sr.collection_sr.stream_sr.first = fl_emit_error
    };
    struct object {
        const struct butterflyfish_sorted_set_sr *sorted_set_sr;
    };
...
static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_sr_last(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_OBJECT_IS_NULL);
}

static void check_last_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_sr_last((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_OUT_IS_NULL);
}
...
static void check_last_error_on_set_is_empty(void **state) {
    ...
    will_return(fl_emit_error,
                BUTTERFLYFISH_SORTED_SET_SR_ERROR_SET_IS_EMPTY);
    assert_int_equal(
            butterflyfish_sorted_set_sr_last(
                    (const struct butterflyfish_sorted_set_sr *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_SET_IS_EMPTY);
}
...
static void check_as_sorted_set_last_error_on_set_is_empty(void **state) {
    const struct butterflyfish_sorted_set_sr sorted_set_sr = {
            .ordered_set_sr.set_sr.collection_sr.last = fl_emit_error
    };
    struct object {
        const struct butterflyfish_sorted_set_sr *sorted_set_sr;
    };
...
static void check_remove_item_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_sr_remove_item(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_OBJECT_IS_NULL);
}
...
static void check_remove_item(void **state) {
    const struct butterflyfish_sorted_set_sr sorted_set_sr = {
            .ordered_set_sr.set_sr.remove_item = remove_item
    };
    struct object {
        const struct butterflyfish_sorted_set_sr *sorted_set_sr;
    };
    ...
    assert_int_equal(
            butterflyfish_sorted_set_sr_remove_item(
                    (struct butterflyfish_sorted_set_sr *) &instance,
                    (void *) 1),
            0);
}

static void check_as_ordered_set_remove_item(void **state) {
    const struct butterflyfish_sorted_set_sr sorted_set_sr = {
            .ordered_set_sr.set_sr.remove_item = remove_item
    };
    struct object {
    ...
    expect_function_call(remove_item);
    assert_int_equal(
            butterflyfish_ordered_set_sr_remove_item(
...
static void check_as_set_remove_item(void **state) {
    ...
    expect_function_call(remove_item);
    assert_int_equal(
            butterflyfish_set_sr_remove_item(
...
static void check_remove_item_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_sr_remove_item((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_ITEM_IS_NULL);
}

static void check_remove_all_items_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_sr_remove_all_items(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_OBJECT_IS_NULL);
}

static void check_remove_all_items_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_sr_remove_all_items((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_OTHER_IS_NULL);
}

static int
remove_all_items(void *const object,
                 const struct butterflyfish_stream_sr *const items) {
    function_called();
    assert_non_null(object);
...
static void check_remove_all_items(void **state) {
    const struct butterflyfish_sorted_set_sr sorted_set_sr = {
            .ordered_set_sr.set_sr.remove_all_items = remove_all_items
    };
    struct object {
        const struct butterflyfish_sorted_set_sr *sorted_set_sr;
    };
    ...
    assert_int_equal(
            butterflyfish_sorted_set_sr_remove_all_items(
                    (struct butterflyfish_sorted_set_sr *) &instance,
                    (void *) 1),
            0);
}

static void check_as_ordered_set_remove_all_items(void **state) {
    const struct butterflyfish_sorted_set_sr sorted_set_sr = {
            .ordered_set_sr.set_sr.remove_all_items = remove_all_items
    };
    struct object {
    ...
    expect_function_call(remove_all_items);
    assert_int_equal(
            butterflyfish_ordered_set_sr_remove_all_items(
                    (struct butterflyfish_ordered_set_sr *) &instance,
                    (void *) 1),
            0);
}
...
static void check_as_set_remove_all_items(void **state) {
    ...
    expect_function_call(remove_all_items);
    assert_int_equal(
            butterflyfish_set_sr_remove_all_items(
                    (struct butterflyfish_set_sr *) &instance,
                    (void *) 1),
            0);
}
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_sr_next(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_OBJECT_IS_NULL);
}

static void check_next_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_sr_next((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_ITEM_IS_NULL);
}

static void check_next_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_sr_next((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_OUT_IS_NULL);
}
...
static void check_next_error_on_end_of_sequence(void **state) {
    ...
    will_return(np_emit_error,
                BUTTERFLYFISH_SORTED_SET_SR_ERROR_END_OF_SEQUENCE);
    assert_int_equal(
            butterflyfish_sorted_set_sr_next(
                    (const struct butterflyfish_sorted_set_sr *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_END_OF_SEQUENCE);
...
static void check_as_sorted_set_next_error_on_end_of_sequence(void **state) {
    const struct butterflyfish_sorted_set_sr sorted_set_sr = {
            .ordered_set_sr.set_sr.collection_sr.stream_sr.next = np_emit_error
    };
    struct object {
        const struct butterflyfish_sorted_set_sr *sorted_set_sr;
    };
...
static void check_prev_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_sr_prev(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_OBJECT_IS_NULL);
}

static void check_prev_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_sr_prev((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_ITEM_IS_NULL);
}

static void check_prev_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_sr_prev((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_OUT_IS_NULL);
}
...
static void check_prev_error_on_end_of_sequence(void **state) {
    ...
    will_return(np_emit_error,
                BUTTERFLYFISH_SORTED_SET_SR_ERROR_END_OF_SEQUENCE);
    assert_int_equal(
            butterflyfish_sorted_set_sr_prev(
                    (const struct butterflyfish_sorted_set_sr *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_END_OF_SEQUENCE);
...
static void check_as_sorted_set_prev_error_on_end_of_sequence(void **state) {
    const struct butterflyfish_sorted_set_sr sorted_set_sr = {
            .ordered_set_sr.set_sr.collection_sr.prev = np_emit_error
    };
    struct object {
        const struct butterflyfish_sorted_set_sr *sorted_set_sr;
    };
...
static void check_add_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_sr_add(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_OBJECT_IS_NULL);
}

static void check_add_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_sr_add((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_VALUE_IS_NULL);
}
...
static void check_add_error_on_value_already_exits(void **state) {
    const struct butterflyfish_sorted_set_sr sorted_set_sr = {
            .ordered_set_sr.set_sr.add = ar_emit_error
    };
    struct object {
        const struct butterflyfish_sorted_set_sr *sorted_set_sr;
    };
    ...
    will_return(ar_emit_error,
                BUTTERFLYFISH_SORTED_SET_SR_ERROR_VALUE_ALREADY_EXISTS);
    assert_int_equal(
            butterflyfish_sorted_set_sr_add(
                    (struct butterflyfish_sorted_set_sr *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_VALUE_ALREADY_EXISTS);
}
...
static void check_add_error_on_memory_allocation_failed(void **state) {
    ...
    expect_function_call(ar_emit_error);
    will_return(ar_emit_error,
                BUTTERFLYFISH_SORTED_SET_SR_ERROR_MEMORY_ALLOCATION_FAILED);
    assert_int_equal(
            butterflyfish_sorted_set_sr_add(
                    (struct butterflyfish_sorted_set_sr *) &instance,
                    (void *) 1),
...
static void check_add_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_sr_add_all(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_OBJECT_IS_NULL);
}

static void check_add_all_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_sr_add_all((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_OTHER_IS_NULL);
}
...
static void check_add_all_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_sorted_set_sr sorted_set_sr = {
            .ordered_set_sr.set_sr.add_all = ar_all_emit_error
    };
    struct object {
        const struct butterflyfish_sorted_set_sr *sorted_set_sr;
    };
    ...
    will_return(ar_all_emit_error,
                BUTTERFLYFISH_SORTED_SET_SR_ERROR_MEMORY_ALLOCATION_FAILED);
    assert_int_equal(
            butterflyfish_sorted_set_sr_add_all(
                    (struct butterflyfish_sorted_set_sr *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_MEMORY_ALLOCATION_FAILED);
}
...
static void check_remove_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_sr_remove(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_OBJECT_IS_NULL);
}

static void check_remove_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_sr_remove((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_VALUE_IS_NULL);
}

static void check_remove_error_on_value_not_found(void **state) {
    const struct butterflyfish_sorted_set_sr sorted_set_sr = {
            .ordered_set_sr.set_sr.remove = ar_emit_error
    };
    struct object {
        const struct butterflyfish_sorted_set_sr *sorted_set_sr;
    };
    ...
    expect_function_call(ar_emit_error);
    will_return(ar_emit_error,
                BUTTERFLYFISH_SORTED_SET_SR_ERROR_VALUE_NOT_FOUND);
    assert_int_equal(
            butterflyfish_sorted_set_sr_remove(
                    (struct butterflyfish_sorted_set_sr *) &instance,
                    (void *) 1),
...
static void check_remove_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_sr_remove_all(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_OBJECT_IS_NULL);
}

static void check_remove_all_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_sr_remove_all((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_OTHER_IS_NULL);
}

static void check_remove_all_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_sorted_set_sr sorted_set_sr = {
            .ordered_set_sr.set_sr.remove_all = ar_all_emit_error
    };
    struct object {
        const struct butterflyfish_sorted_set_sr *sorted_set_sr;
    };
    ...
    will_return(ar_all_emit_error,
                BUTTERFLYFISH_SORTED_SET_SR_ERROR_MEMORY_ALLOCATION_FAILED);
    assert_int_equal(
            butterflyfish_sorted_set_sr_remove_all(
                    (struct butterflyfish_sorted_set_sr *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_MEMORY_ALLOCATION_FAILED);
}
...
static void check_contains_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_sr_contains(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_OBJECT_IS_NULL);
}

static void check_contains_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_sr_contains((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_VALUE_IS_NULL);
}

static void check_contains_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_sr_contains((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_OUT_IS_NULL);
}
...
static void check_contains_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_sorted_set_sr sorted_set_sr = {
            .ordered_set_sr.set_sr.contains = contains_emit_error
    };
    struct object {
        const struct butterflyfish_sorted_set_sr *sorted_set_sr;
    };
    ...
    will_return(contains_emit_error,
                BUTTERFLYFISH_SORTED_SET_SR_ERROR_MEMORY_ALLOCATION_FAILED);
    assert_int_equal(
            butterflyfish_sorted_set_sr_contains(
                    (struct butterflyfish_sorted_set_sr *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_MEMORY_ALLOCATION_FAILED);
...
check_as_ordered_set_contains_error_on_memory_allocation_failed(void **state) {
    ...
    will_return(contains_emit_error,
                BUTTERFLYFISH_SORTED_SET_SR_ERROR_MEMORY_ALLOCATION_FAILED);
    assert_int_equal(
            butterflyfish_ordered_set_sr_contains(
                    (struct butterflyfish_ordered_set_sr *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_ORDERED_SET_SR_ERROR_MEMORY_ALLOCATION_FAILED);
...
static void check_contains_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_sr_contains_all(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_OBJECT_IS_NULL);
}
...
check_contains_all_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_sorted_set_sr sorted_set_sr = {
            .ordered_set_sr.set_sr.contains_all = contains_all_emit_error
    };
    struct object {
        const struct butterflyfish_sorted_set_sr *sorted_set_sr;
    };
...
static void check_retain_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_sr_retain_all(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_OBJECT_IS_NULL);
}

static void check_retain_all_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_sr_retain_all((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_OTHER_IS_NULL);
}
...
check_retain_all_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_sorted_set_sr sorted_set_sr = {
            .ordered_set_sr.set_sr.retain_all = retain_all_emit_error
    };
    struct object {
        const struct butterflyfish_sorted_set_sr *sorted_set_sr;
    };
    ...
    will_return(retain_all_emit_error,
                BUTTERFLYFISH_SORTED_SET_SR_ERROR_MEMORY_ALLOCATION_FAILED);
    assert_int_equal(
            butterflyfish_sorted_set_sr_retain_all(
                    (struct butterflyfish_sorted_set_sr *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_MEMORY_ALLOCATION_FAILED);
}
...
static void check_get_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_sr_get(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_OBJECT_IS_NULL);
}

static void check_get_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_sr_get((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_VALUE_IS_NULL);
}

static void check_get_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_sr_get((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_OUT_IS_NULL);
}
...
static void check_get_error_on_item_not_found(void **state) {
    const struct butterflyfish_sorted_set_sr sorted_set_sr = {
            .ordered_set_sr.set_sr.get = get_emit_error
    };
    struct object {
        const struct butterflyfish_sorted_set_sr *sorted_set_sr;
    };
    ...
    will_return(get_emit_error,
                BUTTERFLYFISH_SORTED_SET_SR_ERROR_ITEM_NOT_FOUND);
    assert_int_equal(
            butterflyfish_sorted_set_sr_get(
                    (struct butterflyfish_sorted_set_sr *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_ITEM_NOT_FOUND);
...
static void check_ceiling_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_sr_ceiling(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_OBJECT_IS_NULL);
}

static void check_ceiling_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_sr_ceiling( (void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_VALUE_IS_NULL);
}

static void check_ceiling_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_sr_ceiling( (void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_OUT_IS_NULL);
}
...
static void check_ceiling_error_on_item_not_found(void **state) {
    ...
    will_return(get_emit_error,
                BUTTERFLYFISH_SORTED_SET_SR_ERROR_ITEM_NOT_FOUND);
    assert_int_equal(
            butterflyfish_sorted_set_sr_ceiling(
                    (struct butterflyfish_sorted_set_sr *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_ITEM_NOT_FOUND);
...
static void check_floor_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_sr_floor(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_OBJECT_IS_NULL);
}

static void check_floor_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_sr_floor( (void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_VALUE_IS_NULL);
}

static void check_floor_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_sr_floor( (void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_OUT_IS_NULL);
}
...
static void check_floor_error_on_item_not_found(void **state) {
    ...
    will_return(get_emit_error,
                BUTTERFLYFISH_SORTED_SET_SR_ERROR_ITEM_NOT_FOUND);
    assert_int_equal(
            butterflyfish_sorted_set_sr_floor(
                    (struct butterflyfish_sorted_set_sr *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_ITEM_NOT_FOUND);
...
static void check_higher_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_sr_higher(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_OBJECT_IS_NULL);
}

static void check_higher_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_sr_higher( (void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_VALUE_IS_NULL);
}

static void check_higher_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_sr_higher( (void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_OUT_IS_NULL);
}
...
static void check_higher_error_on_item_not_found(void **state) {
    ...
    will_return(get_emit_error,
                BUTTERFLYFISH_SORTED_SET_SR_ERROR_ITEM_NOT_FOUND);
    assert_int_equal(
            butterflyfish_sorted_set_sr_higher(
                    (struct butterflyfish_sorted_set_sr *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_ITEM_NOT_FOUND);
...
static void check_lower_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_sr_lower(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_OBJECT_IS_NULL);
}

static void check_lower_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_sr_lower( (void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_VALUE_IS_NULL);
}

static void check_lower_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_sr_lower( (void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_OUT_IS_NULL);
}
...
static void check_lower_error_on_item_not_found(void **state) {
    ...
    will_return(get_emit_error,
                BUTTERFLYFISH_SORTED_SET_SR_ERROR_ITEM_NOT_FOUND);
    assert_int_equal(
            butterflyfish_sorted_set_sr_lower(
                    (struct butterflyfish_sorted_set_sr *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_SET_SR_ERROR_ITEM_NOT_FOUND);
...
int main(int argc, char *argv[]) {
    const struct CMUnitTest tests[] = {
            ...
            cmocka_unit_test(check_as_ordered_set_remove_item),
            ...
            cmocka_unit_test(check_as_ordered_set_remove_all_items),
