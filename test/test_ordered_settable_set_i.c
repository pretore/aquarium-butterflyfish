...
struct instance {
    const struct butterflyfish_ordered_settable_set_i *const id;
    void *data;
};
...
static int stream_first(const void *const object,
    ...
    seagrass_required_true(&ordered_settable_set_i == instance->id);
    return mock();
}
...
static void check_as_stream(void **state) {
    assert_ptr_equal(ordered_settable_set_i.as_stream, &stream_i);
}

static void check_as_collection(void **state) {
    assert_ptr_equal(ordered_settable_set_i.as_collection, &collection_i);
}

static void check_as_settable(void **state) {
    assert_ptr_equal(ordered_settable_set_i.as_settable, &settable_i);
}

static void check_as_ordered(void **state) {
    assert_ptr_equal(ordered_settable_set_i.as_ordered, &ordered_i);
}

static void check_as_set(void **state) {
    assert_ptr_equal(ordered_settable_set_i.as_set, &set_i);
}

static void check_as_settable_set(void **state) {
    assert_ptr_equal(ordered_settable_set_i.as_settable_set, &settable_set_i);
}

static void check_as_ordered_set(void **state) {
    assert_ptr_equal(ordered_settable_set_i.as_ordered_set, &ordered_set_i);
}

static void check_count_error_on_object_is_null(void **state) {
    assert_int_equal(ordered_settable_set_i.count(NULL, (void *) 1),
                     BUTTERFLYFISH_ORDERED_SETTABLE_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_count_error_on_out_is_null(void **state) {
    assert_int_equal(ordered_settable_set_i.count((void *) 1, NULL),
...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(ordered_settable_set_i.first(NULL, (void *) 1),
                     BUTTERFLYFISH_ORDERED_SETTABLE_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_first_error_on_out_is_null(void **state) {
    assert_int_equal(ordered_settable_set_i.first((void *) 1, NULL),
                     BUTTERFLYFISH_ORDERED_SETTABLE_SET_I_ERROR_OUT_IS_NULL);
}
...
static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(ordered_settable_set_i.last(NULL, (void *) 1),
                     BUTTERFLYFISH_ORDERED_SETTABLE_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_last_error_on_out_is_null(void **state) {
    assert_int_equal(ordered_settable_set_i.last((void *) 1, NULL),
                     BUTTERFLYFISH_ORDERED_SETTABLE_SET_I_ERROR_OUT_IS_NULL);
}
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(ordered_settable_set_i.next(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_ORDERED_SETTABLE_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_next_error_on_item_is_null(void **state) {
    assert_int_equal(ordered_settable_set_i.next((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_ORDERED_SETTABLE_SET_I_ERROR_ITEM_IS_NULL);
}

static void check_next_error_on_out_is_null(void **state) {
    assert_int_equal(ordered_settable_set_i.next((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_ORDERED_SETTABLE_SET_I_ERROR_OUT_IS_NULL);
}
...
static void check_prev_error_on_object_is_null(void **state) {
    assert_int_equal(ordered_settable_set_i.prev(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_ORDERED_SETTABLE_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_prev_error_on_item_is_null(void **state) {
    assert_int_equal(ordered_settable_set_i.prev((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_ORDERED_SETTABLE_SET_I_ERROR_ITEM_IS_NULL);
}

static void check_prev_error_on_out_is_null(void **state) {
    assert_int_equal(ordered_settable_set_i.prev((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_ORDERED_SETTABLE_SET_I_ERROR_OUT_IS_NULL);
}
...
static void check_contains_error_on_object_is_null(void **state) {
    assert_int_equal(ordered_settable_set_i.contains(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_ORDERED_SETTABLE_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_contains_error_on_value_is_null(void **state) {
    assert_int_equal(ordered_settable_set_i.contains((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_ORDERED_SETTABLE_SET_I_ERROR_VALUE_IS_NULL);
}

static void check_contains_error_on_out_is_null(void **state) {
    assert_int_equal(ordered_settable_set_i.contains((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_ORDERED_SETTABLE_SET_I_ERROR_OUT_IS_NULL);
}
...
static void check_get_error_on_object_is_null(void **state) {
    assert_int_equal(ordered_settable_set_i.get(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_ORDERED_SETTABLE_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_get_error_on_value_is_null(void **state) {
    assert_int_equal(ordered_settable_set_i.get((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_ORDERED_SETTABLE_SET_I_ERROR_VALUE_IS_NULL);
}

static void check_get_error_on_out_is_null(void **state) {
    assert_int_equal(ordered_settable_set_i.get((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_ORDERED_SETTABLE_SET_I_ERROR_OUT_IS_NULL);
}
...
static void check_set_item_error_on_object_is_null(void **state) {
    assert_int_equal(ordered_settable_set_i.set_item(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_ORDERED_SETTABLE_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_set_item_error_on_item_is_null(void **state) {
    assert_int_equal(ordered_settable_set_i.set_item((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_ORDERED_SETTABLE_SET_I_ERROR_ITEM_IS_NULL);
}

static void check_set_item_error_on_value_is_null(void **state) {
    assert_int_equal(ordered_settable_set_i.set_item((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_ORDERED_SETTABLE_SET_I_ERROR_VALUE_IS_NULL);
}
...
static void check_set_error_on_object_is_null(void **state) {
    assert_int_equal(ordered_settable_set_i.set(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_ORDERED_SETTABLE_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_set_error_on_item_is_null(void **state) {
    assert_int_equal(ordered_settable_set_i.set((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_ORDERED_SETTABLE_SET_I_ERROR_ITEM_IS_NULL);
}

static void check_set_error_on_value_is_null(void **state) {
    assert_int_equal(ordered_settable_set_i.set((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_ORDERED_SETTABLE_SET_I_ERROR_VALUE_IS_NULL);
}
