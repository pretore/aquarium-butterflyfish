...
static void check_as_stream_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_map_i_i_as_stream(NULL, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_stream_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_map_i_i_as_stream((void *) 1, NULL),
...
static void check_as_stream(void **state) {
    ...
    assert_int_equal(butterflyfish_reducible_map_i_i_as_stream(
            (const struct butterflyfish_reducible_map_i_i *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}

static void check_as_collection_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_map_i_i_as_collection(NULL, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_collection_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_map_i_i_as_collection((void *) 1, NULL),
            BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_as_collection(void **state) {
    ...
    assert_int_equal(butterflyfish_reducible_map_i_i_as_collection(
            (const struct butterflyfish_reducible_map_i_i *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_map_i_i_as_set(NULL, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_set_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_map_i_i_as_set((void *) 1, NULL),
            BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_as_set(void **state) {
    ...
    assert_int_equal(butterflyfish_reducible_map_i_i_as_set(
            (const struct butterflyfish_reducible_map_i_i *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_removable_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_map_i_i_as_removable(NULL, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_removable_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_map_i_i_as_removable((void *) 1, NULL),
            BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_as_removable(void **state) {
    ...
    assert_int_equal(butterflyfish_reducible_map_i_i_as_removable(
            (struct butterflyfish_reducible_map_i_i *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}

static void check_as_map_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_map_i_i_as_map(NULL, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_map_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_map_i_i_as_map((void *) 1, NULL),
            BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_removable_as_collection(void **state) {
    ...
    assert_int_equal(butterflyfish_reducible_map_i_i_as_removable(
            (struct butterflyfish_reducible_map_i_i *) &instance, &as), 0);
    const struct butterflyfish_collection_i_i *out;
...
static void check_count_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_map_i_i_count(NULL, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_count_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_map_i_i_count((void *) 1, NULL),
            BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_count(void **state) {
    ...
    uintmax_t out;
    assert_int_equal(butterflyfish_reducible_map_i_i_count(
            (const struct butterflyfish_reducible_map_i_i *) &instance, &out),
                    0);
...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_map_i_i_first(NULL, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_first_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_map_i_i_first((void *) 1, NULL),
            BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_first_error_on_map_is_empty(void **state) {
    ...
    assert_int_equal(
            butterflyfish_reducible_map_i_i_first(
...
static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_map_i_i_last(NULL, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_last_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_map_i_i_last((void *) 1, NULL),
            BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_last_error_on_map_is_empty(void **state) {
    ...
    assert_int_equal(
            butterflyfish_reducible_map_i_i_last(
                    (const struct butterflyfish_reducible_map_i_i *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_MAP_IS_EMPTY);
}
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_map_i_i_next(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_next_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_map_i_i_next((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_ITEM_IS_NULL);
}

static void check_next_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_map_i_i_next((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_next_error_on_end_of_sequence(void **state) {
    ...
    assert_int_equal(
            butterflyfish_reducible_map_i_i_next(
                    (const struct butterflyfish_reducible_map_i_i *) &instance,
                    (void *) 1,
                    (void *) 1),
...
static void check_prev_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_map_i_i_prev(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_prev_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_map_i_i_prev((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_ITEM_IS_NULL);
}

static void check_prev_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_map_i_i_prev((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_prev_error_on_end_of_sequence(void **state) {
    ...
    assert_int_equal(
            butterflyfish_reducible_map_i_i_prev(
                    (const struct butterflyfish_reducible_map_i_i *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_END_OF_SEQUENCE);
...
static void check_contains_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_map_i_i_contains(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_contains_error_on_entry_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_map_i_i_contains(
                    (void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_ENTRY_IS_NULL);
}
...
static void check_contains_key_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_map_i_i_contains_key(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_contains_key_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_map_i_i_contains_key((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_VALUE_IS_NULL);
}

static void check_contains_key_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_map_i_i_contains_key((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_contains_key_error_on_memory_allocation_failed(void **state) {
    ...
    assert_int_equal(
            butterflyfish_reducible_map_i_i_contains_key(
                    (struct butterflyfish_reducible_map_i_i *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_MEMORY_ALLOCATION_FAILED);
...
static void check_contains_value_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_map_i_i_contains_value(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_contains_value_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_map_i_i_contains_value((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_VALUE_IS_NULL);
}

static void check_contains_value_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_map_i_i_contains_value((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_contains_value_error_on_memory_allocation_failed(void **state) {
    ...
    will_return(map_contains_value,
                BUTTERFLYFISH_MAP_I_I_ERROR_MEMORY_ALLOCATION_FAILED);
    assert_int_equal(
            butterflyfish_reducible_map_i_i_contains_value(
                    (struct butterflyfish_reducible_map_i_i *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_MEMORY_ALLOCATION_FAILED);
...
static void check_contains_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_map_i_i_contains_all(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_contains_all_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_map_i_i_contains_all((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_OTHER_IS_NULL);
}

static void check_contains_all_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_map_i_i_contains_all((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_OUT_IS_NULL);
}
...
check_contains_all_error_on_memory_allocation_failed(void **state) {
    ...
    will_return(set_contains_all,
                BUTTERFLYFISH_SET_I_I_ERROR_MEMORY_ALLOCATION_FAILED);
    assert_int_equal(
            butterflyfish_reducible_map_i_i_contains_all(
                    (struct butterflyfish_reducible_map_i_i *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_MEMORY_ALLOCATION_FAILED);
...
static void check_contains_all_keys_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_map_i_i_contains_all_keys(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_contains_all_keys_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_map_i_i_contains_all_keys((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_OTHER_IS_NULL);
}

static void check_contains_all_keys_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_map_i_i_contains_all_keys((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_OUT_IS_NULL);
}
...
check_contains_all_keys_error_on_memory_allocation_failed(void **state) {
    ...
    will_return(map_contains_all_keys,
                BUTTERFLYFISH_SET_I_I_ERROR_MEMORY_ALLOCATION_FAILED);
    assert_int_equal(
            butterflyfish_reducible_map_i_i_contains_all_keys(
                    (struct butterflyfish_reducible_map_i_i *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_MEMORY_ALLOCATION_FAILED);
...
static void check_contains_all_values_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_map_i_i_contains_all_values(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_contains_all_values_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_map_i_i_contains_all_values((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_OTHER_IS_NULL);
}

static void check_contains_all_values_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_map_i_i_contains_all_values((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_OUT_IS_NULL);
}
...
check_contains_all_values_error_on_memory_allocation_failed(void **state) {
    ...
    will_return(map_contains_all_values,
                BUTTERFLYFISH_SET_I_I_ERROR_MEMORY_ALLOCATION_FAILED);
    assert_int_equal(
            butterflyfish_reducible_map_i_i_contains_all_values(
                    (struct butterflyfish_reducible_map_i_i *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_MEMORY_ALLOCATION_FAILED);
...
static void check_get_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_map_i_i_get(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_get_error_on_entry_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_map_i_i_get((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_ENTRY_IS_NULL);
}

static void check_get_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_map_i_i_get((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_get_error_on_entry_not_found(void **state) {
    ...
    assert_int_equal(
            butterflyfish_reducible_map_i_i_get(
                    (struct butterflyfish_reducible_map_i_i *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_ENTRY_NOT_FOUND);
}
...
static void check_get_value_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_map_i_i_get_value(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_get_value_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_map_i_i_get_value((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_VALUE_IS_NULL);
}

static void check_get_value_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_map_i_i_get_value((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_get_value_error_on_value_not_found(void **state) {
    ...
    assert_int_equal(
            butterflyfish_reducible_map_i_i_get_value(
                    (struct butterflyfish_reducible_map_i_i *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_VALUE_NOT_FOUND);
}
...
static void check_get_entry_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_map_i_i_get_entry(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_get_entry_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_map_i_i_get_entry((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_VALUE_IS_NULL);
}

static void check_get_entry_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_reducible_map_i_i_get_entry((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_get_entry_error_on_value_not_found(void **state) {
    ...
    will_return(map_get_entry,
                BUTTERFLYFISH_MAP_I_I_ERROR_VALUE_NOT_FOUND);
    assert_int_equal(
            butterflyfish_reducible_map_i_i_get_entry(
                    (struct butterflyfish_reducible_map_i_i *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_VALUE_NOT_FOUND);
...
static void check_remove_error_on_object_is_null(void **state) {
    assert_int_equal(butterflyfish_reducible_map_i_i_remove(NULL, (void *) 1),
                     BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_remove_error_on_key_is_null(void **state) {
    assert_int_equal(butterflyfish_reducible_map_i_i_remove((void *) 1, NULL),
...
static void check_remove_error_on_key_not_found(void **state) {
    ...
    assert_int_equal(
            butterflyfish_reducible_map_i_i_remove(
                    (struct butterflyfish_reducible_map_i_i *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_KEY_NOT_FOUND);
}
...
static void check_remove_all_error_on_object_is_null(void **state) {
    assert_int_equal(butterflyfish_reducible_map_i_i_remove_all(NULL, (void *) 1),
                     BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_remove_all_error_on_other_is_null(void **state) {
    assert_int_equal(butterflyfish_reducible_map_i_i_remove_all((void *) 1, NULL),
                     BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_OTHER_IS_NULL);
}
...
static void check_remove_all_error_on_memory_allocation_failed(void **state) {
    ...
    will_return(reducible_map_remove_all,
                BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_MEMORY_ALLOCATION_FAILED);
    assert_int_equal(
            butterflyfish_reducible_map_i_i_remove_all(
                    (struct butterflyfish_reducible_map_i_i *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_MEMORY_ALLOCATION_FAILED);
}
...
static void check_retain_all_error_on_object_is_null(void **state) {
    assert_int_equal(butterflyfish_reducible_map_i_i_retain_all(NULL, (void *) 1),
                     BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_retain_all_error_on_other_is_null(void **state) {
    assert_int_equal(butterflyfish_reducible_map_i_i_retain_all((void *) 1, NULL),
                     BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_OTHER_IS_NULL);
}
...
static void check_retain_all_error_on_memory_allocation_failed(void **state) {
    ...
    will_return(reducible_map_retain_all,
                BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_MEMORY_ALLOCATION_FAILED);
    assert_int_equal(
            butterflyfish_reducible_map_i_i_retain_all(
                    (struct butterflyfish_reducible_map_i_i *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_MEMORY_ALLOCATION_FAILED);
}
...
static void check_remove_entry_error_on_object_is_null(void **state) {
    assert_int_equal(butterflyfish_reducible_map_i_i_remove_entry(NULL, (void *) 1),
                     BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_remove_entry_error_on_entry_is_null(void **state) {
    assert_int_equal(butterflyfish_reducible_map_i_i_remove_entry((void *) 1, NULL),
                     BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_ENTRY_IS_NULL);
}
...
static void check_remove_entry(void **state) {
    ...
    assert_int_equal(
            butterflyfish_reducible_map_i_i_remove_entry(
                    (struct butterflyfish_reducible_map_i_i *) &instance,
                    (void *) 1), 0);
}

static void check_remove_all_entries_error_on_object_is_null(void **state) {
    assert_int_equal(butterflyfish_reducible_map_i_i_remove_all_entries(NULL, (void*) 1),
                     BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_remove_all_entries_error_on_entries_is_null(void **state) {
    assert_int_equal(butterflyfish_reducible_map_i_i_remove_all_entries((void *) 1,NULL),
                     BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_OTHER_IS_NULL);
}
...
static void check_remove_all_entries(void **state) {
    ...
    assert_int_equal(
            butterflyfish_reducible_map_i_i_remove_all_entries(
                    (struct butterflyfish_reducible_map_i_i *) &instance,
                    (void *) 1), 0);
}

static void check_keys_error_on_object_is_null(void **state) {
    assert_int_equal(butterflyfish_reducible_map_i_i_keys(NULL, (void *) 1),
                     BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_keys_error_on_out_is_null(void **state) {
    assert_int_equal(butterflyfish_reducible_map_i_i_keys((void *) 1, NULL),
                     BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_keys(void **state) {
    ...
    assert_int_equal(
            butterflyfish_reducible_map_i_i_keys(
                    (struct butterflyfish_reducible_map_i_i *) &instance,
                    &out), 0);
}
...
static void check_as_map_keys(void **state) {
    ...
    assert_int_equal(butterflyfish_reducible_map_i_i_as_map(
            (const struct butterflyfish_reducible_map_i_i *)
                    &instance, &as), 0);
...
static void check_values_error_on_object_is_null(void **state) {
    assert_int_equal(butterflyfish_reducible_map_i_i_values(NULL, (void *) 1),
                     BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_values_error_on_out_is_null(void **state) {
    assert_int_equal(butterflyfish_reducible_map_i_i_values((void *) 1, NULL),
                     BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_OUT_IS_NULL);
}
