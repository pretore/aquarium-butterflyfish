...
static void check_as_stream_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_set_sr_as_stream(NULL, (void *) 1),
            BUTTERFLYFISH_SET_SR_ERROR_OBJECT_IS_NULL);
}

static void check_as_stream_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_set_sr_as_stream((void *) 1, NULL),
...
static void check_as_collection(void **state) {
    ...
    assert_int_equal(butterflyfish_set_sr_as_collection(&set, &collection), 0);
    assert_ptr_equal(&set, collection);
}

static void check_count_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_set_sr_count(NULL, (void *) 1),
            BUTTERFLYFISH_SET_SR_ERROR_OBJECT_IS_NULL);
}

static void check_count_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_set_sr_count((void *) 1, NULL),
            BUTTERFLYFISH_SET_SR_ERROR_OUT_IS_NULL);
}
...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_set_sr_first(NULL, (void *) 1),
            BUTTERFLYFISH_SET_SR_ERROR_OBJECT_IS_NULL);
}

static void check_first_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_set_sr_first((void *) 1, NULL),
            BUTTERFLYFISH_SET_SR_ERROR_OUT_IS_NULL);
}
...
static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_set_sr_last(NULL, (void *) 1),
            BUTTERFLYFISH_SET_SR_ERROR_OBJECT_IS_NULL);
}

static void check_last_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_set_sr_last((void *) 1, NULL),
            BUTTERFLYFISH_SET_SR_ERROR_OUT_IS_NULL);
}
...
static void check_remove_item_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_set_sr_remove_item(NULL, (void *) 1),
            BUTTERFLYFISH_SET_SR_ERROR_OBJECT_IS_NULL);
}

static void check_remove_item_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_set_sr_remove_item((void *) 1, NULL),
...
static void check_remove_all_items_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_set_sr_remove_all_items(NULL, (void *) 1),
            BUTTERFLYFISH_SET_SR_ERROR_OBJECT_IS_NULL);
}

static void check_remove_all_items_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_set_sr_remove_all_items((void *) 1, NULL),
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_set_sr_next(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SET_SR_ERROR_OBJECT_IS_NULL);
}

static void check_next_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_set_sr_next((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SET_SR_ERROR_ITEM_IS_NULL);
}

static void check_next_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_set_sr_next((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SET_SR_ERROR_OUT_IS_NULL);
}
...
static void check_prev_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_set_sr_prev(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SET_SR_ERROR_OBJECT_IS_NULL);
}

static void check_prev_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_set_sr_prev((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SET_SR_ERROR_ITEM_IS_NULL);
}

static void check_prev_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_set_sr_prev((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SET_SR_ERROR_OUT_IS_NULL);
}
...
static void check_add_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_set_sr_add(NULL, (void *) 1),
            BUTTERFLYFISH_SET_SR_ERROR_OBJECT_IS_NULL);
}

static void check_add_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_set_sr_add((void *) 1, NULL),
...
static void check_add_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_set_sr_add_all(NULL, (void *) 1),
            BUTTERFLYFISH_SET_SR_ERROR_OBJECT_IS_NULL);
}

static void check_add_all_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_set_sr_add_all((void *) 1, NULL),
            BUTTERFLYFISH_SET_SR_ERROR_OTHER_IS_NULL);
}
...
static void check_remove_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_set_sr_remove(NULL, (void *) 1),
            BUTTERFLYFISH_SET_SR_ERROR_OBJECT_IS_NULL);
}

static void check_remove_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_set_sr_remove((void *) 1, NULL),
            BUTTERFLYFISH_SET_SR_ERROR_VALUE_IS_NULL);
}
...
static void check_remove_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_set_sr_remove_all(NULL, (void *) 1),
            BUTTERFLYFISH_SET_SR_ERROR_OBJECT_IS_NULL);
}

static void check_remove_all_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_set_sr_remove_all((void *) 1, NULL),
            BUTTERFLYFISH_SET_SR_ERROR_OTHER_IS_NULL);
}
...
static void check_contains_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_set_sr_contains(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SET_SR_ERROR_OBJECT_IS_NULL);
}

static void check_contains_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_set_sr_contains((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SET_SR_ERROR_VALUE_IS_NULL);
}

static void check_contains_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_set_sr_contains((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SET_SR_ERROR_OUT_IS_NULL);
}
...
static void check_contains_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_set_sr_contains_all(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SET_SR_ERROR_OBJECT_IS_NULL);
}

static void check_contains_all_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_set_sr_contains_all((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SET_SR_ERROR_OTHER_IS_NULL);
}

static void check_contains_all_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_set_sr_contains_all((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SET_SR_ERROR_OUT_IS_NULL);
}
...
static void check_retain_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_set_sr_retain_all(NULL, (void *) 1),
            BUTTERFLYFISH_SET_SR_ERROR_OBJECT_IS_NULL);
}

static void check_retain_all_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_set_sr_retain_all((void *) 1, NULL),
            BUTTERFLYFISH_SET_SR_ERROR_OTHER_IS_NULL);
}
...
static void check_get_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_set_sr_get(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SET_SR_ERROR_OBJECT_IS_NULL);
}

static void check_get_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_set_sr_get((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SET_SR_ERROR_VALUE_IS_NULL);
}

static void check_get_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_set_sr_get((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SET_SR_ERROR_OUT_IS_NULL);
}
