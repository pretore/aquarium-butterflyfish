...
static void check_as_collection(void **state) {
    ...
    assert_int_equal(butterflyfish_queue_s_as_collection(
            &queue, &collection), 0);
...
static void check_as_reducible_queue_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_queue_s_as_reducible_queue(NULL, (void *) 1),
            BUTTERFLYFISH_QUEUE_S_ERROR_OBJECT_IS_NULL);
}

static void check_as_reducible_queue_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_queue_s_as_reducible_queue((void *) 1, NULL),
            BUTTERFLYFISH_QUEUE_S_ERROR_OUT_IS_NULL);
}
...
static void check_as_reducible_queue(void **state) {
    ...
    assert_int_equal(butterflyfish_queue_s_as_reducible_queue(
...
static void check_count(void **state) {
    ...
    const struct butterflyfish_queue_s queue_s = {
            .reducible_queue_s.collection_s.count = count
    };
    struct object {
        const struct butterflyfish_queue_s *queue_s;
    };
