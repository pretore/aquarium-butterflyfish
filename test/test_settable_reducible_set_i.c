...
struct object {
    const struct butterflyfish_settable_reducible_set_i
            *const settable_reducible_set_i;
...
static void check_as_stream_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_reducible_set_i_as_stream(
                    NULL, (void *) 1),
...
static void check_as_stream(void **state) {
    ...
    assert_int_equal(butterflyfish_settable_reducible_set_i_as_stream(
            (const struct butterflyfish_settable_reducible_set_i *)
                    &instance, &out), 0);
...
static void check_as_collection_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_reducible_set_i_as_collection(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_collection(void **state) {
    ...
    assert_int_equal(butterflyfish_settable_reducible_set_i_as_collection(
            (const struct butterflyfish_settable_reducible_set_i *)
                    &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_settable_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_reducible_set_i_as_settable(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_settable(void **state) {
    ...
    assert_int_equal(butterflyfish_settable_reducible_set_i_as_settable(
...
static void check_as_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_reducible_set_i_as_set(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_set(void **state) {
    ...
    assert_int_equal(butterflyfish_settable_reducible_set_i_as_set(
            (const struct butterflyfish_settable_reducible_set_i *)
                    &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_removable_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_reducible_set_i_as_removable(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_removable(void **state) {
    ...
    assert_int_equal(butterflyfish_settable_reducible_set_i_as_removable(
            (struct butterflyfish_settable_reducible_set_i *)
                    &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_settable_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_reducible_set_i_as_settable_set(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_reducible_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_reducible_set_i_as_reducible_set(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_count_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_reducible_set_i_count(NULL, (void *) 1),
            BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_count_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_reducible_set_i_count((void *) 1, NULL),
            BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_ERROR_OUT_IS_NULL);
}
...
static void check_count(void **state) {
    ...
    uintmax_t out;
    assert_int_equal(butterflyfish_settable_reducible_set_i_count(
            (const struct butterflyfish_settable_reducible_set_i *)
                    &instance, &out), 0);
...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_reducible_set_i_first(NULL, (void *) 1),
            BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_first_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_reducible_set_i_first((void *) 1, NULL),
            BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_ERROR_OUT_IS_NULL);
}
...
static void check_first_error_on_set_is_empty(void **state) {
    ...
    assert_int_equal(
            butterflyfish_settable_reducible_set_i_first(
                    (const struct butterflyfish_settable_reducible_set_i *) &instance,
                    (void *) 1),
...
static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_reducible_set_i_last(NULL, (void *) 1),
            BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_last_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_reducible_set_i_last((void *) 1, NULL),
            BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_ERROR_OUT_IS_NULL);
}
...
static void check_last_error_on_set_is_empty(void **state) {
    ...
    assert_int_equal(
            butterflyfish_settable_reducible_set_i_last(
                    (const struct butterflyfish_settable_reducible_set_i *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_ERROR_SET_IS_EMPTY);
}
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_reducible_set_i_next(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_prev_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_reducible_set_i_prev(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_contains_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_reducible_set_i_contains(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_contains_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_reducible_set_i_contains_all(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_contains_all_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_reducible_set_i_contains_all(
                    (void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_ERROR_OTHER_IS_NULL);
}
...
static void check_get_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_reducible_set_i_get(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_set_item_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_reducible_set_i_set_item(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_set_item_error_on_value_is_invalid(void **state) {
    ...
    assert_int_equal(
            butterflyfish_settable_reducible_set_i_set_item(
                    (struct butterflyfish_settable_reducible_set_i *) &instance,
                    (void *) 1,
                    (void *) 1),
...
static void check_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_reducible_set_i_set(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_remove_item_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_reducible_set_i_remove_item(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_remove_all_items_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_reducible_set_i_remove_all_items(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_remove_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_reducible_set_i_remove(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_remove_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_reducible_set_i_remove_all(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_retain_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_reducible_set_i_retain_all(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_ERROR_OBJECT_IS_NULL);
}
