...
static void check_as_stream_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_map_s_s_as_stream(NULL, (void *) 1),
            BUTTERFLYFISH_MAP_S_S_ERROR_OBJECT_IS_NULL);
}

static void check_as_stream_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_map_s_s_as_stream((void *) 1, NULL),
...
static void check_as_collection(void **state) {
    ...
    assert_int_equal(butterflyfish_map_s_s_as_collection(
            &map, &collection), 0);
...
static void check_count_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_map_s_s_count(NULL, (void *) 1),
            BUTTERFLYFISH_MAP_S_S_ERROR_OBJECT_IS_NULL);
}

static void check_count_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_map_s_s_count((void *) 1, NULL),
            BUTTERFLYFISH_MAP_S_S_ERROR_OUT_IS_NULL);
}
...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_map_s_s_first(NULL, (void *) 1),
            BUTTERFLYFISH_MAP_S_S_ERROR_OBJECT_IS_NULL);
}

static void check_first_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_map_s_s_first((void *) 1, NULL),
            BUTTERFLYFISH_MAP_S_S_ERROR_OUT_IS_NULL);
}
...
static void check_first_error_on_map_is_empty(void **state) {
    const struct butterflyfish_map_s_s map_s_s = {
            .collection_s_s.stream_s_s.first = fl_emit_error
    };
    struct object {
        const struct butterflyfish_map_s_s *map_s_s;
    };
...
static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_map_s_s_last(NULL, (void *) 1),
            BUTTERFLYFISH_MAP_S_S_ERROR_OBJECT_IS_NULL);
}

static void check_last_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_map_s_s_last((void *) 1, NULL),
            BUTTERFLYFISH_MAP_S_S_ERROR_OUT_IS_NULL);
}

static void check_last_error_on_map_is_empty(void **state) {
    const struct butterflyfish_map_s_s map_s_s = {
            .collection_s_s.last = fl_emit_error
    };
    struct object {
        const struct butterflyfish_map_s_s *map_s_s;
    };
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_map_s_s_next(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_MAP_S_S_ERROR_OBJECT_IS_NULL);
}

static void check_next_error_on_entry_is_null(void **state) {
    assert_int_equal(
            butterflyfish_map_s_s_next((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_MAP_S_S_ERROR_ENTRY_IS_NULL);
}

static void check_next_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_map_s_s_next((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_MAP_S_S_ERROR_OUT_IS_NULL);
}
...
static void check_next_error_on_end_of_sequence(void **state) {
    const struct butterflyfish_map_s_s map_s_s = {
            .collection_s_s.stream_s_s.next = np_emit_error
    };
    struct object {
        const struct butterflyfish_map_s_s *map_s_s;
    };
...
static void check_prev_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_map_s_s_prev(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_MAP_S_S_ERROR_OBJECT_IS_NULL);
}

static void check_prev_error_on_entry_is_null(void **state) {
    assert_int_equal(
            butterflyfish_map_s_s_prev((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_MAP_S_S_ERROR_ENTRY_IS_NULL);
}

static void check_prev_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_map_s_s_prev((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_MAP_S_S_ERROR_OUT_IS_NULL);
}

static void check_prev_error_on_end_of_sequence(void **state) {
    const struct butterflyfish_map_s_s map_s_s = {
            .collection_s_s.prev = np_emit_error
    };
    struct object {
        const struct butterflyfish_map_s_s *map_s_s;
    };
...
static void check_remove_entry_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_map_s_s_remove_entry(NULL, (void *) 1),
            BUTTERFLYFISH_MAP_S_S_ERROR_OBJECT_IS_NULL);
}

static void check_remove_entry_error_on_entry_is_null(void **state) {
    assert_int_equal(
            butterflyfish_map_s_s_remove_entry((void *) 1, NULL),
            BUTTERFLYFISH_MAP_S_S_ERROR_ENTRY_IS_NULL);
}
...
static void check_remove_all_entries_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_map_s_s_remove_all_entries(NULL, (void *) 1),
            BUTTERFLYFISH_MAP_S_S_ERROR_OBJECT_IS_NULL);
}

static void check_remove_all_entries_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_map_s_s_remove_all_entries((void *) 1, NULL),
...
static void check_put_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_map_s_s_put(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_MAP_S_S_ERROR_OBJECT_IS_NULL);
}

static void check_put_error_on_key_is_null(void **state) {
    assert_int_equal(
            butterflyfish_map_s_s_put((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_MAP_S_S_ERROR_KEY_IS_NULL);
}

static void check_put_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_map_s_s_put((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_MAP_S_S_ERROR_VALUE_IS_NULL);
}
...
static void check_replace_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_map_s_s_replace(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_MAP_S_S_ERROR_OBJECT_IS_NULL);
}

static void check_replace_error_on_key_is_null(void **state) {
    assert_int_equal(
            butterflyfish_map_s_s_replace((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_MAP_S_S_ERROR_KEY_IS_NULL);
}

static void check_replace_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_map_s_s_replace((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_MAP_S_S_ERROR_VALUE_IS_NULL);
}
...
static void check_remove_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_map_s_s_remove(NULL, (void *) 1),
            BUTTERFLYFISH_MAP_S_S_ERROR_OBJECT_IS_NULL);
}

static void check_remove_error_on_key_is_null(void **state) {
    assert_int_equal(
            butterflyfish_map_s_s_remove((void *) 1, NULL),
            BUTTERFLYFISH_MAP_S_S_ERROR_KEY_IS_NULL);
}
...
static void check_add_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_map_s_s_add_all(NULL, (void *) 1),
            BUTTERFLYFISH_MAP_S_S_ERROR_OBJECT_IS_NULL);
}

static void check_add_all_error_on_key_is_null(void **state) {
    assert_int_equal(
            butterflyfish_map_s_s_add_all((void *) 1, NULL),
            BUTTERFLYFISH_MAP_S_S_ERROR_OTHER_IS_NULL);
}
...
static void check_put_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_map_s_s_put_all(NULL, (void *) 1),
            BUTTERFLYFISH_MAP_S_S_ERROR_OBJECT_IS_NULL);
}

static void check_put_all_error_on_key_is_null(void **state) {
    assert_int_equal(
            butterflyfish_map_s_s_put_all((void *) 1, NULL),
            BUTTERFLYFISH_MAP_S_S_ERROR_OTHER_IS_NULL);
}
...
static void check_replace_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_map_s_s_replace_all(NULL, (void *) 1),
            BUTTERFLYFISH_MAP_S_S_ERROR_OBJECT_IS_NULL);
}

static void check_replace_all_error_on_key_is_null(void **state) {
    assert_int_equal(
            butterflyfish_map_s_s_replace_all((void *) 1, NULL),
            BUTTERFLYFISH_MAP_S_S_ERROR_OTHER_IS_NULL);
}
...
static void check_remove_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_map_s_s_remove_all(NULL, (void *) 1),
            BUTTERFLYFISH_MAP_S_S_ERROR_OBJECT_IS_NULL);
}

static void check_remove_all_error_on_key_is_null(void **state) {
    assert_int_equal(
            butterflyfish_map_s_s_remove_all((void *) 1, NULL),
            BUTTERFLYFISH_MAP_S_S_ERROR_OTHER_IS_NULL);
}
...
static void check_retain_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_map_s_s_retain_all(NULL, (void *) 1),
            BUTTERFLYFISH_MAP_S_S_ERROR_OBJECT_IS_NULL);
}

static void check_retain_all_error_on_key_is_null(void **state) {
    assert_int_equal(
            butterflyfish_map_s_s_retain_all((void *) 1, NULL),
            BUTTERFLYFISH_MAP_S_S_ERROR_OTHER_IS_NULL);
}
...
static void check_merge_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_map_s_s_merge(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_MAP_S_S_ERROR_OBJECT_IS_NULL);
}

static void check_merge_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_map_s_s_merge((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_MAP_S_S_ERROR_OTHER_IS_NULL);
}

static void check_merge_error_on_function_is_null(void **state) {
    assert_int_equal(
            butterflyfish_map_s_s_merge((void *) 1, (void *) 1, NULL),
...
static void check_contains_key_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_map_s_s_contains_key(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_MAP_S_S_ERROR_OBJECT_IS_NULL);
}

static void check_contains_key_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_map_s_s_contains_key((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_MAP_S_S_ERROR_KEY_IS_NULL);
}

static void check_contains_key_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_map_s_s_contains_key((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_MAP_S_S_ERROR_OUT_IS_NULL);
}
...
static void check_get_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_map_s_s_get(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_MAP_S_S_ERROR_OBJECT_IS_NULL);
}

static void check_get_error_on_key_is_null(void **state) {
    assert_int_equal(
            butterflyfish_map_s_s_get((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_MAP_S_S_ERROR_KEY_IS_NULL);
}

static void check_get_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_map_s_s_get((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_MAP_S_S_ERROR_OUT_IS_NULL);
}
...
static void check_get_entry_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_map_s_s_get_entry(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_MAP_S_S_ERROR_OBJECT_IS_NULL);
}

static void check_get_entry_error_on_key_is_null(void **state) {
    assert_int_equal(
            butterflyfish_map_s_s_get_entry((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_MAP_S_S_ERROR_KEY_IS_NULL);
}

static void check_get_entry_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_map_s_s_get_entry((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_MAP_S_S_ERROR_OUT_IS_NULL);
}
...
static void check_keys_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_map_s_s_keys(NULL, (void *) 1),
            BUTTERFLYFISH_MAP_S_S_ERROR_OBJECT_IS_NULL);
}
...
static void check_keys_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_map_s_s_keys((void *) 1, NULL),
            BUTTERFLYFISH_MAP_S_S_ERROR_OUT_IS_NULL);
}

static void check_values_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_map_s_s_values(NULL, (void *) 1),
            BUTTERFLYFISH_MAP_S_S_ERROR_OBJECT_IS_NULL);
}

static void check_values_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_map_s_s_values((void *) 1, NULL),
            BUTTERFLYFISH_MAP_S_S_ERROR_OUT_IS_NULL);
}
