...
static void check_as_stream_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_as_stream(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_stream_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_as_stream((void *) 1, NULL),
...
static void check_as_stream(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_incremental_map_i_i_as_stream(
            (const struct butterflyfish_sorted_incremental_map_i_i *) &instance,
                    &out), 0);
...
static void check_as_collection_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_as_collection(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_collection_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_as_collection((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_as_collection(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_incremental_map_i_i_as_collection(
            (const struct butterflyfish_sorted_incremental_map_i_i *) &instance,
                    &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_sorted_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_as_sorted(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_sorted_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_as_sorted((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_as_sorted(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_incremental_map_i_i_as_sorted(
            (const struct butterflyfish_sorted_incremental_map_i_i *) &instance,
                    &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_as_set(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_set_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_as_set((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_as_set(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_incremental_map_i_i_as_set(
            (const struct butterflyfish_sorted_incremental_map_i_i *) &instance,
                    &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_map_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_as_map(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_map_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_as_map((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_as_map(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_incremental_map_i_i_as_map(
            (const struct butterflyfish_sorted_incremental_map_i_i *) &instance,
                    &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_addable_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_as_addable(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_addable_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_as_addable((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_as_addable(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_incremental_map_i_i_as_addable(
...
static void check_as_sorted_map_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_as_sorted_map(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_sorted_map_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_as_sorted_map((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_as_incremental_map_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_as_incremental_map(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_incremental_map_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_as_incremental_map((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_addable_as_collection(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_incremental_map_i_i_as_addable(
            (struct butterflyfish_sorted_incremental_map_i_i *) &instance, &as), 0);
    const struct butterflyfish_collection_i_i *out;
...
static void check_count_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_count(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_count_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_count((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_count(void **state) {
    ...
    uintmax_t out;
    assert_int_equal(butterflyfish_sorted_incremental_map_i_i_count(
            (const struct butterflyfish_sorted_incremental_map_i_i *) &instance,
                    &out), 0);
...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_first(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_first_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_first((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_first_error_on_map_is_empty(void **state) {
    ...
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_first(
                    (const struct butterflyfish_sorted_incremental_map_i_i *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_MAP_IS_EMPTY);
}

static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_last(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_last_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_last((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_last_error_on_map_is_empty(void **state) {
    ...
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_last(
                    (const struct butterflyfish_sorted_incremental_map_i_i *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_MAP_IS_EMPTY);
}
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_next(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_next_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_next((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_ITEM_IS_NULL);
}

static void check_next_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_next((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_next_error_on_end_of_sequence(void **state) {
    ...
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_next(
                    (const struct butterflyfish_sorted_incremental_map_i_i *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_END_OF_SEQUENCE);
}

static void check_prev_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_prev(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_prev_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_prev((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_ITEM_IS_NULL);
}

static void check_prev_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_prev((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_prev_error_on_end_of_sequence(void **state) {
    ...
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_prev(
                    (const struct butterflyfish_sorted_incremental_map_i_i *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_END_OF_SEQUENCE);
...
static void check_contains_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_contains(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_contains_error_on_entry_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_contains((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_ENTRY_IS_NULL);
}

static void check_contains_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_contains((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_contains_error_on_memory_allocation_failed(void **state) {
    ...
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_contains(
                    (struct butterflyfish_sorted_incremental_map_i_i *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_MEMORY_ALLOCATION_FAILED);
}

static void check_contains_key_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_contains_key(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_contains_key_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_contains_key((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_VALUE_IS_NULL);
}

static void check_contains_key_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_contains_key((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_contains_key_error_on_memory_allocation_failed(void **state) {
    ...
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_contains_key(
                    (struct butterflyfish_sorted_incremental_map_i_i *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_MEMORY_ALLOCATION_FAILED);
...
static void check_contains_value_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_contains_value(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_contains_value_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_contains_value((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_VALUE_IS_NULL);
}

static void check_contains_value_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_contains_value((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_contains_value_error_on_memory_allocation_failed(void **state) {
    ...
    will_return(map_contains_value,
                BUTTERFLYFISH_MAP_I_I_ERROR_MEMORY_ALLOCATION_FAILED);
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_contains_value(
                    (struct butterflyfish_sorted_incremental_map_i_i *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_MEMORY_ALLOCATION_FAILED);
...
static void check_contains_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_contains_all(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_contains_all_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_contains_all((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OTHER_IS_NULL);
}

static void check_contains_all_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_contains_all((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL);
}
...
check_contains_all_error_on_memory_allocation_failed(void **state) {
    ...
    will_return(set_contains_all,
                BUTTERFLYFISH_SET_I_I_ERROR_MEMORY_ALLOCATION_FAILED);
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_contains_all(
                    (struct butterflyfish_sorted_incremental_map_i_i *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_MEMORY_ALLOCATION_FAILED);
...
static void check_contains_all_keys_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_contains_all_keys(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_contains_all_keys_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_contains_all_keys((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OTHER_IS_NULL);
}

static void check_contains_all_keys_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_contains_all_keys((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL);
}
...
check_contains_all_keys_error_on_memory_allocation_failed(void **state) {
    ...
    will_return(map_contains_all_keys,
                BUTTERFLYFISH_SET_I_I_ERROR_MEMORY_ALLOCATION_FAILED);
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_contains_all_keys(
                    (struct butterflyfish_sorted_incremental_map_i_i *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_MEMORY_ALLOCATION_FAILED);
...
static void check_contains_all_values_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_contains_all_values(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_contains_all_values_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_contains_all_values((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OTHER_IS_NULL);
}

static void check_contains_all_values_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_contains_all_values((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL);
}
...
check_contains_all_values_error_on_memory_allocation_failed(void **state) {
    ...
    will_return(map_contains_all_values,
                BUTTERFLYFISH_SET_I_I_ERROR_MEMORY_ALLOCATION_FAILED);
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_contains_all_values(
                    (struct butterflyfish_sorted_incremental_map_i_i *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_MEMORY_ALLOCATION_FAILED);
...
static void check_get_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_get(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_get_error_on_entry_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_get((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_ENTRY_IS_NULL);
}

static void check_get_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_get((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_get_error_on_entry_not_found(void **state) {
    ...
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_get(
                    (struct butterflyfish_sorted_incremental_map_i_i *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_ENTRY_NOT_FOUND);
}
...
static void check_get_value_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_get_value(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_get_value_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_get_value((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_VALUE_IS_NULL);
}

static void check_get_value_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_get_value((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_get_value_error_on_key_not_found(void **state) {
    ...
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_get_value(
                    (struct butterflyfish_sorted_incremental_map_i_i *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_KEY_NOT_FOUND);
}
...
static void check_get_entry_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_get_entry(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_get_entry_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_get_entry((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_VALUE_IS_NULL);
}

static void check_get_entry_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_get_entry((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_get_entry_error_on_key_not_found(void **state) {
    ...
    will_return(map_get_entry,
                BUTTERFLYFISH_MAP_I_I_ERROR_VALUE_NOT_FOUND);
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_get_entry(
                    (struct butterflyfish_sorted_incremental_map_i_i *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_KEY_NOT_FOUND);
...
static void check_add_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_add(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_add_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_add((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_VALUE_IS_NULL);
}
...
static void check_add_error_on_entry_is_invalid(void **state) {
    ...
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_add(
                    (struct butterflyfish_sorted_incremental_map_i_i *) &instance,
                    (void *) 1),
...
static void check_add_error_on_key_already_exists(void **state) {
    ...
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_add(
                    (struct butterflyfish_sorted_incremental_map_i_i *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_KEY_ALREADY_EXISTS);
}
...
static void check_add_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_add_all(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_add_all_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_add_all((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OTHER_IS_NULL);
}
...
static void check_add_all_error_on_memory_allocation_failed(void **state) {
    ...
    will_return(addable_add_all,
                BUTTERFLYFISH_ADDABLE_I_I_ERROR_MEMORY_ALLOCATION_FAILED);
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_add_all(
                    (struct butterflyfish_sorted_incremental_map_i_i *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_MEMORY_ALLOCATION_FAILED);
}
...
static void check_add_value_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_add_value(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OBJECT_IS_NULL);
...
static void check_add_value_error_on_key_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_add_value(
                    (void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_KEY_IS_NULL);
}
...
static void check_add_value_error_value_is_invalid(void **state) {
    ...
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_add_value(
                    ...
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_VALUE_IS_INVALID);
}
...
static void check_ceiling_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_ceiling(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_ceiling_error_on_key_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_ceiling((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_KEY_IS_NULL);
}

static void check_ceiling_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_ceiling((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_ceiling_error_on_key_not_found(void **state) {
    ...
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_ceiling(
                    (const struct butterflyfish_sorted_incremental_map_i_i *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_KEY_NOT_FOUND);
...
static void check_floor_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_floor(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_floor_error_on_key_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_floor((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_KEY_IS_NULL);
}

static void check_floor_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_floor((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_floor_error_on_key_not_found(void **state) {
    ...
    will_return(sorted_map_floor,
                BUTTERFLYFISH_SORTED_MAP_I_I_ERROR_VALUE_NOT_FOUND);
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_floor(
                    (const struct butterflyfish_sorted_incremental_map_i_i *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_KEY_NOT_FOUND);
...
static void check_higher_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_higher(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_higher_error_on_key_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_higher((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_KEY_IS_NULL);
}

static void check_higher_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_higher((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_higher_error_on_key_not_found(void **state) {
    ...
    will_return(sorted_map_higher,
                BUTTERFLYFISH_SORTED_MAP_I_I_ERROR_VALUE_NOT_FOUND);
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_higher(
                    (const struct butterflyfish_sorted_incremental_map_i_i *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_KEY_NOT_FOUND);
...
static void check_lower_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_lower(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_lower_error_on_key_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_lower((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_KEY_IS_NULL);
}

static void check_lower_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_lower((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_lower_error_on_key_not_found(void **state) {
    ...
    will_return(sorted_map_lower,
                BUTTERFLYFISH_SORTED_MAP_I_I_ERROR_VALUE_NOT_FOUND);
    assert_int_equal(
            butterflyfish_sorted_incremental_map_i_i_lower(
                    (const struct butterflyfish_sorted_incremental_map_i_i *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_KEY_NOT_FOUND);
...
static void check_keys_error_on_object_is_null(void **state) {
    assert_int_equal(butterflyfish_sorted_incremental_map_i_i_keys(NULL, (void *) 1),
                     BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_keys_error_on_out_is_null(void **state) {
    assert_int_equal(butterflyfish_sorted_incremental_map_i_i_keys((void *) 1, NULL),
                     BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_keys(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_incremental_map_i_i_keys(
                    (struct butterflyfish_sorted_incremental_map_i_i *) &instance,
                    &out), 0);
}
...
static void check_values_error_on_out_is_null(void **state) {
    assert_int_equal(butterflyfish_sorted_incremental_map_i_i_values((void *) 1, NULL),
                     BUTTERFLYFISH_SORTED_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL);
}
