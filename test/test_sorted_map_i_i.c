...
static void check_count(void **state) {
    ...
    const struct butterflyfish_sorted_map_i_i sorted_map_i_i = {
            .ordered_map_i_i.map_i_i.collection_i_i.count = count
    };
    struct object {
        const struct butterflyfish_sorted_map_i_i *sorted_map_i_i;
    };
    ...
    uintmax_t out;
    assert_int_equal(
            butterflyfish_sorted_map_i_i_count(
...
static void check_remove_entry(void **state) {
    const struct butterflyfish_sorted_map_i_i sorted_map_i_i = {
            .ordered_map_i_i.map_i_i.remove_entry = remove_entry
    };
    struct object {
        const struct butterflyfish_sorted_map_i_i *sorted_map_i_i;
    };
    ...
    assert_int_equal(
            butterflyfish_sorted_map_i_i_remove_entry(
...
static void check_remove_all_entries(void **state) {
    const struct butterflyfish_sorted_map_i_i sorted_map_i_i = {
            .ordered_map_i_i.map_i_i.remove_all_entries = remove_all_entries
    };
    struct object {
        const struct butterflyfish_sorted_map_i_i *sorted_map_i_i;
    };
    ...
    assert_int_equal(
            butterflyfish_sorted_map_i_i_remove_all_entries(
                    (struct butterflyfish_sorted_map_i_i *) &instance,
                    (void *) 1),
            0);
}
...
static int keys(void *const object,
                struct butterflyfish_sorted_set_i **const out) {
    function_called();
    assert_non_null(object);
    assert_non_null(out);
    return 0;
...
static void check_keys(void **state) {
    ...
    assert_int_equal(
            butterflyfish_sorted_map_i_i_keys(
                    (struct butterflyfish_sorted_map_i_i *) &instance,
                    (void *) 1),
            0);
}
...
static void check_values(void **state) {
    const struct butterflyfish_sorted_map_i_i sorted_map_i_i = {
            .ordered_map_i_i.map_i_i.values = values
    };
    struct object {
        const struct butterflyfish_sorted_map_i_i *sorted_map_i_i;
    };
    ...
    assert_int_equal(
            butterflyfish_sorted_map_i_i_values(
                    (struct butterflyfish_sorted_map_i_i *) &instance,
                    (void *) 1),
            0);
}
