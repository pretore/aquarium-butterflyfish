...
static void check_as_stream_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_sr_sr_as_stream(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_SR_SR_ERROR_OBJECT_IS_NULL);
}

static void check_as_stream_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_sr_sr_as_stream((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_MAP_SR_SR_ERROR_OUT_IS_NULL);
}

static void check_as_stream(void **state) {
    struct butterflyfish_sorted_map_sr_sr sorted_map = {};
    const struct butterflyfish_stream_sr_sr *stream;
    assert_int_equal(butterflyfish_sorted_map_sr_sr_as_stream(
            &sorted_map, &stream), 0);
...
static void check_as_collection_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_sr_sr_as_collection(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_SR_SR_ERROR_OBJECT_IS_NULL);
}

static void check_as_collection_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_sr_sr_as_collection((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_MAP_SR_SR_ERROR_OUT_IS_NULL);
}
...
static void check_as_collection(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_map_sr_sr_as_collection(
...
static void check_as_map_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_sr_sr_as_map(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_SR_SR_ERROR_OBJECT_IS_NULL);
}

static void check_as_map_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_sr_sr_as_map((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_MAP_SR_SR_ERROR_OUT_IS_NULL);
}
...
static void check_as_map(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_map_sr_sr_as_map(
            &sorted_map, &map), 0);
...
static void check_as_ordered_map_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_sr_sr_as_ordered_map(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_SR_SR_ERROR_OBJECT_IS_NULL);
}

static void check_as_ordered_map_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_sr_sr_as_ordered_map((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_MAP_SR_SR_ERROR_OUT_IS_NULL);
}
...
static void check_as_ordered_map(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_map_sr_sr_as_ordered_map(
