...
struct object {
    const struct butterflyfish_unordered_i *const unordered_i;
...
static int as_collection(const struct butterflyfish_unordered_i *const object,
                         const struct butterflyfish_collection_i **const out) {
    assert_non_null(object);
    assert_non_null(out);
    *out = butterflyfish_cast(object, struct object, unordered_i, collection_i);
    return 0;
}

const struct butterflyfish_unordered_i unordered_i = {
        .as_collection = as_collection,
};

static void check_as_stream_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_unordered_i_as_stream(NULL, (void *) 1),
            BUTTERFLYFISH_UNORDERED_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_stream_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_unordered_i_as_stream((void *) 1, NULL),
            BUTTERFLYFISH_UNORDERED_I_ERROR_OUT_IS_NULL);
}

static void check_as_stream(void **state) {
    const struct object instance = {
            .unordered_i = &unordered_i,
    ...
    assert_int_equal(butterflyfish_unordered_i_as_stream(
            (const struct butterflyfish_unordered_i *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}

static void check_as_collection_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_unordered_i_as_collection(NULL, (void *) 1),
            BUTTERFLYFISH_UNORDERED_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_collection_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_unordered_i_as_collection((void *) 1, NULL),
            BUTTERFLYFISH_UNORDERED_I_ERROR_OUT_IS_NULL);
}
...
static void check_as_collection(void **state) {
    ...
    assert_int_equal(butterflyfish_unordered_i_as_collection(
            (const struct butterflyfish_unordered_i *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_count_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_unordered_i_count(NULL, (void *) 1),
            BUTTERFLYFISH_UNORDERED_I_ERROR_OBJECT_IS_NULL);
}

static void check_count_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_unordered_i_count((void *) 1, NULL),
            BUTTERFLYFISH_UNORDERED_I_ERROR_OUT_IS_NULL);
}
...
static void check_count(void **state) {
    ...
    uintmax_t out;
    assert_int_equal(butterflyfish_unordered_i_count(
            (const struct butterflyfish_unordered_i *) &instance, &out), 0);
...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_unordered_i_first(NULL, (void *) 1),
            BUTTERFLYFISH_UNORDERED_I_ERROR_OBJECT_IS_NULL);
}

static void check_first_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_unordered_i_first((void *) 1, NULL),
            BUTTERFLYFISH_UNORDERED_I_ERROR_OUT_IS_NULL);
}
...
static void check_first_error_on_unordered_is_empty(void **state) {
    ...
    assert_int_equal(
            butterflyfish_unordered_i_first(
                    (const struct butterflyfish_unordered_i *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_UNORDERED_I_ERROR_UNORDERED_IS_EMPTY);
}

static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_unordered_i_last(NULL, (void *) 1),
            BUTTERFLYFISH_UNORDERED_I_ERROR_OBJECT_IS_NULL);
}

static void check_last_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_unordered_i_last((void *) 1, NULL),
            BUTTERFLYFISH_UNORDERED_I_ERROR_OUT_IS_NULL);
}
...
static void check_last_error_on_unordered_is_empty(void **state) {
    ...
    assert_int_equal(
            butterflyfish_unordered_i_last(
                    (const struct butterflyfish_unordered_i *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_UNORDERED_I_ERROR_UNORDERED_IS_EMPTY);
}
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_unordered_i_next(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_UNORDERED_I_ERROR_OBJECT_IS_NULL);
}

static void check_next_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_unordered_i_next((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_UNORDERED_I_ERROR_ITEM_IS_NULL);
}

static void check_next_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_unordered_i_next((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_UNORDERED_I_ERROR_OUT_IS_NULL);
}
...
static void check_next_error_on_end_of_sequence(void **state) {
    ...
    assert_int_equal(
            butterflyfish_unordered_i_next(
                    (const struct butterflyfish_unordered_i *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_UNORDERED_I_ERROR_END_OF_SEQUENCE);
}

static void check_prev_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_unordered_i_prev(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_UNORDERED_I_ERROR_OBJECT_IS_NULL);
}

static void check_prev_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_unordered_i_prev((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_UNORDERED_I_ERROR_ITEM_IS_NULL);
}

static void check_prev_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_unordered_i_prev((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_UNORDERED_I_ERROR_OUT_IS_NULL);
}
...
static void check_prev_error_on_end_of_sequence(void **state) {
    ...
    assert_int_equal(
            butterflyfish_unordered_i_prev(
                    (const struct butterflyfish_unordered_i *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_UNORDERED_I_ERROR_END_OF_SEQUENCE);
