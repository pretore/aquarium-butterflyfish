...
struct instance {
    const struct butterflyfish_settable_reducible_set_i_i *const id;
};

const struct butterflyfish_settable_reducible_set_i_i settable_reducible_set_i_i;
static int stream_first(const void *const object,
    ...
    seagrass_required_true(&settable_reducible_set_i_i == instance->id);
    return mock();
}
...
static void check_as_stream(void **state) {
    assert_ptr_equal(settable_reducible_set_i_i.as_stream, &stream_i_i);
}

static void check_as_collection(void **state) {
    assert_ptr_equal(settable_reducible_set_i_i.as_collection, &collection_i_i);
}

static void check_as_settable(void **state) {
    assert_ptr_equal(settable_reducible_set_i_i.as_settable, &settable_i_i);
}

static void check_as_set(void **state) {
    assert_ptr_equal(settable_reducible_set_i_i.as_set, &set_i_i);
}

static void check_as_removable(void **state) {
    assert_ptr_equal(settable_reducible_set_i_i.as_removable, &removable_i_i);
}

static void check_as_settable_set(void **state) {
    assert_ptr_equal(settable_reducible_set_i_i.as_settable_set, &settable_set_i_i);
}

static void check_as_reducible_set(void **state) {
    assert_ptr_equal(settable_reducible_set_i_i.as_reducible_set, &reducible_set_i_i);
}

static void check_count_error_on_object_is_null(void **state) {
    assert_int_equal(settable_reducible_set_i_i.count(NULL, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_count_error_on_out_is_null(void **state) {
    assert_int_equal(settable_reducible_set_i_i.count((void *) 1, NULL),
...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(settable_reducible_set_i_i.first(NULL, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_first_error_on_out_is_null(void **state) {
    assert_int_equal(settable_reducible_set_i_i.first((void *) 1, NULL),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(settable_reducible_set_i_i.last(NULL, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_last_error_on_out_is_null(void **state) {
    assert_int_equal(settable_reducible_set_i_i.last((void *) 1, NULL),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(settable_reducible_set_i_i.next(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_next_error_on_item_is_null(void **state) {
    assert_int_equal(settable_reducible_set_i_i.next((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_ERROR_ITEM_IS_NULL);
}

static void check_next_error_on_out_is_null(void **state) {
    assert_int_equal(settable_reducible_set_i_i.next((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_prev_error_on_object_is_null(void **state) {
    assert_int_equal(settable_reducible_set_i_i.prev(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_prev_error_on_item_is_null(void **state) {
    assert_int_equal(settable_reducible_set_i_i.prev((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_ERROR_ITEM_IS_NULL);
}

static void check_prev_error_on_out_is_null(void **state) {
    assert_int_equal(settable_reducible_set_i_i.prev((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_contains_error_on_object_is_null(void **state) {
    assert_int_equal(settable_reducible_set_i_i.contains(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_contains_error_on_value_is_null(void **state) {
    assert_int_equal(settable_reducible_set_i_i.contains((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_ERROR_VALUE_IS_NULL);
}

static void check_contains_error_on_out_is_null(void **state) {
    assert_int_equal(settable_reducible_set_i_i.contains((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_get_error_on_object_is_null(void **state) {
    assert_int_equal(settable_reducible_set_i_i.get(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_get_error_on_value_is_null(void **state) {
    assert_int_equal(settable_reducible_set_i_i.get((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_ERROR_VALUE_IS_NULL);
}

static void check_get_error_on_out_is_null(void **state) {
    assert_int_equal(settable_reducible_set_i_i.get((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_set_item_error_on_object_is_null(void **state) {
    assert_int_equal(settable_reducible_set_i_i.set_item(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_set_item_error_on_item_is_null(void **state) {
    assert_int_equal(settable_reducible_set_i_i.set_item((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_ERROR_ITEM_IS_NULL);
}

static void check_set_item_error_on_value_is_null(void **state) {
    assert_int_equal(settable_reducible_set_i_i.set_item((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_ERROR_VALUE_IS_NULL);
}
...
static void check_set_error_on_object_is_null(void **state) {
    assert_int_equal(settable_reducible_set_i_i.set(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_set_error_on_item_is_null(void **state) {
    assert_int_equal(settable_reducible_set_i_i.set((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_ERROR_ITEM_IS_NULL);
}

static void check_set_error_on_value_is_null(void **state) {
    assert_int_equal(settable_reducible_set_i_i.set((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_ERROR_VALUE_IS_NULL);
}
...
static void check_remove_item_error_on_object_is_null(void **state) {
    assert_int_equal(settable_reducible_set_i_i.remove_item(NULL, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_remove_item_error_on_item_is_null(void **state) {
    assert_int_equal(settable_reducible_set_i_i.remove_item((void *) 1, NULL),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_ERROR_ITEM_IS_NULL);
}
...
static void check_remove_error_on_object_is_null(void **state) {
    assert_int_equal(settable_reducible_set_i_i.remove(NULL, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_remove_error_on_value_is_null(void **state) {
    assert_int_equal(settable_reducible_set_i_i.remove((void *) 1, NULL),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_ERROR_VALUE_IS_NULL);
}
