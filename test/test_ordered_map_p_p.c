...
static void check_as_stream_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_p_p_as_stream(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_P_P_ERROR_OBJECT_IS_NULL);
}

static void check_as_stream_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_p_p_as_stream((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_P_P_ERROR_OUT_IS_NULL);
}

static void check_as_stream(void **state) {
    struct butterflyfish_ordered_map_p_p ordered_map = {};
    const struct butterflyfish_stream_p_p *stream;
    assert_int_equal(butterflyfish_ordered_map_p_p_as_stream(
...
static void check_as_collection_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_p_p_as_collection(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_P_P_ERROR_OBJECT_IS_NULL);
}

static void check_as_collection_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_p_p_as_collection((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_P_P_ERROR_OUT_IS_NULL);
}
...
static void check_as_collection(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_map_p_p_as_collection(
...
static void check_as_map_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_p_p_as_map(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_P_P_ERROR_OBJECT_IS_NULL);
}

static void check_as_map_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_p_p_as_map((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_P_P_ERROR_OUT_IS_NULL);
}
...
static void check_as_map(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_map_p_p_as_map(
            &ordered_map, &map), 0);
...
static void check_count_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_p_p_count(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_P_P_ERROR_OBJECT_IS_NULL);
}

static void check_count_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_p_p_count((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_P_P_ERROR_OUT_IS_NULL);
}
...
static void check_count(void **state) {
    ...
    const struct butterflyfish_ordered_map_p_p ordered_map_p_p = {
            .map_p_p.collection_p_p.count = count
    };
    struct object {
        const struct butterflyfish_ordered_map_p_p *ordered_map_p_p;
    };
    struct object instance = {
            .ordered_map_p_p = &ordered_map_p_p
    };
    ...
    uintmax_t out;
    assert_int_equal(
            butterflyfish_ordered_map_p_p_count(
...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_p_p_first(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_P_P_ERROR_OBJECT_IS_NULL);
}

static void check_first_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_p_p_first((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_P_P_ERROR_OUT_IS_NULL);
}
...
static void check_first_error_on_map_is_empty(void **state) {
    const struct butterflyfish_ordered_map_p_p ordered_map_p_p = {
            .map_p_p.collection_p_p.stream_p_p.first = fl_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_map_p_p *ordered_map_p_p;
    };
...
static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_p_p_last(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_P_P_ERROR_OBJECT_IS_NULL);
}

static void check_last_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_p_p_last((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_P_P_ERROR_OUT_IS_NULL);
}

static void check_last_error_on_map_is_empty(void **state) {
    const struct butterflyfish_ordered_map_p_p ordered_map_p_p = {
            .map_p_p.collection_p_p.last = fl_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_map_p_p *ordered_map_p_p;
    };
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_p_p_next(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_P_P_ERROR_OBJECT_IS_NULL);
}

static void check_next_error_on_entry_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_p_p_next((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_P_P_ERROR_ENTRY_IS_NULL);
}

static void check_next_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_p_p_next((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_P_P_ERROR_OUT_IS_NULL);
}
...
static void check_next_error_on_end_of_sequence(void **state) {
    const struct butterflyfish_ordered_map_p_p ordered_map_p_p = {
            .map_p_p.collection_p_p.stream_p_p.next = np_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_map_p_p *ordered_map_p_p;
    };
...
static void check_prev_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_p_p_prev(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_P_P_ERROR_OBJECT_IS_NULL);
}

static void check_prev_error_on_entry_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_p_p_prev((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_P_P_ERROR_ENTRY_IS_NULL);
}

static void check_prev_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_p_p_prev((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_P_P_ERROR_OUT_IS_NULL);
}

static void check_prev_error_on_end_of_sequence(void **state) {
    const struct butterflyfish_ordered_map_p_p ordered_map_p_p = {
            .map_p_p.collection_p_p.prev = np_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_map_p_p *ordered_map_p_p;
    };
...
static void check_remove_entry_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_p_p_remove_entry(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_P_P_ERROR_OBJECT_IS_NULL);
}

static void check_remove_entry_error_on_entry_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_p_p_remove_entry((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_P_P_ERROR_ENTRY_IS_NULL);
}
...
static void check_remove_entry(void **state) {
    const struct butterflyfish_ordered_map_p_p ordered_map_p_p = {
            .map_p_p.remove_entry = remove_entry
    };
    struct object {
        const struct butterflyfish_ordered_map_p_p *ordered_map_p_p;
    };
    ...
    assert_int_equal(
            butterflyfish_ordered_map_p_p_remove_entry(
...
static void check_remove_all_entries_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_p_p_remove_all_entries(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_P_P_ERROR_OBJECT_IS_NULL);
}

static void check_remove_all_entries_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_p_p_remove_all_entries((void *) 1, NULL),
...
static void check_remove_all_entries(void **state) {
    const struct butterflyfish_ordered_map_p_p ordered_map_p_p = {
            .map_p_p.remove_all_entries = remove_all_entries
    };
    struct object {
        const struct butterflyfish_ordered_map_p_p *ordered_map_p_p;
    };
    ...
    assert_int_equal(
            butterflyfish_ordered_map_p_p_remove_all_entries(
                    (struct butterflyfish_ordered_map_p_p *) &instance,
                    (void *) 1),
            0);
}
...
static void check_add_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_p_p_add(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_P_P_ERROR_OBJECT_IS_NULL);
}
...
static void check_put_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_p_p_put(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_P_P_ERROR_OBJECT_IS_NULL);
}
...
static void check_replace_error_on_key_not_found(void **state) {
    const struct butterflyfish_ordered_map_p_p ordered_map_p_p = {
            .map_p_p.replace = apr_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_map_p_p *ordered_map_p_p;
    };
...
static void check_remove_error_on_key_not_found(void **state) {
    const struct butterflyfish_ordered_map_p_p ordered_map_p_p = {
            .map_p_p.remove = remove_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_map_p_p *ordered_map_p_p;
    };
...
static void check_add_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_p_p_add_all(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_P_P_ERROR_OBJECT_IS_NULL);
}

static void check_add_all_error_on_key_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_p_p_add_all((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_P_P_ERROR_OTHER_IS_NULL);
}
...
static void check_add_all_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_ordered_map_p_p ordered_map_p_p = {
            .map_p_p.add_all = all_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_map_p_p *ordered_map_p_p;
    };
...
static void check_put_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_p_p_put_all(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_P_P_ERROR_OBJECT_IS_NULL);
}

static void check_put_all_error_on_key_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_p_p_put_all((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_P_P_ERROR_OTHER_IS_NULL);
}

static void check_put_all_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_ordered_map_p_p ordered_map_p_p = {
            .map_p_p.put_all = all_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_map_p_p *ordered_map_p_p;
    };
...
static void check_replace_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_p_p_replace_all(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_P_P_ERROR_OBJECT_IS_NULL);
}

static void check_replace_all_error_on_key_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_p_p_replace_all((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_P_P_ERROR_OTHER_IS_NULL);
}

static void check_replace_all_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_ordered_map_p_p ordered_map_p_p = {
            .map_p_p.replace_all = all_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_map_p_p *ordered_map_p_p;
    };
...
static void check_remove_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_p_p_remove_all(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_P_P_ERROR_OBJECT_IS_NULL);
}

static void check_remove_all_error_on_key_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_p_p_remove_all((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_P_P_ERROR_OTHER_IS_NULL);
}
...
static void check_remove_all_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_ordered_map_p_p ordered_map_p_p = {
            .map_p_p.remove_all = rr_all_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_map_p_p *ordered_map_p_p;
    };
...
static void check_retain_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_p_p_retain_all(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_P_P_ERROR_OBJECT_IS_NULL);
}

static void check_retain_all_error_on_key_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_p_p_retain_all((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_P_P_ERROR_OTHER_IS_NULL);
}

static void check_retain_all_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_ordered_map_p_p ordered_map_p_p = {
            .map_p_p.retain_all = rr_all_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_map_p_p *ordered_map_p_p;
    };
...
static void check_merge_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_p_p_merge(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_P_P_ERROR_OBJECT_IS_NULL);
}

static void check_merge_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_p_p_merge((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_P_P_ERROR_OTHER_IS_NULL);
}

static void check_merge_error_on_function_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_p_p_merge((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_P_P_ERROR_FUNCTION_IS_NULL);
}
...
static void check_merge_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_ordered_map_p_p ordered_map_p_p = {
            .map_p_p.merge = merge_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_map_p_p *ordered_map_p_p;
    };
...
static void check_contains_key_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_p_p_contains_key(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_P_P_ERROR_OBJECT_IS_NULL);
}
...
check_contains_key_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_ordered_map_p_p ordered_map_p_p = {
            .map_p_p.contains_key = contains_key_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_map_p_p *ordered_map_p_p;
    };
...
check_contains_all_keys_error_on_memory_allocation_failed(void **state) {
    const struct butterflyfish_ordered_map_p_p ordered_map_p_p = {
            .map_p_p.contains_all_keys = contains_all_keys_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_map_p_p *ordered_map_p_p;
    };
...
static void check_get_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_p_p_get(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_P_P_ERROR_OBJECT_IS_NULL);
}
...
static void check_get_entry_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_p_p_get_entry((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_P_P_ERROR_OUT_IS_NULL);
}
...
static void check_get_entry_error_on_key_not_found(void **state) {
    const struct butterflyfish_ordered_map_p_p ordered_map_p_p = {
            .map_p_p.get_entry = get_entry_emit_error
    };
    struct object {
        const struct butterflyfish_ordered_map_p_p *ordered_map_p_p;
    };
...
static void check_keys_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_p_p_keys(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_P_P_ERROR_OBJECT_IS_NULL);
}

static void check_keys_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_p_p_keys((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_P_P_ERROR_OUT_IS_NULL);
}
...
static void check_keys(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_map_p_p_keys(
                    (struct butterflyfish_ordered_map_p_p *) &instance,
                    (void *) 1),
            0);
}
...
static void check_values_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_p_p_values(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_P_P_ERROR_OBJECT_IS_NULL);
}

static void check_values_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_p_p_values((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_P_P_ERROR_OUT_IS_NULL);
}
...
static void check_values(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_map_p_p_values(
                    (struct butterflyfish_ordered_map_p_p *) &instance,
                    (void *) 1),
            0);
}
