...
static void check_as_stream_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_fixed_list_i_as_stream(NULL, (void *) 1),
            BUTTERFLYFISH_FIXED_LIST_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_stream_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_fixed_list_i_as_stream((void *) 1, NULL),
            BUTTERFLYFISH_FIXED_LIST_I_ERROR_OUT_IS_NULL);
}

static void check_as_stream(void **state) {
    struct butterflyfish_fixed_list_i fixed_list = {};
    const struct butterflyfish_stream_i *stream;
    assert_int_equal(butterflyfish_fixed_list_i_as_stream(
            &fixed_list, &stream), 0);
...
static void check_as_collection_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_fixed_list_i_as_collection(NULL, (void *) 1),
            BUTTERFLYFISH_FIXED_LIST_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_collection_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_fixed_list_i_as_collection((void *) 1, NULL),
            BUTTERFLYFISH_FIXED_LIST_I_ERROR_OUT_IS_NULL);
}
...
static void check_as_collection(void **state) {
    ...
    assert_int_equal(butterflyfish_fixed_list_i_as_collection(
...
static void check_count_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_fixed_list_i_count(NULL, (void *) 1),
            BUTTERFLYFISH_FIXED_LIST_I_ERROR_OBJECT_IS_NULL);
}

static void check_count_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_fixed_list_i_count((void *) 1, NULL),
            BUTTERFLYFISH_FIXED_LIST_I_ERROR_OUT_IS_NULL);
}
...
static void check_count(void **state) {
    ...
    uintmax_t out;
    assert_int_equal(
            butterflyfish_fixed_list_i_count(
...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_fixed_list_i_first(NULL, (void *) 1),
            BUTTERFLYFISH_FIXED_LIST_I_ERROR_OBJECT_IS_NULL);
}

static void check_first_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_fixed_list_i_first((void *) 1, NULL),
            BUTTERFLYFISH_FIXED_LIST_I_ERROR_OUT_IS_NULL);
}

static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_fixed_list_i_last(NULL, (void *) 1),
            BUTTERFLYFISH_FIXED_LIST_I_ERROR_OBJECT_IS_NULL);
}

static void check_last_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_fixed_list_i_last((void *) 1, NULL),
            BUTTERFLYFISH_FIXED_LIST_I_ERROR_OUT_IS_NULL);
}
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_fixed_list_i_next(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_FIXED_LIST_I_ERROR_OBJECT_IS_NULL);
}

static void check_next_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_fixed_list_i_next((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_FIXED_LIST_I_ERROR_ITEM_IS_NULL);
}

static void check_next_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_fixed_list_i_next((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_FIXED_LIST_I_ERROR_OUT_IS_NULL);
}
...
static void check_prev_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_fixed_list_i_prev(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_FIXED_LIST_I_ERROR_OBJECT_IS_NULL);
}

static void check_prev_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_fixed_list_i_prev((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_FIXED_LIST_I_ERROR_ITEM_IS_NULL);
}

static void check_prev_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_fixed_list_i_prev((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_FIXED_LIST_I_ERROR_OUT_IS_NULL);
}
...
static void check_get_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_fixed_list_i_get(NULL, 0, (void *) 1),
            BUTTERFLYFISH_FIXED_LIST_I_ERROR_OBJECT_IS_NULL);
}

static void check_get_error_on_out(void **state) {
    assert_int_equal(
            butterflyfish_fixed_list_i_get((void *) 1, 0, NULL),
            BUTTERFLYFISH_FIXED_LIST_I_ERROR_OUT_IS_NULL);
}
...
static void check_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_fixed_list_i_set(NULL, 0, (void *) 1),
            BUTTERFLYFISH_FIXED_LIST_I_ERROR_OBJECT_IS_NULL);
}

static void check_set_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_fixed_list_i_set((void *) 1, 0, NULL),
...
static void check_at_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_fixed_list_i_at(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_FIXED_LIST_I_ERROR_OBJECT_IS_NULL);
}

static void check_at_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_fixed_list_i_at((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_FIXED_LIST_I_ERROR_ITEM_IS_NULL);
}

static void check_at_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_fixed_list_i_at((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_FIXED_LIST_I_ERROR_OUT_IS_NULL);
}
