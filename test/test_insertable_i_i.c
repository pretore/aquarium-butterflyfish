...
static void check_as_stream_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_insertable_i_i_as_stream(NULL, (void *) 1),
            BUTTERFLYFISH_INSERTABLE_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_stream_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_insertable_i_i_as_stream((void *) 1, NULL),
...
static void check_as_stream(void **state) {
    ...
    assert_int_equal(butterflyfish_insertable_i_i_as_stream(
            (const struct butterflyfish_insertable_i_i *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}

static void check_as_collection_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_insertable_i_i_as_collection(NULL, (void *) 1),
            BUTTERFLYFISH_INSERTABLE_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_collection_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_insertable_i_i_as_collection((void *) 1, NULL),
            BUTTERFLYFISH_INSERTABLE_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_as_collection(void **state) {
    ...
    assert_int_equal(butterflyfish_insertable_i_i_as_collection(
            (const struct butterflyfish_insertable_i_i *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_ordered_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_insertable_i_i_as_ordered(NULL, (void *) 1),
            BUTTERFLYFISH_INSERTABLE_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_ordered_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_insertable_i_i_as_ordered((void *) 1, NULL),
            BUTTERFLYFISH_INSERTABLE_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_as_ordered(void **state) {
    ...
    assert_int_equal(butterflyfish_insertable_i_i_as_ordered(
            (const struct butterflyfish_insertable_i_i *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_count_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_insertable_i_i_count(NULL, (void *) 1),
            BUTTERFLYFISH_INSERTABLE_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_count_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_insertable_i_i_count((void *) 1, NULL),
            BUTTERFLYFISH_INSERTABLE_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_count(void **state) {
    ...
    uintmax_t out;
    assert_int_equal(butterflyfish_insertable_i_i_count(
            (const struct butterflyfish_insertable_i_i *) &instance, &out), 0);
...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_insertable_i_i_first(NULL, (void *) 1),
            BUTTERFLYFISH_INSERTABLE_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_first_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_insertable_i_i_first((void *) 1, NULL),
            BUTTERFLYFISH_INSERTABLE_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_insertable_i_i_last(NULL, (void *) 1),
            BUTTERFLYFISH_INSERTABLE_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_last_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_insertable_i_i_last((void *) 1, NULL),
            BUTTERFLYFISH_INSERTABLE_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_last_error_on_ordered_is_empty(void **state) {
    ...
    assert_int_equal(
            butterflyfish_insertable_i_i_last(
                    (const struct butterflyfish_insertable_i_i *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_INSERTABLE_I_I_ERROR_INSERTABLE_IS_EMPTY);
}
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_insertable_i_i_next(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_INSERTABLE_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_next_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_insertable_i_i_next((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_INSERTABLE_I_I_ERROR_ITEM_IS_NULL);
}

static void check_next_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_insertable_i_i_next((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_INSERTABLE_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_next_error_on_end_of_sequence(void **state) {
    ...
    assert_int_equal(
            butterflyfish_insertable_i_i_next(
                    (const struct butterflyfish_insertable_i_i *) &instance,
                    (void *) 1,
                    (void *) 1),
...
static void check_prev_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_insertable_i_i_prev(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_INSERTABLE_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_prev_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_insertable_i_i_prev((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_INSERTABLE_I_I_ERROR_ITEM_IS_NULL);
}

static void check_prev_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_insertable_i_i_prev((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_INSERTABLE_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_prev_error_on_end_of_sequence(void **state) {
    ...
    assert_int_equal(
            butterflyfish_insertable_i_i_prev(
                    (const struct butterflyfish_insertable_i_i *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_INSERTABLE_I_I_ERROR_END_OF_SEQUENCE);
...
static void check_insert_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_insertable_i_i_insert(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_INSERTABLE_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_insert_error_on_value_is_invalid(void **state) {
    ...
    assert_int_equal(
            butterflyfish_insertable_i_i_insert(
                    (struct butterflyfish_insertable_i_i *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_INSERTABLE_I_I_ERROR_VALUE_IS_INVALID);
}
...
static void check_insert_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_insertable_i_i_insert_all(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_INSERTABLE_I_I_ERROR_OBJECT_IS_NULL);
}
