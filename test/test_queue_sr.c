...
static void check_as_stream_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_queue_sr_as_stream(NULL, (void *) 1),
            BUTTERFLYFISH_QUEUE_SR_ERROR_OBJECT_IS_NULL);
}

static void check_as_stream_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_queue_sr_as_stream((void *) 1, NULL),
            BUTTERFLYFISH_QUEUE_SR_ERROR_OUT_IS_NULL);
}

static void check_as_stream(void **state) {
    struct butterflyfish_queue_sr queue = {};
    const struct butterflyfish_stream_sr *stream;
    assert_int_equal(butterflyfish_queue_sr_as_stream(&queue, &stream), 0);
    assert_ptr_equal(&queue, stream);
}

static void check_as_collection_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_queue_sr_as_collection(NULL, (void *) 1),
            BUTTERFLYFISH_QUEUE_SR_ERROR_OBJECT_IS_NULL);
}

static void check_as_collection_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_queue_sr_as_collection((void *) 1, NULL),
            BUTTERFLYFISH_QUEUE_SR_ERROR_OUT_IS_NULL);
}
...
static void check_as_collection(void **state) {
    ...
    assert_int_equal(butterflyfish_queue_sr_as_collection(
            &queue, &collection), 0);
...
static void check_as_reducible_queue_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_queue_sr_as_reducible_queue(NULL, (void *) 1),
            BUTTERFLYFISH_QUEUE_SR_ERROR_OBJECT_IS_NULL);
}

static void check_as_reducible_queue_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_queue_sr_as_reducible_queue((void *) 1, NULL),
            BUTTERFLYFISH_QUEUE_SR_ERROR_OUT_IS_NULL);
}

static void check_as_reducible_queue(void **state) {
    struct butterflyfish_queue_sr queue = {};
    struct butterflyfish_reducible_queue_sr *reducible_queue;
    assert_int_equal(butterflyfish_queue_sr_as_reducible_queue(
...
static void check_count_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_queue_sr_count(NULL, (void *) 1),
            BUTTERFLYFISH_QUEUE_SR_ERROR_OBJECT_IS_NULL);
}

static void check_count_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_queue_sr_count((void *) 1, NULL),
            BUTTERFLYFISH_QUEUE_SR_ERROR_OUT_IS_NULL);
}
...
static void check_count(void **state) {
    srand(time(NULL));
    const struct butterflyfish_queue_sr queue_sr = {
            .reducible_queue_sr.collection_sr.count = count
    };
    struct object {
        const struct butterflyfish_queue_sr *queue_sr;
    };
    ...
    uintmax_t out;
    assert_int_equal(
            butterflyfish_queue_sr_count(
                    (const struct butterflyfish_queue_sr *) &instance,
                    &out),
            0);
...
static void check_as_reducible_queue_count(void **state) {
    ...
    uintmax_t out;
    assert_int_equal(
            butterflyfish_reducible_queue_sr_count(
...
static void check_first_error_on_queue_is_empty(void **state) {
    const struct butterflyfish_queue_sr queue_sr = {
            .reducible_queue_sr.collection_sr.stream_sr.first = fl_emit_error
    };
    struct object {
        const struct butterflyfish_queue_sr *queue_sr;
    };
    ...
    will_return(fl_emit_error,
                BUTTERFLYFISH_QUEUE_SR_ERROR_QUEUE_IS_EMPTY);
    assert_int_equal(
            butterflyfish_queue_sr_first(
                    (const struct butterflyfish_queue_sr *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_QUEUE_SR_ERROR_QUEUE_IS_EMPTY);
}
...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_queue_sr_first(NULL, (void *) 1),
            BUTTERFLYFISH_QUEUE_SR_ERROR_OBJECT_IS_NULL);
}

static void check_first_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_queue_sr_first((void *) 1, NULL),
            BUTTERFLYFISH_QUEUE_SR_ERROR_OUT_IS_NULL);
}

static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_queue_sr_last(NULL, (void *) 1),
            BUTTERFLYFISH_QUEUE_SR_ERROR_OBJECT_IS_NULL);
}

static void check_last_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_queue_sr_last((void *) 1, NULL),
            BUTTERFLYFISH_QUEUE_SR_ERROR_OUT_IS_NULL);
}

static void check_last_error_on_queue_is_empty(void **state) {
    const struct butterflyfish_queue_sr queue_sr = {
            .reducible_queue_sr.collection_sr.last = fl_emit_error
    };
    struct object {
        const struct butterflyfish_queue_sr *queue_sr;
    };
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_queue_sr_next(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_QUEUE_SR_ERROR_OBJECT_IS_NULL);
}

static void check_next_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_queue_sr_next((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_QUEUE_SR_ERROR_ITEM_IS_NULL);
}

static void check_next_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_queue_sr_next((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_QUEUE_SR_ERROR_OUT_IS_NULL);
}
...
static void check_next_error_on_end_of_sequence(void **state) {
    const struct butterflyfish_queue_sr queue_sr = {
            .reducible_queue_sr.collection_sr.stream_sr.next = np_emit_error
    };
    struct object {
        const struct butterflyfish_queue_sr *queue_sr;
    };
    ...
    will_return(np_emit_error,
                BUTTERFLYFISH_QUEUE_SR_ERROR_END_OF_SEQUENCE);
    assert_int_equal(
            butterflyfish_queue_sr_next(
                    (const struct butterflyfish_queue_sr *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_QUEUE_SR_ERROR_END_OF_SEQUENCE);
...
static void check_prev_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_queue_sr_prev(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_QUEUE_SR_ERROR_OBJECT_IS_NULL);
}

static void check_prev_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_queue_sr_prev((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_QUEUE_SR_ERROR_ITEM_IS_NULL);
}

static void check_prev_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_queue_sr_prev((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_QUEUE_SR_ERROR_OUT_IS_NULL);
}

static void check_prev_error_on_end_of_sequence(void **state) {
    const struct butterflyfish_queue_sr queue_sr = {
            .reducible_queue_sr.collection_sr.prev = np_emit_error
    };
    struct object {
        const struct butterflyfish_queue_sr *queue_sr;
    };
...
static void check_remove_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_queue_sr_remove(NULL, (void *) 1),
            BUTTERFLYFISH_QUEUE_SR_ERROR_OBJECT_IS_NULL);
}

static void check_remove_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_queue_sr_remove((void *) 1, NULL),
            BUTTERFLYFISH_QUEUE_SR_ERROR_OUT_IS_NULL);
}
...
static void check_remove_error_on_queue_is_empty(void **state) {
    const struct butterflyfish_queue_sr queue_sr = {
            .reducible_queue_sr.remove = remove_emit_error
    };
    struct object {
        const struct butterflyfish_queue_sr *queue_sr;
    };
    ...
    will_return(remove_emit_error,
                BUTTERFLYFISH_QUEUE_SR_ERROR_QUEUE_IS_EMPTY);
    assert_int_equal(
            butterflyfish_queue_sr_remove(
                    (struct butterflyfish_queue_sr *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_QUEUE_SR_ERROR_QUEUE_IS_EMPTY);
}
...
static void check_add_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_queue_sr_add(NULL, (void *) 1),
            BUTTERFLYFISH_QUEUE_SR_ERROR_OBJECT_IS_NULL);
}

static void check_add_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_queue_sr_add((void *) 1, NULL),
            BUTTERFLYFISH_QUEUE_SR_ERROR_VALUE_IS_NULL);
}
...
static void check_add_error_on_memory_allocation_failed(void **state) {
    ...
    will_return(add_emit_error,
                BUTTERFLYFISH_QUEUE_SR_ERROR_MEMORY_ALLOCATION_FAILED);
    assert_int_equal(
            butterflyfish_queue_sr_add(
                    (struct butterflyfish_queue_sr *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_QUEUE_SR_ERROR_MEMORY_ALLOCATION_FAILED);
}
...
static void check_add_error_on_value_is_invalid(void **state) {
    ...
    expect_function_call(add_emit_error);
    will_return(add_emit_error,
                BUTTERFLYFISH_QUEUE_SR_ERROR_VALUE_IS_INVALID);
    assert_int_equal(
            butterflyfish_queue_sr_add(
                    (struct butterflyfish_queue_sr *) &instance,
                    (void *) 1),
...
static void check_add_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_queue_sr_add_all(NULL, (void *) 1),
            BUTTERFLYFISH_QUEUE_SR_ERROR_OBJECT_IS_NULL);
}

static void check_add_all_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_queue_sr_add_all((void *) 1, NULL),
            BUTTERFLYFISH_QUEUE_SR_ERROR_OTHER_IS_NULL);
}
...
static void check_add_all_error_on_memory_allocation_failed(void **state) {
    ...
    will_return(add_all_emit_error,
                BUTTERFLYFISH_QUEUE_SR_ERROR_MEMORY_ALLOCATION_FAILED);
    assert_int_equal(
            butterflyfish_queue_sr_add_all(
                    (struct butterflyfish_queue_sr *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_QUEUE_SR_ERROR_MEMORY_ALLOCATION_FAILED);
}
