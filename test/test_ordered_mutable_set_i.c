...
settable_set_as_settable(
        struct butterflyfish_settable_set_i *const object,
...
static int insertable_as_ordered(
        const struct butterflyfish_insertable_i *const object,
        const struct butterflyfish_ordered_i **const out) {
    assert_non_null(object);
    assert_non_null(out);
...
settable_reducible_set_as_settable_set(
    ...
    assert_non_null(out);
    *out = butterflyfish_cast(object, struct object,
            settable_reducible_set_i, settable_set_i);
    return 0;
}
...
settable_reducible_set_as_reducible_set(
    ...
    assert_non_null(out);
    *out = butterflyfish_cast(object, struct object,
            settable_reducible_set_i, reducible_set_i);
    return 0;
}
...
static void check_as_stream_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_as_stream(
                    NULL, (void *) 1),
...
static void check_as_stream(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_mutable_set_i_as_stream(
            (const struct butterflyfish_ordered_mutable_set_i *) &instance,
                    &out), 0);
...
static void check_as_collection_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_as_collection(
                    NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_collection(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_mutable_set_i_as_collection(
            (const struct butterflyfish_ordered_mutable_set_i *) &instance,
                    &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_addable_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_as_addable(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_addable_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_as_addable((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MUTABLE_SET_I_ERROR_OUT_IS_NULL);
}
...
static void check_as_addable(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_mutable_set_i_as_addable(
            (struct butterflyfish_ordered_mutable_set_i *) &instance,
            &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_removable_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_as_removable(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_removable_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_as_removable((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MUTABLE_SET_I_ERROR_OUT_IS_NULL);
}
...
static void check_as_removable(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_mutable_set_i_as_removable(
            (struct butterflyfish_ordered_mutable_set_i *) &instance,
            &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_settable_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_as_settable(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_settable_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_as_settable((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MUTABLE_SET_I_ERROR_OUT_IS_NULL);
}
...
static void check_as_settable(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_mutable_set_i_as_settable(
            (struct butterflyfish_ordered_mutable_set_i *) &instance,
            &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_ordered_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_as_ordered(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_ordered_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_as_ordered((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MUTABLE_SET_I_ERROR_OUT_IS_NULL);
}
...
static void check_as_ordered(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_mutable_set_i_as_ordered(
            (const struct butterflyfish_ordered_mutable_set_i *) &instance,
            &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_as_set(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_set_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_as_set((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MUTABLE_SET_I_ERROR_OUT_IS_NULL);
}
...
static void check_as_set(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_mutable_set_i_as_set(
            (const struct butterflyfish_ordered_mutable_set_i *) &instance,
            &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_settable_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_as_settable_set(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_settable_set_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_as_settable_set((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MUTABLE_SET_I_ERROR_OUT_IS_NULL);
}
...
static void check_as_settable_set(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_mutable_set_i_as_settable_set(
            (struct butterflyfish_ordered_mutable_set_i *) &instance,
            &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_incremental_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_as_incremental_set(
                    NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_incremental_set(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_mutable_set_i_as_incremental_set(
            (struct butterflyfish_ordered_mutable_set_i *) &instance,
            &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_reducible_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_as_reducible_set(
                    NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_reducible_set(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_mutable_set_i_as_reducible_set(
            (struct butterflyfish_ordered_mutable_set_i *) &instance,
            &out), 0);
    assert_ptr_equal(out, check);
}
...
check_as_settable_incremental_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_as_settable_incremental_set(
                    NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_settable_incremental_set(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_mutable_set_i_as_settable_incremental_set(
            (struct butterflyfish_ordered_mutable_set_i *) &instance,
            &out), 0);
    assert_ptr_equal(out, check);
}
...
check_as_settable_reducible_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_as_settable_reducible_set(
                    NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_settable_reducible_set(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_mutable_set_i_as_settable_reducible_set(
            (struct butterflyfish_ordered_mutable_set_i *) &instance,
            &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_mutable_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_as_mutable_set(
                    NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_mutable_set(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_mutable_set_i_as_mutable_set(
            (struct butterflyfish_ordered_mutable_set_i *) &instance,
            &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_ordered_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_as_ordered_set(
                    NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_ordered_set(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_mutable_set_i_as_ordered_set(
            (const struct butterflyfish_ordered_mutable_set_i *) &instance,
            &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_insertable_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_as_insertable(
                    NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_insertable(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_mutable_set_i_as_insertable(
            (struct butterflyfish_ordered_mutable_set_i *) &instance,
            &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_ordered_settable_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_as_ordered_settable_set(
                    NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_ordered_settable_set(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_mutable_set_i_as_ordered_settable_set(
            (struct butterflyfish_ordered_mutable_set_i *) &instance,
            &out), 0);
    assert_ptr_equal(out, check);
}
...
check_as_ordered_incremental_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_as_ordered_incremental_set(
                    NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
check_as_ordered_reducible_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_as_ordered_reducible_set(
                    NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
check_as_ordered_settable_incremental_set_error_on_object_is_null(
        void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_as_ordered_settable_incremental_set(
                    NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
check_as_ordered_settable_reducible_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_as_ordered_settable_reducible_set(
                    NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL);
}
    ...
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_as_ordered_settable_reducible_set(
                    (struct butterflyfish_ordered_mutable_set_i *)
                            &instance, &as), 0);
    struct butterflyfish_settable_reducible_set_i *out;
    assert_int_equal(butterflyfish_ordered_settable_reducible_set_i_as_settable_reducible_set(
            as, &out), 0);
    assert_ptr_equal(out, check);
}
    ...
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_as_ordered_settable_incremental_set(
                    (struct butterflyfish_ordered_mutable_set_i *)
                            &instance, &as), 0);
    struct butterflyfish_settable_incremental_set_i *out;
    assert_int_equal(butterflyfish_ordered_settable_incremental_set_i_as_settable_incremental_set(
            as, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_ordered_set_as_set(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_as_ordered_set(
                    (const struct butterflyfish_ordered_mutable_set_i *)
                            &instance, &as), 0);
    const struct butterflyfish_set_i *out;
...
static void check_settable_set_as_set(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_as_settable_set(
                    (struct butterflyfish_ordered_mutable_set_i *)
                            &instance, &as), 0);
    const struct butterflyfish_set_i *out;
...
static void check_count_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_count(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_count_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_count((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MUTABLE_SET_I_ERROR_OUT_IS_NULL);
}
...
static void check_count(void **state) {
    ...
    uintmax_t out;
    assert_int_equal(butterflyfish_ordered_mutable_set_i_count(
            (const struct butterflyfish_ordered_mutable_set_i *) &instance,
                    &out), 0);
...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_first(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_first_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_first((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MUTABLE_SET_I_ERROR_OUT_IS_NULL);
}
...
static void check_first_error_on_set_is_empty(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_first(
                    (const struct butterflyfish_ordered_mutable_set_i *) &instance,
                    (void *) 1),
...
static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_last(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_last_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_last((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MUTABLE_SET_I_ERROR_OUT_IS_NULL);
}
...
static void check_last_error_on_set_is_empty(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_last(
                    (const struct butterflyfish_ordered_mutable_set_i *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_SET_I_ERROR_SET_IS_EMPTY);
}
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_next(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_prev_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_prev(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_contains_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_contains(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_contains_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_contains_all(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_get_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_get(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_set_item_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_set_item(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_set(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_add_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_add(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_add_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_add((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MUTABLE_SET_I_ERROR_VALUE_IS_NULL);
}
...
static void check_add_error_on_value_already_exits(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_add(
                    (struct butterflyfish_ordered_mutable_set_i *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_SET_I_ERROR_VALUE_ALREADY_EXISTS);
}
...
static void check_add_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_add_all(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_add_all_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_add_all((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MUTABLE_SET_I_ERROR_OTHER_IS_NULL);
}
...
static void check_add_all_error_on_memory_allocation_failed(void **state) {
    ...
    will_return(addable_add_all,
                BUTTERFLYFISH_ADDABLE_I_ERROR_MEMORY_ALLOCATION_FAILED);
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_add_all(
                    (struct butterflyfish_ordered_mutable_set_i *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_SET_I_ERROR_MEMORY_ALLOCATION_FAILED);
}
...
static void check_insert_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_insert(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_insert_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_insert_all(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_remove_item_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_remove_item(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_remove_item_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_remove_item((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MUTABLE_SET_I_ERROR_ITEM_IS_NULL);
}
...
static void check_remove_item(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_remove_item(
                    (struct butterflyfish_ordered_mutable_set_i *) &instance,
                    (void *) 1), 0);
}
...
static void check_remove_all_items_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_remove_all_items(
                    NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_remove_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_remove(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_remove_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_remove((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MUTABLE_SET_I_ERROR_VALUE_IS_NULL);
}
...
static void check_remove_error_on_value_not_found(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_remove(
                    (struct butterflyfish_ordered_mutable_set_i *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_SET_I_ERROR_VALUE_NOT_FOUND);
}
...
static void check_remove_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_remove_all(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_remove_all_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_remove_all((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MUTABLE_SET_I_ERROR_OTHER_IS_NULL);
}
...
static void check_remove_all_error_on_memory_allocation_failed(void **state) {
    ...
    will_return(reducible_set_remove_all,
                BUTTERFLYFISH_REDUCIBLE_SET_I_ERROR_MEMORY_ALLOCATION_FAILED);
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_remove_all(
                    (struct butterflyfish_ordered_mutable_set_i *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_SET_I_ERROR_MEMORY_ALLOCATION_FAILED);
}
...
static void check_retain_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_retain_all(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL);
}

static void check_retain_all_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_retain_all((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MUTABLE_SET_I_ERROR_OTHER_IS_NULL);
}
...
static void check_retain_all_error_on_memory_allocation_failed(void **state) {
    ...
    will_return(reducible_set_retain_all,
                BUTTERFLYFISH_REDUCIBLE_SET_I_ERROR_MEMORY_ALLOCATION_FAILED);
    assert_int_equal(
            butterflyfish_ordered_mutable_set_i_retain_all(
                    (struct butterflyfish_ordered_mutable_set_i *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_ORDERED_MUTABLE_SET_I_ERROR_MEMORY_ALLOCATION_FAILED);
}
