...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_stream_i_first(NULL, (void *) 1),
            BUTTERFLYFISH_STREAM_I_ERROR_OBJECT_IS_NULL);
}

static void check_first_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_stream_i_first((void *) 1, NULL),
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_stream_i_next(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_STREAM_I_ERROR_OBJECT_IS_NULL);
}

static void check_next_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_stream_i_next((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_STREAM_I_ERROR_ITEM_IS_NULL);
}

static void check_next_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_stream_i_next((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_STREAM_I_ERROR_OUT_IS_NULL);
}
