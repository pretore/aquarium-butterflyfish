...
struct instance {
    const struct butterflyfish_settable_reducible_map_i_i *const id;
    void *data;
};
...
static int stream_first(const void *const object,
    ...
    seagrass_required_true(&settable_reducible_map_i_i == instance->id);
    return mock();
}
...
static void check_as_stream(void **state) {
    assert_ptr_equal(settable_reducible_map_i_i.as_stream, &stream_i_i);
}

static void check_as_collection(void **state) {
    assert_ptr_equal(settable_reducible_map_i_i.as_collection, &collection_i_i);
}

static void check_as_set(void **state) {
    assert_ptr_equal(settable_reducible_map_i_i.as_set, &set_i_i);
}

static void check_as_removable(void **state) {
    assert_ptr_equal(settable_reducible_map_i_i.as_removable, &removable_i_i);
}

static void check_as_settable(void **state) {
    assert_ptr_equal(settable_reducible_map_i_i.as_settable, &settable_i_i);
}

static void check_as_map(void **state) {
    assert_ptr_equal(settable_reducible_map_i_i.as_map, &map_i_i);
}

static void check_as_settable_map(void **state) {
    assert_ptr_equal(settable_reducible_map_i_i.as_settable_map, &settable_map_i_i);
}

static void check_as_reducible_map(void **state) {
    assert_ptr_equal(settable_reducible_map_i_i.as_reducible_map, &reducible_map_i_i);
}

static void check_count_error_on_object_is_null(void **state) {
    assert_int_equal(settable_reducible_map_i_i.count(NULL, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_count_error_on_out_is_null(void **state) {
    assert_int_equal(settable_reducible_map_i_i.count((void *) 1, NULL),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_OUT_IS_NULL);
}

static void check_count(void **state) {
    srand(time(NULL));
    struct instance instance = {
            .id = &settable_reducible_map_i_i,
    };
...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(settable_reducible_map_i_i.first(NULL, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_first_error_on_out_is_null(void **state) {
    assert_int_equal(settable_reducible_map_i_i.first((void *) 1, NULL),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_first_error_on_map_is_empty(void **state) {
    ...
    assert_int_equal(instance.id->first(&instance, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_MAP_IS_EMPTY);
}

static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(settable_reducible_map_i_i.last(NULL, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_last_error_on_out_is_null(void **state) {
    assert_int_equal(settable_reducible_map_i_i.last((void *) 1, NULL),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(settable_reducible_map_i_i.next(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_next_error_on_item_is_null(void **state) {
    assert_int_equal(settable_reducible_map_i_i.next((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_ITEM_IS_NULL);
}

static void check_next_error_on_out_is_null(void **state) {
    assert_int_equal(settable_reducible_map_i_i.next((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_next_error_on_end_of_sequence(void **state) {
    ...
    assert_int_equal(instance.id->next(&instance, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_END_OF_SEQUENCE);
}

static void check_prev_error_on_object_is_null(void **state) {
    assert_int_equal(settable_reducible_map_i_i.prev(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_prev_error_on_item_is_null(void **state) {
    assert_int_equal(settable_reducible_map_i_i.prev((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_ITEM_IS_NULL);
}

static void check_prev_error_on_out_is_null(void **state) {
    assert_int_equal(settable_reducible_map_i_i.prev((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_contains_key_error_on_object_is_null(void **state) {
    assert_int_equal(settable_reducible_map_i_i.contains_key(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_contains_key_error_on_key_is_null(void **state) {
    assert_int_equal(settable_reducible_map_i_i.contains_key((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_KEY_IS_NULL);
}

static void check_contains_key_error_on_out_is_null(void **state) {
    assert_int_equal(settable_reducible_map_i_i.contains_key((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_contains_key_error_on_memory_allocation_failed(void **state) {
    ...
    assert_int_equal(settable_reducible_map_i_i.contains_key(&instance, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_MEMORY_ALLOCATION_FAILED);
}

static void check_contains_value_error_on_object_is_null(void **state) {
    assert_int_equal(settable_reducible_map_i_i.contains_value(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_contains_value_error_on_value_is_null(void **state) {
    assert_int_equal(settable_reducible_map_i_i.contains_value((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_VALUE_IS_NULL);
}

static void check_contains_value_error_on_out_is_null(void **state) {
    assert_int_equal(settable_reducible_map_i_i.contains_value((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_contains_value_error_on_memory_allocation_failed(void **state) {
    ...
    will_return(map_contains_value,
                BUTTERFLYFISH_MAP_I_I_ERROR_MEMORY_ALLOCATION_FAILED);
    assert_int_equal(settable_reducible_map_i_i.contains_value(&instance, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_MEMORY_ALLOCATION_FAILED);
}

static void check_get_error_on_object_is_null(void **state) {
    assert_int_equal(settable_reducible_map_i_i.get(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_get_error_on_entry_is_null(void **state) {
    assert_int_equal(settable_reducible_map_i_i.get((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_ENTRY_IS_NULL);
}

static void check_get_error_on_out_is_null(void **state) {
    assert_int_equal(settable_reducible_map_i_i.get((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_get_error_on_entry_not_found(void **state) {
    ...
    assert_int_equal(instance.id->get(&instance, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_KEY_NOT_FOUND);
}
...
static void check_get_entry_error_on_object_is_null(void **state) {
    assert_int_equal(settable_reducible_map_i_i.get_entry(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_get_entry_error_on_key_is_null(void **state) {
    assert_int_equal(settable_reducible_map_i_i.get_entry((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_KEY_IS_NULL);
}

static void check_get_entry_error_on_out_is_null(void **state) {
    assert_int_equal(settable_reducible_map_i_i.get_entry((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_set_error_on_object_is_null(void **state) {
    assert_int_equal(settable_reducible_map_i_i.set(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_set_error_on_key_is_null(void **state) {
    assert_int_equal(settable_reducible_map_i_i.set((void *) 1, NULL,(void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_KEY_IS_NULL);
}

static void check_set_error_on_value_is_null(void **state) {
    assert_int_equal(settable_reducible_map_i_i.set((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_VALUE_IS_NULL);
}
...
static void check_set_error_on_value_is_invalid(void **state) {
    ...
    assert_int_equal(instance.id->set(&instance, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_VALUE_IS_INVALID);
}
...
static void check_set_key_error_on_object_is_null(void **state) {
    assert_int_equal(settable_reducible_map_i_i.set_key(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_set_key_error_on_key_is_null(void **state) {
    assert_int_equal(settable_reducible_map_i_i.set_key((void *) 1, NULL,(void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_KEY_IS_NULL);
}

static void check_set_key_error_on_value_is_null(void **state) {
    assert_int_equal(settable_reducible_map_i_i.set_key((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_VALUE_IS_NULL);
}
...
static void check_set_key_error_on_key_already_exists(void **state) {
    ...
    assert_int_equal(instance.id->set_key(&instance, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_KEY_ALREADY_EXISTS);
}
...
static void check_set_entry_error_on_object_is_null(void **state) {
    assert_int_equal(settable_reducible_map_i_i.set_entry(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_set_entry_error_on_key_is_null(void **state) {
    assert_int_equal(settable_reducible_map_i_i.set_entry((void *) 1, NULL,(void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_KEY_IS_NULL);
}

static void check_set_entry_error_on_value_is_null(void **state) {
    assert_int_equal(settable_reducible_map_i_i.set_entry((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_VALUE_IS_NULL);
}
...
static void check_set_entry_error_on_value_is_invalid(void **state) {
    ...
    will_return(settable_set_item,
                BUTTERFLYFISH_SETTABLE_I_I_ERROR_VALUE_IS_INVALID);
    assert_int_equal(settable_reducible_map_i_i.set_entry(&instance,(void *) 1, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_VALUE_IS_INVALID);
}
...
static void check_remove_error_on_object_is_null(void **state) {
    assert_int_equal(settable_reducible_map_i_i.remove(NULL, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_remove_error_on_key_is_null(void **state) {
    assert_int_equal(settable_reducible_map_i_i.remove((void *) 1, NULL),
                     BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_KEY_IS_NULL);
}
...
static void check_keys(void **state) {
    assert_int_equal(settable_reducible_map_i_i.keys, (void *) 1);
}

static void check_values(void **state) {
    assert_int_equal(settable_reducible_map_i_i.values, (void *) 1);
}
