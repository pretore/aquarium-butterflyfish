...
static void check_as_stream_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_p_p_as_stream(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_P_P_ERROR_OBJECT_IS_NULL);
}

static void check_as_stream_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_p_p_as_stream((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_MAP_P_P_ERROR_OUT_IS_NULL);
}

static void check_as_stream(void **state) {
    struct butterflyfish_sorted_map_p_p sorted_map = {};
    const struct butterflyfish_stream_p_p *stream;
    assert_int_equal(butterflyfish_sorted_map_p_p_as_stream(
            &sorted_map, &stream), 0);
...
static void check_as_collection_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_p_p_as_collection(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_P_P_ERROR_OBJECT_IS_NULL);
}

static void check_as_collection_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_p_p_as_collection((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_MAP_P_P_ERROR_OUT_IS_NULL);
}
...
static void check_as_collection(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_map_p_p_as_collection(
...
static void check_as_map_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_p_p_as_map(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_P_P_ERROR_OBJECT_IS_NULL);
}

static void check_as_map_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_p_p_as_map((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_MAP_P_P_ERROR_OUT_IS_NULL);
}
...
static void check_as_map(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_map_p_p_as_map(
            &sorted_map, &map), 0);
...
static void check_as_ordered_map_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_p_p_as_ordered_map(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_MAP_P_P_ERROR_OBJECT_IS_NULL);
}

static void check_as_ordered_map_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_map_p_p_as_ordered_map((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_MAP_P_P_ERROR_OUT_IS_NULL);
}
...
static void check_as_ordered_map(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_map_p_p_as_ordered_map(
...
static void check_count(void **state) {
    ...
    const struct butterflyfish_sorted_map_p_p sorted_map_p_p = {
            .ordered_map_p_p.map_p_p.collection_p_p.count = count
    };
    struct object {
        const struct butterflyfish_sorted_map_p_p *sorted_map_p_p;
    };
    ...
    uintmax_t out;
    assert_int_equal(
            butterflyfish_sorted_map_p_p_count(
...
static void check_remove_entry(void **state) {
    const struct butterflyfish_sorted_map_p_p sorted_map_p_p = {
            .ordered_map_p_p.map_p_p.remove_entry = remove_entry
    };
    struct object {
        const struct butterflyfish_sorted_map_p_p *sorted_map_p_p;
    };
    ...
    assert_int_equal(
            butterflyfish_sorted_map_p_p_remove_entry(
...
static void check_remove_all_entries(void **state) {
    const struct butterflyfish_sorted_map_p_p sorted_map_p_p = {
            .ordered_map_p_p.map_p_p.remove_all_entries = remove_all_entries
    };
    struct object {
        const struct butterflyfish_sorted_map_p_p *sorted_map_p_p;
    };
    ...
    assert_int_equal(
            butterflyfish_sorted_map_p_p_remove_all_entries(
                    (struct butterflyfish_sorted_map_p_p *) &instance,
                    (void *) 1),
            0);
}
...
static void check_keys(void **state) {
    ...
    assert_int_equal(
            butterflyfish_sorted_map_p_p_keys(
                    (struct butterflyfish_sorted_map_p_p *) &instance,
                    (void *) 1),
            0);
}
...
static void check_values(void **state) {
    const struct butterflyfish_sorted_map_p_p sorted_map_p_p = {
            .ordered_map_p_p.map_p_p.values = values
    };
    struct object {
        const struct butterflyfish_sorted_map_p_p *sorted_map_p_p;
    };
    ...
    assert_int_equal(
            butterflyfish_sorted_map_p_p_values(
                    (struct butterflyfish_sorted_map_p_p *) &instance,
                    (void *) 1),
            0);
}
