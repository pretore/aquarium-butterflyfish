...
struct object {
    const struct butterflyfish_sorted_settable_incremental_list_i_i *const
            sorted_settable_incremental_list_i_i;
    const struct butterflyfish_settable_incremental_list_i_i *const
            settable_incremental_list_i_i;
    const struct butterflyfish_sorted_incremental_list_i_i *const
            sorted_incremental_list_i_i;
    const struct butterflyfish_sorted_settable_list_i_i *const
            sorted_settable_list_i_i;
    ...
    const struct butterflyfish_sorted_list_i_i *const sorted_list_i_i;
...
static int
sorted_as_collection(const struct butterflyfish_sorted_i_i *object,
...
static int
sorted_list_as_sorted(const struct butterflyfish_sorted_list_i_i *const object,
                      const struct butterflyfish_sorted_i_i **const out) {
    assert_non_null(object);
    assert_non_null(out);
    *out = butterflyfish_cast(object, struct object, sorted_list_i_i, sorted_i_i);
    return 0;
}

static int
sorted_list_as_list(const struct butterflyfish_sorted_list_i_i *const object,
                    const struct butterflyfish_list_i_i **const out) {
    assert_non_null(object);
    assert_non_null(out);
    *out = butterflyfish_cast(object, struct object, sorted_list_i_i, list_i_i);
    return 0;
}

const struct butterflyfish_sorted_list_i_i sorted_list_i_i = {
...
sorted_settable_list_as_settable_list(
        struct butterflyfish_sorted_settable_list_i_i *const object,
        struct butterflyfish_settable_list_i_i **const out) {
    assert_non_null(object);
    assert_non_null(out);
    *out = butterflyfish_cast(object, struct object, sorted_settable_list_i_i,
                              settable_list_i_i);
    return 0;
}
...
sorted_settable_list_as_sorted_list(
        const struct butterflyfish_sorted_settable_list_i_i *const object,
        const struct butterflyfish_sorted_list_i_i **const out) {
    assert_non_null(object);
    assert_non_null(out);
    *out = butterflyfish_cast(object, struct object, sorted_settable_list_i_i,
                              sorted_list_i_i);
...
const struct butterflyfish_sorted_settable_list_i_i sorted_settable_list_i_i = {
...
sorted_incremental_list_as_sorted_list(
        const struct butterflyfish_sorted_incremental_list_i_i *const object,
        const struct butterflyfish_sorted_list_i_i **const out) {
    assert_non_null(object);
    assert_non_null(out);
    *out = butterflyfish_cast(object, struct object, sorted_incremental_list_i_i,
            sorted_list_i_i);
    return 0;
}
...
sorted_incremental_list_as_incremental_list(
        struct butterflyfish_sorted_incremental_list_i_i *const object,
...
const struct
butterflyfish_sorted_incremental_list_i_i sorted_incremental_list_i_i = {
...
sorted_settable_incremental_list_as_sorted_incremental_list(
        struct butterflyfish_sorted_settable_incremental_list_i_i *const object,
        struct butterflyfish_sorted_incremental_list_i_i **const out) {
    assert_non_null(object);
    assert_non_null(out);
    *out = butterflyfish_cast(object, struct object,
            sorted_settable_incremental_list_i_i,
...
sorted_settable_incremental_list_as_sorted_settable_list(
        struct butterflyfish_sorted_settable_incremental_list_i_i *const object,
        struct butterflyfish_sorted_settable_list_i_i **const out) {
    assert_non_null(object);
    assert_non_null(out);
    *out = butterflyfish_cast(object, struct object,
            sorted_settable_incremental_list_i_i,
...
const struct
butterflyfish_sorted_settable_incremental_list_i_i
sorted_settable_incremental_list_i_i = {
...
static void check_as_stream_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_list_i_i_as_stream(
                    NULL, (void *) 1),
...
static void check_as_stream_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_list_i_i_as_stream(
                    (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OUT_IS_NULL);
}
...
static void check_as_stream(void **state) {
    const struct object instance = {
            ...
            .sorted_incremental_list_i_i = &sorted_incremental_list_i_i,
            .sorted_settable_list_i_i = &sorted_settable_list_i_i,
            .incremental_list_i_i = &incremental_list_i_i,
            .settable_list_i_i = &settable_list_i_i,
            .sorted_list_i_i = &sorted_list_i_i,
    ...
    assert_int_equal(butterflyfish_sorted_settable_incremental_list_i_i_as_stream(
            (const struct butterflyfish_sorted_settable_incremental_list_i_i *)
                    &instance, &out), 0);
...
static void check_as_collection_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_list_i_i_as_collection(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_collection(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_settable_incremental_list_i_i_as_collection(
            (const struct butterflyfish_sorted_settable_incremental_list_i_i *)
                    &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_sorted_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_list_i_i_as_sorted(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_sorted(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_settable_incremental_list_i_i_as_sorted(
            (const struct butterflyfish_sorted_settable_incremental_list_i_i *)
                    &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_list_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_list_i_i_as_list(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_list(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_settable_incremental_list_i_i_as_list(
            (const struct butterflyfish_sorted_settable_incremental_list_i_i *)
                    &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_settable_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_list_i_i_as_settable(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_settable(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_settable_incremental_list_i_i_as_settable(
...
static void check_as_addable_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_list_i_i_as_addable(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_addable(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_settable_incremental_list_i_i_as_addable(
            (struct butterflyfish_sorted_settable_incremental_list_i_i *)
                    &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_sorted_list_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_list_i_i_as_sorted_list(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_sorted_list(void **state) {
    ...
    const void *check = (char *) &instance
                        + offsetof(struct object, sorted_list_i_i);
    const struct butterflyfish_sorted_list_i_i *out;
    assert_int_equal(butterflyfish_sorted_settable_incremental_list_i_i_as_sorted_list(
            (const struct butterflyfish_sorted_settable_incremental_list_i_i *)
                    &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_settable_list_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_list_i_i_as_settable_list(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_settable_list(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_settable_incremental_list_i_i_as_settable_list(
            (struct butterflyfish_sorted_settable_incremental_list_i_i *)
                    &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_incremental_list_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_list_i_i_as_incremental_list(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_incremental_list(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_settable_incremental_list_i_i_as_incremental_list(
            (struct butterflyfish_sorted_settable_incremental_list_i_i *)
                    &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_sorted_settable_list_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_list_i_i_as_sorted_settable_list(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_sorted_settable_list(void **state) {
    ...
    const void *check = (char *) &instance
                        + offsetof(struct object, sorted_settable_list_i_i);
    struct butterflyfish_sorted_settable_list_i_i *out;
    assert_int_equal(butterflyfish_sorted_settable_incremental_list_i_i_as_sorted_settable_list(
            (struct butterflyfish_sorted_settable_incremental_list_i_i *)
                    &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_sorted_incremental_list_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_list_i_i_as_sorted_incremental_list(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_sorted_incremental_list(void **state) {
    ...
    const void *check = (char *) &instance
                        + offsetof(struct object, sorted_incremental_list_i_i);
    struct butterflyfish_sorted_incremental_list_i_i *out;
    assert_int_equal(butterflyfish_sorted_settable_incremental_list_i_i_as_sorted_incremental_list(
            (struct butterflyfish_sorted_settable_incremental_list_i_i *)
                    &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_settable_incremental_list(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_settable_incremental_list_i_i_as_settable_incremental_list(
            (struct butterflyfish_sorted_settable_incremental_list_i_i *)
                    &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_sorted_incremental_list_as_sorted_list(void **state) {
    ...
    const void *check = (char *) &instance
            + offsetof(struct object, sorted_list_i_i);
    struct butterflyfish_sorted_incremental_list_i_i *as;
    assert_int_equal(butterflyfish_sorted_settable_incremental_list_i_i_as_sorted_incremental_list(
            (struct butterflyfish_sorted_settable_incremental_list_i_i *)
                    &instance, &as), 0);
    const struct butterflyfish_sorted_list_i_i *out;
    assert_int_equal(butterflyfish_sorted_incremental_list_i_i_as_sorted_list(as, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_sorted_list_as_list(void **state) {
    ...
    const void *check = (char *) &instance + offsetof(struct object, list_i_i);
    const struct butterflyfish_sorted_list_i_i *as;
    assert_int_equal(butterflyfish_sorted_settable_incremental_list_i_i_as_sorted_list(
            (struct butterflyfish_sorted_settable_incremental_list_i_i *)
                    &instance, &as), 0);
    const struct butterflyfish_list_i_i *out;
    assert_int_equal(butterflyfish_sorted_list_i_i_as_list(as, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_count_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_list_i_i_count(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_count(void **state) {
    ...
    uintmax_t out;
    assert_int_equal(butterflyfish_sorted_settable_incremental_list_i_i_count(
            (const struct butterflyfish_sorted_settable_incremental_list_i_i *)
                    &instance, &out), 0);
...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_list_i_i_first(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_first_error_on_list_is_empty(void **state) {
    ...
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_list_i_i_first(
                    (const struct butterflyfish_sorted_settable_incremental_list_i_i *)
                            &instance, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_LIST_IS_EMPTY);
}

static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_list_i_i_last(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_list_i_i_next(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_next_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_list_i_i_next(
                    (void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_ITEM_IS_NULL);
}
...
static void check_prev_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_list_i_i_prev(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_get_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_list_i_i_get(
                    NULL, 0, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_at_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_list_i_i_at(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_list_i_i_set(
                    NULL, 0, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_set_item_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_list_i_i_set_item(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_ceiling_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_list_i_i_ceiling(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_floor_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_list_i_i_floor(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_higher_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_list_i_i_higher(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_lower_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_list_i_i_lower(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_add_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_list_i_i_add(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
...
static void check_add_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_list_i_i_add_all(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL);
}
