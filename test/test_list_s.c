...
static void check_as_collection(void **state) {
    ...
    assert_int_equal(butterflyfish_list_s_as_collection(
            &list, &collection), 0);
...
static void check_as_fixed_list_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_s_as_fixed_list(NULL, (void *) 1),
            BUTTERFLYFISH_LIST_S_ERROR_OBJECT_IS_NULL);
}

static void check_as_fixed_list_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_s_as_fixed_list((void *) 1, NULL),
            BUTTERFLYFISH_LIST_S_ERROR_OUT_IS_NULL);
}
...
static void check_as_fixed_list(void **state) {
    ...
    assert_int_equal(butterflyfish_list_s_as_fixed_list(
            &list, &fixed_list), 0);
...
static void check_as_reducible_list_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_s_as_reducible_list(NULL, (void *) 1),
            BUTTERFLYFISH_LIST_S_ERROR_OBJECT_IS_NULL);
}

static void check_as_reducible_list_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_s_as_reducible_list((void *) 1, NULL),
            BUTTERFLYFISH_LIST_S_ERROR_OUT_IS_NULL);
}

static void check_as_reducible_list(void **state) {
    struct butterflyfish_list_s list = {};
    struct butterflyfish_reducible_list_s *reducible_list;
    assert_int_equal(butterflyfish_list_s_as_reducible_list(
