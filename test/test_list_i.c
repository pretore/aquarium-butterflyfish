...
static void check_as_stream(void **state) {
    struct butterflyfish_list_i list = {};
    const struct butterflyfish_stream_i *stream;
    assert_int_equal(butterflyfish_list_i_as_stream(&list, &stream), 0);
...
static void check_as_fixed_list_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_i_as_fixed_list(NULL, (void *) 1),
            BUTTERFLYFISH_LIST_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_fixed_list_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_i_as_fixed_list((void *) 1, NULL),
            BUTTERFLYFISH_LIST_I_ERROR_OUT_IS_NULL);
}
...
static void check_as_fixed_list(void **state) {
    ...
    assert_int_equal(butterflyfish_list_i_as_fixed_list(
            &list, &fixed_list), 0);
...
static void check_as_reducible_list_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_i_as_reducible_list(NULL, (void *) 1),
            BUTTERFLYFISH_LIST_I_ERROR_OBJECT_IS_NULL);
}

static void check_as_reducible_list_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_list_i_as_reducible_list((void *) 1, NULL),
            BUTTERFLYFISH_LIST_I_ERROR_OUT_IS_NULL);
}
...
static void check_as_reducible_list(void **state) {
    ...
    assert_int_equal(butterflyfish_list_i_as_reducible_list(
...
static void check_count(void **state) {
    ...
    const struct butterflyfish_list_i list_i = {
            .reducible_list_i.fixed_list_i.collection_i.count = count
    };
    struct object {
        const struct butterflyfish_list_i *list_i;
    };
...
static void check_count_as_reducible_list(void **state) {
    ...
    const struct butterflyfish_reducible_list_i reducible_list_i = {
            .fixed_list_i.collection_i.count = count
    };
    struct object {
        const struct butterflyfish_reducible_list_i *reducible_list_i;
    };
    ...
    uintmax_t out;
    assert_int_equal(
            butterflyfish_reducible_list_i_count(
...
static void check_set_error_on_value_is_invalid(void **state) {
    ...
    expect_function_call(set_emit_error);
    will_return(set_emit_error,
                BUTTERFLYFISH_LIST_I_ERROR_VALUE_IS_INVALID);
    assert_int_equal(
            butterflyfish_list_i_set(
                    (struct butterflyfish_list_i *) &instance,
                    0,
...
static void check_remove(void **state) {
    const struct butterflyfish_list_i list_i = {
            .reducible_list_i.remove = remove
    };
    struct object {
        const struct butterflyfish_list_i *list_i;
    };
    ...
    assert_int_equal(
            butterflyfish_list_i_remove(
                    (struct butterflyfish_list_i *) &instance, 0),
            0);
}
...
static void check_remove_item(void **state) {
    const struct butterflyfish_list_i list_i = {
            .reducible_list_i.remove_item = remove_item
    };
    struct object {
        const struct butterflyfish_list_i *list_i;
    };
...
static int remove_all_items(void *const object,
                            const struct butterflyfish_stream_i *const stream) {
    function_called();
    assert_non_null(object);
...
static void check_remove_items(void **state) {
    const struct butterflyfish_list_i list_i = {
            .reducible_list_i.remove_all_items = remove_all_items
    };
    struct object {
        const struct butterflyfish_list_i *list_i;
    };
    ...
    assert_int_equal(
            butterflyfish_list_i_remove_all_items(
                    (struct butterflyfish_list_i *) &instance,
                    (void *) 1),
            0);
}
