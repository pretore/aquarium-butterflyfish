#ifndef _BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_H_
#define _BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_H_
...
#define BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL \
    BUTTERFLYFISH_SETTABLE_LIST_I_I_ERROR_OBJECT_IS_NULL
#define BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OUT_IS_NULL \
    BUTTERFLYFISH_SETTABLE_LIST_I_I_ERROR_OUT_IS_NULL
#define BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_LIST_IS_EMPTY \
    BUTTERFLYFISH_SETTABLE_LIST_I_I_ERROR_LIST_IS_EMPTY
#define BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_ITEM_IS_NULL \
    BUTTERFLYFISH_SETTABLE_LIST_I_I_ERROR_ITEM_IS_NULL
#define BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_END_OF_SEQUENCE \
    BUTTERFLYFISH_SETTABLE_LIST_I_I_ERROR_END_OF_SEQUENCE
#define BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_INDEX_IS_OUT_OF_BOUNDS \
    BUTTERFLYFISH_SETTABLE_LIST_I_I_ERROR_INDEX_IS_OUT_OF_BOUNDS
#define BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_ITEM_NOT_FOUND \
    BUTTERFLYFISH_SETTABLE_LIST_I_I_ERROR_ITEM_NOT_FOUND
#define BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_VALUE_IS_NULL \
    BUTTERFLYFISH_SETTABLE_LIST_I_I_ERROR_VALUE_IS_NULL
#define BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_MEMORY_ALLOCATION_FAILED \
    BUTTERFLYFISH_SETTABLE_LIST_I_I_ERROR_MEMORY_ALLOCATION_FAILED
#define BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_VALUE_IS_INVALID \
    BUTTERFLYFISH_SETTABLE_LIST_I_I_ERROR_VALUE_IS_INVALID
#define BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OTHER_IS_NULL \
...
struct butterflyfish_settable_incremental_list_i_i {
    int (*const as_settable_list)(
            struct butterflyfish_settable_incremental_list_i_i *object,
 ...
 * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OUT_IS_NULL if out
 * is <i>NULL</i>.
 */
int butterflyfish_settable_incremental_list_i_i_as_stream(
        const struct butterflyfish_settable_incremental_list_i_i *object,
 ...
 * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OUT_IS_NULL if out
 * is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_LIST_IS_EMPTY if
 * list is empty.
 */
 ...
 * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_ITEM_IS_NULL if
 * item is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OUT_IS_NULL if out
 * is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_END_OF_SEQUENCE if
 ...
 * is <i>NULL</i>.
 * @throws
 * BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_INDEX_IS_OUT_OF_BOUNDS if at
 ...
 * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OUT_IS_NULL if out
 * is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_ITEM_NOT_FOUND if
 ...
 * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_ITEM_IS_NULL if
 * item is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_VALUE_IS_NULL if
 * value is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_VALUE_IS_INVALID
 * if value is invalid.
 * @throws
 ...
 * does not refer to an item contained within the list.
 * @throws
 * BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_MEMORY_ALLOCATION_FAILED if
 ...
 * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OTHER_IS_NULL if
 * other is <i>NULL</i>.
 * @throws
 * BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_MEMORY_ALLOCATION_FAILED if
...
#endif /* _BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_H_ */
