...
struct butterflyfish_settable_incremental_list_i_i {
     ...
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL
     * if object is <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OUT_IS_NULL if
     * out is <i>NULL</i>.
     */
     ...
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OUT_IS_NULL if
     * out is <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_LIST_IS_EMPTY
     * if list is empty.
     */
     ...
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL
     * if object is <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_ITEM_IS_NULL
     * if item is <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OUT_IS_NULL if
     * out is <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_END_OF_SEQUENCE
     ...
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OUT_IS_NULL if
     * out is <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_ITEM_NOT_FOUND
     ...
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_ITEM_IS_NULL
     * if item is <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_VALUE_IS_NULL
     * if value is <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_VALUE_IS_INVALID
     * if value is invalid.
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_VALUE_ALREADY_EXISTS
     * if value is already present.
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_MEMORY_ALLOCATION_FAILED
     ...
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_VALUE_IS_NULL
     * if value is <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_INDEX_IS_OUT_OF_BOUNDS
     * if at does not refer to an item contained within the list.
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_MEMORY_ALLOCATION_FAILED
     * if there is not enough memory to set the item to value.
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_VALUE_IS_INVALID
     ...
     * value is <i>NULL</i>.
     * @throws
     * BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_VALUE_ALREADY_EXISTS if
