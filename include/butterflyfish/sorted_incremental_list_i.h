#ifndef _BUTTERFLYFISH_SORTED_INCREMENTAL_LIST_I_H_
#define _BUTTERFLYFISH_SORTED_INCREMENTAL_LIST_I_H_
...
#define BUTTERFLYFISH_SORTED_INCREMENTAL_LIST_I_ERROR_OBJECT_IS_NULL \
    BUTTERFLYFISH_SORTED_LIST_I_ERROR_OBJECT_IS_NULL
#define BUTTERFLYFISH_SORTED_INCREMENTAL_LIST_I_ERROR_OUT_IS_NULL \
    BUTTERFLYFISH_SORTED_LIST_I_ERROR_OUT_IS_NULL
#define BUTTERFLYFISH_SORTED_INCREMENTAL_LIST_I_ERROR_LIST_IS_EMPTY \
    BUTTERFLYFISH_SORTED_LIST_I_ERROR_LIST_IS_EMPTY
#define BUTTERFLYFISH_SORTED_INCREMENTAL_LIST_I_ERROR_ITEM_IS_NULL \
    BUTTERFLYFISH_SORTED_LIST_I_ERROR_ITEM_IS_NULL
#define BUTTERFLYFISH_SORTED_INCREMENTAL_LIST_I_ERROR_END_OF_SEQUENCE \
    BUTTERFLYFISH_SORTED_LIST_I_ERROR_END_OF_SEQUENCE
#define BUTTERFLYFISH_SORTED_INCREMENTAL_LIST_I_ERROR_INDEX_IS_OUT_OF_BOUNDS \
    BUTTERFLYFISH_SORTED_LIST_I_ERROR_INDEX_IS_OUT_OF_BOUNDS
#define BUTTERFLYFISH_SORTED_INCREMENTAL_LIST_I_ERROR_ITEM_NOT_FOUND \
    BUTTERFLYFISH_SORTED_LIST_I_ERROR_ITEM_NOT_FOUND
#define BUTTERFLYFISH_SORTED_INCREMENTAL_LIST_I_ERROR_VALUE_IS_NULL \
    BUTTERFLYFISH_SORTED_LIST_I_ERROR_VALUE_IS_NULL
#define BUTTERFLYFISH_SORTED_INCREMENTAL_LIST_I_ERROR_VALUE_NOT_FOUND \
    BUTTERFLYFISH_SORTED_LIST_I_ERROR_VALUE_NOT_FOUND
#define BUTTERFLYFISH_SORTED_INCREMENTAL_LIST_I_ERROR_VALUE_IS_INVALID \
    BUTTERFLYFISH_INCREMENTAL_LIST_I_ERROR_VALUE_IS_INVALID
#define BUTTERFLYFISH_SORTED_INCREMENTAL_LIST_I_ERROR_OTHER_IS_NULL \
    BUTTERFLYFISH_INCREMENTAL_LIST_I_ERROR_OTHER_IS_NULL
#define BUTTERFLYFISH_SORTED_INCREMENTAL_LIST_I_ERROR_MEMORY_ALLOCATION_FAILED \
    BUTTERFLYFISH_SORTED_LIST_I_ERROR_MEMORY_ALLOCATION_FAILED

struct butterflyfish_sorted_incremental_list_i {
    int (*const as_sorted_list)(
            const struct butterflyfish_sorted_incremental_list_i *object,
            const struct butterflyfish_sorted_list_i **out);

    int (*const as_incremental_list)(
            struct butterflyfish_sorted_incremental_list_i *object,
 ...
 * @throws BUTTERFLYFISH_SORTED_INCREMENTAL_LIST_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_INCREMENTAL_LIST_I_ERROR_OUT_IS_NULL if out
 * is <i>NULL</i>.
 */
 ...
 * @throws BUTTERFLYFISH_SORTED_INCREMENTAL_LIST_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_INCREMENTAL_LIST_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 */
 ...
 * @throws BUTTERFLYFISH_SORTED_INCREMENTAL_LIST_I_ERROR_OUT_IS_NULL if out
 * is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_INCREMENTAL_LIST_I_ERROR_LIST_IS_EMPTY if
 * list is empty.
 */
 ...
 * @throws BUTTERFLYFISH_SORTED_INCREMENTAL_LIST_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_INCREMENTAL_LIST_I_ERROR_ITEM_IS_NULL if item
 * is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_INCREMENTAL_LIST_I_ERROR_OUT_IS_NULL if out
 * is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_INCREMENTAL_LIST_I_ERROR_END_OF_SEQUENCE if
 ...
 * @throws BUTTERFLYFISH_SORTED_INCREMENTAL_LIST_I_ERROR_OUT_IS_NULL if out
 * is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_INCREMENTAL_LIST_I_ERROR_INDEX_IS_OUT_OF_BOUNDS
 ...
 * @throws BUTTERFLYFISH_SORTED_INCREMENTAL_LIST_I_ERROR_OUT_IS_NULL if out
 * is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_INCREMENTAL_LIST_I_ERROR_ITEM_NOT_FOUND if
 ...
 * @throws BUTTERFLYFISH_SORTED_INCREMENTAL_LIST_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_INCREMENTAL_LIST_I_ERROR_VALUE_IS_NULL if
 * value is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_INCREMENTAL_LIST_I_ERROR_OUT_IS_NULL if out
 * is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_INCREMENTAL_LIST_I_ERROR_VALUE_NOT_FOUND if
 * no value in sorted was equal to or higher than value.
 * @throws
 * BUTTERFLYFISH_SORTED_INCREMENTAL_LIST_I_ERROR_MEMORY_ALLOCATION_FAILED if
 ...
 * @throws BUTTERFLYFISH_SORTED_INCREMENTAL_LIST_I_ERROR_VALUE_IS_INVALID if
 * value is invalid.
 ...
 * @throws BUTTERFLYFISH_SORTED_INCREMENTAL_LIST_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_INCREMENTAL_LIST_I_ERROR_OTHER_IS_NULL if
 * other is <i>NULL</i>.
 * @throws
 * BUTTERFLYFISH_SORTED_INCREMENTAL_LIST_I_ERROR_MEMORY_ALLOCATION_FAILED if
...
#endif /* _BUTTERFLYFISH_SORTED_INCREMENTAL_LIST_I_H_ */
