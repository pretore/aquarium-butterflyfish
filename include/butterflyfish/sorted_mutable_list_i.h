#ifndef _BUTTERFLYFISH_SORTED_MUTABLE_LIST_I_H_
#define _BUTTERFLYFISH_SORTED_MUTABLE_LIST_I_H_

#include <stddef.h>
#include <stdbool.h>
#include <stdint.h>

#include "sorted_settable_incremental_list_i.h"
#include "sorted_settable_reducible_list_i.h"
#include "mutable_list_i.h"

struct sea_turtle_integer;

#define BUTTERFLYFISH_SORTED_MUTABLE_LIST_I_ERROR_OBJECT_IS_NULL \
    BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_ERROR_OBJECT_IS_NULL
#define BUTTERFLYFISH_SORTED_MUTABLE_LIST_I_ERROR_OUT_IS_NULL \
    BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_ERROR_OUT_IS_NULL
#define BUTTERFLYFISH_SORTED_MUTABLE_LIST_I_ERROR_LIST_IS_EMPTY \
    BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_ERROR_LIST_IS_EMPTY
#define BUTTERFLYFISH_SORTED_MUTABLE_LIST_I_ERROR_ITEM_IS_NULL \
    BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_ERROR_ITEM_IS_NULL
#define BUTTERFLYFISH_SORTED_MUTABLE_LIST_I_ERROR_END_OF_SEQUENCE \
    BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_ERROR_END_OF_SEQUENCE
#define BUTTERFLYFISH_SORTED_MUTABLE_LIST_I_ERROR_INDEX_IS_OUT_OF_BOUNDS \
    BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_ERROR_INDEX_IS_OUT_OF_BOUNDS
#define BUTTERFLYFISH_SORTED_MUTABLE_LIST_I_ERROR_ITEM_NOT_FOUND \
    BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_ERROR_ITEM_NOT_FOUND
#define BUTTERFLYFISH_SORTED_MUTABLE_LIST_I_ERROR_VALUE_IS_NULL \
    BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_ERROR_VALUE_IS_NULL
#define BUTTERFLYFISH_SORTED_MUTABLE_LIST_I_ERROR_MEMORY_ALLOCATION_FAILED \
    BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_ERROR_MEMORY_ALLOCATION_FAILED
#define BUTTERFLYFISH_SORTED_MUTABLE_LIST_I_ERROR_VALUE_IS_INVALID \
    BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_ERROR_VALUE_IS_INVALID
#define BUTTERFLYFISH_SORTED_MUTABLE_LIST_I_ERROR_VALUE_NOT_FOUND \
    BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_ERROR_VALUE_NOT_FOUND
#define BUTTERFLYFISH_SORTED_MUTABLE_LIST_I_ERROR_OTHER_IS_NULL \
    BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_ERROR_OTHER_IS_NULL

struct butterflyfish_sorted_mutable_list_i {
    int (*const as_sorted_settable_incremental_list)(
            struct butterflyfish_sorted_mutable_list_i *object,
            struct butterflyfish_sorted_settable_incremental_list_i **out);

    int (*const as_sorted_settable_reducible_list)(
            struct butterflyfish_sorted_mutable_list_i *object,
...
/**
 * @brief Return sorted mutable list as a stream.
 * @param [in] object sorted mutable list instance.
 * @param [out] out receive stream.
 * @return On success <i>0</i>, otherwise an error code.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_LIST_I_ERROR_OBJECT_IS_NULL if object
 * is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_LIST_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 */
...
/**
 * @brief Return sorted mutable list as a collection.
 * @param [in] object sorted mutable list instance.
...
/**
 * @brief Return sorted mutable list as a sorted.
 * @param [in] object sorted mutable list instance.
...
/**
 * @brief Return sorted mutable list as a settable.
 * @param [in] object sorted mutable list instance.
...
/**
 * @brief Return sorted mutable list as an addable.
 * @param [in] object sorted mutable list instance.
...
/**
 * @brief Return sorted mutable list as a list.
 * @param [in] object sorted mutable list instance.
...
/**
 * @brief Return sorted mutable list as a removable.
 * @param [in] object sorted mutable list instance.
...
/**
 * @brief Return sorted mutable list as a sorted list.
 * @param [in] object sorted mutable list instance.
...
/**
 * @brief Return sorted mutable list as a settable list.
 * @param [in] object sorted mutable list instance.
...
/**
 * @brief Return sorted mutable list as a incremental list.
 * @param [in] object sorted mutable list instance.
...
/**
 * @brief Return sorted mutable list as a reducible list.
 * @param [in] object sorted mutable list instance.
...
/**
 * @brief Return sorted mutable list as a settable incremental list.
 * @param [in] object sorted mutable list instance.
...
/**
 * @brief Return sorted mutable list as a settable reducible list.
 * @param [in] object sorted mutable list instance.
...
/**
 * @brief Return sorted mutable list as a sorted settable list.
 * @param [in] object sorted mutable list instance.
...
/**
 * @brief Return sorted mutable list as a sorted incremental list.
 * @param [in] object sorted mutable list instance.
...
/**
 * @brief Return sorted mutable list as a sorted reducible list.
 * @param [in] object sorted mutable list instance.
...
/**
 * @brief Return sorted mutable list as a mutable list.
 * @param [in] object sorted mutable list instance.
...
/**
 * @brief Return sorted mutable list as a sorted settable incremental list.
 * @param [in] object sorted mutable list instance.
 * @param [out] out receive sorted settable incremental list.
 * @return On success <i>0</i>, otherwise an error code.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_LIST_I_ERROR_OBJECT_IS_NULL if object
 * is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_LIST_I_ERROR_OUT_IS_NULL if out is
...
/**
 * @brief Return sorted mutable list as a sorted settable reducible list.
 * @param [in] object sorted mutable list instance.
 * @param [out] out receive sorted settable reducible list.
 * @return On success <i>0</i>, otherwise an error code.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_LIST_I_ERROR_OBJECT_IS_NULL if object
 * is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_LIST_I_ERROR_OUT_IS_NULL if out is
 ...
 * @return On success <i>0</i>, otherwise an error code.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_LIST_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_LIST_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 */
...
/**
 * @brief First item of the sorted mutable list.
 * @param [in] object sorted mutable list instance.
 ...
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_LIST_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_LIST_I_ERROR_LIST_IS_EMPTY if list is
 * empty.
 */
...
/**
 * @brief Last item of the sorted mutable list.
 * @param [in] object sorted mutable list instance.
 * @param [out] out receive the item.
 * @return On success <i>0</i>, otherwise an error code.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_LIST_I_ERROR_OBJECT_IS_NULL if
 ...
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_LIST_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_LIST_I_ERROR_LIST_IS_EMPTY if list
 * is empty.
 */
 ...
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_LIST_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_LIST_I_ERROR_ITEM_IS_NULL if item is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_LIST_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_LIST_I_ERROR_END_OF_SEQUENCE if there
 * is no next item.
 */
 ...
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_LIST_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_LIST_I_ERROR_INDEX_IS_OUT_OF_BOUNDS if
 ...
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_LIST_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_LIST_I_ERROR_ITEM_NOT_FOUND if item is
 ...
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_LIST_I_ERROR_ITEM_IS_NULL if item is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_LIST_I_ERROR_VALUE_IS_NULL if value is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_LIST_I_ERROR_VALUE_IS_INVALID if
 * value is invalid.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_LIST_I_ERROR_MEMORY_ALLOCATION_FAILED
 ...
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_LIST_I_ERROR_INDEX_IS_OUT_OF_BOUNDS if
 * at does not refer to an item contained within the mutable list.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_LIST_I_ERROR_VALUE_IS_INVALID if
 * value is invalid.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_LIST_I_ERROR_MEMORY_ALLOCATION_FAILED
 * if there is not enough memory to set the item to value.
 ...
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_LIST_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_LIST_I_ERROR_VALUE_NOT_FOUND if no
 ...
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_LIST_I_ERROR_OBJECT_IS_NULL if object
 * is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_LIST_I_ERROR_VALUE_IS_NULL if value
 * is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_LIST_I_ERROR_MEMORY_ALLOCATION_FAILED
 ...
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_LIST_I_ERROR_OBJECT_IS_NULL if object
 * is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_LIST_I_ERROR_OTHER_IS_NULL if other
 * is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_LIST_I_ERROR_MEMORY_ALLOCATION_FAILED
 ...
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_LIST_I_ERROR_OBJECT_IS_NULL if object
 * is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_LIST_I_ERROR_INDEX_IS_OUT_OF_BOUNDS
...
#endif /* _BUTTERFLYFISH_SORTED_MUTABLE_LIST_I_H_ */
