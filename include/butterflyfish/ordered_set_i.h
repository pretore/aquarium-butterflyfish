...
struct butterflyfish_ordered_set_i {
    ...
    /**
      ...
      * <i>NULL</i>.
      * @throws BUTTERFLYFISH_ORDERED_SET_I_ERROR_OUT_IS_NULL if out is
      * <i>NULL</i>.
      */
     ...
     * @throws BUTTERFLYFISH_ORDERED_SET_I_ERROR_OUT_IS_NULL if out is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_ORDERED_SET_I_ERROR_SET_IS_EMPTY if set is empty.
     */
     ...
     * @throws BUTTERFLYFISH_ORDERED_SET_I_ERROR_OUT_IS_NULL if out is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_ORDERED_SET_I_ERROR_END_OF_SEQUENCE if there is
     * no next item.
     */
     ...
     * @throws BUTTERFLYFISH_ORDERED_SET_I_ERROR_OUT_IS_NULL if out is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_ORDERED_SET_I_ERROR_VALUE_NOT_FOUND if value is
