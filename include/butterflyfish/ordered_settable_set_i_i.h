...
struct butterflyfish_ordered_settable_set_i_i {
    ...
    /**
      ...
      * object is <i>NULL</i>.
      * @throws BUTTERFLYFISH_ORDERED_SETTABLE_SET_I_I_ERROR_OUT_IS_NULL if out
      * is <i>NULL</i>.
      */
     ...
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_ORDERED_SETTABLE_SET_I_I_ERROR_SET_IS_EMPTY if set
     * is empty.
     */
     ...
     * @throws BUTTERFLYFISH_ORDERED_SETTABLE_SET_I_I_ERROR_OBJECT_IS_NULL if
     * object is <i>NULL</i>.
     * @throws BUTTERFLYFISH_ORDERED_SETTABLE_SET_I_I_ERROR_ITEM_IS_NULL if
     * item is <i>NULL</i>.
     * @throws BUTTERFLYFISH_ORDERED_SETTABLE_SET_I_I_ERROR_OUT_IS_NULL if out is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_ORDERED_SETTABLE_SET_I_I_ERROR_END_OF_SEQUENCE if
     ...
     * @throws BUTTERFLYFISH_ORDERED_SETTABLE_SET_I_I_ERROR_OBJECT_IS_NULL if
     * object is <i>NULL</i>.
     * @throws BUTTERFLYFISH_ORDERED_SETTABLE_SET_I_I_ERROR_VALUE_IS_NULL if
     * value is <i>NULL</i>.
     * @throws BUTTERFLYFISH_ORDERED_SETTABLE_SET_I_I_ERROR_OUT_IS_NULL if out is
     * <i>NULL</i>.
     ...
     * @throws BUTTERFLYFISH_ORDERED_SETTABLE_SET_I_I_ERROR_MEMORY_ALLOCATION_FAILED if
