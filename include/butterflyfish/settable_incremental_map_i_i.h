#ifndef _BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_I_I_H_
#define _BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_I_I_H_
...
#define BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_I_I_ERROR_OBJECT_IS_NULL \
    BUTTERFLYFISH_SETTABLE_MAP_I_I_ERROR_OBJECT_IS_NULL
#define BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL \
    BUTTERFLYFISH_SETTABLE_MAP_I_I_ERROR_OUT_IS_NULL
#define BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_I_I_ERROR_MAP_IS_EMPTY \
    BUTTERFLYFISH_SETTABLE_MAP_I_I_ERROR_MAP_IS_EMPTY
#define BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_I_I_ERROR_ITEM_IS_NULL \
    BUTTERFLYFISH_SETTABLE_MAP_I_I_ERROR_ITEM_IS_NULL
#define BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_I_I_ERROR_END_OF_SEQUENCE \
    BUTTERFLYFISH_SETTABLE_MAP_I_I_ERROR_END_OF_SEQUENCE
#define BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_I_I_ERROR_OTHER_IS_NULL \
    BUTTERFLYFISH_SETTABLE_MAP_I_I_ERROR_OTHER_IS_NULL
#define BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_I_I_ERROR_VALUE_IS_NULL \
    BUTTERFLYFISH_SETTABLE_MAP_I_I_ERROR_VALUE_IS_NULL
#define BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_I_I_ERROR_ENTRY_IS_NULL \
    BUTTERFLYFISH_SETTABLE_MAP_I_I_ERROR_ENTRY_IS_NULL
#define BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_I_I_ERROR_KEY_IS_NULL \
    BUTTERFLYFISH_SETTABLE_MAP_I_I_ERROR_KEY_IS_NULL
#define BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_I_I_ERROR_MEMORY_ALLOCATION_FAILED \
    BUTTERFLYFISH_SETTABLE_MAP_I_I_ERROR_MEMORY_ALLOCATION_FAILED
#define BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_I_I_ERROR_VALUE_NOT_FOUND \
    BUTTERFLYFISH_SETTABLE_MAP_I_I_ERROR_VALUE_NOT_FOUND
#define BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_I_I_ERROR_ENTRY_NOT_FOUND \
    BUTTERFLYFISH_SETTABLE_MAP_I_I_ERROR_ENTRY_NOT_FOUND
#define BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_I_I_ERROR_KEY_NOT_FOUND \
    BUTTERFLYFISH_SETTABLE_MAP_I_I_ERROR_KEY_NOT_FOUND
#define BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_I_I_ERROR_VALUE_IS_INVALID \
    BUTTERFLYFISH_SETTABLE_MAP_I_I_ERROR_VALUE_IS_INVALID
#define BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_I_I_ERROR_KEY_ALREADY_EXISTS \
    BUTTERFLYFISH_SETTABLE_MAP_I_I_ERROR_KEY_ALREADY_EXISTS
#define BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_I_I_ERROR_ENTRY_IS_INVALID \
...
struct butterflyfish_settable_incremental_map_i_i {
    int (*const as_settable_map)(
            struct butterflyfish_settable_incremental_map_i_i *object,
 ...
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL if
 * out is <i>NULL</i>.
 */
int butterflyfish_settable_incremental_map_i_i_as_stream(
        const struct butterflyfish_settable_incremental_map_i_i *object,
 ...
 * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL if
 * out is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_I_I_ERROR_MAP_IS_EMPTY if
 * map is empty.
 */
 ...
 * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_I_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_I_I_ERROR_ITEM_IS_NULL if
 * item is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL if
 * out is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_I_I_ERROR_END_OF_SEQUENCE
 ...
 * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_I_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_I_I_ERROR_ENTRY_IS_NULL if
 * entry is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL if
 * out is <i>NULL</i>.
 * @throws
 * BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_I_I_ERROR_MEMORY_ALLOCATION_FAILED if
 ...
 * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_I_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_I_I_ERROR_KEY_IS_NULL if
 * key is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL if
 * out is <i>NULL</i>.
 * @throws
 ...
 * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_I_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_I_I_ERROR_VALUE_IS_NULL if
 * value is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL if
 * out is <i>NULL</i>.
 * @throws
 ...
 * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_I_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_I_I_ERROR_OTHER_IS_NULL if
 * other is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL if
 * out is <i>NULL</i>.
 * @throws
 ...
 * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL if
 * out is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_I_I_ERROR_ENTRY_NOT_FOUND
 ...
 * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL if
 * out is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_I_I_ERROR_KEY_NOT_FOUND if
 ...
 * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_I_I_ERROR_KEY_NOT_FOUND if
 * key is not in the map instance.
 * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_I_I_ERROR_VALUE_IS_INVALID
 * if value is invalid.
 * @throws
 * BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_I_I_ERROR_MEMORY_ALLOCATION_FAILED if
 ...
 * key is not in the map instance.
 * @throws
 * BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_I_I_ERROR_KEY_ALREADY_EXISTS if key
 ...
 * BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_I_I_ERROR_KEY_ALREADY_EXISTS if key
 * is already present in the map.
 * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_I_I_ERROR_ENTRY_IS_INVALID
 * if entry is invalid.
 * @throws
...
#endif /* _BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_I_I_H_ */
