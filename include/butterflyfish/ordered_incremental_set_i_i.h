...
#define BUTTERFLYFISH_ORDERED_INCREMENTAL_SET_I_I_ERROR_OTHER_IS_NULL \
...
struct butterflyfish_ordered_incremental_set_i_i {
    int (*const as_insertable)(
            struct butterflyfish_ordered_incremental_set_i_i *object,
            struct butterflyfish_insertable_i_i **out);

    int (*const as_ordered_set)(
            const struct butterflyfish_ordered_incremental_set_i_i *object,
 ...
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_SET_I_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_SET_I_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 */
int butterflyfish_ordered_incremental_set_i_i_as_stream(
        const struct butterflyfish_ordered_incremental_set_i_i *object,
 ...
 * <i>NULL</i>.
 */
int butterflyfish_ordered_incremental_set_i_i_as_collection(
        const struct butterflyfish_ordered_incremental_set_i_i *object,
 ...
 * <i>NULL</i>.
 */
int butterflyfish_ordered_incremental_set_i_i_as_addable(
        struct butterflyfish_ordered_incremental_set_i_i *object,
 ...
 * <i>NULL</i>.
 */
int butterflyfish_ordered_incremental_set_i_i_as_ordered(
        const struct butterflyfish_ordered_incremental_set_i_i *object,
 ...
 * <i>NULL</i>.
 */
int butterflyfish_ordered_incremental_set_i_i_as_insertable(
        struct butterflyfish_ordered_incremental_set_i_i *object,
        struct butterflyfish_insertable_i_i **out);
 ...
 * <i>NULL</i>.
 */
int butterflyfish_ordered_incremental_set_i_i_as_set(
        const struct butterflyfish_ordered_incremental_set_i_i *object,
 ...
 * <i>NULL</i>.
 */
int butterflyfish_ordered_incremental_set_i_i_as_incremental_set(
        struct butterflyfish_ordered_incremental_set_i_i *object,
        struct butterflyfish_incremental_set_i_i **out);
 ...
 * <i>NULL</i>.
 */
int butterflyfish_ordered_incremental_set_i_i_as_ordered_set(
        const struct butterflyfish_ordered_incremental_set_i_i *object,
        const struct butterflyfish_ordered_set_i_i **out);
 ...
 * <i>NULL</i>.
 */
int butterflyfish_ordered_incremental_set_i_i_count(
        const struct butterflyfish_ordered_incremental_set_i_i *object,
        uintmax_t *out);
 ...
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_SET_I_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_SET_I_I_ERROR_SET_IS_EMPTY if set is
 * empty.
 */
int butterflyfish_ordered_incremental_set_i_i_first(
        const struct butterflyfish_ordered_incremental_set_i_i *object,
 ...
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_SET_I_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_SET_I_I_ERROR_SET_IS_EMPTY if set
 * is empty.
 */
int butterflyfish_ordered_incremental_set_i_i_last(
        const struct butterflyfish_ordered_incremental_set_i_i *object,
        const struct butterflyfish_map_i_i_entry **out);
 ...
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_SET_I_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_SET_I_I_ERROR_ITEM_IS_NULL if item is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_SET_I_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_SET_I_I_ERROR_END_OF_SEQUENCE if
 * there is no next item.
 */
int butterflyfish_ordered_incremental_set_i_i_next(
        const struct butterflyfish_ordered_incremental_set_i_i *object,
 ...
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_SET_I_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_SET_I_I_ERROR_ITEM_IS_NULL if item
 * is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_SET_I_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_SET_I_I_ERROR_END_OF_SEQUENCE if
 ...
 */
int butterflyfish_ordered_incremental_set_i_i_prev(
        const struct butterflyfish_ordered_incremental_set_i_i *object,
        const struct butterflyfish_map_i_i_entry *item,
        const struct butterflyfish_map_i_i_entry **out);
 ...
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_SET_I_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_SET_I_I_ERROR_VALUE_IS_NULL if
 * value is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_SET_I_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 ...
 */
int butterflyfish_ordered_incremental_set_i_i_contains(
        const struct butterflyfish_ordered_incremental_set_i_i *object,
 ...
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_SET_I_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_SET_I_I_ERROR_OTHER_IS_NULL if
 * other is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_SET_I_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_SET_I_I_ERROR_MEMORY_ALLOCATION_FAILED
 * if there is insufficient memory to find the item.
 */
int butterflyfish_ordered_incremental_set_i_i_contains_all(
        const struct butterflyfish_ordered_incremental_set_i_i *object,
 ...
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_SET_I_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_SET_I_I_ERROR_VALUE_NOT_FOUND if
 * value is not in the set instance.
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_SET_I_I_ERROR_MEMORY_ALLOCATION_FAILED
 * if there is insufficient memory to find the item.
 */
int butterflyfish_ordered_incremental_set_i_i_get(
        const struct butterflyfish_ordered_incremental_set_i_i *object,
        const struct butterflyfish_map_i_i_entry *value,
        const struct butterflyfish_map_i_i_entry **out);
 ...
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_SET_I_I_ERROR_VALUE_IS_INVALID if
 * value is invalid.
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_SET_I_I_ERROR_MEMORY_ALLOCATION_FAILED
 * if there is insufficient memory to add value to the set.
 * @note <b>value</b> is copied and then placed into the set.
 */
int butterflyfish_ordered_incremental_set_i_i_add(
        struct butterflyfish_ordered_incremental_set_i_i *object,
        const struct butterflyfish_map_i_i_entry *value);
 ...
 */
int butterflyfish_ordered_incremental_set_i_i_add_all(
        struct butterflyfish_ordered_incremental_set_i_i *object,
        const struct butterflyfish_stream_i_i *other);
 ...
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_SET_I_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_SET_I_I_ERROR_ITEM_IS_NULL if
 * item is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_SET_I_I_ERROR_VALUE_IS_NULL if
 * value is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_SET_I_I_ERROR_VALUE_ALREADY_EXISTS
 ...
 * @note <b>value</b> is copied and then placed into the set.
 */
int butterflyfish_ordered_incremental_set_i_i_insert(
        struct butterflyfish_ordered_incremental_set_i_i *object,
        const struct butterflyfish_map_i_i_entry *item,
        const struct butterflyfish_map_i_i_entry *value);
 ...
 * @note streamed <b>values</b> are copied and then placed into the set.
 */
int butterflyfish_ordered_incremental_set_i_i_insert_all(
        struct butterflyfish_ordered_incremental_set_i_i *object,
        const struct butterflyfish_map_i_i_entry *item,
        const struct butterflyfish_stream_i_i *other);
