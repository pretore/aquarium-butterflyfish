...
struct butterflyfish_ordered_settable_map_i_i {
    ...
    const struct butterflyfish_ordered_settable_set_i *const keys;
     ...
     * object is <i>NULL</i>.
     * @throws BUTTERFLYFISH_ORDERED_SETTABLE_MAP_I_I_ERROR_OUT_IS_NULL if
     * out is <i>NULL</i>.
     */
     ...
     * @throws BUTTERFLYFISH_ORDERED_SETTABLE_MAP_I_I_ERROR_OUT_IS_NULL if
     * out is <i>NULL</i>.
     * @throws BUTTERFLYFISH_ORDERED_SETTABLE_MAP_I_I_ERROR_MAP_IS_EMPTY if
     * map is empty.
     */
     ...
     * @throws BUTTERFLYFISH_ORDERED_SETTABLE_MAP_I_I_ERROR_OBJECT_IS_NULL if
     * object is <i>NULL</i>.
     * @throws BUTTERFLYFISH_ORDERED_SETTABLE_MAP_I_I_ERROR_ITEM_IS_NULL if
     * item is <i>NULL</i>.
     * @throws BUTTERFLYFISH_ORDERED_SETTABLE_MAP_I_I_ERROR_OUT_IS_NULL if
     * out is <i>NULL</i>.
     * @throws BUTTERFLYFISH_ORDERED_SETTABLE_MAP_I_I_ERROR_END_OF_SEQUENCE
     ...
     * @throws BUTTERFLYFISH_ORDERED_SETTABLE_MAP_I_I_ERROR_OUT_IS_NULL if
     * out is <i>NULL</i>.
     * @throws BUTTERFLYFISH_ORDERED_SETTABLE_MAP_I_I_ERROR_MEMORY_ALLOCATION_FAILED
     ...
     * @throws BUTTERFLYFISH_ORDERED_SETTABLE_MAP_I_I_ERROR_OUT_IS_NULL if
     * out is <i>NULL</i>.
     * @throws BUTTERFLYFISH_ORDERED_SETTABLE_MAP_I_I_ERROR_KEY_NOT_FOUND if
     ...
     * @throws BUTTERFLYFISH_ORDERED_SETTABLE_MAP_I_I_ERROR_KEY_NOT_FOUND if
     * key is not in the map instance.
     * @throws BUTTERFLYFISH_ORDERED_SETTABLE_MAP_I_I_ERROR_VALUE_IS_INVALID
     * if value is invalid.
     * @throws BUTTERFLYFISH_ORDERED_SETTABLE_MAP_I_I_ERROR_MEMORY_ALLOCATION_FAILED
     ...
     * @throws BUTTERFLYFISH_ORDERED_SETTABLE_MAP_I_I_ERROR_KEY_NOT_FOUND if
     * key is not in the map instance.
     * @throws BUTTERFLYFISH_ORDERED_SETTABLE_MAP_I_I_ERROR_KEY_ALREADY_EXISTS
