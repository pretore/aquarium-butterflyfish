...
struct butterflyfish_mutable_set_i {
    ...
    /**
      ...
      * <i>NULL</i>.
      * @throws BUTTERFLYFISH_MUTABLE_SET_I_ERROR_OUT_IS_NULL if out is
      * <i>NULL</i>.
      */
     ...
     * @throws BUTTERFLYFISH_MUTABLE_SET_I_ERROR_OUT_IS_NULL if out is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_MUTABLE_SET_I_ERROR_END_OF_SEQUENCE if there is
     * no next item.
     */
     ...
     * @throws BUTTERFLYFISH_MUTABLE_SET_I_ERROR_OUT_IS_NULL if out is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_MUTABLE_SET_I_ERROR_MEMORY_ALLOCATION_FAILED
     ...
     * @param [out] out receive the item.
     * @return On success <i>0</i>, otherwise an error code.
     * @throws BUTTERFLYFISH_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL
     * if object is <i>NULL</i>.
     * @throws BUTTERFLYFISH_MUTABLE_SET_I_ERROR_VALUE_IS_NULL
     * if value is <i>NULL</i>.
     * @throws BUTTERFLYFISH_MUTABLE_SET_I_ERROR_OUT_IS_NULL if
     * out is <i>NULL</i>.
     * @throws BUTTERFLYFISH_MUTABLE_SET_I_ERROR_VALUE_NOT_FOUND
     ...
     * @throws BUTTERFLYFISH_MUTABLE_SET_I_ERROR_VALUE_IS_INVALID if value
     * invalid.
     * @throws BUTTERFLYFISH_MUTABLE_SET_I_ERROR_MEMORY_ALLOCATION_FAILED
     * if there is not enough memory to set the item to value.
