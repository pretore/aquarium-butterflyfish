#ifndef _BUTTERFLYFISH_SET_I_I_H_
#define _BUTTERFLYFISH_SET_I_I_H_
...
#define BUTTERFLYFISH_SET_I_I_ERROR_SET_IS_EMPTY \
    BUTTERFLYFISH_COLLECTION_I_I_ERROR_COLLECTION_IS_EMPTY
#define BUTTERFLYFISH_SET_I_I_ERROR_ITEM_IS_NULL \
    BUTTERFLYFISH_COLLECTION_I_I_ERROR_ITEM_IS_NULL
#define BUTTERFLYFISH_SET_I_I_ERROR_END_OF_SEQUENCE \
    BUTTERFLYFISH_COLLECTION_I_I_ERROR_END_OF_SEQUENCE
#define BUTTERFLYFISH_SET_I_I_ERROR_OTHER_IS_NULL \
    SEA_URCHIN_ERROR_OTHER_IS_NULL
#define BUTTERFLYFISH_SET_I_I_ERROR_VALUE_IS_NULL \
    SEA_URCHIN_ERROR_VALUE_IS_NULL
#define BUTTERFLYFISH_SET_I_I_ERROR_MEMORY_ALLOCATION_FAILED \
    SEA_URCHIN_ERROR_MEMORY_ALLOCATION_FAILED
#define BUTTERFLYFISH_SET_I_I_ERROR_VALUE_NOT_FOUND \
...
struct butterflyfish_set_i_i {
    ...
    int (*const contains_all)(const struct butterflyfish_set_i_i *object,
                              const struct butterflyfish_stream_i_i *other,
                              bool *out);

    int (*const get)(const struct butterflyfish_set_i_i *object,
                     const struct butterflyfish_map_i_i_entry *value,
 ...
 * @throws BUTTERFLYFISH_SET_I_I_ERROR_OBJECT_IS_NULL if object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SET_I_I_ERROR_OUT_IS_NULL if out is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SET_I_I_ERROR_SET_IS_EMPTY if set is empty.
 */
 ...
 * @throws BUTTERFLYFISH_SET_I_I_ERROR_ITEM_IS_NULL if item is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SET_I_I_ERROR_OUT_IS_NULL if out is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SET_I_I_ERROR_END_OF_SEQUENCE if there is no previous
 * item.
 */
 ...
 * @return On success <i>0</i>, otherwise an error code.
 * @throws BUTTERFLYFISH_SET_I_I_ERROR_OBJECT_IS_NULL if object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SET_I_I_ERROR_VALUE_IS_NULL if value is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SET_I_I_ERROR_OUT_IS_NULL if out is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SET_I_I_ERROR_MEMORY_ALLOCATION_FAILED if there is
 ...
 * @return On success <i>0</i>, otherwise an error code.
 * @throws BUTTERFLYFISH_SET_I_I_ERROR_OBJECT_IS_NULL if object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SET_I_I_ERROR_OTHER_IS_NULL if other is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SET_I_I_ERROR_OUT_IS_NULL if out is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SET_I_I_ERROR_MEMORY_ALLOCATION_FAILED if there is
 * insufficient memory to find the item.
 */
 ...
 * @throws BUTTERFLYFISH_SET_I_I_ERROR_VALUE_IS_NULL if value is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SET_I_I_ERROR_OUT_IS_NULL if out is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SET_I_I_ERROR_VALUE_NOT_FOUND if value is not in the
 * set instance.
 * @throws BUTTERFLYFISH_SET_I_I_ERROR_MEMORY_ALLOCATION_FAILED if there is
 * insufficient memory to find the item.
 */
...
#endif /* _BUTTERFLYFISH_SET_I_I_H_ */
