#ifndef _BUTTERFLYFISH_QUEUE_NI_H_
#define _BUTTERFLYFISH_QUEUE_NI_H_
...
#define BUTTERFLYFISH_QUEUE_NI_ERROR_VALUE_IS_INVALID \
...
int butterflyfish_queue_ni_as_reducible_queue(
        ...
        struct butterflyfish_reducible_queue_ni **out);
 ...
 * @return On success <i>0</i>, otherwise an error code.
 * @throws BUTTERFLYFISH_QUEUE_NI_ERROR_OBJECT_IS_NULL if object is
 * <i>NULL</i>.
 ...
 * @throws BUTTERFLYFISH_QUEUE_NI_ERROR_ITEM_IS_NULL if item is <i>NULL</i>.
 * @throws BUTTERFLYFISH_QUEUE_NI_ERROR_OUT_IS_NULL if out is <i>NULL</i>.
 * @throws BUTTERFLYFISH_QUEUE_NI_ERROR_END_OF_SEQUENCE if there is no
 * previous item.
 */
 ...
 * @return On success <i>0</i>, otherwise an error code.
 * @throws BUTTERFLYFISH_QUEUE_NI_ERROR_OBJECT_IS_NULL if object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_QUEUE_NI_ERROR_VALUE_IS_NULL if value is <i>NULL</i>.
 * @throws BUTTERFLYFISH_QUEUE_NI_ERROR_MEMORY_ALLOCATION_FAILED if there is
 * insufficient memory to add value.
 * @throws BUTTERFLYFISH_QUEUE_NI_ERROR_VALUE_IS_INVALID if value is invalid.
