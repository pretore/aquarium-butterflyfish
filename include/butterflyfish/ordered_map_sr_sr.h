#ifndef _BUTTERFLYFISH_ORDERED_MAP_SR_SR_H_
#define _BUTTERFLYFISH_ORDERED_MAP_SR_SR_H_
...
#define BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_OBJECT_IS_NULL \
    BUTTERFLYFISH_MAP_SR_SR_ERROR_OBJECT_IS_NULL
#define BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_OUT_IS_NULL \
    BUTTERFLYFISH_MAP_SR_SR_ERROR_OUT_IS_NULL
#define BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_MAP_IS_EMPTY \
    BUTTERFLYFISH_MAP_SR_SR_ERROR_MAP_IS_EMPTY
#define BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_ENTRY_IS_NULL \
    BUTTERFLYFISH_MAP_SR_SR_ERROR_ENTRY_IS_NULL
#define BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_END_OF_SEQUENCE \
    BUTTERFLYFISH_MAP_SR_SR_ERROR_END_OF_SEQUENCE
#define BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_OTHER_IS_NULL \
    BUTTERFLYFISH_MAP_SR_SR_ERROR_OTHER_IS_NULL
#define BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_KEY_IS_NULL \
    BUTTERFLYFISH_MAP_SR_SR_ERROR_KEY_IS_NULL
#define BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_VALUE_IS_NULL \
    BUTTERFLYFISH_MAP_SR_SR_ERROR_VALUE_IS_NULL
#define BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_KEY_ALREADY_EXISTS \
    BUTTERFLYFISH_MAP_SR_SR_ERROR_KEY_ALREADY_EXISTS
#define BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_MEMORY_ALLOCATION_FAILED \
    BUTTERFLYFISH_MAP_SR_SR_ERROR_MEMORY_ALLOCATION_FAILED
#define BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_KEY_NOT_FOUND \
    BUTTERFLYFISH_MAP_SR_SR_ERROR_KEY_NOT_FOUND
#define BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_FUNCTION_IS_NULL \
    BUTTERFLYFISH_MAP_SR_SR_ERROR_FUNCTION_IS_NULL

struct butterflyfish_ordered_map_sr_sr {
 ...
 * @throws BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_OBJECT_IS_NULL if object is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 */
int butterflyfish_ordered_map_sr_sr_as_stream(
        const struct butterflyfish_ordered_map_sr_sr *object,
...
int butterflyfish_ordered_map_sr_sr_as_map(
        struct butterflyfish_ordered_map_sr_sr *object,
 ...
 * @throws BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_MAP_IS_EMPTY if map is empty.
 */
 ...
 * @throws BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_OBJECT_IS_NULL if object is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_ENTRY_IS_NULL if entry is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_END_OF_SEQUENCE if there is no
 * next entry.
 */
 ...
 * @throws BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_OBJECT_IS_NULL if object is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_OTHER_IS_NULL if other is
 * <i>NULL</i>.
 */
 ...
 * @throws BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_OBJECT_IS_NULL if object is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_KEY_IS_NULL if key is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_VALUE_IS_NULL if value is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_KEY_ALREADY_EXISTS if key is
 * already present in the map.
 * @throws BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_MEMORY_ALLOCATION_FAILED if
 ...
 * @throws BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_VALUE_IS_NULL if value is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_KEY_NOT_FOUND if key is not
 * present in the map.
 * @throws BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_MEMORY_ALLOCATION_FAILED if
 ...
 * @throws BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_OTHER_IS_NULL if other is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_FUNCTION_IS_NULL if function is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_MEMORY_ALLOCATION_FAILED if
 ...
 * @throws BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_KEY_NOT_FOUND if key not found
 * in map.
 * @throws BUTTERFLYFISH_ORDERED_MAP_SR_SR_ERROR_MEMORY_ALLOCATION_FAILED if
...
#endif /* _BUTTERFLYFISH_ORDERED_MAP_SR_SR_H_ */
