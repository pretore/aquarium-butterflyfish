#ifndef _BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_H_
#define _BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_H_
...
#include "reducible_set_i_i.h"

struct butterflyfish_map_i_i_entry;

#define BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_ERROR_OBJECT_IS_NULL \
    BUTTERFLYFISH_SETTABLE_SET_I_I_ERROR_OBJECT_IS_NULL
#define BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_ERROR_OUT_IS_NULL \
    BUTTERFLYFISH_SETTABLE_SET_I_I_ERROR_OUT_IS_NULL
#define BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_ERROR_SET_IS_EMPTY \
    BUTTERFLYFISH_SETTABLE_SET_I_I_ERROR_SET_IS_EMPTY
#define BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_ERROR_ITEM_IS_NULL \
    BUTTERFLYFISH_SETTABLE_SET_I_I_ERROR_ITEM_IS_NULL
#define BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_ERROR_END_OF_SEQUENCE \
    BUTTERFLYFISH_SETTABLE_SET_I_I_ERROR_END_OF_SEQUENCE
#define BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_ERROR_OTHER_IS_NULL \
    BUTTERFLYFISH_SETTABLE_SET_I_I_ERROR_OTHER_IS_NULL
#define BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_ERROR_VALUE_IS_NULL \
    BUTTERFLYFISH_SETTABLE_SET_I_I_ERROR_VALUE_IS_NULL
#define BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_ERROR_VALUE_ALREADY_EXISTS \
    BUTTERFLYFISH_SETTABLE_SET_I_I_ERROR_VALUE_ALREADY_EXISTS
#define BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_ERROR_VALUE_IS_INVALID \
    BUTTERFLYFISH_SETTABLE_SET_I_I_ERROR_VALUE_IS_INVALID
#define BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_ERROR_MEMORY_ALLOCATION_FAILED \
    BUTTERFLYFISH_SETTABLE_SET_I_I_ERROR_MEMORY_ALLOCATION_FAILED
#define BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_ERROR_VALUE_NOT_FOUND \
...
struct butterflyfish_settable_reducible_set_i_i {
    int (*const as_settable_set)(
            struct butterflyfish_settable_reducible_set_i_i *object,
 ...
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 */
int butterflyfish_settable_reducible_set_i_i_as_stream(
        const struct butterflyfish_settable_reducible_set_i_i *object,
 ...
 * <i>NULL</i>.
 */
int butterflyfish_settable_reducible_set_i_i_as_collection(
        const struct butterflyfish_settable_reducible_set_i_i *object,
 ...
 * <i>NULL</i>.
 */
int butterflyfish_settable_reducible_set_i_i_as_settable(
        struct butterflyfish_settable_reducible_set_i_i *object,
 ...
 * <i>NULL</i>.
 */
int butterflyfish_settable_reducible_set_i_i_as_set(
        const struct butterflyfish_settable_reducible_set_i_i *object,
 ...
 * <i>NULL</i>.
 */
int butterflyfish_settable_reducible_set_i_i_as_removable(
        struct butterflyfish_settable_reducible_set_i_i *object,
 ...
 * <i>NULL</i>.
 */
int butterflyfish_settable_reducible_set_i_i_as_settable_set(
        struct butterflyfish_settable_reducible_set_i_i *object,
        struct butterflyfish_settable_set_i_i **out);
 ...
 * <i>NULL</i>.
 */
int butterflyfish_settable_reducible_set_i_i_as_reducible_set(
        struct butterflyfish_settable_reducible_set_i_i *object,
        struct butterflyfish_reducible_set_i_i **out);
 ...
 * <i>NULL</i>.
 */
int butterflyfish_settable_reducible_set_i_i_count(
        const struct butterflyfish_settable_reducible_set_i_i *object,
        uintmax_t *out);
 ...
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_ERROR_SET_IS_EMPTY if set
 * is empty.
 */
int butterflyfish_settable_reducible_set_i_i_first(
        const struct butterflyfish_settable_reducible_set_i_i *object,
 ...
 * is empty.
 */
int butterflyfish_settable_reducible_set_i_i_last(
        const struct butterflyfish_settable_reducible_set_i_i *object,
        const struct butterflyfish_map_i_i_entry **out);
 ...
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_ERROR_ITEM_IS_NULL if item is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_ERROR_END_OF_SEQUENCE if
 * there is no next item.
 */
int butterflyfish_settable_reducible_set_i_i_next(
        const struct butterflyfish_settable_reducible_set_i_i *object,
 ...
 */
int butterflyfish_settable_reducible_set_i_i_prev(
        const struct butterflyfish_settable_reducible_set_i_i *object,
        const struct butterflyfish_map_i_i_entry *item,
        const struct butterflyfish_map_i_i_entry **out);
 ...
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_ERROR_VALUE_IS_NULL if
 * value is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws
 * BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_ERROR_MEMORY_ALLOCATION_FAILED if
 * there is insufficient memory to find the item.
 */
int butterflyfish_settable_reducible_set_i_i_contains(
        const struct butterflyfish_settable_reducible_set_i_i *object,
 ...
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_ERROR_OTHER_IS_NULL if
 * other is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws
 ...
 * there is insufficient memory to find the item.
 */
int butterflyfish_settable_reducible_set_i_i_contains_all(
        const struct butterflyfish_settable_reducible_set_i_i *object,
 ...
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_ERROR_VALUE_NOT_FOUND if
 * value is not in the set instance.
 * @throws
 * BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_ERROR_MEMORY_ALLOCATION_FAILED if
 * there is insufficient memory to find the item.
 */
int butterflyfish_settable_reducible_set_i_i_get(
        const struct butterflyfish_settable_reducible_set_i_i *object,
        const struct butterflyfish_map_i_i_entry *value,
        const struct butterflyfish_map_i_i_entry **out);
 ...
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_ERROR_VALUE_IS_NULL if
 * value is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_ERROR_VALUE_ALREADY_EXISTS
 * if value is already present in the set.
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_ERROR_VALUE_IS_INVALID
 * if value is invalid.
 * @throws
 * BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_ERROR_MEMORY_ALLOCATION_FAILED if
 ...
 */
int butterflyfish_settable_reducible_set_i_i_set_item(
        struct butterflyfish_settable_reducible_set_i_i *object,
        const struct butterflyfish_map_i_i_entry *item,
        const struct butterflyfish_map_i_i_entry *value);
 ...
 */
int butterflyfish_settable_reducible_set_i_i_set(
        struct butterflyfish_settable_reducible_set_i_i *object,
        const struct butterflyfish_map_i_i_entry *item,
        const struct butterflyfish_map_i_i_entry *value);
 ...
 */
int butterflyfish_settable_reducible_set_i_i_remove_item(
        struct butterflyfish_settable_reducible_set_i_i *object,
        const struct butterflyfish_map_i_i_entry *item);
 ...
 */
int butterflyfish_settable_reducible_set_i_i_remove_all_items(
        struct butterflyfish_settable_reducible_set_i_i *object,
        const struct butterflyfish_stream_i_i *other);
 ...
 */
int butterflyfish_settable_reducible_set_i_i_remove(
        struct butterflyfish_settable_reducible_set_i_i *object,
        const struct butterflyfish_map_i_i_entry *value);
 ...
 */
int butterflyfish_settable_reducible_set_i_i_remove_all(
        struct butterflyfish_settable_reducible_set_i_i *object,
        const struct butterflyfish_stream_i_i *other);
 ...
 * there is insufficient memory to find the item.
 */
int butterflyfish_settable_reducible_set_i_i_retain_all(
        struct butterflyfish_settable_reducible_set_i_i *object,
        const struct butterflyfish_stream_i_i *other);

#endif /* _BUTTERFLYFISH_SETTABLE_REDUCIBLE_SET_I_I_H_ */
