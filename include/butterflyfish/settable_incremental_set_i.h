#ifndef _BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_I_H_
#define _BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_I_H_
...
#define BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_I_ERROR_OBJECT_IS_NULL \
    BUTTERFLYFISH_SETTABLE_SET_I_ERROR_OBJECT_IS_NULL
#define BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_I_ERROR_OUT_IS_NULL \
    BUTTERFLYFISH_SETTABLE_SET_I_ERROR_OUT_IS_NULL
#define BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_I_ERROR_SET_IS_EMPTY \
    BUTTERFLYFISH_SETTABLE_SET_I_ERROR_SET_IS_EMPTY
#define BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_I_ERROR_ITEM_IS_NULL \
    BUTTERFLYFISH_SETTABLE_SET_I_ERROR_ITEM_IS_NULL
#define BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_I_ERROR_END_OF_SEQUENCE \
    BUTTERFLYFISH_SETTABLE_SET_I_ERROR_END_OF_SEQUENCE
#define BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_I_ERROR_OTHER_IS_NULL \
    BUTTERFLYFISH_SETTABLE_SET_I_ERROR_OTHER_IS_NULL
#define BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_I_ERROR_VALUE_IS_NULL \
    BUTTERFLYFISH_SETTABLE_SET_I_ERROR_VALUE_IS_NULL
#define BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_I_ERROR_VALUE_ALREADY_EXISTS \
    BUTTERFLYFISH_SETTABLE_SET_I_ERROR_VALUE_ALREADY_EXISTS
#define BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_I_ERROR_VALUE_IS_INVALID \
    BUTTERFLYFISH_SETTABLE_SET_I_ERROR_VALUE_IS_INVALID
#define BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_I_ERROR_MEMORY_ALLOCATION_FAILED \
    BUTTERFLYFISH_SET_I_ERROR_MEMORY_ALLOCATION_FAILED
#define BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_I_ERROR_VALUE_NOT_FOUND \
    BUTTERFLYFISH_SET_I_ERROR_VALUE_NOT_FOUND

struct butterflyfish_settable_incremental_set_i {
    int (*const as_settable_set)(
            struct butterflyfish_settable_incremental_set_i *object,
 ...
 * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 */
int butterflyfish_settable_incremental_set_i_as_stream(
        const struct butterflyfish_settable_incremental_set_i *object,
 ...
 * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_I_ERROR_OUT_IS_NULL if
 * out is <i>NULL</i>.
 */
 ...
 * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_I_ERROR_SET_IS_EMPTY if set
 * is empty.
 */
 ...
 * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_I_ERROR_ITEM_IS_NULL if
 * item is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_I_ERROR_END_OF_SEQUENCE if
 ...
 * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_I_ERROR_VALUE_IS_NULL if
 * value is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws
 * BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_I_ERROR_MEMORY_ALLOCATION_FAILED if
 ...
 * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_I_ERROR_OTHER_IS_NULL if
 * other is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws
 ...
 * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_I_ERROR_VALUE_NOT_FOUND if
 ...
 * value is <i>NULL</i>.
 * @throws
 * BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_I_ERROR_VALUE_ALREADY_EXISTS if
 * value is already present in the set.
 * @throws
 * BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_I_ERROR_VALUE_IS_INVALID if value
 * is invalid.
 * @throws
 * BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_I_ERROR_MEMORY_ALLOCATION_FAILED if
...
#endif /* _BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_I_H_ */
