...
struct butterflyfish_settable_incremental_set_i_i {
    ...
    /**
      ...
      * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_I_I_ERROR_OBJECT_IS_NULL
     ...
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_I_I_ERROR_OUT_IS_NULL if
     * out is <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_I_I_ERROR_SET_IS_EMPTY if
     * set is empty.
     */
     ...
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_I_I_ERROR_OUT_IS_NULL if
     * out is <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_I_I_ERROR_END_OF_SEQUENCE
     ...
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_I_I_ERROR_OBJECT_IS_NULL
     * if object is <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_I_I_ERROR_VALUE_IS_NULL
     * if value is <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_I_I_ERROR_OUT_IS_NULL if
     * out is <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_I_I_ERROR_MEMORY_ALLOCATION_FAILED
     ...
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_I_I_ERROR_OUT_IS_NULL if
     * out is <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_I_I_ERROR_VALUE_NOT_FOUND
     ...
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_I_I_ERROR_VALUE_IS_NULL
     * if value is <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_I_I_ERROR_VALUE_IS_INVALID
     * if value is invalid.
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_I_I_ERROR_VALUE_ALREADY_EXISTS
