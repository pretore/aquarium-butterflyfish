...
struct butterflyfish_insertable_i_i {
     ...
     * @throws BUTTERFLYFISH_INSERTABLE_I_I_ERROR_OUT_IS_NULL if out is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_INSERTABLE_I_I_ERROR_INSERTABLE_IS_EMPTY if
     * insertable is empty.
     */
     ...
     * @throws BUTTERFLYFISH_INSERTABLE_I_I_ERROR_OUT_IS_NULL if out is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_INSERTABLE_I_I_ERROR_END_OF_SEQUENCE if there is
     * no next item.
     */
     ...
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_INSERTABLE_I_I_ERROR_VALUE_ALREADY_EXISTS if value
     * is already present.
