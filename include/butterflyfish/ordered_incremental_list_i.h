#ifndef _BUTTERFLYFISH_ORDERED_INCREMENTAL_LIST_I_H_
#define _BUTTERFLYFISH_ORDERED_INCREMENTAL_LIST_I_H_

#include <stddef.h>
#include <stdbool.h>
#include <stdint.h>

#include "insertable_i.h"
#include "ordered_list_i.h"
#include "incremental_list_i.h"

struct sea_turtle_integer;

#define BUTTERFLYFISH_ORDERED_INCREMENTAL_LIST_I_ERROR_OBJECT_IS_NULL \
    BUTTERFLYFISH_ORDERED_I_ERROR_OBJECT_IS_NULL
#define BUTTERFLYFISH_ORDERED_INCREMENTAL_LIST_I_ERROR_OUT_IS_NULL \
    BUTTERFLYFISH_INSERTABLE_I_ERROR_OUT_IS_NULL
#define BUTTERFLYFISH_ORDERED_INCREMENTAL_LIST_I_ERROR_LIST_IS_EMPTY \
    BUTTERFLYFISH_INSERTABLE_I_ERROR_INSERTABLE_IS_EMPTY
#define BUTTERFLYFISH_ORDERED_INCREMENTAL_LIST_I_ERROR_ITEM_IS_NULL \
    BUTTERFLYFISH_INSERTABLE_I_ERROR_ITEM_IS_NULL
#define BUTTERFLYFISH_ORDERED_INCREMENTAL_LIST_I_ERROR_END_OF_SEQUENCE \
    BUTTERFLYFISH_INSERTABLE_I_ERROR_END_OF_SEQUENCE
#define BUTTERFLYFISH_ORDERED_INCREMENTAL_LIST_I_ERROR_MEMORY_ALLOCATION_FAILED \
    BUTTERFLYFISH_INSERTABLE_I_ERROR_MEMORY_ALLOCATION_FAILED
#define BUTTERFLYFISH_ORDERED_INCREMENTAL_LIST_I_ERROR_OTHER_IS_NULL \
    BUTTERFLYFISH_INSERTABLE_I_ERROR_OTHER_IS_NULL
#define BUTTERFLYFISH_ORDERED_INCREMENTAL_LIST_I_ERROR_VALUE_IS_NULL \
    BUTTERFLYFISH_INSERTABLE_I_ERROR_VALUE_IS_NULL
#define BUTTERFLYFISH_ORDERED_INCREMENTAL_LIST_I_ERROR_VALUE_IS_INVALID \
    BUTTERFLYFISH_INSERTABLE_I_ERROR_VALUE_IS_INVALID
#define BUTTERFLYFISH_ORDERED_INCREMENTAL_LIST_I_ERROR_INDEX_IS_OUT_OF_BOUNDS \
    BUTTERFLYFISH_ORDERED_LIST_I_ERROR_INDEX_IS_OUT_OF_BOUNDS
#define BUTTERFLYFISH_ORDERED_INCREMENTAL_LIST_I_ERROR_ITEM_NOT_FOUND \
    BUTTERFLYFISH_ORDERED_LIST_I_ERROR_ITEM_NOT_FOUND

struct butterflyfish_ordered_incremental_list_i {
    int (*const as_insertable)(
            struct butterflyfish_ordered_incremental_list_i *object,
            struct butterflyfish_insertable_i **out);

    int (*const as_ordered_list)(
            const struct butterflyfish_ordered_incremental_list_i *object,
 ...
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_LIST_I_ERROR_OBJECT_IS_NULL if
 * object  is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_LIST_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 */
 ...
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_LIST_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_LIST_I_ERROR_LIST_IS_EMPTY if list
 * is empty.
 */
 ...
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_LIST_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_LIST_I_ERROR_LIST_IS_EMPTY if
 * list is empty.
 */
 ...
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_LIST_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_LIST_I_ERROR_ITEM_IS_NULL if
 * item is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_LIST_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_LIST_I_ERROR_END_OF_SEQUENCE if
 ...
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_LIST_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_LIST_I_ERROR_ITEM_NOT_FOUND if
 ...
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_LIST_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_LIST_I_ERROR_VALUE_IS_NULL if
 * value is <i>NULL</i>.
 * @throws
 * BUTTERFLYFISH_ORDERED_INCREMENTAL_LIST_I_ERROR_MEMORY_ALLOCATION_FAILED
 * if there is not enough memory to add the value.
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_LIST_I_ERROR_VALUE_IS_INVALID if
 * value is invalid.
 ...
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_LIST_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_LIST_I_ERROR_OTHER_IS_NULL if
 * other is <i>NULL</i>.
 * @throws
 * BUTTERFLYFISH_ORDERED_INCREMENTAL_LIST_I_ERROR_MEMORY_ALLOCATION_FAILED if
...
#endif /* _BUTTERFLYFISH_ORDERED_INCREMENTAL_LIST_I_H_ */
