#ifndef _BUTTERFLYFISH_SORTED_REDUCIBLE_SET_I_I_H_
#define _BUTTERFLYFISH_SORTED_REDUCIBLE_SET_I_I_H_
...
#define BUTTERFLYFISH_SORTED_REDUCIBLE_SET_I_I_ERROR_OBJECT_IS_NULL \
    BUTTERFLYFISH_SORTED_SET_I_I_ERROR_OBJECT_IS_NULL
#define BUTTERFLYFISH_SORTED_REDUCIBLE_SET_I_I_ERROR_OUT_IS_NULL \
    BUTTERFLYFISH_SORTED_SET_I_I_ERROR_OUT_IS_NULL
#define BUTTERFLYFISH_SORTED_REDUCIBLE_SET_I_I_ERROR_SET_IS_EMPTY \
    BUTTERFLYFISH_SORTED_SET_I_I_ERROR_SET_IS_EMPTY
#define BUTTERFLYFISH_SORTED_REDUCIBLE_SET_I_I_ERROR_ITEM_IS_NULL \
    BUTTERFLYFISH_SORTED_SET_I_I_ERROR_ITEM_IS_NULL
#define BUTTERFLYFISH_SORTED_REDUCIBLE_SET_I_I_ERROR_END_OF_SEQUENCE \
    BUTTERFLYFISH_SORTED_SET_I_I_ERROR_END_OF_SEQUENCE
#define BUTTERFLYFISH_SORTED_REDUCIBLE_SET_I_I_ERROR_OTHER_IS_NULL \
    BUTTERFLYFISH_SORTED_SET_I_I_ERROR_OTHER_IS_NULL
#define BUTTERFLYFISH_SORTED_REDUCIBLE_SET_I_I_ERROR_VALUE_IS_NULL \
    BUTTERFLYFISH_SORTED_SET_I_I_ERROR_VALUE_IS_NULL
#define BUTTERFLYFISH_SORTED_REDUCIBLE_SET_I_I_ERROR_MEMORY_ALLOCATION_FAILED \
    BUTTERFLYFISH_SORTED_SET_I_I_ERROR_MEMORY_ALLOCATION_FAILED
#define BUTTERFLYFISH_SORTED_REDUCIBLE_SET_I_I_ERROR_VALUE_NOT_FOUND \
    BUTTERFLYFISH_SORTED_SET_I_I_ERROR_VALUE_NOT_FOUND

struct butterflyfish_sorted_reducible_set_i_i {
    int (*const as_sorted_set)(
            const struct butterflyfish_sorted_reducible_set_i_i *object,
            const struct butterflyfish_sorted_set_i_i **out);

    int (*const as_reducible_set)(
            struct butterflyfish_sorted_reducible_set_i_i *object,
 ...
 * @throws BUTTERFLYFISH_SORTED_REDUCIBLE_SET_I_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_REDUCIBLE_SET_I_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 */
 ...
 * @throws BUTTERFLYFISH_SORTED_REDUCIBLE_SET_I_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_REDUCIBLE_SET_I_I_ERROR_SET_IS_EMPTY if set is
 * empty.
 */
 ...
 * @throws BUTTERFLYFISH_SORTED_REDUCIBLE_SET_I_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_REDUCIBLE_SET_I_I_ERROR_ITEM_IS_NULL if item is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_REDUCIBLE_SET_I_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_REDUCIBLE_SET_I_I_ERROR_END_OF_SEQUENCE if
 ...
 * @throws BUTTERFLYFISH_SORTED_REDUCIBLE_SET_I_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_REDUCIBLE_SET_I_I_ERROR_VALUE_IS_NULL if value is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_REDUCIBLE_SET_I_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_REDUCIBLE_SET_I_I_ERROR_MEMORY_ALLOCATION_FAILED
 ...
 * @throws BUTTERFLYFISH_SORTED_REDUCIBLE_SET_I_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_REDUCIBLE_SET_I_I_ERROR_OTHER_IS_NULL if other is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_REDUCIBLE_SET_I_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_REDUCIBLE_SET_I_I_ERROR_MEMORY_ALLOCATION_FAILED
 ...
 * @throws BUTTERFLYFISH_SORTED_REDUCIBLE_SET_I_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_REDUCIBLE_SET_I_I_ERROR_VALUE_NOT_FOUND if
 ...
 * @throws BUTTERFLYFISH_SORTED_REDUCIBLE_SET_I_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_REDUCIBLE_SET_I_I_ERROR_OTHER_IS_NULL if other
 * is <i>NULL</i>.
 ...
 * @throws BUTTERFLYFISH_SORTED_REDUCIBLE_SET_I_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_REDUCIBLE_SET_I_I_ERROR_VALUE_IS_NULL if
 * value is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_REDUCIBLE_SET_I_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_REDUCIBLE_SET_I_I_ERROR_VALUE_NOT_FOUND if no
...
#endif /* _BUTTERFLYFISH_SORTED_REDUCIBLE_SET_I_I_H_ */
