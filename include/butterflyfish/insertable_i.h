...
#define BUTTERFLYFISH_INSERTABLE_I_ERROR_OTHER_IS_NULL \
...
struct butterflyfish_insertable_i {
    int (*const as_ordered)(const struct butterflyfish_insertable_i *object,
                            const struct butterflyfish_ordered_i **out);

    int (*const insert)(struct butterflyfish_insertable_i *object,
                        const struct sea_turtle_integer *item,
                        const struct sea_turtle_integer *value);

    int (*const insert_all)(struct butterflyfish_insertable_i *object,
                            const struct sea_turtle_integer *item,
 ...
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_INSERTABLE_I_ERROR_OUT_IS_NULL if out is <i>NULL</i>.
 */
int butterflyfish_insertable_i_as_stream(
        const struct butterflyfish_insertable_i *object,
 ...
 * @throws BUTTERFLYFISH_INSERTABLE_I_ERROR_OUT_IS_NULL if out is <i>NULL</i>.
 */
int butterflyfish_insertable_i_as_collection(
        const struct butterflyfish_insertable_i *object,
 ...
 * @throws BUTTERFLYFISH_INSERTABLE_I_ERROR_OUT_IS_NULL if out is <i>NULL</i>.
 */
int butterflyfish_insertable_i_as_ordered(
        const struct butterflyfish_insertable_i *object,
        const struct butterflyfish_ordered_i **out);
 ...
 * @throws BUTTERFLYFISH_INSERTABLE_I_ERROR_OUT_IS_NULL if out is <i>NULL</i>.
 */
int butterflyfish_insertable_i_count(
        const struct butterflyfish_insertable_i *object,
        uintmax_t *out);
 ...
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_INSERTABLE_I_ERROR_OUT_IS_NULL if out is <i>NULL</i>.
 * @throws BUTTERFLYFISH_INSERTABLE_I_ERROR_INSERTABLE_IS_EMPTY if insertable
 * is empty.
 */
int butterflyfish_insertable_i_first(
        const struct butterflyfish_insertable_i *object,
 ...
 * is empty.
 */
int butterflyfish_insertable_i_last(
        const struct butterflyfish_insertable_i *object,
        const struct sea_turtle_integer **out);
 ...
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_INSERTABLE_I_ERROR_OUT_IS_NULL if out is <i>NULL</i>.
 * @throws BUTTERFLYFISH_INSERTABLE_I_ERROR_END_OF_SEQUENCE if there is no
 * next item.
 */
int butterflyfish_insertable_i_next(
        const struct butterflyfish_insertable_i *object,
        const struct sea_turtle_integer *item,
        const struct sea_turtle_integer **out);
 ...
 * previous item.
 */
int butterflyfish_insertable_i_prev(
        const struct butterflyfish_insertable_i *object,
        const struct sea_turtle_integer *item,
        const struct sea_turtle_integer **out);
 ...
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_INSERTABLE_I_ERROR_VALUE_ALREADY_EXISTS if value is
 * already present.
 ...
 */
int butterflyfish_insertable_i_insert(
        struct butterflyfish_insertable_i *object,
        const struct sea_turtle_integer *item,
        const struct sea_turtle_integer *value);
 ...
 * @throws BUTTERFLYFISH_INSERTABLE_I_ERROR_ITEM_IS_NULL if item is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_INSERTABLE_I_ERROR_OTHER_IS_NULL if other is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_INSERTABLE_I_ERROR_MEMORY_ALLOCATION_FAILED if there
 ...
 */
int butterflyfish_insertable_i_insert_all(
        struct butterflyfish_insertable_i *object,
        const struct sea_turtle_integer *item,
        const struct butterflyfish_stream_i *other);
