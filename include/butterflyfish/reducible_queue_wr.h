#ifndef _BUTTERFLYFISH_REDUCIBLE_QUEUE_WR_H_
#define _BUTTERFLYFISH_REDUCIBLE_QUEUE_WR_H_
...
#define BUTTERFLYFISH_REDUCIBLE_QUEUE_WR_ERROR_OBJECT_IS_NULL \
    BUTTERFLYFISH_COLLECTION_WR_ERROR_OBJECT_IS_NULL
#define BUTTERFLYFISH_REDUCIBLE_QUEUE_WR_ERROR_OUT_IS_NULL \
    BUTTERFLYFISH_COLLECTION_WR_ERROR_OUT_IS_NULL
#define BUTTERFLYFISH_REDUCIBLE_QUEUE_WR_ERROR_QUEUE_IS_EMPTY \
    BUTTERFLYFISH_COLLECTION_WR_ERROR_COLLECTION_IS_EMPTY
#define BUTTERFLYFISH_REDUCIBLE_QUEUE_WR_ERROR_ITEM_IS_NULL \
    BUTTERFLYFISH_COLLECTION_WR_ERROR_ITEM_IS_NULL
#define BUTTERFLYFISH_REDUCIBLE_QUEUE_WR_ERROR_END_OF_SEQUENCE \
    BUTTERFLYFISH_COLLECTION_WR_ERROR_END_OF_SEQUENCE

struct butterflyfish_reducible_queue_wr {
 ...
 * @throws BUTTERFLYFISH_REDUCIBLE_QUEUE_WR_ERROR_OBJECT_IS_NULL if object is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_REDUCIBLE_QUEUE_WR_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 */
int butterflyfish_reducible_queue_wr_as_stream(
        const struct butterflyfish_reducible_queue_wr *object,
 ...
 * <i>NULL</i>.
 */
int butterflyfish_reducible_queue_wr_as_collection(
        const struct butterflyfish_reducible_queue_wr *object,
 ...
 * @throws BUTTERFLYFISH_REDUCIBLE_QUEUE_WR_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_REDUCIBLE_QUEUE_WR_ERROR_QUEUE_IS_EMPTY if queue is
 * empty.
 */
 ...
 * @throws BUTTERFLYFISH_REDUCIBLE_QUEUE_WR_ERROR_OBJECT_IS_NULL if object is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_REDUCIBLE_QUEUE_WR_ERROR_ITEM_IS_NULL if item is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_REDUCIBLE_QUEUE_WR_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_REDUCIBLE_QUEUE_WR_ERROR_END_OF_SEQUENCE if there is
 * no next item.
 */
...
int butterflyfish_reducible_queue_wr_remove(
        struct butterflyfish_reducible_queue_wr *object,
        struct triggerfish_weak **out);

#endif /* _BUTTERFLYFISH_REDUCIBLE_QUEUE_WR_H_ */
