#ifndef _BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_H_
#define _BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_H_

#include <stddef.h>
#include <stdbool.h>
#include <stdint.h>

#include "sorted_settable_set_i_i.h"
#include "sorted_incremental_set_i_i.h"
#include "settable_incremental_set_i_i.h"

struct butterflyfish_map_i_i_entry;

#define BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_OBJECT_IS_NULL \
    BUTTERFLYFISH_SORTED_SETTABLE_SET_I_I_ERROR_OBJECT_IS_NULL
#define BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_OUT_IS_NULL \
    BUTTERFLYFISH_SORTED_SETTABLE_SET_I_I_ERROR_OUT_IS_NULL
#define BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_SET_IS_EMPTY \
    BUTTERFLYFISH_SORTED_SETTABLE_SET_I_I_ERROR_SET_IS_EMPTY
#define BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_ITEM_IS_NULL \
    BUTTERFLYFISH_SORTED_SETTABLE_SET_I_I_ERROR_ITEM_IS_NULL
#define BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_END_OF_SEQUENCE \
    BUTTERFLYFISH_SORTED_SETTABLE_SET_I_I_ERROR_END_OF_SEQUENCE
#define BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_OTHER_IS_NULL \
    BUTTERFLYFISH_SORTED_SETTABLE_SET_I_I_ERROR_OTHER_IS_NULL
#define BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_VALUE_IS_NULL \
    BUTTERFLYFISH_SORTED_SETTABLE_SET_I_I_ERROR_VALUE_IS_NULL
#define BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_VALUE_ALREADY_EXISTS \
    BUTTERFLYFISH_SORTED_SETTABLE_SET_I_I_ERROR_VALUE_ALREADY_EXISTS
#define BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_VALUE_IS_INVALID \
    BUTTERFLYFISH_SORTED_SETTABLE_SET_I_I_ERROR_VALUE_IS_INVALID
#define BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_MEMORY_ALLOCATION_FAILED \
    BUTTERFLYFISH_SORTED_SETTABLE_SET_I_I_ERROR_MEMORY_ALLOCATION_FAILED
#define BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_VALUE_NOT_FOUND \
 ...
 * @throws
 * BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_OUT_IS_NULL
 * if out is <i>NULL</i>.
 */
int butterflyfish_sorted_settable_incremental_set_i_i_as_stream(
        const struct butterflyfish_sorted_settable_incremental_set_i_i *object,
 ...
 * @throws BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_OUT_IS_NULL
 * if out is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_SET_IS_EMPTY
 * if set is empty.
 */
 ...
 * BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_ITEM_IS_NULL
 * if item is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_OUT_IS_NULL
 * if out is <i>NULL</i>.
 * @throws
 * BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_END_OF_SEQUENCE if
 ...
 * object is <i>NULL</i>.
 * @throws
 * BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_VALUE_IS_NULL if
 * value is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_OUT_IS_NULL
 * if out is <i>NULL</i>.
 * @throws
 ...
 * object is <i>NULL</i>.
 * @throws
 * BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_OTHER_IS_NULL if
 * other is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_OUT_IS_NULL
 * if out is <i>NULL</i>.
 * @throws
 ...
 * if out is <i>NULL</i>.
 * @throws
 * BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_VALUE_NOT_FOUND if
 ...
 * @throws
 * BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_VALUE_IS_INVALID if
 * value is invalid.
 * @throws
 * BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_MEMORY_ALLOCATION_FAILED
 ...
 * if item is <i>NULL</i>.
 * @throws
 * BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_VALUE_IS_NULL if value
 * is <i>NULL</i>.
 * @throws
 * BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_VALUE_NOT_FOUND if
 ...
 * if out is <i>NULL</i>.
 * @throws
 * BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_ERROR_VALUE_NOT_FOUND if no
...
#endif /* _BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_SET_I_I_H_ */
