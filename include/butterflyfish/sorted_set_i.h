...
struct butterflyfish_sorted_set_i {
    int (*const as_sorted)(const struct butterflyfish_sorted_set_i *object,
                           const struct butterflyfish_sorted_i **out);

    int (*const as_set)(const struct butterflyfish_sorted_set_i *object,
 ...
 * @throws BUTTERFLYFISH_SORTED_SET_I_ERROR_OBJECT_IS_NULL if object is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_SET_I_ERROR_ITEM_IS_NULL if item is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_SET_I_ERROR_OUT_IS_NULL if out is <i>NULL</i>.
 ...
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_SET_I_ERROR_OUT_IS_NULL if out is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_SET_I_ERROR_VALUE_NOT_FOUND if no value in
