#ifndef _BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_H_
#define _BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_H_
...
#include "sorted_incremental_list_i.h"
#include "settable_incremental_list_i.h"

struct sea_turtle_integer;

#define BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_ERROR_OBJECT_IS_NULL \
    BUTTERFLYFISH_SORTED_SETTABLE_LIST_I_ERROR_OBJECT_IS_NULL
#define BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_ERROR_OUT_IS_NULL \
    BUTTERFLYFISH_SORTED_SETTABLE_LIST_I_ERROR_OUT_IS_NULL
#define BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_ERROR_LIST_IS_EMPTY \
    BUTTERFLYFISH_SORTED_SETTABLE_LIST_I_ERROR_LIST_IS_EMPTY
#define BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_ERROR_ITEM_IS_NULL \
    BUTTERFLYFISH_SORTED_SETTABLE_LIST_I_ERROR_ITEM_IS_NULL
#define BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_ERROR_END_OF_SEQUENCE \
    BUTTERFLYFISH_SORTED_SETTABLE_LIST_I_ERROR_END_OF_SEQUENCE
#define BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_ERROR_INDEX_IS_OUT_OF_BOUNDS \
    BUTTERFLYFISH_SORTED_SETTABLE_LIST_I_ERROR_INDEX_IS_OUT_OF_BOUNDS
#define BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_ERROR_ITEM_NOT_FOUND \
    BUTTERFLYFISH_SORTED_SETTABLE_LIST_I_ERROR_ITEM_NOT_FOUND
#define BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_ERROR_VALUE_IS_NULL \
    BUTTERFLYFISH_SORTED_SETTABLE_LIST_I_ERROR_VALUE_IS_NULL
#define BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_ERROR_MEMORY_ALLOCATION_FAILED \
    BUTTERFLYFISH_SORTED_SETTABLE_LIST_I_ERROR_MEMORY_ALLOCATION_FAILED
#define BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_ERROR_VALUE_IS_INVALID \
    BUTTERFLYFISH_SORTED_SETTABLE_LIST_I_ERROR_VALUE_IS_INVALID
#define BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_ERROR_VALUE_NOT_FOUND \
    BUTTERFLYFISH_SORTED_SETTABLE_LIST_I_ERROR_VALUE_NOT_FOUND
#define BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_ERROR_OTHER_IS_NULL \
...
struct butterflyfish_sorted_settable_incremental_list_i {
    int (*const as_sorted_settable_list)(
            struct butterflyfish_sorted_settable_incremental_list_i *object,
 ...
 * @throws
 * BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_ERROR_OUT_IS_NULL
 * if out is <i>NULL</i>.
 */
int butterflyfish_sorted_settable_incremental_list_i_as_stream(
        const struct butterflyfish_sorted_settable_incremental_list_i *object,
 ...
 * if out is <i>NULL</i>.
 */
int butterflyfish_sorted_settable_incremental_list_i_as_collection(
        const struct butterflyfish_sorted_settable_incremental_list_i *object,
 ...
 * if out is <i>NULL</i>.
 */
int butterflyfish_sorted_settable_incremental_list_i_as_sorted(
        const struct butterflyfish_sorted_settable_incremental_list_i *object,
 ...
 * if out is <i>NULL</i>.
 */
int butterflyfish_sorted_settable_incremental_list_i_as_list(
        const struct butterflyfish_sorted_settable_incremental_list_i *object,
 ...
 * if out is <i>NULL</i>.
 */
int butterflyfish_sorted_settable_incremental_list_i_as_settable(
        struct butterflyfish_sorted_settable_incremental_list_i *object,
 ...
 * if out is <i>NULL</i>.
 */
int butterflyfish_sorted_settable_incremental_list_i_as_addable(
        struct butterflyfish_sorted_settable_incremental_list_i *object,
 ...
 * if out is <i>NULL</i>.
 */
int butterflyfish_sorted_settable_incremental_list_i_as_sorted_list(
        const struct butterflyfish_sorted_settable_incremental_list_i *object,
 ...
 * if out is <i>NULL</i>.
 */
int butterflyfish_sorted_settable_incremental_list_i_as_settable_list(
        struct butterflyfish_sorted_settable_incremental_list_i *object,
 ...
 * if out is <i>NULL</i>.
 */
int butterflyfish_sorted_settable_incremental_list_i_as_incremental_list(
        struct butterflyfish_sorted_settable_incremental_list_i *object,
 ...
 * if out is <i>NULL</i>.
 */
int butterflyfish_sorted_settable_incremental_list_i_as_sorted_settable_list(
        struct butterflyfish_sorted_settable_incremental_list_i *object,
        struct butterflyfish_sorted_settable_list_i **out);
 ...
 * if out is <i>NULL</i>.
 */
int butterflyfish_sorted_settable_incremental_list_i_as_sorted_incremental_list(
        struct butterflyfish_sorted_settable_incremental_list_i *object,
        struct butterflyfish_sorted_incremental_list_i **out);
 ...
 * if out is <i>NULL</i>.
 */
int butterflyfish_sorted_settable_incremental_list_i_count(
        const struct butterflyfish_sorted_settable_incremental_list_i *object,
        uintmax_t *out);
 ...
 * @throws BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_ERROR_OUT_IS_NULL
 * if out is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_ERROR_LIST_IS_EMPTY
 * if list is empty.
 */
int butterflyfish_sorted_settable_incremental_list_i_first(
        const struct butterflyfish_sorted_settable_incremental_list_i *object,
 ...
 * if list is empty.
 */
int butterflyfish_sorted_settable_incremental_list_i_last(
        const struct butterflyfish_sorted_settable_incremental_list_i *object,
        const struct sea_turtle_integer **out);
 ...
 * BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_ERROR_OBJECT_IS_NULL
 * if object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_ERROR_ITEM_IS_NULL
 * if item is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_ERROR_OUT_IS_NULL
 * if out is <i>NULL</i>.
 * @throws
 ...
 */
int butterflyfish_sorted_settable_incremental_list_i_next(
        const struct butterflyfish_sorted_settable_incremental_list_i *object,
 ...
 */
int butterflyfish_sorted_settable_incremental_list_i_prev(
        const struct butterflyfish_sorted_settable_incremental_list_i *object,
        const struct sea_turtle_integer *item,
        const struct sea_turtle_integer **out);
 ...
 */
int butterflyfish_sorted_settable_incremental_list_i_get(
        const struct butterflyfish_sorted_settable_incremental_list_i *object,
        uintmax_t at,
        const struct sea_turtle_integer **out);
 ...
 */
int butterflyfish_sorted_settable_incremental_list_i_at(
        const struct butterflyfish_sorted_settable_incremental_list_i *object,
        const struct sea_turtle_integer *item,
        uintmax_t *out);
 ...
 */
int butterflyfish_sorted_settable_incremental_list_i_set_item(
        struct butterflyfish_sorted_settable_incremental_list_i *object,
        const struct sea_turtle_integer *item,
 ...
 * BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_ERROR_MEMORY_ALLOCATION_FAILED
 * if there is not enough memory to set the item to value.
 * @throws BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_ERROR_VALUE_IS_INVALID
 * if value is invalid.
 * @note <b>value</b> is copied and then item at index is set to it.
 */
int butterflyfish_sorted_settable_incremental_list_i_set(
        struct butterflyfish_sorted_settable_incremental_list_i *object,
        uintmax_t at,
        const struct sea_turtle_integer *value);
 ...
 * BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_ERROR_OBJECT_IS_NULL
 * if object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_ERROR_VALUE_IS_NULL
 * if value is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_ERROR_OUT_IS_NULL
 * if out is <i>NULL</i>.
 * @throws
 ...
 */
int butterflyfish_sorted_settable_incremental_list_i_ceiling(
        const struct butterflyfish_sorted_settable_incremental_list_i *object,
        const struct sea_turtle_integer *value,
        const struct sea_turtle_integer **out);
 ...
 * if there is insufficient memory to find the item.
 */
int butterflyfish_sorted_settable_incremental_list_i_floor(
        const struct butterflyfish_sorted_settable_incremental_list_i *object,
        const struct sea_turtle_integer *value,
        const struct sea_turtle_integer **out);
 ...
 * if there is insufficient memory to find the item.
 */
int butterflyfish_sorted_settable_incremental_list_i_higher(
        const struct butterflyfish_sorted_settable_incremental_list_i *object,
        const struct sea_turtle_integer *value,
        const struct sea_turtle_integer **out);
 ...
 * if there is insufficient memory to find the item.
 */
int butterflyfish_sorted_settable_incremental_list_i_lower(
        const struct butterflyfish_sorted_settable_incremental_list_i *object,
        const struct sea_turtle_integer *value,
        const struct sea_turtle_integer **out);
 ...
 */
int butterflyfish_sorted_settable_incremental_list_i_add(
        struct butterflyfish_sorted_settable_incremental_list_i *object,
        const struct sea_turtle_integer *value);
 ...
 */
int butterflyfish_sorted_settable_incremental_list_i_add_all(
        struct butterflyfish_sorted_settable_incremental_list_i *object,
        const struct butterflyfish_stream_i *other);

#endif /* _BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_I_H_ */
