#ifndef _BUTTERFLYFISH_LIST_SR_H_
#define _BUTTERFLYFISH_LIST_SR_H_

#include <stddef.h>
#include <stdbool.h>
#include <stdint.h>

#include "reducible_list_sr.h"

struct triggerfish_strong;

#define BUTTERFLYFISH_LIST_SR_ERROR_OBJECT_IS_NULL \
    BUTTERFLYFISH_REDUCIBLE_LIST_SR_ERROR_OBJECT_IS_NULL
#define BUTTERFLYFISH_LIST_SR_ERROR_OUT_IS_NULL \
    BUTTERFLYFISH_REDUCIBLE_LIST_SR_ERROR_OUT_IS_NULL
#define BUTTERFLYFISH_LIST_SR_ERROR_LIST_IS_EMPTY \
    BUTTERFLYFISH_REDUCIBLE_LIST_SR_ERROR_LIST_IS_EMPTY
#define BUTTERFLYFISH_LIST_SR_ERROR_ITEM_IS_NULL \
    BUTTERFLYFISH_REDUCIBLE_LIST_SR_ERROR_ITEM_IS_NULL
#define BUTTERFLYFISH_LIST_SR_ERROR_END_OF_SEQUENCE \
    BUTTERFLYFISH_REDUCIBLE_LIST_SR_ERROR_END_OF_SEQUENCE
#define BUTTERFLYFISH_LIST_SR_ERROR_VALUE_IS_NULL \
    BUTTERFLYFISH_REDUCIBLE_LIST_SR_ERROR_VALUE_IS_NULL
#define BUTTERFLYFISH_LIST_SR_ERROR_MEMORY_ALLOCATION_FAILED \
    BUTTERFLYFISH_REDUCIBLE_LIST_SR_ERROR_MEMORY_ALLOCATION_FAILED
#define BUTTERFLYFISH_LIST_SR_ERROR_INDEX_IS_OUT_OF_BOUNDS \
    BUTTERFLYFISH_REDUCIBLE_LIST_SR_ERROR_INDEX_IS_OUT_OF_BOUNDS
#define BUTTERFLYFISH_LIST_SR_ERROR_ITEM_IS_OUT_OF_BOUNDS \
    BUTTERFLYFISH_REDUCIBLE_LIST_SR_ERROR_ITEM_IS_OUT_OF_BOUNDS
#define BUTTERFLYFISH_LIST_SR_ERROR_VALUE_IS_INVALID \
    BUTTERFLYFISH_REDUCIBLE_LIST_SR_ERROR_VALUE_IS_INVALID
#define BUTTERFLYFISH_LIST_SR_ERROR_OTHER_IS_NULL \
    BUTTERFLYFISH_REDUCIBLE_LIST_SR_ERROR_OTHER_IS_NULL

struct butterflyfish_list_sr {
 ...
 * @throws BUTTERFLYFISH_LIST_SR_ERROR_OUT_IS_NULL if out is <i>NULL</i>.
 */
int butterflyfish_list_sr_as_stream(
        const struct butterflyfish_list_sr *object,
...
int butterflyfish_list_sr_as_fixed_list(
        ...
        struct butterflyfish_fixed_list_sr **out);
 ...
 * @throws BUTTERFLYFISH_LIST_SR_ERROR_OBJECT_IS_NULL if object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_LIST_SR_ERROR_OUT_IS_NULL if out is <i>NULL</i>.
 * @throws BUTTERFLYFISH_LIST_SR_ERROR_LIST_IS_EMPTY if list is empty.
 */
 ...
 * @throws BUTTERFLYFISH_LIST_SR_ERROR_OUT_IS_NULL if out is <i>NULL</i>.
 * @throws BUTTERFLYFISH_LIST_SR_ERROR_END_OF_SEQUENCE if there is no next item.
 */
 ...
 * @throws BUTTERFLYFISH_LIST_SR_ERROR_ITEM_IS_NULL if item is <i>NULL</i>.
 * @throws BUTTERFLYFISH_LIST_SR_ERROR_OUT_IS_NULL if out is <i>NULL</i>.
 * @throws BUTTERFLYFISH_LIST_SR_ERROR_END_OF_SEQUENCE if there is no previous
 * item.
 */
 ...
 * @throws BUTTERFLYFISH_LIST_SR_ERROR_VALUE_IS_INVALID if value is invalid.
 */
