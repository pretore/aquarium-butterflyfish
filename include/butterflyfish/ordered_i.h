...
struct butterflyfish_ordered_i {
    int (*const as_collection)(
            const struct butterflyfish_ordered_i *object,
 ...
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_I_ERROR_OUT_IS_NULL if out is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_I_ERROR_ORDERED_IS_EMPTY if ordered is empty.
 */
 ...
 * @throws BUTTERFLYFISH_ORDERED_I_ERROR_OBJECT_IS_NULL if object is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_I_ERROR_ITEM_IS_NULL if item is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_I_ERROR_OUT_IS_NULL if out is <i>NULL</i>.
