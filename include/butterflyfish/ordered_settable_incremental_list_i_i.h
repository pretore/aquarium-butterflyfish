#ifndef _BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_H_
#define _BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_H_
...
#include "ordered_incremental_list_i_i.h"
#include "settable_incremental_list_i_i.h"

struct butterflyfish_map_i_i_entry;

#define BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL \
    BUTTERFLYFISH_ORDERED_SETTABLE_LIST_I_I_ERROR_OBJECT_IS_NULL
#define BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OUT_IS_NULL \
    BUTTERFLYFISH_ORDERED_SETTABLE_LIST_I_I_ERROR_OUT_IS_NULL
#define BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_LIST_IS_EMPTY \
    BUTTERFLYFISH_ORDERED_SETTABLE_LIST_I_I_ERROR_LIST_IS_EMPTY
#define BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_ITEM_IS_NULL \
    BUTTERFLYFISH_ORDERED_SETTABLE_LIST_I_I_ERROR_ITEM_IS_NULL
#define BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_END_OF_SEQUENCE \
    BUTTERFLYFISH_ORDERED_SETTABLE_LIST_I_I_ERROR_END_OF_SEQUENCE
#define BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_INDEX_IS_OUT_OF_BOUNDS \
    BUTTERFLYFISH_ORDERED_SETTABLE_LIST_I_I_ERROR_INDEX_IS_OUT_OF_BOUNDS
#define BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_ITEM_NOT_FOUND \
    BUTTERFLYFISH_ORDERED_SETTABLE_LIST_I_I_ERROR_ITEM_NOT_FOUND
#define BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_VALUE_IS_NULL \
    BUTTERFLYFISH_ORDERED_SETTABLE_LIST_I_I_ERROR_VALUE_IS_NULL
#define BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_MEMORY_ALLOCATION_FAILED \
    BUTTERFLYFISH_ORDERED_SETTABLE_LIST_I_I_ERROR_MEMORY_ALLOCATION_FAILED
#define BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_VALUE_IS_INVALID \
    BUTTERFLYFISH_ORDERED_SETTABLE_LIST_I_I_ERROR_VALUE_IS_INVALID
#define BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OTHER_IS_NULL \
...
struct butterflyfish_ordered_settable_incremental_list_i_i {
    int (*const as_ordered_settable_list)(
            struct butterflyfish_ordered_settable_incremental_list_i_i *object,
 ...
 * @throws
 * BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OUT_IS_NULL
 * if out is <i>NULL</i>.
 */
int butterflyfish_ordered_settable_incremental_list_i_i_as_stream(
        const struct butterflyfish_ordered_settable_incremental_list_i_i *object,
 ...
 * if out is <i>NULL</i>.
 */
int butterflyfish_ordered_settable_incremental_list_i_i_as_collection(
        const struct butterflyfish_ordered_settable_incremental_list_i_i *object,
 ...
 * if out is <i>NULL</i>.
 */
int butterflyfish_ordered_settable_incremental_list_i_i_as_ordered(
        const struct butterflyfish_ordered_settable_incremental_list_i_i *object,
 ...
 * if out is <i>NULL</i>.
 */
int butterflyfish_ordered_settable_incremental_list_i_i_as_list(
        const struct butterflyfish_ordered_settable_incremental_list_i_i *object,
 ...
 * if out is <i>NULL</i>.
 */
int butterflyfish_ordered_settable_incremental_list_i_i_as_addable(
        struct butterflyfish_ordered_settable_incremental_list_i_i *object,
 ...
 * if out is <i>NULL</i>.
 */
int butterflyfish_ordered_settable_incremental_list_i_i_as_settable(
        struct butterflyfish_ordered_settable_incremental_list_i_i *object,
 ...
 * if out is <i>NULL</i>.
 */
int butterflyfish_ordered_settable_incremental_list_i_i_as_insertable(
        struct butterflyfish_ordered_settable_incremental_list_i_i *object,
 ...
 * if out is <i>NULL</i>.
 */
int butterflyfish_ordered_settable_incremental_list_i_i_as_ordered_list(
        const struct butterflyfish_ordered_settable_incremental_list_i_i *object,
 ...
 * if out is <i>NULL</i>.
 */
int butterflyfish_ordered_settable_incremental_list_i_i_as_incremental_list(
        struct butterflyfish_ordered_settable_incremental_list_i_i *object,
 ...
 * if out is <i>NULL</i>.
 */
int butterflyfish_ordered_settable_incremental_list_i_i_as_settable_list(
        struct butterflyfish_ordered_settable_incremental_list_i_i *object,
 ...
 * if out is <i>NULL</i>.
 */
int butterflyfish_ordered_settable_incremental_list_i_i_as_ordered_incremental_list(
        struct butterflyfish_ordered_settable_incremental_list_i_i *object,
        struct butterflyfish_ordered_incremental_list_i_i **out);
 ...
 * if out is <i>NULL</i>.
 */
int butterflyfish_ordered_settable_incremental_list_i_i_as_ordered_settable_list(
        struct butterflyfish_ordered_settable_incremental_list_i_i *object,
        struct butterflyfish_ordered_settable_list_i_i **out);
 ...
 * object is <i>NULL</i>.
 * @throws
 * BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OUT_IS_NULL if out
 * is <i>NULL</i>.
 */
int butterflyfish_ordered_settable_incremental_list_i_i_count(
        const struct butterflyfish_ordered_settable_incremental_list_i_i *object,
        uintmax_t *out);
 ...
 * is <i>NULL</i>.
 * @throws
 * BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_LIST_IS_EMPTY if
 * list is empty.
 */
int butterflyfish_ordered_settable_incremental_list_i_i_first(
        const struct butterflyfish_ordered_settable_incremental_list_i_i *object,
 ...
 * list is empty.
 */
int butterflyfish_ordered_settable_incremental_list_i_i_last(
        const struct butterflyfish_ordered_settable_incremental_list_i_i *object,
        const struct butterflyfish_map_i_i_entry **out);
 ...
 * object is <i>NULL</i>.
 * @throws
 * BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_ITEM_IS_NULL if
 * item is <i>NULL</i>.
 * @throws
 * BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OUT_IS_NULL if out
 * is <i>NULL</i>.
 * @throws
 * BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_END_OF_SEQUENCE if
 * there is no next item.
 */
int butterflyfish_ordered_settable_incremental_list_i_i_next(
        const struct butterflyfish_ordered_settable_incremental_list_i_i *object,
 ...
 */
int butterflyfish_ordered_settable_incremental_list_i_i_prev(
        const struct butterflyfish_ordered_settable_incremental_list_i_i *object,
        const struct butterflyfish_map_i_i_entry *item,
        const struct butterflyfish_map_i_i_entry **out);
 ...
 */
int butterflyfish_ordered_settable_incremental_list_i_i_get(
        const struct butterflyfish_ordered_settable_incremental_list_i_i *object,
        uintmax_t at,
        const struct butterflyfish_map_i_i_entry **out);
 ...
 * is <i>NULL</i>.
 * @throws
 * BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_ITEM_NOT_FOUND if
 * item is not contained within the settable list.
 */
int butterflyfish_ordered_settable_incremental_list_i_i_at(
        const struct butterflyfish_ordered_settable_incremental_list_i_i *object,
        const struct butterflyfish_map_i_i_entry *item,
        uintmax_t *out);
 ...
 * object is <i>NULL</i>.
 * @throws
 * BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_VALUE_IS_NULL if
 * value is <i>NULL</i>.
 * @throws
 * BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_INDEX_IS_OUT_OF_BOUNDS
 * if at does not refer to an item contained within the settable list.
 ...
 * @throws
 * BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_VALUE_IS_INVALID if
 * value is invalid.
 * @note <b>value</b> is copied and then item at index is set to it.
 */
int butterflyfish_ordered_settable_incremental_list_i_i_set(
        struct butterflyfish_ordered_settable_incremental_list_i_i *object,
        uintmax_t at,
 ...
 * value is <i>NULL</i>.
 * @throws
 * BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_MEMORY_ALLOCATION_FAILED if
 ...
 */
int butterflyfish_ordered_settable_incremental_list_i_i_set_item(
        struct butterflyfish_ordered_settable_incremental_list_i_i *object,
        const struct butterflyfish_map_i_i_entry *item,
        const struct butterflyfish_map_i_i_entry *value);
 ...
 */
int butterflyfish_ordered_settable_incremental_list_i_i_add(
        struct butterflyfish_ordered_settable_incremental_list_i_i *object,
        const struct butterflyfish_map_i_i_entry *value);
 ...
 * object is <i>NULL</i>.
 * @throws
 * BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_OTHER_IS_NULL if
 * other is <i>NULL</i>.
 * @throws
 * BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_ERROR_MEMORY_ALLOCATION_FAILED if
 ...
 */
int butterflyfish_ordered_settable_incremental_list_i_i_add_all(
        struct butterflyfish_ordered_settable_incremental_list_i_i *object,
 ...
 */
int butterflyfish_ordered_settable_incremental_list_i_i_insert(
        struct butterflyfish_ordered_settable_incremental_list_i_i *object,
        const struct butterflyfish_map_i_i_entry *item,
        const struct butterflyfish_map_i_i_entry *value);
 ...
 */
int butterflyfish_ordered_settable_incremental_list_i_i_insert_all(
        struct butterflyfish_ordered_settable_incremental_list_i_i *object,
        const struct butterflyfish_map_i_i_entry *item,
        const struct butterflyfish_stream_i_i *other);

#endif /* _BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_LIST_I_I_H_ */
