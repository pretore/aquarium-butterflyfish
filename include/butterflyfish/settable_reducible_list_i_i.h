...
#define BUTTERFLYFISH_SETTABLE_REDUCIBLE_LIST_I_I_ERROR_MEMORY_ALLOCATION_FAILED \
...
struct butterflyfish_settable_reducible_list_i_i {
    ...
    const struct butterflyfish_settable_list_i_i *const as_settable_list;
    const struct butterflyfish_reducible_list_i_i *const as_reducible_list;
     ...
     * object is <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_LIST_I_I_ERROR_OUT_IS_NULL if
     * out is <i>NULL</i>.
     */
     ...
     * @return On success <i>0</i>, otherwise an error code.
     * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_LIST_I_I_ERROR_OBJECT_IS_NULL
     ...
     * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_LIST_I_I_ERROR_OBJECT_IS_NULL
     * if object is <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_LIST_I_I_ERROR_ITEM_IS_NULL if
     * item is <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_LIST_I_I_ERROR_OUT_IS_NULL if
     * out is <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_LIST_I_I_ERROR_END_OF_SEQUENCE
     ...
     * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_LIST_I_I_ERROR_OUT_IS_NULL if
     * out is <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_LIST_I_I_ERROR_INDEX_IS_OUT_OF_BOUNDS
     ...
     * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_LIST_I_I_ERROR_OUT_IS_NULL if
     * out is <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_LIST_I_I_ERROR_ITEM_NOT_FOUND
     ...
     * value is <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_LIST_I_I_ERROR_VALUE_IS_INVALID
     * if value is invalid.
     * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_LIST_I_I_ERROR_VALUE_ALREADY_EXISTS
     * if value is already present.
     * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_LIST_I_I_ERROR_MEMORY_ALLOCATION_FAILED
     ...
     * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_LIST_I_I_ERROR_OBJECT_IS_NULL
     * if object is <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_LIST_I_I_ERROR_ITEM_IS_NULL
     * if item is <i>NULL</i>.
