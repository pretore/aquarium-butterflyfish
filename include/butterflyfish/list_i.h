...
#define BUTTERFLYFISH_LIST_I_ERROR_ITEM_NOT_FOUND \
...
struct butterflyfish_list_i {
     ...
     * @throws BUTTERFLYFISH_LIST_I_ERROR_OBJECT_IS_NULL if object is
     * <i>NULL</i>.
     ...
     * @throws BUTTERFLYFISH_LIST_I_ERROR_OUT_IS_NULL if out is <i>NULL</i>.
     * @throws BUTTERFLYFISH_LIST_I_ERROR_END_OF_SEQUENCE if there is no next
     * item.
     */
     ...
     * @throws BUTTERFLYFISH_LIST_I_ERROR_ITEM_IS_NULL if item is <i>NULL</i>.
     * @throws BUTTERFLYFISH_LIST_I_ERROR_OUT_IS_NULL if out is <i>NULL</i>.
     * @throws BUTTERFLYFISH_LIST_I_ERROR_END_OF_SEQUENCE if there is no
     * previous item.
     */
     ...
     * @throws BUTTERFLYFISH_LIST_I_ERROR_ITEM_IS_NULL if item is <i>NULL</i>.
     * @throws BUTTERFLYFISH_LIST_I_ERROR_OUT_IS_NULL if out is <i>NULL</i>.
     * @throws BUTTERFLYFISH_LIST_I_ERROR_ITEM_NOT_FOUND if item is not
