...
struct butterflyfish_list_i {
    int (*const as_collection)(const struct butterflyfish_list_i *object,
                               const struct butterflyfish_collection_i **out);

    int (*const get)(const struct butterflyfish_list_i *object,
                     uintmax_t at,
                     const struct sea_turtle_integer **out);

    int (*const at)(const struct butterflyfish_list_i *object,
 ...
 * @throws BUTTERFLYFISH_LIST_I_ERROR_ITEM_IS_NULL if item is <i>NULL</i>.
 * @throws BUTTERFLYFISH_LIST_I_ERROR_OUT_IS_NULL if out is <i>NULL</i>.
 * @throws BUTTERFLYFISH_LIST_I_ERROR_ITEM_NOT_FOUND if item is not contained
 * within the list.
 */
