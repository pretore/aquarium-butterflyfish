...
struct butterflyfish_mutable_list_i_i {
     ...
     * @throws BUTTERFLYFISH_MUTABLE_LIST_I_I_ERROR_OUT_IS_NULL if out is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_MUTABLE_LIST_I_I_ERROR_LIST_IS_EMPTY if list is
     * empty.
     */
     ...
     * @throws BUTTERFLYFISH_MUTABLE_LIST_I_I_ERROR_OUT_IS_NULL if out is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_MUTABLE_LIST_I_I_ERROR_END_OF_SEQUENCE if there is
     * no next item.
     */
     ...
     * @throws BUTTERFLYFISH_MUTABLE_LIST_I_I_ERROR_OUT_IS_NULL if out is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_MUTABLE_LIST_I_I_ERROR_INDEX_IS_OUT_OF_BOUNDS
     ...
     * @throws BUTTERFLYFISH_MUTABLE_LIST_I_I_ERROR_OUT_IS_NULL if out is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_MUTABLE_LIST_I_I_ERROR_ITEM_NOT_FOUND if item is
     ...
     * is invalid.
     * @throws BUTTERFLYFISH_MUTABLE_LIST_I_I_ERROR_VALUE_ALREADY_EXISTS if
     ...
     * @throws BUTTERFLYFISH_MUTABLE_LIST_I_I_ERROR_VALUE_IS_NULL if value is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_MUTABLE_LIST_I_I_ERROR_INDEX_IS_OUT_OF_BOUNDS if
     * at does not refer to an item contained within the list.
     * @throws BUTTERFLYFISH_MUTABLE_LIST_I_I_ERROR_MEMORY_ALLOCATION_FAILED
     * if there is not enough memory to set the item to value.
     * @throws BUTTERFLYFISH_MUTABLE_LIST_I_I_ERROR_VALUE_IS_INVALID
     * if value is invalid.
