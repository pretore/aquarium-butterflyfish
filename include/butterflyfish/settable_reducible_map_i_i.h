...
struct butterflyfish_settable_reducible_map_i_i {
    ...
    const struct butterflyfish_settable_reducible_set_i *const keys;
     ...
     * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_OBJECT_IS_NULL
     * if object is <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_OUT_IS_NULL if
     * out is <i>NULL</i>.
     */
     ...
     * @return On success <i>0</i>, otherwise an error code.
     * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_OBJECT_IS_NULL if object is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_OUT_IS_NULL if out is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_MAP_IS_EMPTY if map is
     * empty.
     */
     ...
     * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_OBJECT_IS_NULL if object is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_ITEM_IS_NULL if item is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_OUT_IS_NULL if out is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_END_OF_SEQUENCE if there
     * is no next item.
     */
     ...
     * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_OUT_IS_NULL if out is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_MEMORY_ALLOCATION_FAILED
     ...
     * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_OBJECT_IS_NULL if object is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_VALUE_IS_NULL if value is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_OUT_IS_NULL if out is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_MEMORY_ALLOCATION_FAILED
     ...
     * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_OUT_IS_NULL if out is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_KEY_NOT_FOUND if key is
     ...
     * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_VALUE_IS_NULL if value is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_KEY_NOT_FOUND if key is not
     * in the map instance.
     * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_VALUE_IS_INVALID if value is
     * invalid.
     * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_MEMORY_ALLOCATION_FAILED if
     ...
     * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_KEY_NOT_FOUND if key is not
     * in the map instance.
     * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_KEY_ALREADY_EXISTS if key
     ...
     * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_OBJECT_IS_NULL if object is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_ENTRY_IS_NULL if entry is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_VALUE_IS_NULL if value is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_KEY_ALREADY_EXISTS if key
     * is already present in the map.
     * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_VALUE_IS_INVALID if value
     * is invalid.
     * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_MEMORY_ALLOCATION_FAILED if
     ...
     * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_OBJECT_IS_NULL
     * if object is <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_KEY_IS_NULL if
     * key is <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_I_I_ERROR_KEY_NOT_FOUND
