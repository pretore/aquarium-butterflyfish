...
#define BUTTERFLYFISH_ADDABLE_I_I_ERROR_OTHER_IS_NULL \
...
struct butterflyfish_addable_i_i {
    ...
    int (*const add_all)(struct butterflyfish_addable_i_i *object,
 ...
 * @throws BUTTERFLYFISH_ADDABLE_I_I_ERROR_OBJECT_IS_NULL if object is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ADDABLE_I_I_ERROR_ITEM_IS_NULL if item is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ADDABLE_I_I_ERROR_OUT_IS_NULL if out is <i>NULL</i>.
...
int butterflyfish_addable_i_i_add(
        struct butterflyfish_addable_i_i *object,
        const struct butterflyfish_map_i_i_entry *value);
