#ifndef _BUTTERFLYFISH_ORDERED_I_I_H_
#define _BUTTERFLYFISH_ORDERED_I_I_H_
...
#define BUTTERFLYFISH_ORDERED_I_I_ERROR_ORDERED_IS_EMPTY \
    BUTTERFLYFISH_COLLECTION_I_I_ERROR_COLLECTION_IS_EMPTY
#define BUTTERFLYFISH_ORDERED_I_I_ERROR_ITEM_IS_NULL \
    BUTTERFLYFISH_COLLECTION_I_I_ERROR_ITEM_IS_NULL
#define BUTTERFLYFISH_ORDERED_I_I_ERROR_END_OF_SEQUENCE \
    BUTTERFLYFISH_COLLECTION_I_I_ERROR_END_OF_SEQUENCE

struct butterflyfish_ordered_i_i {
 ...
 */
int butterflyfish_ordered_i_i_as_stream(
        const struct butterflyfish_ordered_i_i *object,
 ...
 * @throws BUTTERFLYFISH_ORDERED_I_I_ERROR_OUT_IS_NULL if out is <i>NULL</i>.
 */
int butterflyfish_ordered_i_i_as_collection(
        const struct butterflyfish_ordered_i_i *object,
        const struct butterflyfish_collection_i_i **out);
 ...
 * @throws BUTTERFLYFISH_ORDERED_I_I_ERROR_OUT_IS_NULL if out is <i>NULL</i>.
 */
int butterflyfish_ordered_i_i_count(
        const struct butterflyfish_ordered_i_i *object,
        uintmax_t *out);
 ...
 * @throws BUTTERFLYFISH_ORDERED_I_I_ERROR_OBJECT_IS_NULL if object is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_I_I_ERROR_ITEM_IS_NULL if item is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_I_I_ERROR_OUT_IS_NULL if out is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_I_I_ERROR_END_OF_SEQUENCE if there is no next
 * item.
 */
int butterflyfish_ordered_i_i_next(
        const struct butterflyfish_ordered_i_i *object,
 ...
 * @throws BUTTERFLYFISH_ORDERED_I_I_ERROR_ITEM_IS_NULL if item is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_I_I_ERROR_OUT_IS_NULL if out is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_I_I_ERROR_END_OF_SEQUENCE if there is no
 * previous item.
 */
int butterflyfish_ordered_i_i_prev(
        const struct butterflyfish_ordered_i_i *object,
        const struct butterflyfish_map_i_i_entry *item,
        const struct butterflyfish_map_i_i_entry **out);

#endif /* _BUTTERFLYFISH_ORDERED_I_I_H_ */
