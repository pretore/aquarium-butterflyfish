...
#define BUTTERFLYFISH_ORDERED_MAP_I_I_ERROR_KEY_ALREADY_EXISTS \
...
#define BUTTERFLYFISH_ORDERED_MAP_I_I_ERROR_FUNCTION_IS_NULL \
...
int butterflyfish_ordered_map_i_i_first(
        const struct butterflyfish_ordered_map_i_i *object,
        struct butterflyfish_map_entry_i_i **out);
...
int butterflyfish_ordered_map_i_i_remove_entry(
        struct butterflyfish_ordered_map_i_i *object,
        const struct butterflyfish_map_entry_i_i *entry);
 ...
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_MAP_I_I_ERROR_KEY_ALREADY_EXISTS if key is
 ...
 * @throws BUTTERFLYFISH_ORDERED_MAP_I_I_ERROR_VALUE_IS_NULL if value is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_MAP_I_I_ERROR_KEY_NOT_FOUND if key is not
 * present in the map.
 * @throws BUTTERFLYFISH_ORDERED_MAP_I_I_ERROR_MEMORY_ALLOCATION_FAILED if
 ...
 * @throws BUTTERFLYFISH_ORDERED_MAP_I_I_ERROR_OTHER_IS_NULL if other is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_MAP_I_I_ERROR_FUNCTION_IS_NULL if function is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_MAP_I_I_ERROR_MEMORY_ALLOCATION_FAILED if
 ...
 * @throws BUTTERFLYFISH_ORDERED_MAP_I_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_MAP_I_I_ERROR_KEY_NOT_FOUND if key not found
 * in map.
 * @throws BUTTERFLYFISH_ORDERED_MAP_I_I_ERROR_MEMORY_ALLOCATION_FAILED if
