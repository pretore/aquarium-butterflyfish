#ifndef _BUTTERFLYFISH_ORDERED_MAP_I_I_H_
#define _BUTTERFLYFISH_ORDERED_MAP_I_I_H_
...
#define BUTTERFLYFISH_ORDERED_MAP_I_I_ERROR_OBJECT_IS_NULL \
    BUTTERFLYFISH_MAP_I_I_ERROR_OBJECT_IS_NULL
#define BUTTERFLYFISH_ORDERED_MAP_I_I_ERROR_OUT_IS_NULL \
    BUTTERFLYFISH_MAP_I_I_ERROR_OUT_IS_NULL
#define BUTTERFLYFISH_ORDERED_MAP_I_I_ERROR_MAP_IS_EMPTY \
    BUTTERFLYFISH_MAP_I_I_ERROR_MAP_IS_EMPTY
#define BUTTERFLYFISH_ORDERED_MAP_I_I_ERROR_ITEM_IS_NULL \
    BUTTERFLYFISH_MAP_I_I_ERROR_ITEM_IS_NULL
#define BUTTERFLYFISH_ORDERED_MAP_I_I_ERROR_END_OF_SEQUENCE \
    BUTTERFLYFISH_MAP_I_I_ERROR_END_OF_SEQUENCE
#define BUTTERFLYFISH_ORDERED_MAP_I_I_ERROR_OTHER_IS_NULL \
    BUTTERFLYFISH_MAP_I_I_ERROR_OTHER_IS_NULL
#define BUTTERFLYFISH_ORDERED_MAP_I_I_ERROR_VALUE_IS_NULL \
    BUTTERFLYFISH_MAP_I_I_ERROR_VALUE_IS_NULL
#define BUTTERFLYFISH_ORDERED_MAP_I_I_ERROR_ENTRY_IS_NULL \
    BUTTERFLYFISH_MAP_I_I_ERROR_ENTRY_IS_NULL
#define BUTTERFLYFISH_ORDERED_MAP_I_I_ERROR_KEY_IS_NULL \
    BUTTERFLYFISH_MAP_I_I_ERROR_KEY_IS_NULL
#define BUTTERFLYFISH_ORDERED_MAP_I_I_ERROR_MEMORY_ALLOCATION_FAILED \
    BUTTERFLYFISH_MAP_I_I_ERROR_MEMORY_ALLOCATION_FAILED
#define BUTTERFLYFISH_ORDERED_MAP_I_I_ERROR_VALUE_NOT_FOUND \
    BUTTERFLYFISH_MAP_I_I_ERROR_VALUE_NOT_FOUND
#define BUTTERFLYFISH_ORDERED_MAP_I_I_ERROR_ENTRY_NOT_FOUND \
    BUTTERFLYFISH_MAP_I_I_ERROR_ENTRY_NOT_FOUND
#define BUTTERFLYFISH_ORDERED_MAP_I_I_ERROR_KEY_NOT_FOUND \
    BUTTERFLYFISH_MAP_I_I_ERROR_KEY_NOT_FOUND

struct butterflyfish_ordered_map_i_i {
    int (*const as_ordered)(
            const struct butterflyfish_ordered_map_i_i *object,
 ...
 * @throws BUTTERFLYFISH_ORDERED_MAP_I_I_ERROR_OBJECT_IS_NULL if object is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_MAP_I_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 */
 ...
 * <i>NULL</i>.
 */
int butterflyfish_ordered_map_i_i_as_set(
        const struct butterflyfish_ordered_map_i_i *object,
 ...
 * <i>NULL</i>.
 */
int butterflyfish_ordered_map_i_i_as_ordered(
        const struct butterflyfish_ordered_map_i_i *object,
        const struct butterflyfish_ordered_i_i **out);
 ...
 * @throws BUTTERFLYFISH_ORDERED_MAP_I_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_MAP_I_I_ERROR_MAP_IS_EMPTY if map is empty.
 */
 ...
 * @throws BUTTERFLYFISH_ORDERED_MAP_I_I_ERROR_OBJECT_IS_NULL if object is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_MAP_I_I_ERROR_ITEM_IS_NULL if item is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_MAP_I_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_MAP_I_I_ERROR_END_OF_SEQUENCE if there is no
 * next item.
 */
 ...
 * @throws BUTTERFLYFISH_ORDERED_MAP_I_I_ERROR_OBJECT_IS_NULL if object is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_MAP_I_I_ERROR_ENTRY_IS_NULL if entry is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_MAP_I_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_MAP_I_I_ERROR_MEMORY_ALLOCATION_FAILED if
 * there is insufficient memory to find the entry.
 */
int butterflyfish_ordered_map_i_i_contains(
        const struct butterflyfish_ordered_map_i_i *object,
 ...
 * @throws BUTTERFLYFISH_ORDERED_MAP_I_I_ERROR_OBJECT_IS_NULL if object is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_MAP_I_I_ERROR_KEY_IS_NULL if key is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_MAP_I_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_MAP_I_I_ERROR_MEMORY_ALLOCATION_FAILED if
 ...
 * @throws BUTTERFLYFISH_ORDERED_MAP_I_I_ERROR_OBJECT_IS_NULL if object is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_MAP_I_I_ERROR_VALUE_IS_NULL if value is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_MAP_I_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_MAP_I_I_ERROR_MEMORY_ALLOCATION_FAILED if
 * there is insufficient memory to find the entry.
 */
int butterflyfish_ordered_map_i_i_contains_value(
        const struct butterflyfish_ordered_map_i_i *object,
 ...
 * @throws BUTTERFLYFISH_ORDERED_MAP_I_I_ERROR_OBJECT_IS_NULL if object is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_MAP_I_I_ERROR_OTHER_IS_NULL if other is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_MAP_I_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_MAP_I_I_ERROR_MEMORY_ALLOCATION_FAILED if
 * there is insufficient memory to find the entry.
 */
int butterflyfish_ordered_map_i_i_contains_all(
        const struct butterflyfish_ordered_map_i_i *object,
 ...
 * there is insufficient memory to find the entry.
 */
int butterflyfish_ordered_map_i_i_contains_all_values(
        const struct butterflyfish_ordered_map_i_i *object,
        const struct butterflyfish_stream_i *other,
        bool *out);
 ...
 * @throws BUTTERFLYFISH_ORDERED_MAP_I_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_MAP_I_I_ERROR_ENTRY_NOT_FOUND if entry is
 ...
 * @throws BUTTERFLYFISH_ORDERED_MAP_I_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_MAP_I_I_ERROR_KEY_NOT_FOUND if key is not in
 * the map instance.
 * @throws BUTTERFLYFISH_ORDERED_MAP_I_I_ERROR_MEMORY_ALLOCATION_FAILED if
 * there is insufficient memory to find the value.
 */
int butterflyfish_ordered_map_i_i_get_value(
        const struct butterflyfish_ordered_map_i_i *object,
        const struct sea_turtle_integer *key,
...
#endif /* _BUTTERFLYFISH_ORDERED_MAP_I_I_H_ */
