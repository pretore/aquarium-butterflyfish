...
#define BUTTERFLYFISH_REMOVABLE_I_ERROR_OTHER_IS_NULL \
    SEA_URCHIN_ERROR_OTHER_IS_NULL

struct butterflyfish_removable_i {
    int (*const as_collection)(const struct butterflyfish_removable_i *object,
                               const struct butterflyfish_collection_i **out);

    int (*const remove_item)(struct butterflyfish_removable_i *object,
                             const struct sea_turtle_integer *item);

    int (*const remove_all_items)(struct butterflyfish_removable_i *object,
 ...
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_REMOVABLE_I_ERROR_OUT_IS_NULL if out is <i>NULL</i>.
 */
int butterflyfish_removable_i_as_stream(
        const struct butterflyfish_removable_i *object,
 ...
 * @throws BUTTERFLYFISH_REMOVABLE_I_ERROR_OUT_IS_NULL if out is <i>NULL</i>.
 */
int butterflyfish_removable_i_as_collection(
        const struct butterflyfish_removable_i *object,
        const struct butterflyfish_collection_i **out);
 ...
 * @throws BUTTERFLYFISH_REMOVABLE_I_ERROR_OUT_IS_NULL if out is <i>NULL</i>.
 */
int butterflyfish_removable_i_count(
        const struct butterflyfish_removable_i *object,
        uintmax_t *out);
 ...
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_REMOVABLE_I_ERROR_OUT_IS_NULL if out is <i>NULL</i>.
 * @throws BUTTERFLYFISH_REMOVABLE_I_ERROR_REMOVABLE_IS_EMPTY if removable is
 * empty.
 */
int butterflyfish_removable_i_first(
        const struct butterflyfish_removable_i *object,
 ...
 * empty.
 */
int butterflyfish_removable_i_last(
        const struct butterflyfish_removable_i *object,
        const struct sea_turtle_integer **out);
 ...
 * @throws BUTTERFLYFISH_REMOVABLE_I_ERROR_OBJECT_IS_NULL if object is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_REMOVABLE_I_ERROR_ITEM_IS_NULL if item is <i>NULL</i>.
 * @throws BUTTERFLYFISH_REMOVABLE_I_ERROR_OUT_IS_NULL if out is <i>NULL</i>.
 * @throws BUTTERFLYFISH_REMOVABLE_I_ERROR_END_OF_SEQUENCE if there is no
 * next item.
 */
int butterflyfish_removable_i_next(
        const struct butterflyfish_removable_i *object,
        const struct sea_turtle_integer *item,
        const struct sea_turtle_integer **out);
 ...
 * previous item.
 */
int butterflyfish_removable_i_prev(
        const struct butterflyfish_removable_i *object,
        const struct sea_turtle_integer *item,
        const struct sea_turtle_integer **out);
 ...
 */
int butterflyfish_removable_i_remove_item(
        struct butterflyfish_removable_i *object,
        const struct sea_turtle_integer *item);
 ...
 * @throws BUTTERFLYFISH_REMOVABLE_I_ERROR_OBJECT_IS_NULL if object is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_REMOVABLE_I_ERROR_OTHER_IS_NULL if other is
 * <i>NULL</i>.
 * @note streamed items within <b>other</b> is invalidated when removed.
 */
int butterflyfish_removable_i_remove_all_items(
        struct butterflyfish_removable_i *object,
        const struct butterflyfish_stream_i *other);
