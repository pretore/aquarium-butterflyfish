#ifndef _BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_H_
#define _BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_H_

#include <stddef.h>
#include <stdbool.h>
#include <stdint.h>

#include "ordered_settable_list_i.h"
#include "ordered_reducible_list_i.h"
#include "settable_reducible_list_i.h"

struct sea_turtle_integer;

#define BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_OBJECT_IS_NULL \
    BUTTERFLYFISH_ORDERED_SETTABLE_LIST_I_ERROR_OBJECT_IS_NULL
#define BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_OUT_IS_NULL \
    BUTTERFLYFISH_ORDERED_SETTABLE_LIST_I_ERROR_OUT_IS_NULL
#define BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_LIST_IS_EMPTY \
    BUTTERFLYFISH_ORDERED_SETTABLE_LIST_I_ERROR_LIST_IS_EMPTY
#define BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_ITEM_IS_NULL \
    BUTTERFLYFISH_ORDERED_SETTABLE_LIST_I_ERROR_ITEM_IS_NULL
#define BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_END_OF_SEQUENCE \
    BUTTERFLYFISH_ORDERED_SETTABLE_LIST_I_ERROR_END_OF_SEQUENCE
#define BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_INDEX_IS_OUT_OF_BOUNDS \
    BUTTERFLYFISH_ORDERED_SETTABLE_LIST_I_ERROR_INDEX_IS_OUT_OF_BOUNDS
#define BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_ITEM_NOT_FOUND \
    BUTTERFLYFISH_ORDERED_SETTABLE_LIST_I_ERROR_ITEM_NOT_FOUND
#define BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_VALUE_IS_NULL \
    BUTTERFLYFISH_ORDERED_SETTABLE_LIST_I_ERROR_VALUE_IS_NULL
#define BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_MEMORY_ALLOCATION_FAILED \
    BUTTERFLYFISH_ORDERED_SETTABLE_LIST_I_ERROR_MEMORY_ALLOCATION_FAILED
#define BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_VALUE_IS_INVALID \
    BUTTERFLYFISH_ORDERED_SETTABLE_LIST_I_ERROR_VALUE_IS_INVALID
#define BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_OTHER_IS_NULL \
...
struct butterflyfish_ordered_settable_reducible_list_i {
    int (*const as_ordered_settable_list)(
            struct butterflyfish_ordered_settable_reducible_list_i *object,
 ...
 * @throws
 * BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_OUT_IS_NULL
 * if out is <i>NULL</i>.
 */
int butterflyfish_ordered_settable_reducible_list_i_as_stream(
        const struct butterflyfish_ordered_settable_reducible_list_i *object,
 ...
 * if out is <i>NULL</i>.
 */
int butterflyfish_ordered_settable_reducible_list_i_as_collection(
        const struct butterflyfish_ordered_settable_reducible_list_i *object,
 ...
 * if out is <i>NULL</i>.
 */
int butterflyfish_ordered_settable_reducible_list_i_as_ordered(
        const struct butterflyfish_ordered_settable_reducible_list_i *object,
 ...
 * if out is <i>NULL</i>.
 */
int butterflyfish_ordered_settable_reducible_list_i_as_list(
        const struct butterflyfish_ordered_settable_reducible_list_i *object,
 ...
 * if out is <i>NULL</i>.
 */
int butterflyfish_ordered_settable_reducible_list_i_as_settable(
        struct butterflyfish_ordered_settable_reducible_list_i *object,
 ...
 * if out is <i>NULL</i>.
 */
int butterflyfish_ordered_settable_reducible_list_i_as_removable(
        struct butterflyfish_ordered_settable_reducible_list_i *object,
 ...
 * if out is <i>NULL</i>.
 */
int butterflyfish_ordered_settable_reducible_list_i_as_ordered_list(
        const struct butterflyfish_ordered_settable_reducible_list_i *object,
 ...
 * if out is <i>NULL</i>.
 */
int butterflyfish_ordered_settable_reducible_list_i_as_settable_list(
        struct butterflyfish_ordered_settable_reducible_list_i *object,
 ...
 * if out is <i>NULL</i>.
 */
int butterflyfish_ordered_settable_reducible_list_i_as_reducible_list(
        struct butterflyfish_ordered_settable_reducible_list_i *object,
 ...
 * if out is <i>NULL</i>.
 */
int butterflyfish_ordered_settable_reducible_list_i_as_ordered_settable_list(
        struct butterflyfish_ordered_settable_reducible_list_i *object,
        struct butterflyfish_ordered_settable_list_i **out);
 ...
 * if out is <i>NULL</i>.
 */
int butterflyfish_ordered_settable_reducible_list_i_as_ordered_reducible_list(
        struct butterflyfish_ordered_settable_reducible_list_i *object,
        struct butterflyfish_ordered_reducible_list_i **out);
 ...
 * if out is <i>NULL</i>.
 */
int butterflyfish_ordered_settable_reducible_list_i_as_settable_reducible_list(
        struct butterflyfish_ordered_settable_reducible_list_i *object,
        struct butterflyfish_settable_reducible_list_i **out);
 ...
 * if out is <i>NULL</i>.
 */
int butterflyfish_ordered_settable_reducible_list_i_count(
        const struct butterflyfish_ordered_settable_reducible_list_i *object,
        uintmax_t *out);
 ...
 * if out is <i>NULL</i>.
 * @throws
 * BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_LIST_IS_EMPTY if list
 * is empty.
 */
int butterflyfish_ordered_settable_reducible_list_i_first(
        const struct butterflyfish_ordered_settable_reducible_list_i *object,
 ...
 * is empty.
 */
int butterflyfish_ordered_settable_reducible_list_i_last(
        const struct butterflyfish_ordered_settable_reducible_list_i *object,
        const struct sea_turtle_integer **out);
 ...
 * @return On success <i>0</i>, otherwise an error code.
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_OBJECT_IS_NULL
 * if object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_ITEM_IS_NULL
 * if item is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_OUT_IS_NULL
 * if out is <i>NULL</i>.
 * @throws
 ...
 */
int butterflyfish_ordered_settable_reducible_list_i_next(
        const struct butterflyfish_ordered_settable_reducible_list_i *object,
 ...
 * if out is <i>NULL</i>.
 * @throws
 * BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_END_OF_SEQUENCE if
 * there is no previous item.
 */
int butterflyfish_ordered_settable_reducible_list_i_prev(
        const struct butterflyfish_ordered_settable_reducible_list_i *object,
        const struct sea_turtle_integer *item,
        const struct sea_turtle_integer **out);
 ...
 */
int butterflyfish_ordered_settable_reducible_list_i_get(
        const struct butterflyfish_ordered_settable_reducible_list_i *object,
        uintmax_t at,
        const struct sea_turtle_integer **out);
 ...
 * if out is <i>NULL</i>.
 * @throws
 * BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_ITEM_NOT_FOUND if item
 * is not contained within the settable list.
 */
int butterflyfish_ordered_settable_reducible_list_i_at(
        const struct butterflyfish_ordered_settable_reducible_list_i *object,
        const struct sea_turtle_integer *item,
        uintmax_t *out);
 ...
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_OBJECT_IS_NULL
 * if object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_VALUE_IS_NULL
 ...
 */
int butterflyfish_ordered_settable_reducible_list_i_set(
        struct butterflyfish_ordered_settable_reducible_list_i *object,
        uintmax_t at,
 ...
 * BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_MEMORY_ALLOCATION_FAILED
 * if there is not enough memory to set the item to value.
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_VALUE_IS_INVALID
 * if value is invalid.
 * @note <b>value</b> is copied and then item is set to it.
 */
int butterflyfish_ordered_settable_reducible_list_i_set_item(
        struct butterflyfish_ordered_settable_reducible_list_i *object,
        const struct sea_turtle_integer *item,
        const struct sea_turtle_integer *value);
 ...
 */
int butterflyfish_ordered_settable_reducible_list_i_remove_item(
        struct butterflyfish_ordered_settable_reducible_list_i *object,
        const struct sea_turtle_integer *item);
 ...
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_OBJECT_IS_NULL
 * if object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_ERROR_OTHER_IS_NULL
 * if other is <i>NULL</i>.
 * @note streamed items within <b>other</b> is invalidated when removed.
 */
int butterflyfish_ordered_settable_reducible_list_i_remove_all_items(
        struct butterflyfish_ordered_settable_reducible_list_i *object,
 ...
 */
int butterflyfish_ordered_settable_reducible_list_i_remove(
        struct butterflyfish_ordered_settable_reducible_list_i *object,
        uintmax_t at);
 ...
 */
int butterflyfish_ordered_settable_reducible_list_i_remove_all(
        struct butterflyfish_ordered_settable_reducible_list_i *object,
        const struct butterflyfish_stream_ni *other);

#endif /* _BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_LIST_I_H_ */
