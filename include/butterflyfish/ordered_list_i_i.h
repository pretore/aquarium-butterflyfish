...
struct butterflyfish_ordered_list_i_i {
     ...
     * @throws BUTTERFLYFISH_ORDERED_LIST_I_I_ERROR_OUT_IS_NULL if out is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_ORDERED_LIST_I_I_ERROR_LIST_IS_EMPTY if list is
     * empty.
     */
     ...
     * @throws BUTTERFLYFISH_ORDERED_LIST_I_I_ERROR_OUT_IS_NULL if out is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_ORDERED_LIST_I_I_ERROR_END_OF_SEQUENCE if there is
     * no next item.
     */
     ...
     * @throws BUTTERFLYFISH_ORDERED_LIST_I_I_ERROR_OUT_IS_NULL if out is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_ORDERED_LIST_I_I_ERROR_INDEX_IS_OUT_OF_BOUNDS if
