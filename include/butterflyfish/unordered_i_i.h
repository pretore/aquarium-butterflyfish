...
struct butterflyfish_unordered_i_i {
    int (*const as_collection)(
            const struct butterflyfish_unordered_i_i *object,
 ...
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_UNORDERED_I_I_ERROR_OUT_IS_NULL if out is <i>NULL</i>.
 */
 ...
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_UNORDERED_I_I_ERROR_OUT_IS_NULL if out is <i>NULL</i>.
 * @throws BUTTERFLYFISH_UNORDERED_I_I_ERROR_UNORDERED_IS_EMPTY if unordered is
 * empty.
 */
 ...
 * @throws BUTTERFLYFISH_UNORDERED_I_I_ERROR_OBJECT_IS_NULL if object is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_UNORDERED_I_I_ERROR_ITEM_IS_NULL if item is <i>NULL</i>.
 * @throws BUTTERFLYFISH_UNORDERED_I_I_ERROR_OUT_IS_NULL if out is <i>NULL</i>.
 * @throws BUTTERFLYFISH_UNORDERED_I_I_ERROR_END_OF_SEQUENCE if there is no next
 * item.
 */
