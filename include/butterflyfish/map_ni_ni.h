#ifndef _BUTTERFLYFISH_MAP_NI_NI_H_
#define _BUTTERFLYFISH_MAP_NI_NI_H_

#include <stddef.h>
#include <stdbool.h>
#include <stdint.h>

#include "collection_ni_ni.h"

struct butterflyfish_stream_ni;
struct butterflyfish_set_ni;
struct butterflyfish_reducible_list_ni;

#define BUTTERFLYFISH_MAP_NI_NI_ERROR_OBJECT_IS_NULL \
    BUTTERFLYFISH_COLLECTION_NI_NI_ERROR_OBJECT_IS_NULL
#define BUTTERFLYFISH_MAP_NI_NI_ERROR_OUT_IS_NULL \
    BUTTERFLYFISH_COLLECTION_NI_NI_ERROR_OUT_IS_NULL
#define BUTTERFLYFISH_MAP_NI_NI_ERROR_MAP_IS_EMPTY \
    BUTTERFLYFISH_COLLECTION_NI_NI_ERROR_COLLECTION_IS_EMPTY
#define BUTTERFLYFISH_MAP_NI_NI_ERROR_ENTRY_IS_NULL \
    BUTTERFLYFISH_COLLECTION_NI_NI_ERROR_ENTRY_IS_NULL
#define BUTTERFLYFISH_MAP_NI_NI_ERROR_END_OF_SEQUENCE \
    BUTTERFLYFISH_COLLECTION_NI_NI_ERROR_END_OF_SEQUENCE
#define BUTTERFLYFISH_MAP_NI_NI_ERROR_OTHER_IS_NULL \
    SEA_URCHIN_ERROR_OTHER_IS_NULL
#define BUTTERFLYFISH_MAP_NI_NI_ERROR_KEY_ALREADY_EXISTS \
    SEA_URCHIN_ERROR_VALUE_ALREADY_EXISTS
#define BUTTERFLYFISH_MAP_NI_NI_ERROR_MEMORY_ALLOCATION_FAILED \
    SEA_URCHIN_ERROR_MEMORY_ALLOCATION_FAILED
#define BUTTERFLYFISH_MAP_NI_NI_ERROR_KEY_NOT_FOUND \
    SEA_URCHIN_ERROR_VALUE_NOT_FOUND
#define BUTTERFLYFISH_MAP_NI_NI_ERROR_FUNCTION_IS_NULL \
 ...
 * @throws BUTTERFLYFISH_MAP_NI_NI_ERROR_OBJECT_IS_NULL if object is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_MAP_NI_NI_ERROR_OUT_IS_NULL if out is <i>NULL</i>.
 */
 ...
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_MAP_NI_NI_ERROR_OUT_IS_NULL if out is <i>NULL</i>.
 * @throws BUTTERFLYFISH_MAP_NI_NI_ERROR_MAP_IS_EMPTY if map is empty.
 */
 ...
 * @throws BUTTERFLYFISH_MAP_NI_NI_ERROR_OBJECT_IS_NULL if object is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_MAP_NI_NI_ERROR_ENTRY_IS_NULL if entry is <i>NULL</i>.
 * @throws BUTTERFLYFISH_MAP_NI_NI_ERROR_OUT_IS_NULL if out is <i>NULL</i>.
 * @throws BUTTERFLYFISH_MAP_NI_NI_ERROR_END_OF_SEQUENCE if there is no next
 * entry.
 */
 ...
 * @throws BUTTERFLYFISH_MAP_NI_NI_ERROR_ENTRY_IS_NULL if entry is <i>NULL</i>.
 * @throws BUTTERFLYFISH_MAP_NI_NI_ERROR_OUT_IS_NULL if out is <i>NULL</i>.
 * @throws BUTTERFLYFISH_MAP_NI_NI_ERROR_END_OF_SEQUENCE if there is no previous
 * entry.
 */
 ...
 * @throws BUTTERFLYFISH_MAP_NI_NI_ERROR_OBJECT_IS_NULL if object is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_MAP_NI_NI_ERROR_OTHER_IS_NULL if other is <i>NULL</i>.
 */
 ...
 * @throws BUTTERFLYFISH_MAP_NI_NI_ERROR_OBJECT_IS_NULL if object is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_MAP_NI_NI_ERROR_KEY_ALREADY_EXISTS if key is already
 * present in the map.
 * @throws BUTTERFLYFISH_MAP_NI_NI_ERROR_MEMORY_ALLOCATION_FAILED if there is
 ...
 * @throws BUTTERFLYFISH_MAP_NI_NI_ERROR_OBJECT_IS_NULL if object is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_MAP_NI_NI_ERROR_KEY_NOT_FOUND if key is not present in
 * the map.
 * @throws BUTTERFLYFISH_MAP_NI_NI_ERROR_MEMORY_ALLOCATION_FAILED if there is
 ...
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_MAP_NI_NI_ERROR_OTHER_IS_NULL if other is <i>NULL</i>.
 * @throws BUTTERFLYFISH_MAP_NI_NI_ERROR_FUNCTION_IS_NULL if function is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_MAP_NI_NI_ERROR_MEMORY_ALLOCATION_FAILED if there is
 ...
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_MAP_NI_NI_ERROR_OUT_IS_NULL if out is <i>NULL</i>.
 * @throws BUTTERFLYFISH_MAP_NI_NI_ERROR_KEY_NOT_FOUND if key not found in map.
 * @throws BUTTERFLYFISH_MAP_NI_NI_ERROR_MEMORY_ALLOCATION_FAILED if there is
...
#endif /* _BUTTERFLYFISH_MAP_NI_NI_H_ */
