...
struct butterflyfish_settable_set_i {
    ...
    const struct butterflyfish_settable_set_i *const as_settable;
     ...
     * @throws BUTTERFLYFISH_SETTABLE_SET_I_ERROR_OUT_IS_NULL if out is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_SET_I_ERROR_END_OF_SEQUENCE if there is
     * no next item.
     */
     ...
     * @throws BUTTERFLYFISH_SETTABLE_SET_I_ERROR_OUT_IS_NULL if out is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_SET_I_ERROR_VALUE_NOT_FOUND if value is
     ...
     * invalid.
     * @throws BUTTERFLYFISH_SETTABLE_SET_I_ERROR_VALUE_ALREADY_EXISTS if
