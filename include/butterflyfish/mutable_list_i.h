...
#define BUTTERFLYFISH_MUTABLE_LIST_I_ERROR_OTHER_IS_NULL \
...
struct butterflyfish_mutable_list_i {
    int (*const as_settable_incremental_list)(
            struct butterflyfish_mutable_list_i *object,
...
int butterflyfish_mutable_list_i_as_stream(
        const struct butterflyfish_mutable_list_i *object,
 ...
 * @throws BUTTERFLYFISH_MUTABLE_LIST_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_MUTABLE_LIST_I_ERROR_LIST_IS_EMPTY if mutable list is
 * empty.
 */
 ...
 * @throws BUTTERFLYFISH_MUTABLE_LIST_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_MUTABLE_LIST_I_ERROR_LIST_IS_EMPTY if mutable list
 * is empty.
 */
 ...
 * @throws BUTTERFLYFISH_MUTABLE_LIST_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_MUTABLE_LIST_I_ERROR_END_OF_SEQUENCE if there is no
 * next item.
 */
 ...
 * @throws BUTTERFLYFISH_MUTABLE_LIST_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_MUTABLE_LIST_I_ERROR_INDEX_IS_OUT_OF_BOUNDS if at does
 ...
 * @throws BUTTERFLYFISH_MUTABLE_LIST_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_MUTABLE_LIST_I_ERROR_ITEM_NOT_FOUND if item is not
 ...
 * @throws BUTTERFLYFISH_MUTABLE_LIST_I_ERROR_INDEX_IS_OUT_OF_BOUNDS if at does
 * not refer to an item contained within the mutable list.
 * @throws BUTTERFLYFISH_MUTABLE_LIST_I_ERROR_MEMORY_ALLOCATION_FAILED if there
 * is not enough memory to set the item to value.
 * @throws BUTTERFLYFISH_MUTABLE_LIST_I_ERROR_VALUE_IS_INVALID if value is
 * invalid.
 ...
 * @throws BUTTERFLYFISH_MUTABLE_LIST_I_ERROR_OBJECT_IS_NULL if object is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_MUTABLE_LIST_I_ERROR_OTHER_IS_NULL if other is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_MUTABLE_LIST_I_ERROR_MEMORY_ALLOCATION_FAILED if
 ...
 * @throws BUTTERFLYFISH_MUTABLE_LIST_I_ERROR_OBJECT_IS_NULL if object is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_MUTABLE_LIST_I_ERROR_INDEX_IS_OUT_OF_BOUNDS if at
