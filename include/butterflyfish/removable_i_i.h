...
struct butterflyfish_removable_i_i {
     ...
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_REMOVABLE_I_I_ERROR_OUT_IS_NULL if out is
     * <i>NULL</i>.
     */
     ...
     * @throws BUTTERFLYFISH_REMOVABLE_I_I_ERROR_OUT_IS_NULL if out is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_REMOVABLE_I_I_ERROR_REMOVABLE_IS_EMPTY if
     * removable is empty.
     */
     ...
     * @throws BUTTERFLYFISH_REMOVABLE_I_I_ERROR_OBJECT_IS_NULL if object is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_REMOVABLE_I_I_ERROR_ITEM_IS_NULL if item is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_REMOVABLE_I_I_ERROR_OUT_IS_NULL if out is
     * <i>NULL</i>.
