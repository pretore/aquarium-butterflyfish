...
#define BUTTERFLYFISH_INCREMENTAL_SET_I_ERROR_OTHER_IS_NULL \
...
struct butterflyfish_incremental_set_i {
    int (*const as_addable)(
            struct butterflyfish_incremental_set_i *object,
            struct butterflyfish_addable_i **out);

    int (*const as_set)(const struct butterflyfish_incremental_set_i *object,
 ...
 * @throws BUTTERFLYFISH_INCREMENTAL_SET_I_ERROR_OBJECT_IS_NULL if object is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_INCREMENTAL_SET_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 */
int butterflyfish_incremental_set_i_as_stream(
        const struct butterflyfish_incremental_set_i *object,
 ...
 * <i>NULL</i>.
 */
int butterflyfish_incremental_set_i_as_collection(
        const struct butterflyfish_incremental_set_i *object,
 ...
 * <i>NULL</i>.
 */
int butterflyfish_incremental_set_i_as_addable(
        struct butterflyfish_incremental_set_i *object,
        struct butterflyfish_addable_i **out);
 ...
 * <i>NULL</i>.
 */
int butterflyfish_incremental_set_i_as_set(
        const struct butterflyfish_incremental_set_i *object,
        const struct butterflyfish_set_i **out);
 ...
 * <i>NULL</i>.
 */
int butterflyfish_incremental_set_i_count(
        const struct butterflyfish_incremental_set_i *object,
        uintmax_t *out);
 ...
 * @throws BUTTERFLYFISH_INCREMENTAL_SET_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_INCREMENTAL_SET_I_ERROR_SET_IS_EMPTY if set is empty.
 */
int butterflyfish_incremental_set_i_first(
        const struct butterflyfish_incremental_set_i *object,
 ...
 * @throws BUTTERFLYFISH_INCREMENTAL_SET_I_ERROR_SET_IS_EMPTY if set is empty.
 */
int butterflyfish_incremental_set_i_last(
        const struct butterflyfish_incremental_set_i *object,
        const struct sea_turtle_integer **out);
 ...
 * @throws BUTTERFLYFISH_INCREMENTAL_SET_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_INCREMENTAL_SET_I_ERROR_END_OF_SEQUENCE if there is
 * no next item.
 */
int butterflyfish_incremental_set_i_next(
        const struct butterflyfish_incremental_set_i *object,
 ...
 * @throws BUTTERFLYFISH_INCREMENTAL_SET_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_INCREMENTAL_SET_I_ERROR_END_OF_SEQUENCE if there is no
 * previous item.
 */
int butterflyfish_incremental_set_i_prev(
        const struct butterflyfish_incremental_set_i *object,
        const struct sea_turtle_integer *item,
        const struct sea_turtle_integer **out);
 ...
 * @throws BUTTERFLYFISH_INCREMENTAL_SET_I_ERROR_OBJECT_IS_NULL if object is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_INCREMENTAL_SET_I_ERROR_VALUE_IS_NULL if value is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_INCREMENTAL_SET_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_INCREMENTAL_SET_I_ERROR_MEMORY_ALLOCATION_FAILED if
 * there is insufficient memory to find the item.
 */
int butterflyfish_incremental_set_i_contains(
        const struct butterflyfish_incremental_set_i *object,
 ...
 * @throws BUTTERFLYFISH_INCREMENTAL_SET_I_ERROR_OBJECT_IS_NULL if object is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_INCREMENTAL_SET_I_ERROR_OTHER_IS_NULL if other is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_INCREMENTAL_SET_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_INCREMENTAL_SET_I_ERROR_MEMORY_ALLOCATION_FAILED if
 * there is insufficient memory to find the item.
 */
int butterflyfish_incremental_set_i_contains_all(
        const struct butterflyfish_incremental_set_i *object,
 ...
 * @throws BUTTERFLYFISH_INCREMENTAL_SET_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_INCREMENTAL_SET_I_ERROR_VALUE_NOT_FOUND if value is
 * not in the set instance.
 * @throws BUTTERFLYFISH_INCREMENTAL_SET_I_ERROR_MEMORY_ALLOCATION_FAILED if
 * there is insufficient memory to find the item.
 */
int butterflyfish_incremental_set_i_get(
        const struct butterflyfish_incremental_set_i *object,
        const struct sea_turtle_integer *value,
        const struct sea_turtle_integer **out);
 ...
 * @throws BUTTERFLYFISH_INCREMENTAL_SET_I_ERROR_VALUE_IS_INVALID if value
 * is invalid.
 * @throws BUTTERFLYFISH_INCREMENTAL_SET_I_ERROR_MEMORY_ALLOCATION_FAILED if
 * there is insufficient memory to add value to the set.
 * @note <b>value</b> is copied and then placed into the set.
 */
int butterflyfish_incremental_set_i_add(
        struct butterflyfish_incremental_set_i *object,
        const struct sea_turtle_integer *value);
 ...
 */
int butterflyfish_incremental_set_i_add_all(
        struct butterflyfish_incremental_set_i *object,
        const struct butterflyfish_stream_i *other);
