#ifndef _BUTTERFLYFISH_ORDERED_REDUCIBLE_SET_I_I_H_
#define _BUTTERFLYFISH_ORDERED_REDUCIBLE_SET_I_I_H_
...
#define BUTTERFLYFISH_ORDERED_REDUCIBLE_SET_I_I_ERROR_OBJECT_IS_NULL \
    BUTTERFLYFISH_REDUCIBLE_SET_I_I_ERROR_OBJECT_IS_NULL
#define BUTTERFLYFISH_ORDERED_REDUCIBLE_SET_I_I_ERROR_OUT_IS_NULL \
    BUTTERFLYFISH_REDUCIBLE_SET_I_I_ERROR_OUT_IS_NULL
#define BUTTERFLYFISH_ORDERED_REDUCIBLE_SET_I_I_ERROR_SET_IS_EMPTY \
    BUTTERFLYFISH_REDUCIBLE_SET_I_I_ERROR_SET_IS_EMPTY
#define BUTTERFLYFISH_ORDERED_REDUCIBLE_SET_I_I_ERROR_ITEM_IS_NULL \
    BUTTERFLYFISH_REDUCIBLE_SET_I_I_ERROR_ITEM_IS_NULL
#define BUTTERFLYFISH_ORDERED_REDUCIBLE_SET_I_I_ERROR_END_OF_SEQUENCE \
    BUTTERFLYFISH_REDUCIBLE_SET_I_I_ERROR_END_OF_SEQUENCE
#define BUTTERFLYFISH_ORDERED_REDUCIBLE_SET_I_I_ERROR_OTHER_IS_NULL \
    BUTTERFLYFISH_REDUCIBLE_SET_I_I_ERROR_OTHER_IS_NULL
#define BUTTERFLYFISH_ORDERED_REDUCIBLE_SET_I_I_ERROR_VALUE_IS_NULL \
    BUTTERFLYFISH_REDUCIBLE_SET_I_I_ERROR_VALUE_IS_NULL
#define BUTTERFLYFISH_ORDERED_REDUCIBLE_SET_I_I_ERROR_MEMORY_ALLOCATION_FAILED \
    BUTTERFLYFISH_REDUCIBLE_SET_I_I_ERROR_MEMORY_ALLOCATION_FAILED
#define BUTTERFLYFISH_ORDERED_REDUCIBLE_SET_I_I_ERROR_VALUE_NOT_FOUND \
    BUTTERFLYFISH_REDUCIBLE_SET_I_I_ERROR_VALUE_NOT_FOUND

struct butterflyfish_ordered_reducible_set_i_i {
    int (*const as_ordered_set)(
            const struct butterflyfish_ordered_reducible_set_i_i *object,
            const struct butterflyfish_ordered_set_i_i **out);

    int (*const as_reducible_set)(
            struct butterflyfish_ordered_reducible_set_i_i *object,
 ...
 * @throws BUTTERFLYFISH_ORDERED_REDUCIBLE_SET_I_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_REDUCIBLE_SET_I_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 */
 ...
 * @throws BUTTERFLYFISH_ORDERED_REDUCIBLE_SET_I_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_REDUCIBLE_SET_I_I_ERROR_SET_IS_EMPTY if set is
 * empty.
 */
 ...
 * @throws BUTTERFLYFISH_ORDERED_REDUCIBLE_SET_I_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_REDUCIBLE_SET_I_I_ERROR_ITEM_IS_NULL if item is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_REDUCIBLE_SET_I_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_REDUCIBLE_SET_I_I_ERROR_END_OF_SEQUENCE if
 ...
 * @throws BUTTERFLYFISH_ORDERED_REDUCIBLE_SET_I_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_REDUCIBLE_SET_I_I_ERROR_VALUE_IS_NULL if value
 * is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_REDUCIBLE_SET_I_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_REDUCIBLE_SET_I_I_ERROR_MEMORY_ALLOCATION_FAILED
 ...
 * @throws BUTTERFLYFISH_ORDERED_REDUCIBLE_SET_I_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_REDUCIBLE_SET_I_I_ERROR_OTHER_IS_NULL if other
 * is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_REDUCIBLE_SET_I_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_REDUCIBLE_SET_I_I_ERROR_MEMORY_ALLOCATION_FAILED
 ...
 * @throws BUTTERFLYFISH_ORDERED_REDUCIBLE_SET_I_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_REDUCIBLE_SET_I_I_ERROR_VALUE_NOT_FOUND if
 ...
 * @throws BUTTERFLYFISH_ORDERED_REDUCIBLE_SET_I_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_REDUCIBLE_SET_I_I_ERROR_ITEM_IS_NULL if item
 * is <i>NULL</i>.
...
#endif /* _BUTTERFLYFISH_ORDERED_REDUCIBLE_SET_I_I_H_ */
