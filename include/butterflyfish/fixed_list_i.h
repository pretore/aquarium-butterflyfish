...
#define BUTTERFLYFISH_FIXED_LIST_I_ERROR_VALUE_IS_INVALID \
 ...
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_FIXED_LIST_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 */
int butterflyfish_fixed_list_i_as_stream(
 ...
 * <i>NULL</i>.
 */
int butterflyfish_fixed_list_i_as_collection(
        const struct butterflyfish_fixed_list_i *object,
 ...
 * @throws BUTTERFLYFISH_FIXED_LIST_I_ERROR_VALUE_IS_INVALID if value is
 * invalid.
