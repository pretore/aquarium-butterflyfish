...
#define BUTTERFLYFISH_INCREMENTAL_LIST_I_I_ERROR_OTHER_IS_NULL \
...
struct butterflyfish_incremental_list_i_i {
    int (*const as_addable)(
            struct butterflyfish_incremental_list_i_i *object,
            struct butterflyfish_addable_i_i **out);

    int (*const as_list)(
            const struct butterflyfish_incremental_list_i_i *object,
 ...
 * @throws BUTTERFLYFISH_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL if object is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_INCREMENTAL_LIST_I_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 */
int butterflyfish_incremental_list_i_i_as_stream(
        const struct butterflyfish_incremental_list_i_i *object,
 ...
 * <i>NULL</i>.
 */
int butterflyfish_incremental_list_i_i_as_collection(
        const struct butterflyfish_incremental_list_i_i *object,
 ...
 * <i>NULL</i>.
 */
int butterflyfish_incremental_list_i_i_as_addable(
        struct butterflyfish_incremental_list_i_i *object,
        struct butterflyfish_addable_i_i **out);
 ...
 * <i>NULL</i>.
 */
int butterflyfish_incremental_list_i_i_as_list(
        const struct butterflyfish_incremental_list_i_i *object,
        const struct butterflyfish_list_i_i **out);
 ...
 * <i>NULL</i>.
 */
int butterflyfish_incremental_list_i_i_count(
        const struct butterflyfish_incremental_list_i_i *object,
        uintmax_t *out);
 ...
 * @throws BUTTERFLYFISH_INCREMENTAL_LIST_I_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_INCREMENTAL_LIST_I_I_ERROR_LIST_IS_EMPTY if
 * incremental list is empty.
 */
int butterflyfish_incremental_list_i_i_first(
        const struct butterflyfish_incremental_list_i_i *object,
 ...
 * incremental list is empty.
 */
int butterflyfish_incremental_list_i_i_last(
        const struct butterflyfish_incremental_list_i_i *object,
        const struct butterflyfish_map_i_i_entry **out);
 ...
 * @throws BUTTERFLYFISH_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL if object is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_INCREMENTAL_LIST_I_I_ERROR_ITEM_IS_NULL if item is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_INCREMENTAL_LIST_I_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_INCREMENTAL_LIST_I_I_ERROR_END_OF_SEQUENCE if there is
 * no next item.
 */
int butterflyfish_incremental_list_i_i_next(
        const struct butterflyfish_incremental_list_i_i *object,
 ...
 * no previous item.
 */
int butterflyfish_incremental_list_i_i_prev(
        const struct butterflyfish_incremental_list_i_i *object,
        const struct butterflyfish_map_i_i_entry *item,
        const struct butterflyfish_map_i_i_entry **out);
 ...
 * @throws BUTTERFLYFISH_INCREMENTAL_LIST_I_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_INCREMENTAL_LIST_I_I_ERROR_INDEX_IS_OUT_OF_BOUNDS if
 * at does not refer to an item contained within the list.
 */
int butterflyfish_incremental_list_i_i_get(
        const struct butterflyfish_incremental_list_i_i *object,
        uintmax_t at,
        const struct butterflyfish_map_i_i_entry **out);
 ...
 * @throws BUTTERFLYFISH_INCREMENTAL_LIST_I_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_INCREMENTAL_LIST_I_I_ERROR_ITEM_NOT_FOUND if item is
 * not contained within the list.
 */
int butterflyfish_incremental_list_i_i_at(
        const struct butterflyfish_incremental_list_i_i *object,
        const struct butterflyfish_map_i_i_entry *item,
        uintmax_t *out);
 ...
 * @throws BUTTERFLYFISH_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL if object is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_INCREMENTAL_LIST_I_I_ERROR_VALUE_IS_NULL if value is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_INCREMENTAL_LIST_I_I_ERROR_MEMORY_ALLOCATION_FAILED
 * if there is not enough memory to add the value.
 * @throws BUTTERFLYFISH_INCREMENTAL_LIST_I_I_ERROR_VALUE_IS_INVALID if value
 * is invalid.
 * @note <b>value</b> is copied and then added to the end.
 */
int butterflyfish_incremental_list_i_i_add(
        struct butterflyfish_incremental_list_i_i *object,
 ...
 * @throws BUTTERFLYFISH_INCREMENTAL_LIST_I_I_ERROR_OBJECT_IS_NULL if object is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_INCREMENTAL_LIST_I_I_ERROR_OTHER_IS_NULL if other is
 * <i>NULL</i>.
 ...
 */
int butterflyfish_incremental_list_i_i_add_all(
        struct butterflyfish_incremental_list_i_i *object,
