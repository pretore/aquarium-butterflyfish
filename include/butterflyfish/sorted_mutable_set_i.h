#ifndef _BUTTERFLYFISH_SORTED_MUTABLE_SET_I_H_
#define _BUTTERFLYFISH_SORTED_MUTABLE_SET_I_H_

#include <stddef.h>
#include <stdbool.h>
#include <stdint.h>

#include "sorted_settable_incremental_set_i.h"
#include "sorted_settable_reducible_set_i.h"
#include "mutable_set_i.h"

struct sea_turtle_integer;

#define BUTTERFLYFISH_SORTED_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL \
    BUTTERFLYFISH_SORTED_SETTABLE_SET_I_ERROR_OBJECT_IS_NULL
#define BUTTERFLYFISH_SORTED_MUTABLE_SET_I_ERROR_OUT_IS_NULL \
    BUTTERFLYFISH_SORTED_SETTABLE_SET_I_ERROR_OUT_IS_NULL
#define BUTTERFLYFISH_SORTED_MUTABLE_SET_I_ERROR_SET_IS_EMPTY \
    BUTTERFLYFISH_SORTED_SETTABLE_SET_I_ERROR_SET_IS_EMPTY
#define BUTTERFLYFISH_SORTED_MUTABLE_SET_I_ERROR_ITEM_IS_NULL \
    BUTTERFLYFISH_SORTED_SETTABLE_SET_I_ERROR_ITEM_IS_NULL
#define BUTTERFLYFISH_SORTED_MUTABLE_SET_I_ERROR_END_OF_SEQUENCE \
    BUTTERFLYFISH_SORTED_SETTABLE_SET_I_ERROR_END_OF_SEQUENCE
#define BUTTERFLYFISH_SORTED_MUTABLE_SET_I_ERROR_OTHER_IS_NULL \
    BUTTERFLYFISH_SORTED_SETTABLE_SET_I_ERROR_OTHER_IS_NULL
#define BUTTERFLYFISH_SORTED_MUTABLE_SET_I_ERROR_VALUE_IS_NULL \
    BUTTERFLYFISH_SORTED_SETTABLE_SET_I_ERROR_VALUE_IS_NULL
#define BUTTERFLYFISH_SORTED_MUTABLE_SET_I_ERROR_VALUE_ALREADY_EXISTS \
    BUTTERFLYFISH_SORTED_SETTABLE_SET_I_ERROR_VALUE_ALREADY_EXISTS
#define BUTTERFLYFISH_SORTED_MUTABLE_SET_I_ERROR_VALUE_IS_INVALID \
    BUTTERFLYFISH_SORTED_SETTABLE_SET_I_ERROR_VALUE_IS_INVALID
#define BUTTERFLYFISH_SORTED_MUTABLE_SET_I_ERROR_MEMORY_ALLOCATION_FAILED \
    BUTTERFLYFISH_SORTED_SETTABLE_SET_I_ERROR_MEMORY_ALLOCATION_FAILED
#define BUTTERFLYFISH_SORTED_MUTABLE_SET_I_ERROR_VALUE_NOT_FOUND \
    BUTTERFLYFISH_SORTED_SETTABLE_SET_I_ERROR_VALUE_NOT_FOUND

struct butterflyfish_sorted_mutable_set_i {
    int (*const as_sorted_settable_incremental_set)(
            struct butterflyfish_sorted_mutable_set_i *object,
            struct butterflyfish_sorted_settable_incremental_set_i **out);

    int (*const as_sorted_settable_reducible_set)(
            struct butterflyfish_sorted_mutable_set_i *object,
...
/**
 * @brief Return sorted mutable set as a stream.
 * @param [in] object sorted mutable set instance.
 * @param [out] out receive stream.
 * @return On success <i>0</i>, otherwise an error code.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL if object
 * is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_SET_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 */
int butterflyfish_sorted_mutable_set_i_as_stream(
        const struct butterflyfish_sorted_mutable_set_i *object,
        const struct butterflyfish_stream_i **out);

/**
 * @brief Return sorted mutable set as a collection.
 * @param [in] object sorted mutable set instance.
...
/**
 * @brief Return sorted mutable set as an addable.
 * @param [in] object sorted mutable set instance.
...
/**
 * @brief Return sorted mutable set as a settable.
 * @param [in] object sorted mutable set instance.
...
/**
 * @brief Return sorted mutable set as a set.
 * @param [in] object sorted mutable set instance.
...
/**
 * @brief Return sorted mutable set as a removable.
 * @param [in] object sorted mutable set instance.
...
/**
 * @brief Return sorted mutable set as a settable set.
 * @param [in] object sorted mutable set instance.
...
/**
 * @brief Return sorted mutable set as a incremental set.
 * @param [in] object sorted mutable set instance.
...
/**
 * @brief Return sorted mutable set as a reducible set.
 * @param [in] object sorted mutable set instance.
...
/**
 * @brief Return sorted mutable set as a settable incremental set.
 * @param [in] object sorted mutable set instance.
...
/**
 * @brief Return sorted mutable set as a settable reducible set.
 * @param [in] object sorted mutable set instance.
...
/**
 * @brief Return sorted mutable set as a mutable set.
 * @param [in] object sorted mutable set instance.
...
/**
 * @brief Return sorted mutable set as a sorted.
 * @param [in] object sorted mutable set instance.
...
/**
 * @brief Return sorted mutable set as an sorted set.
 * @param [in] object sorted mutable set instance.
...
/**
 * @brief Return sorted mutable set as an sorted settable set.
 * @param [in] object sorted mutable set instance.
...
/**
 * @brief Return sorted mutable set as an sorted incremental set.
 * @param [in] object sorted mutable set instance.
 * @param [out] out receive sorted incremental set.
 * @return On success <i>0</i>, otherwise an error code.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL if object
 * is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_SET_I_ERROR_OUT_IS_NULL if out is
...
/**
 * @brief Return sorted mutable set as an sorted reducible set.
 * @param [in] object sorted mutable set instance.
...
/**
 * @brief Return sorted mutable set as an sorted settable incremental set.
 * @param [in] object sorted mutable set instance.
 * @param [out] out receive sorted settable incremental set.
 * @return On success <i>0</i>, otherwise an error code.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL if object
 * is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_SET_I_ERROR_OUT_IS_NULL if out is
...
/**
 * @brief Return sorted mutable set as an sorted settable reducible set.
 * @param [in] object sorted mutable set instance.
 * @param [out] out receive sorted settable reducible set.
 * @return On success <i>0</i>, otherwise an error code.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL if object
 * is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_SET_I_ERROR_OUT_IS_NULL if out is
...
/**
 * @brief First item of the sorted mutable set.
 * @param [in] object sorted mutable set instance.
 ...
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_SET_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_SET_I_ERROR_SET_IS_EMPTY if set is
 * empty.
 */
...
/**
 * @brief Last item of the sorted mutable set.
 * @param [in] object sorted mutable set instance.
 * @param [out] out receive the item.
 * @return On success <i>0</i>, otherwise an error code.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL if object
 ...
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL if object
 * is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_SET_I_ERROR_ITEM_IS_NULL if item is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_SET_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_SET_I_ERROR_END_OF_SEQUENCE if there
 * is no next item.
 */
...
/**
 * @brief Check if sorted mutable set contains the given value.
 * @param [in] object sorted mutable set instance.
 ...
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL if object
 * is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_SET_I_ERROR_VALUE_IS_NULL if value is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_SET_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_SET_I_ERROR_MEMORY_ALLOCATION_FAILED
...
/**
 * @brief Check if sorted mutable set contains all the given values.
 * @param [in] object sorted mutable set instance.
 ...
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL if object
 * is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_SET_I_ERROR_OTHER_IS_NULL if other is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_SET_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_SET_I_ERROR_MEMORY_ALLOCATION_FAILED
 ...
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_SET_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_SET_I_ERROR_VALUE_NOT_FOUND if value
 ...
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_SET_I_ERROR_VALUE_IS_NULL if value is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_SET_I_ERROR_VALUE_ALREADY_EXISTS if
 * value is already present in the set.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_SET_I_ERROR_VALUE_IS_INVALID if value
 * is invalid.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_SET_I_ERROR_MEMORY_ALLOCATION_FAILED
 ...
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_SET_I_ERROR_ITEM_IS_NULL if item is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_SET_I_ERROR_VALUE_IS_NULL if value
 * is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_SET_I_ERROR_VALUE_NOT_FOUND if item
 * is not in the set.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_SET_I_ERROR_VALUE_ALREADY_EXISTS if
 * value is already present in the set.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_SET_I_ERROR_VALUE_IS_INVALID if value
...
/**
 * @brief Add value to the sorted mutable set.
 * @param [in] object sorted mutable set instance.
...
/**
 * @brief Add all the values to the sorted mutable set.
 * @param [in] object sorted mutable set instance.
 ...
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL if object
 * is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_SET_I_ERROR_ITEM_IS_NULL if item
 * is <i>NULL</i>.
 ...
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL if object
 * is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_SET_I_ERROR_OTHER_IS_NULL if other
 * is <i>NULL</i>.
...
/**
 * @brief Remove value from the sorted mutable set.
 * @param [in] object sorted mutable set instance.
...
/**
 * @brief Remove values from the sorted mutable set.
 * @param [in] object sorted mutable set instance.
 ...
 * @param [out] out receive the item.
 * @return On success <i>0</i>, otherwise an error code.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_SET_I_ERROR_OBJECT_IS_NULL if object is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_SET_I_ERROR_VALUE_IS_NULL if value is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_SET_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_SET_I_ERROR_VALUE_NOT_FOUND if no
 * value in sorted mutable set was equal to or higher than value.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_SET_I_ERROR_MEMORY_ALLOCATION_FAILED
 * if there is insufficient memory to find the item.
 */
 ...
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_SET_I_ERROR_VALUE_NOT_FOUND if no
 * value in sorted mutable set was equal to or lower than value.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_SET_I_ERROR_MEMORY_ALLOCATION_FAILED
 * if there is insufficient memory to find the item.
 */
 ...
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_SET_I_ERROR_VALUE_NOT_FOUND if no
 * value in sorted mutable set is greater.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_SET_I_ERROR_MEMORY_ALLOCATION_FAILED
 * if there is insufficient memory to find the item.
 */
 ...
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_SET_I_ERROR_VALUE_NOT_FOUND if no
 * value in sorted mutable set is lower.
 * @throws BUTTERFLYFISH_SORTED_MUTABLE_SET_I_ERROR_MEMORY_ALLOCATION_FAILED
 * if there is insufficient memory to find the item.
 */
...
#endif /* _BUTTERFLYFISH_SORTED_MUTABLE_SET_I_H_ */
