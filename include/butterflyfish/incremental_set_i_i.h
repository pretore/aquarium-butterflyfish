...
struct butterflyfish_incremental_set_i_i {
    ...
    /**
      ...
      * @throws BUTTERFLYFISH_INCREMENTAL_SET_I_I_ERROR_OBJECT_IS_NULL if
      * object is <i>NULL</i>.
     ...
     * @return On success <i>0</i>, otherwise an error code.
     * @throws BUTTERFLYFISH_INCREMENTAL_SET_I_I_ERROR_OBJECT_IS_NULL if object
     * is <i>NULL</i>.
     * @throws BUTTERFLYFISH_INCREMENTAL_SET_I_I_ERROR_OUT_IS_NULL if out is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_INCREMENTAL_SET_I_I_ERROR_SET_IS_EMPTY if set is
     * empty.
     */
     ...
     * @throws BUTTERFLYFISH_INCREMENTAL_SET_I_I_ERROR_OUT_IS_NULL if out is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_INCREMENTAL_SET_I_I_ERROR_END_OF_SEQUENCE if there
     * is no next item.
     */
     ...
     * @throws BUTTERFLYFISH_INCREMENTAL_SET_I_I_ERROR_OBJECT_IS_NULL if object
     * is <i>NULL</i>.
     * @throws BUTTERFLYFISH_INCREMENTAL_SET_I_I_ERROR_VALUE_IS_NULL if value
     * is <i>NULL</i>.
     * @throws BUTTERFLYFISH_INCREMENTAL_SET_I_I_ERROR_OUT_IS_NULL if out is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_INCREMENTAL_SET_I_I_ERROR_MEMORY_ALLOCATION_FAILED
     ...
     * @throws BUTTERFLYFISH_INCREMENTAL_SET_I_I_ERROR_OUT_IS_NULL if out is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_INCREMENTAL_SET_I_I_ERROR_VALUE_NOT_FOUND if value
     ...
     * @throws BUTTERFLYFISH_INCREMENTAL_SET_I_I_ERROR_VALUE_IS_INVALID if
     * value is invalid.
     * @throws BUTTERFLYFISH_INCREMENTAL_SET_I_I_ERROR_MEMORY_ALLOCATION_FAILED
