#ifndef _BUTTERFLYFISH_SORTED_MAP_P_P_H_
#define _BUTTERFLYFISH_SORTED_MAP_P_P_H_

#include <stddef.h>
#include <stdbool.h>
#include <stdint.h>

#include "ordered_map_p_p.h"

struct butterflyfish_stream_p;
struct butterflyfish_sorted_set_p;
struct butterflyfish_reducible_list_p;

#define BUTTERFLYFISH_SORTED_MAP_P_P_ERROR_OBJECT_IS_NULL \
    BUTTERFLYFISH_ORDERED_MAP_P_P_ERROR_OBJECT_IS_NULL
#define BUTTERFLYFISH_SORTED_MAP_P_P_ERROR_OUT_IS_NULL \
    BUTTERFLYFISH_ORDERED_MAP_P_P_ERROR_OUT_IS_NULL
#define BUTTERFLYFISH_SORTED_MAP_P_P_ERROR_MAP_IS_EMPTY \
    BUTTERFLYFISH_ORDERED_MAP_P_P_ERROR_MAP_IS_EMPTY
#define BUTTERFLYFISH_SORTED_MAP_P_P_ERROR_ENTRY_IS_NULL \
    BUTTERFLYFISH_ORDERED_MAP_P_P_ERROR_ENTRY_IS_NULL
#define BUTTERFLYFISH_SORTED_MAP_P_P_ERROR_END_OF_SEQUENCE \
...
#define BUTTERFLYFISH_SORTED_MAP_P_P_ERROR_KEY_NOT_FOUND \
    BUTTERFLYFISH_ORDERED_MAP_P_P_ERROR_KEY_NOT_FOUND
#define BUTTERFLYFISH_SORTED_MAP_P_P_ERROR_FUNCTION_IS_NULL \
    BUTTERFLYFISH_ORDERED_MAP_P_P_ERROR_FUNCTION_IS_NULL

struct butterflyfish_sorted_map_p_p {
    ...
    int (*const keys)(void *object,
                      struct butterflyfish_sorted_set_p **out);
 ...
 * <i>NULL</i>.
 */
int butterflyfish_sorted_map_p_p_as_stream(
 ...
 * <i>NULL</i>.
 */
int butterflyfish_sorted_map_p_p_as_collection(
        const struct butterflyfish_sorted_map_p_p *object,
 ...
 * <i>NULL</i>.
 */
int butterflyfish_sorted_map_p_p_as_map(
        struct butterflyfish_sorted_map_p_p *object,
        struct butterflyfish_map_p_p **out);
 ...
 * <i>NULL</i>.
 */
int butterflyfish_sorted_map_p_p_as_ordered_map(
        struct butterflyfish_sorted_map_p_p *object,
        struct butterflyfish_ordered_map_p_p **out);
 ...
 * @throws BUTTERFLYFISH_SORTED_MAP_P_P_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_MAP_P_P_ERROR_MAP_IS_EMPTY if map is empty.
 */
 ...
 * @throws BUTTERFLYFISH_SORTED_MAP_P_P_ERROR_OBJECT_IS_NULL if object is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_MAP_P_P_ERROR_ENTRY_IS_NULL if entry is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_MAP_P_P_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_MAP_P_P_ERROR_END_OF_SEQUENCE if there is no
 * next entry.
 */
 ...
 * @throws BUTTERFLYFISH_SORTED_MAP_P_P_ERROR_OBJECT_IS_NULL if object is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_MAP_P_P_ERROR_OTHER_IS_NULL if other is
 * <i>NULL</i>.
 */
 ...
 * @throws BUTTERFLYFISH_SORTED_MAP_P_P_ERROR_OTHER_IS_NULL if other is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_MAP_P_P_ERROR_FUNCTION_IS_NULL if function is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_MAP_P_P_ERROR_MEMORY_ALLOCATION_FAILED if
...
#endif /* _BUTTERFLYFISH_SORTED_MAP_P_P_H_ */
