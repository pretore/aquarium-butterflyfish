#ifndef _BUTTERFLYFISH_SWAPPABLE_SETTABLE_SET_I_H_
#define _BUTTERFLYFISH_SWAPPABLE_SETTABLE_SET_I_H_
...
#define BUTTERFLYFISH_SWAPPABLE_SETTABLE_SET_I_ERROR_OBJECT_IS_NULL \
    BUTTERFLYFISH_SWAPPABLE_SET_I_ERROR_OBJECT_IS_NULL
#define BUTTERFLYFISH_SWAPPABLE_SETTABLE_SET_I_ERROR_OUT_IS_NULL \
    BUTTERFLYFISH_SWAPPABLE_SET_I_ERROR_OUT_IS_NULL
#define BUTTERFLYFISH_SWAPPABLE_SETTABLE_SET_I_ERROR_SET_IS_EMPTY \
    BUTTERFLYFISH_SWAPPABLE_SET_I_ERROR_SET_IS_EMPTY
#define BUTTERFLYFISH_SWAPPABLE_SETTABLE_SET_I_ERROR_ITEM_IS_NULL \
    BUTTERFLYFISH_SWAPPABLE_SET_I_ERROR_ITEM_IS_NULL
#define BUTTERFLYFISH_SWAPPABLE_SETTABLE_SET_I_ERROR_END_OF_SEQUENCE \
    BUTTERFLYFISH_SWAPPABLE_SET_I_ERROR_END_OF_SEQUENCE
#define BUTTERFLYFISH_SWAPPABLE_SETTABLE_SET_I_ERROR_OTHER_IS_NULL \
    BUTTERFLYFISH_SWAPPABLE_SET_I_ERROR_OTHER_IS_NULL
#define BUTTERFLYFISH_SWAPPABLE_SETTABLE_SET_I_ERROR_VALUE_IS_NULL \
    BUTTERFLYFISH_SWAPPABLE_SET_I_ERROR_VALUE_IS_NULL
#define BUTTERFLYFISH_SWAPPABLE_SETTABLE_SET_I_ERROR_MEMORY_ALLOCATION_FAILED \
    BUTTERFLYFISH_SWAPPABLE_SET_I_ERROR_MEMORY_ALLOCATION_FAILED
#define BUTTERFLYFISH_SWAPPABLE_SETTABLE_SET_I_ERROR_VALUE_NOT_FOUND \
    BUTTERFLYFISH_SWAPPABLE_SET_I_ERROR_VALUE_NOT_FOUND
#define BUTTERFLYFISH_SWAPPABLE_SETTABLE_SET_I_ERROR_VALUE_ALREADY_EXISTS \
    BUTTERFLYFISH_ORDERED_SETTABLE_SET_I_ERROR_VALUE_ALREADY_EXISTS
#define BUTTERFLYFISH_SWAPPABLE_SETTABLE_SET_I_ERROR_VALUE_IS_INVALID \
    BUTTERFLYFISH_ORDERED_SETTABLE_SET_I_ERROR_VALUE_IS_INVALID

struct butterflyfish_swappable_settable_set_i {
    int (*const as_ordered_settable_set)(
            struct butterflyfish_swappable_settable_set_i *object,
...
/**
 * @brief Return swappable set as a stream.
 * @param [in] object swappable set instance.
 * @param [out] out receive stream.
 * @return On success <i>0</i>, otherwise an error code.
 * @throws BUTTERFLYFISH_SWAPPABLE_SETTABLE_SET_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SWAPPABLE_SETTABLE_SET_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 */
int butterflyfish_swappable_settable_set_i_as_stream(
        const struct butterflyfish_swappable_settable_set_i *object,
        const struct butterflyfish_stream_i **out);

/**
 * @brief Return swappable set as a collection.
 * @param [in] object swappable set instance.
...
/**
 * @brief Return swappable set as settable.
 * @param [in] object swappable set instance.
...
/**
 * @brief Return swappable set as ordered.
 * @param [in] object swappable set instance.
...
/**
 * @brief Return swappable set as a set.
 * @param [in] object swappable set instance.
...
/**
 * @brief Return swappable set as a settable set.
 * @param [in] object swappable set instance.
...
/**
 * @brief Return swappable set as a ordered set.
 * @param [in] object swappable set instance.
...
/**
 * @brief Return swappable set as swappable.
 * @param [in] object swappable set instance.
...
/**
 * @brief Return swappable set as a ordered settable set.
 * @param [in] object swappable set instance.
 ...
 * @throws BUTTERFLYFISH_SWAPPABLE_SETTABLE_SET_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SWAPPABLE_SETTABLE_SET_I_ERROR_SET_IS_EMPTY if set is
 * empty.
 */
 ...
 * @throws BUTTERFLYFISH_SWAPPABLE_SETTABLE_SET_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SWAPPABLE_SETTABLE_SET_I_ERROR_ITEM_IS_NULL if item is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SWAPPABLE_SETTABLE_SET_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SWAPPABLE_SETTABLE_SET_I_ERROR_END_OF_SEQUENCE if
 ...
 * @throws BUTTERFLYFISH_SWAPPABLE_SETTABLE_SET_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SWAPPABLE_SETTABLE_SET_I_ERROR_VALUE_IS_NULL if
 * value is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SWAPPABLE_SETTABLE_SET_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SWAPPABLE_SETTABLE_SET_I_ERROR_MEMORY_ALLOCATION_FAILED
 ...
 * @throws BUTTERFLYFISH_SWAPPABLE_SETTABLE_SET_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SWAPPABLE_SETTABLE_SET_I_ERROR_OTHER_IS_NULL if
 * other is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SWAPPABLE_SETTABLE_SET_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SWAPPABLE_SETTABLE_SET_I_ERROR_MEMORY_ALLOCATION_FAILED
 ...
 * @throws BUTTERFLYFISH_SWAPPABLE_SETTABLE_SET_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SWAPPABLE_SETTABLE_SET_I_ERROR_VALUE_NOT_FOUND if
 ...
 * @throws BUTTERFLYFISH_SWAPPABLE_SETTABLE_SET_I_ERROR_VALUE_IS_NULL if
 * value is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SWAPPABLE_SETTABLE_SET_I_ERROR_VALUE_ALREADY_EXISTS if
 * value is already present in the set.
 * @throws BUTTERFLYFISH_SWAPPABLE_SETTABLE_SET_I_ERROR_VALUE_IS_INVALID if
 * value is invalid.
 * @throws BUTTERFLYFISH_SWAPPABLE_SETTABLE_SET_I_ERROR_MEMORY_ALLOCATION_FAILED
...
#endif /* _BUTTERFLYFISH_SWAPPABLE_SETTABLE_SET_I_H_ */
