#ifndef _BUTTERFLYFISH_INCREMENTAL_MAP_I_I_H_
#define _BUTTERFLYFISH_INCREMENTAL_MAP_I_I_H_
...
#define BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL \
    BUTTERFLYFISH_MAP_I_I_ERROR_OUT_IS_NULL
#define BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_MAP_IS_EMPTY \
    BUTTERFLYFISH_MAP_I_I_ERROR_MAP_IS_EMPTY
#define BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_ITEM_IS_NULL \
    BUTTERFLYFISH_MAP_I_I_ERROR_ITEM_IS_NULL
#define BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_END_OF_SEQUENCE \
    BUTTERFLYFISH_MAP_I_I_ERROR_END_OF_SEQUENCE
#define BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_OTHER_IS_NULL \
    BUTTERFLYFISH_MAP_I_I_ERROR_OTHER_IS_NULL
#define BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_VALUE_IS_NULL \
    BUTTERFLYFISH_MAP_I_I_ERROR_VALUE_IS_NULL
#define BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_ENTRY_IS_NULL \
    BUTTERFLYFISH_MAP_I_I_ERROR_ENTRY_IS_NULL
#define BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_KEY_IS_NULL \
    BUTTERFLYFISH_MAP_I_I_ERROR_KEY_IS_NULL
#define BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_MEMORY_ALLOCATION_FAILED \
    BUTTERFLYFISH_MAP_I_I_ERROR_MEMORY_ALLOCATION_FAILED
#define BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_VALUE_NOT_FOUND \
    BUTTERFLYFISH_MAP_I_I_ERROR_VALUE_NOT_FOUND
#define BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_ENTRY_NOT_FOUND \
    BUTTERFLYFISH_MAP_I_I_ERROR_ENTRY_NOT_FOUND
#define BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_KEY_NOT_FOUND \
    BUTTERFLYFISH_MAP_I_I_ERROR_KEY_NOT_FOUND
#define BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_VALUE_IS_INVALID \
    BUTTERFLYFISH_ADDABLE_I_I_ERROR_VALUE_IS_INVALID
#define BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_ENTRY_IS_INVALID \
    BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_VALUE_IS_INVALID
#define BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_KEY_ALREADY_EXISTS \
    BUTTERFLYFISH_ADDABLE_I_I_ERROR_VALUE_ALREADY_EXISTS

struct butterflyfish_incremental_map_i_i {
    int (*const as_map)(
 ...
 * @throws BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_OBJECT_IS_NULL if object
 * is <i>NULL</i>.
 * @throws BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 */
int butterflyfish_incremental_map_i_i_as_stream(
        const struct butterflyfish_incremental_map_i_i *object,
 ...
 * <i>NULL</i>.
 */
int butterflyfish_incremental_map_i_i_as_collection(
        const struct butterflyfish_incremental_map_i_i *object,
 ...
 * <i>NULL</i>.
 */
int butterflyfish_incremental_map_i_i_as_set(
        const struct butterflyfish_incremental_map_i_i *object,
 ...
 * <i>NULL</i>.
 */
int butterflyfish_incremental_map_i_i_as_addable(
        struct butterflyfish_incremental_map_i_i *object,
        struct butterflyfish_addable_i_i **out);
 ...
 * <i>NULL</i>.
 */
int butterflyfish_incremental_map_i_i_as_map(
        const struct butterflyfish_incremental_map_i_i *object,
        const struct butterflyfish_map_i_i **out);
 ...
 * <i>NULL</i>.
 */
int butterflyfish_incremental_map_i_i_count(
        const struct butterflyfish_incremental_map_i_i *object,
        uintmax_t *out);
 ...
 * @throws BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_MAP_IS_EMPTY if map is
 * empty.
 */
int butterflyfish_incremental_map_i_i_first(
        const struct butterflyfish_incremental_map_i_i *object,
 ...
 * empty.
 */
int butterflyfish_incremental_map_i_i_last(
        const struct butterflyfish_incremental_map_i_i *object,
        const struct butterflyfish_map_i_i_entry **out);
 ...
 * @throws BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_OBJECT_IS_NULL if object
 * is <i>NULL</i>.
 * @throws BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_ITEM_IS_NULL if item is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_END_OF_SEQUENCE if there
 * is no next item.
 */
int butterflyfish_incremental_map_i_i_next(
        const struct butterflyfish_incremental_map_i_i *object,
 ...
 * is no previous item.
 */
int butterflyfish_incremental_map_i_i_prev(
        const struct butterflyfish_incremental_map_i_i *object,
        const struct butterflyfish_map_i_i_entry *item,
        const struct butterflyfish_map_i_i_entry **out);
 ...
 * @throws BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_OBJECT_IS_NULL if object
 * is <i>NULL</i>.
 * @throws BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_ENTRY_IS_NULL if entry is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_MEMORY_ALLOCATION_FAILED
 ...
 * @throws BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_OBJECT_IS_NULL if object
 * is <i>NULL</i>.
 * @throws BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_KEY_IS_NULL if key is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_MEMORY_ALLOCATION_FAILED
 * if there is insufficient memory to find the entry.
 */
int butterflyfish_incremental_map_i_i_contains_key(
        const struct butterflyfish_incremental_map_i_i *object,
        const struct sea_turtle_integer *key,
        bool *out);
 ...
 * @throws BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_OBJECT_IS_NULL if object
 * is <i>NULL</i>.
 * @throws BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_VALUE_IS_NULL if value is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_MEMORY_ALLOCATION_FAILED
 * if there is insufficient memory to find the entry.
 */
int butterflyfish_incremental_map_i_i_contains_value(
        const struct butterflyfish_incremental_map_i_i *object,
        const struct sea_turtle_integer *value,
        bool *out);
 ...
 * @throws BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_OBJECT_IS_NULL if object
 * is <i>NULL</i>.
 * @throws BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_OTHER_IS_NULL if other is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_MEMORY_ALLOCATION_FAILED
 * if there is insufficient memory to find the entry.
 */
int butterflyfish_incremental_map_i_i_contains_all(
        const struct butterflyfish_incremental_map_i_i *object,
 ...
 * if there is insufficient memory to find the entry.
 */
int butterflyfish_incremental_map_i_i_contains_all_keys(
        const struct butterflyfish_incremental_map_i_i *object,
 ...
 * if there is insufficient memory to find the entry.
 */
int butterflyfish_incremental_map_i_i_contains_all_values(
        const struct butterflyfish_incremental_map_i_i *object,
        const struct butterflyfish_stream_i *other,
        bool *out);
 ...
 * @throws BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_ENTRY_NOT_FOUND if entry
 * is not in the map instance.
 * @throws BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_MEMORY_ALLOCATION_FAILED
 * if there is insufficient memory to find the entry.
 */
int butterflyfish_incremental_map_i_i_get(
        const struct butterflyfish_incremental_map_i_i *object,
        const struct butterflyfish_map_i_i_entry *entry,
        const struct butterflyfish_map_i_i_entry **out);
 ...
 * @throws BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_KEY_NOT_FOUND if key is
 * not in the map instance.
 * @throws BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_MEMORY_ALLOCATION_FAILED
 * if there is insufficient memory to find the value.
 */
int butterflyfish_incremental_map_i_i_get_value(
        const struct butterflyfish_incremental_map_i_i *object,
        const struct sea_turtle_integer *key,
 ...
 * if there is insufficient memory to find the value.
 */
int butterflyfish_incremental_map_i_i_get_entry(
        const struct butterflyfish_incremental_map_i_i *object,
        const struct sea_turtle_integer *key,
        const struct butterflyfish_map_i_i_entry **out);
 ...
 * @return On success <i>0</i>, otherwise an error code.
 * @throws BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_OBJECT_IS_NULL if object is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_ENTRY_IS_NULL if entry is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_KEY_ALREADY_EXISTS if key
 * is already present in the map.
 * @throws BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_ENTRY_IS_INVALID if entry is
 * invalid.
 * @throws BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_MEMORY_ALLOCATION_FAILED
 ...
 */
int butterflyfish_incremental_map_i_i_add_all(
        struct butterflyfish_incremental_map_i_i *object,
        const struct butterflyfish_stream_i_i *other);
 ...
 * @throws BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_KEY_ALREADY_EXISTS if key
 * is already present in the map.
 * @throws BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_VALUE_IS_INVALID if value
 * is invalid.
 * @throws BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_MEMORY_ALLOCATION_FAILED if
 * there is insufficient memory to add value to the set.
 * @note <b>value</b> is copied.
 */
int butterflyfish_incremental_map_i_i_add_value(
        struct butterflyfish_incremental_map_i_i *object,
        const struct sea_turtle_integer *key,
        const struct sea_turtle_integer *value);
 ...
 * <i>NULL</i>.
 */
int butterflyfish_incremental_map_i_i_keys(
        struct butterflyfish_incremental_map_i_i *object,
        struct butterflyfish_incremental_set_i **out);
...
#endif /* _BUTTERFLYFISH_INCREMENTAL_MAP_I_I_H_ */
