...
struct butterflyfish_incremental_map_i_i {
    ...
    const struct butterflyfish_incremental_set_i *const keys;
     ...
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL if out is <i>NULL</i>.
     */
     ...
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL if out is <i>NULL</i>.
     * @throws BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_MAP_IS_EMPTY if map is empty.
     */
     ...
     * @throws BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_OBJECT_IS_NULL if object is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_ITEM_IS_NULL if item is <i>NULL</i>.
     * @throws BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL if out is <i>NULL</i>.
     * @throws BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_END_OF_SEQUENCE if there is no next
     * item.
     */
     ...
     * @throws BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_ITEM_IS_NULL if item is <i>NULL</i>.
     * @throws BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL if out is <i>NULL</i>.
     * @throws BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_END_OF_SEQUENCE if there is no
     * previous item.
     */
     ...
     * @throws BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_OBJECT_IS_NULL if object is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_KEY_IS_NULL if key is <i>NULL</i>.
     * @throws BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL if out is <i>NULL</i>.
     * @throws BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_MEMORY_ALLOCATION_FAILED if there is
     ...
     * @throws BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_KEY_IS_NULL if key is <i>NULL</i>.
     * @throws BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_OUT_IS_NULL if out is <i>NULL</i>.
     * @throws BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_KEY_NOT_FOUND if key is not in the
     * map instance.
     * @throws BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_MEMORY_ALLOCATION_FAILED if there is
     ...
     * @return On success <i>0</i>, otherwise an error code.
     * @throws BUTTERFLYFISH_INCREMENTAL_MAP_I_I_ERROR_OBJECT_IS_NULL if
     * object is <i>NULL</i>.
