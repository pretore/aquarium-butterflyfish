...
struct butterflyfish_settable_list_i {
     ...
     * @throws BUTTERFLYFISH_SETTABLE_LIST_I_ERROR_OBJECT_IS_NULL if object
     * is <i>NULL</i>.
     ...
     * @throws BUTTERFLYFISH_SETTABLE_LIST_I_ERROR_OUT_IS_NULL if out is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_LIST_I_ERROR_LIST_IS_EMPTY if list is
     * empty.
     */
     ...
     * @throws BUTTERFLYFISH_SETTABLE_LIST_I_ERROR_OUT_IS_NULL if out is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_LIST_I_ERROR_END_OF_SEQUENCE if there
     * is no next item.
     */
     ...
     * @throws BUTTERFLYFISH_SETTABLE_LIST_I_ERROR_OUT_IS_NULL if out is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_LIST_I_ERROR_INDEX_IS_OUT_OF_BOUNDS if
     ...
     * @throws BUTTERFLYFISH_SETTABLE_LIST_I_ERROR_OUT_IS_NULL if out is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_LIST_I_ERROR_ITEM_NOT_FOUND if item is
     ...
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_LIST_I_ERROR_VALUE_IS_INVALID if
     * value is invalid.
     * @throws BUTTERFLYFISH_SETTABLE_LIST_I_ERROR_VALUE_ALREADY_EXISTS if
     * value is already present.
     * @throws BUTTERFLYFISH_SETTABLE_LIST_I_ERROR_MEMORY_ALLOCATION_FAILED
     ...
     * @throws BUTTERFLYFISH_SETTABLE_LIST_I_ERROR_VALUE_IS_NULL if value is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_LIST_I_ERROR_INDEX_IS_OUT_OF_BOUNDS
