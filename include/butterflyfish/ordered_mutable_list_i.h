#ifndef _BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_H_
#define _BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_H_
...
#define BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_ERROR_OBJECT_IS_NULL \
    BUTTERFLYFISH_MUTABLE_LIST_I_ERROR_OBJECT_IS_NULL
#define BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_ERROR_OUT_IS_NULL \
    BUTTERFLYFISH_MUTABLE_LIST_I_ERROR_OUT_IS_NULL
#define BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_ERROR_LIST_IS_EMPTY \
    BUTTERFLYFISH_MUTABLE_LIST_I_ERROR_LIST_IS_EMPTY
#define BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_ERROR_ITEM_IS_NULL \
    BUTTERFLYFISH_MUTABLE_LIST_I_ERROR_ITEM_IS_NULL
#define BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_ERROR_END_OF_SEQUENCE \
    BUTTERFLYFISH_MUTABLE_LIST_I_ERROR_END_OF_SEQUENCE
#define BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_ERROR_INDEX_IS_OUT_OF_BOUNDS \
    BUTTERFLYFISH_MUTABLE_LIST_I_ERROR_INDEX_IS_OUT_OF_BOUNDS
#define BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_ERROR_ITEM_NOT_FOUND \
    BUTTERFLYFISH_MUTABLE_LIST_I_ERROR_ITEM_NOT_FOUND
#define BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_ERROR_VALUE_IS_NULL \
    BUTTERFLYFISH_MUTABLE_LIST_I_ERROR_VALUE_IS_NULL
#define BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_ERROR_MEMORY_ALLOCATION_FAILED \
    BUTTERFLYFISH_MUTABLE_LIST_I_ERROR_MEMORY_ALLOCATION_FAILED
#define BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_ERROR_VALUE_IS_INVALID \
    BUTTERFLYFISH_MUTABLE_LIST_I_ERROR_VALUE_IS_INVALID
#define BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_ERROR_OTHER_IS_NULL \
 ...
 * @throws BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 */
int butterflyfish_ordered_mutable_list_i_as_stream(
        const struct butterflyfish_ordered_mutable_list_i *object,
 ...
 * @throws BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_ERROR_LIST_IS_EMPTY if list
 * is empty.
 */
 ...
 * @throws BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_ERROR_ITEM_IS_NULL if item is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_ERROR_END_OF_SEQUENCE if there
 * is no next item.
 */
 ...
 * @throws BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_ERROR_INDEX_IS_OUT_OF_BOUNDS if
 ...
 * @throws BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_ERROR_ITEM_NOT_FOUND if item is
 ...
 * @throws BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_ERROR_VALUE_IS_NULL if value is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_ERROR_INDEX_IS_OUT_OF_BOUNDS if
 * at does not refer to an item contained within the list.
 * @throws BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_ERROR_MEMORY_ALLOCATION_FAILED
 * if there is not enough memory to set the item to value.
 * @throws BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_ERROR_VALUE_IS_INVALID if value
 * is invalid.
 ...
 * <i>NULL</i>.
 * @throws
 * BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_ERROR_MEMORY_ALLOCATION_FAILED if
 ...
 * @throws BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_ERROR_VALUE_IS_NULL if value
 * is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_ERROR_MEMORY_ALLOCATION_FAILED
 * if there is not enough memory to add the value.
 * @throws BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_ERROR_VALUE_IS_INVALID if
 * value is invalid.
 ...
 * @throws BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_ERROR_OTHER_IS_NULL if
 * other is <i>NULL</i>.
 * @throws
 * BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_ERROR_MEMORY_ALLOCATION_FAILED if
 ...
 * @throws BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_ERROR_ITEM_IS_NULL if
 * item is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_ERROR_VALUE_IS_NULL if
 * value is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_ERROR_VALUE_IS_INVALID if
 * value is invalid.
 * @throws
 ...
 * @throws BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_ERROR_ITEM_IS_NULL if item
 * is <i>NULL</i>.
 ...
 * @throws BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_ERROR_INDEX_IS_OUT_OF_BOUNDS
...
#endif /* _BUTTERFLYFISH_ORDERED_MUTABLE_LIST_I_H_ */
