...
#define BUTTERFLYFISH_MUTABLE_SET_$T$_ERROR_OTHER_IS_NULL \
...
struct butterflyfish_mutable_set_$t$ {
    int (*const as_settable_incremental_set)(
            struct butterflyfish_mutable_set_$t$ *object,
 ...
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_MUTABLE_SET_$T$_ERROR_OUT_IS_NULL if out is <i>NULL</i>.
 */
int butterflyfish_mutable_set_$t$_as_stream(
        const struct butterflyfish_mutable_set_$t$ *object,
 ...
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_MUTABLE_SET_$T$_ERROR_OUT_IS_NULL if out is <i>NULL</i>.
 * @throws BUTTERFLYFISH_MUTABLE_SET_$T$_ERROR_END_OF_SEQUENCE if there is no
 * next item.
 */
 ...
 * @throws BUTTERFLYFISH_MUTABLE_SET_$T$_ERROR_OBJECT_IS_NULL if object is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_MUTABLE_SET_$T$_ERROR_OTHER_IS_NULL if other is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_MUTABLE_SET_$T$_ERROR_OUT_IS_NULL if out is <i>NULL</i>.
 * @throws BUTTERFLYFISH_MUTABLE_SET_$T$_ERROR_MEMORY_ALLOCATION_FAILED if
 * there is insufficient memory to find the item.
 ...
 * @throws BUTTERFLYFISH_MUTABLE_SET_$T$_ERROR_VALUE_IS_NULL if value is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_MUTABLE_SET_$T$_ERROR_VALUE_ALREADY_EXISTS if value is
 * already present in the set.
 * @throws BUTTERFLYFISH_MUTABLE_SET_$T$_ERROR_VALUE_IS_INVALID if value is
 * invalid.
 * @throws BUTTERFLYFISH_MUTABLE_SET_$T$_ERROR_MEMORY_ALLOCATION_FAILED if there
