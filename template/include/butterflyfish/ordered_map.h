...
struct butterflyfish_ordered_map_$t$ {
    ...
    const struct butterflyfish_ordered_set_$mkt$ *const keys;
     ...
     * @throws BUTTERFLYFISH_ORDERED_MAP_$T$_ERROR_OUT_IS_NULL if out is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_ORDERED_MAP_$T$_ERROR_MAP_IS_EMPTY if map is
     * empty.
     */
     ...
     * @throws BUTTERFLYFISH_ORDERED_MAP_$T$_ERROR_OUT_IS_NULL if out is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_ORDERED_MAP_$T$_ERROR_END_OF_SEQUENCE if there
     * is no next item.
     */
     ...
     * @throws BUTTERFLYFISH_ORDERED_MAP_$T$_ERROR_OUT_IS_NULL if out is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_ORDERED_MAP_$T$_ERROR_MEMORY_ALLOCATION_FAILED
     ...
     * @throws BUTTERFLYFISH_ORDERED_MAP_$T$_ERROR_OUT_IS_NULL if out is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_ORDERED_MAP_$T$_ERROR_KEY_NOT_FOUND if key is
