...
struct butterflyfish_mutable_list_$t$ {
     ...
     * @throws BUTTERFLYFISH_MUTABLE_LIST_$T$_ERROR_OUT_IS_NULL if out is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_MUTABLE_LIST_$T$_ERROR_LIST_IS_EMPTY if list is
     * empty.
     */
     ...
     * @throws BUTTERFLYFISH_MUTABLE_LIST_$T$_ERROR_OUT_IS_NULL if out is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_MUTABLE_LIST_$T$_ERROR_END_OF_SEQUENCE if there is
     * no next item.
     */
     ...
     * @throws BUTTERFLYFISH_MUTABLE_LIST_$T$_ERROR_OUT_IS_NULL if out is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_MUTABLE_LIST_$T$_ERROR_INDEX_IS_OUT_OF_BOUNDS
     ...
     * @throws BUTTERFLYFISH_MUTABLE_LIST_$T$_ERROR_OUT_IS_NULL if out is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_MUTABLE_LIST_$T$_ERROR_ITEM_NOT_FOUND if item is
     ...
     * is invalid.
     * @throws BUTTERFLYFISH_MUTABLE_LIST_$T$_ERROR_VALUE_ALREADY_EXISTS if
     ...
     * @throws BUTTERFLYFISH_MUTABLE_LIST_$T$_ERROR_VALUE_IS_NULL if value is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_MUTABLE_LIST_$T$_ERROR_INDEX_IS_OUT_OF_BOUNDS if
     * at does not refer to an item contained within the list.
     * @throws BUTTERFLYFISH_MUTABLE_LIST_$T$_ERROR_MEMORY_ALLOCATION_FAILED
     * if there is not enough memory to set the item to value.
     * @throws BUTTERFLYFISH_MUTABLE_LIST_$T$_ERROR_VALUE_IS_INVALID
     * if value is invalid.
