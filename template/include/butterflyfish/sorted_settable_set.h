#ifndef _BUTTERFLYFISH_SORTED_SETTABLE_SET_$T$_H_
#define _BUTTERFLYFISH_SORTED_SETTABLE_SET_$T$_H_
...
#define BUTTERFLYFISH_SORTED_SETTABLE_SET_$T$_ERROR_OBJECT_IS_NULL \
    BUTTERFLYFISH_SORTED_SET_$T$_ERROR_OBJECT_IS_NULL
#define BUTTERFLYFISH_SORTED_SETTABLE_SET_$T$_ERROR_OUT_IS_NULL \
    BUTTERFLYFISH_SORTED_SET_$T$_ERROR_OUT_IS_NULL
#define BUTTERFLYFISH_SORTED_SETTABLE_SET_$T$_ERROR_SET_IS_EMPTY \
    BUTTERFLYFISH_SORTED_SET_$T$_ERROR_SET_IS_EMPTY
#define BUTTERFLYFISH_SORTED_SETTABLE_SET_$T$_ERROR_ITEM_IS_NULL \
    BUTTERFLYFISH_SORTED_SET_$T$_ERROR_ITEM_IS_NULL
#define BUTTERFLYFISH_SORTED_SETTABLE_SET_$T$_ERROR_END_OF_SEQUENCE \
    BUTTERFLYFISH_SORTED_SET_$T$_ERROR_END_OF_SEQUENCE
#define BUTTERFLYFISH_SORTED_SETTABLE_SET_$T$_ERROR_OTHER_IS_NULL \
    BUTTERFLYFISH_SORTED_SET_$T$_ERROR_OTHER_IS_NULL
#define BUTTERFLYFISH_SORTED_SETTABLE_SET_$T$_ERROR_VALUE_IS_NULL \
    BUTTERFLYFISH_SORTED_SET_$T$_ERROR_VALUE_IS_NULL
#define BUTTERFLYFISH_SORTED_SETTABLE_SET_$T$_ERROR_VALUE_ALREADY_EXISTS \
    BUTTERFLYFISH_SETTABLE_SET_$T$_ERROR_VALUE_ALREADY_EXISTS
#define BUTTERFLYFISH_SORTED_SETTABLE_SET_$T$_ERROR_VALUE_IS_INVALID \
    BUTTERFLYFISH_SETTABLE_SET_$T$_ERROR_VALUE_IS_INVALID
#define BUTTERFLYFISH_SORTED_SETTABLE_SET_$T$_ERROR_MEMORY_ALLOCATION_FAILED \
    BUTTERFLYFISH_SORTED_SET_$T$_ERROR_MEMORY_ALLOCATION_FAILED
#define BUTTERFLYFISH_SORTED_SETTABLE_SET_$T$_ERROR_VALUE_NOT_FOUND \
    BUTTERFLYFISH_SORTED_SET_$T$_ERROR_VALUE_NOT_FOUND

struct butterflyfish_sorted_settable_set_$t$ {
    int (*const as_sorted_set)(
            const struct butterflyfish_sorted_settable_set_$t$ *object,
            const struct butterflyfish_sorted_set_$t$ **out);

    int (*const as_settable_set)(
            struct butterflyfish_sorted_settable_set_$t$ *object,
 ...
 * @throws BUTTERFLYFISH_SORTED_SETTABLE_SET_$T$_ERROR_OBJECT_IS_NULL if object
 * is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_SETTABLE_SET_$T$_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 */
int butterflyfish_sorted_settable_set_$t$_as_stream(
        const struct butterflyfish_sorted_settable_set_$t$ *object,
 ...
 * <i>NULL</i>.
 */
int butterflyfish_sorted_settable_set_$t$_as_collection(
        const struct butterflyfish_sorted_settable_set_$t$ *object,
 ...
 * <i>NULL</i>.
 */
int butterflyfish_sorted_settable_set_$t$_as_settable(
        struct butterflyfish_sorted_settable_set_$t$ *object,
 ...
 * <i>NULL</i>.
 */
int butterflyfish_sorted_settable_set_$t$_as_sorted(
        const struct butterflyfish_sorted_settable_set_$t$ *object,
 ...
 * <i>NULL</i>.
 */
int butterflyfish_sorted_settable_set_$t$_as_set(
        const struct butterflyfish_sorted_settable_set_$t$ *object,
 ...
 * <i>NULL</i>.
 */
int butterflyfish_sorted_settable_set_$t$_as_sorted_set(
        const struct butterflyfish_sorted_settable_set_$t$ *object,
        const struct butterflyfish_sorted_set_$t$ **out);
 ...
 * <i>NULL</i>.
 */
int butterflyfish_sorted_settable_set_$t$_as_settable_set(
        struct butterflyfish_sorted_settable_set_$t$ *object,
        struct butterflyfish_settable_set_$t$ **out);
 ...
 * <i>NULL</i>.
 */
int butterflyfish_sorted_settable_set_$t$_count(
        const struct butterflyfish_sorted_settable_set_$t$ *object,
        uintmax_t *out);
 ...
 * @throws BUTTERFLYFISH_SORTED_SETTABLE_SET_$T$_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_SETTABLE_SET_$T$_ERROR_SET_IS_EMPTY if set is
 * empty.
 */
int butterflyfish_sorted_settable_set_$t$_first(
        const struct butterflyfish_sorted_settable_set_$t$ *object,
        const $v$*out);
 ...
 * empty.
 */
int butterflyfish_sorted_settable_set_$t$_last(
        const struct butterflyfish_sorted_settable_set_$t$ *object,
        const $v$*out);
 ...
 * @throws BUTTERFLYFISH_SORTED_SETTABLE_SET_$T$_ERROR_OBJECT_IS_NULL if object
 * is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_SETTABLE_SET_$T$_ERROR_ITEM_IS_NULL if item is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_SETTABLE_SET_$T$_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_SETTABLE_SET_$T$_ERROR_END_OF_SEQUENCE if there
 * is no next item.
 */
int butterflyfish_sorted_settable_set_$t$_next(
        const struct butterflyfish_sorted_settable_set_$t$ *object,
        const $v$item,
        const $v$*out);
 ...
 * is no previous item.
 */
int butterflyfish_sorted_settable_set_$t$_prev(
        const struct butterflyfish_sorted_settable_set_$t$ *object,
        const $v$item,
        const $v$*out);
 ...
 * @throws BUTTERFLYFISH_SORTED_SETTABLE_SET_$T$_ERROR_OBJECT_IS_NULL if object
 * is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_SETTABLE_SET_$T$_ERROR_VALUE_IS_NULL if value is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_SETTABLE_SET_$T$_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_SETTABLE_SET_$T$_ERROR_MEMORY_ALLOCATION_FAILED
 * if there is insufficient memory to find the item.
 */
int butterflyfish_sorted_settable_set_$t$_contains(
        const struct butterflyfish_sorted_settable_set_$t$ *object,
        const $v$value,
        bool *out);
 ...
 * @throws BUTTERFLYFISH_SORTED_SETTABLE_SET_$T$_ERROR_OBJECT_IS_NULL if object
 * is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_SETTABLE_SET_$T$_ERROR_OTHER_IS_NULL if other is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_SETTABLE_SET_$T$_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_SETTABLE_SET_$T$_ERROR_MEMORY_ALLOCATION_FAILED
 * if there is insufficient memory to find the item.
 */
int butterflyfish_sorted_settable_set_$t$_contains_all(
        const struct butterflyfish_sorted_settable_set_$t$ *object,
 ...
 * @throws BUTTERFLYFISH_SORTED_SETTABLE_SET_$T$_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_SETTABLE_SET_$T$_ERROR_VALUE_NOT_FOUND if value
 * is not in the set instance.
 * @throws BUTTERFLYFISH_SORTED_SETTABLE_SET_$T$_ERROR_MEMORY_ALLOCATION_FAILED
 * if there is insufficient memory to find the item.
 */
int butterflyfish_sorted_settable_set_$t$_get(
        const struct butterflyfish_sorted_settable_set_$t$ *object,
        const $v$value,
        const $v$*out);
 ...
 * @throws BUTTERFLYFISH_SORTED_SETTABLE_SET_$T$_ERROR_VALUE_IS_NULL if value is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_SETTABLE_SET_$T$_ERROR_VALUE_ALREADY_EXISTS if
 * value is already present in the set.
 * @throws BUTTERFLYFISH_SORTED_SETTABLE_SET_$T$_ERROR_VALUE_IS_INVALID if
 * value is invalid.
 * @throws BUTTERFLYFISH_SORTED_SETTABLE_SET_$T$_ERROR_MEMORY_ALLOCATION_FAILED
 * if there is not enough memory to set the item to value.
 * @note <b>value</b> is copied and then item is set to it.
 */
int butterflyfish_sorted_settable_set_$t$_set_item(
        struct butterflyfish_sorted_settable_set_$t$ *object,
        const $v$item,
        const $v$value);
 ...
 * @throws BUTTERFLYFISH_SORTED_SETTABLE_SET_$T$_ERROR_VALUE_IS_NULL if value is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_SETTABLE_SET_$T$_ERROR_VALUE_NOT_FOUND if item is
 * not in the set.
 * @throws BUTTERFLYFISH_SORTED_SETTABLE_SET_$T$_ERROR_VALUE_ALREADY_EXISTS if
 * value is already present in the set.
 * @throws BUTTERFLYFISH_SORTED_SETTABLE_SET_$T$_ERROR_VALUE_IS_INVALID if
 ...
 */
int butterflyfish_sorted_settable_set_$t$_set(
        struct butterflyfish_sorted_settable_set_$t$ *object,
        const $v$item,
        const $v$value);
 ...
 * @throws BUTTERFLYFISH_SORTED_SETTABLE_SET_$T$_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_SETTABLE_SET_$T$_ERROR_VALUE_NOT_FOUND if no
 * value in sorted settable set was equal to or higher than value.
 * @throws BUTTERFLYFISH_SORTED_SETTABLE_SET_$T$_ERROR_MEMORY_ALLOCATION_FAILED
 * if there is insufficient memory to find the item.
 */
int butterflyfish_sorted_settable_set_$t$_ceiling(
        const struct butterflyfish_sorted_settable_set_$t$ *object,
        const $v$value,
        const $v$*out);
 ...
 */
int butterflyfish_sorted_settable_set_$t$_floor(
        const struct butterflyfish_sorted_settable_set_$t$ *object,
        const $v$value,
        const $v$*out);
 ...
 * if there is insufficient memory to find the item.
 */
int butterflyfish_sorted_settable_set_$t$_higher(
        const struct butterflyfish_sorted_settable_set_$t$ *object,
        const $v$value,
        const $v$*out);
 ...
 * if there is insufficient memory to find the item.
 */
int butterflyfish_sorted_settable_set_$t$_lower(
        const struct butterflyfish_sorted_settable_set_$t$ *object,
        const $v$value,
        const $v$*out);

#endif /* _BUTTERFLYFISH_SORTED_SETTABLE_SET_$T$_H_ */
