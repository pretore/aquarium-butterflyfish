#ifndef _BUTTERFLYFISH_SORTED_INCREMENTAL_SET_$T$_H_
#define _BUTTERFLYFISH_SORTED_INCREMENTAL_SET_$T$_H_
...
#define BUTTERFLYFISH_SORTED_INCREMENTAL_SET_$T$_ERROR_OBJECT_IS_NULL \
    BUTTERFLYFISH_SORTED_SET_$T$_ERROR_OBJECT_IS_NULL
#define BUTTERFLYFISH_SORTED_INCREMENTAL_SET_$T$_ERROR_OUT_IS_NULL \
    BUTTERFLYFISH_SORTED_SET_$T$_ERROR_OUT_IS_NULL
#define BUTTERFLYFISH_SORTED_INCREMENTAL_SET_$T$_ERROR_SET_IS_EMPTY \
    BUTTERFLYFISH_SORTED_SET_$T$_ERROR_SET_IS_EMPTY
#define BUTTERFLYFISH_SORTED_INCREMENTAL_SET_$T$_ERROR_ITEM_IS_NULL \
    BUTTERFLYFISH_SORTED_SET_$T$_ERROR_ITEM_IS_NULL
#define BUTTERFLYFISH_SORTED_INCREMENTAL_SET_$T$_ERROR_END_OF_SEQUENCE \
    BUTTERFLYFISH_SORTED_SET_$T$_ERROR_END_OF_SEQUENCE
#define BUTTERFLYFISH_SORTED_INCREMENTAL_SET_$T$_ERROR_OTHER_IS_NULL \
    BUTTERFLYFISH_SORTED_SET_$T$_ERROR_OTHER_IS_NULL
#define BUTTERFLYFISH_SORTED_INCREMENTAL_SET_$T$_ERROR_VALUE_IS_NULL \
    BUTTERFLYFISH_SORTED_SET_$T$_ERROR_VALUE_IS_NULL
#define BUTTERFLYFISH_SORTED_INCREMENTAL_SET_$T$_ERROR_VALUE_ALREADY_EXISTS \
    BUTTERFLYFISH_INCREMENTAL_SET_$T$_ERROR_VALUE_ALREADY_EXISTS
#define BUTTERFLYFISH_SORTED_INCREMENTAL_SET_$T$_ERROR_VALUE_IS_INVALID \
    BUTTERFLYFISH_INCREMENTAL_SET_$T$_ERROR_VALUE_IS_INVALID
#define BUTTERFLYFISH_SORTED_INCREMENTAL_SET_$T$_ERROR_MEMORY_ALLOCATION_FAILED \
    BUTTERFLYFISH_SORTED_SET_$T$_ERROR_MEMORY_ALLOCATION_FAILED
#define BUTTERFLYFISH_SORTED_INCREMENTAL_SET_$T$_ERROR_VALUE_NOT_FOUND \
    BUTTERFLYFISH_SORTED_SET_$T$_ERROR_VALUE_NOT_FOUND

struct butterflyfish_sorted_incremental_set_$t$ {
    int (*const as_sorted_set)(
            const struct butterflyfish_sorted_incremental_set_$t$ *object,
            const struct butterflyfish_sorted_set_$t$ **out);

    int (*const as_incremental_set)(
            struct butterflyfish_sorted_incremental_set_$t$ *object,
 ...
 * @throws BUTTERFLYFISH_SORTED_INCREMENTAL_SET_$T$_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_INCREMENTAL_SET_$T$_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 */
 ...
 * @throws BUTTERFLYFISH_SORTED_INCREMENTAL_SET_$T$_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_INCREMENTAL_SET_$T$_ERROR_SET_IS_EMPTY if set
 * is empty.
 */
 ...
 * @throws BUTTERFLYFISH_SORTED_INCREMENTAL_SET_$T$_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_INCREMENTAL_SET_$T$_ERROR_ITEM_IS_NULL if item
 * is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_INCREMENTAL_SET_$T$_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_INCREMENTAL_SET_$T$_ERROR_END_OF_SEQUENCE if
 ...
 * @throws BUTTERFLYFISH_SORTED_INCREMENTAL_SET_$T$_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_INCREMENTAL_SET_$T$_ERROR_VALUE_IS_NULL if
 * value is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_INCREMENTAL_SET_$T$_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_INCREMENTAL_SET_$T$_ERROR_MEMORY_ALLOCATION_FAILED
 ...
 * @throws BUTTERFLYFISH_SORTED_INCREMENTAL_SET_$T$_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_INCREMENTAL_SET_$T$_ERROR_OTHER_IS_NULL if
 * other is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_INCREMENTAL_SET_$T$_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_INCREMENTAL_SET_$T$_ERROR_MEMORY_ALLOCATION_FAILED
 ...
 * @throws BUTTERFLYFISH_SORTED_INCREMENTAL_SET_$T$_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_INCREMENTAL_SET_$T$_ERROR_VALUE_NOT_FOUND if
 ...
 * @throws BUTTERFLYFISH_SORTED_INCREMENTAL_SET_$T$_ERROR_VALUE_IS_NULL if
 * value is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_INCREMENTAL_SET_$T$_ERROR_VALUE_ALREADY_EXISTS if
 * value is already present in the set.
 * @throws BUTTERFLYFISH_SORTED_INCREMENTAL_SET_$T$_ERROR_VALUE_IS_INVALID if
 * value is invalid.
 * @throws BUTTERFLYFISH_SORTED_INCREMENTAL_SET_$T$_ERROR_MEMORY_ALLOCATION_FAILED
 ...
 * @throws BUTTERFLYFISH_SORTED_INCREMENTAL_SET_$T$_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SORTED_INCREMENTAL_SET_$T$_ERROR_VALUE_NOT_FOUND if no
...
#endif /* _BUTTERFLYFISH_SORTED_INCREMENTAL_SET_$T$_H_ */
