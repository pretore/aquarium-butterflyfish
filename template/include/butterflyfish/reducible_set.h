...
struct butterflyfish_reducible_set_$t$ {
    int (*const as_set)(const struct butterflyfish_reducible_set_$t$ *object,
                        const struct butterflyfish_set_$t$ **out);

    int (*const as_removable)(
            struct butterflyfish_reducible_set_$t$ *object,
            struct butterflyfish_removable_$t$ **out);

    int (*const remove)(struct butterflyfish_reducible_set_$t$ *object,
                        const $v$value);

    int (*const remove_all)(struct butterflyfish_reducible_set_$t$ *object,
                            const struct butterflyfish_stream_$t$ *other);

    int (*const retain_all)(struct butterflyfish_reducible_set_$t$ *object,
                            const struct butterflyfish_stream_$t$ *other);
};
...
int butterflyfish_reducible_set_$t$_as_stream(
        const struct butterflyfish_reducible_set_$t$ *object,
 ...
 * @throws BUTTERFLYFISH_REDUCIBLE_SET_$T$_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_REDUCIBLE_SET_$T$_ERROR_SET_IS_EMPTY if set is empty.
 */
 ...
 * @throws BUTTERFLYFISH_REDUCIBLE_SET_$T$_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_REDUCIBLE_SET_$T$_ERROR_END_OF_SEQUENCE if there is no
 * next item.
 */
 ...
 * @throws BUTTERFLYFISH_REDUCIBLE_SET_$T$_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_REDUCIBLE_SET_$T$_ERROR_MEMORY_ALLOCATION_FAILED if
 ...
 * @throws BUTTERFLYFISH_REDUCIBLE_SET_$T$_ERROR_OBJECT_IS_NULL if object is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_REDUCIBLE_SET_$T$_ERROR_OTHER_IS_NULL if other is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_REDUCIBLE_SET_$T$_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_REDUCIBLE_SET_$T$_ERROR_MEMORY_ALLOCATION_FAILED if
 ...
 * @throws BUTTERFLYFISH_REDUCIBLE_SET_$T$_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_REDUCIBLE_SET_$T$_ERROR_VALUE_NOT_FOUND if value is
