...
struct butterflyfish_addable_$t$ {
     ...
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_ADDABLE_$T$_ERROR_OUT_IS_NULL if out is <i>NULL</i>.
     * @throws BUTTERFLYFISH_ADDABLE_$T$_ERROR_ADDABLE_IS_EMPTY if addable is
     * empty.
     */
     ...
     * @throws BUTTERFLYFISH_ADDABLE_$T$_ERROR_OBJECT_IS_NULL if object is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_ADDABLE_$T$_ERROR_ITEM_IS_NULL if item is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_ADDABLE_$T$_ERROR_OUT_IS_NULL if out is <i>NULL</i>.
     ...
     * @throws BUTTERFLYFISH_ADDABLE_$T$_ERROR_OBJECT_IS_NULL if object is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_ADDABLE_$T$_ERROR_VALUE_IS_NULL if value is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_ADDABLE_$T$_ERROR_VALUE_ALREADY_EXISTS if value is
     * already present.
     * @throws BUTTERFLYFISH_ADDABLE_$T$_ERROR_VALUE_IS_INVALID if value is
     * invalid.
     * @throws BUTTERFLYFISH_ADDABLE_$T$_ERROR_MEMORY_ALLOCATION_FAILED if
