...
struct butterflyfish_settable_incremental_map_$t$ {
    ...
    const struct butterflyfish_settable_incremental_set_$mkt$ *const keys;
     ...
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL
     * if object is <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_OUT_IS_NULL
     * if out is <i>NULL</i>.
     */
     ...
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_OUT_IS_NULL
     * if out is <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_MAP_IS_EMPTY
     * if map is empty.
     */
     ...
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL
     * if object is <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_ITEM_IS_NULL
     * if item is <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_OUT_IS_NULL
     * if out is <i>NULL</i>.
     ...
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL
     * if object is <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_KEY_IS_NULL
     * if key is <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_OUT_IS_NULL
     * if out is <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_MEMORY_ALLOCATION_FAILED
     ...
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL
     * if object is <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_VALUE_IS_NULL
     ...
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_OUT_IS_NULL
     * if out is <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_KEY_NOT_FOUND
     ...
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_KEY_NOT_FOUND
     * if key is not in the map instance.
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_KEY_ALREADY_EXISTS
     ...
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL
     * if object is <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_ENTRY_IS_NULL
