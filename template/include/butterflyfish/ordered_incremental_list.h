...
#define BUTTERFLYFISH_ORDERED_INCREMENTAL_LIST_$T$_ERROR_OTHER_IS_NULL \
...
struct butterflyfish_ordered_incremental_list_$t$ {
    int (*const as_insertable)(
            struct butterflyfish_ordered_incremental_list_$t$ *object,
            struct butterflyfish_insertable_$t$ **out);

    int (*const as_ordered_list)(
            const struct butterflyfish_ordered_incremental_list_$t$ *object,
 ...
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_LIST_$T$_ERROR_OBJECT_IS_NULL if
 * object  is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_LIST_$T$_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 */
 ...
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_LIST_$T$_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_LIST_$T$_ERROR_LIST_IS_EMPTY if list
 * is empty.
 */
 ...
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_LIST_$T$_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_LIST_$T$_ERROR_LIST_IS_EMPTY if
 * list is empty.
 */
 ...
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_LIST_$T$_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_LIST_$T$_ERROR_ITEM_IS_NULL if
 * item is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_LIST_$T$_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_LIST_$T$_ERROR_END_OF_SEQUENCE if
 ...
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_LIST_$T$_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_LIST_$T$_ERROR_ITEM_NOT_FOUND if
 ...
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_LIST_$T$_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_LIST_$T$_ERROR_VALUE_IS_NULL if
 * value is <i>NULL</i>.
 * @throws
 * BUTTERFLYFISH_ORDERED_INCREMENTAL_LIST_$T$_ERROR_MEMORY_ALLOCATION_FAILED
 * if there is not enough memory to add the value.
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_LIST_$T$_ERROR_VALUE_IS_INVALID if
 * value is invalid.
 ...
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_LIST_$T$_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_LIST_$T$_ERROR_OTHER_IS_NULL if
 * other is <i>NULL</i>.
 * @throws
 * BUTTERFLYFISH_ORDERED_INCREMENTAL_LIST_$T$_ERROR_MEMORY_ALLOCATION_FAILED if
