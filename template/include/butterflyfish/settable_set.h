#ifndef _BUTTERFLYFISH_SETTABLE_SET_$T$_H_
#define _BUTTERFLYFISH_SETTABLE_SET_$T$_H_
...
#define BUTTERFLYFISH_SETTABLE_SET_$T$_ERROR_OBJECT_IS_NULL \
    BUTTERFLYFISH_SET_$T$_ERROR_OBJECT_IS_NULL
#define BUTTERFLYFISH_SETTABLE_SET_$T$_ERROR_OUT_IS_NULL \
    BUTTERFLYFISH_SET_$T$_ERROR_OUT_IS_NULL
#define BUTTERFLYFISH_SETTABLE_SET_$T$_ERROR_SET_IS_EMPTY \
    BUTTERFLYFISH_SET_$T$_ERROR_SET_IS_EMPTY
#define BUTTERFLYFISH_SETTABLE_SET_$T$_ERROR_ITEM_IS_NULL \
    BUTTERFLYFISH_SET_$T$_ERROR_ITEM_IS_NULL
#define BUTTERFLYFISH_SETTABLE_SET_$T$_ERROR_END_OF_SEQUENCE \
    BUTTERFLYFISH_SET_$T$_ERROR_END_OF_SEQUENCE
#define BUTTERFLYFISH_SETTABLE_SET_$T$_ERROR_OTHER_IS_NULL \
    BUTTERFLYFISH_SET_$T$_ERROR_OTHER_IS_NULL
#define BUTTERFLYFISH_SETTABLE_SET_$T$_ERROR_VALUE_IS_NULL \
    BUTTERFLYFISH_SET_$T$_ERROR_VALUE_IS_NULL
#define BUTTERFLYFISH_SETTABLE_SET_$T$_ERROR_VALUE_ALREADY_EXISTS \
    SEA_URCHIN_ERROR_VALUE_ALREADY_EXISTS
#define BUTTERFLYFISH_SETTABLE_SET_$T$_ERROR_VALUE_IS_INVALID \
    BUTTERFLYFISH_SETTABLE_$T$_ERROR_VALUE_IS_INVALID
#define BUTTERFLYFISH_SETTABLE_SET_$T$_ERROR_MEMORY_ALLOCATION_FAILED \
    BUTTERFLYFISH_SET_$T$_ERROR_MEMORY_ALLOCATION_FAILED
#define BUTTERFLYFISH_SETTABLE_SET_$T$_ERROR_VALUE_NOT_FOUND \
    BUTTERFLYFISH_SET_$T$_ERROR_VALUE_NOT_FOUND

struct butterflyfish_settable_set_$t$ {
    int (*const as_set)(const struct butterflyfish_settable_set_$t$ *object,
                        const struct butterflyfish_set_$t$ **out);

    int (*const as_settable)(struct butterflyfish_settable_set_$t$ *object,
                             struct butterflyfish_settable_$t$ **out);

    int (*const set)(struct butterflyfish_settable_set_$t$ *object,
                     const $v$item,
                     const $v$value);
};
 ...
 * @throws BUTTERFLYFISH_SETTABLE_SET_$T$_ERROR_OBJECT_IS_NULL if object is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_SET_$T$_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 */
int butterflyfish_settable_set_$t$_as_stream(
        const struct butterflyfish_settable_set_$t$ *object,
...
int butterflyfish_settable_set_$t$_as_settable(
        struct butterflyfish_settable_set_$t$ *object,
        struct butterflyfish_settable_$t$ **out);
 ...
 * @throws BUTTERFLYFISH_SETTABLE_SET_$T$_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_SET_$T$_ERROR_SET_IS_EMPTY if set is empty.
 */
 ...
 * @throws BUTTERFLYFISH_SETTABLE_SET_$T$_ERROR_OBJECT_IS_NULL if object is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_SET_$T$_ERROR_ITEM_IS_NULL if item is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_SET_$T$_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_SET_$T$_ERROR_END_OF_SEQUENCE if there is no
 * next item.
 */
 ...
 * @throws BUTTERFLYFISH_SETTABLE_SET_$T$_ERROR_OBJECT_IS_NULL if object is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_SET_$T$_ERROR_VALUE_IS_NULL if value is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_SET_$T$_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_SET_$T$_ERROR_MEMORY_ALLOCATION_FAILED if
 ...
 * @throws BUTTERFLYFISH_SETTABLE_SET_$T$_ERROR_OBJECT_IS_NULL if object is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_SET_$T$_ERROR_OTHER_IS_NULL if other is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_SET_$T$_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_SET_$T$_ERROR_MEMORY_ALLOCATION_FAILED if
 ...
 * @throws BUTTERFLYFISH_SETTABLE_SET_$T$_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_SET_$T$_ERROR_VALUE_NOT_FOUND if value is not
 * in the set.
 * @throws BUTTERFLYFISH_SETTABLE_SET_$T$_ERROR_MEMORY_ALLOCATION_FAILED if
 * there is insufficient memory to find the item.
 */
 ...
 * @throws BUTTERFLYFISH_SETTABLE_SET_$T$_ERROR_VALUE_IS_NULL if value is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_SET_$T$_ERROR_VALUE_ALREADY_EXISTS if value is
 * already present in the set.
 * @throws BUTTERFLYFISH_SETTABLE_SET_$T$_ERROR_VALUE_IS_INVALID if value is
 * invalid.
 * @throws BUTTERFLYFISH_SETTABLE_SET_$T$_ERROR_MEMORY_ALLOCATION_FAILED if there
 ...
 * @throws BUTTERFLYFISH_SETTABLE_SET_$T$_ERROR_VALUE_IS_NULL if value is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_SET_$T$_ERROR_VALUE_NOT_FOUND if item is
 * not in the set.
 * @throws BUTTERFLYFISH_SETTABLE_SET_$T$_ERROR_VALUE_ALREADY_EXISTS if value is
 * already present in the set.
 * @throws BUTTERFLYFISH_SETTABLE_SET_$T$_ERROR_VALUE_IS_INVALID if value
 * invalid.
 * @throws BUTTERFLYFISH_SETTABLE_SET_$T$_ERROR_MEMORY_ALLOCATION_FAILED if
...
#endif /* _BUTTERFLYFISH_SETTABLE_SET_$T$_H_ */
