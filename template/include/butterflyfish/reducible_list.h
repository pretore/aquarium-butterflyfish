#ifndef _BUTTERFLYFISH_REDUCIBLE_LIST_$T$_H_
#define _BUTTERFLYFISH_REDUCIBLE_LIST_$T$_H_
...
#define BUTTERFLYFISH_REDUCIBLE_LIST_$T$_ERROR_OBJECT_IS_NULL \
    BUTTERFLYFISH_LIST_$T$_ERROR_OBJECT_IS_NULL
#define BUTTERFLYFISH_REDUCIBLE_LIST_$T$_ERROR_OUT_IS_NULL \
    BUTTERFLYFISH_LIST_$T$_ERROR_OUT_IS_NULL
#define BUTTERFLYFISH_REDUCIBLE_LIST_$T$_ERROR_LIST_IS_EMPTY \
    BUTTERFLYFISH_LIST_$T$_ERROR_LIST_IS_EMPTY
#define BUTTERFLYFISH_REDUCIBLE_LIST_$T$_ERROR_ITEM_IS_NULL \
    BUTTERFLYFISH_LIST_$T$_ERROR_ITEM_IS_NULL
#define BUTTERFLYFISH_REDUCIBLE_LIST_$T$_ERROR_END_OF_SEQUENCE \
    BUTTERFLYFISH_LIST_$T$_ERROR_END_OF_SEQUENCE
#define BUTTERFLYFISH_REDUCIBLE_LIST_$T$_ERROR_INDEX_IS_OUT_OF_BOUNDS \
    BUTTERFLYFISH_LIST_$T$_ERROR_INDEX_IS_OUT_OF_BOUNDS
#define BUTTERFLYFISH_REDUCIBLE_LIST_$T$_ERROR_ITEM_NOT_FOUND \
    BUTTERFLYFISH_LIST_$T$_ERROR_ITEM_NOT_FOUND
#define BUTTERFLYFISH_REDUCIBLE_LIST_$T$_ERROR_OTHER_IS_NULL \
    SEA_URCHIN_ERROR_OTHER_IS_NULL
#define BUTTERFLYFISH_REDUCIBLE_LIST_$T$_ERROR_MEMORY_ALLOCATION_FAILED \
    SEA_URCHIN_ERROR_MEMORY_ALLOCATION_FAILED

struct butterflyfish_reducible_list_$t$ {
    int (*const as_removable)(
            struct butterflyfish_reducible_list_$t$ *object,
            struct butterflyfish_removable_$t$ **out);

    int (*const as_list)(
            const struct butterflyfish_reducible_list_$t$ *object,
 ...
 * @throws BUTTERFLYFISH_REDUCIBLE_LIST_$T$_ERROR_OBJECT_IS_NULL if object is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_REDUCIBLE_LIST_$T$_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 */
 ...
 * @throws BUTTERFLYFISH_REDUCIBLE_LIST_$T$_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_REDUCIBLE_LIST_$T$_ERROR_LIST_IS_EMPTY if list is empty.
 */
 ...
 * @throws BUTTERFLYFISH_REDUCIBLE_LIST_$T$_ERROR_OBJECT_IS_NULL if object is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_REDUCIBLE_LIST_$T$_ERROR_ITEM_IS_NULL if item is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_REDUCIBLE_LIST_$T$_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_REDUCIBLE_LIST_$T$_ERROR_END_OF_SEQUENCE if there is no
 * next item.
 */
 ...
 * @throws BUTTERFLYFISH_REDUCIBLE_LIST_$T$_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_REDUCIBLE_LIST_$T$_ERROR_INDEX_IS_OUT_OF_BOUNDS if
 ...
 * @throws BUTTERFLYFISH_REDUCIBLE_LIST_$T$_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_REDUCIBLE_LIST_$T$_ERROR_ITEM_NOT_FOUND if item is
 ...
 * @throws BUTTERFLYFISH_REDUCIBLE_LIST_$T$_ERROR_OBJECT_IS_NULL if object is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_REDUCIBLE_LIST_$T$_ERROR_OTHER_IS_NULL if other is
 * <i>NULL</i>.
 ...
 * @throws BUTTERFLYFISH_REDUCIBLE_LIST_$T$_ERROR_OBJECT_IS_NULL if object is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_REDUCIBLE_LIST_$T$_ERROR_INDEX_IS_OUT_OF_BOUNDS if at
 ...
 * @throws BUTTERFLYFISH_REDUCIBLE_LIST_$T$_ERROR_OTHER_IS_NULL if other is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_REDUCIBLE_LIST_$T$_ERROR_MEMORY_ALLOCATION_FAILED if
...
#endif /* _BUTTERFLYFISH_REDUCIBLE_LIST_$T$_H_ */
