...
struct butterflyfish_settable_list_$t$ {
    int (*const as_settable)(struct butterflyfish_settable_list_$t$ *object,
                             struct butterflyfish_settable_$t$ **out);

    int (*const as_list)(const struct butterflyfish_settable_list_$t$ *object,
                         const struct butterflyfish_list_$t$ **out);

    int (*const set)(struct butterflyfish_settable_list_$t$ *object,
                     uintmax_t at,
                     const $v$value);
};
 ...
 * @throws BUTTERFLYFISH_SETTABLE_LIST_$T$_ERROR_OBJECT_IS_NULL if object is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_LIST_$T$_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 */
int butterflyfish_settable_list_$t$_as_stream(
        const struct butterflyfish_settable_list_$t$ *object,
 ...
 * <i>NULL</i>.
 */
int butterflyfish_settable_list_$t$_as_collection(
        const struct butterflyfish_settable_list_$t$ *object,
 ...
 * <i>NULL</i>.
 */
int butterflyfish_settable_list_$t$_as_settable(
        struct butterflyfish_settable_list_$t$ *object,
        struct butterflyfish_settable_$t$ **out);
 ...
 * <i>NULL</i>.
 */
int butterflyfish_settable_list_$t$_as_list(
        const struct butterflyfish_settable_list_$t$ *object,
        const struct butterflyfish_list_$t$ **out);
 ...
 * <i>NULL</i>.
 */
int butterflyfish_settable_list_$t$_count(
        const struct butterflyfish_settable_list_$t$ *object,
        uintmax_t *out);
 ...
 * @throws BUTTERFLYFISH_SETTABLE_LIST_$T$_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_LIST_$T$_ERROR_LIST_IS_EMPTY if list is empty.
 */
int butterflyfish_settable_list_$t$_first(
        const struct butterflyfish_settable_list_$t$ *object,
        const $v$*out);
 ...
 * @throws BUTTERFLYFISH_SETTABLE_LIST_$T$_ERROR_LIST_IS_EMPTY if list is empty.
 */
int butterflyfish_settable_list_$t$_last(
        const struct butterflyfish_settable_list_$t$ *object,
        const $v$*out);
 ...
 * @throws BUTTERFLYFISH_SETTABLE_LIST_$T$_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_LIST_$T$_ERROR_END_OF_SEQUENCE if there is no
 * next item.
 */
int butterflyfish_settable_list_$t$_next(
        const struct butterflyfish_settable_list_$t$ *object,
        const $v$item,
        const $v$*out);
 ...
 * previous item.
 */
int butterflyfish_settable_list_$t$_prev(
        const struct butterflyfish_settable_list_$t$ *object,
        const $v$item,
        const $v$*out);
 ...
 * @throws BUTTERFLYFISH_SETTABLE_LIST_$T$_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_LIST_$T$_ERROR_INDEX_IS_OUT_OF_BOUNDS if at
 * does not refer to an item contained within the list.
 */
int butterflyfish_settable_list_$t$_get(
        const struct butterflyfish_settable_list_$t$ *object,
        uintmax_t at,
        const $v$*out);
 ...
 * @throws BUTTERFLYFISH_SETTABLE_LIST_$T$_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_LIST_$T$_ERROR_ITEM_NOT_FOUND if item is not
 * contained within the list.
 */
int butterflyfish_settable_list_$t$_at(
        const struct butterflyfish_settable_list_$t$ *object,
        const $v$item,
        uintmax_t *out);
 ...
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_LIST_$T$_ERROR_VALUE_IS_INVALID if value is
 * invalid.
 * @throws BUTTERFLYFISH_SETTABLE_LIST_$T$_ERROR_MEMORY_ALLOCATION_FAILED if there
 * is not enough memory to set the item to value.
 * @note <b>value</b> is copied and then item is set to it.
 */
int butterflyfish_settable_list_$t$_set_item(
        struct butterflyfish_settable_list_$t$ *object,
        const $v$item,
        const $v$value);
 ...
 * @throws BUTTERFLYFISH_SETTABLE_LIST_$T$_ERROR_INDEX_IS_OUT_OF_BOUNDS if at
 * does not refer to an item contained within the list.
 * @throws BUTTERFLYFISH_SETTABLE_LIST_$T$_ERROR_MEMORY_ALLOCATION_FAILED if
 * there is not enough memory to set the item to value.
 * @throws BUTTERFLYFISH_SETTABLE_LIST_$T$_ERROR_VALUE_IS_INVALID if value is
 * invalid.
 * @note <b>value</b> is copied and then item at index is set to it.
 */
int butterflyfish_settable_list_$t$_set(
        struct butterflyfish_settable_list_$t$ *object,
        uintmax_t at,
        const $v$value);
