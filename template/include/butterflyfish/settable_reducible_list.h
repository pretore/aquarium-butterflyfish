...
#define BUTTERFLYFISH_SETTABLE_REDUCIBLE_LIST_$T$_ERROR_OTHER_IS_NULL \
...
struct butterflyfish_settable_reducible_list_$t$ {
    int (*const as_settable_list)(
            struct butterflyfish_settable_reducible_list_$t$ *object,
 ...
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_LIST_$T$_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 */
int butterflyfish_settable_reducible_list_$t$_as_stream(
        const struct butterflyfish_settable_reducible_list_$t$ *object,
 ...
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_LIST_$T$_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_LIST_$T$_ERROR_ITEM_IS_NULL if item
 * is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_LIST_$T$_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_LIST_$T$_ERROR_END_OF_SEQUENCE if
 ...
 * <i>NULL</i>.
 * @throws
 * BUTTERFLYFISH_SETTABLE_REDUCIBLE_LIST_$T$_ERROR_INDEX_IS_OUT_OF_BOUNDS if at
 ...
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_LIST_$T$_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_LIST_$T$_ERROR_ITEM_NOT_FOUND if
 ...
 * value is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_LIST_$T$_ERROR_VALUE_IS_INVALID if
 * value is invalid.
 * @throws
 * BUTTERFLYFISH_SETTABLE_REDUCIBLE_LIST_$T$_ERROR_MEMORY_ALLOCATION_FAILED if
 ...
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_LIST_$T$_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_LIST_$T$_ERROR_OTHER_IS_NULL if
 * other is <i>NULL</i>.
