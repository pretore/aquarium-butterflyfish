#ifndef _BUTTERFLYFISH_ORDERED_SETTABLE_LIST_$T$_H_
#define _BUTTERFLYFISH_ORDERED_SETTABLE_LIST_$T$_H_
...
#define BUTTERFLYFISH_ORDERED_SETTABLE_LIST_$T$_ERROR_OBJECT_IS_NULL \
    BUTTERFLYFISH_SETTABLE_LIST_$T$_ERROR_OBJECT_IS_NULL
#define BUTTERFLYFISH_ORDERED_SETTABLE_LIST_$T$_ERROR_OUT_IS_NULL \
    BUTTERFLYFISH_SETTABLE_LIST_$T$_ERROR_OUT_IS_NULL
#define BUTTERFLYFISH_ORDERED_SETTABLE_LIST_$T$_ERROR_LIST_IS_EMPTY \
    BUTTERFLYFISH_SETTABLE_LIST_$T$_ERROR_LIST_IS_EMPTY
#define BUTTERFLYFISH_ORDERED_SETTABLE_LIST_$T$_ERROR_ITEM_IS_NULL \
    BUTTERFLYFISH_SETTABLE_LIST_$T$_ERROR_ITEM_IS_NULL
#define BUTTERFLYFISH_ORDERED_SETTABLE_LIST_$T$_ERROR_END_OF_SEQUENCE \
    BUTTERFLYFISH_SETTABLE_LIST_$T$_ERROR_END_OF_SEQUENCE
#define BUTTERFLYFISH_ORDERED_SETTABLE_LIST_$T$_ERROR_INDEX_IS_OUT_OF_BOUNDS \
    BUTTERFLYFISH_SETTABLE_LIST_$T$_ERROR_INDEX_IS_OUT_OF_BOUNDS
#define BUTTERFLYFISH_ORDERED_SETTABLE_LIST_$T$_ERROR_ITEM_NOT_FOUND \
    BUTTERFLYFISH_SETTABLE_LIST_$T$_ERROR_ITEM_NOT_FOUND
#define BUTTERFLYFISH_ORDERED_SETTABLE_LIST_$T$_ERROR_VALUE_IS_NULL \
    BUTTERFLYFISH_SETTABLE_LIST_$T$_ERROR_VALUE_IS_NULL
#define BUTTERFLYFISH_ORDERED_SETTABLE_LIST_$T$_ERROR_MEMORY_ALLOCATION_FAILED \
    BUTTERFLYFISH_SETTABLE_LIST_$T$_ERROR_MEMORY_ALLOCATION_FAILED
#define BUTTERFLYFISH_ORDERED_SETTABLE_LIST_$T$_ERROR_VALUE_IS_INVALID \
    BUTTERFLYFISH_SETTABLE_LIST_$T$_ERROR_VALUE_IS_INVALID

struct butterflyfish_ordered_settable_list_$t$ {
    int (*const as_settable_list)(
            struct butterflyfish_ordered_settable_list_$t$ *object,
            struct butterflyfish_settable_list_$t$ **out);

    int (*const as_ordered_list)(
            const struct butterflyfish_ordered_settable_list_$t$ *object,
 ...
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_LIST_$T$_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_LIST_$T$_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 */
 ...
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_LIST_$T$_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_LIST_$T$_ERROR_LIST_IS_EMPTY if list
 * is empty.
 */
 ...
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_LIST_$T$_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_LIST_$T$_ERROR_ITEM_IS_NULL if item is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_LIST_$T$_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_LIST_$T$_ERROR_END_OF_SEQUENCE if there
 * is no next item.
 */
 ...
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_LIST_$T$_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_LIST_$T$_ERROR_INDEX_IS_OUT_OF_BOUNDS
 ...
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_LIST_$T$_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_LIST_$T$_ERROR_ITEM_NOT_FOUND if item
 ...
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_LIST_$T$_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_LIST_$T$_ERROR_VALUE_IS_NULL if value
 * is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_LIST_$T$_ERROR_INDEX_IS_OUT_OF_BOUNDS
 * if at does not refer to an item contained within the settable list.
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_LIST_$T$_ERROR_MEMORY_ALLOCATION_FAILED
 * if there is not enough memory to set the item to value.
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_LIST_$T$_ERROR_VALUE_IS_INVALID if
 * value is invalid.
 ...
 * is <i>NULL</i>.
 * @throws
 * BUTTERFLYFISH_ORDERED_SETTABLE_LIST_$T$_ERROR_MEMORY_ALLOCATION_FAILED if
...
#endif /* _BUTTERFLYFISH_ORDERED_SETTABLE_LIST_$T$_H_ */
