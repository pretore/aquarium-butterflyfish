...
#define BUTTERFLYFISH_INCREMENTAL_SET_$T$_ERROR_OTHER_IS_NULL \
...
struct butterflyfish_incremental_set_$t$ {
    int (*const as_addable)(
            struct butterflyfish_incremental_set_$t$ *object,
            struct butterflyfish_addable_$t$ **out);

    int (*const as_set)(const struct butterflyfish_incremental_set_$t$ *object,
 ...
 * @throws BUTTERFLYFISH_INCREMENTAL_SET_$T$_ERROR_OBJECT_IS_NULL if object is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_INCREMENTAL_SET_$T$_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 */
int butterflyfish_incremental_set_$t$_as_stream(
        const struct butterflyfish_incremental_set_$t$ *object,
 ...
 * <i>NULL</i>.
 */
int butterflyfish_incremental_set_$t$_as_collection(
        const struct butterflyfish_incremental_set_$t$ *object,
 ...
 * <i>NULL</i>.
 */
int butterflyfish_incremental_set_$t$_as_addable(
        struct butterflyfish_incremental_set_$t$ *object,
        struct butterflyfish_addable_$t$ **out);
 ...
 * <i>NULL</i>.
 */
int butterflyfish_incremental_set_$t$_as_set(
        const struct butterflyfish_incremental_set_$t$ *object,
        const struct butterflyfish_set_$t$ **out);
 ...
 * <i>NULL</i>.
 */
int butterflyfish_incremental_set_$t$_count(
        const struct butterflyfish_incremental_set_$t$ *object,
        uintmax_t *out);
 ...
 * @throws BUTTERFLYFISH_INCREMENTAL_SET_$T$_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_INCREMENTAL_SET_$T$_ERROR_SET_IS_EMPTY if set is empty.
 */
int butterflyfish_incremental_set_$t$_first(
        const struct butterflyfish_incremental_set_$t$ *object,
        const $v$*out);
 ...
 * @throws BUTTERFLYFISH_INCREMENTAL_SET_$T$_ERROR_SET_IS_EMPTY if set is empty.
 */
int butterflyfish_incremental_set_$t$_last(
        const struct butterflyfish_incremental_set_$t$ *object,
        const $v$*out);
 ...
 * @throws BUTTERFLYFISH_INCREMENTAL_SET_$T$_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_INCREMENTAL_SET_$T$_ERROR_END_OF_SEQUENCE if there is
 * no next item.
 */
int butterflyfish_incremental_set_$t$_next(
        const struct butterflyfish_incremental_set_$t$ *object,
        const $v$item,
        const $v$*out);
 ...
 * @throws BUTTERFLYFISH_INCREMENTAL_SET_$T$_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_INCREMENTAL_SET_$T$_ERROR_END_OF_SEQUENCE if there is no
 * previous item.
 */
int butterflyfish_incremental_set_$t$_prev(
        const struct butterflyfish_incremental_set_$t$ *object,
        const $v$item,
        const $v$*out);
 ...
 * @throws BUTTERFLYFISH_INCREMENTAL_SET_$T$_ERROR_OBJECT_IS_NULL if object is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_INCREMENTAL_SET_$T$_ERROR_VALUE_IS_NULL if value is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_INCREMENTAL_SET_$T$_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_INCREMENTAL_SET_$T$_ERROR_MEMORY_ALLOCATION_FAILED if
 * there is insufficient memory to find the item.
 */
int butterflyfish_incremental_set_$t$_contains(
        const struct butterflyfish_incremental_set_$t$ *object,
        const $v$value,
        bool *out);
 ...
 * @throws BUTTERFLYFISH_INCREMENTAL_SET_$T$_ERROR_OBJECT_IS_NULL if object is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_INCREMENTAL_SET_$T$_ERROR_OTHER_IS_NULL if other is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_INCREMENTAL_SET_$T$_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_INCREMENTAL_SET_$T$_ERROR_MEMORY_ALLOCATION_FAILED if
 * there is insufficient memory to find the item.
 */
int butterflyfish_incremental_set_$t$_contains_all(
        const struct butterflyfish_incremental_set_$t$ *object,
 ...
 * @throws BUTTERFLYFISH_INCREMENTAL_SET_$T$_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_INCREMENTAL_SET_$T$_ERROR_VALUE_NOT_FOUND if value is
 * not in the set instance.
 * @throws BUTTERFLYFISH_INCREMENTAL_SET_$T$_ERROR_MEMORY_ALLOCATION_FAILED if
 * there is insufficient memory to find the item.
 */
int butterflyfish_incremental_set_$t$_get(
        const struct butterflyfish_incremental_set_$t$ *object,
        const $v$value,
        const $v$*out);
 ...
 * @throws BUTTERFLYFISH_INCREMENTAL_SET_$T$_ERROR_VALUE_IS_INVALID if value
 * is invalid.
 * @throws BUTTERFLYFISH_INCREMENTAL_SET_$T$_ERROR_MEMORY_ALLOCATION_FAILED if
 * there is insufficient memory to add value to the set.
 * @note <b>value</b> is copied and then placed into the set.
 */
int butterflyfish_incremental_set_$t$_add(
        struct butterflyfish_incremental_set_$t$ *object,
        const $v$value);
 ...
 */
int butterflyfish_incremental_set_$t$_add_all(
        struct butterflyfish_incremental_set_$t$ *object,
        const struct butterflyfish_stream_$t$ *other);
