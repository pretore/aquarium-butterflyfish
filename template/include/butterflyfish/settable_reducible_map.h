#ifndef _BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_H_
#define _BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_H_
...
struct butterflyfish_settable_reducible_set_$mkt$;
struct butterflyfish_ordered_settable_reducible_list_$mvt$;

#define BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_OBJECT_IS_NULL \
    BUTTERFLYFISH_SETTABLE_MAP_$T$_ERROR_OBJECT_IS_NULL
#define BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_OUT_IS_NULL \
    BUTTERFLYFISH_SETTABLE_MAP_$T$_ERROR_OUT_IS_NULL
#define BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_MAP_IS_EMPTY \
    BUTTERFLYFISH_SETTABLE_MAP_$T$_ERROR_MAP_IS_EMPTY
#define BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_ITEM_IS_NULL \
    BUTTERFLYFISH_SETTABLE_MAP_$T$_ERROR_ITEM_IS_NULL
#define BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_END_OF_SEQUENCE \
    BUTTERFLYFISH_SETTABLE_MAP_$T$_ERROR_END_OF_SEQUENCE
#define BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_OTHER_IS_NULL \
    BUTTERFLYFISH_SETTABLE_MAP_$T$_ERROR_OTHER_IS_NULL
#define BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_VALUE_IS_NULL \
    BUTTERFLYFISH_SETTABLE_MAP_$T$_ERROR_VALUE_IS_NULL
#define BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_ENTRY_IS_NULL \
    BUTTERFLYFISH_SETTABLE_MAP_$T$_ERROR_ENTRY_IS_NULL
#define BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_KEY_IS_NULL \
    BUTTERFLYFISH_SETTABLE_MAP_$T$_ERROR_KEY_IS_NULL
#define BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_MEMORY_ALLOCATION_FAILED \
    BUTTERFLYFISH_SETTABLE_MAP_$T$_ERROR_MEMORY_ALLOCATION_FAILED
#define BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_VALUE_NOT_FOUND \
    BUTTERFLYFISH_SETTABLE_MAP_$T$_ERROR_VALUE_NOT_FOUND
#define BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_ENTRY_NOT_FOUND \
    BUTTERFLYFISH_SETTABLE_MAP_$T$_ERROR_ENTRY_NOT_FOUND
#define BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_KEY_NOT_FOUND \
    BUTTERFLYFISH_SETTABLE_MAP_$T$_ERROR_KEY_NOT_FOUND
#define BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_VALUE_IS_INVALID \
    BUTTERFLYFISH_SETTABLE_MAP_$T$_ERROR_VALUE_IS_INVALID
#define BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_KEY_ALREADY_EXISTS \
    BUTTERFLYFISH_SETTABLE_MAP_$T$_ERROR_KEY_ALREADY_EXISTS

struct butterflyfish_settable_reducible_map_$t$ {
    int (*const as_settable_map)(
            struct butterflyfish_settable_reducible_map_$t$ *object,
 ...
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_OUT_IS_NULL if out
 * is <i>NULL</i>.
 */
int butterflyfish_settable_reducible_map_$t$_as_stream(
        const struct butterflyfish_settable_reducible_map_$t$ *object,
 ...
 * is <i>NULL</i>.
 */
int butterflyfish_settable_reducible_map_$t$_as_collection(
        const struct butterflyfish_settable_reducible_map_$t$ *object,
 ...
 * is <i>NULL</i>.
 */
int butterflyfish_settable_reducible_map_$t$_as_set(
        const struct butterflyfish_settable_reducible_map_$t$ *object,
 ...
 * is <i>NULL</i>.
 */
int butterflyfish_settable_reducible_map_$t$_as_removable(
        struct butterflyfish_settable_reducible_map_$t$ *object,
 ...
 * is <i>NULL</i>.
 */
int butterflyfish_settable_reducible_map_$t$_as_settable(
        struct butterflyfish_settable_reducible_map_$t$ *object,
 ...
 * is <i>NULL</i>.
 */
int butterflyfish_settable_reducible_map_$t$_as_map(
        const struct butterflyfish_settable_reducible_map_$t$ *object,
 ...
 * is <i>NULL</i>.
 */
int butterflyfish_settable_reducible_map_$t$_as_settable_map(
        struct butterflyfish_settable_reducible_map_$t$ *object,
        struct butterflyfish_settable_map_$t$ **out);
 ...
 * is <i>NULL</i>.
 */
int butterflyfish_settable_reducible_map_$t$_as_reducible_map(
        struct butterflyfish_settable_reducible_map_$t$ *object,
        struct butterflyfish_reducible_map_$t$ **out);
 ...
 * is <i>NULL</i>.
 */
int butterflyfish_settable_reducible_map_$t$_count(
        const struct butterflyfish_settable_reducible_map_$t$ *object,
        uintmax_t *out);
 ...
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_OUT_IS_NULL if out
 * is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_MAP_IS_EMPTY if map
 * is empty.
 */
int butterflyfish_settable_reducible_map_$t$_first(
        const struct butterflyfish_settable_reducible_map_$t$ *object,
        const $v$*out);
 ...
 * is empty.
 */
int butterflyfish_settable_reducible_map_$t$_last(
        const struct butterflyfish_settable_reducible_map_$t$ *object,
        const $v$*out);
 ...
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_ITEM_IS_NULL if
 * item is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_OUT_IS_NULL if out
 * is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_END_OF_SEQUENCE if
 * there is no next item.
 */
int butterflyfish_settable_reducible_map_$t$_next(
        const struct butterflyfish_settable_reducible_map_$t$ *object,
        const $v$item,
        const $v$*out);
 ...
 */
int butterflyfish_settable_reducible_map_$t$_prev(
        const struct butterflyfish_settable_reducible_map_$t$ *object,
        const $v$item,
        const $v$*out);
 ...
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_ENTRY_IS_NULL if
 * entry is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_OUT_IS_NULL if out
 * is <i>NULL</i>.
 * @throws
 * BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_MEMORY_ALLOCATION_FAILED if
 * there is insufficient memory to find the entry.
 */
int butterflyfish_settable_reducible_map_$t$_contains(
        const struct butterflyfish_settable_reducible_map_$t$ *object,
        const $v$entry,
        bool *out);
 ...
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_KEY_IS_NULL if key
 * is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_OUT_IS_NULL if out
 * is <i>NULL</i>.
 * @throws
 ...
 * there is insufficient memory to find the entry.
 */
int butterflyfish_settable_reducible_map_$t$_contains_key(
        const struct butterflyfish_settable_reducible_map_$t$ *object,
        const $mkv$key,
        bool *out);
 ...
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_VALUE_IS_NULL if
 * value is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_OUT_IS_NULL if out
 * is <i>NULL</i>.
 * @throws
 ...
 * there is insufficient memory to find the entry.
 */
int butterflyfish_settable_reducible_map_$t$_contains_value(
        const struct butterflyfish_settable_reducible_map_$t$ *object,
        const $mvv$value,
        bool *out);
 ...
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_OTHER_IS_NULL if
 * other is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_OUT_IS_NULL if out
 * is <i>NULL</i>.
 * @throws
 ...
 * there is insufficient memory to find the entry.
 */
int butterflyfish_settable_reducible_map_$t$_contains_all(
        const struct butterflyfish_settable_reducible_map_$t$ *object,
 ...
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_OTHER_IS_NULL if
 * other is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws
 * BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_MEMORY_ALLOCATION_FAILED if
 * there is insufficient memory to find the entry.
 */
int butterflyfish_settable_reducible_map_$t$_contains_all_keys(
        const struct butterflyfish_settable_reducible_map_$t$ *object,
 ...
 * there is insufficient memory to find the entry.
 */
int butterflyfish_settable_reducible_map_$t$_contains_all_values(
        const struct butterflyfish_settable_reducible_map_$t$ *object,
 ...
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_OUT_IS_NULL if out
 * is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_ENTRY_NOT_FOUND if
 * entry is not in the map instance.
 * @throws
 * BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_MEMORY_ALLOCATION_FAILED if
 * there is insufficient memory to find the entry.
 */
int butterflyfish_settable_reducible_map_$t$_get(
        const struct butterflyfish_settable_reducible_map_$t$ *object,
        const $v$entry,
        const $v$*out);
 ...
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_OUT_IS_NULL if out
 * is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_KEY_NOT_FOUND if
 * key is not in the map instance.
 * @throws
 * BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_MEMORY_ALLOCATION_FAILED if
 * there is insufficient memory to find the value.
 */
int butterflyfish_settable_reducible_map_$t$_get_value(
        const struct butterflyfish_settable_reducible_map_$t$ *object,
        const $mkv$key,
        const $mvv$*out);
 ...
 * there is insufficient memory to find the value.
 */
int butterflyfish_settable_reducible_map_$t$_get_entry(
        const struct butterflyfish_settable_reducible_map_$t$ *object,
        const $mkv$key,
        const $v$*out);
 ...
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_KEY_NOT_FOUND if
 * key is not in the map instance.
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_VALUE_IS_INVALID if
 * value is invalid.
 * @throws
 * BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_MEMORY_ALLOCATION_FAILED if
 ...
 */
int butterflyfish_settable_reducible_map_$t$_set_value(
        struct butterflyfish_settable_reducible_map_$t$ *object,
        const $mkv$key,
        const $mvv$value);
 ...
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_KEY_IS_NULL if key is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_VALUE_IS_NULL if
 * value is <i>NULL</i>.
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_KEY_NOT_FOUND if
 * key is not in the map instance.
 * @throws BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_KEY_ALREADY_EXISTS
 ...
 */
int butterflyfish_settable_reducible_map_$t$_set_key(
        struct butterflyfish_settable_reducible_map_$t$ *object,
        const $mkv$key,
        const $mkv$value);
 ...
 */
int butterflyfish_settable_reducible_map_$t$_set_entry(
        struct butterflyfish_settable_reducible_map_$t$ *object,
        const $v$entry,
        const $v$value);
 ...
 * there is insufficient memory to find the entry.
 */
int butterflyfish_settable_reducible_map_$t$_remove(
        struct butterflyfish_settable_reducible_map_$t$ *object,
        const $mkv$key);
 ...
 */
int butterflyfish_settable_reducible_map_$t$_remove_all(
        struct butterflyfish_settable_reducible_map_$t$ *object,
        const struct butterflyfish_stream_$mkt$ *other);
 ...
 * there is insufficient memory to find the entry.
 */
int butterflyfish_settable_reducible_map_$t$_retain_all(
        struct butterflyfish_settable_reducible_map_$t$ *object,
        const struct butterflyfish_stream_$mkt$ *other);
 ...
 */
int butterflyfish_settable_reducible_map_$t$_remove_entry(
        struct butterflyfish_settable_reducible_map_$t$ *object,
        const $v$entry);
 ...
 */
int butterflyfish_settable_reducible_map_$t$_remove_all_entries(
        struct butterflyfish_settable_reducible_map_$t$ *object,
        const struct butterflyfish_stream_$t$ *other);
 ...
 * <i>NULL</i>.
 */
int butterflyfish_settable_reducible_map_$t$_keys(
        struct butterflyfish_settable_reducible_map_$t$ *object,
        struct butterflyfish_settable_reducible_set_$mkt$ **out);
 ...
 * <i>NULL</i>.
 */
int butterflyfish_settable_reducible_map_$t$_values(
        struct butterflyfish_settable_reducible_map_$t$ *object,
        struct butterflyfish_ordered_settable_reducible_list_$mvt$ **out);

#endif /* _BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_H_ */
