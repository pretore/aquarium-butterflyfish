...
#define BUTTERFLYFISH_ORDERED_SETTABLE_SET_$T$_ERROR_OTHER_IS_NULL \
...
struct butterflyfish_ordered_settable_set_$t$ {
    int (*const as_ordered_set)(
            const struct butterflyfish_ordered_settable_set_$t$ *object,
            const struct butterflyfish_ordered_set_$t$ **out);

    int (*const as_settable_set)(
            struct butterflyfish_ordered_settable_set_$t$ *object,
 ...
 * <i>NULL</i>.
 */
int butterflyfish_ordered_settable_set_$t$_as_stream(
        const struct butterflyfish_ordered_settable_set_$t$ *object,
 ...
 * <i>NULL</i>.
 */
int butterflyfish_ordered_settable_set_$t$_as_collection(
        const struct butterflyfish_ordered_settable_set_$t$ *object,
 ...
 * <i>NULL</i>.
 */
int butterflyfish_ordered_settable_set_$t$_as_settable(
        struct butterflyfish_ordered_settable_set_$t$ *object,
 ...
 * <i>NULL</i>.
 */
int butterflyfish_ordered_settable_set_$t$_as_ordered(
        const struct butterflyfish_ordered_settable_set_$t$ *object,
 ...
 * <i>NULL</i>.
 */
int butterflyfish_ordered_settable_set_$t$_as_set(
        const struct butterflyfish_ordered_settable_set_$t$ *object,
 ...
 * <i>NULL</i>.
 */
int butterflyfish_ordered_settable_set_$t$_as_settable_set(
        struct butterflyfish_ordered_settable_set_$t$ *object,
        struct butterflyfish_settable_set_$t$ **out);
 ...
 * <i>NULL</i>.
 */
int butterflyfish_ordered_settable_set_$t$_as_ordered_set(
        const struct butterflyfish_ordered_settable_set_$t$ *object,
        const struct butterflyfish_ordered_set_$t$ **out);
 ...
 * <i>NULL</i>.
 */
int butterflyfish_ordered_settable_set_$t$_count(
        const struct butterflyfish_ordered_settable_set_$t$ *object,
        uintmax_t *out);
 ...
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_SET_$T$_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_SET_$T$_ERROR_SET_IS_EMPTY if set is
 * empty.
 */
int butterflyfish_ordered_settable_set_$t$_first(
        const struct butterflyfish_ordered_settable_set_$t$ *object,
        const $v$*out);
 ...
 * empty.
 */
int butterflyfish_ordered_settable_set_$t$_last(
        const struct butterflyfish_ordered_settable_set_$t$ *object,
        const $v$*out);
 ...
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_SET_$T$_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_SET_$T$_ERROR_ITEM_IS_NULL if item is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_SET_$T$_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_SET_$T$_ERROR_END_OF_SEQUENCE if there
 * is no next item.
 */
int butterflyfish_ordered_settable_set_$t$_next(
        const struct butterflyfish_ordered_settable_set_$t$ *object,
        const $v$item,
        const $v$*out);
 ...
 * is no previous item.
 */
int butterflyfish_ordered_settable_set_$t$_prev(
        const struct butterflyfish_ordered_settable_set_$t$ *object,
        const $v$item,
        const $v$*out);
 ...
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_SET_$T$_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_SET_$T$_ERROR_VALUE_IS_NULL if value is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_SET_$T$_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 ...
 */
int butterflyfish_ordered_settable_set_$t$_contains(
        const struct butterflyfish_ordered_settable_set_$t$ *object,
        const $v$value,
        bool *out);
 ...
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_SET_$T$_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_SET_$T$_ERROR_OTHER_IS_NULL if other is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_SET_$T$_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_SET_$T$_ERROR_MEMORY_ALLOCATION_FAILED
 * if there is insufficient memory to find the item.
 */
int butterflyfish_ordered_settable_set_$t$_contains_all(
        const struct butterflyfish_ordered_settable_set_$t$ *object,
 ...
 * if there is insufficient memory to find the item.
 */
int butterflyfish_ordered_settable_set_$t$_get(
        const struct butterflyfish_ordered_settable_set_$t$ *object,
        const $v$value,
        const $v$*out);
 ...
 */
int butterflyfish_ordered_settable_set_$t$_set_item(
        struct butterflyfish_ordered_settable_set_$t$ *object,
        const $v$item,
        const $v$value);
 ...
 * @param [in] value to which item is to be set to.
 * @return On success <i>0</i>, otherwise an error code.
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_SET_$T$_ERROR_OBJECT_IS_NULL if object
 * is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_SET_$T$_ERROR_ITEM_IS_NULL if item is
 * <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_SET_$T$_ERROR_VALUE_IS_NULL if value
 * is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_SET_$T$_ERROR_VALUE_NOT_FOUND if item
 * is not in the set.
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_SET_$T$_ERROR_VALUE_ALREADY_EXISTS if
 * value is already present in the set.
  * @throws BUTTERFLYFISH_ORDERED_SETTABLE_SET_$T$_ERROR_VALUE_IS_INVALID if
 ...
 */
int butterflyfish_ordered_settable_set_$t$_set(
        struct butterflyfish_ordered_settable_set_$t$ *object,
        const $v$item,
        const $v$value);
