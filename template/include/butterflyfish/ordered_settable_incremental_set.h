#ifndef _BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_SET_$T$_H_
#define _BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_SET_$T$_H_
...
#include "ordered_incremental_set_$t$.h"
#include "settable_incremental_set_$t$.h"

$d$

#define BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_SET_$T$_ERROR_OBJECT_IS_NULL \
    BUTTERFLYFISH_ORDERED_SETTABLE_SET_$T$_ERROR_OBJECT_IS_NULL
#define BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_SET_$T$_ERROR_OUT_IS_NULL \
    BUTTERFLYFISH_ORDERED_SETTABLE_SET_$T$_ERROR_OUT_IS_NULL
#define BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_SET_$T$_ERROR_SET_IS_EMPTY \
    BUTTERFLYFISH_ORDERED_SETTABLE_SET_$T$_ERROR_SET_IS_EMPTY
#define BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_SET_$T$_ERROR_ITEM_IS_NULL \
    BUTTERFLYFISH_ORDERED_SETTABLE_SET_$T$_ERROR_ITEM_IS_NULL
#define BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_SET_$T$_ERROR_END_OF_SEQUENCE \
    BUTTERFLYFISH_ORDERED_SETTABLE_SET_$T$_ERROR_END_OF_SEQUENCE
#define BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_SET_$T$_ERROR_OTHER_IS_NULL \
    BUTTERFLYFISH_ORDERED_SETTABLE_SET_$T$_ERROR_OTHER_IS_NULL
#define BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_SET_$T$_ERROR_VALUE_IS_NULL \
    BUTTERFLYFISH_ORDERED_SETTABLE_SET_$T$_ERROR_VALUE_IS_NULL
#define BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_SET_$T$_ERROR_VALUE_ALREADY_EXISTS \
    BUTTERFLYFISH_ORDERED_SETTABLE_SET_$T$_ERROR_VALUE_ALREADY_EXISTS
#define BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_SET_$T$_ERROR_VALUE_IS_INVALID \
    BUTTERFLYFISH_ORDERED_SETTABLE_SET_$T$_ERROR_VALUE_IS_INVALID
#define BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_SET_$T$_ERROR_MEMORY_ALLOCATION_FAILED \
    BUTTERFLYFISH_ORDERED_SETTABLE_SET_$T$_ERROR_MEMORY_ALLOCATION_FAILED
#define BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_SET_$T$_ERROR_VALUE_NOT_FOUND \
...
struct butterflyfish_ordered_settable_incremental_set_$t$ {
    int (*const as_ordered_settable_set)(
            struct butterflyfish_ordered_settable_incremental_set_$t$ *object,
 ...
 * @throws
 * BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_SET_$T$_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_SET_$T$_ERROR_OUT_IS_NULL
 * if out is <i>NULL</i>.
 */
int butterflyfish_ordered_settable_incremental_set_$t$_as_stream(
        const struct butterflyfish_ordered_settable_incremental_set_$t$ *object,
 ...
 * if out is <i>NULL</i>.
 * @throws
 * BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_SET_$T$_ERROR_SET_IS_EMPTY if set
 * is empty.
 */
 ...
 * object is <i>NULL</i>.
 * @throws
 * BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_SET_$T$_ERROR_ITEM_IS_NULL if
 * item is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_SET_$T$_ERROR_OUT_IS_NULL
 * if out is <i>NULL</i>.
 * @throws
 * BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_SET_$T$_ERROR_END_OF_SEQUENCE if
 ...
 * object is <i>NULL</i>.
 * @throws
 * BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_SET_$T$_ERROR_VALUE_IS_NULL if
 * value is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_SET_$T$_ERROR_OUT_IS_NULL
 * if out is <i>NULL</i>.
 * @throws
 ...
 * object is <i>NULL</i>.
 * @throws
 * BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_SET_$T$_ERROR_OTHER_IS_NULL if
 * other is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_SET_$T$_ERROR_OUT_IS_NULL
 * if out is <i>NULL</i>.
 * @throws
 ...
 * if out is <i>NULL</i>.
 * @throws
 * BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_SET_$T$_ERROR_VALUE_NOT_FOUND if
 ...
 * if value is already present in the set.
 * @throws
 * BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_SET_$T$_ERROR_VALUE_IS_INVALID if
 * value is invalid.
 * @throws
 * BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_SET_$T$_ERROR_MEMORY_ALLOCATION_FAILED
 * if there is insufficient memory to add value to the set.
...
#endif /* _BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_SET_$T$_H_ */
