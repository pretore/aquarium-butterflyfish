...
struct butterflyfish_settable_incremental_list_$t$ {
     ...
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_$T$_ERROR_OBJECT_IS_NULL
     * if object is <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_$T$_ERROR_OUT_IS_NULL if
     * out is <i>NULL</i>.
     */
     ...
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_$T$_ERROR_OUT_IS_NULL if
     * out is <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_$T$_ERROR_LIST_IS_EMPTY
     * if list is empty.
     */
     ...
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_$T$_ERROR_OBJECT_IS_NULL
     * if object is <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_$T$_ERROR_ITEM_IS_NULL
     * if item is <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_$T$_ERROR_OUT_IS_NULL if
     * out is <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_$T$_ERROR_END_OF_SEQUENCE
     ...
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_$T$_ERROR_OUT_IS_NULL if
     * out is <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_$T$_ERROR_ITEM_NOT_FOUND
     ...
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_$T$_ERROR_ITEM_IS_NULL
     * if item is <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_$T$_ERROR_VALUE_IS_NULL
     * if value is <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_$T$_ERROR_VALUE_IS_INVALID
     * if value is invalid.
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_$T$_ERROR_VALUE_ALREADY_EXISTS
     * if value is already present.
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_$T$_ERROR_MEMORY_ALLOCATION_FAILED
     ...
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_$T$_ERROR_VALUE_IS_NULL
     * if value is <i>NULL</i>.
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_$T$_ERROR_INDEX_IS_OUT_OF_BOUNDS
     * if at does not refer to an item contained within the list.
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_$T$_ERROR_MEMORY_ALLOCATION_FAILED
     * if there is not enough memory to set the item to value.
     * @throws BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_$T$_ERROR_VALUE_IS_INVALID
     ...
     * value is <i>NULL</i>.
     * @throws
     * BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_$T$_ERROR_VALUE_ALREADY_EXISTS if
