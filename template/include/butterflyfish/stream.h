...
struct butterflyfish_stream_$t$ {
    int (*const first)(const struct butterflyfish_stream_$t$ *object,
                       const $v$*out);

    int (*const next)(const struct butterflyfish_stream_$t$ *object,
                      const $v$item,
                      const $v$*out);
};
...
int butterflyfish_stream_$t$_first(
        const struct butterflyfish_stream_$t$ *object,
        const $v$*out);
