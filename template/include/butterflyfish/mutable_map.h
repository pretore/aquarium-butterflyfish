...
struct butterflyfish_mutable_map_$t$ {
     ...
     * @throws BUTTERFLYFISH_MUTABLE_MAP_$T$_ERROR_OBJECT_IS_NULL if object
     * is <i>NULL</i>.
     ...
     * @throws BUTTERFLYFISH_MUTABLE_MAP_$T$_ERROR_OUT_IS_NULL if out is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_MUTABLE_MAP_$T$_ERROR_MAP_IS_EMPTY if map is
     * empty.
     */
     ...
     * @throws BUTTERFLYFISH_MUTABLE_MAP_$T$_ERROR_OUT_IS_NULL if out is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_MUTABLE_MAP_$T$_ERROR_END_OF_SEQUENCE if there
     * is no next item.
     */
     ...
     * @throws BUTTERFLYFISH_MUTABLE_MAP_$T$_ERROR_OUT_IS_NULL if out is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_MUTABLE_MAP_$T$_ERROR_KEY_NOT_FOUND if key is
     ...
     * @throws BUTTERFLYFISH_MUTABLE_MAP_$T$_ERROR_KEY_NOT_FOUND if key is
     * not in the map instance.
     * @throws BUTTERFLYFISH_MUTABLE_MAP_$T$_ERROR_VALUE_IS_INVALID if value
     * is invalid.
     * @throws BUTTERFLYFISH_MUTABLE_MAP_$T$_ERROR_MEMORY_ALLOCATION_FAILED
