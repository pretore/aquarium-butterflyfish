...
struct butterflyfish_unordered_$t$ {
     ...
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_UNORDERED_$T$_ERROR_OUT_IS_NULL if out is
     * <i>NULL</i>.
     */
     ...
     * @throws BUTTERFLYFISH_UNORDERED_$T$_ERROR_OUT_IS_NULL if out is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_UNORDERED_$T$_ERROR_UNORDERED_IS_EMPTY if
     * unordered is empty.
     */
     ...
     * @throws BUTTERFLYFISH_UNORDERED_$T$_ERROR_OBJECT_IS_NULL if object is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_UNORDERED_$T$_ERROR_ITEM_IS_NULL if item is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_UNORDERED_$T$_ERROR_OUT_IS_NULL if out is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_UNORDERED_$T$_ERROR_END_OF_SEQUENCE if there is
     * no next item.
     */
