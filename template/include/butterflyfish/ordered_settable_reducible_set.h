#ifndef _BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_SET_$T$_H_
#define _BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_SET_$T$_H_

#include <stddef.h>
#include <stdbool.h>
#include <stdint.h>

#include "ordered_settable_set_$t$.h"
#include "ordered_reducible_set_$t$.h"
#include "settable_reducible_set_$t$.h"

$d$

#define BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_SET_$T$_ERROR_OBJECT_IS_NULL \
    BUTTERFLYFISH_ORDERED_SETTABLE_SET_$T$_ERROR_OBJECT_IS_NULL
#define BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_SET_$T$_ERROR_OUT_IS_NULL \
    BUTTERFLYFISH_ORDERED_SETTABLE_SET_$T$_ERROR_OUT_IS_NULL
#define BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_SET_$T$_ERROR_SET_IS_EMPTY \
    BUTTERFLYFISH_ORDERED_SETTABLE_SET_$T$_ERROR_SET_IS_EMPTY
#define BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_SET_$T$_ERROR_ITEM_IS_NULL \
    BUTTERFLYFISH_ORDERED_SETTABLE_SET_$T$_ERROR_ITEM_IS_NULL
#define BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_SET_$T$_ERROR_END_OF_SEQUENCE \
    BUTTERFLYFISH_ORDERED_SETTABLE_SET_$T$_ERROR_END_OF_SEQUENCE
#define BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_SET_$T$_ERROR_OTHER_IS_NULL \
    BUTTERFLYFISH_ORDERED_SETTABLE_SET_$T$_ERROR_OTHER_IS_NULL
#define BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_SET_$T$_ERROR_VALUE_IS_NULL \
    BUTTERFLYFISH_ORDERED_SETTABLE_SET_$T$_ERROR_VALUE_IS_NULL
#define BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_SET_$T$_ERROR_VALUE_ALREADY_EXISTS \
    BUTTERFLYFISH_ORDERED_SETTABLE_SET_$T$_ERROR_VALUE_ALREADY_EXISTS
#define BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_SET_$T$_ERROR_VALUE_IS_INVALID \
    BUTTERFLYFISH_ORDERED_SETTABLE_SET_$T$_ERROR_VALUE_IS_INVALID
#define BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_SET_$T$_ERROR_MEMORY_ALLOCATION_FAILED \
    BUTTERFLYFISH_ORDERED_SETTABLE_SET_$T$_ERROR_MEMORY_ALLOCATION_FAILED
#define BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_SET_$T$_ERROR_VALUE_NOT_FOUND \
...
struct butterflyfish_ordered_settable_reducible_set_$t$ {
    int (*const as_ordered_settable_set)(
            struct butterflyfish_ordered_settable_reducible_set_$t$ *object,
 ...
 * @throws
 * BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_SET_$T$_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_SET_$T$_ERROR_OUT_IS_NULL if
 * out is <i>NULL</i>.
 */
int butterflyfish_ordered_settable_reducible_set_$t$_as_stream(
        const struct butterflyfish_ordered_settable_reducible_set_$t$ *object,
 ...
 * BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_SET_$T$_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_SET_$T$_ERROR_OUT_IS_NULL
 * if out is <i>NULL</i>.
 */
 ...
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_SET_$T$_ERROR_OUT_IS_NULL
 * if out is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_SET_$T$_ERROR_SET_IS_EMPTY
 * if set is empty.
 */
 ...
 * BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_SET_$T$_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_SET_$T$_ERROR_ITEM_IS_NULL
 * if item is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_SET_$T$_ERROR_OUT_IS_NULL
 * if out is <i>NULL</i>.
 * @throws
 * BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_SET_$T$_ERROR_END_OF_SEQUENCE if there
 * is no next item.
 */
 ...
 * if out is <i>NULL</i>.
 * @throws
 * BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_SET_$T$_ERROR_END_OF_SEQUENCE if
 ...
 * BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_SET_$T$_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_SET_$T$_ERROR_VALUE_IS_NULL
 ...
 * BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_SET_$T$_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_SET_$T$_ERROR_OTHER_IS_NULL
 ...
 * if out is <i>NULL</i>.
 * @throws
 * BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_SET_$T$_ERROR_VALUE_NOT_FOUND if
 ...
 * if value is <i>NULL</i>.
 * @throws
 * BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_SET_$T$_ERROR_VALUE_ALREADY_EXISTS if
 * value is already present in the set.
 * @throws
 * BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_SET_$T$_ERROR_VALUE_IS_INVALID if
 * value is invalid.
 * @throws
 * BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_SET_$T$_ERROR_MEMORY_ALLOCATION_FAILED
 ...
 * if value is <i>NULL</i>.
 * @throws
 * BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_SET_$T$_ERROR_VALUE_NOT_FOUND if item
 * is not in the set.
 * @throws
 * BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_SET_$T$_ERROR_VALUE_ALREADY_EXISTS if
 * value is already present in the set.
...
#endif /* _BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_SET_$T$_H_ */
