...
struct butterflyfish_reducible_map_$t$ {
    ...
    const struct butterflyfish_reducible_set_$mkt$ *const keys;
    const struct butterflyfish_ordered_reducible_list_$mvt$ *const values;
     ...
     * @throws BUTTERFLYFISH_REDUCIBLE_MAP_$T$_ERROR_OBJECT_IS_NULL if object
     * is <i>NULL</i>.
     ...
     * @throws BUTTERFLYFISH_REDUCIBLE_MAP_$T$_ERROR_OUT_IS_NULL if out is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_REDUCIBLE_MAP_$T$_ERROR_MAP_IS_EMPTY if map is
     * empty.
     */
     ...
     * @throws BUTTERFLYFISH_REDUCIBLE_MAP_$T$_ERROR_OUT_IS_NULL if out is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_REDUCIBLE_MAP_$T$_ERROR_END_OF_SEQUENCE if there
     * is no next item.
     */
     ...
     * @throws BUTTERFLYFISH_REDUCIBLE_MAP_$T$_ERROR_OUT_IS_NULL if out is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_REDUCIBLE_MAP_$T$_ERROR_MEMORY_ALLOCATION_FAILED
