...
#define BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_OTHER_IS_NULL \
...
#define BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_ENTRY_IS_NULL \
...
#define BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_VALUE_NOT_FOUND \
    BUTTERFLYFISH_ORDERED_MAP_$T$_ERROR_VALUE_NOT_FOUND
#define BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_ENTRY_NOT_FOUND \
...
#define BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_ENTRY_IS_INVALID \
...
struct butterflyfish_ordered_incremental_map_$t$ {
    int (*const as_incremental_map)(
            struct butterflyfish_ordered_incremental_map_$t$ *object,
            struct butterflyfish_incremental_map_$t$ **out);

    int (*const as_ordered_map)(
            const struct butterflyfish_ordered_incremental_map_$t$ *object,
 ...
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_OUT_IS_NULL if out
 * is <i>NULL</i>.
 */
int butterflyfish_ordered_incremental_map_$t$_as_stream(
        const struct butterflyfish_ordered_incremental_map_$t$ *object,
 ...
 * is <i>NULL</i>.
 */
int butterflyfish_ordered_incremental_map_$t$_as_collection(
        const struct butterflyfish_ordered_incremental_map_$t$ *object,
 ...
 * is <i>NULL</i>.
 */
int butterflyfish_ordered_incremental_map_$t$_as_set(
        const struct butterflyfish_ordered_incremental_map_$t$ *object,
 ...
 * is <i>NULL</i>.
 */
int butterflyfish_ordered_incremental_map_$t$_as_ordered(
        const struct butterflyfish_ordered_incremental_map_$t$ *object,
 ...
 * is <i>NULL</i>.
 */
int butterflyfish_ordered_incremental_map_$t$_as_insertable(
        struct butterflyfish_ordered_incremental_map_$t$ *object,
        struct butterflyfish_insertable_$t$ **out);
 ...
 * is <i>NULL</i>.
 */
int butterflyfish_ordered_incremental_map_$t$_as_addable(
        struct butterflyfish_ordered_incremental_map_$t$ *object,
 ...
 * is <i>NULL</i>.
 */
int butterflyfish_ordered_incremental_map_$t$_as_map(
        const struct butterflyfish_ordered_incremental_map_$t$ *object,
 ...
 * is <i>NULL</i>.
 */
int butterflyfish_ordered_incremental_map_$t$_as_ordered_map(
        const struct butterflyfish_ordered_incremental_map_$t$ *object,
        const struct butterflyfish_ordered_map_$t$ **out);
 ...
 * is <i>NULL</i>.
 */
int butterflyfish_ordered_incremental_map_$t$_as_incremental_map(
        struct butterflyfish_ordered_incremental_map_$t$ *object,
        struct butterflyfish_incremental_map_$t$ **out);
 ...
 * is <i>NULL</i>.
 */
int butterflyfish_ordered_incremental_map_$t$_count(
        const struct butterflyfish_ordered_incremental_map_$t$ *object,
        uintmax_t *out);
 ...
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_OUT_IS_NULL if out
 * is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_MAP_IS_EMPTY if
 * map is empty.
 */
int butterflyfish_ordered_incremental_map_$t$_first(
        const struct butterflyfish_ordered_incremental_map_$t$ *object,
        const $v$*out);
 ...
 * map is empty.
 */
int butterflyfish_ordered_incremental_map_$t$_last(
        const struct butterflyfish_ordered_incremental_map_$t$ *object,
        const $v$*out);
 ...
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_ITEM_IS_NULL if
 * item is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_OUT_IS_NULL if out
 * is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_END_OF_SEQUENCE if
 * there is no next item.
 */
int butterflyfish_ordered_incremental_map_$t$_next(
        const struct butterflyfish_ordered_incremental_map_$t$ *object,
        const $v$item,
        const $v$*out);
 ...
 */
int butterflyfish_ordered_incremental_map_$t$_prev(
        const struct butterflyfish_ordered_incremental_map_$t$ *object,
        const $v$item,
        const $v$*out);
 ...
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_ENTRY_IS_NULL if
 * entry is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_OUT_IS_NULL if out
 * is <i>NULL</i>.
 * @throws
 ...
 */
int butterflyfish_ordered_incremental_map_$t$_contains(
        const struct butterflyfish_ordered_incremental_map_$t$ *object,
        const $v$entry,
        bool *out);
 ...
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_KEY_IS_NULL if key
 * is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_OUT_IS_NULL if out
 * is <i>NULL</i>.
 * @throws
 ...
 * if there is insufficient memory to find the entry.
 */
int butterflyfish_ordered_incremental_map_$t$_contains_key(
        const struct butterflyfish_ordered_incremental_map_$t$ *object,
        const $mkv$key,
        bool *out);
 ...
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_VALUE_IS_NULL if
 * value is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_OUT_IS_NULL if out
 * is <i>NULL</i>.
 * @throws
 ...
 * if there is insufficient memory to find the entry.
 */
int butterflyfish_ordered_incremental_map_$t$_contains_value(
        const struct butterflyfish_ordered_incremental_map_$t$ *object,
        const $mvv$value,
        bool *out);
 ...
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_OTHER_IS_NULL if
 * other is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_OUT_IS_NULL if out
 * is <i>NULL</i>.
 * @throws
 ...
 * if there is insufficient memory to find the entry.
 */
int butterflyfish_ordered_incremental_map_$t$_contains_all(
        const struct butterflyfish_ordered_incremental_map_$t$ *object,
 ...
 * if there is insufficient memory to find the entry.
 */
int butterflyfish_ordered_incremental_map_$t$_contains_all_keys(
        const struct butterflyfish_ordered_incremental_map_$t$ *object,
 ...
 * if there is insufficient memory to find the entry.
 */
int butterflyfish_ordered_incremental_map_$t$_contains_all_values(
        const struct butterflyfish_ordered_incremental_map_$t$ *object,
 ...
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_OUT_IS_NULL if out
 * is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_ENTRY_NOT_FOUND if
 * entry is not in the map instance.
 * @throws
 * BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_MEMORY_ALLOCATION_FAILED
 * if there is insufficient memory to find the entry.
 */
int butterflyfish_ordered_incremental_map_$t$_get(
        const struct butterflyfish_ordered_incremental_map_$t$ *object,
        const $v$entry,
        const $v$*out);
 ...
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_OUT_IS_NULL if out
 * is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_KEY_NOT_FOUND if
 * key is not in the map instance.
 * @throws
 * BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_MEMORY_ALLOCATION_FAILED
 * if there is insufficient memory to find the value.
 */
int butterflyfish_ordered_incremental_map_$t$_get_value(
        const struct butterflyfish_ordered_incremental_map_$t$ *object,
        const $mkv$key,
        const $mvv$*out);
 ...
 * if there is insufficient memory to find the value.
 */
int butterflyfish_ordered_incremental_map_$t$_get_entry(
        const struct butterflyfish_ordered_incremental_map_$t$ *object,
        const $mkv$key,
        const $v$*out);
 ...
 * @throws BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_ENTRY_IS_INVALID
 * if entry is invalid.
 * @throws
 * BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_MEMORY_ALLOCATION_FAILED
 ...
 */
int butterflyfish_ordered_incremental_map_$t$_add(
        struct butterflyfish_ordered_incremental_map_$t$ *object,
        const $v$entry);
 ...
 */
int butterflyfish_ordered_incremental_map_$t$_add_all(
        struct butterflyfish_ordered_incremental_map_$t$ *object,
        const struct butterflyfish_stream_$t$ *other);
 ...
 * if value is invalid.
 * @throws
 * BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_MEMORY_ALLOCATION_FAILED if
 * there is insufficient memory to add value to the set.
 * @note <b>value</b> is copied.
 */
int butterflyfish_ordered_incremental_map_$t$_add_value(
        struct butterflyfish_ordered_incremental_map_$t$ *object,
        const $mkv$key,
        const $mvv$value);
 ...
 * value is <i>NULL</i>.
 * @throws
 * BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_VALUE_ALREADY_EXISTS if
 ...
 */
int butterflyfish_ordered_incremental_map_$t$_insert(
        struct butterflyfish_ordered_incremental_map_$t$ *object,
        const $v$item,
        const $v$value);
 ...
 */
int butterflyfish_ordered_incremental_map_$t$_insert_all(
        struct butterflyfish_ordered_incremental_map_$t$ *object,
        const $v$item,
        const struct butterflyfish_stream_$t$ *other);
 ...
 * is <i>NULL</i>.
 */
int butterflyfish_ordered_incremental_map_$t$_keys(
        struct butterflyfish_ordered_incremental_map_$t$ *object,
        struct butterflyfish_ordered_incremental_set_$mkt$ **out);
 ...
 * is <i>NULL</i>.
 */
int butterflyfish_ordered_incremental_map_$t$_values(
        const struct butterflyfish_ordered_incremental_map_$t$ *object,
        const struct butterflyfish_ordered_list_$mvt$ **out);
