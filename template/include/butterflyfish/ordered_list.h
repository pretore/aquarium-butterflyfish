...
struct butterflyfish_ordered_list_$t$ {
     ...
     * @throws BUTTERFLYFISH_ORDERED_LIST_$T$_ERROR_OUT_IS_NULL if out is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_ORDERED_LIST_$T$_ERROR_LIST_IS_EMPTY if list is
     * empty.
     */
     ...
     * @throws BUTTERFLYFISH_ORDERED_LIST_$T$_ERROR_OUT_IS_NULL if out is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_ORDERED_LIST_$T$_ERROR_END_OF_SEQUENCE if there is
     * no next item.
     */
     ...
     * @throws BUTTERFLYFISH_ORDERED_LIST_$T$_ERROR_OUT_IS_NULL if out is
     * <i>NULL</i>.
     * @throws BUTTERFLYFISH_ORDERED_LIST_$T$_ERROR_INDEX_IS_OUT_OF_BOUNDS if
