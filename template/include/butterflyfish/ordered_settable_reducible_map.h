#ifndef _BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_MAP_$T$_H_
#define _BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_MAP_$T$_H_
...
#include "ordered_reducible_map_$t$.h"
#include "settable_reducible_map_$t$.h"

struct butterflyfish_stream_$mkt$;
struct butterflyfish_stream_$mvt$;
struct butterflyfish_ordered_settable_reducible_set_$mkt$;
struct butterflyfish_ordered_settable_reducible_list_$mvt$;

#define BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_OBJECT_IS_NULL \
    BUTTERFLYFISH_ORDERED_SETTABLE_MAP_$T$_ERROR_OBJECT_IS_NULL
#define BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_OUT_IS_NULL \
    BUTTERFLYFISH_ORDERED_SETTABLE_MAP_$T$_ERROR_OUT_IS_NULL
#define BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_MAP_IS_EMPTY \
    BUTTERFLYFISH_ORDERED_SETTABLE_MAP_$T$_ERROR_MAP_IS_EMPTY
#define BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_ITEM_IS_NULL \
    BUTTERFLYFISH_ORDERED_SETTABLE_MAP_$T$_ERROR_ITEM_IS_NULL
#define BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_END_OF_SEQUENCE \
    BUTTERFLYFISH_ORDERED_SETTABLE_MAP_$T$_ERROR_END_OF_SEQUENCE
#define BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_OTHER_IS_NULL \
    BUTTERFLYFISH_ORDERED_SETTABLE_MAP_$T$_ERROR_OTHER_IS_NULL
#define BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_VALUE_IS_NULL \
    BUTTERFLYFISH_ORDERED_SETTABLE_MAP_$T$_ERROR_VALUE_IS_NULL
#define BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_ENTRY_IS_NULL \
    BUTTERFLYFISH_ORDERED_SETTABLE_MAP_$T$_ERROR_ENTRY_IS_NULL
#define BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_KEY_IS_NULL \
    BUTTERFLYFISH_ORDERED_SETTABLE_MAP_$T$_ERROR_KEY_IS_NULL
#define BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_MEMORY_ALLOCATION_FAILED \
    BUTTERFLYFISH_ORDERED_SETTABLE_MAP_$T$_ERROR_MEMORY_ALLOCATION_FAILED
#define BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_VALUE_NOT_FOUND \
    BUTTERFLYFISH_ORDERED_SETTABLE_MAP_$T$_ERROR_VALUE_NOT_FOUND
#define BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_ENTRY_NOT_FOUND \
    BUTTERFLYFISH_ORDERED_SETTABLE_MAP_$T$_ERROR_ENTRY_NOT_FOUND
#define BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_KEY_NOT_FOUND \
    BUTTERFLYFISH_ORDERED_SETTABLE_MAP_$T$_ERROR_KEY_NOT_FOUND
#define BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_VALUE_IS_INVALID \
    BUTTERFLYFISH_ORDERED_SETTABLE_MAP_$T$_ERROR_VALUE_IS_INVALID
#define BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_KEY_ALREADY_EXISTS \
 ...
 * @throws
 * BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_OUT_IS_NULL
 * if out is <i>NULL</i>.
 */
int butterflyfish_ordered_settable_reducible_map_$t$_as_stream(
        const struct butterflyfish_ordered_settable_reducible_map_$t$ *object,
 ...
 * if out is <i>NULL</i>.
 * @throws
 * BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_MAP_IS_EMPTY if map
 * is empty.
 */
 ...
 * object is <i>NULL</i>.
 * @throws
 * BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_ITEM_IS_NULL if
 * item is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_OUT_IS_NULL
 * if out is <i>NULL</i>.
 * @throws
 * BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_END_OF_SEQUENCE if
 ...
 * object is <i>NULL</i>.
 * @throws
 * BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_ENTRY_IS_NULL if
 * entry is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_OUT_IS_NULL
 * if out is <i>NULL</i>.
 * @throws
 ...
 * BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_OBJECT_IS_NULL if
 * object is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_KEY_IS_NULL
 * if key is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_OUT_IS_NULL
 * if out is <i>NULL</i>.
 * @throws
 ...
 * object is <i>NULL</i>.
 * @throws
 * BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_VALUE_IS_NULL if
 * value is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_OUT_IS_NULL
 * if out is <i>NULL</i>.
 * @throws
 ...
 * object is <i>NULL</i>.
 * @throws
 * BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_OTHER_IS_NULL if
 * other is <i>NULL</i>.
 * @throws BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_OUT_IS_NULL
 * if out is <i>NULL</i>.
 * @throws
 ...
 * if out is <i>NULL</i>.
 * @throws
 * BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_ENTRY_NOT_FOUND if
 ...
 * if out is <i>NULL</i>.
 * @throws
 * BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_KEY_NOT_FOUND if key
 ...
 * is not in the map instance.
 * @throws
 * BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_VALUE_IS_INVALID if
 * value is invalid.
 * @throws
 * BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_MEMORY_ALLOCATION_FAILED
 ...
 * is not in the map instance.
 * @throws
 * BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_KEY_ALREADY_EXISTS if
...
#endif /* _BUTTERFLYFISH_ORDERED_SETTABLE_REDUCIBLE_MAP_$T$_H_ */
