...
struct object {
    const struct butterflyfish_sorted_settable_incremental_list_$t$ *const
            sorted_settable_incremental_list_$t$;
    const struct butterflyfish_settable_incremental_list_$t$ *const
            settable_incremental_list_$t$;
    const struct butterflyfish_sorted_incremental_list_$t$ *const
            sorted_incremental_list_$t$;
    const struct butterflyfish_sorted_settable_list_$t$ *const
            sorted_settable_list_$t$;
    ...
    const struct butterflyfish_sorted_list_$t$ *const sorted_list_$t$;
...
static int
sorted_as_collection(const struct butterflyfish_sorted_$t$ *object,
...
static int
sorted_list_as_sorted(const struct butterflyfish_sorted_list_$t$ *const object,
                      const struct butterflyfish_sorted_$t$ **const out) {
    assert_non_null(object);
    assert_non_null(out);
    *out = butterflyfish_cast(object, struct object, sorted_list_$t$, sorted_$t$);
    return 0;
}

static int
sorted_list_as_list(const struct butterflyfish_sorted_list_$t$ *const object,
                    const struct butterflyfish_list_$t$ **const out) {
    assert_non_null(object);
    assert_non_null(out);
    *out = butterflyfish_cast(object, struct object, sorted_list_$t$, list_$t$);
    return 0;
}

const struct butterflyfish_sorted_list_$t$ sorted_list_$t$ = {
...
sorted_settable_list_as_settable_list(
    ...
    assert_non_null(object);
    assert_non_null(out);
    *out = butterflyfish_cast(object, struct object, sorted_settable_list_$t$,
                              settable_list_$t$);
    return 0;
}
...
const struct butterflyfish_sorted_settable_list_$t$ sorted_settable_list_$t$ = {
...
sorted_incremental_list_as_sorted_list(
    ...
    assert_non_null(object);
    assert_non_null(out);
    *out = butterflyfish_cast(object, struct object, sorted_incremental_list_$t$,
            sorted_list_$t$);
    return 0;
}
...
const struct
butterflyfish_sorted_incremental_list_$t$ sorted_incremental_list_$t$ = {
...
sorted_settable_incremental_list_as_sorted_incremental_list(
        struct butterflyfish_sorted_settable_incremental_list_$t$ *const object,
        struct butterflyfish_sorted_incremental_list_$t$ **const out) {
    assert_non_null(object);
    assert_non_null(out);
    *out = butterflyfish_cast(object, struct object,
            sorted_settable_incremental_list_$t$,
...
sorted_settable_incremental_list_as_sorted_settable_list(
        struct butterflyfish_sorted_settable_incremental_list_$t$ *const object,
        struct butterflyfish_sorted_settable_list_$t$ **const out) {
    assert_non_null(object);
    assert_non_null(out);
    *out = butterflyfish_cast(object, struct object,
            sorted_settable_incremental_list_$t$,
...
const struct
butterflyfish_sorted_settable_incremental_list_$t$
sorted_settable_incremental_list_$t$ = {
...
static void check_as_stream_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_list_$t$_as_stream(
                    NULL, (void *) 1),
...
static void check_as_stream_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_list_$t$_as_stream(
                    (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_as_stream(void **state) {
    const struct object instance = {
            ...
            .sorted_incremental_list_$t$ = &sorted_incremental_list_$t$,
            .sorted_settable_list_$t$ = &sorted_settable_list_$t$,
            .incremental_list_$t$ = &incremental_list_$t$,
            .settable_list_$t$ = &settable_list_$t$,
            .sorted_list_$t$ = &sorted_list_$t$,
    ...
    assert_int_equal(butterflyfish_sorted_settable_incremental_list_$t$_as_stream(
            (const struct butterflyfish_sorted_settable_incremental_list_$t$ *)
                    &instance, &out), 0);
...
static void check_as_collection_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_list_$t$_as_collection(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_$T$_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_collection(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_settable_incremental_list_$t$_as_collection(
            (const struct butterflyfish_sorted_settable_incremental_list_$t$ *)
                    &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_sorted_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_list_$t$_as_sorted(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_$T$_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_sorted(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_settable_incremental_list_$t$_as_sorted(
            (const struct butterflyfish_sorted_settable_incremental_list_$t$ *)
                    &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_list_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_list_$t$_as_list(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_$T$_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_list(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_settable_incremental_list_$t$_as_list(
            (const struct butterflyfish_sorted_settable_incremental_list_$t$ *)
                    &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_settable_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_list_$t$_as_settable(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_$T$_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_settable(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_settable_incremental_list_$t$_as_settable(
...
static void check_as_addable_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_list_$t$_as_addable(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_$T$_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_addable(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_settable_incremental_list_$t$_as_addable(
            (struct butterflyfish_sorted_settable_incremental_list_$t$ *)
                    &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_sorted_list_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_list_$t$_as_sorted_list(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_$T$_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_sorted_list(void **state) {
    ...
    const void *check = (char *) &instance
                        + offsetof(struct object, sorted_list_$t$);
    const struct butterflyfish_sorted_list_$t$ *out;
    assert_int_equal(butterflyfish_sorted_settable_incremental_list_$t$_as_sorted_list(
            (const struct butterflyfish_sorted_settable_incremental_list_$t$ *)
                    &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_settable_list_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_list_$t$_as_settable_list(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_$T$_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_settable_list(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_settable_incremental_list_$t$_as_settable_list(
            (struct butterflyfish_sorted_settable_incremental_list_$t$ *)
                    &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_incremental_list_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_list_$t$_as_incremental_list(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_$T$_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_incremental_list(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_settable_incremental_list_$t$_as_incremental_list(
            (struct butterflyfish_sorted_settable_incremental_list_$t$ *)
                    &instance, &out), 0);
    assert_ptr_equal(out, check);
}

static void check_as_sorted_settable_list_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_list_$t$_as_sorted_settable_list(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_$T$_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_sorted_settable_list(void **state) {
    ...
    const void *check = (char *) &instance
                        + offsetof(struct object, sorted_settable_list_$t$);
    struct butterflyfish_sorted_settable_list_$t$ *out;
    assert_int_equal(butterflyfish_sorted_settable_incremental_list_$t$_as_sorted_settable_list(
            (struct butterflyfish_sorted_settable_incremental_list_$t$ *)
                    &instance, &out), 0);
    assert_ptr_equal(out, check);
}

static void check_as_sorted_incremental_list_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_list_$t$_as_sorted_incremental_list(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_as_sorted_incremental_list_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_list_$t$_as_sorted_incremental_list(
                    (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_$T$_ERROR_OUT_IS_NULL);
...
static void check_as_sorted_incremental_list(void **state) {
    ...
    const void *check = (char *) &instance
                        + offsetof(struct object, sorted_incremental_list_$t$);
    struct butterflyfish_sorted_incremental_list_$t$ *out;
    assert_int_equal(butterflyfish_sorted_settable_incremental_list_$t$_as_sorted_incremental_list(
            (struct butterflyfish_sorted_settable_incremental_list_$t$ *)
                    &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_settable_incremental_list(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_settable_incremental_list_$t$_as_settable_incremental_list(
            (struct butterflyfish_sorted_settable_incremental_list_$t$ *)
                    &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_sorted_incremental_list_as_sorted_list(void **state) {
    ...
    const void *check = (char *) &instance
            + offsetof(struct object, sorted_list_$t$);
    struct butterflyfish_sorted_incremental_list_$t$ *as;
    assert_int_equal(butterflyfish_sorted_settable_incremental_list_$t$_as_sorted_incremental_list(
            (struct butterflyfish_sorted_settable_incremental_list_$t$ *)
                    &instance, &as), 0);
    const struct butterflyfish_sorted_list_$t$ *out;
    assert_int_equal(butterflyfish_sorted_incremental_list_$t$_as_sorted_list(as, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_sorted_list_as_list(void **state) {
    const struct object instance = {
            .sorted_settable_incremental_list_$t$ =
                    &sorted_settable_incremental_list_$t$,
            .settable_incremental_list_$t$ = &settable_incremental_list_$t$,
    ...
    const void *check = (char *) &instance + offsetof(struct object, list_$t$);
    const struct butterflyfish_sorted_list_$t$ *as;
    assert_int_equal(butterflyfish_sorted_settable_incremental_list_$t$_as_sorted_list(
            (struct butterflyfish_sorted_settable_incremental_list_$t$ *)
                    &instance, &as), 0);
    const struct butterflyfish_list_$t$ *out;
    assert_int_equal(butterflyfish_sorted_list_$t$_as_list(as, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_count_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_list_$t$_count(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_$T$_ERROR_OBJECT_IS_NULL);
}
...
static void check_count(void **state) {
    ...
    uintmax_t out;
    assert_int_equal(butterflyfish_sorted_settable_incremental_list_$t$_count(
            (const struct butterflyfish_sorted_settable_incremental_list_$t$ *)
                    &instance, &out), 0);
...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_list_$t$_first(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_$T$_ERROR_OBJECT_IS_NULL);
}
...
static void check_first_error_on_list_is_empty(void **state) {
    ...
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_list_$t$_first(
                    (const struct butterflyfish_sorted_settable_incremental_list_$t$ *)
                            &instance, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_$T$_ERROR_LIST_IS_EMPTY);
}

static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_list_$t$_last(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_$T$_ERROR_OBJECT_IS_NULL);
}
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_list_$t$_next(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_$T$_ERROR_OBJECT_IS_NULL);
}
...
static void check_next_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_list_$t$_next(
                    (void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_$T$_ERROR_ITEM_IS_NULL);
}
...
static void check_prev_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_list_$t$_prev(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_$T$_ERROR_OBJECT_IS_NULL);
}
...
static void check_get_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_list_$t$_get(
                    NULL, 0, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_$T$_ERROR_OBJECT_IS_NULL);
}
...
static void check_at_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_list_$t$_at(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_$T$_ERROR_OBJECT_IS_NULL);
}
...
static void check_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_list_$t$_set(
                    NULL, 0, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_$T$_ERROR_OBJECT_IS_NULL);
}
...
static void check_set_item_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_list_$t$_set_item(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_$T$_ERROR_OBJECT_IS_NULL);
}
...
static void check_ceiling_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_list_$t$_ceiling(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_$T$_ERROR_OBJECT_IS_NULL);
}
...
static void check_floor_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_list_$t$_floor(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_$T$_ERROR_OBJECT_IS_NULL);
}
...
static void check_higher_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_list_$t$_higher(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_$T$_ERROR_OBJECT_IS_NULL);
}
...
static void check_lower_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_list_$t$_lower(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_$T$_ERROR_OBJECT_IS_NULL);
}
...
static void check_add_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_list_$t$_add(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_$T$_ERROR_OBJECT_IS_NULL);
}
...
static void check_add_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_settable_incremental_list_$t$_add_all(
                    NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SETTABLE_INCREMENTAL_LIST_$T$_ERROR_OBJECT_IS_NULL);
}
...
int main(int argc, char *argv[]) {
    const struct CMUnitTest tests[] = {
            ...
            cmocka_unit_test(check_sorted_list_as_list),
