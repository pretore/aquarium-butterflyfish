...
struct instance {
    const struct butterflyfish_reducible_map_$t$ *const id;
    void *data;
};
...
static int stream_first(const void *const object,
    ...
    seagrass_required_true(&reducible_map_$t$ == instance->id);
    return mock();
}
...
static void check_as_stream(void **state) {
    assert_ptr_equal(reducible_map_$t$.as_stream, &stream_$t$);
}

static void check_as_collection(void **state) {
    assert_ptr_equal(reducible_map_$t$.as_collection, &collection_$t$);
}

static void check_as_set(void **state) {
    assert_ptr_equal(reducible_map_$t$.as_set, &set_$t$);
}

static void check_as_removable(void **state) {
    assert_ptr_equal(reducible_map_$t$.as_removable, &removable_$t$);
}

static void check_as_map(void **state) {
    assert_ptr_equal(reducible_map_$t$.as_map, &map_$t$);
}

static void check_count_error_on_object_is_null(void **state) {
    assert_int_equal(reducible_map_$t$.count(NULL, (void *) 1),
                     BUTTERFLYFISH_REDUCIBLE_MAP_I_I_ERROR_OBJECT_IS_NULL);
}

static void check_count_error_on_out_is_null(void **state) {
    assert_int_equal(reducible_map_$t$.count((void *) 1, NULL),
...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(reducible_map_$t$.first(NULL, (void *) 1),
                     BUTTERFLYFISH_REDUCIBLE_MAP_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_first_error_on_out_is_null(void **state) {
    assert_int_equal(reducible_map_$t$.first((void *) 1, NULL),
...
static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(reducible_map_$t$.last(NULL, (void *) 1),
                     BUTTERFLYFISH_REDUCIBLE_MAP_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_last_error_on_out_is_null(void **state) {
    assert_int_equal(reducible_map_$t$.last((void *) 1, NULL),
                     BUTTERFLYFISH_REDUCIBLE_MAP_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(reducible_map_$t$.next(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_REDUCIBLE_MAP_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_next_error_on_item_is_null(void **state) {
    assert_int_equal(reducible_map_$t$.next((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_REDUCIBLE_MAP_$T$_ERROR_ITEM_IS_NULL);
}

static void check_next_error_on_out_is_null(void **state) {
    assert_int_equal(reducible_map_$t$.next((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_REDUCIBLE_MAP_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_prev_error_on_object_is_null(void **state) {
    assert_int_equal(reducible_map_$t$.prev(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_REDUCIBLE_MAP_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_prev_error_on_item_is_null(void **state) {
    assert_int_equal(reducible_map_$t$.prev((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_REDUCIBLE_MAP_$T$_ERROR_ITEM_IS_NULL);
}

static void check_prev_error_on_out_is_null(void **state) {
    assert_int_equal(reducible_map_$t$.prev((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_REDUCIBLE_MAP_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_prev_error_on_end_of_sequence(void **state) {
    ...
    assert_int_equal(reducible_map_$t$.prev(&instance, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_REDUCIBLE_MAP_$T$_ERROR_END_OF_SEQUENCE);
}

static void check_contains_key_error_on_object_is_null(void **state) {
    assert_int_equal(reducible_map_$t$.contains_key(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_REDUCIBLE_MAP_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_contains_key_error_on_key_is_null(void **state) {
    assert_int_equal(reducible_map_$t$.contains_key((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_REDUCIBLE_MAP_$T$_ERROR_KEY_IS_NULL);
}

static void check_contains_key_error_on_out_is_null(void **state) {
    assert_int_equal(reducible_map_$t$.contains_key((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_REDUCIBLE_MAP_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_contains_value_error_on_object_is_null(void **state) {
    assert_int_equal(reducible_map_$t$.contains_value(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_REDUCIBLE_MAP_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_contains_value_error_on_value_is_null(void **state) {
    assert_int_equal(reducible_map_$t$.contains_value((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_REDUCIBLE_MAP_$T$_ERROR_VALUE_IS_NULL);
}

static void check_contains_value_error_on_out_is_null(void **state) {
    assert_int_equal(reducible_map_$t$.contains_value((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_REDUCIBLE_MAP_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_get_error_on_object_is_null(void **state) {
    assert_int_equal(reducible_map_$t$.get(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_REDUCIBLE_MAP_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_get_error_on_key_is_null(void **state) {
    assert_int_equal(reducible_map_$t$.get((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_REDUCIBLE_MAP_$T$_ERROR_KEY_IS_NULL);
}

static void check_get_error_on_out_is_null(void **state) {
    assert_int_equal(reducible_map_$t$.get((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_REDUCIBLE_MAP_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_get_entry_error_on_object_is_null(void **state) {
    assert_int_equal(reducible_map_$t$.get_entry(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_REDUCIBLE_MAP_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_get_entry_error_on_key_is_null(void **state) {
    assert_int_equal(reducible_map_$t$.get_entry((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_REDUCIBLE_MAP_$T$_ERROR_KEY_IS_NULL);
}

static void check_get_entry_error_on_out_is_null(void **state) {
    assert_int_equal(reducible_map_$t$.get_entry((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_REDUCIBLE_MAP_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_remove_error_on_object_is_null(void **state) {
    assert_int_equal(reducible_map_$t$.remove(NULL, (void *) 1),
                     BUTTERFLYFISH_REDUCIBLE_MAP_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_remove_error_on_key_is_null(void **state) {
    assert_int_equal(reducible_map_$t$.remove((void *) 1, NULL),
                     BUTTERFLYFISH_REDUCIBLE_MAP_$T$_ERROR_KEY_IS_NULL);
}
...
static void check_keys(void **state) {
    assert_int_equal(reducible_map_$t$.keys, (void *) 1);
}

static void check_values(void **state) {
    assert_int_equal(reducible_map_$t$.values, (void *) 1);
}
