...
static void check_as_stream_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_$t$_as_stream(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_as_stream_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_$t$_as_stream((void *) 1, NULL),
...
static void check_as_stream(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_set_$t$_as_stream(
            (const struct butterflyfish_sorted_set_$t$ *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}

static void check_as_collection_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_$t$_as_collection(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_as_collection_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_$t$_as_collection((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_as_collection(void **state) {
    ...
    const struct butterflyfish_collection_$t$ *out;
    assert_int_equal(butterflyfish_sorted_set_$t$_as_collection(
            (const struct butterflyfish_sorted_set_$t$ *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_sorted_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_$t$_as_sorted(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_as_sorted_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_$t$_as_sorted((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_as_sorted(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_set_$t$_as_sorted(
            (struct butterflyfish_sorted_set_$t$ *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}

static void check_as_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_$t$_as_set(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_as_set_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_$t$_as_set((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_as_set(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_set_$t$_as_set(
            (struct butterflyfish_sorted_set_$t$ *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_sorted_as_collection(void **state) {
    ...
    assert_int_equal(butterflyfish_sorted_set_$t$_as_sorted(
            (struct butterflyfish_sorted_set_$t$ *) &instance, &as), 0);
    const struct butterflyfish_collection_$t$ *out;
...
static void check_count_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_$t$_count(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_count_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_$t$_count((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_count(void **state) {
    ...
    uintmax_t out;
    assert_int_equal(butterflyfish_sorted_set_$t$_count(
            (const struct butterflyfish_sorted_set_$t$ *) &instance, &out), 0);
...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_$t$_first(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_first_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_$t$_first((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_first_error_on_set_is_empty(void **state) {
    ...
    assert_int_equal(
            butterflyfish_sorted_set_$t$_first(
                    (const struct butterflyfish_sorted_set_$t$ *) &instance,
                    (void *) 1),
...
static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_$t$_last(NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_last_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_$t$_last((void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_last_error_on_set_is_empty(void **state) {
    ...
    assert_int_equal(
            butterflyfish_sorted_set_$t$_last(
                    (const struct butterflyfish_sorted_set_$t$ *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_SET_$T$_ERROR_SET_IS_EMPTY);
}
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_$t$_next(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_next_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_$t$_next((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_$T$_ERROR_ITEM_IS_NULL);
}

static void check_next_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_$t$_next((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_next_error_on_end_of_sequence(void **state) {
    ...
    assert_int_equal(
            butterflyfish_sorted_set_$t$_next(
                    (const struct butterflyfish_sorted_set_$t$ *) &instance,
                    (void *) 1,
                    (void *) 1),
...
static void check_prev_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_$t$_prev(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_prev_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_$t$_prev((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_$T$_ERROR_ITEM_IS_NULL);
}

static void check_prev_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_$t$_prev((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_prev_error_on_end_of_sequence(void **state) {
    ...
    assert_int_equal(
            butterflyfish_sorted_set_$t$_prev(
                    (const struct butterflyfish_sorted_set_$t$ *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_SET_$T$_ERROR_END_OF_SEQUENCE);
...
static void check_ceiling_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_$t$_ceiling(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_ceiling_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_$t$_ceiling((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_$T$_ERROR_VALUE_IS_NULL);
}

static void check_ceiling_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_$t$_ceiling((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_ceiling_error_on_value_not_found(void **state) {
    ...
    assert_int_equal(
            butterflyfish_sorted_set_$t$_ceiling(
                    (const struct butterflyfish_sorted_set_$t$ *) &instance,
                    (void *) 1,
                    (void *) 1),
...
static void check_floor_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_$t$_floor(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_floor_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_$t$_floor((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_$T$_ERROR_VALUE_IS_NULL);
}

static void check_floor_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_$t$_floor((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_floor_error_on_value_not_found(void **state) {
    ...
    will_return(sorted_floor,
                BUTTERFLYFISH_SORTED_$T$_ERROR_VALUE_NOT_FOUND);
    assert_int_equal(
            butterflyfish_sorted_set_$t$_floor(
                    (const struct butterflyfish_sorted_set_$t$ *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_SET_$T$_ERROR_VALUE_NOT_FOUND);
...
static void check_higher_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_$t$_higher(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_higher_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_$t$_higher((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_$T$_ERROR_VALUE_IS_NULL);
}

static void check_higher_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_$t$_higher((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_higher_error_on_value_not_found(void **state) {
    ...
    will_return(sorted_higher,
                BUTTERFLYFISH_SORTED_$T$_ERROR_VALUE_NOT_FOUND);
    assert_int_equal(
            butterflyfish_sorted_set_$t$_higher(
                    (const struct butterflyfish_sorted_set_$t$ *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_SET_$T$_ERROR_VALUE_NOT_FOUND);
...
static void check_lower_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_$t$_lower(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_lower_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_$t$_lower((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_$T$_ERROR_VALUE_IS_NULL);
}

static void check_lower_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_$t$_lower((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_lower_error_on_value_not_found(void **state) {
    ...
    will_return(sorted_lower,
                BUTTERFLYFISH_SORTED_$T$_ERROR_VALUE_NOT_FOUND);
    assert_int_equal(
            butterflyfish_sorted_set_$t$_lower(
                    (const struct butterflyfish_sorted_set_$t$ *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_SET_$T$_ERROR_VALUE_NOT_FOUND);
...
static void check_contains_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_$t$_contains(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_contains_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_$t$_contains((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_$T$_ERROR_VALUE_IS_NULL);
}

static void check_contains_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_$t$_contains((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_contains_error_on_memory_allocation_failed(void **state) {
    ...
    assert_int_equal(
            butterflyfish_sorted_set_$t$_contains(
                    (struct butterflyfish_sorted_set_$t$ *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_SET_$T$_ERROR_MEMORY_ALLOCATION_FAILED);
}
...
static void check_contains_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_$t$_contains_all(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_$T$_ERROR_OBJECT_IS_NULL);
}
...
static void check_get_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_$t$_get(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_get_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_$t$_get((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SORTED_SET_$T$_ERROR_VALUE_IS_NULL);
}

static void check_get_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_sorted_set_$t$_get((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SORTED_SET_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_get_error_on_value_not_found(void **state) {
    ...
    assert_int_equal(
            butterflyfish_sorted_set_$t$_get(
                    (struct butterflyfish_sorted_set_$t$ *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SORTED_SET_$T$_ERROR_VALUE_NOT_FOUND);
