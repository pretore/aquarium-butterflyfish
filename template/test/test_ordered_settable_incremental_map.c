...
static void check_as_stream_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_map_$t$_as_stream(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_as_stream_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_map_$t$_as_stream((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_as_stream(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_settable_incremental_map_$t$_as_stream(
            (const struct butterflyfish_ordered_settable_incremental_map_$t$ *) &instance,
            &out), 0);
...
static void check_as_collection_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_map_$t$_as_collection(
                    NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_collection(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_settable_incremental_map_$t$_as_collection(
            (const struct butterflyfish_ordered_settable_incremental_map_$t$ *) &instance,
            &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_map_$t$_as_set(
                    NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_set(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_settable_incremental_map_$t$_as_set(
            (const struct butterflyfish_ordered_settable_incremental_map_$t$ *) &instance,
            &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_ordered_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_map_$t$_as_ordered(
                    NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_ordered(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_settable_incremental_map_$t$_as_ordered(
            (const struct butterflyfish_ordered_settable_incremental_map_$t$ *) &instance,
            &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_insertable_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_map_$t$_as_insertable(
                    NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_insertable(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_settable_incremental_map_$t$_as_insertable(
            (struct butterflyfish_ordered_settable_incremental_map_$t$ *) &instance,
            &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_settable_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_map_$t$_as_settable(
                    NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_settable(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_settable_incremental_map_$t$_as_settable(
            (struct butterflyfish_ordered_settable_incremental_map_$t$ *) &instance,
            &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_addable_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_map_$t$_as_addable(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_as_addable_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_map_$t$_as_addable((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_as_addable(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_settable_incremental_map_$t$_as_addable(
            (struct butterflyfish_ordered_settable_incremental_map_$t$ *) &instance,
                    &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_map_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_map_$t$_as_map(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_as_map_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_map_$t$_as_map((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_as_map(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_settable_incremental_map_$t$_as_map(
            (const struct butterflyfish_ordered_settable_incremental_map_$t$ *) &instance,
            &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_ordered_map_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_map_$t$_as_ordered_map(
                    NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_ordered_map_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_map_$t$_as_ordered_map((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_as_ordered_map(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_settable_incremental_map_$t$_as_ordered_map(
            (const struct butterflyfish_ordered_settable_incremental_map_$t$ *) &instance,
            &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_settable_map_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_map_$t$_as_settable_map(
                    NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_settable_map_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_map_$t$_as_settable_map((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_as_settable_map(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_settable_incremental_map_$t$_as_settable_map(
            (struct butterflyfish_ordered_settable_incremental_map_$t$ *) &instance,
            &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_as_incremental_map_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_map_$t$_as_incremental_map(
                    NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_incremental_map(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_settable_incremental_map_$t$_as_incremental_map(
            (struct butterflyfish_ordered_settable_incremental_map_$t$ *)
                    &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
check_as_ordered_settable_map_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_map_$t$_as_ordered_settable_map(
                    NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_ordered_settable_map(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_settable_incremental_map_$t$_as_ordered_settable_map(
            (struct butterflyfish_ordered_settable_incremental_map_$t$ *)
                    &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
check_as_settable_incremental_map_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_map_$t$_as_settable_incremental_map(
                    NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_settable_incremental_map(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_settable_incremental_map_$t$_as_settable_incremental_map(
            (struct butterflyfish_ordered_settable_incremental_map_$t$ *)
                    &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
check_as_ordered_incremental_map_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_map_$t$_as_ordered_incremental_map(
                    NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL);
}
...
static void check_as_ordered_incremental_map(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_settable_incremental_map_$t$_as_ordered_incremental_map(
            (struct butterflyfish_ordered_settable_incremental_map_$t$ *)
                    &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_ordered_settable_map_as_ordered_map(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_settable_incremental_map_$t$_as_ordered_settable_map(
            ...
            &as), 0);
    const struct butterflyfish_ordered_map_$t$ *out;
    assert_int_equal(butterflyfish_ordered_settable_map_$t$_as_ordered_map(
            as, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_ordered_settable_map_as_settable_map(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_settable_incremental_map_$t$_as_ordered_settable_map(
            ...
            &as), 0);
    struct butterflyfish_settable_map_$t$ *out;
    assert_int_equal(butterflyfish_ordered_settable_map_$t$_as_settable_map(
            as, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_ordered_incremental_map_as_incremental_map(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_settable_incremental_map_$t$_as_ordered_incremental_map(
            ...
            &as), 0);
    struct butterflyfish_incremental_map_$t$ *out;
    assert_int_equal(butterflyfish_ordered_incremental_map_$t$_as_incremental_map(
            as, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_count_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_map_$t$_count(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_count_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_map_$t$_count((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_count(void **state) {
    ...
    uintmax_t out;
    assert_int_equal(butterflyfish_ordered_settable_incremental_map_$t$_count(
            (const struct butterflyfish_ordered_settable_incremental_map_$t$ *)
                    &instance, &out), 0);
...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_map_$t$_first(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_first_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_map_$t$_first((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_first_error_on_map_is_empty(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_map_$t$_first(
                    (const struct butterflyfish_ordered_settable_incremental_map_$t$ *)
                            &instance, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_MAP_IS_EMPTY);
}

static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_map_$t$_last(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_last_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_map_$t$_last((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_last_error_on_map_is_empty(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_map_$t$_last(
                    (const struct butterflyfish_ordered_settable_incremental_map_$t$ *)
                            &instance, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_MAP_IS_EMPTY);
}
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_map_$t$_next(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL);
}
...
static void check_next_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_map_$t$_next(
                    (void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_ITEM_IS_NULL);
}
...
static void check_next_error_on_end_of_sequence(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_map_$t$_next(
                    ...
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_END_OF_SEQUENCE);
}

static void check_prev_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_map_$t$_prev(
                    NULL,(void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL);
}
...
static void check_contains_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_map_$t$_contains(
                    NULL, (void *) 1, (void*) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL);
}
...
static void check_contains_error_on_entry_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_map_$t$_contains(
                    (void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_ENTRY_IS_NULL);
}
...
static void check_contains_error_on_memory_allocation_failed(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_map_$t$_contains(
                    ...
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_MEMORY_ALLOCATION_FAILED);
}

static void check_contains_key_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_map_$t$_contains_key(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL);
}
...
static void check_contains_key_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_map_$t$_contains_key(
                    (void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_VALUE_IS_NULL);
}
...
static void check_contains_value_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_map_$t$_contains_value(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL);
}
...
static void check_contains_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_map_$t$_contains_all(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL);
}
...
static void check_contains_all_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_map_$t$_contains_all(
                    (void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_OTHER_IS_NULL);
}
...
static void check_contains_all_keys_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_map_$t$_contains_all_keys(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL);
}
...
static void check_contains_all_values_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_map_$t$_contains_all_values(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL);
}
...
static void check_get_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_map_$t$_get(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL);
}
...
static void check_get_error_on_entry_not_found(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_map_$t$_get(
                    ...
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_ENTRY_NOT_FOUND);
}
...
static void check_get_value_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_map_$t$_get_value(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL);
}
...
static void check_get_value_error_on_value_not_found(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_map_$t$_get_value(
                    ...
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_VALUE_NOT_FOUND);
}
...
static void check_get_entry_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_map_$t$_get_entry(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL);
}
...
static void check_set_value_error_on_object_is_null(void **state) {
    assert_int_equal(butterflyfish_ordered_settable_incremental_map_$t$_set_value(
            NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL);
}
...
static void check_set_value_error_on_key_is_null(void **state) {
    assert_int_equal(butterflyfish_ordered_settable_incremental_map_$t$_set_value(
            (void *) 1, NULL,(void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_KEY_IS_NULL);
}
...
static void check_set_value_error_on_key_not_found(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_settable_incremental_map_$t$_set_value(
            (struct butterflyfish_ordered_settable_incremental_map_$t$ *) &instance,
                    (void *) 1, (void *) 1),
                     BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_KEY_NOT_FOUND);
}
...
static void check_set_value_error_on_value_is_invalid(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_settable_incremental_map_$t$_set_value(
            (struct butterflyfish_ordered_settable_incremental_map_$t$ *) &instance,
                    (void *) 1, (void *) 1),
                     BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_VALUE_IS_INVALID);
}
...
static void check_set_key_error_on_object_is_null(void **state) {
    assert_int_equal(butterflyfish_ordered_settable_incremental_map_$t$_set_key(
            NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL);
}
...
static void check_set_key_error_on_key_already_exists(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_settable_incremental_map_$t$_set_key(
            (struct butterflyfish_ordered_settable_incremental_map_$t$ *) &instance,
                    (void *) 1, (void *) 1),
                     BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_KEY_ALREADY_EXISTS);
}
...
static void check_set_entry_error_on_object_is_null(void **state) {
    assert_int_equal(butterflyfish_ordered_settable_incremental_map_$t$_set_entry(
            NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL);
}
...
static void check_add_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_map_$t$_add(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_add_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_map_$t$_add((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_VALUE_IS_NULL);
}
...
static void check_add_error_on_entry_is_invalid(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_map_$t$_add(
                    (struct butterflyfish_ordered_settable_incremental_map_$t$ *)
                            &instance, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_ENTRY_IS_INVALID);
}
...
static void check_add_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_map_$t$_add_all(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_add_all_error_on_other_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_map_$t$_add_all((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_OTHER_IS_NULL);
}
...
static void check_add_all_error_on_memory_allocation_failed(void **state) {
    ...
    will_return(addable_add_all,
                BUTTERFLYFISH_ADDABLE_$T$_ERROR_MEMORY_ALLOCATION_FAILED);
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_map_$t$_add_all(
                    (struct butterflyfish_ordered_settable_incremental_map_$t$ *)
                            &instance, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_MEMORY_ALLOCATION_FAILED);
}
...
static void check_add_value_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_map_$t$_add_value(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL);
...
static void check_insert_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_map_$t$_insert(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL);
}
...
static void check_insert_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_settable_incremental_map_$t$_insert_all(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL);
}
...
static void check_keys_error_on_object_is_null(void **state) {
    assert_int_equal(butterflyfish_ordered_settable_incremental_map_$t$_keys(NULL, (void *) 1),
                     BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_keys_error_on_out_is_null(void **state) {
    assert_int_equal(butterflyfish_ordered_settable_incremental_map_$t$_keys((void *) 1,NULL),
                     BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_keys(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_settable_incremental_map_$t$_keys(
            (struct butterflyfish_ordered_settable_incremental_map_$t$ *) &instance,
                    &out), 0);
}
...
static void check_values_error_on_object_is_null(void **state) {
    assert_int_equal(butterflyfish_ordered_settable_incremental_map_$t$_values(NULL, (void *) 1),
                     BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_values_error_on_out_is_null(void **state) {
    assert_int_equal(butterflyfish_ordered_settable_incremental_map_$t$_values((void *) 1, NULL),
                     BUTTERFLYFISH_ORDERED_SETTABLE_INCREMENTAL_MAP_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_values(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_settable_incremental_map_$t$_values(
            (struct butterflyfish_ordered_settable_incremental_map_$t$ *) &instance,
                    &out), 0);
}
...
static void check_as_ordered_map_values(void **state) {
    ...
    const struct butterflyfish_ordered_map_$t$ *as;
    assert_int_equal(butterflyfish_ordered_settable_incremental_map_$t$_as_ordered_map(
            (struct butterflyfish_ordered_settable_incremental_map_$t$ *) &instance, &as),
                    0);
    const struct butterflyfish_ordered_list_$mvt$ *out;
