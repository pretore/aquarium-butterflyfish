...
struct instance {
    const struct butterflyfish_ordered_incremental_map_$t$ *const id;
    void *data;
};

const struct butterflyfish_ordered_incremental_map_$t$
...
static int stream_first(const void *const object,
    ...
    seagrass_required_true(&ordered_incremental_map_$t$ == instance->id);
    return mock();
}
...
static int
ordered_incremental_map_insert(void *const object,
                               const $mkv$const key,
                               const $mvv$const value,
                               const $v$const item) {
    if (!object) {
        return BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL;
    }
    if (!key) {
        return BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_KEY_IS_NULL;
    }
    if (!value) {
        return BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_VALUE_IS_NULL;
    }
    if (!item) {
        return BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_ITEM_IS_NULL;
    }
    function_called();
    const struct instance *instance = object;
    seagrass_required_true(&ordered_incremental_map_$t$ == instance->id);
...
butterflyfish_ordered_incremental_map_$t$ ordered_incremental_map_$t$ = {
        ...
        .as_incremental_map = &incremental_map_$t$,
        .first = stream_first,
        .next = stream_next,
        .count = collection_count,
        .last = collection_last,
        ...
        .get = map_get,
        .get_entry = map_get_entry,
        .insert = ordered_incremental_map_insert,
        .keys = (void *) 1,
        .values = (void *) 1,
};

static void check_as_stream(void **state) {
    assert_ptr_equal(ordered_incremental_map_$t$.as_stream, &stream_$t$);
}

static void check_as_collection(void **state) {
    assert_ptr_equal(ordered_incremental_map_$t$.as_collection, &collection_$t$);
}

static void check_as_set(void **state) {
    assert_ptr_equal(ordered_incremental_map_$t$.as_set, &set_$t$);
}

static void check_as_ordered(void **state) {
    assert_ptr_equal(ordered_incremental_map_$t$.as_ordered, &ordered_$t$);
}

static void check_as_insertable(void **state) {
    assert_ptr_equal(ordered_incremental_map_$t$.as_insertable, &insertable_$t$);
}

static void check_as_addable(void **state) {
    assert_ptr_equal(ordered_incremental_map_$t$.as_addable, &addable_$t$);
}

static void check_as_map(void **state) {
    assert_ptr_equal(ordered_incremental_map_$t$.as_map, &map_$t$);
}

static void check_as_ordered_map(void **state) {
    assert_ptr_equal(ordered_incremental_map_$t$.as_ordered_map, &ordered_map_$t$);
}

static void check_as_incremental_map(void **state) {
    assert_ptr_equal(ordered_incremental_map_$t$.as_incremental_map, &incremental_map_$t$);
}

static void check_count_error_on_object_is_null(void **state) {
    assert_int_equal(ordered_incremental_map_$t$.count(NULL, (void *) 1),
                     BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_count_error_on_out_is_null(void **state) {
    assert_int_equal(ordered_incremental_map_$t$.count((void *) 1, NULL),
                     BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_OUT_IS_NULL);
}

static void check_count(void **state) {
    srand(time(NULL));
    struct instance instance = {
            .id = &ordered_incremental_map_$t$,
    };
...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(ordered_incremental_map_$t$.first(NULL, (void *) 1),
                     BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_first_error_on_out_is_null(void **state) {
    assert_int_equal(ordered_incremental_map_$t$.first((void *) 1, NULL),
                     BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_first_error_on_map_is_empty(void **state) {
    ...
    assert_int_equal(ordered_incremental_map_$t$.first(&instance, (void *) 1),
                     BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_MAP_IS_EMPTY);
}

static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(ordered_incremental_map_$t$.last(NULL, (void *) 1),
                     BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_last_error_on_out_is_null(void **state) {
    assert_int_equal(ordered_incremental_map_$t$.last((void *) 1, NULL),
                     BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(ordered_incremental_map_$t$.next(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_next_error_on_item_is_null(void **state) {
    assert_int_equal(ordered_incremental_map_$t$.next((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_ITEM_IS_NULL);
}

static void check_next_error_on_out_is_null(void **state) {
    assert_int_equal(ordered_incremental_map_$t$.next((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_next_error_on_end_of_sequence(void **state) {
    ...
    assert_int_equal(instance.id->next(&instance, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_END_OF_SEQUENCE);
}

static void check_prev_error_on_object_is_null(void **state) {
    assert_int_equal(ordered_incremental_map_$t$.prev(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_prev_error_on_item_is_null(void **state) {
    assert_int_equal(ordered_incremental_map_$t$.prev((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_ITEM_IS_NULL);
}

static void check_prev_error_on_out_is_null(void **state) {
    assert_int_equal(ordered_incremental_map_$t$.prev((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_contains_key_error_on_object_is_null(void **state) {
    assert_int_equal(ordered_incremental_map_$t$.contains_key(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_contains_key_error_on_value_is_null(void **state) {
    assert_int_equal(ordered_incremental_map_$t$.contains_key((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_KEY_IS_NULL);
}

static void check_contains_key_error_on_out_is_null(void **state) {
    assert_int_equal(ordered_incremental_map_$t$.contains_key((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_contains_value_error_on_object_is_null(void **state) {
    assert_int_equal(ordered_incremental_map_$t$.contains_value(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_contains_value_error_on_value_is_null(void **state) {
    assert_int_equal(ordered_incremental_map_$t$.contains_value((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_VALUE_IS_NULL);
}

static void check_contains_value_error_on_out_is_null(void **state) {
    assert_int_equal(ordered_incremental_map_$t$.contains_value((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_get_error_on_object_is_null(void **state) {
    assert_int_equal(ordered_incremental_map_$t$.get(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_get_error_on_key_is_null(void **state) {
    assert_int_equal(ordered_incremental_map_$t$.get((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_KEY_IS_NULL);
}

static void check_get_error_on_out_is_null(void **state) {
    assert_int_equal(ordered_incremental_map_$t$.get((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_get_error_on_key_not_found(void **state) {
    ...
    assert_int_equal(instance.id->get(&instance, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_KEY_NOT_FOUND);
}
...
static void check_get_entry_error_on_object_is_null(void **state) {
    assert_int_equal(ordered_incremental_map_$t$.get_entry(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_get_entry_error_on_key_is_null(void **state) {
    assert_int_equal(ordered_incremental_map_$t$.get_entry((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_KEY_IS_NULL);
}

static void check_get_entry_error_on_out_is_null(void **state) {
    assert_int_equal(ordered_incremental_map_$t$.get_entry((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_add_error_on_object_is_null(void **state) {
    assert_int_equal(ordered_incremental_map_$t$.add(NULL, (void *) 1, (void*) 1),
                     BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_add_error_on_key_is_null(void **state) {
    assert_int_equal(ordered_incremental_map_$t$.add((void *) 1, NULL, (void*) 1),
                     BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_KEY_IS_NULL);
}

static void check_add_error_on_value_is_null(void **state) {
    assert_int_equal(ordered_incremental_map_$t$.add((void *) 1,(void*) 1, NULL),
                     BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_VALUE_IS_NULL);
}
...
static void check_add_error_on_key_already_exists(void **state) {
    ...
    assert_int_equal(instance.id->add(&instance, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_KEY_ALREADY_EXISTS);
}
...
static void check_insert_error_on_object_is_null(void **state) {
    assert_int_equal(ordered_incremental_map_$t$.insert(NULL, (void *) 1,(void *) 1, (void *) 1),
                     BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_insert_error_on_key_is_null(void **state) {
    assert_int_equal(ordered_incremental_map_$t$.insert((void *) 1, NULL, (void *) 1,(void *) 1),
                     BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_KEY_IS_NULL);
}

static void check_insert_error_on_value_is_null(void **state) {
    assert_int_equal(ordered_incremental_map_$t$.insert((void *) 1,(void *) 1,NULL,(void *) 1),
                     BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_VALUE_IS_NULL);
}

static void check_insert_error_on_item_is_null(void **state) {
    assert_int_equal(ordered_incremental_map_$t$.insert((void *) 1, (void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_ITEM_IS_NULL);
}

static void check_insert_error_on_key_already_exists(void **state) {
    struct instance instance = {
            .id = &ordered_incremental_map_$t$,
    };
    expect_function_call(ordered_incremental_map_insert);
    will_return(ordered_incremental_map_insert,
                BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_KEY_ALREADY_EXISTS);
    assert_int_equal(instance.id->insert(&instance, (void *) 1, (void *) 1,(void *) 1),
                     BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_KEY_ALREADY_EXISTS);
}
...
static void check_keys(void **state) {
    assert_ptr_equal(ordered_incremental_map_$t$.keys, (void *) 1);
}

static void check_values(void **state) {
    assert_ptr_equal(ordered_incremental_map_$t$.values, (void *) 1);
}
...
int main(int argc, char *argv[]) {
    const struct CMUnitTest tests[] = {
            ...
            cmocka_unit_test(check_insert_error_on_key_is_null),
            ...
            cmocka_unit_test(check_insert_error_on_key_already_exists),
