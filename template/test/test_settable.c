...
static int
as_collection(const struct butterflyfish_settable_$t$ *const object,
...
static void check_as_stream_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_$t$_as_stream(NULL, (void *) 1),
            BUTTERFLYFISH_COLLECTION_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_as_stream_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_$t$_as_stream((void *) 1, NULL),
...
static void check_as_stream(void **state) {
    ...
    assert_int_equal(butterflyfish_settable_$t$_as_stream(
            (struct butterflyfish_settable_$t$ *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}

static void check_as_collection_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_$t$_as_collection(NULL, (void *) 1),
            BUTTERFLYFISH_SETTABLE_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_as_collection_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_$t$_as_collection((void *) 1, NULL),
            BUTTERFLYFISH_SETTABLE_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_as_collection(void **state) {
    ...
    assert_int_equal(butterflyfish_settable_$t$_as_collection(
            (struct butterflyfish_settable_$t$ *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_count_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_$t$_count(NULL, (void *) 1),
            BUTTERFLYFISH_SETTABLE_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_count_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_$t$_count((void *) 1, NULL),
            BUTTERFLYFISH_SETTABLE_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_count(void **state) {
    ...
    uintmax_t out;
    assert_int_equal(butterflyfish_settable_$t$_count(
            (const struct butterflyfish_settable_$t$ *) &instance, &out), 0);
...
static void check_first_error_on_collection_is_empty(void **state) {
    ...
    assert_int_equal(
            butterflyfish_settable_$t$_first(
                    (const struct butterflyfish_settable_$t$ *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_SETTABLE_$T$_ERROR_SETTABLE_IS_EMPTY);
}

static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_$t$_first(NULL, (void *) 1),
            BUTTERFLYFISH_SETTABLE_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_first_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_$t$_first((void *) 1, NULL),
            BUTTERFLYFISH_SETTABLE_$T$_ERROR_OUT_IS_NULL);
}

static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_$t$_last(NULL, (void *) 1),
            BUTTERFLYFISH_SETTABLE_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_last_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_$t$_last((void *) 1, NULL),
            BUTTERFLYFISH_SETTABLE_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_last_error_on_collection_is_empty(void **state) {
    ...
    assert_int_equal(
            butterflyfish_settable_$t$_last(
                    (const struct butterflyfish_settable_$t$ *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_SETTABLE_$T$_ERROR_SETTABLE_IS_EMPTY);
}
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_$t$_next(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SETTABLE_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_next_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_$t$_next((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SETTABLE_$T$_ERROR_ITEM_IS_NULL);
}

static void check_next_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_$t$_next((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SETTABLE_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_next_error_on_end_of_sequence(void **state) {
    ...
    assert_int_equal(
            butterflyfish_settable_$t$_next(
                    (const struct butterflyfish_settable_$t$ *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SETTABLE_$T$_ERROR_END_OF_SEQUENCE);
}

static void check_prev_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_$t$_prev(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SETTABLE_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_prev_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_$t$_prev((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SETTABLE_$T$_ERROR_ITEM_IS_NULL);
}

static void check_prev_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_$t$_prev((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SETTABLE_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_prev_error_on_end_of_sequence(void **state) {
    ...
    assert_int_equal(
            butterflyfish_settable_$t$_prev(
                    (const struct butterflyfish_settable_$t$ *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SETTABLE_$T$_ERROR_END_OF_SEQUENCE);
...
static void check_set_item_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_$t$_set_item(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_SETTABLE_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_set_item_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_$t$_set_item((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_SETTABLE_$T$_ERROR_ITEM_IS_NULL);
}

static void check_set_item_error_on_value_is_null(void **state) {
    assert_int_equal(
            butterflyfish_settable_$t$_set_item((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_SETTABLE_$T$_ERROR_VALUE_IS_NULL);
}
...
static void check_set_item_error_on_value_is_invalid(void **state) {
    ...
    assert_int_equal(
            butterflyfish_settable_$t$_set_item(
                    (struct butterflyfish_settable_$t$ *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_SETTABLE_$T$_ERROR_VALUE_IS_INVALID);
}
