...
struct instance {
    const struct butterflyfish_settable_incremental_set_$t$ *const id;
    void *data;
};

const struct butterflyfish_settable_incremental_set_$t$
...
static int stream_first(const void *const object,
    ...
    seagrass_required_true(&settable_incremental_set_$t$ == instance->id);
    return mock();
}
...
static void check_as_stream(void **state) {
    assert_ptr_equal(settable_incremental_set_$t$.as_stream, &stream_$t$);
}

static void check_as_collection(void **state) {
    assert_ptr_equal(settable_incremental_set_$t$.as_collection, &collection_$t$);
}

static void check_as_settable(void **state) {
    assert_ptr_equal(settable_incremental_set_$t$.as_settable, &settable_$t$);
}

static void check_as_set(void **state) {
    assert_ptr_equal(settable_incremental_set_$t$.as_set, &set_$t$);
}

static void check_as_addable(void **state) {
    assert_ptr_equal(settable_incremental_set_$t$.as_addable, &addable_$t$);
}

static void check_as_settable_set(void **state) {
    assert_ptr_equal(settable_incremental_set_$t$.as_settable_set, &settable_set_$t$);
}

static void check_as_incremental_set(void **state) {
    assert_ptr_equal(settable_incremental_set_$t$.as_incremental_set, &incremental_set_$t$);
}

static void check_count_error_on_object_is_null(void **state) {
    assert_int_equal(settable_incremental_set_$t$.count(NULL, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_count_error_on_out_is_null(void **state) {
    assert_int_equal(settable_incremental_set_$t$.count((void *) 1, NULL),
...
static void check_count(void **state) {
    ...
    struct instance instance = {
            .id = &settable_incremental_set_$t$,
    };
...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(settable_incremental_set_$t$.first(NULL, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_first_error_on_out_is_null(void **state) {
    assert_int_equal(settable_incremental_set_$t$.first((void *) 1, NULL),
                     BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(settable_incremental_set_$t$.last(NULL, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_last_error_on_out_is_null(void **state) {
    assert_int_equal(settable_incremental_set_$t$.last((void *) 1, NULL),
                     BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(settable_incremental_set_$t$.next(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_next_error_on_item_is_null(void **state) {
    assert_int_equal(settable_incremental_set_$t$.next((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_$T$_ERROR_ITEM_IS_NULL);
}

static void check_next_error_on_out_is_null(void **state) {
    assert_int_equal(settable_incremental_set_$t$.next((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_prev_error_on_object_is_null(void **state) {
    assert_int_equal(settable_incremental_set_$t$.prev(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_prev_error_on_item_is_null(void **state) {
    assert_int_equal(settable_incremental_set_$t$.prev((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_$T$_ERROR_ITEM_IS_NULL);
}

static void check_prev_error_on_out_is_null(void **state) {
    assert_int_equal(settable_incremental_set_$t$.prev((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_contains_error_on_object_is_null(void **state) {
    assert_int_equal(settable_incremental_set_$t$.contains(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_contains_error_on_value_is_null(void **state) {
    assert_int_equal(settable_incremental_set_$t$.contains((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_$T$_ERROR_VALUE_IS_NULL);
}

static void check_contains_error_on_out_is_null(void **state) {
    assert_int_equal(settable_incremental_set_$t$.contains((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_get_error_on_object_is_null(void **state) {
    assert_int_equal(settable_incremental_set_$t$.get(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_get_error_on_value_is_null(void **state) {
    assert_int_equal(settable_incremental_set_$t$.get((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_$T$_ERROR_VALUE_IS_NULL);
}

static void check_get_error_on_out_is_null(void **state) {
    assert_int_equal(settable_incremental_set_$t$.get((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_set_item_error_on_object_is_null(void **state) {
    assert_int_equal(settable_incremental_set_$t$.set_item(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_set_item_error_on_item_is_null(void **state) {
    assert_int_equal(settable_incremental_set_$t$.set_item((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_$T$_ERROR_ITEM_IS_NULL);
}

static void check_set_item_error_on_value_is_null(void **state) {
    assert_int_equal(settable_incremental_set_$t$.set_item((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_$T$_ERROR_VALUE_IS_NULL);
}
...
static void check_set_item_error_on_value_is_invalid(void **state) {
    ...
    assert_int_equal(settable_incremental_set_$t$.set_item(&instance, (void *) 1,(void *) 1),
...
static void check_set_error_on_object_is_null(void **state) {
    assert_int_equal(settable_incremental_set_$t$.set(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_set_error_on_item_is_null(void **state) {
    assert_int_equal(settable_incremental_set_$t$.set((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_$T$_ERROR_ITEM_IS_NULL);
}

static void check_set_error_on_value_is_null(void **state) {
    assert_int_equal(settable_incremental_set_$t$.set((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_$T$_ERROR_VALUE_IS_NULL);
}
...
static void check_add_error_on_object_is_null(void **state) {
    assert_int_equal(settable_incremental_set_$t$.add(NULL, (void *) 1),
                     BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_add_error_on_value_is_null(void **state) {
    assert_int_equal(settable_incremental_set_$t$.add((void *) 1, NULL),
                     BUTTERFLYFISH_SETTABLE_INCREMENTAL_SET_$T$_ERROR_VALUE_IS_NULL);
}
