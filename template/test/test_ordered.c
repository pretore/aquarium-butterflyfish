...
static int as_collection(const struct butterflyfish_ordered_$t$ *const object,
...
static void check_as_stream_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_$t$_as_stream(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_as_stream_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_$t$_as_stream((void *) 1, NULL),
...
static void check_as_stream(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_$t$_as_stream(
            (const struct butterflyfish_ordered_$t$ *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}

static void check_as_collection_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_$t$_as_collection(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_as_collection_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_$t$_as_collection((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_count_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_$t$_count(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_count_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_$t$_count((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_count(void **state) {
    ...
    uintmax_t out;
    assert_int_equal(butterflyfish_ordered_$t$_count(
            (const struct butterflyfish_ordered_$t$ *) &instance, &out), 0);
...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_$t$_first(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_first_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_$t$_first((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_first_error_on_ordered_is_empty(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_$t$_first(
                    (const struct butterflyfish_ordered_$t$ *) &instance,
                    (void *) 1),
...
static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_$t$_last(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_last_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_$t$_last((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_last_error_on_ordered_is_empty(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_$t$_last(
                    (const struct butterflyfish_ordered_$t$ *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_ORDERED_$T$_ERROR_ORDERED_IS_EMPTY);
}
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_$t$_next(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_next_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_$t$_next((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_$T$_ERROR_ITEM_IS_NULL);
}

static void check_next_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_$t$_next((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_next_error_on_end_of_sequence(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_$t$_next(
                    (const struct butterflyfish_ordered_$t$ *) &instance,
                    (void *) 1,
                    (void *) 1),
...
static void check_prev_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_$t$_prev(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_prev_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_$t$_prev((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_$T$_ERROR_ITEM_IS_NULL);
}

static void check_prev_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_$t$_prev((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_prev_error_on_end_of_sequence(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_$t$_prev(
                    (const struct butterflyfish_ordered_$t$ *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_ORDERED_$T$_ERROR_END_OF_SEQUENCE);
