...
static void check_as_stream_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_$t$_as_stream(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_as_stream_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_$t$_as_stream((void *) 1, NULL),
...
static void check_as_stream(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_map_$t$_as_stream(
            (const struct butterflyfish_ordered_map_$t$ *) &instance,
                    &out), 0);
...
static void check_as_collection_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_$t$_as_collection(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_as_collection_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_$t$_as_collection((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_as_collection(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_map_$t$_as_collection(
            (const struct butterflyfish_ordered_map_$t$ *) &instance, &out),
                    0);
    assert_ptr_equal(out, check);
}
...
static void check_as_set_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_$t$_as_set(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_as_set_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_$t$_as_set((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_as_set(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_map_$t$_as_set(
            (const struct butterflyfish_ordered_map_$t$ *) &instance, &out),
                    0);
    assert_ptr_equal(out, check);
}
...
static void check_as_ordered_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_$t$_as_ordered(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_as_ordered_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_$t$_as_ordered((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_as_ordered(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_map_$t$_as_ordered(
            (const struct butterflyfish_ordered_map_$t$ *) &instance, &out),
                     0);
    assert_ptr_equal(out, check);
}
...
static void check_as_map_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_$t$_as_map(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_as_map_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_$t$_as_map((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_as_map(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_map_$t$_as_map(
            (const struct butterflyfish_ordered_map_$t$ *) &instance, &out),
                     0);
    assert_ptr_equal(out, check);
}
...
static void check_count_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_$t$_count(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_count_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_$t$_count((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_count(void **state) {
    ...
    uintmax_t out;
    assert_int_equal(butterflyfish_ordered_map_$t$_count(
            (const struct butterflyfish_ordered_map_$t$ *) &instance, &out),
                    0);
...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_$t$_first(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_first_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_$t$_first((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_first_error_on_map_is_empty(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_map_$t$_first(
                    (const struct butterflyfish_ordered_map_$t$ *) &instance,
                    (void *) 1),
...
static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_$t$_last(NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_last_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_$t$_last((void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_last_error_on_map_is_empty(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_map_$t$_last(
                    (const struct butterflyfish_ordered_map_$t$ *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_$T$_ERROR_MAP_IS_EMPTY);
}
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_$t$_next(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_next_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_$t$_next((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_$T$_ERROR_ITEM_IS_NULL);
}

static void check_next_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_$t$_next((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_next_error_on_end_of_sequence(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_map_$t$_next(
                    (const struct butterflyfish_ordered_map_$t$ *) &instance,
                    (void *) 1,
                    (void *) 1),
...
static void check_prev_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_$t$_prev(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_prev_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_$t$_prev((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_$T$_ERROR_ITEM_IS_NULL);
}

static void check_prev_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_$t$_prev((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_prev_error_on_end_of_sequence(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_map_$t$_prev(
                    (const struct butterflyfish_ordered_map_$t$ *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_$T$_ERROR_END_OF_SEQUENCE);
...
static void check_contains_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_$t$_contains(
                    NULL, (void *) 1, (void*) 1),
            BUTTERFLYFISH_ORDERED_MAP_$T$_ERROR_OBJECT_IS_NULL);
}
...
static void check_contains_error_on_memory_allocation_failed(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_map_$t$_contains(
                    (struct butterflyfish_ordered_map_$t$ *) &instance,
                    (void *) 1,
                    (void *) 1),
...
static void check_contains_key_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_$t$_contains_key(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_$T$_ERROR_OBJECT_IS_NULL);
}
...
static void check_contains_value_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_$t$_contains_value(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_$T$_ERROR_OBJECT_IS_NULL);
}
...
static void check_contains_all_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_$t$_contains_all(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_$T$_ERROR_OBJECT_IS_NULL);
}
...
static void check_contains_all_keys_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_$t$_contains_all_keys(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_$T$_ERROR_OBJECT_IS_NULL);
}
...
static void check_contains_all_values_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_$t$_contains_all_values(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_$T$_ERROR_OBJECT_IS_NULL);
}
...
static void check_get_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_$t$_get(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_get_error_on_entry_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_$t$_get((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_$T$_ERROR_ENTRY_IS_NULL);
}

static void check_get_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_$t$_get((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_ORDERED_MAP_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_get_error_on_entry_not_found(void **state) {
    ...
    assert_int_equal(
            butterflyfish_ordered_map_$t$_get(
                    (struct butterflyfish_ordered_map_$t$ *) &instance,
                    (void *) 1,
                    (void *) 1),
...
static void check_get_value_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_$t$_get_value(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_$T$_ERROR_OBJECT_IS_NULL);
}
...
static void check_get_entry_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_ordered_map_$t$_get_entry(
                    NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_ORDERED_MAP_$T$_ERROR_OBJECT_IS_NULL);
}
...
static void check_keys_error_on_object_is_null(void **state) {
    assert_int_equal(butterflyfish_ordered_map_$t$_keys(NULL, (void *) 1),
                     BUTTERFLYFISH_MAP_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_keys_error_on_out_is_null(void **state) {
    assert_int_equal(butterflyfish_ordered_map_$t$_keys((void *) 1, NULL),
...
static void check_keys(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_map_$t$_keys(
            (struct butterflyfish_ordered_map_$t$ *) &instance, &out), 0);
}
...
static void check_as_map_keys(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_map_$t$_as_map(
            (const struct butterflyfish_ordered_map_$t$ *)
                    &instance, &as), 0);
...
static void check_values_error_on_object_is_null(void **state) {
    assert_int_equal(butterflyfish_ordered_map_$t$_values(NULL, (void *) 1),
                     BUTTERFLYFISH_ORDERED_MAP_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_values_error_on_out_is_null(void **state) {
    assert_int_equal(butterflyfish_ordered_map_$t$_values((void *) 1, NULL),
                     BUTTERFLYFISH_ORDERED_MAP_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_values(void **state) {
    ...
    assert_int_equal(butterflyfish_ordered_map_$t$_values(
            (struct butterflyfish_ordered_map_$t$ *) &instance, &out), 0);
}
...
static void check_as_map_values(void **state) {
    ...
    const struct butterflyfish_map_$t$ *as;
    assert_int_equal(butterflyfish_ordered_map_$t$_as_map(
            (struct butterflyfish_ordered_map_$t$ *) &instance, &as), 0);
    const struct butterflyfish_ordered_list_$mvt$ *out;
