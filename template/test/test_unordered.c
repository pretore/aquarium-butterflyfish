...
struct object {
    const struct butterflyfish_unordered_$t$ *const unordered_$t$;
...
static int as_collection(const struct butterflyfish_unordered_$t$ *const object,
                         const struct butterflyfish_collection_$t$ **const out) {
    assert_non_null(object);
    assert_non_null(out);
    *out = butterflyfish_cast(object, struct object, unordered_$t$, collection_$t$);
    return 0;
}

const struct butterflyfish_unordered_$t$ unordered_$t$ = {
        .as_collection = as_collection,
};

static void check_as_stream_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_unordered_$t$_as_stream(NULL, (void *) 1),
            BUTTERFLYFISH_UNORDERED_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_as_stream_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_unordered_$t$_as_stream((void *) 1, NULL),
            BUTTERFLYFISH_UNORDERED_$T$_ERROR_OUT_IS_NULL);
}

static void check_as_stream(void **state) {
    const struct object instance = {
            .unordered_$t$ = &unordered_$t$,
    ...
    assert_int_equal(butterflyfish_unordered_$t$_as_stream(
            (const struct butterflyfish_unordered_$t$ *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}

static void check_as_collection_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_unordered_$t$_as_collection(NULL, (void *) 1),
            BUTTERFLYFISH_UNORDERED_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_as_collection_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_unordered_$t$_as_collection((void *) 1, NULL),
            BUTTERFLYFISH_UNORDERED_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_as_collection(void **state) {
    ...
    assert_int_equal(butterflyfish_unordered_$t$_as_collection(
            (const struct butterflyfish_unordered_$t$ *) &instance, &out), 0);
    assert_ptr_equal(out, check);
}
...
static void check_count_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_unordered_$t$_count(NULL, (void *) 1),
            BUTTERFLYFISH_UNORDERED_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_count_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_unordered_$t$_count((void *) 1, NULL),
            BUTTERFLYFISH_UNORDERED_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_count(void **state) {
    ...
    uintmax_t out;
    assert_int_equal(butterflyfish_unordered_$t$_count(
            (const struct butterflyfish_unordered_$t$ *) &instance, &out), 0);
...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_unordered_$t$_first(NULL, (void *) 1),
            BUTTERFLYFISH_UNORDERED_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_first_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_unordered_$t$_first((void *) 1, NULL),
            BUTTERFLYFISH_UNORDERED_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_first_error_on_unordered_is_empty(void **state) {
    ...
    assert_int_equal(
            butterflyfish_unordered_$t$_first(
                    (const struct butterflyfish_unordered_$t$ *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_UNORDERED_$T$_ERROR_UNORDERED_IS_EMPTY);
}

static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_unordered_$t$_last(NULL, (void *) 1),
            BUTTERFLYFISH_UNORDERED_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_last_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_unordered_$t$_last((void *) 1, NULL),
            BUTTERFLYFISH_UNORDERED_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_last_error_on_unordered_is_empty(void **state) {
    ...
    assert_int_equal(
            butterflyfish_unordered_$t$_last(
                    (const struct butterflyfish_unordered_$t$ *) &instance,
                    (void *) 1),
            BUTTERFLYFISH_UNORDERED_$T$_ERROR_UNORDERED_IS_EMPTY);
}
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_unordered_$t$_next(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_UNORDERED_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_next_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_unordered_$t$_next((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_UNORDERED_$T$_ERROR_ITEM_IS_NULL);
}

static void check_next_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_unordered_$t$_next((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_UNORDERED_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_next_error_on_end_of_sequence(void **state) {
    ...
    assert_int_equal(
            butterflyfish_unordered_$t$_next(
                    (const struct butterflyfish_unordered_$t$ *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_UNORDERED_$T$_ERROR_END_OF_SEQUENCE);
}

static void check_prev_error_on_object_is_null(void **state) {
    assert_int_equal(
            butterflyfish_unordered_$t$_prev(NULL, (void *) 1, (void *) 1),
            BUTTERFLYFISH_UNORDERED_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_prev_error_on_item_is_null(void **state) {
    assert_int_equal(
            butterflyfish_unordered_$t$_prev((void *) 1, NULL, (void *) 1),
            BUTTERFLYFISH_UNORDERED_$T$_ERROR_ITEM_IS_NULL);
}

static void check_prev_error_on_out_is_null(void **state) {
    assert_int_equal(
            butterflyfish_unordered_$t$_prev((void *) 1, (void *) 1, NULL),
            BUTTERFLYFISH_UNORDERED_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_prev_error_on_end_of_sequence(void **state) {
    ...
    assert_int_equal(
            butterflyfish_unordered_$t$_prev(
                    (const struct butterflyfish_unordered_$t$ *) &instance,
                    (void *) 1,
                    (void *) 1),
            BUTTERFLYFISH_UNORDERED_$T$_ERROR_END_OF_SEQUENCE);
