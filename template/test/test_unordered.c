...
struct instance {
    const struct butterflyfish_unordered_$t$ *const id;
    void *data;
};
...
static int stream_first(const void *const object,
    ...
    seagrass_required_true(&unordered_$t$ == instance->id);
    return mock();
}
...
static void check_as_stream(void **state) {
    assert_ptr_equal(unordered_$t$.as_stream, &stream_$t$);
}

static void check_as_collection(void **state) {
    assert_ptr_equal(unordered_$t$.as_collection, &collection_$t$);
}

static void check_count_error_on_object_is_null(void **state) {
    assert_int_equal(unordered_$t$.count(NULL, (void *) 1),
                     BUTTERFLYFISH_UNORDERED_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_count_error_on_out_is_null(void **state) {
    assert_int_equal(unordered_$t$.count((void *) 1, NULL),
...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(unordered_$t$.first(NULL, (void *) 1),
                     BUTTERFLYFISH_UNORDERED_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_first_error_on_out_is_null(void **state) {
    assert_int_equal(unordered_$t$.first((void *) 1, NULL),
                     BUTTERFLYFISH_UNORDERED_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(unordered_$t$.last(NULL, (void *) 1),
                     BUTTERFLYFISH_UNORDERED_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_last_error_on_out_is_null(void **state) {
    assert_int_equal(unordered_$t$.last((void *) 1, NULL),
                     BUTTERFLYFISH_UNORDERED_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_next_error_on_object_is_null(void **state) {
    assert_int_equal(unordered_$t$.next(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_UNORDERED_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_next_error_on_item_is_null(void **state) {
    assert_int_equal(unordered_$t$.next((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_UNORDERED_$T$_ERROR_ITEM_IS_NULL);
}

static void check_next_error_on_out_is_null(void **state) {
    assert_int_equal(unordered_$t$.next((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_UNORDERED_$T$_ERROR_OUT_IS_NULL);
}
...
static void check_prev_error_on_object_is_null(void **state) {
    assert_int_equal(unordered_$t$.prev(NULL, (void *) 1, (void *) 1),
                     BUTTERFLYFISH_UNORDERED_$T$_ERROR_OBJECT_IS_NULL);
}

static void check_prev_error_on_item_is_null(void **state) {
    assert_int_equal(unordered_$t$.prev((void *) 1, NULL, (void *) 1),
                     BUTTERFLYFISH_UNORDERED_$T$_ERROR_ITEM_IS_NULL);
}

static void check_prev_error_on_out_is_null(void **state) {
    assert_int_equal(unordered_$t$.prev((void *) 1, (void *) 1, NULL),
                     BUTTERFLYFISH_UNORDERED_$T$_ERROR_OUT_IS_NULL);
}
