...
static inline int
as_settable_map(struct butterflyfish_settable_reducible_map_$t$ *const object,
...
static inline int
as_reducible_map(struct butterflyfish_settable_reducible_map_$t$ *const object,
...
static inline int
as_map(const struct butterflyfish_settable_reducible_map_$t$ *const object,
...
static inline int
as_removable(
        const struct butterflyfish_settable_reducible_map_$t$ *const object,
...
static inline int
as_settable(struct butterflyfish_settable_reducible_map_$t$ *const object,
...
static inline int
as_set(const struct butterflyfish_settable_reducible_map_$t$ *const object,
...
static inline int
as_stream(const struct butterflyfish_settable_reducible_map_$t$ *const object,
...
int butterflyfish_settable_reducible_map_$t$_first(
        ...
        const $v$*const out) {
    if (!object) {
        return BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_OBJECT_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_settable_reducible_map_$t$_next(
    ...
    if (!item) {
        return BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_ITEM_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_settable_reducible_map_$t$_remove_entry(
    ...
    if (!entry) {
        return BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_ENTRY_IS_NULL;
    }
...
int butterflyfish_settable_reducible_map_$t$_remove_all_entries(
    ...
    if (!other) {
        return BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_OTHER_IS_NULL;
    }
    struct butterflyfish_removable_$t$ *removable;
    seagrass_required_true(!as_removable(object, &removable));
...
int butterflyfish_settable_reducible_map_$t$_contains_key(
    ...
    if (!key) {
        return BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_KEY_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_settable_reducible_map_$t$_contains_value(
    ...
    if (!value) {
        return BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_VALUE_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SETTABLE_REDUCIBLE_MAP_$T$_ERROR_OUT_IS_NULL;
    }
...
#pragma mark settable_reducible_map_$t$ -
