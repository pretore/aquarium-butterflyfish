...
#define INVOKE(x) \\
    (*(struct butterflyfish_sorted_reducible_map_$t$ **) x)
#define INVOKE_REDUCIBLE_MAP(x) \\
    (*(struct butterflyfish_reducible_map_$t$ **) x)
#define INVOKE_SORTED_MAP(x)    (*(struct butterflyfish_sorted_map_$t$ **) x)
...
as_sorted_map(
    ...
    assert(object);
    assert(out);
    return INVOKE(object)->as_sorted_map(object, out);
}

static inline int
as_removable(struct butterflyfish_sorted_reducible_map_$t$ *const object,
...
static inline int
as_map(const struct butterflyfish_sorted_reducible_map_$t$ *const object,
       const struct butterflyfish_map_$t$ **const out) {
    assert(object);
    assert(out);
    struct butterflyfish_reducible_map_$t$ *reducible_map;
    seagrass_required_true(!as_reducible_map(
            (void *) object, &reducible_map));
    return INVOKE_REDUCIBLE_MAP(reducible_map)->as_map(reducible_map, out);
}

static inline int
as_sorted(const struct butterflyfish_sorted_reducible_map_$t$ *const object,
...
static inline int
as_set(const struct butterflyfish_sorted_reducible_map_$t$ *const object,
...
static inline int
as_stream(const struct butterflyfish_sorted_reducible_map_$t$ *const object,
...
int butterflyfish_sorted_reducible_map_$t$_first(
        ...
        const $v$*const out) {
    if (!object) {
        return BUTTERFLYFISH_SORTED_REDUCIBLE_MAP_$T$_ERROR_OBJECT_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SORTED_REDUCIBLE_MAP_$T$_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_sorted_reducible_map_$t$_next(
    ...
    if (!item) {
        return BUTTERFLYFISH_SORTED_REDUCIBLE_MAP_$T$_ERROR_ITEM_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SORTED_REDUCIBLE_MAP_$T$_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_sorted_reducible_map_$t$_remove_entry(
    ...
    if (!entry) {
        return BUTTERFLYFISH_SORTED_REDUCIBLE_MAP_$T$_ERROR_ENTRY_IS_NULL;
    }
...
int butterflyfish_sorted_reducible_map_$t$_remove_all_entries(
    ...
    if (!other) {
        return BUTTERFLYFISH_SORTED_REDUCIBLE_MAP_$T$_ERROR_OTHER_IS_NULL;
    }
    struct butterflyfish_removable_$t$ *removable;
    seagrass_required_true(!as_removable(object, &removable));
...
int butterflyfish_sorted_reducible_map_$t$_contains_key(
    ...
    if (!key) {
        return BUTTERFLYFISH_SORTED_REDUCIBLE_MAP_$T$_ERROR_KEY_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SORTED_REDUCIBLE_MAP_$T$_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_sorted_reducible_map_$t$_contains_value(
    ...
    if (!value) {
        return BUTTERFLYFISH_SORTED_REDUCIBLE_MAP_$T$_ERROR_VALUE_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SORTED_REDUCIBLE_MAP_$T$_ERROR_OUT_IS_NULL;
    }
...
#pragma mark sorted_reducible_map_$t$ -
