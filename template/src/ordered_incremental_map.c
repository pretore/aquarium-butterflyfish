...
static inline int
as_addable(struct butterflyfish_ordered_incremental_map_$t$ *const object,
...
static inline int
as_map(const struct butterflyfish_ordered_incremental_map_$t$ *const object,
...
static inline int
as_set(const struct butterflyfish_ordered_incremental_map_$t$ *const object,
...
static inline int
as_stream(const struct butterflyfish_ordered_incremental_map_$t$ *const object,
...
int butterflyfish_ordered_incremental_map_$t$_first(
    ...
    if (!out) {
        return BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_ordered_incremental_map_$t$_contains(
    ...
    if (!entry) {
        return BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_ENTRY_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_ordered_incremental_map_$t$_contains_all(
    ...
    if (!other) {
        return BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_OTHER_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_ORDERED_INCREMENTAL_MAP_$T$_ERROR_OUT_IS_NULL;
    }
...
#pragma mark ordered_incremental_map_$t$ -
