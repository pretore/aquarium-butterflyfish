...
static inline int
as_settable(struct butterflyfish_settable_incremental_list_$t$ *const object,
...
static inline int
as_list(const struct butterflyfish_settable_incremental_list_$t$ *const object,
...
static inline int
as_addable(struct butterflyfish_settable_incremental_list_$t$ *const object,
...
static inline int
as_collection(
        const struct butterflyfish_settable_incremental_list_$t$ *const object,
...
static inline int
as_stream(const struct butterflyfish_settable_incremental_list_$t$ *const object,
...
int butterflyfish_settable_incremental_list_$t$_first(
        ...
        const $v$*const out) {
    if (!object) {
        return BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_$T$_ERROR_OBJECT_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_$T$_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_settable_incremental_list_$t$_next(
    ...
    if (!item) {
        return BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_$T$_ERROR_ITEM_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_$T$_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_settable_incremental_list_$t$_set_item(
    ...
    if (!value) {
        return BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_$T$_ERROR_VALUE_IS_NULL;
    }
    struct butterflyfish_settable_$t$ *settable;
...
int butterflyfish_settable_incremental_list_$t$_add_all(
    ...
    if (!other) {
        return BUTTERFLYFISH_SETTABLE_INCREMENTAL_LIST_$T$_ERROR_OTHER_IS_NULL;
    }
    struct butterflyfish_addable_$t$ *addable;
    seagrass_required_true(!as_addable(object, &addable));
...
#pragma mark settable_incremental_$t$ -
