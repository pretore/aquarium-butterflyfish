...
static inline int
as_settable_map(struct butterflyfish_sorted_settable_map_$t$ *const object,
...
static inline int
as_sorted_map(const struct butterflyfish_sorted_settable_map_$t$ *const object,
...
static inline int
as_map(const struct butterflyfish_sorted_settable_map_$t$ *const object,
...
static inline int
as_sorted(const struct butterflyfish_sorted_settable_map_$t$ *const object,
...
static inline int
as_settable(struct butterflyfish_sorted_settable_map_$t$ *const object,
...
static inline int
as_set(const struct butterflyfish_sorted_settable_map_$t$ *const object,
...
static inline int
as_collection(const struct butterflyfish_sorted_settable_map_$t$ *const object,
...
static inline int
as_stream(const struct butterflyfish_sorted_settable_map_$t$ *const object,
...
int butterflyfish_sorted_settable_map_$t$_first(
        ...
        const $v$*const out) {
    if (!object) {
        return BUTTERFLYFISH_SORTED_SETTABLE_MAP_$T$_ERROR_OBJECT_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SORTED_SETTABLE_MAP_$T$_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_sorted_settable_map_$t$_next(
    ...
    if (!item) {
        return BUTTERFLYFISH_SORTED_SETTABLE_MAP_$T$_ERROR_ITEM_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SORTED_SETTABLE_MAP_$T$_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_sorted_settable_map_$t$_contains(
    ...
    if (!entry) {
        return BUTTERFLYFISH_SORTED_SETTABLE_MAP_$T$_ERROR_ENTRY_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SORTED_SETTABLE_MAP_$T$_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_sorted_settable_map_$t$_contains_all(
    ...
    if (!other) {
        return BUTTERFLYFISH_SORTED_SETTABLE_MAP_$T$_ERROR_OTHER_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SORTED_SETTABLE_MAP_$T$_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_sorted_settable_map_$t$_contains_key(
    ...
    if (!key) {
        return BUTTERFLYFISH_SORTED_SETTABLE_MAP_$T$_ERROR_KEY_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SORTED_SETTABLE_MAP_$T$_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_sorted_settable_map_$t$_contains_value(
    ...
    if (!value) {
        return BUTTERFLYFISH_SORTED_SETTABLE_MAP_$T$_ERROR_VALUE_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SORTED_SETTABLE_MAP_$T$_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_sorted_settable_map_$t$_ceiling(
        ...
        const $v$*const out) {
    if (!object) {
        return BUTTERFLYFISH_SORTED_MAP_$T$_ERROR_OBJECT_IS_NULL;
    }
    if (!key) {
        return BUTTERFLYFISH_SORTED_MAP_$T$_ERROR_KEY_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SORTED_MAP_$T$_ERROR_OUT_IS_NULL;
    }
    const struct butterflyfish_sorted_map_$t$ *sorted_map;
    seagrass_required_true(!as_sorted_map(object, &sorted_map));
...
#pragma mark sorted_settable_map_$t$ -
