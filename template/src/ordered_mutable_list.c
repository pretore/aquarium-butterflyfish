...
#define INVOKE(x) \\
    (*(struct butterflyfish_ordered_mutable_list_$t$ **) x)
#define INVOKE_ORDERED_SETTABLE_INCREMENTAL_LIST(x) \\
    (*(struct butterflyfish_ordered_settable_incremental_list_$t$ **) x)
#define INVOKE_ORDERED_SETTABLE_REDUCIBLE_LIST(x) \\
    (*(struct butterflyfish_ordered_settable_reducible_list_$t$ **) x)
...
#define INVOKE_ORDERED_REDUCIBLE_LIST(x) \\
    (*(struct butterflyfish_ordered_reducible_list_$t$ **) x)
#define INVOKE_MUTABLE_LIST(x) \\
    (*(struct butterflyfish_mutable_list_$t$ **) x)
#define INVOKE_ORDERED_LIST(x) \\
    (*(struct butterflyfish_ordered_list_$t$ **) x)
#define INVOKE_SETTABLE_INCREMENTAL_LIST(x) \\
    (*(struct butterflyfish_settable_incremental_list_$t$ **) x)
...
static inline int
as_mutable_list(struct butterflyfish_ordered_mutable_list_$t$ *const object,
...
static inline int
as_ordered_list(
        const struct butterflyfish_ordered_mutable_list_$t$ *const object,
        const struct butterflyfish_ordered_list_$t$ **const out) {
    assert(object);
    assert(out);
    struct butterflyfish_ordered_settable_list_$t$ *ordered_settable_list;
...
as_settable_incremental_list(
    ...
    assert(object);
    assert(out);
    struct butterflyfish_mutable_list_$t$ *mutable_list;
...
static inline int
as_settable_list(struct butterflyfish_ordered_mutable_list_$t$ *const object,
...
static inline int
as_incremental_list(struct butterflyfish_ordered_mutable_list_$t$ *const object,
                    struct butterflyfish_incremental_list_$t$ **const out) {
    assert(object);
    assert(out);
    struct butterflyfish_ordered_incremental_list_$t$ *ordered_incremental_list;
...
static inline int
as_reducible_list(struct butterflyfish_ordered_mutable_list_$t$ *const object,
                  struct butterflyfish_reducible_list_$t$ **const out) {
    assert(object);
    assert(out);
    struct butterflyfish_ordered_reducible_list_$t$ *ordered_reducible_list;
...
static inline int
as_list(const struct butterflyfish_ordered_mutable_list_$t$ *const object,
...
static inline int
as_removable(struct butterflyfish_ordered_mutable_list_$t$ *const object,
...
static inline int
as_addable(struct butterflyfish_ordered_mutable_list_$t$ *const object,
...
static inline int
as_settable(struct butterflyfish_ordered_mutable_list_$t$ *const object,
...
static inline int
as_ordered(const struct butterflyfish_ordered_mutable_list_$t$ *const object,
...
static inline int
as_insertable(struct butterflyfish_ordered_mutable_list_$t$ *const object,
...
static inline int
as_collection(const struct butterflyfish_ordered_mutable_list_$t$ *const object,
...
static inline int
as_stream(const struct butterflyfish_ordered_mutable_list_$t$ *const object,
...
int butterflyfish_ordered_mutable_list_$t$_first(
        ...
        const $v$*const out) {
    if (!object) {
        return BUTTERFLYFISH_ORDERED_MUTABLE_LIST_$T$_ERROR_OBJECT_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_ORDERED_MUTABLE_LIST_$T$_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_ordered_mutable_list_$t$_next(
    ...
    if (!item) {
        return BUTTERFLYFISH_ORDERED_MUTABLE_LIST_$T$_ERROR_ITEM_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_ORDERED_MUTABLE_LIST_$T$_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_ordered_mutable_list_$t$_set_item(
    ...
    if (!value) {
        return BUTTERFLYFISH_ORDERED_MUTABLE_LIST_$T$_ERROR_VALUE_IS_NULL;
    }
...
int butterflyfish_ordered_mutable_list_$t$_add_all(
    ...
    if (!other) {
        return BUTTERFLYFISH_ORDERED_MUTABLE_LIST_$T$_ERROR_OTHER_IS_NULL;
    }
    struct butterflyfish_addable_$t$ *addable;
    seagrass_required_true(!as_addable(object, &addable));
