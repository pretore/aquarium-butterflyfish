...
#define INVOKE_ORDERED_MAP(x)   (*(struct butterflyfish_ordered_map_$t$ **) x)
...
static inline int
as_reducible_map(struct butterflyfish_ordered_reducible_map_$t$ *const object,
...
static inline int
as_ordered(const struct butterflyfish_ordered_reducible_map_$t$ *const object,
...
static inline int
as_removable(struct butterflyfish_ordered_reducible_map_$t$ *const object,
...
static inline int
as_map(const struct butterflyfish_ordered_reducible_map_$t$ *const object,
...
static inline int
as_set(const struct butterflyfish_ordered_reducible_map_$t$ *const object,
...
static inline int
as_stream(const struct butterflyfish_ordered_reducible_map_$t$ *const object,
...
int butterflyfish_ordered_reducible_map_$t$_first(
        ...
        const $v$*const out) {
    if (!object) {
        return BUTTERFLYFISH_ORDERED_REDUCIBLE_MAP_$T$_ERROR_OBJECT_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_ORDERED_REDUCIBLE_MAP_$T$_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_ordered_reducible_map_$t$_next(
    ...
    if (!item) {
        return BUTTERFLYFISH_ORDERED_REDUCIBLE_MAP_$T$_ERROR_ITEM_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_ORDERED_REDUCIBLE_MAP_$T$_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_ordered_reducible_map_$t$_contains(
    ...
    if (!entry) {
        return BUTTERFLYFISH_ORDERED_REDUCIBLE_MAP_$T$_ERROR_ENTRY_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_ORDERED_REDUCIBLE_MAP_$T$_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_ordered_reducible_map_$t$_contains_all(
    ...
    if (!other) {
        return BUTTERFLYFISH_ORDERED_REDUCIBLE_MAP_$T$_ERROR_OTHER_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_ORDERED_REDUCIBLE_MAP_$T$_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_ordered_reducible_map_$t$_contains_key(
    ...
    if (!key) {
        return BUTTERFLYFISH_ORDERED_REDUCIBLE_MAP_$T$_ERROR_KEY_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_ORDERED_REDUCIBLE_MAP_$T$_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_ordered_reducible_map_$t$_contains_value(
    ...
    if (!value) {
        return BUTTERFLYFISH_ORDERED_REDUCIBLE_MAP_$T$_ERROR_VALUE_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_ORDERED_REDUCIBLE_MAP_$T$_ERROR_OUT_IS_NULL;
    }
...
#pragma mark ordered_reducible_map_$t$ -
