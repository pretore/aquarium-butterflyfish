...
static inline int
as_stream(const struct butterflyfish_unordered_$t$ *const object,
...
int butterflyfish_unordered_$t$_first(
        const struct butterflyfish_unordered_$t$ *const object,
        const $v$*const out) {
    if (!object) {
        return BUTTERFLYFISH_UNORDERED_$T$_ERROR_OBJECT_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_UNORDERED_$T$_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_unordered_$t$_next(
    ...
    if (!item) {
        return BUTTERFLYFISH_UNORDERED_$T$_ERROR_ITEM_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_UNORDERED_$T$_ERROR_OUT_IS_NULL;
    }
