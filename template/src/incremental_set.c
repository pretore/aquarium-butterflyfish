...
#define INVOKE(x)               (*(struct butterflyfish_incremental_set_$t$ **) x)
...
static inline int
as_addable(struct butterflyfish_incremental_set_$t$ *const object,
...
static inline int
as_set(const struct butterflyfish_incremental_set_$t$ *const object,
...
static inline int
as_collection(const struct butterflyfish_incremental_set_$t$ *const object,
...
static inline int
as_stream(const struct butterflyfish_incremental_set_$t$ *const object,
...
int butterflyfish_incremental_set_$t$_first(
        ...
        const $v$*const out) {
    if (!object) {
        return BUTTERFLYFISH_INCREMENTAL_SET_$T$_ERROR_OBJECT_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_INCREMENTAL_SET_$T$_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_incremental_set_$t$_next(
    ...
    if (!item) {
        return BUTTERFLYFISH_INCREMENTAL_SET_$T$_ERROR_ITEM_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_INCREMENTAL_SET_$T$_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_incremental_set_$t$_contains(
    ...
    if (!value) {
        return BUTTERFLYFISH_INCREMENTAL_SET_$T$_ERROR_VALUE_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_INCREMENTAL_SET_$T$_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_incremental_set_$t$_contains_all(
    ...
    if (!other) {
        return BUTTERFLYFISH_INCREMENTAL_SET_$T$_ERROR_OTHER_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_INCREMENTAL_SET_$T$_ERROR_OUT_IS_NULL;
    }
...
#pragma mark incremental_set_$t$ -
