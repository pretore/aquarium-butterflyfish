...
#define INVOKE(x)               (*(struct butterflyfish_sorted_map_$t$ **) x)
...
static inline int
as_map(const struct butterflyfish_sorted_map_$t$ *const object,
...
static inline int
as_sorted(const struct butterflyfish_sorted_map_$t$ *const object,
...
static inline int
as_set(const struct butterflyfish_sorted_map_$t$ *const object,
...
static inline int
as_collection(const struct butterflyfish_sorted_map_$t$ *const object,
...
static inline int
as_stream(const struct butterflyfish_sorted_map_$t$ *const object,
...
int butterflyfish_sorted_map_$t$_first(
        const struct butterflyfish_sorted_map_$t$ *const object,
        const $v$*const out) {
    if (!object) {
...
int butterflyfish_sorted_map_$t$_next(
    ...
    if (!item) {
        return BUTTERFLYFISH_SORTED_MAP_$T$_ERROR_ITEM_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SORTED_MAP_$T$_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_sorted_map_$t$_contains(
    ...
    if (!entry) {
        return BUTTERFLYFISH_SORTED_MAP_$T$_ERROR_ENTRY_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SORTED_MAP_$T$_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_sorted_map_$t$_contains_all(
    ...
    if (!other) {
        return BUTTERFLYFISH_SORTED_MAP_$T$_ERROR_OTHER_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SORTED_MAP_$T$_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_sorted_map_$t$_contains_value(
    ...
    if (!value) {
        return BUTTERFLYFISH_SORTED_MAP_$T$_ERROR_VALUE_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SORTED_MAP_$T$_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_sorted_map_$t$_ceiling(
    ...
    return INVOKE(object)->ceiling(object, key, out);
}
...
int butterflyfish_sorted_map_$t$_floor(
    ...
    return INVOKE(object)->floor(object, key, out);
}
...
int butterflyfish_sorted_map_$t$_higher(
    ...
    return INVOKE(object)->higher(object, key, out);
}
...
int butterflyfish_sorted_map_$t$_lower(
    ...
    return INVOKE(object)->lower(object, key, out);
}
