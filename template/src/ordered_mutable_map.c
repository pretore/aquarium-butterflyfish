...
#define INVOKE(x) \\
    (*(struct butterflyfish_ordered_mutable_map_$t$ **) x)
...
#define INVOKE_MUTABLE_MAP(x) \\
    (*(struct butterflyfish_mutable_map_$t$ **) x)
...
as_ordered_settable_map(
    ...
    assert(object);
    assert(out);
    struct butterflyfish_ordered_settable_incremental_map_$t$ *map;
...
as_ordered_reducible_map(
    ...
    assert(object);
    assert(out);
    struct butterflyfish_ordered_settable_reducible_map_$t$ *map;
...
static inline int
as_ordered_map(const struct butterflyfish_ordered_mutable_map_$t$ *const object,
               const struct butterflyfish_ordered_map_$t$ **const out) {
    assert(object);
    assert(out);
    struct butterflyfish_ordered_settable_map_$t$ *map;
...
static inline int
as_settable_map(struct butterflyfish_ordered_mutable_map_$t$ *const object,
...
static inline int
as_incremental_map(struct butterflyfish_ordered_mutable_map_$t$ *const object,
...
static inline int
as_reducible_map(struct butterflyfish_ordered_mutable_map_$t$ *const object,
                 struct butterflyfish_reducible_map_$t$ **const out) {
    assert(object);
    assert(out);
    struct butterflyfish_ordered_reducible_map_$t$ *map;
...
static inline int
as_map(const struct butterflyfish_ordered_mutable_map_$t$ *const object,
       const struct butterflyfish_map_$t$ **const out) {
    assert(object);
    assert(out);
    const struct butterflyfish_ordered_map_$t$ *map;
    seagrass_required_true(!as_ordered_map(object, &map));
    return INVOKE_ORDERED_MAP(map)->as_map(map, out);
}

static inline int
as_insertable(struct butterflyfish_ordered_mutable_map_$t$ *const object,
...
static inline int
as_ordered(const struct butterflyfish_ordered_mutable_map_$t$ *const object,
...
static inline int
as_collection(const struct butterflyfish_ordered_mutable_map_$t$ *const object,
...
static inline int
as_stream(const struct butterflyfish_ordered_mutable_map_$t$ *const object,
...
int butterflyfish_ordered_mutable_map_$t$_first(
        const struct butterflyfish_ordered_mutable_map_$t$ *const object,
        const $v$*const out) {
    if (!object) {
        return BUTTERFLYFISH_ORDERED_MUTABLE_MAP_$T$_ERROR_OBJECT_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_ORDERED_MUTABLE_MAP_$T$_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_ordered_mutable_map_$t$_next(
    ...
    if (!item) {
        return BUTTERFLYFISH_ORDERED_MUTABLE_MAP_$T$_ERROR_ITEM_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_ORDERED_MUTABLE_MAP_$T$_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_ordered_mutable_map_$t$_contains(
    ...
    if (!entry) {
        return BUTTERFLYFISH_ORDERED_MUTABLE_MAP_$T$_ERROR_ENTRY_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_ORDERED_MUTABLE_MAP_$T$_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_ordered_mutable_map_$t$_contains_all(
    ...
    if (!other) {
        return BUTTERFLYFISH_ORDERED_MUTABLE_MAP_$T$_ERROR_OTHER_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_ORDERED_MUTABLE_MAP_$T$_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_ordered_mutable_map_$t$_contains_key(
    ...
    if (!key) {
        return BUTTERFLYFISH_ORDERED_MUTABLE_MAP_$T$_ERROR_KEY_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_ORDERED_MUTABLE_MAP_$T$_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_ordered_mutable_map_$t$_contains_value(
    ...
    if (!value) {
        return BUTTERFLYFISH_ORDERED_MUTABLE_MAP_$T$_ERROR_VALUE_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_ORDERED_MUTABLE_MAP_$T$_ERROR_OUT_IS_NULL;
    }
...
#pragma mark ordered_mutable_map_$t$ -
...
int butterflyfish_ordered_mutable_map_$t$_as_ordered_settable_incremental_map(
        struct butterflyfish_ordered_mutable_map_$t$ *const object,
        struct butterflyfish_ordered_settable_incremental_map_$t$ **const out) {
    if (!object) {
        return BUTTERFLYFISH_ORDERED_MUTABLE_MAP_$T$_ERROR_OBJECT_IS_NULL;
    }
    if (!out) {
