...
#define INVOKE(x)               (*(struct butterflyfish_settable_map_$t$ **) x)
...
static inline int
as_map(const struct butterflyfish_settable_map_$t$ *const object,
...
static inline int
as_settable(struct butterflyfish_settable_map_$t$ *const object,
...
static inline int
as_set(const struct butterflyfish_settable_map_$t$ *const object,
...
static inline int
as_collection(const struct butterflyfish_settable_map_$t$ *const object,
...
static inline int
as_stream(const struct butterflyfish_settable_map_$t$ *const object,
...
int butterflyfish_settable_map_$t$_first(
    ...
    if (!out) {
        return BUTTERFLYFISH_SETTABLE_MAP_$T$_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_settable_map_$t$_next(
    ...
    if (!item) {
        return BUTTERFLYFISH_SETTABLE_MAP_$T$_ERROR_ITEM_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SETTABLE_MAP_$T$_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_settable_map_$t$_contains(
    ...
    if (!entry) {
        return BUTTERFLYFISH_SETTABLE_MAP_$T$_ERROR_ENTRY_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SETTABLE_MAP_$T$_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_settable_map_$t$_contains_all(
    ...
    if (!other) {
        return BUTTERFLYFISH_SETTABLE_MAP_$T$_ERROR_OTHER_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SETTABLE_MAP_$T$_ERROR_OUT_IS_NULL;
    }
