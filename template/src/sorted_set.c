...
#define INVOKE(x)               (*(struct butterflyfish_sorted_set_$t$ **) x)
...
static inline int
as_sorted(const struct butterflyfish_sorted_set_$t$ *const object,
...
static inline int
as_set(const struct butterflyfish_sorted_set_$t$ *const object,
...
static inline int
as_collection(const struct butterflyfish_sorted_set_$t$ *const object,
...
static inline int
as_stream(const struct butterflyfish_sorted_set_$t$ *const object,
...
int butterflyfish_sorted_set_$t$_first(
        const struct butterflyfish_sorted_set_$t$ *const object,
        const $v$*const out) {
    if (!object) {
        return BUTTERFLYFISH_SORTED_SET_$T$_ERROR_OBJECT_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SORTED_SET_$T$_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_sorted_set_$t$_next(
    ...
    if (!item) {
        return BUTTERFLYFISH_SORTED_SET_$T$_ERROR_ITEM_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SORTED_SET_$T$_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_sorted_set_$t$_ceiling(
    ...
    if (!value) {
        return BUTTERFLYFISH_SORTED_SET_$T$_ERROR_VALUE_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SORTED_SET_$T$_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_sorted_set_$t$_contains_all(
    ...
    if (!other) {
        return BUTTERFLYFISH_SET_$T$_ERROR_OTHER_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SET_$T$_ERROR_OUT_IS_NULL;
    }
