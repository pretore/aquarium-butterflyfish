...
static inline int
as_insertable(struct butterflyfish_ordered_incremental_set_$t$ *const object,
...
static inline int
as_set(const struct butterflyfish_ordered_incremental_set_$t$ *const object,
...
static inline int
as_ordered(const struct butterflyfish_ordered_incremental_set_$t$ *const object,
...
static inline int
as_addable(struct butterflyfish_ordered_incremental_set_$t$ *const object,
...
static inline int
as_stream(const struct butterflyfish_ordered_incremental_set_$t$ *const object,
...
int butterflyfish_ordered_incremental_set_$t$_first(
        ...
        const $v$*const out) {
    if (!object) {
        return BUTTERFLYFISH_ORDERED_INCREMENTAL_SET_$T$_ERROR_OBJECT_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_ORDERED_INCREMENTAL_SET_$T$_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_ordered_incremental_set_$t$_next(
    ...
    if (!item) {
        return BUTTERFLYFISH_ORDERED_INCREMENTAL_SET_$T$_ERROR_ITEM_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_ORDERED_INCREMENTAL_SET_$T$_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_ordered_incremental_set_$t$_contains(
    ...
    if (!value) {
        return BUTTERFLYFISH_ORDERED_INCREMENTAL_SET_$T$_ERROR_VALUE_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_ORDERED_INCREMENTAL_SET_$T$_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_ordered_incremental_set_$t$_contains_all(
    ...
    if (!other) {
        return BUTTERFLYFISH_ORDERED_INCREMENTAL_SET_$T$_ERROR_OTHER_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_ORDERED_INCREMENTAL_SET_$T$_ERROR_OUT_IS_NULL;
    }
...
#pragma mark ordered_incremental_set_$t$ -
