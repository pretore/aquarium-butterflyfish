...
static inline int
as_ordered_set(const struct butterflyfish_ordered_settable_set_$t$ *const object,
...
static inline int
as_settable_set(struct butterflyfish_ordered_settable_set_$t$ *const object,
...
static inline int
as_set(const struct butterflyfish_ordered_settable_set_$t$ *const object,
...
static inline int
as_ordered(const struct butterflyfish_ordered_settable_set_$t$ *const object,
...
static inline int
as_settable(struct butterflyfish_ordered_settable_set_$t$ *const object,
...
static inline int
as_collection(const struct butterflyfish_ordered_settable_set_$t$ *const object,
...
static inline int
as_stream(const struct butterflyfish_ordered_settable_set_$t$ *const object,
...
#pragma mark ordered_settable_set_$t$ -
