...
#define INVOKE(x) \\
    (*(struct butterflyfish_sorted_settable_incremental_map_$t$ **) x)
#define INVOKE_SORTED_SETTABLE_MAP(x) \\
    (*(struct butterflyfish_sorted_settable_map_$t$ **) x)
...
#define INVOKE_SORTED_INCREMENTAL_MAP(x) \\
    (*(struct butterflyfish_sorted_incremental_map_$t$ **) x)
...
#define INVOKE_SORTED_MAP(x) \\
    (*(struct butterflyfish_sorted_map_$t$ **) x)
#define INVOKE_MAP(x)           (*(struct butterflyfish_map_$t$ **) x)
#define INVOKE_SETTABLE(x)      (*(struct butterflyfihs_settable_$t$ **) x)
...
as_settable_map(
    ...
    assert(object);
    assert(out);
    struct butterflyfish_sorted_settable_map_$t$ *sorted_settable_map;
...
static inline int
as_sorted_map(const struct butterflyfish_sorted_settable_incremental_map_$t$
                *const object,
...
as_incremental_map(
    ...
    assert(object);
    assert(out);
    struct butterflyfish_sorted_incremental_map_$t$ *sorted_incremental_map;
...
static inline int
as_map(const struct butterflyfish_sorted_settable_incremental_map_$t$
        *const object,
       const struct butterflyfish_map_$t$ **const out) {
    assert(object);
    assert(out);
    const struct butterflyfish_sorted_map_$t$ *sorted_map;
    seagrass_required_true(!as_sorted_map(object, &sorted_map));
    return INVOKE_SORTED_MAP(sorted_map)->as_map(sorted_map, out);
}

static inline int
as_sorted(const struct butterflyfish_sorted_settable_incremental_map_$t$
            *const object,
...
static inline int
as_addable(struct butterflyfish_sorted_settable_incremental_map_$t$
                *const object,
...
static inline int
as_settable(struct butterflyfish_sorted_settable_incremental_map_$t$
                *const object,
...
static inline int
as_set(const struct butterflyfish_sorted_settable_incremental_map_$t$
        *const object,
...
static inline int
as_collection(const struct butterflyfish_sorted_settable_incremental_map_$t$
                *const object,
...
static inline int
as_stream(const struct butterflyfish_sorted_settable_incremental_map_$t$
            *const object,
...
#pragma mark sorted_settable_incremental_map_$t$ -
