...
#define INVOKE(x)               (*(struct butterflyfish_settable_list_$t$ **) x)
...
static inline int
as_list(const struct butterflyfish_settable_list_$t$ *const object,
...
static inline int
as_settable(struct butterflyfish_settable_list_$t$ *const object,
...
static inline int
as_collection(const struct butterflyfish_settable_list_$t$ *const object,
...
static inline int
as_stream(const struct butterflyfish_settable_list_$t$ *const object,
...
int butterflyfish_settable_list_$t$_first(
    ...
    if (!out) {
        return BUTTERFLYFISH_SETTABLE_LIST_$T$_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_settable_list_$t$_next(
    ...
    if (!item) {
        return BUTTERFLYFISH_SETTABLE_LIST_$T$_ERROR_ITEM_IS_NULL;
    }
    if (!out) {
        return BUTTERFLYFISH_SETTABLE_LIST_$T$_ERROR_OUT_IS_NULL;
    }
...
int butterflyfish_settable_list_$t$_set_item(
        struct butterflyfish_settable_list_$t$ *const object,
        const $v$const item,
        const $v$const value) {
    if (!object) {
        return BUTTERFLYFISH_SETTABLE_LIST_$T$_ERROR_OBJECT_IS_NULL;
