...
#define INVOKE(x) \\
    (*(struct butterflyfish_sorted_settable_incremental_set_$t$ **) x)
...
as_settable_set(
    ...
    assert(object);
    assert(out);
    struct butterflyfish_sorted_settable_set_$t$ *sorted_settable_set;
...
static inline int
as_sorted_set(const struct butterflyfish_sorted_settable_incremental_set_$t$
                *const object,
...
static inline int
as_addable(struct butterflyfish_sorted_settable_incremental_set_$t$
                *const object,
...
static inline int
as_settable(struct butterflyfish_sorted_settable_incremental_set_$t$
                *const object,
...
static inline int
as_set(const struct butterflyfish_sorted_settable_incremental_set_$t$
        *const object,
...
static inline int
as_sorted(const struct butterflyfish_sorted_settable_incremental_set_$t$
            *const object,
...
static inline int
as_collection(const struct butterflyfish_sorted_settable_incremental_set_$t$
            *const object,
...
static inline int
as_stream(const struct butterflyfish_sorted_settable_incremental_set_$t$
            *const object,
...
#pragma mark sorted_settable_incremental_set_$t$ -
